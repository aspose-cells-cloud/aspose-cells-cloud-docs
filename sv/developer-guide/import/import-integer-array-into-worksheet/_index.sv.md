---
title: Importera heltalsarray till Excel Worksheet
linktitle: Importera heltalsarra
type: docs
url: /sv/import/integer-array/
...
description: Aspose.Cells Cloud REST API stöder import av heltalsdata till Excel-filer. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 30
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Importera heltalsarray till Excel kalkylblad
---
Detta REST API `import int array data` till Excel arbetsblad.

Begäran är en HTTP-begäran med innehåll i flera delar (se[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)eller[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). Den första delen av innehållet med flera delar innehåller ImportIntegerArrayOption-data och den andra innehåller en datafil.
