---
title: Importera String Array till Excel Worksheet
second_title: Aspose.Cells Cloud Documen
linktitle: Importera sträng arra
type: docs
url: /sv/import/string-array/
...
Begäran är en HTTP-begäran med innehåll i flera delar (se[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)eller[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). Den första delen av innehållet med flera delar innehåller ImportStringArrayOption-data och den andra innehåller en datafil.
