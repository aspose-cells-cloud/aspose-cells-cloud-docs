...
description: Aspose.Cells Cloud REST API stöder export av Excel form till olika formatfiler. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 20
---
...
|:- |:- |:- |:- |
|/celler/export|SÄTTA|Exportera Excel-objekt från begäran om innehåll till något format|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
