...
description: Aspose.Cells Cloud REST API stöder uppdatering av egenskaper från excel-filer. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 30
---
Denna REST API indikerar till `set/create` dokumentegenskap.
...
| fast egendom|| kropp| med nytt fastighetsvärde.|
| mapp| sträng| fråga| Dokumentmappen.|
| lagringsnamn| sträng| fråga| lagringsnamn.|
 
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Properties/PutDocumentProperty) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
