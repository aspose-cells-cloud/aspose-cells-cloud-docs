---
title: Slå samman en Excel-arbetsböcker till andra Excel-fil
second_title: Aspose.Cells Cloud Documen
linktitle: Workboo
type: docs
url: /sv/workbook/merge/
aliases: [/merge-excel-workbooks/]
keywords: Merge an Excel Workbooks into other Excel file
description: Aspose.Cells Cloud REST API stöder sammanslagning av en Excel-fil till en annan Excel-fil. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 50
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Sammanfoga en Excel arbetsböcker till en annan Excel fil
---
Denna REST API indikerar att en Excel `workbook` ska slås samman med en annan Excel arbetsbok.
...
|:- |:- |:- |:- |
|/cells/{name}/merge|POSTA|Slå samman Excel Arbetsböcker|[PostWorkbooksMerge](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge)|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
