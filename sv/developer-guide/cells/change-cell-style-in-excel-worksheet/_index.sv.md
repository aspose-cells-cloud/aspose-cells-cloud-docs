---
title: Ändra cellstil i Excel Worksheet
type: docs
...
| stil|| kropp| med uppdatera stilinställningar.|
| mapp| sträng| fråga| Arbetsboksmappen.|
| lagringsnamn| sträng| fråga| lagringsnamn.|
 
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Cells/PostUpdateWorksheetCellStyle) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
