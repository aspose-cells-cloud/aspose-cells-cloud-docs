...
------------ | ------------- | ------------- | -------------
 Källmapp | sträng | | [valfritt]MatchCondition | MatchConditionRequest | | [valfritt]Format | sträng | | [valfritt]Outfolder | sträng | | [valfritt]Sparaalternativ | Spara Alternativ | | [frivillig]**MatchConditionRequest-egenskaper**
 
Namn | Skriv | Beskrivning | Anteckningar
------------ | ------------- | ------------- | -------------
 RegexPattern | sträng | | [valfritt]FullMatchvillkor | sträng[]| | [valfritt]Den[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/PostBatchConvert) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
