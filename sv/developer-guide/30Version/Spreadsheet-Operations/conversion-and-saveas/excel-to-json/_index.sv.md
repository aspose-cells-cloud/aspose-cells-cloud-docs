---
title: Excel till Jso
second_title: Documen
linktitle: Excel till Jso
type: docs
url: /sv/convert-excel-file-to-json-file/
keywords: Convert excel files to json files
description: Aspose.Cells Cloud REST API stöder konvertering av Excel-filer till JSON-filer. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 100
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Excel till Json
---
Denna REST API indikerar för `convert` en kalkylbladsfil till en fil i json-format.
...
|:- |:- |:- |:- |
|/celler/konvertera/json|POSTA|Konvertera ett kalkylblad till en pptx-fil.|[PostConvertWorkbookToJson](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson)|

 De[OpenAPI-specifikation](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
