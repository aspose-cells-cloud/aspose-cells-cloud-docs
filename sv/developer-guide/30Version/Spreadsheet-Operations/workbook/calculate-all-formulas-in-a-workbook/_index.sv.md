...
description: Aspose.Cells Cloud REST API stöder beräkning av alla formler i en Excel-arbetsbok. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 140
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Beräkna alla formler i en Excel-arbetsbok
---
Denna REST API indikerar `calculate all formulas` i en Excel-arbetsbok.
...
| ignoreraFel| boolesk| fråga| ignorera fel.|
| mapp| sträng| fråga| Dokumentets mapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookCalculateFormula) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
