---
title: Skydda en Excel-arbetsbok
second_title: Documen
linktitle: Skydda en Excel Fil
type: docs
...
weight: 30
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Skydda en Excel-arbetsbok
---
...
|/celler/{namn}/skydd|POSTA|Skydda ett dokument|[PostProtectDocument](https://apireference.aspose.cloud/cells/#/Workbook/PostProtectDocument)|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostProtectDocument) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
