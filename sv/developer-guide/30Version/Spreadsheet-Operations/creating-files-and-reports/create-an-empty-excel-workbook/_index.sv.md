...
description: "Aspose.Cells Cloud REST API hur man skapar en tom Excel-arbetsbok. SDK:n stöder olika typer av utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift."
weight: 20
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Skapa en tom Excel-arbetsbok
---
Denna REST API indikerar att en `empty workbook` ska skapas.
...
|:- |:- |:- |:- |
|/celler/{namn}|SÄTTA|Skapa en tom arbetsbok|[Lägg till arbetsbokSkapa](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate)|
