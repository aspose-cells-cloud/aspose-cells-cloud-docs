...
description: "Cells.Cloud API för Excel drift: uppgifter stöder import av data till Excel-fil"
weight: 40
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Arbeta med ImportData-uppgift
---
## REST API
