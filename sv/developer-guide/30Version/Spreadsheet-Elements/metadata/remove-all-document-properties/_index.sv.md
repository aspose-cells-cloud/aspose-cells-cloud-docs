...
weight: 58
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Ta bort alla dokumentegenskaper
---
Denna REST API indikerar anpassade dokumentegenskaper och rena inbyggda egenskaper för `delete all`.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
