...
linktitle: Uppdatera utan att använda lagringsutrymme
type: docs
url: /sv/metadata/update/
keywords: Update metadata on excel files
description: Aspose.Cells Cloud REST API stöder uppdatering av metadata i Excel-filer. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 35
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Uppdatera metadata
---
Denna REST API indikerar att `metadata` ska uppdateras från flera Excel-filer.
...
| Dokumentegenskaper|| kropp| Cells dokumentegenskap.|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/PostMetadata) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
