...
description: Aspose.Cells Cloud REST API stöder flyttning av en pivottabell i en Excel-fil. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 120
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Flytta en pivottabell i en Excel-fil
---
Denna REST API indikerar pivottabellen `move`.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldMoveTo) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
