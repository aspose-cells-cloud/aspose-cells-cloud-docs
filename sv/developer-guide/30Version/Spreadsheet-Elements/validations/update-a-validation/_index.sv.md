...
weight: 10
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Uppdatera en kalkylbladsvalidering på ett Excel-kalkylblad
---
Denna REST API anger att kalkylbladsvalideringen ska uppdateras med index på ett Excel-kalkylblad.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
