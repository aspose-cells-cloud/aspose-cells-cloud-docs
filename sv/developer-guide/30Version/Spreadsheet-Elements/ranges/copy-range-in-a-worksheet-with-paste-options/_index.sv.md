---
title: Kopiera område i ett kalkylblad med inklistringsalternativet
...
description: Aspose.Cells Cloud REST API stöder kopiering av ett område i ett Excel-arbetsblad med inklistringsalternativ. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 20
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Kopiera område i ett kalkylblad med inklistringsalternativ
---
Denna REST API anger att området i kalkylbladet ska kopieras på ett Excel-kalkylblad.
...
| räckviddFunktion|| kropp| copydata,copystyle,copyto,copyvalue|
| mapp| sträng| fråga| Arbetsboksmapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangesCopy) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
