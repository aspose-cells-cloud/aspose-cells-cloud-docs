---
title: Använda RTF-formatering på en cell
type: docs
url: /sv/apply-rich-text-formatting-to-a-cell/
weight: 40
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Använd RTF-formatering på en cell
---
Denna REST API indikerar att `rich text formatting` ska tillämpas på en cell i en Excel-fil.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
