---
title: Hämta MaxDataColumn från arbetsbladet Excel
type: docs
url: /sv/get-maxdatacolumn-from-excel-worksheet/
weight: 70
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta MaxDataColumn från Excel-arbetsblad
---
Denna REST API indikerar att en `maxdatacolumn` hämtas i en Excel-fil när parametern `cellOrMethodName` är `maxdatacolumn`.
