---
title: Hämta MergedCell från ett arbetsblad
type: docs
url: /sv/get-mergedcell-from-a-worksheet/
weight: 60
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta MergedCell från ett kalkylblad
---
Denna REST API indikerar att `merged cell` ska hämtas i en Excel-fil.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetMergedCells) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
