---
title: Ange formel för en cell i arbetsbladet Excel
type: docs
url: /sv/set-formula-for-a-cell-in-excel-worksheets/
weight: 80
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Ange formel för en cell i Excel-arbetsblad
---
Denna REST API indikerar uppsättning `cell formula` i en Excel-fil.
