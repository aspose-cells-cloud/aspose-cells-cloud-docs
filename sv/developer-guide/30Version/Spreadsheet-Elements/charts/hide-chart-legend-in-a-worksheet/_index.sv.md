---
title: Dölj diagramförklaring i ett arbetsblad
type: docs
url: /sv/charts/legend/hide/
aliases: [/hide-chart-legend-in-a-worksheet/]
weight: 110
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Dölj diagramförklaring i ett kalkylblad
---
Denna REST API indikerar att förklaringen ska döljas i diagrammet
...
<br/>
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChartLegend) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
