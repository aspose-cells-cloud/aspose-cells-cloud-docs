---
title: Hämta diagramförklaring från ett arbetsblad
type: docs
url: /sv/charts/legend/get/
aliases: [/get-chart-legend-from-a-worksheet/]
weight: 80
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta diagramförklaring från ett kalkylblad
---
Denna REST API indikerar att hämta diagramförklaring
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChartLegend) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
