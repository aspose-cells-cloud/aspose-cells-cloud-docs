---
title: Hämta diagramområde från ett arbetsblad
type: docs
url: /sv/charts/area/get/
aliases: [/get-chart-area-from-a-worksheet/]
weight: 60
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta diagramområde från ett kalkylblad
---
Denna REST API indikerar att man ska hämta information om sjökortsområde.
...
<br/>
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
