---
title: Visa diagramförklaring i ett arbetsblad
type: docs
url: /sv/charts/legend/show/
aliases: [/show-chart-legend-in-a-worksheet/]
weight: 100
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Visa diagramförklaring i ett kalkylblad
---
Denna REST API indikerar att förklaringen i diagrammet ska visas
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartLegend) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
