---
title:  Hämta diagramvärde Axi
type: docs
url: /sv/charts/value-axis/get/
weight: 60
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta diagramvärdeaxel
---
Denna REST API indikerar Hämta diagramvärdeaxel
...
| lagringsnamn| sträng| fråga||
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Charts/GetChartValueAxis) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
