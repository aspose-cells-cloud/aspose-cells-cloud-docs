---
title: Autoanpassa en rad i ett Excel-arbetsblad
...
description: Aspose.Cells Cloud REST API stöder autoanpassning av en rad i ett Excel-arbetsblad. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 30
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Autoanpassa en rad i ett Excel-kalkylblad
---
Denna REST API anger att en rad i ett Excel-arbetsblad ska autoanpassas.
...
| radindex| heltal| fråga| Radindexet.|
| förstaKolumnen| heltal| fråga| Den första kolumnens index.|
| sista kolumnen| heltal| fråga| Den sista kolumnens index.|
|[autoFitterAlternativ](/cells/sv/auto-fitter-options) | objekt| kropp| Alternativen för automatisk montör.|
| mapp| sträng| fråga| Mappen.|
| lagringsnamn| sträng| fråga| lagringsnamn.|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRow) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
