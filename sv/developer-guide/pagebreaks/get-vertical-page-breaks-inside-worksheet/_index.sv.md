---
title: Få vertikal sidbrytning
second_title: Aspose.Cells Cloud Documen
linktitle: Få vertikal sidbrytning
type: docs
...
weight: 20
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Få vertikala sidbrytningar
---
 Denna REST API indikerar att få `vertical` sidbrytningar.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
