---
title: Få horisontell sidbrytning
second_title: Aspose.Cells Cloud Documen
linktitle: Få horisontell sidbrytning
type: docs
...
weight: 10
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Få horisontella sidbrytningar
---
 Denna REST API indikerar att få `horizontal` sidbrytningar.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
