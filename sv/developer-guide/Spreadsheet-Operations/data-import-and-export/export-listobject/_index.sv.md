...
description: Aspose.Cells Cloud REST API stöder export Excel listobjekt till olika typer av formatfiler. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 20
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Exportera listobjekt
---
...
|:- |:- |:- |:- |
|/celler/exportera|POSTA|Exportera Excel från begäran till något format|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
