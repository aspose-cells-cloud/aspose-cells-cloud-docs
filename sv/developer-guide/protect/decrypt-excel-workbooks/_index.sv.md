---
title: Dekryptera en Excel workboo
second_title: Aspose.Cells Cloud Documen
linktitle: Dekryptera
type: docs
url: /sv/workbook/decrypt/
aliases: [/decrypt-excel-workbooks/]
keywords: REST API, spreadsheets, excel, decryp
description: "Cells. Cloud API för Excel fungera: dekryptera en Excel arbetsbok"
weight: 50
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Dekryptera en Excel arbetsbok
---
...
|:- |:- |:- |:- |
|/celler/{namn}/kryptering|DELTE|Dekryptera ett dokument|[Ta bortDecryptDocument](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDocument)|


 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDocument) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
