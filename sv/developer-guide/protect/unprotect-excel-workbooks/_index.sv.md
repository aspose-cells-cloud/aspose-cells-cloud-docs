---
title: Ta bort skyddet för en Excel workboo
second_title: Aspose.Cells Cloud Documen
linktitle: Unprotec
type: docs
url: /sv/workbook/unprotect/
aliases: [/unprotect-excel-workbooks/]
keywords: REST API, spreadsheets, excel, merg
description: "Cells. Cloud API för Excel fungera: skydda en Excel arbetsbok"
weight: 60
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Avskydda en Excel arbetsbok
---
...
|:- |:- |:- |:- |
|/celler/{namn}/skydd|RADERA|Ta bort skyddet av ett dokument|[Ta bortUnProtectDocument](https://apireference.aspose.cloud/cells/#/Workbook/DeleteUnProtectDocument)|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Workbook/DeleteUnProtectDocument) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
