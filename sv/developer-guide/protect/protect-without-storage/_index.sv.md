...
linktitle: Skydda utan att använda förvaring
type: docs
...
| protectWorkbookRequest| klass| formData| Begäran om skydd av arbetsbok|
 
 De[OpenAPI-specifikation](https://reference.aspose.cloud/cells/#/LightCells/PostProtect) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
