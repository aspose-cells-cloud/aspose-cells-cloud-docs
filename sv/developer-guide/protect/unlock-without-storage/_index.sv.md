...
linktitle: Dekryptera utan att använda lagring
type: docs
url: /sv/unlock/without-using-storage/
...
| Lösenord| sträng| fråga||
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/LightCells/PostUnlock) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
