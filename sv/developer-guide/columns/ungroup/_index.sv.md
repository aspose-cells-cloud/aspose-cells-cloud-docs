---
title: Dela upp kolumner på ett Excel arbetsblad
...
description: Aspose.Cells Cloud REST API stöder uppdelningskolumnen på ett Excel-kalkylblad. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 70
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Dela upp kolumner på ett Excel kalkylblad
---
Denna REST API indikerar att dela upp kalkylbladskolumner.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
