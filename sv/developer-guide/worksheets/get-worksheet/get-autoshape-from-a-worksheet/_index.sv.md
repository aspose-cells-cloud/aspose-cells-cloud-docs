---
title: Få en autoshape från ett Excel arbetsblad
second_title: Aspose.Cells Cloud Documen
linktitle: AutoShap
type: docs
url: /sv/shapes/get-autoshape/
aliases: [/get-autoshape-from-a-worksheet/]
keywords: Get autoshape to different format from an Excel worksheet
description: Aspose.Cells Cloud REST API stöder att få autoshape till ett annat format än ett Excel kalkylblad. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 10
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Få en autoshape från ett Excel kalkylblad
---
Denna REST API indikerar `get autoshape info`.
...
| autoformNumber| heltal| väg| Autoshape-numret.|
| formatera| sträng| fråga| Exporterat format.|
| mapp| sträng| fråga| Dokumentmappen.|
| lagringsnamn| sträng| fråga| lagringsnamn.|
 
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Autoshapes/GetWorksheetAutoshape) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
