---
title: Avlägsna sammanslagningen av Cells i Excel-arbetsbladet
type: docs
url: /sv/unmerge-cells-in-excel-worksheet/
weight: 120
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Avsammanslagning Cells i Excel Arbetsblad
---
...
| totala rader| heltal| fråga| Totalt antal rader|
| totalaKolumner| heltal| fråga| Totalt antal kolumner.|
| mapp| sträng| fråga| Arbetsbokens mapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
