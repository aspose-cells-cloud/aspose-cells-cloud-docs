---
title:  Hämta diagrammets andra värde Axi
type: docs
url: /sv/charts/second-value-axis/get/
weight: 60
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta diagram, andra värdeaxel
---
 Denna REST API indikerar Hämta diagrammets andra värdeaxel.
...
| lagringsnamn| sträng| fråga||
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondValueAxis) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
