---
title: Hämta celldata baserat på namngivna rangord
...
weight: 20
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta celldata baserat på namngivet område
---
Denna REST API indikerar Hämta celllista i ett område efter områdesnamn eller radkolumnindex
...
| förstaKolumnen| heltal| fråga| den första kolumnen i intervallet|
| radantal| heltal| fråga| antalet rader i intervallet|
| kolumnAntal| heltal| fråga| antalet kolumner i intervallet|
| mapp| sträng| fråga| Arbetsboksmapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|

 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Ranges/GetWorksheetCellsRangeValue) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
