...
description:  Infoga utsnitt för listobjekt.
weight: 20
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Listobjektinfogningsutsnitt
---
Denna REST API indikerar infogningsutsnitt för listobjekt på ett Excel-arbetsblad.
...
|lagringsnamn|Sträng|Fråga||
 ...
 De[OpenAPI-specifikation](https://reference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectInsertSlicer) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
