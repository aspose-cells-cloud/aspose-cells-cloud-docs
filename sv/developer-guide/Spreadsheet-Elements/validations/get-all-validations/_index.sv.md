---
title: Hämta alla kalkylbladsvalideringar från ett Excel-kalkylblad
second_title: Aspose.Cells Cloud Documen
linktitle: Få alla
type: docs
url: /sv/validations/get-all/
keywords: Get all worksheet validations from an Excel worksheet
description: Aspose.Cells Cloud REST API stöder att hämta alla kalkylbladsvalideringar från ett Excel-kalkylblad. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 10
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Hämta alla kalkylbladsvalideringar från ett Excel-kalkylblad
---
Denna REST API anger att alla kalkylbladsvalideringar ska hämtas på ett Excel-kalkylblad.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
