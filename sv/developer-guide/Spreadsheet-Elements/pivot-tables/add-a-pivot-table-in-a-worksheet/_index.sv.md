---
title: Lägg till en pivottabell i ett Excel-arbetsblad
...
description: Aspose.Cells Cloud REST API stöder tillägg av en pivottabell i ett Excel-arbetsblad. SDK stöder olika typer av utvecklingsspråk. Dessa inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och Swift.
weight: 30
kwords: Excel, Office Moln, REST API, Kalkylblad, PDF, CSV, Json, Markdown, Lägg till en pivottabell i ett Excel-kalkylblad
---
Denna REST API indikerar för `add` en pivottabell i ett kalkylblad.
...
| begäran|| kropp| CreatePivotTableRequest dto i begäran.|
| mapp| sträng| fråga| Dokumentets mapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|
| källdata| sträng| fråga| Data för den nya pivottabellcachen.|
|destinationCellName| sträng| fråga| Cellen i det övre vänstra hörnet av pivottabellrapportens målområde.|
| tabellnamn| sträng| fråga| Namnet på den nya pivottabellrapporten.|
| användSammaKälla| boolesk| fråga| Anger om samma datakälla används när en annan befintlig pivottabell har använt denna datakälla. Om egenskapen är sann sparar den minne.|
 
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable) definierar ett offentligt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
