---
title: Arbeta med SaveResult Tas
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/tasks/save-result/
aliases: [/working-with-saveresult-task/]
keywords: REST API, task, save result, spreadsheets, exce
description: "Cells.Cloud API för Excel fungerar: uppgiftsstöd för att spara resultatet i svarsinnehåll eller molnlagring"
weight: 50
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Arbeta med SaveResult Task
---
## REST API
