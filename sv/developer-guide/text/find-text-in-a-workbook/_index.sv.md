---
title: Hitta text i en Excel workboo
second_title: Aspose.Cells Cloud Documen
linktitle: Hitta i workboo
type: docs
...
description: Aspose.Cells Cloud REST API stöder att hitta text från Excel arbetsbok. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Hitta text i en Excel arbetsbok
---
Denna REST API indikerar till `search` text i en Excel fil.
...
| lagringsnamn| sträng| fråga| lagringsnamn.|
 ...
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksTextSearch) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
