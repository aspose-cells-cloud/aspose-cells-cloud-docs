---
title: Ersätt text i en Excel workboo
second_title: Aspose.Cells Cloud Documen
linktitle: Byt ut i workboo
type: docs
...
description: Aspose.Cells Cloud REST API stöder att ersätta text från Excel arbetsbok. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Ersätt text i en Excel arbetsbok
---
Denna REST API indikerar till `replace` text i en Excel arbetsbok.
...
| gammalt värde| sträng| fråga| Den gamla texten ska ersättas.|
| nyttVärde| sträng| fråga| Den nya texten att ersätta med.|
| mapp| sträng| fråga| Dokumentets mapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|
 
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorsheetTextReplace) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
