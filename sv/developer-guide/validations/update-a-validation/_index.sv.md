---
title: Uppdatera en kalkylbladsvalidering på ett Excel kalkylblad
second_title: Aspose.Cells Cloud Documen
linktitle: Uppdatering
type: docs
url: /sv/validations/update/
keywords: Delete a worksheet validation on an Excel worksheet
description: Aspose.Cells Cloud REST API stöder radering av en kalkylbladsvalidering på ett Excel kalkylblad. SDK stöder olika utvecklingsspråk. De inkluderar Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby och swift
weight: 10
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Uppdatera en kalkylbladsvalidering på ett Excel kalkylblad
---
Denna REST API indikerar att kalkylbladsvalidering ska uppdateras genom index på ett Excel kalkylblad.
...
| validationIndex| heltal| väg| Valideringsindexet.|
| godkännande| objekt| kropp||
| mapp| sträng| fråga| Dokumentets mapp.|
| lagringsnamn| sträng| fråga| lagringsnamn.|
 
 De[OpenAPI-specifikation](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation) definierar ett allmänt tillgängligt programmeringsgränssnitt och låter dig utföra REST-interaktioner direkt från en webbläsare.
