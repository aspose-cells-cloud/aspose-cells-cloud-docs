...
weight: 10
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Ta bort en kalkylbladsvalidering på ett Excel kalkylblad
---
Denna REST API indikerar att en kalkylbladsvalidering ska tas bort genom index på ett Excel kalkylblad.
