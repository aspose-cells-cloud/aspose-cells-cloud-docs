...
type: docs
url: /sv/specification/operation/postworksheetlistobjectremoveduplicates/
description: Ta bort dubbletter i listobjekt
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/RemoveDuplicates,POST,Ta bort dubbletter i listobjekt.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects /PostWorksheetListObjectRemoveDuplicates\'>PostWorksheetListObjectRemoveDuplicates</a>" >}}
