...
type: docs
url: /sv/specification/operation/postcopyworksheetcolumns/
description: Kopiera data från källkolumner till målkolumner i kalkylbladet
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/copy,POST,Kopiera data från källkolumner till målkolumner i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetColumns\'>PostCopyWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex,integer,Källkolumnindex" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destinationColumnIndex,integer,Destination kolumnindex" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnNumber,integer,Det kopierade kolumnnumret" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="kalkylblad,sträng,Destinationskalkylbladets namn." >}} 
