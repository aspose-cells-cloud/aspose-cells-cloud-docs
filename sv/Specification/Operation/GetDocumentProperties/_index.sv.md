...
type: docs
url: /sv/specification/operation/getdocumentproperties/
description: Hämta beskrivningar av Excel filegenskaper
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,GET,Hämta beskrivningar av Excel filegenskaper.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperties\'>GetDocumentProperties</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,Excel egenskapstyp." >}} 
