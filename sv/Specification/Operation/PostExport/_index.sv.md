...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/export,POST,Exportera Excel interna element eller själva arbetsboken till olika formatfiler.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostExport\'>PostExport</a>" >}}
