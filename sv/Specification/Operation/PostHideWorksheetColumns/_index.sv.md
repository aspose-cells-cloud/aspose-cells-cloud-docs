---
title: PostHide WorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/posthideworksheetcolumns/
description: Dölj kalkylbladskolumner i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostHideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,Dölj kalkylbladskolumner i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
