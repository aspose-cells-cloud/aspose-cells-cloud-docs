...
type: docs
url: /sv/specification/operation/getverticalpagebreaks/
description: Hämta beskrivningar av vertikala sidbrytningar i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, GetVerticalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,Hämta beskrivningar av vertikala sidbrytningar i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks \'>GetVerticalPageBreaks</a>" >}}
