...
type: docs
url: /sv/specification/operation/getworksheethyperlinks/
description: Hämta beskrivningar av hyperlänkar i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetWorksheetHyperlinks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,GET,Hämta beskrivningar av hyperlänkar i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/GetWorksheetHyperlinks\'> GetWorksheetHyperlinks</a>" >}}
