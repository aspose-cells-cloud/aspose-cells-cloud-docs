...
type: docs
url: /sv/specification/operation/postworksheethyperlink/
description: Uppdatera hyperlänk efter index i kalkylbladet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},POST,Uppdatera hyperlänk efter index i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /PostWorksheetHyperlink\'>PostWorksheetHyperlink</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="hyperlänk,klass:hyperlänk,Hyperlänkobjekt" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
