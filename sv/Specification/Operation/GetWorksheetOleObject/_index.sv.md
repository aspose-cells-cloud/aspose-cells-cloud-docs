...
type: docs
url: /sv/specification/operation/getworksheetoleobject/
description: Hämta OLE-objektet i ett angivet format i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects/{objectNumber},GET,Hämta OLE-objektet i ett angivet format i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells /#/OleObjects/GetWorksheetOleObject\'>GetWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameternamn, typ, beskrivning" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="objectNumber,integer, Objektnumret." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="format, sträng, objektkonverteringsformat (PNG/TIFF/JPEG/GIF/EMF/BMP)." >}} 
