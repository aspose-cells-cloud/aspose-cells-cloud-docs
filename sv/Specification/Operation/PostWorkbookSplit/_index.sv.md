...
type: docs
url: /sv/specification/operation/postworkbooksplit/
description: Dela upp arbetsboken med ett specifikt format
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/split,POST,Dela upp arbetsboken med ett specifikt format.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit\'>PostWorkbookSplit</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="format, sträng, delat format." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outFolder,string," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="from,integer,Start kalkylbladsindex." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="till,heltal,Avsluta kalkylbladsindex." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" splitNameRule,string,regelnamn: sheetname newguid" >}} 
