...
type: docs
url: /sv/specification/operation/putworkbookbackground/
description: Ange bakgrund i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,PUT,Ange bakgrund i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookBackground\'>PutWorkbookBackground</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath,string,Bildens fullständiga sökväg." >}} 
