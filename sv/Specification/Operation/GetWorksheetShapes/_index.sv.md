...
type: docs
url: /sv/specification/operation/getworksheetshapes/
description: Hämta beskrivningar av former i arbetsbladet
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,Hämta beskrivningar av former i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'> GetWorksheetShapes</a>" >}}
