---
title: Ta bortWorksheetChar
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetchart/
description: Ta bort ett diagram efter index i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, DeleteWorksheetChart
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,Ta bort ett diagram efter index i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ Charts/DeleteWorksheetChart\'>DeleteWorksheetChart</a>" >}}
