...
type: docs
url: /sv/specification/operation/postworksheetcellsrangevalue/
description: Tilldela ett värde till intervallet; vid behov konverteras värdet till en annan datatyp och cellens talformat återställs
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,POST,Tilldela ett värde till intervallet; vid behov kommer värdet att konverteras till en annan datatyp och cellens talformat återställs.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeValue\'>PostWorksheetCellsRangeValue</a> a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Värde, sträng, Indatavärde." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isConverted,boolean,True: konverteras till annan datatyp vid behov." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="setStyle,boolean,True: ställ in talformatet till cellens stil vid konvertering till annan datatyp." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" range,class:range,Omfånget i kalkylbladet." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
