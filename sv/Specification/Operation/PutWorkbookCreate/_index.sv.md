...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name},PUT,Skapa en ny arbetsbok med olika metoder.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate\'>PutWorkbookCreate</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameternamn, typ, beskrivning" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="namn, sträng, Det nya dokumentnamnet." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="templateFile,string,Mallfilen, om data som inte tillhandahålls skapas standardarbetsboken." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="datafil, sträng, datafil för smart markör, om uppgifterna inte tillhandahålls kontrolleras begärans innehåll för data." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isWriteOver,boolean,Anger om målfilen ska skrivas över." >}} 
