---
title: Ta bortWorksheetRo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetrow/
description: Ta bort en rad i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, DeleteWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},DELETE,Ta bort en rad i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetRow\'>DeleteWorksheetRow</a>" >}}
