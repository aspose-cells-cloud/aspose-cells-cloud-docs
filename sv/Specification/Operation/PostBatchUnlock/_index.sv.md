...
type: docs
url: /sv/specification/operation/postbatchunlock/
description: Batchupplåsningsfiler som uppfyller specifika matchningsvillkor
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostBatchUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/unlock,POST,Batchupplåsningsfiler som uppfyller specifika matchningsvillkor.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchUnlock\'>PostBatchUnlock</a>" >}}
