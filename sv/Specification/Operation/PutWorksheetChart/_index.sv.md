...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts,PUT,Lägg till ett nytt diagram i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChart\'> PutWorksheetChart</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="chartType, string, Chart type, se egenskapen Typ i diagramresurs." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,integer,Övre-vänster rad för det nya diagrammet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,integer,Övre-vänster kolumn för det nya diagrammet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightRow,integer,Nedre vänstra rad för det nya diagrammet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightColumn,integer,Nedre vänstra kolumn för det nya diagrammet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="area,string,Ange värdena från vilka dataserien ska plottas." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns=" isVertical,boolean,Ange om serien ska plottas från ett intervall av cellvärden efter rad eller kolumn." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="kategoriData, sträng, Hämta eller ställ in intervallet för kategoriaxelvärden. Det kan vara ett cellområde (t.ex. \'D1:E10\')." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAutoGetSerialName,boolean,Ange om serienamnet ska uppdateras automatiskt." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="title,string,Ange diagramtitelns namn." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="folder,string,Mappen där filen finns." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dataLabels,boolean,Representerar det angivna diagrammets dataetikettvärden som visar beteende. True för att visa värdena, False för att dölja dem." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dataLabelsPosition,string,Representerar dataetikettens position (Center/InsideBase/InsideEnd/OutsideEnd/Above/Below/Left/Right/BestFit/Moved)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="pivotTableSheet,string,Källan är pivottabellens data. Om PivotSource inte är tomt är diagrammet ett PivotChart." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="pivotTableName,string, Pivottabellens namn." >}} 
