...
type: docs
url: /sv/specification/operation/getworksheethyperlink/
description: Hämta hyperlänksbeskrivning efter index i kalkylbladet
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},GET,Hämta hyperlänksbeskrivning via index i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ Hypelinks/GetWorksheetHyperlink\'>GetWorksheetHyperlink</a>" >}}
