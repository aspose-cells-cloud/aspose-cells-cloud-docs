...
type: docs
url: /sv/specification/operation/putworksheetlistobject/
description: Lägg till ett ListObject i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects,PUT,Lägg till ett ListObject i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PutWorksheetListObject\'>PutWorksheetListObject </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,integer,Startraden i listintervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,Startkolumnen i listintervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,integer,Startraden i listintervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,Startkolumnen i listintervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="folder,string,Mappen där filen finns." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hasHeaders,boolean,Ange om intervallet har rubriker." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="displayName,string,Ange om visningsnamn." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="showTotals,boolean,Ange om visa totaler." >}} 
