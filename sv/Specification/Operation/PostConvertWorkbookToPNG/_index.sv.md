...
type: docs
url: /sv/specification/operation/postconvertworkbooktopng/
description: Konvertera Excel-filen till PNG-filer
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostConvertWorkbookToPNG
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/png,POST,Konvertera Excel-fil till PNG-filer.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPNG\'>PostConvertWorkbookToPNG</a>" >}}
