...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,Hämta värdena för celler inom det angivna intervallet.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /GetWorksheetCellsRangeValue\'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="namerange,string,intervallnamnet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,Hämtar indexet för den första raden i intervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,Hämtar indexet för den första kolumnen i intervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,integer,Hämtar antalet rader i intervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnCount,integer,Hämtar antalet kolumner i intervallet." >}} 
