...
type: docs
url: /sv/specification/operation/putworksheetpivottable/
description: Lägg till en pivottabell i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutWorksheetPivotTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables,PUT,Lägg till en pivottabell i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable\'>PutWorksheetPivotTable </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="sourceData,string,Datan för den nya PivotTable-cachen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destCellName,string,Cellen i det övre vänstra hörnet av målintervallet för pivottabellsrapporten." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="tableName,string,Namnet på den nya pivottabellen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="useSameSource,boolean,Anger om samma datakälla används när en annan befintlig pivottabell har använt denna datakälla. Om egenskapen är sann kommer den att spara minne." >}} 
