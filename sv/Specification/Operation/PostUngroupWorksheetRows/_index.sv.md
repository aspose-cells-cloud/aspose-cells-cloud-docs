...
type: docs
url: /sv/specification/operation/postungroupworksheetrows/
description: Dela upp rader i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostUngroupWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/ungroup,POST,Ungroup rader i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows \'>PostUngroupWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="isAll,boolean,Skall alla rader användas" >}} 
