...
type: docs
url: /sv/specification/operation/postchartsecondcategoryaxis/
description: Uppdatera diagrammets andra kategoriaxel i diagrammet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,POST,Uppdatera diagrammets andra kategoriaxel i diagrammet.,<a href=\'https://apireference.aspose.cloud/cells/ #/Charts/PostChartSecondCategoryAxis\'>PostChartSecondCategoryAxis</a>" >}}
