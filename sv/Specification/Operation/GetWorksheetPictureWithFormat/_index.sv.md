...
type: docs
url: /sv/specification/operation/getworksheetpicturewithformat/
description: Hämta en bild efter nummer i arbetsbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, GetWorksheetPictureWithFormat
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureNumber},GET,Hämta en bild efter nummer i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ Pictures/GetWorksheetPictureWithFormat\'>GetWorksheetPictureWithFormat</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameternamn, typ, beskrivning" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="pictureNumber,integer,The picture index." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="format, sträng, bildkonverteringsformat (PNG/TIFF/JPEG/GIF/EMF/BMP)." >}} 
