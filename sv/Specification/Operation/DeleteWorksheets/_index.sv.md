...
type: docs
url: /sv/specification/operation/deleteworksheets/
description: Ta bort matchade kalkylblad i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, Ta bort arbetsark
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,Ta bort matchade kalkylblad i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>Ta bort arbetsblad</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameternamn, typ, beskrivning" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="namn, sträng," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="matchCondition,class:matchconditionrequest," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
