...
type: docs
url: /sv/specification/operation/postworksheetlistobjectconverttorange/
description: Konvertera listobjekt till intervall i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostWorksheetListObjectConvertToRange
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/ConvertToRange,POST,Konvertera listobjekt till intervall i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/ #/ListObjects/PostWorksheetListObjectConvertToRange\'>PostWorksheetListObjectConvertToRange</a>" >}}
