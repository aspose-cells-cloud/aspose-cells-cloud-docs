...
type: docs
url: /sv/specification/operation/postsetworksheetcolumnwidth/
description: Ställ in kalkylbladets kolumnbredd
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostSetWorksheetColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},POST,Ange kalkylbladskolumnbredd.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostSetWorksheetColumnWidth\'>PostSetWorksheetColumnWidth</a>" >}}
