...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,Konvertera Excel-fil till Json-filer.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
