...
type: docs
url: /sv/specification/operation/postimport/
description: Importera data till en Excel-fil och generera utdatafiler i olika format
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostImport
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/import,POST,Importera data till en Excel-fil och generera utdatafiler i olika format.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostImport\'>PostImport</a >" >}}
