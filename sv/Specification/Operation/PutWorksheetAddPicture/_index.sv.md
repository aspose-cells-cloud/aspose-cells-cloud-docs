...
type: docs
url: /sv/specification/operation/putworksheetaddpicture/
description: Lägg till en ny bild i arbetsbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, PutWorksheetAddPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,Lägg till en ny bild i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture\'> PutWorksheetAddPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,integer,Bildens övre vänstra rad." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,integer,Bildens övre vänstra kolumn." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightRow,integer,Bilden nedre högra raden." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightColumn,integer,Bilden nedre högra kolumnen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="picturePath,string,Bildsökvägen, om den inte tillhandahålls, inspekteras bilddata i begärandetexten." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="bild,klass:bild,bildobjekt" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
