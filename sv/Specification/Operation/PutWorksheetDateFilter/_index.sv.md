...
type: docs
url: /sv/specification/operation/putworksheetdatefilter/
description: Använd ett datumfilter i kalkylbladet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,PUT,Använd ett datumfilter i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDateFilter \'>PutWorksheetDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,Anger hur man grupperar dateTime-värden (dag, timme, minut, månad, andra, år)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="år, heltal, året." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="månad,heltal,månaden." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dag, heltal, dagen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="timme,heltal,timmen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="minut, heltal, Minuten." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="andra, heltal, Den andra." >}} 
