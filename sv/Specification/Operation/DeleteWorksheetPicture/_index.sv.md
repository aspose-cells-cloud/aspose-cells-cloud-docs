---
title: Ta bortWorksheetPictur
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetpicture/
description: Ta bort ett bildobjekt genom att indexera i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, Ta bort WorksheetPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},DELETE,Ta bort ett bildobjekt genom att indexera i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/# /Pictures/DeleteWorksheetPicture\'>Ta bort WorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameternamn, typ, beskrivning" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="pictureIndex,integer,Picture index." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
