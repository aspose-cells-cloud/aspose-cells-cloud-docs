---
title: Ta bortWorkbookBackgroun
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworkbookbackground/
description: Ta bort bakgrund i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, DeleteWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,DELETE,Ta bort bakgrund i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground\'>Ta bort WorkbookBackground</a>" >}}
