...
type: docs
url: /sv/specification/operation/postsearch/
description: Sök efter specificerad text i Excel-filer
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostSearch
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/search,POST,Sök efter specificerad text i Excel-filer.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSearch\'>PostSearch</a>" >}}
