...
type: docs
url: /sv/specification/operation/getworksheetrow/
description: Hämta raddata efter radens index i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},GET,Hämta raddata genom radens index i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/ cells/#/Cells/GetWorksheetRow\'>GetWorksheetRow</a>" >}}
