...
type: docs
url: /sv/specification/operation/getworkbooktextitems/
description: Hämta textobjekt i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetWorkbookTextItems
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/textItems,GET,Hämta textobjekt i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems\'>GetWorkbookTextItems</a>" >}}
