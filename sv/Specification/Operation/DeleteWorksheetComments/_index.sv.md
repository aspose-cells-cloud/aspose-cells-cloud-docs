---
title: Ta bortWorksheetComment
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetcomments/
description: Ta bort alla kommentarer i arbetsbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, Ta bort ArbetsbladKommentarer
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,DELETE,Ta bort alla kommentarer i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments\'>Ta bort WorksheetComments </a>" >}}
