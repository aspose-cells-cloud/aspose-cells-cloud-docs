...
type: docs
url: /sv/specification/operation/postworkbookcalculateformula/
description: Beräkna alla formler i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostWorkbookCalculateFormula
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/calculateformula,POST,Beräkna alla formler i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookCalculateFormula\'>PostWorkbookCalculateFormula</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ignoreError,boolean,ignore Error." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:calculationoptions,CalculationOptions Beräkningsalternativ." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
