...
type: docs
url: /sv/specification/operation/postworksheetcellsrangescopy/
description: Kopiera innehåll från källområdet till målområdet i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostWorksheetCellsRangesCopy
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/copy,POST,Kopiera innehåll från källintervallet till målintervallet i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells /#/Ranges/PostWorksheetCellsRangesCopy\'>PostWorksheetCellsRangesCopy</a>" >}}
