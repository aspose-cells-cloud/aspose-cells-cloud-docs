...
type: docs
url: /sv/specification/operation/putdocumentprotectfromchanges/
description: Excel fil skrivskydd
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutDocumentProtectFromChanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/writeProtection,PUT,Excel filskrivskydd.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PutDocumentProtectFromChanges\'>PutDocumentProtectFromChanges</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="password,class:passwordrequest,Lösenordet som behövs för att öppna en Excel-fil." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
