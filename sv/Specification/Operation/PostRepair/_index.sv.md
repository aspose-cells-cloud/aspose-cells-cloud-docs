...
type: docs
url: /sv/specification/operation/postrepair/
description: Reparera onormala filer och generera filer i olika format
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostRepair
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/repair,POST,Reparera onormala filer och generera filer i olika format.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRepair\'>PostRepair</a>" >}}
