---
title: GetChartSecondCategoryAxi
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/getchartsecondcategoryaxis/
description: Hämta diagrammets andra kategoriaxel i tecknet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,GET,Hämta diagrammets andra kategoriaxel i diagrammet,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
