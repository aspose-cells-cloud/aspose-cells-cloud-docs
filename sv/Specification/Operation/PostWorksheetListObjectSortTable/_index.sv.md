...
type: docs
url: /sv/specification/operation/postworksheetlistobjectsorttable/
description: Sortera listobjekt i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostWorksheetListObjectSortTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/sort,POST,Sortera listobjekt i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ ListObjects/PostWorksheetListObjectSortTable\'>PostWorksheetListObjectSortTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataSorter,class:datasorter,Representerar sorteringsordningen för dataintervallet." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
