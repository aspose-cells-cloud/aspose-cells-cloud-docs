...
type: docs
url: /sv/specification/operation/postworkbooksettings/
description: Uppdatera inställning i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostWorkbookSettings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,Uppdatera inställning i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings\'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="inställningar,klass:arbetsbokinställningar,Arbetsbok Inställningsbeskrivning." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
