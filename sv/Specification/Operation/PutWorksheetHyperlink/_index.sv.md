...
type: docs
url: /sv/specification/operation/putworksheethyperlink/
description: Lägg till hyperlänk i kalkylbladet
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,PUT,Lägg till hyperlänk i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink\'>PutWorksheetHyperlink< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,Första raden i hyperlänksintervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,Första kolumnen i hyperlänkintervallet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,Antal rader i detta hyperlänksintervall." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Antal kolumner i detta hyperlänksintervall." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="adress, sträng, Adress till hyperlänken." >}} 
