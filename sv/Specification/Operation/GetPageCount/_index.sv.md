...
type: docs
url: /sv/specification/operation/getpagecount/
description: Få sidräkning i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/pagecount,GET,Hämta sidantal i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount\'>GetPageCount</a>" >}}
