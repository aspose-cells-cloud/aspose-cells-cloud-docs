...
type: docs
url: /sv/specification/operation/postprotect/
description: Excel filer kryptering
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostProtect
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/protect,POST,Excel filkryptering.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostProtect\'>PostProtect</a>" >}}
