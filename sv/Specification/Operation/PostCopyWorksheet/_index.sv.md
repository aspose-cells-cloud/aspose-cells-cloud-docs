...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,Kopiera innehåll och format från ett annat kalkylblad.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'> PostCopyWorksheet</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="källark, sträng, källark." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="källarbetsbok, sträng, källarbetsbok." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder,string,Original arbetsboksmapp." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:copyoptions,Representerar kopieringsalternativen." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
