---
title: PostUnhide WorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/postunhideworksheetcolumns/
description: Visa kalkylbladskolumner i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostUnhideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,Unhide kalkylbladskolumner i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostUnhideWorksheetColumns\'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,Startkolumnindex som ska användas." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totaltKolumner,heltal,Antal kolumner som ska användas." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,Hämtar och ställer in kolumnbredden i teckenenhet." >}} 
