---
title: GetWorksheetValidatio
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/getworksheetvalidation/
description: Hämta en validering genom dess index i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, GetWorksheetValidation
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetWorksheetValidation" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve a validation by its index in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},GET,Hämta en validering genom dess index i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/# /WorksheetValidations/GetWorksheetValidation\'>GetWorksheetValidation</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidationsController/GetWorksheetValidation\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
