...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/defaultstyle,GET,Hämta beskrivningen av standardstilen för arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookDefaultStyle\'>GetWorkbookDefaultStyle</a> a>" >}}
