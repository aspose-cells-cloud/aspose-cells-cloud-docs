...
type: docs
url: /sv/specification/operation/postworksheetpicture/
description: Uppdatera en bild efter index i kalkylbladet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},POST,Uppdatera en bild efter index i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ Pictures/PostWorksheetPicture\'>PostWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameternamn, typ, beskrivning" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="pictureIndex,integer,Bildens index." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="bild,klass:bild,Beskrivning av bildobjekt." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
