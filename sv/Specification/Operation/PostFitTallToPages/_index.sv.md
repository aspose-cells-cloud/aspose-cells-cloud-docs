...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/fittalltopages,POST,Ställ in skalan för vilken sidan ska passa hög när den skrivs ut på arket.,<a href=\'https://apireference.aspose.cloud /cells/#/PageSetup/PostFitTallToPages\'>PostFitTallToPages</a>" >}}
