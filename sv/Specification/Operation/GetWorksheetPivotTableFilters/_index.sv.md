...
type: docs
url: /sv/specification/operation/getworksheetpivottablefilters/
description: Får pivottabellfilter i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetWorksheetPivotTableFilters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters,GET,Hämtar pivottabellfilter i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /GetWorksheetPivotTableFilters\'>GetWorksheetPivotTableFilters</a>" >}}
