...
type: docs
url: /sv/specification/operation/getworkbooknames/
description: Hämta namngivna intervall i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetWorkbookNames
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,Hämta namngivna intervall i arbetsboken.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
