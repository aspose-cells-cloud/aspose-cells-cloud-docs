...
type: docs
url: /sv/specification/operation/getchartcategoryaxis/
description: Hämta beskrivningar av diagramserieaxeln i diagrammet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,GET,Hämta beskrivningar av diagramserieaxeln i diagrammet.,<a href=\'https://apireference.aspose.cloud/cells /#/Charts/GetChartCategoryAxis\'>GetChartCategoryAxis</a>" >}}
