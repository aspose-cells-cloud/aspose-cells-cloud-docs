...
type: docs
url: /sv/specification/operation/postconvertworkbooktomarkdown/
description: Konvertera Excel-filen till Markdown-filer
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostConvertWorkbookToMarkdown
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/markdown,POST,Konvertera Excel-fil till Markdown-filer.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToMarkdown\'>PostConvertWorkbookToMarkdown</a>" >}}
