...
type: docs
url: /sv/specification/operation/postprotectworkbook/
description: Excel skydd
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="protectWorkbookRequest,class:protectworkbookrequest,Skyddsinställningarna." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
