---
title: PutWorksheetCustomFilte
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/putworksheetcustomfilter/
description: Filtrera en lista med anpassade kriterier i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutWorksheetCustomFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/custom,PUT,Filtrera en lista med anpassade kriterier i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter /PutWorksheetCustomFilter\'>PutWorksheetCustomFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="range,string,Representerar intervallet som det angivna autofiltret gäller." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="fieldIndex,integer,Heltalsoffset för fältet som du vill basera filtret på (från vänster i listan; fältet längst till vänster är fält 0)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="operatorType1,string,Filteroperatortypen" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="criteria1,string,De anpassade kriterierna." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ärOch, boolesk, sant/falskt" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="operatorType2,string," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="criteria2,string,De anpassade kriterierna." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="matchBlanks,boolean, Matcha alla tomma celler i listan." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="uppdatera, boolesk, uppdatera automatiska filter för att dölja eller visa raderna." >}} 
