...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/rotate,POST,Rotera rader, kolumner eller andra objekt i Excel-filer och spara dem i olika format.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRotate\'> PostRotera</a>" >}}
