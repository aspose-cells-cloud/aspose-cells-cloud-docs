---
title: Get WorksheetConditional Formatting
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings,GET,Hämta beskrivningar av villkorlig formatering i ett kalkylblad.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings\' >GetWorksheetConditionalFormattings</a>" >}}
