...
type: docs
url: /sv/specification/operation/puthorizontalpagebreak/
description: Lägg till horisontella sidbrytningar i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,Lägg till horisontella sidbrytningar i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >PutHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="cellnamn, sträng, cellnamn" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startkolumn, heltal, startkolumnindex, nollbaserat." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer, End kolumnindex, nollbaserat." >}} 
