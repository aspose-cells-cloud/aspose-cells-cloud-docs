...
type: docs
url: /sv/specification/operation/getnamedranges/
description: Hämta beskrivningar av intervall i kalkylbladen
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetNamedRanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/ranges,GET,Hämta beskrivningar av intervall i kalkylbladen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges\'>GetNamedRanges</a >" >}}
