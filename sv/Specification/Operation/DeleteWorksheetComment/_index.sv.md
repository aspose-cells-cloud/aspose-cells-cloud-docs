---
title: Ta bortWorksheetCommen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetcomment/
description: Ta bort cellkommentar i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, Ta bort ArbetsbladKommentar
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},DELETE,Ta bort cellkommentar i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/ DeleteWorksheetComment\'>Ta bort WorksheetComment</a>" >}}
