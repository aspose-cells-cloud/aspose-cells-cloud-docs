---
title: Ta bort arbetsarkkolumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetcolumns/
description: Ta bort kalkylbladskolumner i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, Ta bort Arbetsarkkolumner
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},DELETE,Ta bort kalkylbladskolumner i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetColumns\'>DeleteWorksheetColumns</a>" >}}
