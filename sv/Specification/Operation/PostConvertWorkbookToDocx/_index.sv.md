...
type: docs
url: /sv/specification/operation/postconvertworkbooktodocx/
description: Konvertera Excel-filen till Docx-filer
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostConvertWorkbookToDocx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/docx,POST,Konvertera Excel-fil till Docx-filer.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx\'>PostConvertWorkbookToDocx</a>" >}}
