...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/copy,POST,Kopiera data och format från specifika hela rader i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetRows\'>PostCopyWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceRowIndex,integer,Källradindex" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destinationRowIndex,integer,Destinationsradindex" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowNumber,integer,Det kopierade radnumret" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="kalkylblad, sträng, kalkylbladets namn." >}} 
