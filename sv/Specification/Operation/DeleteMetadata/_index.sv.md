...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/delete,POST,Ta bort cellers dokumentegenskaper i Excel-filen och spara dem i olika format.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/DeleteMetadata\'>DeleteMetadata </a>" >}}
