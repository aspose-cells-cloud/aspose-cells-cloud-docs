...
type: docs
url: /sv/specification/operation/postchartcategoryaxis/
description: Uppdatera diagramkategoriaxel i diagrammet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,POST,Uppdatera diagramkategoriaxel i diagrammet.,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/PostChartCategoryAxis\'>PostChartCategoryAxis</a>" >}}
