---
title: Ta bortWorksheetPicture
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetpictures/
description: Ta bort alla bilder i arbetsbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, Ta bort WorksheetPictures
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,Ta bort alla bilder i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures\'>Ta bort WorksheetPictures </a>" >}}
