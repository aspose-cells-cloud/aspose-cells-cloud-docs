...
type: docs
url: /sv/specification/operation/gethorizontalpagebreaks/
description: Hämta beskrivningar av horisontella sidbrytningar i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, GetHorizontalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,Hämta beskrivningar av horisontella sidbrytningar i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks \'>GetHorizontalPageBreaks</a>" >}}
