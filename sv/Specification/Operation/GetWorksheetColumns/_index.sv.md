...
type: docs
url: /sv/specification/operation/getworksheetcolumns/
description: Hämta beskrivningar av kalkylbladskolumner
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,Hämta beskrivningar av kalkylbladskolumner.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\' >GetWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="offset,integer,The workdook-mapp." >}} 
