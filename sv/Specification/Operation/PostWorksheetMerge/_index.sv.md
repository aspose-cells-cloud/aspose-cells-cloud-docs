...
type: docs
url: /sv/specification/operation/postworksheetmerge/
description: Slå samman celler i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostWorksheetMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/merge,POST,Slå samman celler i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge\'> PostWorksheetMerge</a>" >}}
