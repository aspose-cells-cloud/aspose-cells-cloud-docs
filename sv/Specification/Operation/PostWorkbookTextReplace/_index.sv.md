...
type: docs
url: /sv/specification/operation/postworkbooktextreplace/
description: Byt ut text i arbetsboken
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostWorkbookTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,Det gamla värdet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,Det nya värdet." >}} 
