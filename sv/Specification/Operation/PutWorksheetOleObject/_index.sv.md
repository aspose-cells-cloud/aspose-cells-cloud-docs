...
type: docs
url: /sv/specification/operation/putworksheetoleobject/
description: Lägg till ett OLE-objekt i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, PutWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,PUT,Lägg till ett OLE-objekt i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/PutWorksheetOleObject\'> PutWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,integer,Övre vänstra radindex" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,integer,Övre vänstra kolumnindex" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="höjd,heltal,Höjd på oleObject, i pixelenhet" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,integer,Width of oleObject, i pixelenhet" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="oleFile, string, OLE filnamn sökväg (fullständigt filnamn)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="bildfil, sträng, sökväg för bildfilnamn (fullständigt filnamn)." >}} 
