---
title: Ta bortWorksheetRow
second_title: Aspose.Cells Cloud Documen
type: docs
url: /sv/specification/operation/deleteworksheetrows/
description: Ta bort flera rader i kalkylbladet
kwords: Excel, Office, Kalkylblad, Cloud REST API, DeleteWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,DELETE,Ta bort flera rader i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows \'>Ta bort arbetsbladsrader</a>" >}}
