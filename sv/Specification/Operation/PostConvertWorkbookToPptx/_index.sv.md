...
type: docs
url: /sv/specification/operation/postconvertworkbooktopptx/
description: Konvertera Excel-filen till Pptx-filer
kwords: Excel, Office, Kalkylblad, Cloud REST API, PostConvertWorkbookToPptx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pptx,POST,Konvertera Excel-fil till Pptx-filer.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx\'>PostConvertWorkbookToPptx</a>" >}}
