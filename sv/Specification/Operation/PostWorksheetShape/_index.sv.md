...
type: docs
url: /sv/specification/operation/postworksheetshape/
description: Uppdatera en form i kalkylbladet
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API referens" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},POST,Uppdatera en form i kalkylbladet.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ PostWorksheetShape\'>PostWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameternamn, typ, beskrivning" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dto,class:shape,Formbeskrivningen." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
