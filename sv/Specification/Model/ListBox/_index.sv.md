...
type: docs
url: /sv/specification/model/listbox/
description: "Aspose.Cells Molnmodellspecifikation: ListBox. Hantera enkelt Excel och andra kalkylarksdokument med funktioner som att öppna, generera, redigera, dela, slå samman, jämföra och konvertera"
weight: 50
---
## **listBox**
...
| Antal objekt| Heltal| Sann| Falsk|| Hämtar antalet objekt i listrutan.|
| Page Change| Heltal| Sann| Falsk|| Anger hur mycket kontrollens värde ändras när användaren klickar på rullningslistens sida upp eller sida ner region.|
| Valda celler| Behållare| Sann| Falsk|| Hämtar de markerade cellerna. Returnerar null om inmatningsintervallet inte är inställt eller inget objekt har valts|
...
| SelectionType| Sträng| Sann| Falsk|| Hämtar eller ställer in valläget för den angivna listrutan.|
