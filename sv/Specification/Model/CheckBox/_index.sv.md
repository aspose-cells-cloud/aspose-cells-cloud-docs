...
type: docs
url: /sv/specification/model/checkbox/
description: "Aspose.Cells Molnmodellspecifikation: CheckBox. Hantera enkelt Excel och andra kalkylarksdokument med funktioner som att öppna, generera, redigera, dela, slå samman, jämföra och konvertera"
kwords: Excel, Office, Kalkylblad, Cloud REST API, CheckBox
weight: 50
---
## **kryssruta**
...
|:- |:- |:- |:- |:- |:- |
| Checked Value| Sträng| Sann| Falsk|| Hämtar eller ställer in kryssrutans värde.|
| Skugga| Boolean| Sann| Falsk|| Indikerar om kombinationsrutan har 3D-skuggning.|
| Värde| Boolean| Sann| Falsk|| Indikerar om kryssrutan är markerad eller inte.|
