...
| PrecisionAsDisplayed| Boolean| Sann| Falsk|| Sant om beräkningar i den här arbetsboken kommer att göras med enbart precisionen av siffrorna när de visas|
...
| ReparationLadda| Boolean| Sann| Falsk|| Anger om programmet senast öppnade arbetsboken i säkert läge eller reparationsläge.|
