...
type: docs
url: /sv/specification/model/radiobutton/
description: "Aspose.Cells Molnmodellspecifikation: RadioButton. Hantera enkelt Excel och andra kalkylarksdokument med funktioner som att öppna, generera, redigera, dela, slå samman, jämföra och konvertera"
kwords: Excel, Office, Kalkylblad, Cloud REST API, RadioButton
weight: 50
---
## **Radio knapp**
...
|:- |:- |:- |:- |:- |:- |
| GroupBox| Klass:GroupBox| Sann| Falsk|| Får GroupBox som innehåller denna RadioButton.|
| Är kontrollerad| Boolean| Sann| Falsk|| Indikerar om radioknappen är markerad eller inte.|
