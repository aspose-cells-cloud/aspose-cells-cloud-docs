...
| Dataetiketter| Klass: LinkElement| Sann| Falsk|| Representerar DataLabels-objektet för den angivna ASerien.|
...
| DownBars| Klass: LinkElement| Sann| Falsk|| Returnerar ett objekt som representerar nedstaplarna på ett linjediagram. Gäller endast linjediagram.|
...
| LegendEntry| Klass: LinkElement| Sann| Falsk|| Får legendposten enligt denna serie.|
| Linje| Klass: Linje| Sann| Falsk|||
