...
type: docs
url: /sv/specification/model/picture/
description: "Aspose.Cells Molnmodellspecifikation: Bild. Hantera enkelt Excel och andra kalkylarksdokument med funktioner som att öppna, generera, redigera, dela, slå samman, jämföra och konvertera"
kwords: Excel, Office, Kalkylblad, Cloud REST API, Bild
weight: 50
---
## **bild**
...
|:- |:- |:- |:- |:- |:- |
| BorderLineColor| Klass: Färg| Sann| Falsk|| Representerar gränslinjen för en bild.|
| Kantvikt| Flytande| Sann| Falsk|| Hämtar eller ställer in vikten för en bilds kantlinje i enheter av pt.|
| Originalhöjd| Heltal| Sann| Falsk|| Får bildens ursprungliga höjd.|
| OriginalWidth| Heltal| Sann| Falsk|| Får bildens ursprungliga bredd.|
| Bildformat| Sträng| Sann| Falsk|||
| SourceFullName| Sträng| Sann| Falsk|| Hämtar eller ställer in sökvägen och namnet på källfilen för den länkade bilden.|
