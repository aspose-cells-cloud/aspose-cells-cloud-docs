...
type: docs
url: /sv/specification/model/button/
description: "Aspose.Cells Molnmodellspecifikation: Knapp. Hantera enkelt Excel och andra kalkylarksdokument med funktioner som att öppna, generera, redigera, dela, slå samman, jämföra och konvertera"
kwords: Excel, Office, Kalkylblad, Cloud REST API, Knapp
weight: 50
---
## **knapp**

 Representerar formulärkontroll:-knappen
