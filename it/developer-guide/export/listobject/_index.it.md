---
title: Esporta oggetto elenco
second_title: Aspose.Cells Cloud Documen
linktitle: Elenco ogg
type: docs
url: /it/export/excel-listobject-to-different-formats/
keywords: Export Excel list object to kinds of format files
description: Aspose.Cells Cloud REST API supporta l'esportazione di oggetti elenco Excel in tipi di file di formato. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 20
---
