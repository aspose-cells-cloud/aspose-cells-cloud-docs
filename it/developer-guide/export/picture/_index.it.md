...
description: Aspose.Cells Cloud REST API supporta l'esportazione di immagini Excel in tipi di file di formato. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 20
---
...
|:- |:- |:- |:- |
|/celle/esporta|INVIARE|Esporta oggetti Excel dal contenuto della richiesta in un formato|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
