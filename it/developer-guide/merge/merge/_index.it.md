...
linktitle: Multifile
type: docs
url: /it/merge/multi-files/
keywords: Merge multi Excel files into Excel file
description: Aspose.Cells Cloud REST API supporta l'unione di più file Excel nel file Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 32
---
...
| unisciInUnFoglio| booleano| domanda| Falso|
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostMerge) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
