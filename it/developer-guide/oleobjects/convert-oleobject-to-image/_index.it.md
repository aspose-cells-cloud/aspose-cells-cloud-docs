---
title: Converti oggetto OLE in immagine in un foglio di lavoro Excel
...
description: Aspose.Cells Cloud REST API supporta la conversazione di un oggetto OLE nell'immagine in un foglio di lavoro Excel. L'SDK supporta tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 40
---
Questo REST API indica `get OLE object` con il formato in un foglio di lavoro Excel.
...
| oggettoNumero| numero intero| sentiero| Il numero dell'oggetto.|
| formato| corda| domanda| Il formato dell'oggetto esportato.|
| cartella| corda| domanda| La cartella documenti.|
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/OleObjects/GetWorksheetOleObject) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
