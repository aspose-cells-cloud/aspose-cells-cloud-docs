...
description: Aspose.Cells Cloud REST API supporta l'aggiornamento di un oggetto OLE in un foglio di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 30
---
Questo REST API indica a `update` un `OLE object` in un foglio di lavoro Excel.
...
| oleObjectIndex| numero intero| sentiero| Indice oggetto vecchio|
| ole|| corpo| Oggetto antico|
| cartella| corda| domanda| La cartella della cartella di lavoro.|
| storageName| corda| domanda| nome di archiviazione.|
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/OleObjects/PostUpdateWorksheetOleObject) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
