...
description: Aspose.Cells Cloud REST API supporta l'ottenimento di un oggetto OLE in un foglio di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 10
---
Questo REST API indica a `get` un `OLE object` con formato in un foglio di lavoro Excel.
