---
title: Utilizzo di SaveResult Tas
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/tasks/save-result/
aliases: [/working-with-saveresult-task/]
keywords: REST API, task, save result, spreadsheets, exce
description: "Cells.Cloud API per Excel operare: attività di supporto per salvare il risultato nel contenuto della risposta o nel cloud storage"
weight: 50
---
## RIPOSO API
