...
description: "Cells.Cloud API per Excel operare: creare una tabella pivot utilizzando l'attività CellsObjectOperate"
weight: 10
---
Questo REST API crea `pivot table` utilizzando l'oggetto celle opera `task`.
