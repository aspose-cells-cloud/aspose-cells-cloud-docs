...
description: Aspose.Cells Cloud API supporta la conversione batch di più file excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 100
---
 Questo REST API indica a `batch conversion` di file idonei
...
------------ | ------------- | ------------- | -------------
 Cartella sorgente | stringa | | [opzionale]MatchCondition | MatchConditionRequest | | [opzionale]Formato | stringa | | [opzionale]OutFolder | stringa | | [opzionale]SalvaOpzioni | SalvaOpzioni | | [opzionale]**Proprietà MatchConditionRequest**
 
Nome | Tipo | Descrizione | Appunti
------------ | ------------- | ------------- | -------------
 Modello Regex | stringa | | [opzionale]FullMatchConditions | stringa[]| | [opzionale]Il[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/PostBatchConvert) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
