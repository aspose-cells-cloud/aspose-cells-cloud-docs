...
description: Aspose.Cells Cloud REST API supporta il trasferimento del foglio di lavoro in un formato diverso da un foglio di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 10
---
...
| verticalResolution| numero intero| domanda| Imposta la risoluzione verticale per le immagini generate, in punti per pollice.|
...
| paginaIndice| numero intero| domanda| Indice della pagina esportata.|
| cartella| corda| domanda| La cartella dei documenti.|
| storageName| corda| domanda| nome di archiviazione.|
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheet) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
