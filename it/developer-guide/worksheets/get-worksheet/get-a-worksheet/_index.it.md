---
title: Ottieni un foglio di lavoro da un foglio di lavoro Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Workshee
type: docs
url: /it/worksheets/get-worksheet/
keywords: Get worksheet to different format from an Excel worksheet
description: Aspose.Cells Cloud REST API supporta il trasferimento del foglio di lavoro in un formato diverso da un foglio di lavoro Excel. L'SDK supporta tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 10
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Ottieni foglio di lavoro da un foglio di lavoro Excel
---
Questo REST API indica `get worksheet description` o `export worksheet to kinds of format file`.
...
| formato| corda| domanda|Il formato del file esportato.|
| verticaleRisoluzione| numero intero| domanda| Imposta la risoluzione verticale per le immagini generate, in punti per pollice.|
| risoluzione orizzontale| numero intero| domanda| Imposta la risoluzione orizzontale per le immagini generate, in punti per pollice.|
| la zona| corda| domanda| Zona esportata.|
| paginaIndice| numero intero| domanda| Indice delle pagine esportate.|
| cartella| corda| domanda| La cartella documenti.|
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheet) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
