...
description: Aspose.Cells Cloud REST API supporta l'eliminazione di più fogli di lavoro Excel su una cartella di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 20
---
...
------------ | ------------- | ------------- | -------------
 Modello Regex | stringa | | [opzionale]FullMatchConditions | stringa[]| | [opzionale]Il[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
