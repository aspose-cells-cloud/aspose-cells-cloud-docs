---
title: Aspose.Cells Cloud Web API - Cerca contenuto nel foglio di calcolo remoto
second_title: Documen
ArticleTitle: Search Content in a Remote Spreadshee
linktitle: Cerca contenuto foglio di calcolo remoto
type: docs
...
description: Cerca in modo efficiente il testo in un foglio di calcolo remoto utilizzando Aspose.Cells API
weight: 100
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, JSON, Markdown, Trova tutte le celle vuote in un foglio di lavoro Excel, ricerca foglio di calcolo remoto, ricerca archiviazione cloud
---
Cerca il testo specificato in un foglio di calcolo remoto.

### **Cerca contenuto nel foglio di calcolo remoto API**
...
|ignorando il caso|Booleano|Domanda|Indica se ignorare la distinzione tra maiuscole e minuscole nella ricerca.|
|cartella|Corda|Domanda|Percorso della cartella in cui è archiviata la cartella di lavoro.|
|Nome di archiviazione|Corda|Domanda|(Facoltativo) Il nome dell'archiviazione cloud personalizzata. Se omesso, verrà utilizzato l'archiviazione predefinita.|
...
### Specifiche OpenAPI
 ...
 IL[Specifiche OpenAPI](https://reference.aspose.cloud/cells/#/SearchControllor/SearchContentInRemoteSpreadsheet) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
