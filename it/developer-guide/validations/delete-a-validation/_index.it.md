...
weight: 10
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Elimina una convalida del foglio di lavoro su un foglio di lavoro Excel
---
Questo REST API indica di eliminare una convalida del foglio di lavoro per indice su un foglio di lavoro Excel.
