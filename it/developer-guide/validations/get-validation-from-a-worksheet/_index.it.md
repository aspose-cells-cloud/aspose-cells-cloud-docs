---
title: Ottieni una convalida del foglio di lavoro per indice da un foglio di lavoro Excel
...
description: Aspose.Cells Cloud REST API supporta l'ottenimento di una convalida del foglio di lavoro per indice da un foglio di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 10
---
Questo REST API indica di ottenere una convalida del foglio di lavoro per indice su un foglio di lavoro Excel.
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidation) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
