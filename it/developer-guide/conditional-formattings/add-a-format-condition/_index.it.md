...
type: docs
url: /it/conditional-formattings/add-format-condition/
aliases: [/add-a-format-condition/]
keywords: REST API, spreadsheets, excel, add a format conditio
description: "Cells.Cloud API per Excel funziona: aggiungi una condizione di formato"
weight: 50
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Aggiungi condizione formato
---
Questo REST API indica Aggiungi una condizione di formato.
...
| cellArea| corda| domanda||
| tipo| corda| domanda||
| tipooperatore| corda| domanda||
| formula 1| corda| domanda||
| formula2| corda| domanda||
| cartella| corda| domanda||
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/PutWorksheetFormatCondition) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
