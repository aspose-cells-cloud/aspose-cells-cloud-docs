...
description: Il Aspose.Cells Cloud API supporta l'aggiunta di un filtro personalizzato su un foglio di lavoro Excel. L'SDK supporta tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 65
---
...
| tipooperatore1| corda| domanda||
| criteri1| corda| domanda||
| è e| booleano| domanda||
| operatorType2| corda| domanda||
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetCustomFilter) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
