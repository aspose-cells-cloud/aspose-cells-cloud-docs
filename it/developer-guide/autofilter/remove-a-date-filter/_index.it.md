...
| dateTimeGroupingType| corda| domanda||
| anno| numero intero| domanda|0 |
| mese| numero intero| domanda|0 |
| giorno| numero intero| domanda|0 |
| ora| numero intero| domanda|0 |
| minuto| numero intero| domanda|0 |
| secondo| numero intero| domanda|0 |
| cartella| corda| domanda||
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
