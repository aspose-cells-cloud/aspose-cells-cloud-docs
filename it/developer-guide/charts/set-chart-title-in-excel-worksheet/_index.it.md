---
title: Imposta il titolo del grafico in Excel Foglio di lavoro
type: docs
url: /it/chart/title/add/
aliases: [/set-chart-title-in-excel-worksheet/]
weight: 30
---
Questo REST API indica di aggiungere il titolo del grafico / impostare il titolo del grafico visibile
...
| titolo|| corpo| Titolo grafico.|
| cartella| corda| domanda| La cartella della cartella di lavoro.|
| storageName| corda| domanda| nome di archiviazione.|

<br/>
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartTitle) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
