...
| chartType| corda| domanda| Tipo di grafico, fare riferimento alla proprietà Tipo nella risorsa grafico.|
...
| NomeTabellaPivot| corda| domanda||
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetAddChart) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
