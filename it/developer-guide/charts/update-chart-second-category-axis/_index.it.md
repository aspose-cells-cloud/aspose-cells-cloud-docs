---
title:  Aggiornamento Grafico Asse Seconda Categoria
type: docs
...
| chartIndex| numero intero| sentiero||
| asse|| corpo||
| cartella| corda| domanda||
| storageName| corda| domanda||
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondCategoryAxis) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
