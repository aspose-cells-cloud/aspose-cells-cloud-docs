---
title:  Aggiorna Grafico Seconda Categoria Axi
type: docs
url: /it/charts/second-category-axis/update/
weight: 160
---
 Questo REST API indica Aggiorna grafico secondo asse di categoria.
...
| storageName| corda| domanda||
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondCategoryAxis) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
