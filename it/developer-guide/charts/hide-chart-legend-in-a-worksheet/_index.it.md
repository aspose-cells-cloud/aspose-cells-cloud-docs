...
weight: 110
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Nascondi legenda del grafico in un foglio di lavoro
---
Questo REST API indica la legenda nascosta nel grafico
...
<br/>
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChartLegend) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
