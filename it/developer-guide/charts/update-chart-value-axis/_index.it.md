---
title:  Aggiorna valore grafico Axi
type: docs
url: /it/charts/value-axis/update/
weight: 160
---
 Questo REST API indica Aggiorna asse valore grafico.
...
| storageName| corda| domanda||
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartValueAxis) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
