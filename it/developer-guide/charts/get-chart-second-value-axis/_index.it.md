---
title:  Ottieni grafico Secondo valore Axi
type: docs
url: /it/charts/second-value-axis/get/
weight: 60
---
 Questo REST API indica Get Chart Second Value Axis.
...
| storageName| corda| domanda||
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondValueAxis) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
