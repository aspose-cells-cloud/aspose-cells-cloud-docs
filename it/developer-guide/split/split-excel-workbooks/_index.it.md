...
description: Aspose.Cells Cloud REST API supporta la suddivisione di una cartella di lavoro Excel in più file. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 130
---
...
|da|numero intero|Inizia l'indice del foglio di lavoro.|
|A|numero intero|Fine indice del foglio di lavoro.|
|risoluzione orizzontale|numero intero|Risoluzione orizzontale dell'immagine.|
|verticalResolution|numero intero|Risoluzione verticale dell'immagine.|
...
|:- |:- |:- |:- |
|/cells/{nome}/split|INVIARE|Dividi una cartella di lavoro Excel|[PostWorkbookDividi](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit)|

 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
