...
description: Scopri come ottenere il file dalla cartella con Aspose Cells Cloud REST API L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 100
---
...
| storageName| corda| domanda| Nome di archiviazione|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Folder/GetFilesList) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
