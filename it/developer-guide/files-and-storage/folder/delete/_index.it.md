...
type: docs
url: /it/folder/delete/
keywords: Learn how to delete folder with Aspose Cells Cloud REST API
description: Scopri come eliminare la cartella con Aspose Cells Cloud REST API L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 100
---
...
|:- |:- |:- |:- |
| sentiero| corda| sentiero| Percorso della cartella, ad es. "/cartella"|
| storageName| corda| domanda| Nome di archiviazione|
| ricorsivo| booleano| domanda| Falso|

 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Folder/DeleteFolder) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
