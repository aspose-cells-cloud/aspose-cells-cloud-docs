---
title: Aspose.Cells Cloud Web API - Converti i dati di una tabella di un foglio di calcolo in un file JSON
second_title: Documen
ArticleTitle: Convert a Spreadsheet Table data to a Json file
linktitle: Converti tabella in JSO
type: docs
url: /it/convert-table-to-json/
keywords: Excel API, JSON conversion, spreadsheet to JSON, cloud file conversion, REST API, Aspose.Cell
description: Convertire in modo efficiente una tabella di foglio di calcolo locale in formato JSON utilizzando Excel API. Questo metodo consente l'elaborazione fluida dei file senza la necessità di archiviazione cloud
weight: 100
kwords: Excel API, conversione JSON, conversione file cloud, foglio di calcolo, REST API, Aspose.Cells, elaborazione unità locale, conversione formato file
---
Converti un foglio di calcolo locale/tabella Excel in un file json con Aspose.Cells Cloud Web API.

## **Converti tabella in JSON API**
...
| foglio di lavoro|Corda| Domanda| Specificare il nome del foglio di lavoro del foglio di calcolo.|
| nometabella|Corda| Domanda| Fornire il nome della tabella da convertire.|
...
| fontPosizione|Corda| Domanda| Utilizza font personalizzati per la conversione.|
| regione|Corda| Domanda|Definisci le impostazioni regionali per il foglio di calcolo.|
...
## Perché dovresti usare Convert Table to Json API?
...
### Converti tabella in JSON API Specifiche

 IL[Converti tabella in JSON API Specifiche](https://reference.aspose.cloud/cells/#/ConversionController/ConvertTableToJson) fornisce un'interfaccia di programmazione accessibile al pubblico, consentendo interazioni REST direttamente da un browser web.

### Utilizzare gli SDK cloud Aspose.Cells

Utilizzare l'SDK è il modo più rapido per sviluppare, poiché astrae i dettagli di basso livello, consentendo di convertire i dati di una tabella di un foglio di calcolo in un file JSON con codice breve.
