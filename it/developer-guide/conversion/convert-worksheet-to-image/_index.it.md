---
title: Aspose.Cells Cloud Web API - Converti un foglio di calcolo in un'immagine
...
description: Convertire in modo efficiente un foglio di calcolo da un'unità locale in vari formati di immagine utilizzando Aspose.Cells API
weight: 100
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, Conversione immagini, SVG, PNG, TIFF, Servizi cloud, Conversione da locale a cloud, Abbina tutte le celle vuote in un foglio di lavoro Excel
---
Converti un foglio di calcolo locale/foglio di lavoro Excel in un'immagine.

## **Converti foglio di lavoro in immagine API**
...
| formato| Corda| Domanda| Formato immagine desiderato: svg, png, tiff, ecc.|
...
### Converti tabella in immagine API Specifiche
 ...
 IL[Converti tabella in immagine API Specifiche](https://reference.aspose.cloud/cells/#/ConversionController/ConvertWorksheetToImage) definisce un'interfaccia di programmazione accessibile al pubblico e consente interazioni REST direttamente da un browser web.
