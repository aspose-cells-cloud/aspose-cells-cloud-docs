---
title: Importa la matrice di stringhe nel foglio di lavoro Excel
...
weight: 40
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Importa array di stringhe nel foglio di lavoro Excel
---
Questo REST API `import string array data` nel foglio di lavoro Excel.

La richiesta è una richiesta HTTP con contenuto in più parti (vedi[RFC2046](http://tools.ietf.org/html/rfc2046#page-17)O[RFC1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). La prima parte del contenuto in più parti contiene i dati ImportStringArrayOption e la seconda contiene un file di dati.
