---
title: Importa 2 Dimension Integer Array in Excel Workshee
second_title: Aspose.Cells Cloud Documen
linktitle: Importa un numero intero a 2 dimensioni arra
type: docs
...
description: Aspose.Cells Cloud REST API supporta l'importazione di dati di array interi a 2 dimensioni in file Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 20
---
Questo REST API `import 2 dimension integer array data` nel foglio di lavoro Excel.

La richiesta è una richiesta HTTP con contenuto in più parti (vedi[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)O[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). La prima parte del contenuto multiparte contiene i dati Import2DimensionIntegerArrayOption e la seconda contiene un file di dati.
