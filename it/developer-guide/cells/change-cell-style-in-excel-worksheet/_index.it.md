---
title: Cambia lo stile della cella nel foglio di lavoro Excel
type: docs
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUpdateWorksheetCellStyle) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
