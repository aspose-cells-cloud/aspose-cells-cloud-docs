---
title: Imposta la formula per una cella nel foglio di lavoro Excel
type: docs
url: /it/set-formula-for-a-cell-in-excel-worksheets/
weight: 80
---
Questo REST API indica il set `cell formula` in un file Excel.
...
| formula| corda| domanda| Formula per cella|
| cartella| corda| domanda| La cartella dei documenti.|
| storageName| corda| domanda| nome di archiviazione.|
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetCellSetValue) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
