...
weight: 60
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Ottieni MergedCell da un foglio di lavoro
---
Questo REST API indica ottenere `merged cell` in un file Excel.
...
| nomefoglio| corda| sentiero| Il nome della scheda di lavoro.|
| cartella| corda| domanda| Cartella documenti.|
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetMergedCells) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
