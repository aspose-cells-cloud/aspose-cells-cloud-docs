---
title: Ottieni MinDataRow da Excel Workshee
type: docs
url: /it/get-mindatarow-from-excel-worksheet/
weight: 90
---
Questo REST API indica che gli spettacoli ottengono un `mindatarow` in un file Excel quando il parametro `cellOrMethodName` è `mindatarow`.
