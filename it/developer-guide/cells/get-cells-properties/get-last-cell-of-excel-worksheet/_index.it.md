---
title: Ottieni l'ultima cella di Excel Foglio di lavoro
type: docs
url: /it/get-last-cell-of-excel-worksheet/
weight: 30
---
Questo REST API indica che gli spettacoli ottengono un `endcell` in un file Excel quando il parametro `cellOrMethodName` è `endcell`.
