---
title: Ottieni MinRow da Excel Workshee
type: docs
url: /it/get-minrow-from-excel-worksheet/
weight: 80
---
Questo REST API indica che gli spettacoli ottengono un `minrow` in un file Excel quando il parametro `cellOrMethodName` è `minrow`.
