---
title: Ottieni MaxDataRow da Excel Workshee
type: docs
url: /it/get-maxdatarow-from-excel-worksheet/
weight: 50
---
Questo REST API indica che gli spettacoli ottengono un `maxdatarow` in un file Excel quando il parametro `cellOrMethodName` è `maxdatarow`.
