---
title: Ottieni MaxDataColumn da Excel Workshee
type: docs
url: /it/get-maxdatacolumn-from-excel-worksheet/
weight: 70
---
Questo REST API indica che gli spettacoli ottengono un `maxdatacolumn` in un file Excel quando il parametro `cellOrMethodName` è `maxdatacolumn`.
