---
title: Ottieni MaxRow da Excel Workshee
type: docs
url: /it/get-maxrow-from-excel-worksheet/
weight: 40
---
Questo REST API indica che gli spettacoli ottengono un `maxrow` in un file Excel quando il parametro `cellOrMethodName` è `maxrow`.
