---
title: Ottieni MinDataColumn da Excel Workshee
type: docs
url: /it/get-mindatacolumn-from-excel-worksheet/
weight: 110
---
Questo REST API indica che gli spettacoli ottengono un `mindatacolumn` in un file Excel quando il parametro `cellOrMethodName` è `mindatacolumn`.
