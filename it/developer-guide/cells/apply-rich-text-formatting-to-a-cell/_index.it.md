---
title: Applicare la formattazione Rich Text a un Cel
type: docs
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
