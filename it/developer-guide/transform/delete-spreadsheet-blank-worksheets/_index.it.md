---
title: Aspose.Cells Cloud Web API - Elimina fogli di lavoro vuoti nel foglio di calcolo
second_title: Documen
ArticleTitle: Delete Blank Worksheets in a Spreadshee
linktitle: Elimina foglio di lavoro vuoto
type: docs
...
description: Elimina in modo efficiente tutti i fogli di lavoro vuoti da un foglio di calcolo che non contengono dati o oggetti. Ottimizza la tua cartella di lavoro per prestazioni migliori.
weight: 100
kwords: Excel, Office Cloud, REST, Foglio di calcolo, PDF, CSV, JSON, Markdown
---
Eliminare tutti i fogli di lavoro vuoti che non contengono dati o altri oggetti da un foglio di calcolo Excel.

## **EliminaFoglio di calcoloFogli di lavoro vuoti API**
...
|:- |:- |:- |:- |
| Foglio di calcolo| File| FormData| Carica il file del foglio di calcolo da pulire.|
...
## Dove dovremmo usare il foglio di calcolo Elimina fogli di lavoro vuoti API?

Quando è necessario trasformare i dati, è possibile utilizzare questo API.

## Perché dovresti usare Delete Spreadsheet Blank Worksheets API?

- Elimina rapidamente tutti i fogli di lavoro vuoti che non contengono dati o altri oggetti da un foglio di calcolo Excel.
- Lo sviluppo può essere completato rapidamente tramite l'SDK esistente.

## Come utilizzare i fogli di lavoro vuoti Elimina foglio di calcolo API con SDK

### Elimina fogli di calcolo vuoti Fogli di lavoro API Specifiche

 IL[Elimina fogli di calcolo vuoti Fogli di lavoro API Specifiche](https://reference.aspose.cloud/cells/#/TransformController/DeleteSpreadsheetBlankWorksheets) definisce un'interfaccia di programmazione accessibile al pubblico, che consente di eseguire interazioni REST direttamente da un browser web.

### Utilizzare gli SDK cloud Aspose.Cells

Utilizzare l'SDK è il modo più rapido per sviluppare, poiché astrae i dettagli di basso livello, consentendo di eliminare i fogli di lavoro vuoti del foglio di calcolo con codice breve.
