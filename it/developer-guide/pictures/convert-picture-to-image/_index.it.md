---
title: Ottieni una foto in un fil Excel
...
description: Aspose.Cells Cloud REST API supporta l'acquisizione di un'immagine in un file Excel. L'SDK supporta tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 10
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdwon, Ottieni un'immagine in un file Excel
---
Questo REST API indica l'indice `get` immagine per immagine da un foglio di lavoro Excel.
...
| immagineIndice| numero intero| sentiero| L'indice delle immagini.|
| formato| corda| domanda| Il formato dell'oggetto esportato.|
| cartella| corda| domanda| La cartella documenti.|
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
