---
title: Aggiorna foto in un Excel fil
...
description: Aspose.Cells Cloud REST API supporta l'aggiornamento di un'immagine in un file Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 70
---
Questo REST API indica `update` immagine per indice immagine per un foglio di lavoro Excel.
...
| immagineIndice| numero intero| sentiero| L'indice dell'immagine.|
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
