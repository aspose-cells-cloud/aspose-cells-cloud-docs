---
title: Aggiorna l'immagine in un fil Excel
...
| immagineIndice| numero intero| sentiero| Indice dell'immagine.|
| immagine|| corpo| Oggetto immagine|
| cartella| corda| domanda| La cartella documenti.|
| storageName| corda| domanda| nome dell'archivio.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
