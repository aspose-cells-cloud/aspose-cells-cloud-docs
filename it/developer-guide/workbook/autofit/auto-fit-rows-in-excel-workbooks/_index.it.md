---
title: Righe di adattamento automatico su un workboo Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Riga
type: docs
url: /it/workbook/autofit/rows/
aliases: [/auto-fit-rows-in-excel-workbooks/]
keywords: Autofit rows on an Excel workboo
description: Aspose.Cells Cloud REST API supporta l'adattamento automatico delle righe su una cartella di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 90
---
...
| autoFitterOptions|| corpo| Opzioni di montaggio automatico.|
| startRow| numero intero| domanda| Inizia fila.|
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookRows) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
