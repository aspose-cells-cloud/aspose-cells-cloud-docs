...
description: Aspose.Cells Cloud REST API come creare una cartella di lavoro Excel da un modello di marcatore intelligente. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 30
---
...
|:- |:- |:- |:- |
|/celle/{nome}|METTERE|Crea una nuova cartella di lavoro Excel da un file modello|[Put Cartella di lavoro Crea](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate)|
