---
title: Separa le colonne su un foglio di lavoro Excel
...
description: Aspose.Cells Cloud REST API supporta la separazione della colonna in un foglio di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 70
---
Questo REST API indica separare le colonne del foglio di lavoro.
...
| firstIndex| numero intero| domanda| Il primo indice di colonna da utilizzare.|
| lastIndex| numero intero| domanda| L'ultimo indice di colonna da utilizzare.|
| cartella| corda| domanda| La cartella dei documenti.|
| storageName| corda| domanda| nome di archiviazione.|


 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
