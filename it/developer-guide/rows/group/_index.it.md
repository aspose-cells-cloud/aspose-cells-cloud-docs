---
title: Righe di gruppo su un foglio di lavoro Excel
...
description: Aspose.Cells Cloud REST API supporta il raggruppamento di righe in un foglio di lavoro Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 60
---
Questo REST API indica di raggruppare le righe in un foglio di lavoro Excel.
...
| firstIndex| numero intero| domanda| Il primo indice di riga da utilizzare.|
| lastIndex| numero intero| domanda| L'ultimo indice di riga da utilizzare.|
| nascondere| booleano| domanda| righe stato visibile|
| cartella| corda| domanda| La cartella dei documenti.|
| storageName| corda| domanda| nome di archiviazione.|
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
