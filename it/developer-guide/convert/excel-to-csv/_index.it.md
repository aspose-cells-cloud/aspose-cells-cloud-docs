...
[PUT /celle/convert](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook) API ti consente di convertire il file MS Excel in un file CSV con impostazioni aggiuntive e salvare il risultato nella risposta.

Questo file Excel REST API `export` in CSV.

[OTTIENI /cells/{nome}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API ti consente di convertire il file MS Excel in un file CSV con impostazioni aggiuntive e salvare il risultato nella risposta.
