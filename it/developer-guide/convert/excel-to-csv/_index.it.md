...
type: docs
url: /it/convert/excel-to-csv/
aliases: [/convert-excel-file-to-csv-in-cloud/]
keywords: Convert excel files to csv files
description: Aspose.Cells Cloud REST API supporta la conversione di file excel in file csv. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 90
---
Questo file excel REST API `saveas` in CSV.

[POST /cells/{nome}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API consente di salvare il file MS Excel come file CSV con impostazioni aggiuntive e salvare il risultato nella memoria.

Questo file excel REST API `convert` in CSV.

[PUT /celle/converti](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook) API consente di convertire il file MS Excel in un file CSV con impostazioni aggiuntive e di salvare il risultato nella risposta.

Questo file excel REST API `export` in CSV.

[OTTIENI /celle/{nome}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API consente di convertire il file MS Excel in un file CSV con impostazioni aggiuntive e di salvare il risultato nella risposta.
