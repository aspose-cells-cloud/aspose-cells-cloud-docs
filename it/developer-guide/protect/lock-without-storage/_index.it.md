...
description: Aspose.Cells Cloud REST API supporta il blocco dei file Excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 70
---
...
| parola d'ordine| corda| domanda||
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostLock) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
