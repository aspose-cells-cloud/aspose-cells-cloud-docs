...
linktitle: Proteggi senza utilizzare storage
type: docs
...
| proteggereWorkbookRequest| classe| formData| Proteggi richiesta cartella di lavoro|
 
 IL[Specifiche OpenAPI](https://reference.aspose.cloud/cells/#/LightCells/PostProtect) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
