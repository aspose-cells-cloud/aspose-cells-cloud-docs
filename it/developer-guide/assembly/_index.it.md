...
description: Aspoe.Cells Cloud genera report in file XLS, XLSX, XLSM, XLSB e ODS utilizzando il modello e il foglio dati. Elabora gli indicatori intelligenti nel modello per riempire i dati da un altro foglio dati. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 40
---
...
| formato| corda| domanda| Xlsx|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/LiteCells/PostAssemble) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
