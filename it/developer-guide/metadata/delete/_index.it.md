...
linktitle: Elimina senza usare storage
type: docs
url: /it/metadata/delete/
keywords: Deleting metadata from Excel files
description: Aspose.Cells Cloud REST API supporta l'eliminazione dei metadati dai file excel. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 55
---
...
| tipo| corda| domanda| Tutto|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/DeleteMetadata) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
