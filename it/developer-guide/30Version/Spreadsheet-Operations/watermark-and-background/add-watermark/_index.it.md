---
title: Aggiungi filigrana nel file Excel
second_title: Documen
linktitle: Aggiungi filigrana al file Excel
type: docs
url: /it/add-watermark-into-excel-files/
aliases: [ /watermark/]
keywords: Add water marker for Excel files
description: Aspose.Cells Cloud REST API supporta l'aggiunta di watermarker per i file Excel. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 39
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Filigrana
---
Questo REST API indica di aggiungere `watermark` ai file Excel.
...
| colore| corda| domanda||
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
