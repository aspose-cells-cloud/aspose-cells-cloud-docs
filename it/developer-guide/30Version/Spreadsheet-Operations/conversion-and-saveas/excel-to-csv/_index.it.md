...
---
Questo REST API indica a `convert` un file di foglio di calcolo in un file in formato csv.
...
|:- |:- |:- |:- |
|/cellule/converti/csv|INVIARE|Converti un foglio di calcolo in un file csv.|[PostConvertWorkbookToCSV](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV)|

 IL[Specifiche OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
