...
weight: 90
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Excel in Docx
---
Questo REST API indica a `convert` un file di foglio di calcolo in un file in formato docx.
...
|:- |:- |:- |:- |
|/cellule/converti/docx|INVIARE|Convertire un foglio di calcolo in un file docx.|[PostConvertWorkbookToDocx](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx)|

 IL[Specifiche OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
...
[GET /cells/{name}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API consente di convertire il file MS Excel in un file CSV con impostazioni aggiuntive e di salvare il risultato nella risposta.
