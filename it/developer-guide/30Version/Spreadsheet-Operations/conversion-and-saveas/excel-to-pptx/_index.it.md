...
description: Aspose.Cells Cloud REST API supporta la conversione di file Excel in file PPTX. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 90
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Excel in Pptx
---
Questo REST API indica a `convert` un file di foglio di calcolo in un file in formato pptx.
...
|:- |:- |:- |:- |
|/cellule/converti/pptx|INVIARE|Convertire un foglio di calcolo in un file pptx.|[PostConvertWorkbookToPptx](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx)|

 IL[Specifiche OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
...
[POST /cells/{name}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API consente di salvare il file MS Excel come file Docx con impostazioni aggiuntive e di salvare il risultato nell'archivio.

Questo file Excel REST API `convert` in Docx.

[METTI /celle/converti](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook) API consente di convertire il file MS Excel in un file Docx con impostazioni aggiuntive e di salvare il risultato nella risposta.

Questo file Excel REST API `export` in Docx.

[GET /cells/{name}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API consente di convertire il file MS Excel in un file Docx con impostazioni aggiuntive e di salvare il risultato nella risposta.
