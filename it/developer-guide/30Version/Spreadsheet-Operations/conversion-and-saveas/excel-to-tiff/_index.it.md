...
[POST /cells/{name}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API consente di salvare il file MS Excel come file TIFF con impostazioni aggiuntive e di salvare il risultato nell'archivio.
...
[GET /cells/{name}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API consente di convertire il file MS Excel nel file TIFF con impostazioni aggiuntive e di salvare il risultato nella risposta.
