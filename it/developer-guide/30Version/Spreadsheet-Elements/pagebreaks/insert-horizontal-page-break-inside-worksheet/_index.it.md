...
weight: 30
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Aggiungi interruzione di pagina orizzontale
---
...
| nome della cella| corda| domanda||
| riga| intero| domanda||
| colonna| intero| domanda||
| colonna di inizio| intero| domanda||
| colonna finale| intero| domanda||
| cartella| corda| domanda||
| Nome di archiviazione| corda| domanda| nome di archiviazione.|

 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
