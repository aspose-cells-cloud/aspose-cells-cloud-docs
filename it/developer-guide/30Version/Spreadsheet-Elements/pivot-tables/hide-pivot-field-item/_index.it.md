...
description: Aspose.Cells Cloud REST API supporta l'occultamento di un campo pivot nella tabella pivot. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 110
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Nascondi elemento campo pivot in una tabella pivot
---
Questo REST API indica che l'elemento del campo pivot è nascosto.
...
| Indiceelemento| intero| domanda||
| èNascondi| booleano| domanda||
| bisogno di ricalcolare| booleano| domanda|Falso|
| cartella| corda| domanda||
| Nome di archiviazione| corda| domanda| nome di archiviazione.|
 
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldHideItem) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
