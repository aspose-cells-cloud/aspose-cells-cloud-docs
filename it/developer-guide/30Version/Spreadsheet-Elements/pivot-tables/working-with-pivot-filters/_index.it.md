...
description: Aspose.Cells Cloud REST API supporta l'aggiunta di filtri per una tabella pivot. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 50
