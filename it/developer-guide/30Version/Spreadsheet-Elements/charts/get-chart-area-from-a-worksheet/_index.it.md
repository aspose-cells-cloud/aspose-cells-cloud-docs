...
keywords:
  ...
  - "SDK"
  - "GetChartArea"
description: "Scopri come recuperare le informazioni sull’area del grafico da un foglio di lavoro utilizzando l’API REST di Aspose.Cells Cloud, con esempi per cURL e diversi SDK."
ArticleTitle: "Ottieni l'area del grafico da un foglio di lavoro - Aspose.Cells Cloud API"
---

Questa REST API restituisce le informazioni sull’area del grafico.

**Prerequisiti:** Per chiamare questo endpoint è necessario disporre di un token di accesso JWT valido, il foglio di lavoro di destinazione deve essere caricato nell’archivio cloud di Aspose Cloud e il formato del file deve essere supportato da Aspose.Cells.

**Contesto:** L’area del grafico definisce il riquadro esterno più ampio di un grafico Excel, inclusi titoli, legende e area di tracciato. Recuperarne le proprietà consente di regolare in modo programmatico il layout e lo stile.
...
| -------------- | ------- | --------- | ------------------------------------------------- |
| name           | string  | path      | Nome del file del foglio di lavoro.               |
...
| folder         | string  | query     | Cartella in cui è archiviato il foglio di lavoro. |
...
## Come utilizzare l’API GetChartArea con gli SDK

### Specifica dell’API GetChartArea

La <a href="https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea" target="_blank" rel="noopener noreferrer">Specifica OpenAPI</a> definisce un’interfaccia di programmazione pubblicamente accessibile e consente di effettuare direttamente interazioni REST da un browser web.
...
Utilizzare un SDK è il modo migliore per velocizzare lo sviluppo. Un SDK gestisce i dettagli di basso livello e ti consente di concentrarti sulle attività del tuo progetto. Consulta il <a href="https://github.com/aspose-cells-cloud" target="_blank" rel="noopener noreferrer">repository GitHub</a> per un elenco completo degli SDK di Aspose.Cells Cloud.
...
**Richiesta HTTP generica (ad esempio, utilizzando fetch):**
