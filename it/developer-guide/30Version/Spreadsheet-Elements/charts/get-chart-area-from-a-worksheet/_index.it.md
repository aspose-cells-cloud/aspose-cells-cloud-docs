...
weight: 60
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Ottieni l'area del grafico da un foglio di lavoro
---
Questo REST API indica di ottenere informazioni sull'area del grafico.
...
<br/>
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
