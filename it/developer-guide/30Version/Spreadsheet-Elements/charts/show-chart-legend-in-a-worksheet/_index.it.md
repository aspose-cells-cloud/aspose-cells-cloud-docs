...
weight: 100
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Mostra legenda grafico in un foglio di lavoro
---
Questo REST API indica di mostrare la legenda nel grafico
...
| Nome di archiviazione| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartLegend) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
