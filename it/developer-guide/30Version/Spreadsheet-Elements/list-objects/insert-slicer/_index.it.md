...
weight: 20
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Slicer di inserimento di oggetti elenco
---
Questo REST API indica l'inserimento dell'affettatrice per l'oggetto elenco su un foglio di lavoro Excel.
