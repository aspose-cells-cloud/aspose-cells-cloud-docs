...
weight: 30
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Adatta automaticamente una riga su un foglio di lavoro Excel
---
...
| indice di riga| intero| domanda| L'indice di riga.|
| prima colonna| intero| domanda| Indice della prima colonna.|
| ultima colonna| intero| domanda| L'indice dell'ultima colonna.|
|[autoFitterOptions](/cells/it/auto-fitter-options) | oggetto| corpo| Le opzioni di Auto Fitter.|
