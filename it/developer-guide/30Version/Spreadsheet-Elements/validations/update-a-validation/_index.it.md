---
title: Aggiornare la convalida di un foglio di lavoro su un foglio di lavoro Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Aggiornamento
type: docs
url: /it/validations/update/
keywords: Delete a worksheet validation on an Excel worksheet
description: Aspose.Cells Cloud REST API supporta l'eliminazione della convalida di un foglio di lavoro su un foglio di lavoro Excel. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 10
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Aggiorna la convalida di un foglio di lavoro su un foglio di lavoro Excel
---
Questo REST API indica di aggiornare la convalida del foglio di lavoro tramite indice su un foglio di lavoro Excel.
...
| Nome di archiviazione| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
