---
title: Ottieni MinDataRow dal foglio di lavoro Excel
type: docs
url: /it/get-mindatarow-from-excel-worksheet/
weight: 90
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Ottieni MinDataRow dal foglio di lavoro Excel
---
Questo REST API indica che viene ottenuto un `mindatarow` in un file Excel quando il parametro `cellOrMethodName` è `mindatarow`.
