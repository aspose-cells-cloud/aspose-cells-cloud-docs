...
| Nome foglio| corda| sentiero| Il foglio di lavoro bame.|
...
|:- |:- |:- |:- |
|/cells/{name}/worksheets/{sheetName}/cells/rows|INVIARE|Elimina righe da un foglio di lavoro Excel|[EliminaRigheFoglioDiLavoro](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows)|
