...
description: "Cells.Cloud API per Excel operare: ottenere un commento"
weight: 10
---
Questo REST API indica Ottieni il commento del foglio di lavoro in base al nome della cella.
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComment) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
