...
description: "Cells.Cloud API per Excel operare: eliminare un commento"
weight: 40
---
Questo REST API indica Elimina il commento della cella del foglio di lavoro.
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComment) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
