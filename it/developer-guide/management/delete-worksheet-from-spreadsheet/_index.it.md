---
title: Aspose.Cells Cloud Web API - Elimina un foglio di lavoro dal foglio di calcolo
second_title: Documen
ArticleTitle: Delete a worksheet from the Spreadshee
linktitle: Elimina il foglio di lavoro dal foglio di calcolo
type: docs
...
description: Questo endpoint API consente agli utenti di eliminare un foglio di lavoro specificato da una cartella di lavoro, semplificando la gestione delle strutture della cartella di lavoro eliminando i fogli di lavoro non necessari o ridondanti
weight: 100
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, JSON, Markdown, Gestisci fogli di lavoro Excel, Elimina fogli di lavoro ridondanti
---
Eliminare un foglio di lavoro da un foglio di calcolo.

## **Elimina il foglio di lavoro dal foglio di calcolo API**
...
| Nome foglio| Corda| Domanda| Specifica il nome o l'identificativo del foglio di lavoro da eliminare. Questo parametro è obbligatorio e deve corrispondere al nome di un foglio di lavoro esistente nella cartella di lavoro.|
...
## Dove dovremmo usare il foglio di lavoro Elimina dal foglio di calcolo API?

Quando devi eliminare un foglio di lavoro dai fogli di calcolo, puoi utilizzare questo API.

## Perché dovresti usare il foglio di lavoro Elimina dal foglio di calcolo API?

- Rimuovi rapidamente i fogli di lavoro dai fogli di calcolo.
- Lo sviluppo può essere completato rapidamente tramite l'SDK esistente.

## Come utilizzare il foglio di lavoro Elimina dal foglio di calcolo API con gli SDK

### Elimina il foglio di lavoro dal foglio di calcolo API Specifiche

 IL[Elimina il foglio di lavoro dal foglio di calcolo API Specifiche](https://reference.aspose.cloud/cells/#/ManagementController/DeleteWorksheetFromSpreadsheet) definisce un'interfaccia di programmazione accessibile al pubblico, che consente di eseguire interazioni REST direttamente da un browser web.

### Utilizzare gli SDK cloud Aspose.Cells

Utilizzare l'SDK è il modo più rapido per sviluppare, poiché astrae i dettagli di basso livello, consentendo di eliminare un foglio di lavoro dal foglio di calcolo con un codice breve.
