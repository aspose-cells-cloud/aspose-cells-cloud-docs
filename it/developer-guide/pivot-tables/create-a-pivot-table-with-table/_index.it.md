...
description: Aspose.Cells Cloud REST API supporta la creazione di una tabella pivot con oggetto elenco. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 60
---
Questo REST API indica di creare un oggetto `pivottable` con elenco.
...
| destsheetNome| corda| domanda||
| richiesta|| corpo||
| cartella| corda| domanda||
| storageName| corda| domanda| nome di archiviazione.|
 
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
