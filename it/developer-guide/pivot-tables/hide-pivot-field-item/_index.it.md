...
description: Aspose.Cells Cloud REST API supporta l'occultamento di un campo pivot nella tabella pivot. L'SDK supporta i tipi di linguaggi di sviluppo. Includono Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e swift
weight: 110
---
Questo REST API indica di nascondere l'elemento del campo pivot.
...
| tipo di campo pivot| corda| domanda||
...
| storageName| corda| domanda| nome di archiviazione.|
 ...
 IL[Specifica OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldHideItem) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
