...
| Colonna in alto a sinistra| intero| domanda| Indice della colonna in alto a sinistra.|
...
| larghezza| intero| domanda| Rappresenta l'altezza dello Spinner, in unità di pixel.|
| altezza| intero| domanda| Rappresenta la larghezza dello Spinner, in unità di pixel.|
