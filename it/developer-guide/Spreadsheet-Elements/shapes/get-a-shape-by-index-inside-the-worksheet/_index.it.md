---
title: Ottieni una forma tramite l'indice su un foglio di lavoro Excel
...
description: Aspose.Cells Cloud REST API supporta l'acquisizione di una forma su un foglio di lavoro Excel. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 20
