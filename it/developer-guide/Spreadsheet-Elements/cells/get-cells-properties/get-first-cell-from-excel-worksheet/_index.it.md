...
weight: 20
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Ottieni la prima cella dal foglio di lavoro Excel
---
Questo REST API indica che viene ottenuto un `firstcell` in un file Excel quando il parametro `cellOrMethodName` è `firstcell`.
