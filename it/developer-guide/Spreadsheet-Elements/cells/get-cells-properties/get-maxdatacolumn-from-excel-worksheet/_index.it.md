---
title: Ottieni MaxDataColumn dal foglio di lavoro Excel
type: docs
url: /it/get-maxdatacolumn-from-excel-worksheet/
weight: 70
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Ottieni MaxDataColumn dal foglio di lavoro Excel
---
Questo REST API indica che viene ottenuto un `maxdatacolumn` in un file Excel quando il parametro `cellOrMethodName` è `maxdatacolumn`.
