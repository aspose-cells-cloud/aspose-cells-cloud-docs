...
weight: 80
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, JSON, Markdown, Imposta formula per una cella nei fogli di lavoro Excel
---
...
| formula| corda| domanda| Formula per la cella|
