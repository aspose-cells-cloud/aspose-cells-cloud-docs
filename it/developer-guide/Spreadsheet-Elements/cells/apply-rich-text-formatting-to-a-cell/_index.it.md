---
title: Applicare la formattazione RTF a una cella
type: docs
url: /it/apply-rich-text-formatting-to-a-cell/
weight: 40
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Applica formattazione RTF a una cella
---
Questo REST API indica di applicare `rich text formatting` a una cella in un file Excel.
...
| nomecella| corda| sentiero||
| opzioni|| corpo||
| cartella| corda| domanda||
| Nome di archiviazione| corda| domanda| nome di archiviazione.|

 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
