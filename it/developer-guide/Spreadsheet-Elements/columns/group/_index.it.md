...
description: Aspose.Cells Cloud REST API supporta il raggruppamento di colonne in un foglio di lavoro Excel. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 60
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Raggruppa colonne in un foglio di lavoro Excel
---
Questo REST API indica le colonne del foglio di lavoro del gruppo.
