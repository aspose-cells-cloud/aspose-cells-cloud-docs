---
title: Elimina riga su un foglio di lavoro Excel
...
weight: 80
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Elimina riga su un foglio di lavoro Excel
---
...
| Nome del foglio| corda| sentiero| Il foglio di lavoro bame.|
| indice di riga| intero| sentiero| Indice di riga.|
| cartella| corda| domanda| La cartella documenti.|
| Nome di archiviazione| corda| domanda| nome di archiviazione.|

 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRow) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
...
Questo esempio mostra come eliminare una riga da un foglio di lavoro Excel utilizzando Aspose.Cells Cloud API nelle tue applicazioni. Puoi utilizzare il nostro REST API con qualsiasi linguaggio: .NET, Java, PHP, Ruby, Rails, Python, jQuery e molti altri.

## **API Informazioni**

|**API**|**Tipo**|**Descrizione**|**Collegamento alla risorsa**|
|:- |:- |:- |:- |
|/cells/{name}/worksheets/{sheetName}/cells/rows|INVIARE|Elimina righe da un foglio di lavoro Excel|[Elimina righe del foglio di lavoro](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows)|
