---
title: Visualizza le righe in un foglio di lavoro Excel
...
weight: 50
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Visualizza le righe nascoste in un foglio di lavoro Excel
---
Questo REST API indica di visualizzare le righe in un foglio di lavoro Excel.
...
| totaleRighe| intero| domanda| Numero di righe da gestire.|
