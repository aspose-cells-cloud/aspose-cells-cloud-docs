---
title: Lavorare con Excel Filtro automatico
...
---
Il filtro automatico è il modo più rapido per selezionare dal foglio di lavoro solo gli elementi che si desidera visualizzare in un elenco. La funzione di filtro automatico consente agli utenti di filtrare gli elementi in un elenco in base a criteri predefiniti. È possibile filtrare in base a testo, numeri o date.
...
<table class="table table-striped">
  ...
  <td class="col-md-10">
  <p>Aspose.Cells Il cloud fornisce
...
per filtrare i dati in base alla proprietà del colore di riempimento delle celle.</p>
 ...
 È possibile implementare diversi tipi di filtri data, ad esempio filtrando tutte le righe con date risalenti a gennaio 2018.<a href="/cells/it/autofilter/add-date-filter/">il API di aggiungi filtro colore data</a> può implementare questa funzionalità.
  ...
  <td class="col-md-10">
  <p>
 A volte sono necessari filtri dinamici basati su una data, ad esempio tutte le celle che contengono date a gennaio, indipendentemente dall'anno.<a href="/cells/it/autofilter/add-dynamic-filter/">il API del filtro dinamico</a>  
</p>
  </td>
  </tr>
      <tr>
  ...
  <td class="col-md-10">
  <p>
<a href="/cells/it/autofilter/add-filter/">Filtri personalizzati API</a> può essere applicato utilizzando Aspose.Cells come selezionare le celle che hanno un numero compreso in un intervallo dato.
</p>
  </td>
  </tr>
        <tr>
 ...
 Se una colonna contiene testo in modo tale che poche celle siano vuote, ed è necessario un filtro per selezionare solo le righe in cui sono presenti celle vuote,<a href="/cells/it/autofilter/match-all-blank/"> Corrisponde a tutte le celle vuote API</a> può essere utilizzato
</p>
  </td>
  </tr>
            <tr>
