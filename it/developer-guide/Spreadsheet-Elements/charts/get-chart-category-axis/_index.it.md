---
title:  Ottieni l'asse della categoria del grafico
type: docs
url: /it/charts/category-axis/get/
weight: 60
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Ottieni asse categoria grafico
---
...
| Nome di archiviazione| corda| domanda||
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
