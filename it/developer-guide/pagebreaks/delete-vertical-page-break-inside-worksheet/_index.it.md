---
title: Elimina l'interruzione della pagina verticale
second_title: Aspose.Cells Cloud Documen
linktitle: Elimina l'interruzione della pagina verticale
type: docs
...
| storageName| corda| domanda| nome dell'archivio.|
 ...
 IL[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/PageBreaks/DeleteVerticalPageBreak) definisce un'interfaccia di programmazione accessibile pubblicamente e consente di eseguire interazioni REST direttamente da un browser web.
