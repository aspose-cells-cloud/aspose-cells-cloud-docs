...
|:- |:- |:- |:- |
|/cellule/converti/pptx|INVIARE|Converti un foglio di calcolo in un file pptx.|[PostConvertWorkbookToPptx](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx)|
...
[GET /cells/{nome}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API consente di convertire il file MS Excel in un file Docx con impostazioni aggiuntive e di salvare il risultato nella risposta.
