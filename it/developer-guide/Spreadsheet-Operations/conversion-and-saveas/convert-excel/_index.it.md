...
|formato flusso|corda| Formato del flusso del file di input.|
...
|Nome del foglio|corda| Converti il foglio di lavoro specificato.|
...
|Adattamento automatico delle colonne|bool| Adatta automaticamente la larghezza delle colonne in questa cartella di lavoro.|
