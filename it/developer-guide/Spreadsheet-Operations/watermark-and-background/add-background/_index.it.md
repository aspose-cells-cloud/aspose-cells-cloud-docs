...
description: Aspose.Cells Cloud REST API supporta l'aggiunta di background su una cartella di lavoro Excel in un file Excel. L'SDK supporta diversi linguaggi di sviluppo, tra cui Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby e Swift.
weight: 160
...
|:- |:- |:- |:- |
|/cells/{nome}/sfondo|METTERE|Aggiungere sfondo nel file Excel|[MettiSfondoCartellaDiLavoro](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookBackground)|
