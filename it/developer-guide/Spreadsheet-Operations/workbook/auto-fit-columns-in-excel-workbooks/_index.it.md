...
weight: 90
kwords: Excel, Office Cloud, REST API, Foglio di calcolo, PDF, CSV, Json, Markdown, Adatta colonne su una cartella di lavoro Excel
---
Questo REST API indica di adattare automaticamente le colonne in una cartella di lavoro Excel.
