...
Nome | Tipo | Descrizione | Note
------------ | ------------- | ------------- | -------------
 RegexPattern | stringa | | [facoltativo]FullMatchConditions | stringa[]| | [facoltativo]Il[Specifiche OpenAPI](https://apireference.aspose.cloud/cells/#/PostBatchConvert) definisce un'interfaccia di programmazione accessibile al pubblico e consente di eseguire interazioni REST direttamente da un browser web.
