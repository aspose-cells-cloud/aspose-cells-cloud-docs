...
|:- |:- |:- |:- |
|[XLS](https://docs.fileformat.com/spreadsheet/xls/)|Excel 95/5.0 - 2003 Quaderno di esercizi.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLSX](https://docs.fileformat.com/spreadsheet/xlsx/)|Office Apri cartella di lavoro XML SpreadsheetML o file modello, con o senza macro.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLSB](https://docs.fileformat.com/spreadsheet/xlsb/)|Excel Cartella di esercizi binaria.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLSM](https://docs.fileformat.com/spreadsheet/xlsm/)|Excel Cartella di lavoro con attivazione macro.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
|[XLT](https://docs.fileformat.com/spreadsheet/xlt/)|Excel 97 - Excel Modello 2003.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[Numeri](https://docs.fileformat.com/spreadsheet/numbers/)|Il documento è creato dall'applicazione "Numbers" di Apple che fa parte della suite iWork office di Apple, un insieme di applicazioni che funzionano sui sistemi operativi Mac OS X e iOS.|{{< emoticons/tick >}}||
...
|[RIMBORSO](https://docs.fileformat.com/word-processing/md/)|Rappresenta un documento di ribasso.||{{< emoticons/tick >}}|
