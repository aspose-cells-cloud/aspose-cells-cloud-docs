---
title: EliminaHeaderFoote
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteheaderfooter/
description: Cancella intestazione e piè di pagina nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, EliminaHeaderFooter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/clearheaderfooter,DELETE,Cancella intestazione e piè di pagina nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/DeleteHeaderFooter \'>EliminaHeaderFooter</a>" >}}
