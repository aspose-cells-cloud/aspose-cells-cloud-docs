...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,Separa colonne del foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns\'> PostSeparacolonne del foglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,intero,Il primo indice di colonna da utilizzare." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex,intero,L\'ultimo indice di colonna da utilizzare." >}} 
