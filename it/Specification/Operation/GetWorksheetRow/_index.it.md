---
title: Ottieni foglio di lavoro Ro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getworksheetrow/
description: Recupera i dati della riga in base all'indice della riga nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetRow
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetWorksheetRow" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve row data by the row\'s index in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},GET,Recupera i dati della riga in base all\'indice della riga nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/ celle/#/Cells/GetWorksheetRow\'>GetWorksheetRow</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/GetWorksheetRow\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/rows/1?folder=TestData/In"
    -X GET 
