...
type: docs
url: /it/specification/operation/putworksheethyperlink/
description: Aggiungi il collegamento ipertestuale nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,PUT,Aggiungi collegamento ipertestuale nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink\'>PutWorksheetHyperlink< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,intero,Prima riga dell\'intervallo dei collegamenti ipertestuali." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,intero,Prima colonna dell\'intervallo dei collegamenti ipertestuali." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,intero,Numero di righe nell\'intervallo di collegamenti ipertestuali." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,intero,Numero di colonne di questo intervallo di collegamenti ipertestuali." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="indirizzo,stringa,Indirizzo del collegamento ipertestuale." >}} 
