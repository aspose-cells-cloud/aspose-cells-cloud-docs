...
type: docs
url: /it/specification/operation/postconvertworkbooktohtml/
description: Converti il file Excel in file HTML
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostConvertWorkbookToHtml
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/html,POST,Converti il file Excel in file HTML.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml\'>PostConvertWorkbookToHtml</a>" >}}
