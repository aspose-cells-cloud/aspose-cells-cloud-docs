---
title: EliminaCaratterefogliodilavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteworksheetchart/
description: Elimina un grafico per indice nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Elimina Grafico foglio di lavoro
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,Elimina un grafico per indice nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ Grafici/Elimina grafico foglio di lavoro\'>Elimina grafico foglio di lavoro</a>" >}}
