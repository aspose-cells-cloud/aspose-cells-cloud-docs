...
type: docs
url: /it/specification/operation/getworksheetcellstyle/
description: Recupera le descrizioni degli stili di cella nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,GET,Recupera le descrizioni degli stili di cella nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/GetWorksheetCellStyle\'>GetWorksheetCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="cellName,string,nome della cella." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
