...
type: docs
url: /it/specification/operation/postmetadata/
description: Aggiorna le proprietà del documento nel file Excel e salvale in vari formati
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/update,POST,Aggiorna le proprietà del documento nel file Excel e salvale in vari formati.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMetadata\'>PostMetadata< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="celleDocumenti, contenitore, proprietà del documento" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
