...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables,PUT,Aggiungi una tabella pivot nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable\'>PutWorksheetPivotTable </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="sourceData,string,I dati per la nuova cache della tabella pivot." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destCellName,string,La cella nell\'angolo superiore sinistro dell\'intervallo di destinazione per il rapporto di tabella pivot." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="tableName,string,Il nome della nuova tabella pivot." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="useSameSource,boolean,Indica se si utilizza la stessa origine dati quando un\'altra tabella pivot esistente ha utilizzato questa origine dati. Se la proprietà è vera, salverà memoria." >}} 
