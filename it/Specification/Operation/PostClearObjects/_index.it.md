---
title: PostClearObject
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postclearobjects/
description: Cancella gli elementi interni nei file Excel e genera file di output in vari formati
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostClearObjects
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/clearobjects,POST,Cancella gli elementi interni nei file Excel e genera file di output in vari formati.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostClearObjects\'>PostClearObjects</a >" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="tipooggetto,stringa,grafico/commento/immagine/forma/elencooggetto/collegamento ipertestuale/oggettoole/pivottable/convalida/Sfondo" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sheetname,string,Il nome del foglio di lavoro, specifica l\'ambito dell\'eliminazione." >}} 
