...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/smartmarker,POST,Elaborazione marcatori intelligenti.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookGetSmartMarkerResult\'>PostWorkbookGetSmartMarkerResult</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="xmlFile,string,Il percorso completo del file xml, se vuoto i dati vengono letti dal corpo della richiesta." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="cartella,stringa,La cartella in cui si trova il file." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outPath,string,Il percorso in cui salvare il risultato" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="storageName,string,Il nome dell\'archivio in cui si trova il file." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,string,Il nome dell\'archivio in cui si trova il file dei risultati." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
