...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/FormatAll,POST,Aggiorna stile nella tabella pivot.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /PostPivotTableStyle\'>PostPivotTableStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,StyleDescrizione dello stile nel corpo della richiesta." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
