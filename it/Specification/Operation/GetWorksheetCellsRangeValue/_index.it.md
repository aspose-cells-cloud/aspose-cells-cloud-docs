...
type: docs
url: /it/specification/operation/getworksheetcellsrangevalue/
description: Recupera i valori delle celle all'interno dell'intervallo specificato
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetCellsRangeValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,Recupera i valori delle celle all\'interno dell\'intervallo specificato.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /GetWorksheetCellsRangeValue\'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="namerange,string,Il nome dell\'intervallo." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,intero,Ottiene l\'indice della prima riga dell\'intervallo." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,intero,Ottiene l\'indice della prima colonnan dell\'intervallo." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,intero,Ottiene il conteggio delle righe nell\'intervallo." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnCount,intero,Ottiene il conteggio delle colonne nell\'intervallo." >}} 
