---
title: GetWorksheetConditionalFormatting
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getworksheetconditionalformattings/
description: Recuperare le descrizioni delle formattazioni condizionali in un foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetConditionalFormattings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings,GET,Recupera le descrizioni delle formattazioni condizionali in un foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings\' >Ottieniformattazioni condizionali del foglio di lavoro</a>" >}}
