...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/active,PUT,Imposta l\'indice del foglio di lavoro attivo nella cartella di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PutActiveWorksheet\'> Metti il foglio di lavoro attivo</a>" >}}
