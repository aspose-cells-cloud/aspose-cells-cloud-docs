...
type: docs
url: /it/specification/operation/postworksheetcellsetvalue/
description: Imposta il valore della cella utilizzando il nome della cella nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetCellSetValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName},POST,Imposta il valore della cella utilizzando il nome della cella nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PostWorksheetCellSetValue\'>PostWorksheetCellSetValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="valore, stringa, valore della cella." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="tipo,stringa,Il tipo di valore." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="formula,stringa,Formula per cella" >}} 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/A1?value=1&type=int&folder=TestData/In"
    -X POST 
