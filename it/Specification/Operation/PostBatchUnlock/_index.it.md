...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/unlock,POST,Sblocco batch di file che soddisfano condizioni di corrispondenza specifiche.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchUnlock\'>PostBatchUnlock</a>" >}}
