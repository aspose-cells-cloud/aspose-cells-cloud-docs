...
type: docs
url: /it/specification/operation/postworksheetmatchnonblanks/
description: Abbina tutte le celle non vuote nell'elenco
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetMatchNonBlanks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchNonBlanks,POST,Abbina tutte le celle non vuote nell\'elenco.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/ PostWorksheetMatchNonBlanks\'>PostWorksheetMatchNonBlanks</a>" >}}
