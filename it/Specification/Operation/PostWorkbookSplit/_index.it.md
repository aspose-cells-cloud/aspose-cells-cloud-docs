...
type: docs
url: /it/specification/operation/postworkbooksplit/
description: Dividere la cartella di lavoro con un formato specifico
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorkbookSplit
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/split,POST,Dividi la cartella di lavoro con un formato specifico.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit\'>PostWorkbookSplit</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="formato,stringa,formato diviso." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outCartella,stringa," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="da,intero,Indice iniziale del foglio di lavoro." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="to,intero,Fine indice del foglio di lavoro." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" splitNameRule,string,nome regola: sheetname newguid" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName, stringa," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
