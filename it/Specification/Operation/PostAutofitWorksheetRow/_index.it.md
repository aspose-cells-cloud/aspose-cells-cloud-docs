---
title: PostAutofitWorksheetRo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postautofitworksheetrow/
description: Adatta automaticamente una riga nel foglio di lavoro
kwords: Excel, Office, foglio di calcolo, Cloud REST API, PostAutofitWorksheetRow
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostAutofitWorksheetRow" >}}
{{< blocks/products/cells/docs-title titlemsg="Autofit a row in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrow,POST,Adatta automaticamente una riga nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRow\'>PostAutofitWorksheetRow </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,intero,L\'indice della prima colonna." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastColumn,intero,L\'indice dell\'ultima colonna." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorksheetsController/PostAutofitWorksheetRow\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/autofitrow?rowIndex=1&firstColumn=1&lastColumn=8&folder=TestData/In"
    -X POST 
