---
title: EliminaFiltroDataFoglioDiLavoro
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,DELETE,Rimuovi un filtro data nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter \'>Elimina filtro data foglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,Specifica come raggruppare i valori dateTime." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="anno,intero,L\'anno." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="mese,intero,Il mese." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="giorno,intero,Il giorno." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ora,intero,L\'ora." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="minuto,intero,Il minuto." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="secondo,intero,Il secondo." >}} 
