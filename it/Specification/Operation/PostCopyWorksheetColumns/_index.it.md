---
title: PostCopyWorksheetColonna
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postcopyworksheetcolumns/
description: Copia i dati dalle colonne di origine alle colonne di destinazione nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostCopyWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/copy,POST,Copia i dati dalle colonne di origine alle colonne di destinazione nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetColumns\'>PostCopyWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex,intero,indice della colonna di origine" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destinazioneColumnIndex,intero,Indice della colonna di destinazione" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnNumber,intero,Il numero della colonna copiata" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="worksheet,string,Il nome del foglio di lavoro di destinazione." >}} 
