---
title: Impostazione cartella di lavoro successiva
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,Aggiorna impostazione nella cartella di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings\'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="impostazioni, classe: impostazioni cartella di lavoro, descrizione dell\'impostazione cartella di lavoro." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
