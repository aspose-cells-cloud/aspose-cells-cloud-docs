...
type: docs
url: /it/specification/operation/postworkbookcalculateformula/
description: Calcola tutte le formule nella cartella di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorkbookCalculateFormula
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/calculateformula,POST,Calcola tutte le formule nella cartella di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookCalculateFormula\'>PostWorkbookCalculateFormula</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ignoreErrore,booleano,ignora Errore." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="opzioni,class:opzionicalcolo,Opzionicalcolo Opzioni di calcolo." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
