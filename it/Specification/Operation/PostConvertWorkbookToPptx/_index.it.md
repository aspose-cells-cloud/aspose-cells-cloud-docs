...
type: docs
url: /it/specification/operation/postconvertworkbooktopptx/
description: Converti il file Excel in file Pptx
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostConvertWorkbookToPptx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pptx,POST,Converti il file Excel in file Pptx.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx\'>PostConvertWorkbookToPptx</a>" >}}
