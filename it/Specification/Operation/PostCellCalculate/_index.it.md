...
type: docs
url: /it/specification/operation/postcellcalculate/
description: Calcola la formula della cella nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostCellCalculate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/calculate,POST,Calcola la formula della cella nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCalculate\'>PostCellCalculate</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="opzioni,classe:opzionicalcolo,Opzioni di calcolo" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
