---
title: Elimina immagine foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteworksheetpicture/
description: Elimina un oggetto immagine in base all'indice nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Elimina immagine foglio di lavoro
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},DELETE,Elimina un oggetto immagine in base all\'indice nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/# /Immagini/DeleteWorksheetPicture\'>DeleteWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="pictureIndex,intero,Indice immagine." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
