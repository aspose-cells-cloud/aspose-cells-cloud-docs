---
title: OttieniAsseCategoriaGrafico
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,GET,Recupera le descrizioni dell\'asse della serie di grafici nel grafico.,<a href=\'https://apireference.aspose.cloud/cells /#/Grafici/GetChartCategoryAxis\'>GetChartCategoryAxis</a>" >}}
