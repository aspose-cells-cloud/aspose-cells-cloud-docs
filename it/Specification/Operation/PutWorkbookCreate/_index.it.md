...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name},PUT,Crea una nuova cartella di lavoro utilizzando metodi diversi.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate\'>PutWorkbookCreate</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="name,string,Il nuovo nome del documento." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="templateFile,string,Il file modello, se i dati non forniti viene creata la cartella di lavoro predefinita." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dataFile,string,File di dati del marcatore intelligente, se i dati non vengono forniti, il contenuto della richiesta viene controllato per i dati." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isWriteOver,boolean,Specifica se scrivere sul file di destinazione." >}} 
