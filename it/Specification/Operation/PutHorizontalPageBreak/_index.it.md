---
title: PutHorizontalPageBrea
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/puthorizontalpagebreak/
description: Aggiungi un'interruzione di pagina orizzontale nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,Aggiunge un\'interruzione di pagina orizzontale nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >InserisciInterruzionePaginaOrizzontale</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="nomecella,stringa,Nome cella" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="riga,intero,Indice di riga, in base zero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="colonna,intero,Indice di colonna, in base zero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,intero,Indice della colonna iniziale, in base zero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,intero,Indice della colonna finale, in base zero." >}} 
