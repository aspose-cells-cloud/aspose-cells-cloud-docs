---
title: OttieniProprietàDocumento
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getdocumentproperties/
description: Recupera le descrizioni delle proprietà del file Excel
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,GET,Recupera le descrizioni delle proprietà del file Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperties\'>GetDocumentProperties</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="tipo,stringa,Excel tipo di proprietà." >}} 
