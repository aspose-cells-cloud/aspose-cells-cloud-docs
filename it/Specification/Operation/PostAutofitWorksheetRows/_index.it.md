...
type: docs
url: /it/specification/operation/postautofitworksheetrows/
description: Adatta automaticamente le righe nel foglio di lavoro
kwords: Excel, Office, foglio di calcolo, Cloud REST API, PostAutofitWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrows,POST,Adatta automaticamente le righe nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows\'>PostAutofitWorksheetRows< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto,boolean,Adatta automaticamente tutte le righe in questo foglio di lavoro." >}} 
