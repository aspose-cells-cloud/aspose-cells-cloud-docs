...
type: docs
url: /it/specification/operation/postconvertworkbooktosql/
description: Converti il file Excel in file SQL Script
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostConvertWorkbookToSQL
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/sql,POST,Converti il file Excel in file script SQL.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL\'>PostConvertWorkbookToSQL</a>" >}}
