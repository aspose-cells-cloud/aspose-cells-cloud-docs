...
type: docs
url: /it/specification/operation/putinsertworksheetrows/
description: Inserisci diverse nuove righe nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutInsertWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,PUT,Inserisci diverse nuove righe nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PutInsertWorksheetRows\'>PutInsertWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Indica se aggiornare i riferimenti in altri fogli di lavoro." >}} 
