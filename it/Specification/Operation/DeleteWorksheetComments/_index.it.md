---
title: Elimina commento foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteworksheetcomments/
description: Elimina tutti i commenti nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Elimina Foglio di lavoroCommenti
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,DELETE,Elimina tutti i commenti nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments\'>DeleteWorksheetComments </a>" >}}
