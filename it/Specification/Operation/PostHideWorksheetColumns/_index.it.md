...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,Nascondi le colonne del foglio di lavoro nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
