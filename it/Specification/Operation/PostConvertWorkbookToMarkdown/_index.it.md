...
type: docs
url: /it/specification/operation/postconvertworkbooktomarkdown/
description: Converti il file Excel in file Markdown
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostConvertWorkbookToMarkdown
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/markdown,POST,Converti il file Excel in file Markdown.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToMarkdown\'>PostConvertWorkbookToMarkdown</a>" >}}
