...
type: docs
url: /it/specification/operation/postrenameworksheet/
description: Rinominare il foglio di lavoro nella cartella di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostRenameWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/rename,POST,Rinomina il foglio di lavoro nella cartella di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostRenameWorksheet\'>PostRenameWorksheet< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="newname,string,Nome del nuovo foglio di lavoro." >}} 
