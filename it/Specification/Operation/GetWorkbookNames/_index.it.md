...
type: docs
url: /it/specification/operation/getworkbooknames/
description: Recupera gli intervalli denominati nella cartella di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorkbookNames
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetWorkbookNames" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve named ranges in the workbook." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,Recupera intervalli denominati nella cartella di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorkbookController/GetWorkbookNames\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
