...
type: docs
url: /it/specification/operation/postworksheettextreplace/
description: Sostituisci il vecchio testo con il nuovo testo nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/replaceText,POST,Sostituisci il vecchio testo con il nuovo testo nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextReplace \'>PostWorksheetTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,Il vecchio testo da sostituire." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,Il nuovo testo da sostituire." >}} 
