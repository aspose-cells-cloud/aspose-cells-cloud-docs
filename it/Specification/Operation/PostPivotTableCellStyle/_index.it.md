...
type: docs
url: /it/specification/operation/postpivottablecellstyle/
description: Aggiorna lo stile della cella nella tabella pivot
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostPivotTableCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,Aggiorna lo stile della cella nella tabella pivot.,<a href=\'https://apireference.aspose.cloud/cells/#/ Tabelle pivot/PostPivotTableCellStyle\'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="colonna,intero,L\'indice della colonna della cella." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="riga,intero,L\'indice di riga della cella." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,Style Descrizione dello stile nel corpo della richiesta." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
