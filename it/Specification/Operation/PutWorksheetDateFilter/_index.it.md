...
type: docs
url: /it/specification/operation/putworksheetdatefilter/
description: Applicare un filtro data nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutWorksheetDateFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,PUT,Applica un filtro data nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDateFilter \'>PutWorksheetDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,Specifica come raggruppare i valori dateTime (giorno, ora, minuto, mese, secondo, anno)." >}} 
