...
type: docs
url: /it/specification/operation/postconvertworkbooktopdf/
description: Converti il file Excel in file PDF
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostConvertWorkbookToPDF
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pdf,POST,Converti il file Excel in file PDF.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF\'>PostConvertWorkbookToPDF</a>" >}}
