...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/split,POST,Split Excel file di fogli di calcolo basati su fogli di lavoro e crea file di output in vari formati.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSplit\'>PostSplit</ un>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="da,intero,indice del foglio" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="to,intero,indice del foglio" >}} 
