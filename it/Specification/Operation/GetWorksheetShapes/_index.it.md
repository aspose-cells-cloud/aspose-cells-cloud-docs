---
title: Ottieni forma foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getworksheetshapes/
description: Recuperare le descrizioni delle forme nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetShapes
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,Recupera le descrizioni delle forme nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'> Ottieni forme foglio di lavoro</a>" >}}
