...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,Copia contenuti e formati da un altro foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'> PostCopiafoglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceSheet,string,foglio di lavoro Source." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceWorkbook,string,cartella di lavoro di origine." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder,string,cartella della cartella di lavoro originale." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="opzioni,class:opzionicopia,Rappresenta le opzioni di copia." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
