...
type: docs
url: /it/specification/operation/postworksheetvalidation/
description: Aggiorna una convalida per indice nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetValidation
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},POST,Aggiorna una convalida per indice nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ Convalide foglio di lavoro/PostConvalida foglio di lavoro\'>PostConvalida foglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="validationIndex,intero,L\'indice di convalida." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="validazione,classe:convalida,descrizione della validazione." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
