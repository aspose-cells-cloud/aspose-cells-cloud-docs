---
title: Elimina forma foglio di lavoro
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,DELETE,Elimina tutte le forme nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShapes\'>DeleteWorksheetShapes </a>" >}}
