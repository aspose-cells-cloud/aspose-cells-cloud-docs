...
type: docs
url: /it/specification/operation/getworksheetconditionalformatting/
description: Recuperare le descrizioni della formattazione condizionale nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetConditionalFormatting
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="indice,intero,L\'indice di formattazione condizionale." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
