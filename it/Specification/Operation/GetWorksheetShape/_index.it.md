---
title: Ottieni foglio di lavoroShap
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},GET,Recupera la descrizione della forma nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes /GetWorksheetShape\'>GetWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="shapeindex,intero,indice della forma nelle forme del foglio di lavoro." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
