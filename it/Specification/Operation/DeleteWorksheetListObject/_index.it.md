...
type: docs
url: /it/specification/operation/deleteworksheetlistobject/
description: Elimina l'oggetto dell'elenco per indice nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, EliminaWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex},DELETE,Elimina gli oggetti dell\'elenco in base all\'indice nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ ListObjects/DeleteWorksheetListObject\'>DeleteWorksheetListObject</a>" >}}
