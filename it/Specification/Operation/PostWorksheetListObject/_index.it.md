...
type: docs
url: /it/specification/operation/postworksheetlistobject/
description: Aggiorna l'oggetto dell'elenco in base all'indice nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex},POST,Aggiorna gli oggetti dell\'elenco in base all\'indice nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ ListObjects/PostWorksheetListObject\'>PostWorksheetListObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="listObjectIndex,intero,elenco Indice oggetto" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="listObject,class:listobject,listObject dto nel corpo della richiesta." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
