...
type: docs
url: /it/specification/operation/postlock/
description: Blocca i file Excel
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostLock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/lock,POST,Blocca i file Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostLock\'>PostLock</a>" >}}
