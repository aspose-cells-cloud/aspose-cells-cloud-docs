---
title: PostTabellaPivotFieldHideIte
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postpivottablefieldhideitem/
description: Nascondi un elemento del campo pivot nella tabella pivot
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostPivotTableFieldHideItem
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Hide,POST,Nascondi un elemento del campo pivot nella tabella pivot.,<a href=\'https://apireference.aspose.cloud/ celle/#/TabellePivot/PostPivotTableFieldHideItem\'>PostPivotTableFieldHideItem</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="itemIndex,intero,L\'indice dell\'elemento pivot nel campo pivot." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isHide, booleano, indica se l\'elemento Pivot specifico è nascosto (vero/falso)." >}} 
