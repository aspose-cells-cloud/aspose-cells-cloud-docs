---
title: Ottieni collegamento ipertestuale foglio di lavoro
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,GET,Recupera le descrizioni dei collegamenti ipertestuali nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/GetWorksheetHyperlinks\'> Ottieni collegamenti ipertestuali del foglio di lavoro</a>" >}}
