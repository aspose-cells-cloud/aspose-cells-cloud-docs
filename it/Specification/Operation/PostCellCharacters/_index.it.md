---
title: Carattere PostCella
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postcellcharacters/
description: Imposta i caratteri della cella nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Caratteri PostCell
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{nome}/worksheets/{sheetName}/cells/{cellName}/characters,POST,Imposta i caratteri della cella nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/CaratteriPostCell\'>Caratteri PostCell</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="opzioni, contenitore," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
