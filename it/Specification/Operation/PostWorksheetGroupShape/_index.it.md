...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/group,POST,Raggruppa forme nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PostWorksheetGroupShape\'> Forma gruppo post foglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="listShape,array<intero>,Array indice forma." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
