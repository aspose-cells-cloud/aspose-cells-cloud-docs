...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/moveto,POST,Sposta l\'intervallo corrente nell\'intervallo di destinazione.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeMoveTo\'>PostWorksheetCellsRangeMoveTo</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destRow,intero,La riga iniziale dell\'intervallo di destinazione." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destColumn,intero,La colonna iniziale dell\'intervallo di destinazione." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" intervallo,classe:intervallo,intervallo nel foglio di lavoro" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
