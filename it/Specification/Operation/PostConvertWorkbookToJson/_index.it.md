...
type: docs
url: /it/specification/operation/postconvertworkbooktojson/
description: Converti il file Excel in file Json
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostConvertWorkbookToJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,Converti il file Excel in file Json.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
