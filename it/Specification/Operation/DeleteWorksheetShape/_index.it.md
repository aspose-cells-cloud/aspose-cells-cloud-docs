---
title: Elimina foglio di lavoro Shap
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteworksheetshape/
description: Elimina una forma nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, EliminaFormafogliodilavoro
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},DELETE,Elimina una forma nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ Elimina forma foglio di lavoro\'>Elimina forma foglio di lavoro</a>" >}}
