...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,GET,Recupera il secondo asse della categoria del grafico nel grafico,<a href=\'https://apireference.aspose.cloud/cells/# /Grafici/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
