...
type: docs
url: /it/specification/operation/postsearch/
description: Cerca il testo specificato all'interno dei file Excel
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostSearch
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/search,POST,Cerca il testo specificato all\'interno di Excel file.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSearch\'>PostSearch</a>" >}}
