---
title: Ottieni foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getworksheets/
description: Recuperare la descrizione dei fogli di lavoro da una cartella di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Ottieni fogli di lavoro
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,GET,Recupera la descrizione dei fogli di lavoro da una cartella di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets\'>GetWorksheets</a>" >}}
