---
title: Elimina riga foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteworksheetrows/
description: Elimina diverse righe nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, DeleteWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,DELETE,Elimina diverse righe nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows \'>EliminaRighe del foglio di lavoro</a>" >}}
