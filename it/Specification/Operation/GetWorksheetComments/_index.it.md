---
title: Ottieni commento foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getworksheetcomments/
description: Recuperare la descrizione dei commenti nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Ottieni foglio di lavoroCommenti
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,GET,Recupera la descrizione dei commenti nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComments\' >Ricevi commenti del foglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorksheetsController/GetWorksheetComments\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/comments?folder=TestData/In"
    -X GET 
