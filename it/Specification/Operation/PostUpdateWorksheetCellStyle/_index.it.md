...
type: docs
url: /it/specification/operation/postupdateworksheetcellstyle/
description: Imposta lo stile della cella utilizzando il nome della cella nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostUpdateWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,POST,Imposta lo stile della cella utilizzando il nome della cella nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostUpdateWorksheetCellStyle\'>PostUpdateWorksheetCellStyle</a>" >}}
