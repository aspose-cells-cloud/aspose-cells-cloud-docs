...
type: docs
url: /it/specification/operation/putverticalpagebreak/
description: Aggiungi un'interruzione di pagina verticale nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutVerticalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,PUT,Aggiunge un\'interruzione di pagina verticale nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutVerticalPageBreak\' >PutVerticalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,intero,Indice della riga iniziale, in base zero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,intero,Indice della riga finale, in base zero." >}} 
