...
type: docs
url: /it/specification/operation/getmetadata/
description: Ottieni le proprietà del documento delle celle
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/get,POST,Ottieni proprietà del documento delle celle.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/GetMetadata\'>GetMetadata</a>" >}}
