...
type: docs
url: /it/specification/operation/postbatchlock/
description: File di blocco batch che soddisfano condizioni di corrispondenza specifiche
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostBatchLock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/lock,POST,Blocco batch di file che soddisfano condizioni di corrispondenza specifiche.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchLock\'>PostBatchLock</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" batchLockRequest,class:batchlockrequest,BatchLockRequest Richiesta di file di blocco batch." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
