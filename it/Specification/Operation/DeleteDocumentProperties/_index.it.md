---
title: EliminaProprietàDocumento
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deletedocumentproperties/
description: Elimina tutte le proprietà personalizzate del documento e reimposta quelle integrate
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, EliminaDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,DELETE,Elimina tutte le proprietà personalizzate del documento e ripristina quelle integrate.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties\'>DeleteDocumentProperties< /a>" >}}
