...
type: docs
url: /it/specification/operation/putworksheetaddpicture/
description: Aggiungi una nuova immagine nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutWorksheetAddPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,Aggiungi una nuova immagine nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture\'> Metti foglio di lavoro Aggiungi immagine</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,intero,La riga in alto a sinistra dell\'immagine." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,intero,La colonna superiore sinistra dell\'immagine." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightRow,intero,La riga in basso a destra dell\'immagine." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightColumn,intero,La colonna in basso a destra dell\'immagine." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="picturePath,string,Il percorso dell\'immagine, se non fornito, i dati dell\'immagine vengono controllati nel corpo della richiesta." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="immagine,classe:immagine,oggetto Immagine" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
