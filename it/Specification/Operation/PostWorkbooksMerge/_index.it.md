...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/merge,POST,Unisci una cartella di lavoro nella cartella di lavoro esistente.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge\'>PostWorkbooksMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mergeWith,string,La cartella di lavoro con cui unirsi." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergedStorageName, stringa, nome dell\'archivio." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
