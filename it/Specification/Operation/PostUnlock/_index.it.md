...
type: docs
url: /it/specification/operation/postunlock/
description: Sblocca Excel file
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/unlock,POST,Sblocca Excel file.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostUnlock\'>PostUnlock</a>" >}}
