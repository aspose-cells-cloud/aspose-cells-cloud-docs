---
title: Elimina immagine del foglio di lavoro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/deleteworksheetpictures/
description: Elimina tutte le immagini nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Elimina immagini foglio di lavoro
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,Elimina tutte le immagini nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures\'>DeleteWorksheetPictures </a>" >}}
