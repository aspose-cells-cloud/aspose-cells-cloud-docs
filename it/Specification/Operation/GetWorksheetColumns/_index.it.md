...
type: docs
url: /it/specification/operation/getworksheetcolumns/
description: Recupera le descrizioni delle colonne del foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,Recupera le descrizioni delle colonne del foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\' >Ottienicolonne del foglio di lavoro</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="offset,intero,La cartella del workdook." >}} 
