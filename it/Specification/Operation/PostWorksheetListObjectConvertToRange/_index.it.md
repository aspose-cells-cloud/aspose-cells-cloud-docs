---
title: PostWorksheetListObjectConvertToRang
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postworksheetlistobjectconverttorange/
description: Converti l'oggetto dell'elenco nell'intervallo nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetListObjectConvertToRange
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostWorksheetListObjectConvertToRange" >}}
{{< blocks/products/cells/docs-title titlemsg="Convert list object to range in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/ConvertToRange,POST,Converti l\'oggetto dell\'elenco nell\'intervallo nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/ #/ListObjects/PostWorksheetListObjectConvertToRange\'>PostWorksheetListObjectConvertToRange</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectConvertToRange\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet7/listobjects/0/ConvertToRange?folder=TestData/In"
    -X POST 
