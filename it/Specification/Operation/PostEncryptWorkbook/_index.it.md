---
title: PostEncryptWorkboo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/postencryptworkbook/
description: Excel Crittografia
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostEncryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{nome}/encryption,POST,Excel Crittografia.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostEncryptWorkbook\'>PostEncryptWorkbook</a>" >}}
