...
type: docs
url: /it/specification/operation/putworksheetshape/
description: Aggiungi una forma nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PutWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,PUT,Aggiungi una forma nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape\'>PutWorksheetShape </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="DrawingType,string,tipo di oggetto forma" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="top,intero,Rappresenta l\'offset verticale di Spinner dalla riga sinistra, in unità di pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="left,intero,Rappresenta l\'offset orizzontale di Spinner dalla sua colonna di sinistra, in unità di pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="larghezza,intero,Rappresenta l\'altezza di Spinner, in unità di pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="altezza,intero,Rappresenta la larghezza di Spinner, in unità di pixel." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nome parametro, Tipo, Descrizione" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="formaDTO,classe:forma," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
