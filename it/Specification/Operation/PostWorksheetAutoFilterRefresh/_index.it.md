...
type: docs
url: /it/specification/operation/postworksheetautofilterrefresh/
description: Aggiorna i filtri automatici nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, PostWorksheetAutoFilterRefresh
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/refresh,POST,Aggiorna i filtri automatici nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetAutoFilterRefresh\' >Aggiornamento filtro automatico post foglio di lavoro</a>" >}}
