---
title: OttieniVerticalPageBreak
second_title: Aspose.Cells Cloud Documen
type: docs
url: /it/specification/operation/getverticalpagebreaks/
description: Recupera le descrizioni delle interruzioni di pagina verticali nel foglio di lavoro
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, GetVerticalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,Metodo Http,Descrizione,API riferimento" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,Recupera le descrizioni delle interruzioni di pagina verticali nel foglio di lavoro.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks \'>GetVerticalPageBreaks</a>" >}}
