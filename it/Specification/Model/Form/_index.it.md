...
|:- |:- |:- |:- |:- |:- |
| TipoForma| Corda| VERO| Falso|||
| Valore controllato| Corda| VERO| Falso|||
| Ombra| Booleano| VERO| Falso|||
| Intervallo di input| Corda| VERO| Falso|||
| Indice selezionato| Numero intero| VERO| Falso|||
| Valore selezionato| Corda| VERO| Falso|||
| Cella selezionata| Classe:LinkElement| VERO| Falso|||
| DropDownLine| Numero intero| VERO| Falso|||
| Conteggio articoli| Numero intero| VERO| Falso|||
| Celle selezionate| Contenitore| VERO| Falso|||
| Tipo di selezione| Corda| VERO| Falso|||
| È selezionato| Booleano| VERO| Falso|||
| Valore corrente| Numero intero| VERO| Falso|||
| minimo| Numero intero| VERO| Falso|||
| Massimo| Numero intero| VERO| Falso|||
| Modifica incrementale| Numero intero| VERO| Falso|||
| Cambio pagina| Numero intero| VERO| Falso|||
| È orizzontale| Booleano| VERO| Falso|||
