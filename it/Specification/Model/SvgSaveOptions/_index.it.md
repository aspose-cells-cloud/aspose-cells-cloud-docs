...
## **svgSaveOptions**
 ...
 Rappresenta le opzioni di salvataggio del file .svg.

| Nome della proprietà| Tipo di proprietà| Nullabile| Sola lettura| Valore di default| Descrizione|
|:- |:- |:- |:- |:- |:- |
| FoglioIndice| Numero intero| VERO| Falso|| Ottiene e imposta il foglio di lavoro da esportare. Se il valore è -1, verrà esportato il foglio di lavoro attivo.|
