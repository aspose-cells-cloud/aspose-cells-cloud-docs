...
type: docs
url: /it/specification/model/radiobutton/
description: "Aspose.Cells Specifica modello Cloud: RadioButton. Gestisci facilmente Excel e altri fogli di calcolo con funzionalità come apertura, generazione, modifica, divisione, unione, confronto e conversione"
weight: 50
---
## **radioButton**
...
|:- |:- |:- |:- |:- |:- |
| GroupBox| Classe:GroupBox| VERO| Falso|| Ottiene l'oggetto GroupBox che contiene questo RadioButton.|
| È selezionato| Booleano| VERO| Falso|| Indica se il pulsante di opzione è selezionato o meno.|
