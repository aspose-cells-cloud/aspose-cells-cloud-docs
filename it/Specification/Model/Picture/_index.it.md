...
type: docs
url: /it/specification/model/picture/
description: "Aspose.Cells Specifiche del modello Cloud: Immagine. Gestisci facilmente Excel e altri fogli di calcolo con funzionalità come apertura, generazione, modifica, divisione, unione, confronto e conversione"
weight: 50
---
## **immagine**
...
|:- |:- |:- |:- |:- |:- |
| Colore della linea di confine| Classe: colore| VERO| Falso|| Rappresenta la linea di confine di un'immagine.|
| Peso del bordo| Galleggiante| VERO| Falso|| Ottiene o imposta lo spessore della linea del bordo di un'immagine in unità di pt.|
| Altezza originale| Numero intero| VERO| Falso|| Ottiene l'altezza originale dell'immagine.|
| Larghezza originale| Numero intero| VERO| Falso|| Ottiene la larghezza originale dell'immagine.|
| Formatoimmagine| Corda| VERO| Falso|||
| NomeCompletoOrigine| Corda| VERO| Falso|| Ottiene o imposta il percorso e il nome del file di origine per l'immagine collegata.|
