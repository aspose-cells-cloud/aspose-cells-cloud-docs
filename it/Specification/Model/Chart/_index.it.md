...
| Parete di fondo| Classe:LinkElement| VERO| Falso||Restituisce un oggetto che rappresenta la parete posteriore di un grafico 3D.|
| CategoriaAsse| Classe:LinkElement| VERO| Falso|| Ottiene l'asse X del grafico.|
| ChartArea| Classe:LinkElement| VERO| Falso|| Ottiene l'area del grafico nel foglio di lavoro.|
| GraficoDataTable| Classe:LinkElement| VERO| Falso|| Rappresenta la tabella dei dati del grafico.|
...
| Pavimento| Classe:LinkElement| VERO| Falso|| Restituisce un oggetto che rappresenta le pareti di un grafico 3D.|
...
| Leggenda| Classe:LinkElement| VERO| Falso|| Ottiene la legenda del grafico.|
| Nome| Corda| VERO| Falso|||
| Serie N| Classe:LinkElement| VERO| Falso|| Ottiene una raccolta che rappresenta le serie di dati nel grafico.|
...
| Area del grafico| Classe:LinkElement| VERO| Falso|| Ottiene l'area del tracciato del grafico che include le etichette dei segni di graduazione degli assi.|
...
| Titolo| Classe:LinkElement| VERO| Falso|||
| Tipo| Corda| VERO| Falso|||
| Assevalore| Classe:LinkElement| VERO| Falso|| Ottiene l'asse Y del grafico.|
