...
type: docs
url: /it/specification/model/jsonsaveoptions/
description: "Aspose.Cells Specifica del modello cloud: JsonSaveOptions. Gestisci facilmente Excel e altri fogli di calcolo con funzionalità come apertura, generazione, modifica, divisione, unione, confronto e conversione"
weight: 50
---
## **jsonSaveOptions**

 Rappresenta le opzioni di salvataggio del file .json.
...
|EsportaAsString| Booleano| VERO| Falso|| Esporta il valore stringa delle celle in json.|
| Rientro| Corda| VERO| Falso|| Indica il rientro.|
