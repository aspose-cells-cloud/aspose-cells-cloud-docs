...
type: docs
url: /it/specification/model/checkbox/
description: "Aspose.Cells Specifica del modello cloud: CheckBox. Gestisci facilmente Excel e altri fogli di calcolo con funzionalità come apertura, generazione, modifica, divisione, unione, confronto e conversione"
kwords: Excel, Office, Foglio di calcolo, Cloud REST API, Casella di controllo
weight: 50
---
...
|:- |:- |:- |:- |:- |:- |
| Valore controllato| Corda| VERO| Falso|| Ottiene o imposta il valore della casella di controllo.|
| Ombra| Booleano| VERO| Falso|| Indica se la casella combinata ha un'ombreggiatura 3D.|
| Valore| Booleano| VERO| Falso|| Indica se la casella di controllo è selezionata o meno.|
