...
|:- |:- |:- |:- |
|/cells/{nom}/worksheets/{sheetName}/ranges/style|POSTE|Définir le style de cellule d'une plage nommée|[PostWorksheetCellsRangeStyle](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeStyle)|
### **cURL Exemple**
