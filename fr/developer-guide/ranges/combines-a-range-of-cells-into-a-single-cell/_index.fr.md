---
title: Combine une gamme de Cells en un seul Cel
...
description: Aspose.Cells Cloud REST API prend en charge la fusion d'une plage de cellules en une seule cellule sur une feuille de calcul Excel. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 20
---
