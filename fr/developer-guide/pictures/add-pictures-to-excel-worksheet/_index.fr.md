...
description: Aspose.Cells Cloud REST API prend en charge l'ajout d'une image dans un fichier Excel. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 20
---
Ce REST API indique au `add` une nouvelle image pour une feuille de calcul Excel.
