---
title: Exporter la feuille de calcul
...
description: Aspose.Cells Cloud REST API prend en charge l'exportation de la feuille de calcul Excel vers des types de fichiers de format. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 20
---
...
|:- |:- |:- |:- |
|/cellules/exporter|POSTE|Exporter Excel du contenu de la demande vers un format|[Post-exportation](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
