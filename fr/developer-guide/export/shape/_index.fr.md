---
title: Forme d'exportation
second_title: Aspose.Cells Cloud Documen
linktitle: Forme
type: docs
url: /fr/export/excel-shape-to-different-formats/
keywords: Export Excel shape to kinds of format files
description: Aspose.Cells Cloud REST API prend en charge l'exportation de la forme Excel vers des types de fichiers de format. Le SDK prend en charge différents types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift.
weight: 20
kwords: Excel, Office Cloud, REST API, Feuille de calcul, PDF, CSV, Json, Markdwon, Exporter la forme
---
...
|:- |:- |:- |:- |
|/cellules/export|METTRE|Exporter des objets Excel du contenu de la demande vers un format|[PostExportation](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
