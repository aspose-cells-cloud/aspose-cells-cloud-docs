...
weight: 60
kwords: Excel, Office Cloud, REST API, Tableur, PDF, CSV, Json, Markdown, Obtenir une zone de graphique à partir d'une feuille de calcul
---
Ce REST API indique d'obtenir des informations sur la zone de carte.
...
<br/>
 ...
 Le[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) définit une interface de programmation accessible au public et vous permet d'effectuer des interactions REST directement à partir d'un navigateur Web.
