...
| Nom de stockage| chaîne| requête||
 ...
 Copie de l'axe de la deuxième catégorie du graphique Tget[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondCategoryAxis) définit une interface de programmation accessible au public et vous permet d'effectuer des interactions REST directement depuis un navigateur Web.
