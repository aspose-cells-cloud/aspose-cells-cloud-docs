---
title:  Obtenir l'axe des valeurs secondaires du graphique
type: docs
url: /fr/charts/second-value-axis/get/
weight: 60
---
 Ce REST API indique Get Chart Second Value Axis.
...
| nom_stockage| chaîne| mettre en doute||
 ...
 Le[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondValueAxis) définit une interface de programmation accessible au public et permet d'effectuer des interactions REST directement depuis un navigateur Web.
