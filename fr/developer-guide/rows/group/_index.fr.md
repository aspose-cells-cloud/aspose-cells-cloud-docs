...
description: Aspose.Cells Cloud REST API prend en charge le regroupement de lignes sur une feuille de calcul Excel. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 60
---
Ce REST API indique de grouper des lignes sur une feuille de calcul Excel.
