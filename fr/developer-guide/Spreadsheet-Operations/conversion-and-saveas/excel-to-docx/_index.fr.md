...
weight: 90
kwords: Excel, Office Cloud, REST API, Tableur, PDF, CSV, Json, Markdown, Excel vers Docx
---
Ce REST API indique à `convert` un fichier de feuille de calcul vers un fichier au format docx.
...
|:- |:- |:- |:- |
|/cellules/convertir/docx|POSTE|Convertir une feuille de calcul en fichier docx.|[PostConvertWorkbookToDocx](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx)|

 Le[Spécification OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx) définit une interface de programmation accessible au public et vous permet d'effectuer des interactions REST directement à partir d'un navigateur Web.
