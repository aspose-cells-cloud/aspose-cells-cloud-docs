...
description: Aspose.Cells Cloud REST API prend en charge le remplacement du texte du classeur Excel. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
---
Ce REST API indique au texte `replace` dans un classeur Excel.
