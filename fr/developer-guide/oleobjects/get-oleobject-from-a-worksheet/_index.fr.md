...
description: Aspose.Cells Cloud REST API prend en charge l'obtention d'un objet OLE dans une feuille de calcul Excel. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 10
---
Ce REST API indique à `get` un `OLE object` avec le format dans une feuille de calcul Excel.
