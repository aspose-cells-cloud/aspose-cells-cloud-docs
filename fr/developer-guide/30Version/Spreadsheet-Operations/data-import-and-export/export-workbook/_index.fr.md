...
description: Aspose.Cells Cloud REST API prend en charge l'exportation de fichiers Excel vers différents formats. Le SDK prend en charge différents langages de développement, notamment Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift.
weight: 20
kwords: Excel, Office Cloud, REST API, Feuille de calcul, PDF, CSV, Json, Markdown, Exporter le classeur
---
...
|:- |:- |:- |:- |
|/cellules/export|POSTE|Exporter des objets Excel à partir du contenu de la demande vers un format|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
