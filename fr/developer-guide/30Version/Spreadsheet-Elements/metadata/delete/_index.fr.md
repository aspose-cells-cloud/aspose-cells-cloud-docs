...
description: Aspose.Cells Cloud REST API prend en charge la suppression des métadonnées des fichiers Excel. Le SDK prend en charge différents langages de développement, notamment Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift.
weight: 55
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdown, Supprimer les métadonnées sur les fichiers Excel.
---
...
| taper| chaîne| requête| tous|
 ...
 Le[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/DeleteMetadata) définit une interface de programmation accessible au public et vous permet d'effectuer des interactions REST directement à partir d'un navigateur Web.
