---
title: Convertir la forme en image
second_title: Aspose.Cells Cloud Documen
linktitle: Conversion
type: docs
url: /fr/shapes/conversion/
aliases: [/convert-autoshape-to-image/]
keywords: Convert shape on an Excel workshee
description: Aspose.Cells Cloud REST API prend en charge la conversion de forme sur une feuille de calcul Excel. Le SDK prend en charge différents types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift.
weight: 10
kwords: Excel, Office Cloud, REST API, Feuille de calcul, PDF, CSV, Json, Markdwon, Convertir la forme en image
---
Ce REST API indique d'obtenir une forme au format d'image sur une feuille de calcul Excel.
