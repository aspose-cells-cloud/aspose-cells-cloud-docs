...
description: Aspose.Cells Cloud REST API prend en charge l'obtention d'un objet de liste (table) dans une feuille de calcul Excel. Le SDK prend en charge différents types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift.
weight: 9
kwords: Excel, Office Cloud, REST API, Feuille de calcul, PDF, CSV, Json, Markdwon, Obtenir un objet liste dans une feuille de calcul Excel
---
 Ce REST API indique à `get` une liste d'informations sur un objet par index ou convertit un `list object` en fichier de format différent dans une feuille de calcul Excel.
...
| listeobjetindex| entier| chemin| index des objets de liste.|
| format| chaîne| requête| format d'exportation.|
| dossier| chaîne| requête| Dossier du document.|
| Nom de stockage| chaîne| requête| nom de stockage.|
 
 Le[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/GetWorksheetListObject) définit une interface de programmation accessible au public et vous permet d'effectuer des interactions REST directement depuis un navigateur Web.
