---
title: Aspose.Cells Cloud Web API - Convertir les données d'un tableau de feuille de calcul en image
...
description: Convertissez efficacement une table de feuille de calcul locale en fichier image à l'aide du Cloud Web Aspose.Cells API
weight: 100
kwords: Excel, Office Cloud, REST API, Feuille de calcul, PDF, CSV, JSON, Markdown, convertir un tableau en image, conversion cloud, formats de fichiers image, conversion de feuille de calcul
---
 Convertir les données d'une feuille de calcul locale ou d'un tableau Excel en image. Prise en charge**FORMATS D'IMAGE :** [PNG](https://docs.fileformat.com/image/png/), [SVG](https://docs.fileformat.com/page-description-language/svg/), [TIFF](https://docs.fileformat.com/image/tiff/), [JPEG](https://docs.fileformat.com/image/jpeg/), [BMP](https://docs.fileformat.com/image/bmp/)

## **Convertir un tableau en image API**
...
|format|Chaîne|Requête|Format de fichier image souhaité (par exemple, png, svg).|
|chemin de sortie|Chaîne|Requête|(Facultatif) Le chemin du dossier où l'image convertie sera stockée. La valeur par défaut est nulle.|
...
|mot de passe|Chaîne|Requête|Mot de passe requis pour accéder au fichier de feuille de calcul.|
...
### Convertir un tableau en image API Spécifications
 ...
 Le[Convertir un tableau en image API Spécifications](https://reference.aspose.cloud/cells/#/ConversionController/ConvertTableToImage) fournit une interface de programmation accessible au public pour effectuer des interactions REST directement à partir d'un navigateur Web.
