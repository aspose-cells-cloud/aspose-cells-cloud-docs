...
description: Aspose.Cells Cloud REST API prend en charge la conversion des fichiers Excel en fichiers csv. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 90
---
Ce fichier Excel REST API `saveas` au format CSV.

[POST /cellules/{nom}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API vous permet d'enregistrer le fichier MS Excel en tant que fichier CSV avec des paramètres supplémentaires et d'enregistrer le résultat dans le stockage.
