...
[POST /cells/{nom}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API vous permet d'enregistrer le fichier MS Excel en tant que fichier PDF avec des paramètres supplémentaires et d'enregistrer le résultat dans le stockage.
