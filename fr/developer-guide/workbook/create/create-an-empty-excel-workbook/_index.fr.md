...
description: Aspose.Cells Cloud REST API comment créer un classeur vide Excel. SDK prend en charge les types de langages de développement. Ils incluent Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby et Swift
weight: 20
---
...
|:- |:- |:- |:- |
|/cellules/{nom}|METTRE|Créer un classeur vide|[PutWorkbookCreate](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate)|
