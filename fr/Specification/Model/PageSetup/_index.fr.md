...
kwords: Excel, Office, feuille de calcul, Cloud REST API, PageSetup
weight: 50
---
## **mise en page**

 paramètre de page d'impression Excel
...
| IsPercentScale| Booléen| Vrai| FAUX|| Si cette propriété est False, les propriétés FitToPagesWide et FitToPagesTall contrôlent la manière dont la feuille de calcul est mise à l'échelle.|
