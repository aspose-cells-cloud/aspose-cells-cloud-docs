...
type: docs
url: /fr/specification/model/xlssaveoptions/
description: "Aspose.Cells Spécification du modèle cloud : XlsSaveOptions. Gérez sans effort Excel et d'autres feuilles de calcul avec des fonctionnalités telles que l'ouverture, la génération, l'édition, le fractionnement, la fusion, la comparaison et la conversion."
weight: 50
---
## **xlsSaveOptions**

 Représente les options d’enregistrement du fichier .xls.
