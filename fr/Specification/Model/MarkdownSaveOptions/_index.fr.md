...
## **markdownEnregistrerOptions**
 ...
 Représente les options d’enregistrement du fichier .md.

| Nom de la propriété| Type de propriété| Nullable| Lecture seulement| Valeur par défaut| Description|
|:- |:- |:- |:- |:- |:- |
| Codage| Chaîne| Vrai| FAUX|| Obtient et définit l'encodage par défaut.|
| Stratégie de format| Chaîne| Vrai| FAUX|| Le fournisseur de données fournit des données de cellules pour enregistrer le classeur en mode clair.|
| Séparateur de ligne| Chaîne| Vrai| FAUX|| Obtient et définit le séparateur de ligne.|
