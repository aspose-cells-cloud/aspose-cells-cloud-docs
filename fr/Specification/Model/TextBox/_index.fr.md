...
type: docs
url: /fr/specification/model/textbox/
description: "Aspose.Cells Spécification du modèle cloud : TextBox. Gérez sans effort Excel et d'autres feuilles de calcul avec des fonctionnalités telles que l'ouverture, la génération, l'édition, le fractionnement, la fusion, la comparaison et la conversion."
kwords: Excel, Office, feuille de calcul, Cloud REST API, TextBox
weight: 50
---
## **zone de texte**
