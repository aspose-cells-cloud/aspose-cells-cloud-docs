...
kwords: Excel, Office, feuille de calcul, Cloud REST API, série
weight: 50
---
## **série**
...
| Étiquettes de données| Classe :Étiquettes de données| Vrai| FAUX|| Représente l'objet DataLabels pour l'ASeries spécifié.|
...
| Barres inférieures| Classe : DropBars| Vrai| FAUX|| Renvoie un objet qui représente les barres descendantes sur un graphique linéaire. S'applique uniquement aux graphiques en courbes.|
...
| LégendeEntrée| Classe : LégendeEntrée| Vrai| FAUX|| Obtient l'entrée de légende selon cette série.|
