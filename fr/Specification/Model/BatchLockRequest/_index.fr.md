...
type: docs
url: /fr/specification/model/batchlockrequest/
description: "Aspose.Cells Spécification du modèle cloud : BatchLockRequest. Gérez sans effort Excel et d'autres feuilles de calcul avec des fonctionnalités telles que l'ouverture, la génération, l'édition, le fractionnement, la fusion, la comparaison et la conversion."
weight: 50
---
## **batchLockRequest**

 Indique une demande de fichier de verrouillage par lots
...
| Mot de passe| Chaîne| Vrai| FAUX|| Verrouiller le fichier avec un mot de passe|
