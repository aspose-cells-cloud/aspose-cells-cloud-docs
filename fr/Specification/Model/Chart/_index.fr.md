...
kwords: Excel, Office, feuille de calcul, Cloud REST API, graphique
weight: 50
---
## **graphique**
...
| Mur arrière| Classe : Murs| Vrai| FAUX|| Renvoie un objet qui représente le mur arrière d'un graphique 3D.|
| CatégorieAxe| Classe : Axe| Vrai| FAUX|| Obtient l'axe X du graphique.|
| ZoneGraphique| Classe : Zone de graphique| Vrai| FAUX|| Obtient la zone graphique dans la feuille de calcul.|
| GraphiqueDonnéesTable| Classe : ChartDataTable| Vrai| FAUX|| Représente le tableau de données du graphique.|
...
| Sol| Classe : Sol| Vrai| FAUX|| Renvoie un objet qui représente les murs d'un graphique 3D.|
...
| Légende| Classe : Légende| Vrai| FAUX|| Obtient la légende du graphique.|
| Nom| Chaîne| Vrai| FAUX|| Représente le nom du graphique.|
| Série NS| Classe : Articles de série| Vrai| FAUX|| Obtient une collection représentant la série de données dans le graphique.|
...
| Zone de tracé| Classe : Zone de tracé| Vrai| FAUX|| Obtient la zone de tracé du graphique qui inclut les étiquettes de graduation des axes.|
