---
title: Supprimer le métadonnée
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deletemetadata/
description: Supprimez les propriétés du document de cellules dans le fichier Excel et enregistrez-les dans différents formats
kwords: Excel, Office, feuille de calcul, Cloud REST API, Supprimer les métadonnées
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/delete,POST,Supprimer les propriétés du document des cellules dans le fichier Excel et les enregistrer dans différents formats.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/DeleteMetadata\'>DeleteMetadata </a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="tapez, chaîne, Cells nom de la propriété du document." >}} 
