---
title: SupprimerWorksheetChar
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deleteworksheetchart/
description: Supprimer un graphique par index dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, DeleteWorksheetChart
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,Supprimer un graphique par index dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/ Graphiques/DeleteWorksheetChart\'>DeleteWorksheetChart</a>" >}}
