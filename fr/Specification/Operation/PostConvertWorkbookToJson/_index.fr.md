...
type: docs
url: /fr/specification/operation/postconvertworkbooktojson/
description: Convertir le fichier Excel en fichiers Json
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostConvertWorkbookToJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,Convertir le fichier Excel en fichiers Json.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
