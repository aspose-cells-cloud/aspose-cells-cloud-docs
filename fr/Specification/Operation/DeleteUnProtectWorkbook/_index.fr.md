---
title: SupprimerUnProtectWorkboo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deleteunprotectworkbook/
description: Excel déprotection
kwords: Excel, Office, feuille de calcul, Cloud REST API, DeleteUnProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/protection,DELETE,Excel déprotection.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/DeleteUnProtectWorkbook\'>DeleteUnProtectWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mot de passe, chaîne, paramètres de protection, seul le mot de passe peut être spécifié." >}} 
