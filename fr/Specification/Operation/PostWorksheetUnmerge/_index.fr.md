...
type: docs
url: /fr/specification/operation/postworksheetunmerge/
description: Annuler la fusion des cellules dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetUnmerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/unmerge,POST,Annuler la fusion des cellules dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge\'> PostWorksheetUnmerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,Le nombre total de lignes." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Le nombre total de colonnes." >}} 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/unmerge?startRow=1&startColumn=1&totalRows=4&totalColumns=4&folder=TestData/In"
    -X POST 
