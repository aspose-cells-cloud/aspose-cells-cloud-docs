...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/search,POST,Recherche le texte spécifié dans les fichiers Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSearch\'>PostSearch</a>" >}}
