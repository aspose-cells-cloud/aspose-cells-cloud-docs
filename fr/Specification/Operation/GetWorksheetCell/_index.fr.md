...
type: docs
url: /fr/specification/operation/getworksheetcell/
description: Récupérer les données de cellule en utilisant la référence de cellule ou le nom de la méthode dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetCell
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellOrMethodName},GET,Récupère les données de cellule à l\'aide de la référence de cellule ou du nom de la méthode dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud /cells/#/Cells/GetWorksheetCell\'>GetWorksheetCell</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="cellOrMethodName,string,Le nom de la cellule ou de la méthode. (Nom de la méthode comme firstcell, endcell etc.)" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/A1?folder=TestData/In"
    -X GET 
