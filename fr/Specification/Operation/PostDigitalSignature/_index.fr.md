...
type: docs
url: /fr/specification/operation/postdigitalsignature/
description: Excel signature numérique du fichier
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostDigitalSignature
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/digitalsignature,POST,Excel fichier de signature numérique.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostDigitalSignature\'>PostDigitalSignature</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="digitalsignaturefile,string,Le chemin du fichier de signature numérique doit inclure à la fois le dossier et le nom du fichier, ainsi que l\'extension." >}} 
