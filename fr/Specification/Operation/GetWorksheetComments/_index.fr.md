...
type: docs
url: /fr/specification/operation/getworksheetcomments/
description: Récupérer la description des commentaires dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetComments
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,GET,Récupère la description des commentaires dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComments\' >Obtenir les commentaires de la feuille de travail</a>" >}}
