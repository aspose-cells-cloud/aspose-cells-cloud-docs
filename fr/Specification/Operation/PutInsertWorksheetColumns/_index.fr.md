...
type: docs
url: /fr/specification/operation/putinsertworksheetcolumns/
description: Insérer des colonnes de feuille de calcul dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutInsertWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},PUT,Insérer des colonnes de feuille de calcul dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PutInsertWorksheetColumns\'>PutInsertWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="colonnes,entier,Le nombre de colonnes." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Indique si les références dans d\'autres feuilles de calcul seront mises à jour." >}} 
