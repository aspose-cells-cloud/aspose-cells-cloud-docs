...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,POST,Mettre à jour l\'axe des catégories du graphique dans le graphique.,<a href=\'https://apireference.aspose.cloud/cells/# /Graphiques/PostChartCategoryAxis\'>PostChartCategoryAxis</a>" >}}
