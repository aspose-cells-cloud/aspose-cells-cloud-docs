...
type: docs
url: /fr/specification/operation/postconvertworkbooktopdf/
description: Convertir le fichier Excel en fichiers PDF
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostConvertWorkbookToPDF
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pdf,POST,Convertir le fichier Excel en fichiers PDF.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF\'>PostConvertWorkbookToPDF</a>" >}}
