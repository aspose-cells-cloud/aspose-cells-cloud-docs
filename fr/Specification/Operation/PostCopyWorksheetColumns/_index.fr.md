---
title: PostCopyWorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postcopyworksheetcolumns/
description: Copier les données des colonnes source vers les colonnes de destination dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostCopyWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/copy,POST,Copier les données des colonnes source vers les colonnes de destination dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetColumns\'>PostCopyWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex, entier, index de la colonne source" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destinationColumnIndex,entier,index de la colonne de destination" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnNumber,entier,Le numéro de colonne copié" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="feuille de calcul, chaîne, nom de la feuille de calcul de destination." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/PostCopyWorksheetColumns\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/columns/copy?sourceColumnIndex=1&destinationColumnIndex=19&columnNumber=8&worksheet=Sheet2&folder=TestData/In"
    -X POST 
