...
type: docs
url: /fr/specification/operation/postpagesetup/
description: Mettre à jour la mise en page dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostPageSetup
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup,POST,Mettre à jour la mise en page dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/PostPageSetup\'>PostPageSetup </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="pageSetup,class:pagesetup,PageSetup Description de la configuration de la page." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
