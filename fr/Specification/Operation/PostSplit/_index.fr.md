...
type: docs
url: /fr/specification/operation/postsplit/
description: Divisez les fichiers de feuille de calcul Excel en fonction de feuilles de calcul et créez des fichiers de sortie dans différents formats
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostSplit
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/split,POST,Split Excel feuilles de calcul basées sur des feuilles de calcul et création de fichiers de sortie dans différents formats.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSplit\'>PostSplit</ une>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="à partir de, entier, index de feuille" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="à, entier, index de feuille" >}} 
