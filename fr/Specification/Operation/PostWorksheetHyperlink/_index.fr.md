...
type: docs
url: /fr/specification/operation/postworksheethyperlink/
description: Mettre à jour le lien hypertexte par index dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},POST,Mettre à jour le lien hypertexte par index dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /PostWorksheetHyperlink\'>PostWorksheetHyperlink</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="hyperlinkIndex,integer,L\'index du lien hypertexte." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="lien hypertexte, classe : lien hypertexte, objet Lien hypertexte" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
