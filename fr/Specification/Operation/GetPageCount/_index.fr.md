---
title: ObtenirPageCoun
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getpagecount/
description: Obtenir le nombre de pages dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/pagecount,GET,Obtenir le nombre de pages dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount\'>GetPageCount</a>" >}}
