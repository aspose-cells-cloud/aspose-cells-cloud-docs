...
type: docs
url: /fr/specification/operation/postworksheetcellsrangemoveto/
description: Déplacer la plage actuelle vers la plage de destination
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetCellsRangeMoveTo
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/moveto,POST,Déplacer la plage actuelle vers la plage de destination.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeMoveTo\'>PostWorksheetCellsRangeMoveTo</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destRow,integer,La ligne de début de la plage de destination." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destColumn,integer,La colonne de début de la plage de destination." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" plage, classe: plage, plage dans la feuille de calcul" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
