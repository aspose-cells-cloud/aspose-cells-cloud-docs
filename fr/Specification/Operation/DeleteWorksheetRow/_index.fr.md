---
title: Supprimer la feuille de travailRo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deleteworksheetrow/
description: Supprimer une ligne dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, DeleteWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},DELETE,Supprimer une ligne dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetRow\'>SupprimerWorksheetRow</a>" >}}
