---
title: SupprimerWorkbookBackgroun
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deleteworkbookbackground/
description: Supprimer l'arrière-plan du classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, SupprimerWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,DELETE,Supprimer l\'arrière-plan du classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground\'>DeleteWorkbookBackground</a>" >}}
