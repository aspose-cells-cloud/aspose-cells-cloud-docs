...
type: docs
url: /fr/specification/operation/putinsertworksheetrows/
description: Insérer plusieurs nouvelles lignes dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutInsertWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,PUT,Insérer plusieurs nouvelles lignes dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PutInsertWorksheetRows\'>PutInsertWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Indique si les références sont mises à jour dans d\'autres feuilles de calcul." >}} 
