...
type: docs
url: /fr/specification/operation/putworksheethyperlink/
description: Ajouter un lien hypertexte dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,PUT,Ajouter un lien hypertexte dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink\'>PutWorksheetHyperlink< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,Première ligne de la plage du lien hypertexte." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,Première colonne de la plage du lien hypertexte." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,Nombre de lignes dans cette plage de lien hypertexte." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Nombre de colonnes de cette plage de lien hypertexte." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="adresse,chaîne,Adresse du lien hypertexte." >}} 
