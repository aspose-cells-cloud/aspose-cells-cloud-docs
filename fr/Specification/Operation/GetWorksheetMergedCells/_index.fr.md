...
type: docs
url: /fr/specification/operation/getworksheetmergedcells/
description: Obtenir les cellules fusionnées d'une feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetMergedCells
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/mergedCells,GET,Obtenir les cellules fusionnées de la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetMergedCells\'>GetWorksheetMergedCells</ une>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorksheetsController/GetWorksheetMergedCells\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/mergedCells?folder=TestData/In"
    -X GET 
