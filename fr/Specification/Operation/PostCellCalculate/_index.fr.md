...
type: docs
url: /fr/specification/operation/postcellcalculate/
description: Calculer la formule de cellule dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostCellCalculate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/calculate,POST,Calculer la formule de cellule dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCalculate\'>PostCellCalculate</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,classe:options de calcul,options de calcul" >}} 
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/PostCellCalculate\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/A1/calculate?folder=TestData/In"
    -X POST 
