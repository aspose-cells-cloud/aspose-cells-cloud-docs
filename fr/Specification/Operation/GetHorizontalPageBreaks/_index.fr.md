---
title: ObtenirHorizontalPageBreak
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/gethorizontalpagebreaks/
description: Récupérer les descriptions des sauts de page horizontaux dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetHorizontalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,Récupérer les descriptions des sauts de page horizontaux dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks \'>Obtenir des sauts de page horizontaux</a>" >}}
