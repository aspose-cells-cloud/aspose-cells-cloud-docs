---
title: PostConvertWorkbookToPpt
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postconvertworkbooktopptx/
description: Convertir le fichier Excel en fichiers Pptx
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostConvertWorkbookToPptx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pptx,POST,Convertir le fichier Excel en fichiers Pptx.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx\'>PostConvertWorkbookToPptx</a>" >}}
