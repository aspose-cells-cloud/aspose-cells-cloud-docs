...
type: docs
url: /fr/specification/operation/putworkbookcreate/
description: Créer un nouveau classeur en utilisant différentes méthodes
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorkbookCreate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name},PUT,Créez un nouveau classeur en utilisant différentes méthodes.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate\'>PutWorkbookCreate</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="name,string,Le nouveau nom du document." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="templateFile,string,Le fichier modèle, si les données non fournies, le classeur par défaut est créé." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dataFile,string,Fichier de données de marqueur intelligent, si les données ne sont pas fournies, le contenu de la demande est vérifié pour les données." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isWriteOver,boolean,Spécifie s\'il faut écrire sur le fichier cible." >}} 
