...
type: docs
url: /fr/specification/operation/putdocumentprotectfromchanges/
description: Excel protection en écriture de fichier
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutDocumentProtectFromChanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/writeProtection,PUT,Excel protection en écriture du fichier.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PutDocumentProtectFromChanges\'>PutDocumentProtectFromChanges</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="password,class:passwordrequest,Le mot de passe nécessaire pour ouvrir un fichier Excel." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
