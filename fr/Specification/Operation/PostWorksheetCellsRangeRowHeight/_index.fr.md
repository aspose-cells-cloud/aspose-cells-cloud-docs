---
title: PostWorksheetCellsRangeRowHeigh
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postworksheetcellsrangerowheight/
description: Définit la hauteur de ligne de la plage
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetCellsRangeRowHeight
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/rowHeight,POST,Définit la hauteur de ligne de la plage.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeRowHeight\'> PostWorksheetCellsRangeRowHeight</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="value,floating,Définit la hauteur de colonne de cette plage." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="range,class:range,L\'objet range." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
