...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,DELETE,Excel décryptage des fichiers.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/DeleteDecryptWorkbook\'>DeleteDecryptWorkbook</a>" >}}
