...
type: docs
url: /fr/specification/operation/postrenameworksheet/
description: Renommer la feuille de calcul dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostRenameWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/rename,POST,Renommer la feuille de calcul dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostRenameWorksheet\'>PostRenameWorksheet< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="newname,string,Nouveau nom de feuille de calcul." >}} 
