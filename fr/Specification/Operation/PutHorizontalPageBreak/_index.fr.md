...
type: docs
url: /fr/specification/operation/puthorizontalpagebreak/
description: Ajouter un saut de page horizontal dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,Ajouter un saut de page horizontal dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >Mettre un saut de page horizontal</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="nom de cellule, chaîne, nom de cellule" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ligne, entier, index de ligne, basé sur zéro." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="colonne, entier, index de colonne, basé sur zéro." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,Index de la colonne de début, base zéro." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,Index de fin de colonne, base zéro." >}} 
