---
title: Supprimer la feuille de travailHyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deleteworksheethyperlink/
description: Supprimer le lien hypertexte par index dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, DeleteWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},DELETE,Supprimer le lien hypertexte par index dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /DeleteWorksheetHyperlink\'>SupprimerWorksheetHyperlink</a>" >}}
