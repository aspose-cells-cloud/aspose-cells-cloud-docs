---
title: Supprimer la forme de la feuille de travail
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deleteworksheetshape/
description: Supprimer une forme dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, DeleteWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},DELETE,Supprimer une forme dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ DeleteWorksheetShape\'>SupprimerWorksheetShape</a>" >}}
