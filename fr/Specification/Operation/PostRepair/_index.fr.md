...
type: docs
url: /fr/specification/operation/postrepair/
description: Réparez les fichiers anormaux et générez des fichiers dans différents formats
kwords: Excel, Office, feuille de calcul, Cloud REST API, post-réparation
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/repair,POST,Réparer les fichiers anormaux et générer des fichiers dans différents formats.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRepair\'>PostRepair</a>" >}}
