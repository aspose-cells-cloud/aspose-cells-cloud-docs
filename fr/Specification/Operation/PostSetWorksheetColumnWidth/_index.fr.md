...
type: docs
url: /fr/specification/operation/postsetworksheetcolumnwidth/
description: Définir la largeur des colonnes de la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostSetWorksheetColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},POST,Définir la largeur des colonnes de la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostSetWorksheetColumnWidth\'>PostSetWorksheetColumnWidth</a>" >}}
