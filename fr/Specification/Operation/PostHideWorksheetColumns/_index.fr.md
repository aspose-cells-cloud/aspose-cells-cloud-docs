---
title: PostMasquer la colonne de la feuille de travail
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/posthideworksheetcolumns/
description: Masquer les colonnes de la feuille de calcul dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostHideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,Masquer les colonnes de la feuille de calcul dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/columns/hide?startColumn=1&totalColumns=10&folder=TestData/In"
    -X POST 
