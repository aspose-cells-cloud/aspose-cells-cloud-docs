---
title: ObtenirWorkbookName
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getworkbooknames/
description: Récupérer les plages nommées dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorkbookNames
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,Récupérer les plages nommées dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
