---
title: PostUnhideWorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postunhideworksheetcolumns/
description: Afficher les colonnes de la feuille de calcul dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostUnhideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,Afficher les colonnes de la feuille de calcul dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostUnhideWorksheetColumns\'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,L\'index de début de colonne à exploiter." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Nombre de colonnes à exploiter." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,Obtient et définit la largeur de la colonne en unité de caractères." >}} 
