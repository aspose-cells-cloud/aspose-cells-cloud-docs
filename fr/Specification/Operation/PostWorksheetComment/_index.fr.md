...
type: docs
url: /fr/specification/operation/postworksheetcomment/
description: Mettre à jour le commentaire de la cellule dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetComment
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},POST,Mettre à jour le commentaire de la cellule dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/ PostWorksheetComment\'>PostWorksheetComment</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="commentaire, classe: commentaire, objet Commentaire." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
