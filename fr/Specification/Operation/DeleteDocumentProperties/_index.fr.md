---
title: Supprimer la propriété du document
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/deletedocumentproperties/
description: Supprimez toutes les propriétés du document personnalisé et réinitialisez celles intégrées
kwords: Excel, Office, feuille de calcul, Cloud REST API, DeleteDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,DELETE,Supprimez toutes les propriétés de document personnalisées et réinitialisez celles intégrées.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties\'>DeleteDocumentProperties< /a>" >}}
