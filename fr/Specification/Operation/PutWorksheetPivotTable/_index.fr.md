...
type: docs
url: /fr/specification/operation/putworksheetpivottable/
description: Ajouter un tableau croisé dynamique dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorksheetPivotTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables,PUT,Ajouter un tableau croisé dynamique dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable\'>PutWorksheetPivotTable </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="sourceData,string,Les données du nouveau cache de tableau croisé dynamique." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destCellName,string,Cellule située dans le coin supérieur gauche de la plage de destination du rapport de tableau croisé dynamique." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="tableName,string,Le nom du nouveau tableau croisé dynamique." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="useSameSource,boolean,Indique si l\'on utilise la même source de données lorsqu\'un autre tableau croisé dynamique existant a utilisé cette source de données. Si la propriété est vraie, cela économisera de la mémoire." >}} 
