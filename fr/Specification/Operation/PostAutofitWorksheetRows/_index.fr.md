...
type: docs
url: /fr/specification/operation/postautofitworksheetrows/
description: Ajustement automatique des lignes dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostAutofitWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrows,POST,Ajustement automatique des lignes dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows\'>PostAutofitWorksheetRows< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto,boolean,Autofits toutes les lignes de cette feuille de calcul." >}} 
