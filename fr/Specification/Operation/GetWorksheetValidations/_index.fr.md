...
type: docs
url: /fr/specification/operation/getworksheetvalidations/
description: Récupérer les descriptions des validations dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,GET,Récupérer les descriptions des validations dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations\'> GetWorksheetValidations</a>" >}}
