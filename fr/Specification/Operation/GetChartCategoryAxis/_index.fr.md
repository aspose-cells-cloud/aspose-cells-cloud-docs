...
type: docs
url: /fr/specification/operation/getchartcategoryaxis/
description: Récupérer les descriptions des axes des séries de graphiques dans le graphique
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,GET,Récupérer les descriptions des axes des séries de graphiques dans le graphique.,<a href=\'https://apireference.aspose.cloud/cells /#/Charts/GetChartCategoryAxis\'>GetChartCategoryAxis</a>" >}}
