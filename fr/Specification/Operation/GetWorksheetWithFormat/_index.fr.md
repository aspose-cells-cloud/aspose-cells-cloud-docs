...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},GET,Récupère la feuille de calcul dans un format spécifié à partir du classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetWithFormat\' >Obtenir une feuille de travail avec le format</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="pageIndex,integer,Représente la page à imprimer" >}} 
