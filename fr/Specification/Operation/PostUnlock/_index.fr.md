...
type: docs
url: /fr/specification/operation/postunlock/
description: Déverrouiller les fichiers Excel
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/unlock,POST,Déverrouiller les fichiers Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostUnlock\'>PostUnlock</a>" >}}
