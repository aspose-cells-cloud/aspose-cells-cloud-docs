...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names/{nameName},GET,Récupérer la description d\'une plage nommée dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookName\'> ObtenirWorkbookName</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="nameName,string,Le nom." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
