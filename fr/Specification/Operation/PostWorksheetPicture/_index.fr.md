...
type: docs
url: /fr/specification/operation/postworksheetpicture/
description: Mettre à jour une image par index dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},POST,Mettre à jour une image par index dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/ Images/PostWorksheetPicture\'>PostWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="PictureIndex,integer,L\'index de l\'image." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="image, classe: image, description de l\'objet image." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
