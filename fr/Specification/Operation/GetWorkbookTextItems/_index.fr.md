---
title: GetWorkbookTextItem
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getworkbooktextitems/
description: Récupérer des éléments de texte dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorkbookTextItems
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/textItems,GET,Récupérer les éléments de texte dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems\'>GetWorkbookTextItems</a>" >}}
