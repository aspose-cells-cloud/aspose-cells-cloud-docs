...
type: docs
url: /fr/specification/operation/postchartsecondcategoryaxis/
description: Mettre à jour le deuxième axe de catégorie du graphique
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,POST,Mettre à jour l\'axe de la deuxième catégorie du graphique.,<a href=\'https://apireference.aspose.cloud/cells/ #/Charts/PostChartSecondCategoryAxis\'>PostChartSecondCategoryAxis</a>" >}}
