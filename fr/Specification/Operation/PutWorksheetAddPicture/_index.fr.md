...
type: docs
url: /fr/specification/operation/putworksheetaddpicture/
description: Ajouter une nouvelle image dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorksheetAddPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,Ajouter une nouvelle image dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture\'> PutWorksheetAddPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="sheetName,string,Le nom de la feuille de travail." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,integer,La ligne supérieure gauche de l\'image." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,integer,La colonne supérieure gauche de l’image." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightRow,integer,La ligne inférieure droite de l\'image." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightColumn,integer,La colonne inférieure droite de l\'image." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="PicturePath,string,Le chemin de l\'image, s\'il n\'est pas fourni, les données de l\'image sont inspectées dans le corps de la demande." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="image, classe: image, objet Pictute" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
