...
type: docs
url: /fr/specification/operation/postworksheetcellsrangescopy/
description: Copier le contenu de la plage source vers la plage de destination dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetCellsRangesCopy
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/copy,POST,Copier le contenu de la plage source vers la plage de destination dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells /#/Ranges/PostWorksheetCellsRangesCopy\'>PostWorksheetCellsRangesCopy</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="rangeOperate, classe : rangecopyrequest, RangeCopyRequestcopydata, copystyle, copyto, copyvalue" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
