...
type: docs
url: /fr/specification/operation/postworkbookgetsmartmarkerresult/
description: Traitement intelligent des marqueurs
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorkbookGetSmartMarkerResult
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/smartmarker,POST,Traitement intelligent des marqueurs.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookGetSmartMarkerResult\'>PostWorkbookGetSmartMarkerResult</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="xmlFile,string,Le chemin complet du fichier XML, s\'il est vide, les données sont lues à partir du corps de la requête." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dossier, chaîne, le dossier où se trouve le fichier." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outPath,string,Le chemin pour enregistrer le résultat" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="storageName,string,Le nom de stockage où se trouve le fichier." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,string,Le nom de stockage où se trouve le fichier de résultats." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
