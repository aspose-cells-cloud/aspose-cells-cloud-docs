---
title: ObtenirWorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getworksheetcolumns/
description: Récupérer les descriptions des colonnes de la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetColumns
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetWorksheetColumns" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve descriptions of worksheet columns." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,Récupérer les descriptions des colonnes de la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\' >Obtenir des colonnes de feuille de travail</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="offset,entier,Le dossier workdook." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/GetWorksheetColumns\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/columns/?offset=1&count=10&folder=TestData/In"
    -X GET 
