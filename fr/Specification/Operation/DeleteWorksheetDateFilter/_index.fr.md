---
title: Supprimer la feuille de travailDateFilte
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,DELETE,Supprimer un filtre de date dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter \'>SupprimerWorksheetDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,Spécifie comment regrouper les valeurs dateTime." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="année,entier,L\'année." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="mois,entier,Le mois." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="jour,entier,Le jour." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="heure,entier,L\'heure." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="minute, entier, La minute." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="seconde,entier,La seconde." >}} 
