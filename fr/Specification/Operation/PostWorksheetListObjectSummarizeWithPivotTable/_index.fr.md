...
type: docs
url: /fr/specification/operation/postworksheetlistobjectsummarizewithpivottable/
description: Créer un tableau croisé dynamique avec un objet de liste dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetListObjectSummarizeWithPivotTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/SummarizeWithPivotTable,POST,Créer un tableau croisé dynamique avec un objet liste dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud /cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable\'>PostWorksheetListObjectSummarizeWithPivotTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destsheetName,string,Le nom de la feuille de calcul cible." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="createPivotTableRequest,class:createpivottablerequest,Créer une demande de tableau croisé dynamique." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
