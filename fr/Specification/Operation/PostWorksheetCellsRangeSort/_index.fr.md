...
type: docs
url: /fr/specification/operation/postworksheetcellsrangesort/
description: Effectuer un tri des données autour d'une plage de cellules
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetCellsRangeSort
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/sort,POST,Effectuer un tri des données autour d\'une plage de cellules.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeSort\'>PostWorksheetCellsRangeSort</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" rangeSortRequest,class:rangesortrequest,RangeSortRequest Demande de tri par plage" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
