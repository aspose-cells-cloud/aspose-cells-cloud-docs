...
type: docs
url: /fr/specification/operation/postconvertworkbooktohtml/
description: Convertir le fichier Excel en fichiers HTML
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostConvertWorkbookToHtml
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/html,POST,Convertir le fichier Excel en fichiers HTML.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml\'>PostConvertWorkbookToHtml</a>" >}}
