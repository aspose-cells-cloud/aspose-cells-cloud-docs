...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,Mettre à jour le style de cellule dans le tableau croisé dynamique.,<a href=\'https://apireference.aspose.cloud/cells/#/ Tableaux croisés dynamiques/PostPivotTableCellStyle\'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="column,integer,L\'index de colonne de la cellule." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="row,integer,L\'index de ligne de la cellule." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,Style Description du style dans le corps de la demande." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
