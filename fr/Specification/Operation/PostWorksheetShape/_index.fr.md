...
type: docs
url: /fr/specification/operation/postworksheetshape/
description: Mettre à jour une forme dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},POST,Mettre à jour une forme dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ PostWorksheetShape\'>PostWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dto,class:shape,La description de la forme." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
