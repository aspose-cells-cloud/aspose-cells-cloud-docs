...
type: docs
url: /fr/specification/operation/postpivottablestyle/
description: Mettre à jour le style dans le tableau croisé dynamique
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostPivotTableStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/FormatAll,POST,Mettre à jour le style dans le tableau croisé dynamique.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /PostPivotTableStyle\'>PostPivotTableStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,StyleStyle description dans le corps de la demande." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
