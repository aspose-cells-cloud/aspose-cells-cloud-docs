...
type: docs
url: /fr/specification/operation/postworksheetmatchnonblanks/
description: Faire correspondre toutes les cellules non vides de la liste
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetMatchNonBlanks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchNonBlanks,POST,Faire correspondre toutes les cellules non vides de la liste.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/ PostWorksheetMatchNonBlanks\'>PostWorksheetMatchNonBlanks</a>" >}}
