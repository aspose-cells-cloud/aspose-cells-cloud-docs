...
type: docs
url: /fr/specification/operation/deleteworksheets/
description: Supprimer les feuilles de calcul correspondantes dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, Supprimer des feuilles de travail
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,Supprimer les feuilles de calcul correspondantes dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>DeleteWorksheets</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="matchCondition, classe : matchconditionrequest," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
