...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/lock,POST,Verrouillez les fichiers Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostLock\'>PostLock</a>" >}}
