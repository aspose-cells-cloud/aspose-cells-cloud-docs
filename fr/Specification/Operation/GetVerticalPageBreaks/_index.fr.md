---
title: ObtenirVerticalPageBreak
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getverticalpagebreaks/
description: Récupérer les descriptions des sauts de page verticaux dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetVerticalPageBreaks
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetVerticalPageBreaks" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve descriptions of vertical page breaks in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,Récupérer les descriptions des sauts de page verticaux dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks \'>Obtenir des sauts de page verticaux</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/PageBreaksController/GetVerticalPageBreaks\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/verticalpagebreaks?folder=TestData/In"
    -X GET 
