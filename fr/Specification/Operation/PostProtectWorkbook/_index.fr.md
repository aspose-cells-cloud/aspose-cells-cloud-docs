...
type: docs
url: /fr/specification/operation/postprotectworkbook/
description: Excel protection
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="protectWorkbookRequest,class:protectworkbookrequest,Les paramètres de protection." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
