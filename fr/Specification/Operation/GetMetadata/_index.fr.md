---
title: ObtenirMétadate
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getmetadata/
description: Obtenir les propriétés du document de cellules
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/get,POST,Obtenir les propriétés du document des cellules.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/GetMetadata\'>GetMetadata</a>" >}}
