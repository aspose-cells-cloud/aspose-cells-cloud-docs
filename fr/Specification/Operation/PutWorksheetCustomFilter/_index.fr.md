...
type: docs
url: /fr/specification/operation/putworksheetcustomfilter/
description: Filtrer une liste avec des critères personnalisés dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorksheetCustomFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/custom,PUT,Filtrer une liste avec des critères personnalisés dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter /PutWorksheetCustomFilter\'>PutWorksheetCustomFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="range,string,Représente la plage à laquelle s\'applique le filtre automatique spécifié." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="OperatorType1,string,Le type d\'opérateur de filtre" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="critères1,string,Les critères personnalisés." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="estEt,booléen,vrai/faux" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="opérateurType2,chaîne," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="critères2,string,Les critères personnalisés." >}} 
