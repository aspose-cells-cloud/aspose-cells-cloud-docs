...
type: docs
url: /fr/specification/operation/postconvertworkbooktopng/
description: Convertir le fichier Excel en fichiers PNG
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostConvertWorkbookToPNG
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/png,POST,Convertir le fichier Excel en fichiers PNG.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPNG\'>PostConvertWorkbookToPNG</a>" >}}
