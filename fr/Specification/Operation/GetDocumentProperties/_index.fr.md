...
type: docs
url: /fr/specification/operation/getdocumentproperties/
description: Récupérer les descriptions des propriétés du fichier Excel
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,GET,Récupérer les descriptions des propriétés du fichier Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperties\'>GetDocumentProperties</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="type, chaîne, type de propriété Excel." >}} 
