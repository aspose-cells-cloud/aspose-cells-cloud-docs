...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/merge,POST,Fusionner les cellules dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge\'> PostWorksheetMerge</a>" >}}
