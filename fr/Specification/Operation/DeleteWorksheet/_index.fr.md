...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},DELETE,Supprimer une feuille de calcul dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheet\'>DeleteWorksheet</ une>" >}}
