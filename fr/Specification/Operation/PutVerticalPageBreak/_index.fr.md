...
type: docs
url: /fr/specification/operation/putverticalpagebreak/
description: Ajouter un saut de page vertical dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutVerticalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,PUT,Ajouter un saut de page vertical dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutVerticalPageBreak\' >Mettre un saut de page vertical</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,integer,Index de ligne de début, base zéro." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,integer,Index de fin de ligne, base zéro." >}} 
