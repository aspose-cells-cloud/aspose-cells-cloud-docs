---
title: PutWorkbookBackgroun
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/putworkbookbackground/
description: Définir l'arrière-plan dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,PUT,Définir l\'arrière-plan dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookBackground\'>PutWorkbookBackground</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath,string,Le chemin complet de l\'image." >}} 
