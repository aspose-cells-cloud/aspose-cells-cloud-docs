...
type: docs
url: /fr/specification/operation/postworksheetcellsrangeunmerge/
description: Annuler la fusion des cellules fusionnées dans cette plage
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetCellsRangeUnMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/unmerge,POST,Annuler la fusion des cellules fusionnées dans cette plage.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeUnMerge\' >PostWorksheetCellsRangeUnMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="plage, classe: plage, plage description de la plage." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
