---
title: PostWorksheetCellsRangeMerg
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postworksheetcellsrangemerge/
description: Fusionner une plage de cellules en une seule cellule
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorksheetCellsRangeMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/merge,POST,Fusionner une plage de cellules en une seule cellule.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /PostWorksheetCellsRangeMerge\'>PostWorksheetCellsRangeMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="plage, classe: plage, description de la plage." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
