---
title: GetWorksheetHyperlien
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getworksheethyperlinks/
description: Récupérer les descriptions des hyperliens dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetHyperlinks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,GET,Récupérer les descriptions des hyperliens dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/GetWorksheetHyperlinks\'> GetWorksheetHyperliens</a>" >}}
