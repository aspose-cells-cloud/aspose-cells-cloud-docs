...
type: docs
url: /fr/specification/operation/postworkbookdatafill/
...
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorkbookDataFill
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datafill,POST,Le remplissage des données pour les fichiers de feuille de calcul est principalement utilisé pour remplir des données vides dans des tableaux et des plages.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/ PostWorkbookDataFill\'>PostWorkbookDataFill</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataFill, classe: datafill," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
