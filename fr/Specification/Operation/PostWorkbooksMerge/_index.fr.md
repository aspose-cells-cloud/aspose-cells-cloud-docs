...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/merge,POST,Fusionner un classeur dans le classeur existant.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge\'>PostWorkbooksMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mergeWith,string,Le classeur avec lequel fusionner." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergedStorageName, chaîne, nom de stockage." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
