---
title: PostEffacerFormat
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postclearformats/
description: Effacer les formats de cellule dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostClearFormats
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostClearFormats" >}}
{{< blocks/products/cells/docs-title titlemsg="Clear cell formats in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearformats,POST,Effacer les formats de cellules dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats\' >PostClearFormats</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,integer,L\'index de la ligne de départ." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,L\'index de la colonne de départ." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,integer,Indice de fin de ligne." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,L\'index de la colonne de fin." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/PostClearFormats\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/clearformats?range=A1:C10&startRow=1&startColumn=1&endRow=3&endColumn=3&folder=TestData/In"
    -X POST 
