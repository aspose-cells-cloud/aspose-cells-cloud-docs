...
type: docs
url: /fr/specification/operation/postconvertworkbooktodocx/
description: Convertir le fichier Excel en fichiers Docx
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostConvertWorkbookToDocx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/docx,POST,Convertir le fichier Excel en fichiers Docx.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx\'>PostConvertWorkbookToDocx</a>" >}}
