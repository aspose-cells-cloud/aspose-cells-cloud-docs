---
title: Obtenir la forme de la feuille de travail
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/getworksheetshapes/
description: Récupérer les descriptions des formes dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetWorksheetShapes
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetWorksheetShapes" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve descriptions of shapes in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,Récupérer les descriptions des formes dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'> ObtenirWorksheetShapes</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/ShapesController/GetWorksheetShapes\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/shapes?folder=TestData/In"
    -X GET 
