...
type: docs
url: /fr/specification/operation/putworksheetshape/
description: Ajouter une forme dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PutWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,PUT,Ajouter une forme dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape\'>PutWorksheetShape </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Type de dessin, chaîne, type d\'objet Forme" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,integer,Index de la ligne supérieure gauche." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,integer,Index de la colonne supérieure gauche." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="top,integer,Représente le décalage vertical de Spinner par rapport à sa ligne de gauche, en unité de pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="left,integer,Représente le décalage horizontal de Spinner par rapport à sa colonne de gauche, en unité de pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,integer,Représente la hauteur de Spinner, en unité de pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="height,integer,Représente la largeur de Spinner, en unité de pixel." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="shapeDTO, classe: forme," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
