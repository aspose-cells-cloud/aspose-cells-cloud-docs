...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,GET,Récupérer l\'axe de la deuxième catégorie du graphique,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
