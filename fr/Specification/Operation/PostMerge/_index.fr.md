...
type: docs
url: /fr/specification/operation/postmerge/
description: Fusionner les cellules dans la feuille de calcul
kwords: Excel, Office, Feuille de calcul, Cloud REST API, PostMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/merge,POST,Fusionner les cellules dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMerge\'>PostMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergeToOneSheet,boolean,Fusionner tous les classeurs dans une feuille." >}} 
