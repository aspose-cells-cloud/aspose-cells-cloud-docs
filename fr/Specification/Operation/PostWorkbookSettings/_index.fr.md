...
type: docs
url: /fr/specification/operation/postworkbooksettings/
description: Mettre à jour le paramètre dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorkbookSettings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,Mettre à jour le paramètre dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings\'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="paramètres, classe : paramètres du classeur, description des paramètres du classeur." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
