...
type: docs
url: /fr/specification/operation/postungroupworksheetcolumns/
description: Dissocier les colonnes d'une feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostUngroupWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,Dissocier les colonnes de la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns\'> PostUngroupWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,Le premier index de colonne à exploiter." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex,integer,Le dernier index de colonne à exploiter." >}} 
