...
type: docs
url: /fr/specification/operation/postcopyworksheet/
description: Copier le contenu et les formats d'une autre feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostCopyWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,Copier le contenu et les formats d\'une autre feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'> PostCopyWorksheet</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceSheet,string,Feuille de calcul source." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceWorkbook, chaîne, source Workbook." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder,string,Dossier du classeur d\'origine." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:copyoptions,Représente les options de copie." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
