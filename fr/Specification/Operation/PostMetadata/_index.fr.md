...
type: docs
url: /fr/specification/operation/postmetadata/
description: Mettez à jour les propriétés du document dans le fichier Excel et enregistrez-les sous différents formats
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/update,POST,Mettre à jour les propriétés du document dans le fichier Excel et les enregistrer dans différents formats.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMetadata\'>PostMetadata< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="cellulesDocuments, conteneur, propriétés du document" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
