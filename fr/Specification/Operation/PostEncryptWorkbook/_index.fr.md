...
type: docs
url: /fr/specification/operation/postencryptworkbook/
description: Excel Cryptage
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostEncryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,POST,Excel Chiffrement.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostEncryptWorkbook\'>PostEncryptWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="chiffrement, classe : workbookencryptionrequest, paramètres WorkbookEncryptionRequestEncryption." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
