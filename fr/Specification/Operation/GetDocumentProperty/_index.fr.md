...
type: docs
url: /fr/specification/operation/getdocumentproperty/
description: Obtenez la propriété Excel par son nom
kwords: Excel, Office, feuille de calcul, Cloud REST API, GetDocumentProperty
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties/{propertyName},GET,Obtenir la propriété Excel par nom.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty\'>GetDocumentProperty</a >" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nom du paramètre, type, description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="propertyName,string,Le nom de la propriété." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
