---
title: PostAutofitWorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postautofitworksheetcolumns/
description: Ajuster automatiquement les colonnes dans la feuille de calcul
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostAutofitWorksheetColumns
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostAutofitWorksheetColumns" >}}
{{< blocks/products/cells/docs-title titlemsg="Autofit columns in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitcolumns,POST,Ajustement automatique des colonnes dans la feuille de calcul.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetColumns\'>PostAutofitWorksheetColumns< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="uniquementAuto,booléen," >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorksheetsController/PostAutofitWorksheetColumns\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/autofitcolumns?startColumn=1&endColumn=9&onlyAuto=true&folder=TestData/In"
    -X POST 
