...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Hide,POST,Masquer un élément de champ pivot dans le tableau croisé dynamique.,<a href=\'https://apireference.aspose.cloud/ cell/#/PivotTables/PostPivotTableFieldHideItem\'>PostPivotTableFieldHideItem</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="itemIndex,integer,L\'index de l\'élément pivot dans le champ pivot." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isHide,boolean,Si le PivotItem spécifique est masqué (vrai/faux)." >}} 
