---
title: PostWorkbookTextReplace
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/specification/operation/postworkbooktextreplace/
description: Remplacer le texte dans le classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorkbookTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/replaceText,POST,Remplacer le texte dans le classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookTextReplace\'>PostWorkbookTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,L\'ancienne valeur." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,La nouvelle valeur." >}} 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/replaceText?oldValue=1234&newValue=5678&folder=TestData/In"
    -X POST 
