...
type: docs
url: /fr/specification/operation/postworkbookcalculateformula/
description: Calculer toutes les formules du classeur
kwords: Excel, Office, feuille de calcul, Cloud REST API, PostWorkbookCalculateFormula
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,Référence API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/calculateformula,POST,Calculer toutes les formules du classeur.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookCalculateFormula\'>PostWorkbookCalculateFormula</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ignoreError,booléen,ignore l\'erreur." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,classe:options de calcul,Options de calcul Options de calcul." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
