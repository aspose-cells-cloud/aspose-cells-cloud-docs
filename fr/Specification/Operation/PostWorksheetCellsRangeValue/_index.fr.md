...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Valeur, chaîne, valeur d\'entrée." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isConverted,boolean,True : converti en un autre type de données, le cas échéant." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="setStyle,boolean,True : définit le format numérique sur le style de la cellule lors de la conversion vers un autre type de données." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nom du paramètre, type, description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" range,class:range,La plage dans la feuille de calcul." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
