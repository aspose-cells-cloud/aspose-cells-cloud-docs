---
title: Aspose.Cells 云 SDK for Per
second_title: Aspose.Cells Cloud Documen
type: docs
url: /zh/available-sdks/aspose-cells-cloud-perl/
description: Aspose.Cells 云支持 Excel 创建、转换、合并、拆分、保护、内部对象操作等
weight: 30
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, Perl
---
该 SDK 是开源的，并遵循 MIT 许可证。您可以访问 Perl 库的源代码，用于 Aspose.Cells Cloud[这里](https://github.com/aspose-cells-cloud/aspose-cells-cloud-perl).
