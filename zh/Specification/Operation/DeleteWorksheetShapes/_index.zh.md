...
type: docs
url: /zh/specification/operation/deleteworksheetshapes/
description: 删除工作表中的所有形状
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetShapes
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,DELETE,删除工作表中的所有形状。,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShapes\'>DeleteWorksheetShapes</a>" >}}
