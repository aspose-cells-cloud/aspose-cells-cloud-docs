...
type: docs
url: /zh/specification/operation/getworksheetshapes/
description: 检索工作表中形状的描述
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,检索工作表中形状的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'>获取工作表形状</a>" >}}
