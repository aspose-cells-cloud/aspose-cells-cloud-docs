...
type: docs
url: /zh/specification/operation/putinsertworksheetcolumns/
description: 在工作表中插入工作表列
kwords: Excel，Office，电子表格，云 REST API，PutInsertWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},PUT,在工作表中插入工作表列。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetColumns\'>PutInsertWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="columns，整数，列数。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference，boolean，指示是否更新其他工作表中的引用。" >}} 
