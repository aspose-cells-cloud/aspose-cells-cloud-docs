...
type: docs
url: /zh/specification/operation/postencryptworkbook/
description: Excel 加密
kwords: Excel，Office，电子表格，云 REST API，PostEncryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,POST,Excel 加密。,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostEncryptWorkbook\'>PostEncryptWorkbook</a>" >}}
