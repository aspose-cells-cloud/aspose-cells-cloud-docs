...
type: docs
url: /zh/specification/operation/getworksheetcomments/
description: 检索工作表中评论的描述
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetComments
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,GET,检索工作表中注释的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComments\'>GetWorksheetComments</a>" >}}
