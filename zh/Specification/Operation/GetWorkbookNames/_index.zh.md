...
type: docs
url: /zh/specification/operation/getworkbooknames/
description: 检索工作簿中的命名范围
kwords: Excel，Office，电子表格，云 REST API，GetWorkbookNames
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,检索工作簿中的命名范围。,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
