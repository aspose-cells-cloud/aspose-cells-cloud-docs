...
type: docs
url: /zh/specification/operation/deleteworksheets/
description: 删除工作簿中匹配的工作表
kwords: Excel，Office，电子表格，云 REST API，删除工作表
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,删除工作簿中匹配的工作表。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>DeleteWorksheets</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="matchCondition,类：matchconditionrequest，" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
