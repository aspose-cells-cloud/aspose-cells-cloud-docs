...
type: docs
url: /zh/specification/operation/postclearformats/
description: 清除工作表中的单元格格式
kwords: Excel，Office，电子表格，云 REST API，PostClearFormats
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearformats,POST,清除工作表中的单元格格式。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats\'>PostClearFormats</a>" >}}
