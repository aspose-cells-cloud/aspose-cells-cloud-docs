...
type: docs
url: /zh/specification/operation/deleteworksheetcolumns/
description: 删除工作表中的工作表列
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},DELETE,删除工作表中的工作表列。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetColumns\'>DeleteWorksheetColumns</a>" >}}
