...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},DELETE,删除工作表中的工作表列。,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetColumns\'>删除WorksheetColumns</a>" >}}
