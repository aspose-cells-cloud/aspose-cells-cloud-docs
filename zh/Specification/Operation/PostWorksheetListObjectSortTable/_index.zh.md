...
type: docs
url: /zh/specification/operation/postworksheetlistobjectsorttable/
description: 对工作表中的列表对象进行排序
kwords: Excel，Office，电子表格，云 REST API，PostWorksheetListObjectSortTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/sort,POST,对工作表中的列表对象进行排序。,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSortTable\'>PostWorksheetListObjectSortTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataSorter，class：datasorter，表示数据范围的排序顺序。" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
