...
type: docs
url: /zh/specification/operation/getchartcategoryaxis/
description: 检索图表中图表系列轴的描述
kwords: Excel，Office，电子表格，云 REST API，GetChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,GET,检索图表中图表系列轴的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis\'>GetChartCategoryAxis</a>" >}}
