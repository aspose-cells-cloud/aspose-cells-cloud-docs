...
type: docs
url: /zh/specification/operation/getworksheetpagecount/
description: 获取工作表中的页数
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagecount,GET,获取工作表中的页数。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetPageCount\'>GetWorksheetPageCount</a>" >}}
