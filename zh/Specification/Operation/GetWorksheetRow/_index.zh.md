...
type: docs
url: /zh/specification/operation/getworksheetrow/
description: 根据工作表中行的索引检索行数据
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},GET,通过工作表中的行索引检索行数据。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRow\'>GetWorksheetRow</a>" >}}
