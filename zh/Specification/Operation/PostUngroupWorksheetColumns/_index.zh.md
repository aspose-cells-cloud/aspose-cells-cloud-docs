...
type: docs
url: /zh/specification/operation/postungroupworksheetcolumns/
description: 取消工作表列的分组
kwords: Excel，Office，电子表格，Cloud REST API，PostUngroupWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,取消分组工作表列。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns\'>PostUngroupWorksheetColumns</a>" >}}
