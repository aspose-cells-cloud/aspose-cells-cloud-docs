...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,取消工作表列的分组。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns\'> PostUngroupWorksheetColumns</a>" >}}
