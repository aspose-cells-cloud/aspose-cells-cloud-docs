...
type: docs
url: /zh/specification/operation/getpagecount/
description: 获取工作簿中的页数
kwords: Excel, Office, 电子表格, Cloud REST API, GetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/pagecount,GET,获取工作簿中的页数。,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount\'>GetPageCount</a>" >}}
