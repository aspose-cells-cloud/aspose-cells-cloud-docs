...
type: docs
url: /zh/specification/operation/postclearcontents/
description: 清除工作表中的单元格区域内容
kwords: Excel, Office, 电子表格, Cloud REST API, PostClearContents
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearcontents,POST,清除工作表中的单元格区域内容。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearContents\'>PostClearContents</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="endRow，integer，结束行索引。" >}} 
