...
type: docs
url: /zh/specification/operation/postworksheetmerge/
description: 合并工作表中的单元格
kwords: Excel，Office，电子表格，云 REST API，PostWorksheetMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/merge,POST,合并工作表中的单元格。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge\'>PostWorksheetMerge</a>" >}}
