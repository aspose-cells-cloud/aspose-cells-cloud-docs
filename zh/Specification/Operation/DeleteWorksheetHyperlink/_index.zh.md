...
type: docs
url: /zh/specification/operation/deleteworksheethyperlink/
description: 按工作表中的索引删除超链接
kwords: Excel，Office，电子表格，Cloud REST API，DeleteWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},DELETE,按工作表中的索引删除超链接。,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlink\'>DeleteWorksheetHyperlink</a>" >}}
