...
type: docs
url: /zh/specification/operation/postworksheetautofilterrefresh/
description: 刷新工作表中的自动筛选器
kwords: Excel，Office，电子表格，云 REST API，PostWorksheetAutoFilterRefresh
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/refresh,POST,刷新工作表中的自动过滤器。,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetAutoFilterRefresh\'>PostWorksheetAutoFilterRefresh</a>" >}}
