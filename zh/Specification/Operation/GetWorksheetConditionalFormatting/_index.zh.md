...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},GET,检索工作表中的条件格式说明。,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings /GetWorksheetConditionalFormatting\'>GetWorksheetConditionalFormatting</a>" >}}
