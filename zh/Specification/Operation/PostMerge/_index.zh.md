...
type: docs
url: /zh/specification/operation/postmerge/
description: 合并工作表中的单元格
kwords: Excel，Office，电子表格，云 REST API，PostMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/merge,POST,合并工作表中的单元格。,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMerge\'>PostMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergeToOneSheet,boolean,将所有工作簿合并到一张工作表中。" >}} 
