...
type: docs
url: /zh/specification/operation/deleteworksheetoleobject/
description: 删除工作表中的 OLE 对象
kwords: Excel, Office, 电子表格, Cloud REST API, DeleteWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects/{oleObjectIndex},DELETE,删除工作表中的 OLE 对象。,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/DeleteWorksheetOleObject\'>DeleteWorksheetOleObject</a>" >}}
