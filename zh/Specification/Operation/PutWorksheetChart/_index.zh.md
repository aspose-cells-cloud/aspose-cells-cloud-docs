...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightRow,integer,新图表的左下行。" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" isVertical,boolean,指定是否按行或按列绘制一系列单元格值的序列。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="categoryData,string,获取或设置类别轴值的范围。它可以是一系列单元格（例如“D1:E10”）。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAutoGetSerialName,boolean,指定是否自动更新序列号。" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dataLabels,boolean,表示指定图表的数据标签值显示行为。 True 则显示值，False 则隐藏它们。" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="ivotTableSheet,string,来源是数据透视表的数据。如果 PivotSource 不为空，则图表是数据透视图。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hubTableName,字符串,数据透视表名称。" >}} 
