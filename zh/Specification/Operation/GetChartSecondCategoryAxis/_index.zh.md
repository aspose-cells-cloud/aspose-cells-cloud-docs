...
type: docs
url: /zh/specification/operation/getchartsecondcategoryaxis/
description: 检索图表中的第二个分类轴
kwords: Excel，Office，电子表格，云 REST API，GetChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,GET,检索图表中的第二个类别轴,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
