...
type: docs
url: /zh/specification/operation/puthorizontalpagebreak/
description: 在工作表中添加水平分页符
kwords: Excel, Office, 电子表格, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,在工作表中添加水平分页符。,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\'>PutHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn，integer，起始列索引，从零开始。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn，integer，结束列索引，从零开始。" >}} 
