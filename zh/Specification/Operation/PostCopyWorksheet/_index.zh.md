...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,从另一个工作表复制内容和格式。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'>后复制工作表</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceSheet，字符串，源工作表。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceWorkbook，字符串，源工作簿。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder，字符串，原始工作簿文件夹。" >}} 
