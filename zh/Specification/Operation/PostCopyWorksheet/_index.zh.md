...
type: docs
url: /zh/specification/operation/postcopyworksheet/
description: 从另一个工作表复制内容和格式
kwords: Excel，Office，电子表格，云 REST API，PostCopyWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,从另一个工作表复制内容和格式。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'>PostCopyWorksheet</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceSheet，string，源工作表。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="源工作簿，字符串，源工作簿。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder，string，原始工作簿文件夹。" >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:copyoptions,表示复制选项。" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
