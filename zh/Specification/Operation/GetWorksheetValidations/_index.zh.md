...
type: docs
url: /zh/specification/operation/getworksheetvalidations/
description: 检索工作表中验证的描述
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,GET,检索工作表中验证的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations\'>GetWorksheetValidations</a>" >}}
