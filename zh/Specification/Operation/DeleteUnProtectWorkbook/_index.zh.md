...
type: docs
url: /zh/specification/operation/deleteunprotectworkbook/
description: Excel 解除保护
kwords: Excel，Office，电子表格，云 REST API，DeleteUnProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/protection,DELETE,Excel 取消保护。,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/DeleteUnProtectWorkbook\'>DeleteUnProtectWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="密码，字符串，保护设置，只能指定密码。" >}} 
