...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},DELETE,删除工作簿中的工作表。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheet\'>DeleteWorksheet</一个>" >}}
