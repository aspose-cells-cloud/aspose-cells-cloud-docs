...
type: docs
url: /zh/specification/operation/deleteworksheetoleobjects/
description: 删除工作表中的所有 OLE 对象
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetOleObjects
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,DELETE,删除工作表中的所有 OLE 对象。,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/DeleteWorksheetOleObjects\'>DeleteWorksheetOleObjects</a>" >}}
