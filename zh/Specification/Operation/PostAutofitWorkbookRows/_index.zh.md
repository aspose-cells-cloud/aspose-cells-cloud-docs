...
description: 工作簿中的自动调整行
kwords: Excel，Office，电子表格，云 REST API，PostAutofitWorkbookRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/autofitrows,POST,自动调整工作簿中的行。,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookRows\'>PostAutofitWorkbookRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow，integer，开始行。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow，整数，结束行。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto，boolean，仅自动。" >}} 
