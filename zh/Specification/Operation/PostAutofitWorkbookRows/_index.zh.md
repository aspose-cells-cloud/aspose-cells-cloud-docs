...
type: docs
url: /zh/specification/operation/postautofitworkbookrows/
description: 自动调整工作簿中的行
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/autofitrows,POST,工作簿中的自动调整行。,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookRows\'>PostAutofitWorkbookRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow，整数，起始行。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow，整数，结束行。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto，布尔值，仅自动。" >}} 
