---
title: PostWorksheetListObject删除重复项
second_title: Aspose.Cells Cloud Documen
type: docs
url: /zh/specification/operation/postworksheetlistobjectremoveduplicates/
description: 删除列表对象中的重复项
kwords: Excel，Office，电子表格，云 REST API，PostWorksheetListObjectRemoveDuplicates
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/RemoveDuplicates,POST,删除列表对象中的重复项。,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectRemoveDuplicates\'>PostWorksheetListObjectRemoveDuplicates</a>" >}}
