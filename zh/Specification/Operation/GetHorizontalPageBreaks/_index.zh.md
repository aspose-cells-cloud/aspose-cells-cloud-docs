...
type: docs
url: /zh/specification/operation/gethorizontalpagebreaks/
description: 检索工作表中水平分页符的描述
kwords: Excel, Office, 电子表格, Cloud REST API, GetHorizontalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,检索工作表中水平分页符的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks\'>GetHorizontalPageBreaks</a>" >}}
