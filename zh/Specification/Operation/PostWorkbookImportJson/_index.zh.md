...
description: 将 JSON 数据文件导入到工作簿中。 JSON 数据文件可以是云文件或来自 HTTP URI 的数据
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/importjson,POST,将 JSON 数据文件导入到工作簿中。 JSON 数据文件可以是云文件，也可以是来自 HTTP URI 的数据。<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostWorkbookImportJson\'>PostWorkbookImportJson</a>" >}}
