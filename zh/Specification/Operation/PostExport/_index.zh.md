...
type: docs
url: /zh/specification/operation/postexport/
description: 将 Excel 内部元素或工作簿本身导出为各种格式的文件
kwords: Excel, Office, 电子表格, Cloud REST API, PostExport
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/export,POST,将 Excel 内部元素或工作簿本身导出为各种格式的文件。,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostExport\'>PostExport</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="objectType，string，导出的对象类型：workbook/worksheet/chart/comment/picture/shape/listobject/oleobject。" >}} 
