...
description: 将 Excel 内部元素或工作簿本身导出为各种格式文件
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/export,POST,将 Excel 内部元素或工作簿本身导出为各种格式文件。,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostExport\'>PostExport</a>" >}}
