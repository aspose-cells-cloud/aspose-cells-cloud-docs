...
type: docs
url: /zh/specification/operation/deleteworkbookbackground/
description: 删除工作簿中的背景
kwords: Excel，Office，电子表格，云 REST API，DeleteWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,DELETE,删除工作簿中的背景。,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground\'>DeleteWorkbookBackground</a>" >}}
