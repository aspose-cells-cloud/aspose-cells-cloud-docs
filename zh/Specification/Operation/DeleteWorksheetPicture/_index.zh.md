...
type: docs
url: /zh/specification/operation/deleteworksheetpicture/
description: 根据工作表中的索引删除图片对象
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},DELETE,根据工作表中的索引删除图片对象。,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPicture\'>DeleteWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="参数名称、类型、描述" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="pictureIndex，整数，图片索引。" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
