...
type: docs
url: /zh/specification/operation/postworksheetmatchblanks/
description: 匹配列表中的所有空白单元格
kwords: Excel，Office，电子表格，云 REST API，PostWorksheetMatchBlanks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchBlanks,POST,匹配列表中的所有空白单元格。,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks\'>PostWorksheetMatchBlanks</a>" >}}
