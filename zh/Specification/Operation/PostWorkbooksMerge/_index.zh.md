...
type: docs
url: /zh/specification/operation/postworkbooksmerge/
description: 将工作簿合并到现有工作簿中
kwords: Excel，Office，电子表格，云 REST API，PostWorkbooksMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/merge,POST,将工作簿合并到现有工作簿中。,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge\'>PostWorkbooksMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mergeWith，string，要合并的工作簿。" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergedStorageName，string，存储名称。" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
