...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/filter,PUT,为工作表中的列添加过滤器。,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter /PutWorksheetFilter\'>PutWorksheetFilter</a>" >}}
