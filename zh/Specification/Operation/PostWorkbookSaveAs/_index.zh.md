...
kwords: Excel，Office，电子表格，云 REST API，PostWorkbookSaveAs
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="newfilename,string,newfilename 保存结果。`newfilename` 应该包含文件名和扩展名。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAutoFitRows，boolean，指示是否在工作簿中自动调整行。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAutoFitColumns，boolean，指示是否在工作簿中自动调整列。" >}} 
