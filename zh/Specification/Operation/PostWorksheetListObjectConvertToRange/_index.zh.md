...
type: docs
url: /zh/specification/operation/postworksheetlistobjectconverttorange/
description: 将列表对象转换为工作表中的范围
kwords: Excel，Office，电子表格，云 REST API，PostWorksheetListObjectConvertToRange
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/ConvertToRange,POST,将列表对象转换为工作表中的范围。,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectConvertToRange\'>PostWorksheetListObjectConvertToRange</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="参数名称、类型、描述" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="listObjectIndex，整数，列表对象索引。" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
