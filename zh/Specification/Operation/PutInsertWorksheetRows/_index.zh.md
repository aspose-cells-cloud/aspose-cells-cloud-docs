...
type: docs
url: /zh/specification/operation/putinsertworksheetrows/
description: 在工作表中插入几行新行
kwords: Excel，Office，电子表格，云 REST API，PutInsertWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,PUT,在工作表中插入几行新行。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRows\'>PutInsertWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference，boolean，表示是否更新其他工作表中的引用。" >}} 
