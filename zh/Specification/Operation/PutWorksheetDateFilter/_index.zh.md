...
kwords: Excel，Office，电子表格，云 REST API，PutWorksheetDateFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType，string，指定如何对日期时间值（日、时、分、月、秒、年）进行分组。" >}} 
