...
type: docs
url: /zh/specification/operation/postrenameworksheet/
description: 重命名工作簿中的工作表
kwords: Excel，Office，电子表格，云 REST API，PostRenameWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/rename,POST,重命名工作簿中的工作表。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostRenameWorksheet\'>PostRenameWorksheet</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="newname，string，新工作表名称。" >}} 
