...
type: docs
url: /zh/specification/operation/deletemetadata/
description: 删除 Excel 文件中的单元格文档属性，并将其保存为各种格式
kwords: Excel，Office，电子表格，云 REST API，删除元数据
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/delete,POST,删除 Excel 文件中的单元格文档属性，并以各种格式保存。,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/DeleteMetadata\'>DeleteMetadata</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="类型，字符串，Cells 文档属性名称。" >}} 
