...
description: 删除Excel文件中的单元格文档属性，并保存为各种格式
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/delete,POST,删除Excel文件中的单元格文档属性，并保存为各种格式。,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/DeleteMetadata\'>删除元数据</a>" >}}
