...
type: docs
url: /zh/specification/operation/postungroupworksheetrows/
description: 取消工作表中行的分组
kwords: Excel，Office，电子表格，Cloud REST API，PostUngroupWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/ungroup,POST,取消工作表中行的分组。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows\'>PostUngroupWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="isAll,boolean,是否所有行均被操作" >}} 
