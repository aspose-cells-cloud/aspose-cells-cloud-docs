...
type: docs
url: /zh/specification/operation/postupdateworksheetcellstyle/
description: 使用工作表中的单元格名称设置单元格样式
kwords: Excel，Office，电子表格，云 REST API，PostUpdateWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,POST,使用工作表中的单元格名称设置单元格样式。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUpdateWorksheetCellStyle\'>PostUpdateWorksheetCellStyle</a>" >}}
