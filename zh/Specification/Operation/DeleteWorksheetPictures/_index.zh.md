...
type: docs
url: /zh/specification/operation/deleteworksheetpictures/
description: 删除工作表中的所有图片
kwords: Excel，Office，电子表格，Cloud REST API，删除工作表图片
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,删除工作表中的所有图片。,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures\'>DeleteWorksheetPictures</a>" >}}
