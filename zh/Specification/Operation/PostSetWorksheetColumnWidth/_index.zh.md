...
type: docs
url: /zh/specification/operation/postsetworksheetcolumnwidth/
description: 设置工作表列宽
kwords: Excel，Office，电子表格，云 REST API，PostSetWorksheetColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},POST,设置工作表列宽。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostSetWorksheetColumnWidth\'>PostSetWorksheetColumnWidth</a>" >}}
