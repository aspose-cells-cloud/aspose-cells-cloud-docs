...
type: docs
url: /zh/specification/operation/getworksheettextitems/
description: 检索工作表中的文本项
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetTextItems
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/textItems,GET,检索工作表中的文本项。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetTextItems\'>GetWorksheetTextItems</a>" >}}
