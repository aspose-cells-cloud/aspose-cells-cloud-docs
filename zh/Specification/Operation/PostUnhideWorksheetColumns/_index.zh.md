...
type: docs
url: /zh/specification/operation/postunhideworksheetcolumns/
description: 取消隐藏工作表中的工作表列
kwords: Excel，Office，电子表格，Cloud REST API，PostUnhideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,取消隐藏工作表中的工作表列。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetColumns\'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,获取和设置以字符为单位的列宽。" >}} 
