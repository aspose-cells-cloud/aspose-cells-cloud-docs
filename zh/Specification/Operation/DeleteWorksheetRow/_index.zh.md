...
type: docs
url: /zh/specification/operation/deleteworksheetrow/
description: 删除工作表中的一行
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},DELETE,删除工作表中的一行。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRow\'>DeleteWorksheetRow</a>" >}}
