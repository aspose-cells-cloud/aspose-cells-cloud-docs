...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,更新数据透视表中的单元格样式。,<a href=\'https://apireference.aspose.cloud/cells/#/数据透视表/PostPivotTableCellStyle\'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="column,integer,单元格的列索引。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="row,integer,单元格的行索引。" >}} 
