...
type: docs
url: /zh/specification/operation/getworksheetcolumns/
description: 检索工作表列的描述
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,检索工作表列的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\'>GetWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="offset，integer，workdook 文件夹。" >}} 
