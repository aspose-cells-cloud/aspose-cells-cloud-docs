...
type: docs
url: /zh/specification/operation/deleteworksheetcomment/
description: 删除工作表中的单元格注释
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},DELETE,删除工作表中的单元格注释。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComment\'>DeleteWorksheetComment</a>" >}}
