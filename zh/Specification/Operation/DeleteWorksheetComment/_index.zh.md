...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},DELETE,删除工作表中的单元格注释。,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/删除工作表注释\'>删除工作表注释</a>" >}}
