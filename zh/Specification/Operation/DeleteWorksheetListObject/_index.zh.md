...
type: docs
url: /zh/specification/operation/deleteworksheetlistobject/
description: 按工作表中的索引删除列表对象
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex},DELETE,按工作表中的索引删除列表对象。,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/DeleteWorksheetListObject\'>DeleteWorksheetListObject</a>" >}}
