...
type: docs
url: /zh/specification/operation/deleteworksheetrows/
description: 删除工作表中的几行
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,DELETE,删除工作表中的几行。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows\'>DeleteWorksheetRows</a>" >}}
