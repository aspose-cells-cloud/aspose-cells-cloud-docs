...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,DELETE,删除工作表中的多行。,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows \'>删除工作表行</a>" >}}
