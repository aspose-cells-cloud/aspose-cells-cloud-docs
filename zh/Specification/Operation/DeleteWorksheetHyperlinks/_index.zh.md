...
type: docs
url: /zh/specification/operation/deleteworksheethyperlinks/
description: 删除工作表中的所有超链接
kwords: Excel，Office，电子表格，Cloud REST API，删除工作表超链接
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,DELETE,删除工作表中的所有超链接。,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlinks\'>DeleteWorksheetHyperlinks</a>" >}}
