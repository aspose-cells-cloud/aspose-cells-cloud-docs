...
type: docs
url: /zh/specification/operation/postchartcategoryaxis/
description: 更新图表中的图表类别轴
kwords: Excel，Office，电子表格，云 REST API，PostChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,POST,更新图表中的图表类别轴。,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/PostChartCategoryAxis\'>PostChartCategoryAxis</a>" >}}
