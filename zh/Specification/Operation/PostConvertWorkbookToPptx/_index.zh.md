...
type: docs
url: /zh/specification/operation/postconvertworkbooktopptx/
description: 将 Excel 文件转换为 Pptx 文件
kwords: Excel，Office，电子表格，云 REST API，PostConvertWorkbookToPptx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pptx,POST,将 Excel 文件转换为 Pptx 文件。,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPptx\'>PostConvertWorkbookToPptx</a>" >}}
