...
type: docs
url: /zh/specification/operation/deleteworksheetvalidations/
description: 删除工作表中的所有验证
kwords: Excel，Office，电子表格，云 REST API，DeleteWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,DELETE,删除工作表中的所有验证。,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidations\'>DeleteWorksheetValidations</a>" >}}
