...
type: docs
url: /zh/specification/operation/putworksheetshape/
description: 在工作表中添加形状
kwords: Excel，Office，电子表格，云 REST API，PutWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,PUT,在工作表中添加形状。,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape\'>PutWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="DrawingType，string，Shape 对象类型" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow，整数，左上行索引。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn，整数，左上列索引。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="top，整数，表示Spinner相对于其左行的垂直偏移量，以像素为单位。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="left，整数，表示Spinner相对于其左列的水平偏移量，以像素为单位。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width，整数，表示Spinner的高度，单位为像素。" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="height，整数，表示Spinner的宽度，单位为像素。" >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="参数名称、类型、描述" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="shapeDTO，类别：形状，" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
