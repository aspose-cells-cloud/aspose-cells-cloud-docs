...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter,GET,从工作表中检索自动过滤器的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter \'>获取工作表自动筛选</a>" >}}
