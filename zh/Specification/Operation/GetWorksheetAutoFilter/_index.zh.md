...
type: docs
url: /zh/specification/operation/getworksheetautofilter/
description: 从工作表中检索自动过滤器的描述
kwords: Excel，Office，电子表格，云 REST API，GetWorksheetAutoFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter,GET,从工作表中检索自动过滤器的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter\'>GetWorksheetAutoFilter</a>" >}}
