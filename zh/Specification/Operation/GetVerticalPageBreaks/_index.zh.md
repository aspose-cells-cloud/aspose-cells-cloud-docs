...
type: docs
url: /zh/specification/operation/getverticalpagebreaks/
description: 检索工作表中垂直分页符的描述
kwords: Excel，Office，电子表格，云 REST API，GetVerticalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,检索工作表中垂直分页符的描述。,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks\'>GetVerticalPageBreaks</a>" >}}
