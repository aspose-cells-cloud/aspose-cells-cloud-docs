...
type: docs
url: /zh/specification/operation/deleteworksheetchart/
description: 在工作表中按索引删除图表
kwords: Excel，Office，电子表格，Cloud REST API，DeleteWorksheetChart
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,描述,API 参考" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,按工作表中的索引删除图表。,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChart\'>DeleteWorksheetChart</a>" >}}
