...
type: docs
url: /zh/specification/model/docxsaveoptions/
description: Aspose.Cells 云模型规范：DocxSaveOptions。轻松处理 Excel 和其他电子表格文档，具有打开、生成、编辑、拆分、合并、比较和转换等功能
kwords: Excel, Office, 电子表格, Cloud REST API, DocxSaveOptions
weight: 50
---
## **docx保存选项**
