...
linktitle: 删除
type: docs
url: /zh/workbook/background/delete/
aliases: [/delete-background-in-workbook/,/workbook/delete-background/]
keywords: Delete background on an Excel workbook
description: Aspose.Cells Cloud REST API 支持删除 Excel 文件中 Excel 工作簿的背景。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 170
---
此 REST API 指示删除 Excel 工作簿上的背景。
...
|**API**|**类型**|**描述**|**资源链接**|
|:- |:- |:- |:- |
|/细胞/{名称}/背景|删除|删除Excel文件中的背景|[删除工作簿背景](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground)|

这[开放API规范](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDDeleteWorkbookBackgroundocument)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
