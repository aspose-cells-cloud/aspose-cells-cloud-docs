---
title: 在 Excel 工作簿上自动调整行
second_title: Aspose.Cells Cloud Documen
linktitle: 排
type: docs
url: /zh/workbook/autofit/rows/
aliases: [/auto-fit-rows-in-excel-workbooks/]
keywords: Autofit rows on an Excel workboo
description: Aspose.Cells Cloud REST API 支持在 Excel 工作簿上自动调整行。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 90
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、Excel 工作簿上的自动调整行
---
此 REST API 表示在 Excel 工作簿上自动调整行。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookRows)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
