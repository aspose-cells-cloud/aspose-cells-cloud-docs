...
description: Aspose.Cells Cloud REST API 如何从智能标记模板创建 Excel 工作簿。 SDK 支持多种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 30
kwords: Excel，Office 云，REST API，电子表格，PDF，CSV，Json，Markdwon，如何使用模板文件创建 Excel 工作簿
---
此 REST API 表示从 `template file` 创建 `workbook`。
...
|:- |:- |:- |:- |
|/单元格/{名称}|放|从模板文件创建新的 Excel 工作簿|[放置工作簿创建](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate)|
