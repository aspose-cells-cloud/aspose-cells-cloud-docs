...
description: Aspose.Cells Cloud REST API 支持将多个 Excel 文件合并到 Excel 文件中。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 32
---
此 REST API 指示 `merge` 将多个 Excel 文件转换为 Excel 文件。
...
|文件|文件|表单数据|要上传的文件|
|格式|细绳|询问| xlsx|
| mergeToOneSheet|布尔值|询问|错误的|
 
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/LiteCells/PostMerge)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
