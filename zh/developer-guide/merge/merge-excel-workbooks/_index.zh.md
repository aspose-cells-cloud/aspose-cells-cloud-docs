...
linktitle: 工作簿
type: docs
url: /zh/workbook/merge/
aliases: [/merge-excel-workbooks/]
keywords: Merge an Excel Workbooks into other Excel file
description: Aspose.Cells Cloud REST API 支持将 Excel 文件合并到其他 Excel 文件中。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 50
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、将 Excel 工作簿合并到其他 Excel 文件中
---
...
|:- |:- |:- |:- |
|/单元格/{名称}/合并|邮政|合并 Excel 工作簿|[工作簿合并](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge)|
