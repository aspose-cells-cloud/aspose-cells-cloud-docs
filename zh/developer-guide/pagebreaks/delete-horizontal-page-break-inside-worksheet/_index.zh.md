...
weight: 50
---
此 REST API 指示删除 `horizontal` 分页符。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/PageBreaks/DeleteHorizontalPageBreak)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
