...
description: Aspose.Cells Cloud REST API 支持将 Excel 列表对象导出为各种格式的文件。 SDK 支持多种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 导出列表对象
---
...
|:- |:- |:- |:- |
|/单元格/导出|邮政|将请求内容中的 Excel 导出为某种格式|[出口后](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
