...
description: Aspose.Cells Cloud REST API 支持将 Excel 图表导出为各种格式的文件。 SDK 支持各种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
kwords: Excel, Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、导出图表
---
您可以导出以下格式：[PNG](https://docs.fileformat.com/Image/png/), [动态图片](https://docs.fileformat.com/image/gif/), [JPEG](https://docs.fileformat.com/image/jpeg/),  [BMP](https://docs.fileformat.com/image/bmp/), [SVG](https://docs.fileformat.com/page-description-language/svg/), [TIFF](https://docs.fileformat.com/image/tiff/), [EMF](https://docs.fileformat.com/image/emf/), [沃姆福](https://docs.fileformat.com/image/Wmf/), [PDF](https://docs.fileformat.com/pdf/).
