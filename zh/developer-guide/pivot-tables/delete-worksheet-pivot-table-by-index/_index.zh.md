...
description: Aspose.Cells Cloud REST API 支持删除 Excel 文件中的数据透视表。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 70
---
此 REST API 按索引指示 `delete` 工作表数据透视表。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTable)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
