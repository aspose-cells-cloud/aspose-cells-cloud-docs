...
weight: 60
---
这个REST API表示创建一个带有列表对象的`pivottable`。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
