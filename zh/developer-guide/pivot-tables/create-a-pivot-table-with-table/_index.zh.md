...
weight: 60
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 将表格转换为数据透视表
---
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
