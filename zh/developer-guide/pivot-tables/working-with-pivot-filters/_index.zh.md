...
weight: 50
---
此 REST API 表示 `add` 枢轴 `filter` 用于枢轴表索引
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTableFilter)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
