...
description: Aspose.Cells Cloud REST API 支持隐藏数据透视表中的数据透视字段。 SDK 支持多种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 110
kwords: Excel, Office 云，REST API，电子表格，PDF，CSV，Json，Markdwon，隐藏数据透视表中的数据透视字段项
---
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldHideItem)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
