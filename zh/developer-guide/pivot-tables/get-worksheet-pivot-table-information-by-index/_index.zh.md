...
description: Aspose.Cells Cloud REST API 支持在 Excel 文件中获取数据透视表。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 10
---
此 REST API 表示按索引获取工作表 `pivottable` 信息。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/PivotTables/GetWorksheetPivotTable)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
