...
weight: 40
---
此 REST API 指示将 `add` 数据透视字段转换为数据透视表
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/PivotTables/PutPivotTableField)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
