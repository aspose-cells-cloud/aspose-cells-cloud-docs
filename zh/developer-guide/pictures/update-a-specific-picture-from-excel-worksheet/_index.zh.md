...
weight: 70
---
对于 Excel 工作表，此 REST API 按图片索引指示 `update` 图片。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
