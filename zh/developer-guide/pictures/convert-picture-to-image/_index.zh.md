...
description: Aspose.Cells Cloud REST API 支持在 Excel 文件中获取图片。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 10
---
此 REST API 指示 Excel 工作表中的逐个图片索引。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
