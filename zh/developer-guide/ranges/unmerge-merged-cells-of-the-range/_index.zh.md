...
description: Aspose.Cells Cloud REST API 支持取消合并工作表 Excel 范围内的合并单元格。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
kwords: Excel, Office 云，REST API，电子表格，PDF，CSV，Json，Markdwon，取消合并范围内的单元格
---
此 REST API 表示取消合并 Excel 工作表上该范围的合并单元格。
