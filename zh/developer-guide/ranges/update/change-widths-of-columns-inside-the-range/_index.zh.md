...
description: Aspose.Cells Cloud REST API 支持设置工作表 Excel 上的范围的列宽。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 74
kwords: Excel, Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、更改范围内的列宽
---
此 REST API 表示设置范围的列宽
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeColumnWidth)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
