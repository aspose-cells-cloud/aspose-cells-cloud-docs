...
description: Aspose.Cells Cloud REST API 支持将工作表上的多个单元格合并为一个单元格。 SDK 支持多种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
kwords: Excel, Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、将 Cells 的范围合并到单个单元格中
---
此 REST API 表示将一系列单元格合并到 Excel 工作表上的单个单元格中。
