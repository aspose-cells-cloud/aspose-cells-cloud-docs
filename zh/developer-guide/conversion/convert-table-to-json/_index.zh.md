---
title: Aspose.Cells Cloud Web API - 将电子表格数据转换为 Json 文件
second_title: Documen
ArticleTitle: Convert a Spreadsheet Table data to a Json file
linktitle: 将表格转换为 JSO
type: docs
...
description: 使用 Excel API 将本地电子表格高效转换为 JSON 格式。此方法可实现无缝文件处理，无需云存储
weight: 100
kwords: Excel API，JSON转换，云文件转换，电子表格，REST API, Aspose.Cells，本地驱动器处理，文件格式转换
---
使用 Aspose.Cells Cloud Web API 将本地电子表格/Excel 表转换为 json 文件。
...
这[将表格转换为 Json API 规范](https://reference.aspose.cloud/cells/#/ConversionController/ConvertTableToJson)提供可公开访问的编程接口，可直接从 Web 浏览器进行 REST 交互。

### 使用 Aspose.Cells 云 SDK

使用 SDK 是最快的开发方式，因为它抽象了低级细节，允许您使用短代码将电子表格数据转换为 json 文件。
