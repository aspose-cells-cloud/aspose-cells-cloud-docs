---
title: Aspose.Cells 云网 API - 将电子表格工作表转换为图像
...
description: 使用 Aspose.Cells API 将电子表格工作表从本地驱动器高效转换为各种图像格式
weight: 100
kwords: Excel、Office 云、REST API、电子表格、图像转换、SVG、PNG、TIFF、云服务、本地到云转换、匹配 Excel 工作表中的所有空白单元格
---
将本地电子表格/Excel 工作表转换为图像。
...
|格式|细绳|询问|所需图像格式：svg、png、tiff 等。|
...
这[将表格转换为图像 API 规格](https://reference.aspose.cloud/cells/#/ConversionController/ConvertWorksheetToImage)定义一个可公开访问的编程接口，并允许直接从 Web 浏览器进行 REST 交互。
