...
|**API**|**类型**|**描述**|**招摇链接**|
|:- |:- |:- |:- |
|/cells/{名称}/split|邮政|拆分 Excel 工作簿|[后工作簿拆分](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit)|

这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
