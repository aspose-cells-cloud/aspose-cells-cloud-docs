...
linktitle: 多文件
type: docs
url: /zh/split/multi-files/
keywords: Split multi Excel files
description: Aspose.Cells Cloud REST API 支持拆分多个 Excel 文件。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 32
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, Split
---
此 REST Api 指示 `split` 个多 Excel 文件。
