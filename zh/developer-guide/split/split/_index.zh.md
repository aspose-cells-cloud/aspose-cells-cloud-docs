...
description: Aspose.Cells Cloud REST API 支持拆分多个 Excel 文件。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 32
---
此 REST Api 指示 `split` 多个 Excel 文件。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/LiteCells/PostSplit)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
