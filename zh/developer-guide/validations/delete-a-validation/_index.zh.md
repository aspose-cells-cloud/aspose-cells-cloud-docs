---
title: 删除 Excel 工作表上的工作表验证
second_title: Aspose.Cells Cloud Documen
linktitle: 刪除
type: docs
url: /zh/validations/delete/
keywords: Delete a worksheet validation on an Excel worksheet
description: Aspose.Cells Cloud REST API 支持删除 Excel 工作表上的工作表验证。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 10
kwords: Excel，Office 云，REST API，电子表格，PDF，CSV，Json，Markdwon，删除 Excel 工作表上的工作表验证
---
此 REST API 表示通过 Excel 工作表上的索引删除工作表验证。
