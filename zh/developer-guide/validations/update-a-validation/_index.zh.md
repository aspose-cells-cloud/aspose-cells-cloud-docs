...
weight: 10
---
此 REST API 指示通过 Excel 工作表上的索引更新工作表验证。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
