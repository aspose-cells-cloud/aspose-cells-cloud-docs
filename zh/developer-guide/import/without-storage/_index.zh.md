...
weight: 10
kwords: Excel, Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、无需使用存储即可导入数据
---
Excel 数据导入是一个复杂的过程。许多因素都增加了复杂性，因此在导出过程中应考虑到这些因素。能够以精确的专业质量将各种格式和类型的数据导入文件是 Aspose.Cells Cloud 的一大特色。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/LightCells/PostImport)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
