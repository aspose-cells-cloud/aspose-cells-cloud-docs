...
weight: 110
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、在工作表中隐藏图表图例
---
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChartLegend)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
