...
|是垂直的|布尔值|询问|真的|
|类别数据|细绳|询问|获取或设置类别 Axis 值的范围。它可以是一系列单元格（例如“d1:e10”）。|
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetAddChart)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
