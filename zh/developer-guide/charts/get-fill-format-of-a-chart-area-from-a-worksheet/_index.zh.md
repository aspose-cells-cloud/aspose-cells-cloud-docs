---
title: 从工作表中获取图表区域的填充格式
type: docs
url: /zh/charts/chart-area/fill-format/get/
aliases: [/get-fill-format-of-a-chart-area-from-a-worksheet/]
weight: 70
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 从工作表中获取图表区域的填充格式
---
此 REST API 表示获取图表区域填充格式信息。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartAreaFillFormat)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
