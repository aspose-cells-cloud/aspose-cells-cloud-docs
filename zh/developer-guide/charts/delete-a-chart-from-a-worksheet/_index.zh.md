...
weight: 40
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 从工作表中删除图表
---
此 REST API 表示通过索引删除工作表图表。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetDeleteChart)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
