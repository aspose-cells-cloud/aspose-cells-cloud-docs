...
weight: 100
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 在工作表中显示图表图例
---
此 REST API 表示在图表中显示图例
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartLegend)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
