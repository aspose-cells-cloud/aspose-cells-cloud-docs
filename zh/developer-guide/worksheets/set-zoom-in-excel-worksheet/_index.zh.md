...
description: Aspose.Cells Cloud REST API 支持为 Excel 工作表设置缩放。SDK 支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、设置 Excel 工作表的缩放
---
这个 REST API 表示 `set the zoom value of Excel worksheet`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/PostUpdateWorksheetZoom)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
