...
description: Aspose.Cells Cloud REST API 支持冻结工作表上的窗格。 SDK 支持多种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 190
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、冻结工作表上的窗格 Excel
---
