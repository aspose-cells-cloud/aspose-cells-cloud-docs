...
description: Aspose.Cells Cloud REST API 支持将 Excel 工作表名称重命名为 Excel 工作簿上的新名称。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
---
这个 REST API 表示 `worksheet rename`
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/PostRenameWorksheet)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
