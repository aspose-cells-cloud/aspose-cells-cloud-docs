...
weight: 20
---
此 REST API 表示 `copy a worksheet` 并在同一工作簿中以新名称保存
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
