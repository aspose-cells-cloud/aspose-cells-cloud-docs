...
weight: 20
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、更新 Excel 工作表上的属性
---
这个 REST API 表示 `update worksheet base properties`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/PostUpdateWorksheetProperty)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
