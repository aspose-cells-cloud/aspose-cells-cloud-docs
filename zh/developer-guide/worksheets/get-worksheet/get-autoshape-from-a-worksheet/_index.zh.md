...
description: Aspose.Cells Cloud REST API 支持将自动形状从 Excel 工作表转换为不同的格式。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 10
---
这个REST API表示`get autoshape info`。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Autoshapes/GetWorksheetAutoshape)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
