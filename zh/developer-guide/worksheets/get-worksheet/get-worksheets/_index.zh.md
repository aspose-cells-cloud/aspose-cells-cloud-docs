...
description: Aspose.Cells Cloud REST API 支持从 Excel 工作簿获取工作表描述。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 10
---
这个 REST API 表示 `get worksheets information`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
