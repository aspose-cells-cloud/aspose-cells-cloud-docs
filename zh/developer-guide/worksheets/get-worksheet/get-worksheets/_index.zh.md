...
weight: 10
---
这个REST API表示`get worksheets information`。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
