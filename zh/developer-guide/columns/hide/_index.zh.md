...
description: Aspose.Cells Cloud REST API 支持隐藏 Excel 工作表上的列。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 40
---
此 REST API 表示隐藏工作表列。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Cells/PostHideWorksheetColumns)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
