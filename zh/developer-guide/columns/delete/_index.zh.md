---
title: 删除 Excel 工作表上的一列
second_title: Aspose.Cells Cloud Documen
linktitle: 刪除
type: docs
url: /zh/columns/delete/
aliases: [/delete-column-from-an-excel-worksheet/,/delete-column-from-a-worksheet/]
keywords: Delete column on an Excel workshee
description: Aspose.Cells Cloud REST API 支持删除 Excel 工作表上的列。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 80
kwords: Excel，Office 云，REST API，电子表格，PDF，CSV，Json，Markdwon，删除 Excel 工作表上的一列
---
此 REST API 副本 `column` 在 Excel 工作表中。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetColumns)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
