...
description: Aspose.Cells Cloud REST API 支持对 Excel 工作表上的列取消分组。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 70
---
...
|最后索引|整数|询问|最后要操作的列索引。|
|文件夹|细绳|询问|文档文件夹。|
|存储名称|细绳|询问|存储名称。|


这[开放API规范](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
