...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上对列进行分组。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 60
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、Excel 工作表上的分组列
---
此 REST API 表示组工作表列。
