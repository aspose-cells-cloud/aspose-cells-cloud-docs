...
|:- |:- |:- |:- |
|文件|文件|表单数据|要上传的文件|
|对象类型|细绳|询问|重复行/空白列/空白行/公式/内容/样式/图表/注释/图片/形状/列表对象/超链接/oleobject/数据透视表/验证/背景|
 
这[开放API规范](https://apireference.aspose.cloud/cells/#/LightCells/PostClearObjects)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
