...
description: Cells.Cloud API for Excel操作：解密Excel工作簿
weight: 50
---
...
|**API**|**类型**|**描述**|**招摇链接**|
|:- |:- |:- |:- |
|/cells/{name}/加密|删除|解密文档|[删除解密文档](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDocument)|


这[开放API规范](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDocument)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
