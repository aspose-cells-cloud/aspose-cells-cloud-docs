...
linktitle: 解密
type: docs
url: /zh/workbook/decrypt/
aliases: [/decrypt-excel-workbooks/]
keywords: REST API, spreadsheets, excel, decryp
description: Cells.Cloud API 为 Excel 操作：解密 Excel 工作簿
weight: 50
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、解密 Excel 工作簿
---
...
|:- |:- |:- |:- |
|/单元格/{名称}/加密|删除|解密文档|[删除解密文档](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDocument)|


这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDocument)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
