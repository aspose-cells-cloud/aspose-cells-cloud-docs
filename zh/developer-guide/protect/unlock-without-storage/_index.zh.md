...
linktitle: 无需使用存储即可解密
type: docs
url: /zh/unlock/without-using-storage/
aliases: [/unlock/without-storage/,/unlock/]
keywords: Unlock Excel files
description: Aspose.Cells Cloud REST API 支持解锁 Excel 文件。SDK 支持多种开发语言。包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 70
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 解锁
---
此 REST API 表示 `unlock` Excel 文件。
## 重置 API
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/LightCells/PostUnlock)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
