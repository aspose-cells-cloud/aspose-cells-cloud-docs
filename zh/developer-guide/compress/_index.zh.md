...
description: Aspose.Cells Cloud REST API 支持压缩excel文件。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 39
---
此 REST API 指示 Excel 文件中的 `compress` 数据。

- 压缩 XLS、XLSX、XLSM、XLSB、ODS
- 压缩多个Excel电子表格文件的快速方法
- 选择压缩级别
- 支持多文件
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/LightCells/PostCompress)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
