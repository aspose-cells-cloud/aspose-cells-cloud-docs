...
description: Aspose.Cells Cloud REST API 支持从 Excel 文件中获取图片。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 10
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、获取 Excel 文件中的图片
---
此 REST API 指示从 Excel 工作表逐张图片索引到 `get`。
...
这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
