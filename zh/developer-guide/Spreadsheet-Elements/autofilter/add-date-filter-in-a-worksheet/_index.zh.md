...
description: Aspose.Cells Cloud API 支持在 Excel 工作表中添加日期筛选器。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 65
...
这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDateFilter)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
