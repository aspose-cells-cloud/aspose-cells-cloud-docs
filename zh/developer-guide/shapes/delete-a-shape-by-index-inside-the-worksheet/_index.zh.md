...
description: Aspose.Cells Cloud REST API 支持删除 Excel 工作表上的形状。SDK 支持多种开发语言。包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 50
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、通过索引删除 Excel 工作表上的形状
---
