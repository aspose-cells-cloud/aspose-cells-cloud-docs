...
description: Aspose.Cells Cloud REST API 支持更新 Excel 工作表上的形状。SDK 支持多种开发语言。其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 31
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、更新 Excel 工作表上的形状
---
此 REST API 表示更新 Excel 工作表上的形状。
