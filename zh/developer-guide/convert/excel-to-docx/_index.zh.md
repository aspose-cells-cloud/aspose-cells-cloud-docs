...
linktitle: Excel 转至医生
type: docs
url: /zh/convert/excel-to-docx/
aliases: [/convert-excel-file-to-docx-in-cloud/]
keywords: Convert excel files to docx files
description: Aspose.Cells Cloud REST API 支持将excel文件转换为docx文件。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 90
---
此 REST API `saveas` excel 文件到 Docx。
...
此 REST API `convert` excel 文件到 Docx。
...
此 REST API `export` excel 文件到 Docx。
