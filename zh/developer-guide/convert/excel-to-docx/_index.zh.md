...
linktitle: Excel 致 Doc
type: docs
url: /zh/convert/excel-to-docx/
aliases: [/convert-excel-file-to-docx-in-cloud/]
keywords: Convert excel files to docx files
description: Aspose.Cells Cloud REST API 支持将 excel 文件转换为 docx 文件。SDK 支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 90
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、Excel 至 Docx
---
此 REST API `saveas` excel 文件转换为 Docx。

[POST /单元格/{名称}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API 允许您使用附加设置将 MS Excel 文件保存为 Docx 文件，并将结果保存到存储中。
...
[获取 /cells/{名称}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API 允许您使用附加设置将 MS Excel 文件转换为 Docx 文件，并将结果保存到响应中。
