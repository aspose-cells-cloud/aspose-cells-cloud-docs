...
linktitle: 康韦尔
type: docs
url: /zh/convert/excel-to-different-formats/
...
weight: 10
kwords: Excel, Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、转换 Excel
---
此 REST API 表示将 `convert` excel 文件转换为不同格式的文件。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
