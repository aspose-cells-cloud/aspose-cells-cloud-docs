...
description: Aspose.Cells Cloud REST API 支持将 Excel 文件转换为 SQL 文件。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 100
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、Excel 到 SQL
---
此 REST API 指示 `convert` 将电子表格文件转换为 SQL 格式文件。
