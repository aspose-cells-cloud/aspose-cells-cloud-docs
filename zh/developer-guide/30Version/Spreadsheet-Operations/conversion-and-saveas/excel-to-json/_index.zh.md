...
weight: 100
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、Excel 至 Json
---
此 REST API 指示 `convert` 电子表格文件为 json 格式文件。
...
这[OpenAPI 规范](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
