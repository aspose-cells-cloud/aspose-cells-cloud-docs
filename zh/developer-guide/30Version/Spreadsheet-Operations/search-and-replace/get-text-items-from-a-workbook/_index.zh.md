...
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、从 Excel 工作簿中获取文本项
---
此 REST API 表示 Excel 工作簿中的 `read` 工作簿的 `text items`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
