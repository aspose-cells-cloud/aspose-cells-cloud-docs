...
description: Aspose.Cells Cloud REST API 支持获取 Excel 工作簿上的名称。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 120
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、从 Excel 工作簿中获取名称
---
