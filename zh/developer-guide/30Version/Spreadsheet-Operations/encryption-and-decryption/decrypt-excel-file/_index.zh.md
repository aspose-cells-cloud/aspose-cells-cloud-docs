...
|:- |:- |:- |:- |
|/cells/{name}/加密|删除|解密文档|[删除解密工作簿](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptWorkbook)|

这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptWorkbook)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
