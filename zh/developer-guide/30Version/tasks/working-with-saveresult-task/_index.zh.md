---
title: 使用 SaveResult Tas
second_title: Aspose.Cells Cloud Documen
type: docs
url: /zh/tasks/save-result/
aliases: [/working-with-saveresult-task/]
keywords: REST API, task, save result, spreadsheets, exce
description: Cells.Cloud API 用于 Excel 操作：任务支持将结果保存到响应内容或云存储中
weight: 50
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 使用 SaveResult 任务
---
## 休息 API
