...
weight: 10
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、获取文件中的图片 Excel
---
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
