...
weight: 20
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 范围排序
---
此 REST API 表示范围排序。
...
这[OpenAPI规范](https://reference.aspose.cloud/cells/#/RangesController/PostWorksheetCellsRangeSort)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
