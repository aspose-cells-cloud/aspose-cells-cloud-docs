...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上设置范围的列宽。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 74
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、更改范围内的列宽
---
