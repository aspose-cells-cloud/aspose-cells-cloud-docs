...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上取消隐藏行。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 50
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、取消隐藏 Excel 工作表上的行
---
此 REST API 表示取消隐藏 Excel 工作表上的行。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetRows)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
