...
weight: 10
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、从 Excel 工作表中获取行信息
---
此 REST API 表示获取 Excel 工作表上的行信息。
...
|姓名|细绳|小路|工作簿名称。|
|工作表名称|细绳|小路|工作表名称。|
|文件夹|细绳|询问| workdook 文件夹。|
|存储名称|细绳|询问|存储名称。|

这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRows)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
