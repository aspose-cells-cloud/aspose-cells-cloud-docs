...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上添加多行。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 20
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、在 Excel 工作表上添加多行
---
此 REST API 表示在 Excel 工作表上添加几个新的工作表行。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRows)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
