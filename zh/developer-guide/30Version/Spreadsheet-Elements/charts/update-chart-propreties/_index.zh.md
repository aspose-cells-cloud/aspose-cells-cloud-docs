...
title: 更新图表属性
type: docs
url: /zh/charts/propreties/update/
aliases: [/update-chart-propreties/]
weight: 160
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、更新图表属性
---
此 REST API 表示更新图表属性
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Charts/PostWorksheetChart)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
