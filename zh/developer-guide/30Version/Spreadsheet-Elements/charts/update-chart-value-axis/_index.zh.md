...
title: 更新图表值 Axi
type: docs
url: /zh/charts/value-axis/update/
weight: 160
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 更新图表值轴
---
此 REST API 表示更新图表值轴。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Charts/PostChartValueAxis)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
