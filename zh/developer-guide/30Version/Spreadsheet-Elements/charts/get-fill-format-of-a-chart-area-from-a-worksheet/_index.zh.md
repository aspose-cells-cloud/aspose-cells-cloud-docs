...
weight: 70
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 从工作表中获取图表区域的填充格式
---
...
这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartAreaFillFormat)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
