...
weight: 90
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 计算 Cells 公式
---
此 REST API 表示在 Excel 文件中计算 `cells formula`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostCellCalculate)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
