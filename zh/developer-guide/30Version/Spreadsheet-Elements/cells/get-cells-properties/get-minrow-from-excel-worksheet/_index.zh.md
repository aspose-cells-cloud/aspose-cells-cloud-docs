---
title: 从 Excel 工作表获取 MinRow
type: docs
url: /zh/get-minrow-from-excel-worksheet/
weight: 80
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、从 Excel 工作表获取 MinRow
---
此 REST API 表示当 `cellOrMethodName` 参数为 `minrow` 时，在 Excel 文件中获取 `minrow`。
