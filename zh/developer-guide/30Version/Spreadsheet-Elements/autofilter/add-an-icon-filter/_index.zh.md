...
|范围|细绳|询问||
|字段索引|整数|询问||
|图标集类型|细绳|询问|箭头 3/箭头灰色 3/旗帜 3/标志 3/符号 3/符号 32/交通灯 31/交通灯 32/箭头 4/箭头灰色 4/评级 4/红转黑 4/交通灯 4/箭头 5/箭头灰色 5/四分之一 5/评级 5/星星 3/方框 5/三角形 3/无/自定义设置/表情符号 3/颜色表情符号 3|
|图标编号|整数|询问||
|匹配空白|细绳|询问|正确/错误|
|刷新|细绳|询问|正确/错误|
|文件夹|细绳|询问|原始工作簿文件夹。|
