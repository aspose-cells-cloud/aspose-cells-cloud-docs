...
description: Aspose.Cells Cloud API 支持从 Excel 工作表获取自动筛选描述。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 50
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、在 Excel 工作表中获取自动过滤器
---
