---
title: 在 Excel 工作表中添加动态日期过滤器
second_title: Documen
linktitle: 添加动态过滤器
type: docs
url: /zh/autofilter/add-dynamic-filter/
...
description: Aspose.Cells Cloud API 支持在 Excel 工作表上添加动态筛选器。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 65
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、在 Excel 工作表中添加动态日期过滤器
---
此 REST API 表示在 Excel 工作表上添加 `dynamic filter`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDynamicFilter)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
