...
description: Aspose.Cells Cloud REST API 支持获取 Excel 工作表上的所有形状。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 10
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、获取 Excel 工作表上的所有形状
---
