...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上解冻窗格。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 200
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、解冻 Excel 工作表上的窗格
---
