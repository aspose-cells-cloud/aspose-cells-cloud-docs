...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作簿中隐藏 Excel 工作表。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 50
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、隐藏 Excel 工作表
---
此 REST API 表示 `hide worksheet`。
