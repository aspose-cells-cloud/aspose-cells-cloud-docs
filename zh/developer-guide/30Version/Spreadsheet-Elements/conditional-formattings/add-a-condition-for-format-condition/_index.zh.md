...
description: Cells.Cloud API 为 Excel 操作：添加条件
weight: 40
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 添加条件
---
此 REST API 表示为格式条件添加条件。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/PutWorksheetFormatConditionCondition)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
