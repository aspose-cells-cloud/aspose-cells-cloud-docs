...
description: Cells.Cloud API 用于 Excel 操作：获取条件格式
weight: 20
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 获取条件格式
---
此 REST API 表示获取条件格式
...
这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
