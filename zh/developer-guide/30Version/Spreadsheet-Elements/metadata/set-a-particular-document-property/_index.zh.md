...
linktitle: 更新
type: docs
url: /zh/document-properties/update/
aliases: [/set-a-particular-document-property/]
keywords: Update properties from excel files
description: Aspose.Cells Cloud REST API 支持从 Excel 文件更新属性。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 30
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdown, 设置特定文档属性
---
此 REST API 表示 `set/create` 文档属性。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Properties/PutDocumentProperty)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
