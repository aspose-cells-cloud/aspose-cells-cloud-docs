...
description: Aspose.Cells Cloud REST API 支持从 Excel 文件中删除属性。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 58
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、删除所有文档属性
---
此 REST API 指示 `delete all` 自定义文档属性并清理内置属性。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
