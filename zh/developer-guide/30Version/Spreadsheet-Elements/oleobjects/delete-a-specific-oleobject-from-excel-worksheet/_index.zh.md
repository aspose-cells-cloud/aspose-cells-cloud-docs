...
---
此 REST API 指示 `delete` 工作表中的 Excel 个 OLE 对象。
...
这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/OleObjects/DeleteWorksheetOleObject)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
