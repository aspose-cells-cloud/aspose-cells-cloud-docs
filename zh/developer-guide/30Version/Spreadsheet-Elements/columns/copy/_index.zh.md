...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上复制列。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 30
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、复制 Excel 工作表上的列
---
...
这[OpenAPI规范](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetColumns)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
