...
linktitle: 无需使用存储即可更换
type: docs
url: /zh/replace/
keywords: Replace old value by new value on Excel files
description: Aspose.Cells Cloud REST API 支持在 Excel 文件上用新值替换旧值。 SDK 支持多种开发语言。 其中包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 80
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、替换 Excel 文件中的文本
---
此 REST API 表示来自 Excel 文件的 `replace` 数据。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/LightCells/PostReplace)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
