...
---
此 REST API 指示 `convert` 将电子表格文件转换为 html 格式的文件。
...
这[OpenAPI规范](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
