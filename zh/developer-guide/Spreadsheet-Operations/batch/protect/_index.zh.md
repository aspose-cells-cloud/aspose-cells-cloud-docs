...
description: Aspose.Cells Cloud API 支持批量保护多个 Excel 文件。SDK 支持多种开发语言，包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 Swift。
weight: 100
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdown、批量保护
---
此 REST API 表示符合条件的文件为 `batch protection`。
