...
description: Aspose.Cells云API支持在Excel工作表上添加日期过滤器。SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 65
---
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDateFilter)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
