...
description: Aspose.Cells 云API 支持在Excel 工作表上为筛选列添加筛选。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 60
---
此 REST API 指示为 Excel 工作表上的过滤器列添加 `a filter`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetFilter)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
