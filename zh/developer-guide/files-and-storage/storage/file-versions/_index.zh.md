...
description: 了解如何使用 Aspose Cells Cloud REST API SDK 支持各种开发语言获取文件版本。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 100
---
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Storage/GetFileVersions)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
