...
description: Cells.Cloud API 适用于 Excel 操作：从条件格式中删除单元格区域
weight: 70
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 删除单元格区域
---
此 REST API 表示从条件格式中删除单元格区域。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/DeleteWorksheetConditionalFormattingArea)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
