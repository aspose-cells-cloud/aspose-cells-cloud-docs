...
description: Cells.Cloud API 为 Excel 操作：获取评论
weight: 10
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, Get
---
此 REST API 表示通过单元格名称获取工作表注释。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComment)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
