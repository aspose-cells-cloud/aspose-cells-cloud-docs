...
description: Cells.Cloud API 进行 Excel 操作：获取评论
weight: 10
---
此 REST API 表示按单元格名称获取工作表注释。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComment)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
