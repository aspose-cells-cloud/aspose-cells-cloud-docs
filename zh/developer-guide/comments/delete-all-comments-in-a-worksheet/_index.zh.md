...
description: Cells.Cloud API for Excel操作：清除注释
weight: 50
---
此 REST API 指示删除工作表的所有评论。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
