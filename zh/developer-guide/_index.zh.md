---
title: "开发者指南：在 Cells Cloud 中实现转换、合并、拆分、保护、搜索、替换与数据转换"
second_title: "文档"
linktitle: "开发者指南"
...
- **[将电子表格另存为其他格式文件](https://docs.aspose.cloud/cells/save-an-excel-file-as-other-formats-files/)**
...
- **[将电子表格表格转换为 CSV](https://docs.aspose.cloud/cells/convert-table-to-csv/)**
...
- **[创建新电子表格](https://docs.aspose.cloud/cells/create-spreadsheet/)**
- **[向电子表格添加工作表](https://docs.aspose.cloud/cells/add-worksheet-to-spreadsheet/)**
- **[从电子表格中删除工作表](https://docs.aspose.cloud/cells/delete-worksheet-from-spreadsheet/)**
- **[重命名电子表格中的工作表](https://docs.aspose.cloud/cells/rename-worksheet-in-spreadsheet/)**

### **搜索与替换**

- **[在电子表格中搜索内容](https://docs.aspose.cloud/cells/search-spreadsheet-content/)**
- **[在电子表格中搜索失效链接](https://docs.aspose.cloud/cells/search-spreadsheet-broken-links/)**
- **[替换电子表格内容](https://docs.aspose.cloud/cells/replace-spreadsheet-content/)**
...
在 GitHub 上免费获取 Cells Cloud SDK。访问开源代码及丰富的使用场景示例：
