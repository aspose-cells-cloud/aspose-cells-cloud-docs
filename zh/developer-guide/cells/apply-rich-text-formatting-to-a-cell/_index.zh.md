---
title: 将富文本格式应用于 Cell
type: docs
url: /zh/apply-rich-text-formatting-to-a-cell/
weight: 40
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 将富文本格式应用于单元格
---
此 REST API 表示将 `rich text formatting` 应用于 Excel 文件中的单元格。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
