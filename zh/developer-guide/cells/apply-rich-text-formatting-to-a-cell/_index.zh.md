...
weight: 40
---
此 REST API 表示将 `rich text formatting` 应用到 Excel 文件中的单元格。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
