---
title: 取消合并 Excel 工作表中的 Cells
type: docs
url: /zh/unmerge-cells-in-excel-worksheet/
weight: 120
---
此 REST API 表示 Excel 文件中的 `unmerge` 单元格。
...
这[开放API规范](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
