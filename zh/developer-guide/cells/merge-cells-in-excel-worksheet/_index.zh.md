---
title: 将 Cells 合并到 Excel 工作表中
type: docs
url: /zh/merge-cells-in-excel-worksheet/
weight: 110
kwords: Excel, Office 云, REST API, 电子表格, PDF, CSV, Json, Markdwon, 合并 Cells 到 Excel 工作表
---
此 REST API 表示 Excel 文件中的 `merge` 个单元格。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
