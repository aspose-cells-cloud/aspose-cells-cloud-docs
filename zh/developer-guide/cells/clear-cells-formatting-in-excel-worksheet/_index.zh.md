---
title: 在 Excel Workshee 中清除 Cells 格式
type: docs
url: /zh/clear-cells-formatting-in-excel-worksheet/
weight: 100
---
此 REST API 表示 Excel 文件中的 `clear` 单元格 `style`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
