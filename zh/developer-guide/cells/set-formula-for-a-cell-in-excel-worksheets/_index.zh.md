---
title: 为 Excel 工作表中的单元格设置公式
type: docs
url: /zh/set-formula-for-a-cell-in-excel-worksheets/
weight: 80
kwords: Excel、Office 云、REST API、电子表格、PDF、CSV、Json、Markdwon、为 Excel 工作表中的单元格设置公式
---
此 REST API 表示在 Excel 文件中设置 `cell formula`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetCellSetValue)定义一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
