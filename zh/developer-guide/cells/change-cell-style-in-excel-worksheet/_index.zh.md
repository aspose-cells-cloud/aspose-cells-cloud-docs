---
title: 更改 Excel Workshee 中的单元格样式
type: docs
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PostUpdateWorksheetCellStyle)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
