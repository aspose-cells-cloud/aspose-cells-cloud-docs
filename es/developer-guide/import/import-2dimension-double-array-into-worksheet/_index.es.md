---
title: Importar matriz doble de 2 dimensiones en la hoja de trabajo Excel
...
description: Aspose.Cells Cloud REST API admite la importación de datos de matriz doble de 2 dimensiones en archivos Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 20
---
Este REST API `import 2 dimension double array data` en Excel hoja de trabajo.

La solicitud es una solicitud HTTP con contenido de varias partes (ver[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)o[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). La primera parte del contenido de varias partes contiene los datos Import2DimensionDoubleArrayOption y la segunda contiene un archivo de datos.
