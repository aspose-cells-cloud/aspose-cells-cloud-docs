---
title: Importe una matriz de cadenas de 2 dimensiones en la hoja de trabajo Excel
...
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Importar matriz de cadenas de 2 dimensiones en hoja de trabajo Excel
---
Este REST API `import 2 dimension string array data` en la hoja de trabajo Excel.

La solicitud es una solicitud HTTP con contenido de varias partes (consulte[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)o[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). La primera parte del contenido de varias partes contiene los datos de Import2DimensionStringArrayOption y la segunda contiene un archivo de datos.
