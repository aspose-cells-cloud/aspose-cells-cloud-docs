---
title: Importar matriz doble en la hoja de trabajo Excel
...
weight: 20
---
Este REST API `import double array data` en Excel hoja de trabajo.

La solicitud es una solicitud HTTP con contenido de varias partes (ver[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)o[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). La primera parte del contenido de varias partes contiene los datos de ImportDoubleArrayOption y la segunda contiene un archivo de datos.
...
**ImportDoubleArrayOptionImportDoubleArrayOption**
