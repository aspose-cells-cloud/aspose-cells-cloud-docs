...
| Hipervínculo|| cuerpo| Objeto de hipervínculo|
| carpeta| cadena| consulta| La carpeta de documentos.|
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Hypelinks/PostWorksheetHyperlink) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
