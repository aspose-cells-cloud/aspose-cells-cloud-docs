...
linktitle: Objeto de lista
type: docs
url: /es/export/excel-listobject-to-different-formats/
keywords: Export Excel list object to kinds of format files
description: Aspose.Cells Cloud REST API admite la exportación de Excel objetos de lista a tipos de archivos de formato. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Exportar objeto de lista
---
