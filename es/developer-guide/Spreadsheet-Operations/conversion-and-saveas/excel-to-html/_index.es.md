...
type: docs
url: /es/convert-excel-file-to-html-file/
aliases: [/convert-excel-file-to-html-in-cloud/,/convert/excel-to-html/]
keywords: Convert excel files to html files
description: Aspose.Cells Cloud REST API admite la conversión de archivos de Excel a HTML. El SDK es compatible con varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 100
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Excel a HTML
---
Este REST API indica a `convert` un archivo de hoja de cálculo a un archivo de formato html.
...
|:- |:- |:- |:- |
|/celdas/convertir/html|CORREO|Convierte una hoja de cálculo en un archivo pptx.|[Conversión posterior del libro de trabajo a HTML](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml)|

 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
