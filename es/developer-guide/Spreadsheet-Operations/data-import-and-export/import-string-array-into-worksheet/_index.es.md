---
title: Importar matriz de cadenas a la hoja de trabajo Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Importar cadena arra
type: docs
...
weight: 40
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Importar matriz de cadenas a la hoja de cálculo Excel
---
Esta hoja de trabajo REST API `import string array data` en Excel.

La solicitud es una solicitud HTTP con contenido de varias partes (ver[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)o[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). La primera parte del contenido multiparte contiene los datos de ImportStringArrayOption y la segunda contiene un archivo de datos.
