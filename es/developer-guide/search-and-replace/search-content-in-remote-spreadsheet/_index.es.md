---
title: Aspose.Cells Cloud Web API - Buscar contenido en una hoja de cálculo remota
second_title: Documen
ArticleTitle: Search Content in a Remote Spreadshee
linktitle: Buscar contenido de hoja de cálculo remota
type: docs
url: /es/search-content-in-remote-spreadsheet/
keywords: remote spreadsheet search, Excel API, search text in spreadsheet, cloud storage search, Aspose.Cells AP
description: Busque texto de manera eficiente en una hoja de cálculo remota utilizando Aspose.Cells API
weight: 100
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Coincidir con todas las celdas en blanco en una hoja de cálculo Excel, búsqueda remota en hoja de cálculo, búsqueda en almacenamiento en la nube
---
Busque texto específico en una hoja de cálculo remota.

### **Buscar contenido en la hoja de cálculo remota API**
...
|ignorandoCase|Booleano|Consulta|Indica si se debe ignorar mayúsculas y minúsculas en la búsqueda.|
|carpeta|Cadena|Consulta|La ruta de la carpeta donde se almacena el libro de trabajo.|
|nombreDeAlmacenamiento|Cadena|Consulta|(Opcional) El nombre del almacenamiento en la nube personalizado. Si se omite, se utiliza el almacenamiento predeterminado.|
...
### Especificación OpenAPI
 ...
 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/SearchControllor/SearchContentInRemoteSpreadsheet) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
