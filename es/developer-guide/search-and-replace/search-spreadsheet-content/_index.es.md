---
title: Aspose.Cells Cloud Web API - Buscar contenido de hoja de cálculo
second_title: Documen
ArticleTitle: Search Spreadsheet Conten
linktitle: Buscar contenido de la hoja de cálculo
type: docs
...
description: Busque texto de manera eficiente dentro de archivos de hojas de cálculo locales utilizando nuestro API
weight: 100
kwords: Excel, Office Nube, REST API, Búsqueda en hoja de cálculo, Exportación PDF, Manejo de CSV, Formato JSON, Integración de Markdown, Coincidencia de Cells vacío en Excel
---
Busque texto dentro de archivos de hojas de cálculo locales utilizando nuestro API.

## **Buscar contenido de la hoja de cálculo API**
...
|:- |:- |:- |:- |
|Hoja de cálculo|Archivo|Datos del formulario|Sube el archivo de hoja de cálculo para buscar.|
|buscarTexto|Cadena|Consulta|El texto a buscar dentro de la hoja de cálculo.|
|ignorandoCase|Booleano|Consulta|Especifique si desea ignorar mayúsculas y minúsculas en la búsqueda.|
|hoja de trabajo|Cadena|Consulta|Especifique la hoja de trabajo en la que se realizará la búsqueda.|
|área de celda|Cadena|Consulta|Especifique el área de celdas a buscar.|
|región|Cadena|Consulta|La configuración regional para la hoja de cálculo.|
...
## ¿Por qué debería utilizar el contenido de búsqueda dentro de la hoja de cálculo API?

- Busque contenido sin esfuerzo dentro de una hoja de cálculo con este API.
...
### Especificación OpenAPI
 ...
 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/SearchControllor/SearchSpreadsheetContent) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
