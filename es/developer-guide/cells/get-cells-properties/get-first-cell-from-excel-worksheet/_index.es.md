---
title: Obtenga la primera celda de Excel Workshee
type: docs
url: /es/get-first-cell-from-excel-worksheet/
weight: 20
---
Este REST API indica que los programas obtienen un `firstcell` en un archivo Excel cuando el parámetro `cellOrMethodName` es `firstcell`.
