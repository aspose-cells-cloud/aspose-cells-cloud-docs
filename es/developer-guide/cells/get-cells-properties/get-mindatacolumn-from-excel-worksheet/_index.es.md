---
title: Obtener MinDataColumn de Excel Workshee
type: docs
url: /es/get-mindatacolumn-from-excel-worksheet/
weight: 110
---
Este REST API indica que los programas obtienen un `mindatacolumn` en un archivo Excel cuando el parámetro `cellOrMethodName` es `mindatacolumn`.
