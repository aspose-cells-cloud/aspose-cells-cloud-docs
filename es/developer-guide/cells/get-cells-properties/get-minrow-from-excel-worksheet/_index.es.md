---
title: Obtener MinRow de Excel Workshee
type: docs
url: /es/get-minrow-from-excel-worksheet/
weight: 80
---
Este REST API indica que los programas obtienen un `minrow` en un archivo Excel cuando el parámetro `cellOrMethodName` es `minrow`.
