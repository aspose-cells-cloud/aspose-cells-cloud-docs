---
title: Obtener MaxDataColumn de Excel Workshee
type: docs
url: /es/get-maxdatacolumn-from-excel-worksheet/
weight: 70
---
Este REST API indica que los programas obtienen un `maxdatacolumn` en un archivo Excel cuando el parámetro `cellOrMethodName` es `maxdatacolumn`.
