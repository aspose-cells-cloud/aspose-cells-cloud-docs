---
title: Obtenga MinColumn de Excel Workshee
type: docs
url: /es/get-mincolumn-from-excel-worksheet/
weight: 100
---
Este REST API indica que los programas obtienen un `mincolumn` en un archivo Excel cuando el parámetro `cellOrMethodName` es `mincolumn`.
