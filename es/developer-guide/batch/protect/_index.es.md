...
description: Aspose.Cells Cloud API admite la protección por lotes de varios archivos de Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 100
---
Este REST API indica al `batch protection` de archivos elegibles.
...
------------ | ------------- | ------------- | -------------
Carpeta de origen | cadena | | [opcional]Condición de coincidencia | Solicitud de condición de coincidencia | | [opcional] Tipo de protección | cadena | | [opcional] Contraseña | cadena | | [opcional]Carpeta de salida | cadena | | [opcional]**Propiedades de MatchConditionRequest**
