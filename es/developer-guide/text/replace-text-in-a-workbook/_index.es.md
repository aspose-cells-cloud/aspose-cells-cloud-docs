...
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Reemplazar texto en un libro de trabajo Excel
---
Este REST API indica texto `replace` en un libro de trabajo Excel.
