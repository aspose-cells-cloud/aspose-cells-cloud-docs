---
title: Obtener elementos de texto de un libro de trabajo Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Ponte en el trabajo
type: docs
...
kwords: Excel, Office Cloud, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Obtener elementos de texto de un libro de trabajo Excel
---
Este REST API indica el `text items` del libro de trabajo `read` en el libro de trabajo Excel.
...
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
