...
description: Aspose.Cells Cloud REST API admite mover una tabla dinámica en un archivo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 120
kwords: Excel, Office Cloud, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Mover una tabla dinámica en un archivo Excel
---
Este REST API indica tabla dinámica `move`.
...
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldMoveTo) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
