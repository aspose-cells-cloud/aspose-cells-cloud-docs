...
description: Aspose.Cells Cloud REST API admite agregar marcador de agua para archivos Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 39
---
Este REST API indica agregar `watermark` en los archivos Excel.
...
| color| cadena| consulta||
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
