---
title: Descargar archivo de Aspose.Cells AP
second_title: Developer Guide for Aspose.Cells AP
linktitle: Descargar archivo AP
type: docs
...
description: Aprenda a utilizar Aspose.Cells API para descargar archivos, incluidos Excel, PDF, CSV y de forma más eficiente.
weight: 100
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Descargar archivo Excel, Recuperar archivo en blanco Cells
---
## **Excel API: Descargar archivo**
...
### **Descripción de la función**
 ...
 El**Descargar archivo** API le permite recuperar archivos almacenados en la nube Aspose. Esta función es esencial para gestionar y acceder a diversos formatos de archivo, como hojas de cálculo Excel, PDF y CSV.

###  Los parámetros de solicitud de**Descargar archivo** API son

| Nombre del parámetro| Tipo| Ruta/Cadena de consulta/HTTPBody| Descripción|
|:- |:- |:- |:- |
| camino| Cadena| Camino| La ruta al archivo que desea descargar.|
| nombreDeAlmacenamiento| Cadena| Consulta| El nombre del almacenamiento desde el que se recuperará el archivo.|
| ID de versión| Cadena| Consulta| El identificador de la versión del archivo a descargar, si corresponde.|
...
## Especificación OpenAPI
 ...
 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/FileController/DownloadFile) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
