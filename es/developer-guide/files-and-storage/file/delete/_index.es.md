...
description: Aprenda a eliminar archivos con Aspose Cells Cloud REST API SDK compatible con tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 100
---
...
| versiónId| cadena| consulta| ID de versión de archivo para eliminar|
