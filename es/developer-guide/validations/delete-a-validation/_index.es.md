...
weight: 10
kwords: Excel, Office Cloud, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Eliminar una validación de hoja de cálculo en una hoja de cálculo Excel
---
Este REST API indica eliminar una validación de hoja de trabajo por índice en una hoja de trabajo Excel.
...
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidation) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
