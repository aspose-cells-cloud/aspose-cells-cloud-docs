...
description: Aspose.Cells Cloud REST API admite obtener una imagen en un archivo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 10
---
Este REST API indica el índice de imagen por imagen `get` de una hoja de trabajo Excel.
...
| índice de imagen| entero| camino| El índice de imágenes.|
