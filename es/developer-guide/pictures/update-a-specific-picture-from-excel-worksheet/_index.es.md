...
description: Aspose.Cells Cloud REST API admite la actualización de una imagen en un archivo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 70
kwords: Excel, Office Cloud, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Actualizar imagen en un archivo Excel
---
...
| índice de imágenes| entero| camino| El índice de la imagen.|
| imagen|| cuerpo| Objeto de imagen|
| carpeta| cadena| consulta| La carpeta de documentos.|
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
