...
description: "Aspose.Cells Cloud REST API: cómo crear un libro de trabajo Excel a partir de una plantilla de marcador inteligente. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift."
weight: 30
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Cómo crear un libro de trabajo Excel con un archivo de plantilla
---
...
|se sobreescribe|cadena| verdadero/falso|
...
|:- |:- |:- |:- |
|/células/{nombre}|PONER|Crear un nuevo libro de trabajo Excel a partir de un archivo de plantilla|[PonerLibroCrear](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate)|

 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
