...
---
Este REST API indica a `convert` un archivo de hoja de cálculo a un archivo de formato csv.
...
|:- |:- |:- |:- |
|/celdas/convertir/csv|CORREO|Convierte una hoja de cálculo en un archivo csv.|[Conversión posterior del libro de trabajo a CSV](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV)|

 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
