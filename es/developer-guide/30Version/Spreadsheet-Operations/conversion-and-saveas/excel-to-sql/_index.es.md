...
type: docs
url: /es/convert-excel-file-to-sql-file/
keywords: Convert excel files to sql files
description: Aspose.Cells Cloud REST API admite la conversión de archivos de Excel a archivos SQL. El SDK es compatible con varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 100
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Excel a SQL
---
Este REST API indica a `convert` un archivo de hoja de cálculo a un archivo de formato sql.
...
|:- |:- |:- |:- |
|/celdas/convertir/sql|CORREO|Convertir una hoja de cálculo en un archivo SQL.|[PostConvertirLibroDeTrabajoASQL](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL)|

 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
