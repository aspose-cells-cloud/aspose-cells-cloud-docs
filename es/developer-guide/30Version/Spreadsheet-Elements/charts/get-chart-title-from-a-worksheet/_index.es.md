...
weight: 120
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Obtener el título del gráfico de una hoja de cálculo
---
Este REST API indica obtener el título del gráfico
...
<br/>
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChartTitle) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
