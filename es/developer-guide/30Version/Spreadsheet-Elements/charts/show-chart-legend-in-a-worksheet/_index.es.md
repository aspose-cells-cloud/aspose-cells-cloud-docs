...
weight: 100
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Mostrar leyenda de gráfico en una hoja de cálculo
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartLegend) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
