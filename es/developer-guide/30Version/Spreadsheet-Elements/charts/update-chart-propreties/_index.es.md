---
title: Actualizar propiedad del gráfico
type: docs
url: /es/charts/propreties/update/
aliases: [/update-chart-propreties/]
weight: 160
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Actualizar propiedades del gráfico
---
Este REST API indica propiedades de gráficos de actualización
...
<br/>
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostWorksheetChart) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
