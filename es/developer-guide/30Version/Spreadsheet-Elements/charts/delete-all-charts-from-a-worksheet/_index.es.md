---
title: Eliminar todos los gráficos de una hoja de trabajo
type: docs
url: /es/charts/clear/
aliases: [/delete-all-charts-from-a-worksheet/]
weight: 30
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Eliminar todos los gráficos de una hoja de cálculo
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetClearCharts) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
