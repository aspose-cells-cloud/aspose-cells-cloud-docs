...
weight: 60
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Obtener eje de valor del gráfico
---
Este REST API indica Obtener eje de valor del gráfico
...
| nombreDeAlmacenamiento| cadena| consulta||
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartValueAxis) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
