---
title:  Obtener la categoría del gráfico Axi
type: docs
url: /es/charts/category-axis/get/
weight: 60
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Obtener eje de categoría de gráfico
---
...
| nombreDeAlmacenamiento| cadena| consulta||
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
