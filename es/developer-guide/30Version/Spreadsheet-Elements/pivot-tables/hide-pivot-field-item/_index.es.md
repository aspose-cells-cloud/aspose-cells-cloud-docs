...
description: Aspose.Cells Cloud REST API permite ocultar un campo dinámico en una tabla dinámica. El SDK es compatible con varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 110
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Ocultar elemento de campo dinámico en una tabla dinámica
---
Este REST API indica ocultar el elemento del campo pivote.
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldHideItem) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
