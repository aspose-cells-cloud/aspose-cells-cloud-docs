...
description: Aspose.Cells Cloud REST API admite la creación de una tabla dinámica con un objeto de lista. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 60
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Convertir tabla en tabla dinámica
---
Este REST API indica crear un `pivottable` con objeto de lista.
...
| nombreDeHojaDeDestino| cadena| consulta||
| pedido|| cuerpo||
| carpeta| cadena| consulta||
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
