...
aliases: [  /es/get-conditional-formatting/ ]
keywords: "Aspose.Cells Cloud, REST API, formato condicional, Excel, hoja de cálculo"
description: "Recuperar reglas de formato condicional desde una hoja de cálculo utilizando la API REST de Aspose.Cells Cloud."
weight: 10
---

Esta API REST recupera reglas de formato condicional desde una hoja de cálculo.
...
| sheetName             | string  | path      | Nombre de la hoja de cálculo que contiene el formato. |
| index                 | integer | path      | Índice de base cero de la regla de formato condicional. |
...
La [Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormatting) define una interfaz de programación públicamente accesible y le permite realizar interacciones REST directamente desde un navegador web.
...
Utilizar un SDK es la mejor manera de acelerar el desarrollo. Un SDK gestiona los detalles de bajo nivel para que pueda centrarse en las tareas de su proyecto. Consulte el [repositorio de GitHub](https://github.com/aspose-cells-cloud) para obtener una lista completa de los SDK de Aspose.Cells Cloud.
