...
description: El SDK Aspose.Cells Cloud API permite agregar un filtro de los 10 mejores en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 65
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Agregar los 10 elementos principales en una hoja de cálculo Excel
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetFilterTop10) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
