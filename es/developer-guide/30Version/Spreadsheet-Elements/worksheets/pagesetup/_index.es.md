...
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Una configuración de página de hoja de cálculo Excel
---
...
|Orden|Cadena|verdadero| FALSO||Representa el orden que Microsoft Excel utiliza para numerar páginas al imprimir una hoja de cálculo grande.|
|Orientación|Cadena|verdadero| FALSO|| Representa la orientación de la página de impresión. Horizontal/Vertical|
|Tamaño del papel|Cadena|verdadero| FALSO||Representa el tamaño del papel.|
|Área de impresión|Cadena|verdadero| FALSO||Representa el rango a imprimir.|
...
|Borrador de impresión|Booleano|verdadero| FALSO||Representa si la hoja se imprimirá sin gráficos.|
