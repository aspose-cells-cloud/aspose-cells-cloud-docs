---
title: Establecer la configuración de página para una hoja de cálculo
second_title: Documen
linktitle: Establecer configuración de página
type: docs
url: /es/set-page-setup/
...
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Establecer la configuración de página para una hoja de cálculo Excel
---
Este REST API indica `Set page setup for an Excel worksheet`.
...
|[Configuración de página](/cells/es/page-setup) | objeto| cuerpo| Descripción de configuración de TPage.|
| carpeta| cadena| consulta| Carpeta de documentos.|
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|

 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/PageSetup/PostPageSetup) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
