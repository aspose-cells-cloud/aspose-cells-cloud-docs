...
description:  Insertar segmentación de datos para el objeto de lista.
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Segmentador de inserción de objetos de lista
---
Este REST API indica insertar una segmentación de datos para un objeto de lista en una hoja de cálculo Excel.
...
|índice de columna|Entero|Consulta||
|nombreCeldaDestino|Cadena|Consulta||
|carpeta|Cadena|Consulta||
|nombreDeAlmacenamiento|Cadena|Consulta||

 El[Especificación OpenAPI](https://reference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectInsertSlicer) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
