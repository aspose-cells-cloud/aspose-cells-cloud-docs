...
weight: 40
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Aplicar formato de texto enriquecido a una celda
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
