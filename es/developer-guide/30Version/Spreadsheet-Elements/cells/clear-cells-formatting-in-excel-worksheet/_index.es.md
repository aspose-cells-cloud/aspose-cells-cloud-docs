---
title: Borrar el formato Cells en la hoja de trabajo Excel
type: docs
url: /es/clear-cells-formatting-in-excel-worksheet/
weight: 100
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Borrar Cells Formato en Excel Hoja de cálculo
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
