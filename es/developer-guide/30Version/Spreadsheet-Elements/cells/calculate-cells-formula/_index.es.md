---
title: Calcular la fórmula Cells
type: docs
url: /es/calculate-cells-formula/
weight: 90
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Calcular fórmula Cells
---
...
| nombreCelda| cadena| camino||
| opciones|| cuerpo||
| carpeta| cadena| consulta||
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|

 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCellCalculate) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
