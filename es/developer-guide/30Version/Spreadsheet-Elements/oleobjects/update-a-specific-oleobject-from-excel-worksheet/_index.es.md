---
title: Actualizar un objeto OLE en una hoja de cálculo Excel
...
description: Aspose.Cells Cloud REST API admite la actualización de un objeto OLE en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 30
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Actualizar un objeto OLE en una hoja de cálculo Excel
---
Este REST API indica a `update` un `OLE object` en una hoja de cálculo Excel.
...
| Índice de objeto ole| entero| camino| Índice de objetos Ole|
| viejo|| cuerpo| Objeto Ole|
| carpeta| cadena| consulta| La carpeta del libro de trabajo.|
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|

 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/OleObjects/PostUpdateWorksheetOleObject) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
