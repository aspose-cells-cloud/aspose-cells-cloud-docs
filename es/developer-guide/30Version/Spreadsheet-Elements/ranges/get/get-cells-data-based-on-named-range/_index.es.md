---
title: Obtener datos de celdas según el rango nombrado
...
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Obtener datos de celdas según un rango con nombre
---
Este REST API indica Obtener lista de celdas en un rango por nombre de rango o índices de fila y columna
...
| primeraFila| entero| consulta| la primera fila de la gama|
| primeraColumna| entero| consulta| la primera columna del rango|
| recuento de filas| entero| consulta| el recuento de filas en el rango|
| recuento de columnas| entero| consulta| el recuento de columnas en el rango|
| carpeta| cadena| consulta| Carpeta de libro de trabajo.|
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|

 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Ranges/GetWorksheetCellsRangeValue) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
