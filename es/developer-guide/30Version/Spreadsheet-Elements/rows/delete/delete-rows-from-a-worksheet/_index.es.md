...
weight: 80
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Eliminar varias filas en una hoja de cálculo Excel
---
Este REST API indica eliminar varias filas en una hoja de cálculo Excel.
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
