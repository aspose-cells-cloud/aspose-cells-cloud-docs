---
title: Obtener la descripción de la fila de una hoja de cálculo Excel
...
description: Aspose.Cells Cloud REST API admite la obtención de información de filas en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 10
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Obtener la descripción de fila de una hoja de cálculo Excel
---
Este REST API indica obtener datos de fila por índice de fila en una hoja de cálculo Excel.
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRow) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
