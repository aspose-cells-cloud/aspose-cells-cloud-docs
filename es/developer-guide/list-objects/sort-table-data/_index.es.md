---
title: Ordenar datos de objetos de lista en una hoja de trabajo Excel
...
description: Aspose.Cells Cloud REST API admite la clasificación de un objeto de lista (tabla) en una hoja de trabajo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 40
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Ordenar datos de objetos de lista en una hoja de trabajo Excel
---
Este REST API indica `sort table's data` en una hoja de trabajo Excel.
...
| clasificador de datos|| cuerpo||
| carpeta| cadena| consulta||
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSortTable) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
