---
title:  Obtener categoría de gráfico Axi
type: docs
...
| nombredealmacenamiento| cadena| consulta||
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
