---
title:  Actualizar valor de gráfico Axi
type: docs
url: /es/charts/value-axis/update/
weight: 160
---
 Este REST API indica actualizar el eje del valor del gráfico.
...
| NombreDeAlmacenamiento| cadena| consulta||
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Charts/PostChartValueAxis) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
