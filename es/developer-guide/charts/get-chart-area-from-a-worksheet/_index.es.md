---
title: Obtener área de gráfico de una hoja de trabajo
type: docs
url: /es/charts/area/get/
aliases: [/get-chart-area-from-a-worksheet/]
weight: 60
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Obtener área de gráfico de una hoja de trabajo
---
Este REST API indica obtener información del área del gráfico.
...
<br/>
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
