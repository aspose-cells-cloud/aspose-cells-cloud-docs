...
weight: 160
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Actualizar propiedades de gráfico
---
...
<br/>
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Charts/PostWorksheetChart) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
