...
weight: 40
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Eliminar un gráfico de una hoja de trabajo
---
...
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetDeleteChart) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
