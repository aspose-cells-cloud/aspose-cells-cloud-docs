---
title: Mostrar filas en una hoja de trabajo Excel
...
description: Aspose.Cells Cloud REST API admite mostrar filas en una hoja de trabajo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 50
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Mostrar filas en una hoja de trabajo Excel
---
Este REST API indica mostrar filas en una hoja de trabajo Excel.
...
| inicio| entero| consulta| El índice de fila inicial que se va a operar.|
| filas totales| entero| consulta| Número de filas a operar.|
| altura| número| consulta|15.0 |
| carpeta| cadena| consulta| La carpeta de documentos.|
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetRows) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
