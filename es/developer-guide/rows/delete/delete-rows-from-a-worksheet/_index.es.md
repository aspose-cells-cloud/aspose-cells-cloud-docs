---
title: Eliminar varias filas en una hoja de trabajo Excel
...
weight: 80
kwords: Excel, Office Cloud, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Eliminar varias filas en una hoja de trabajo Excel
---
Este REST API indica eliminar varias filas en una hoja de trabajo Excel.
...
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
