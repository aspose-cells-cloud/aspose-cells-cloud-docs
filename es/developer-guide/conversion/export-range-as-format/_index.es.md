---
title: Aspose.Cells Cloud Web API - Exportar datos de un rango de hoja de cálculo como un archivo de formato
second_title: Documen
ArticleTitle: Export a Spreadsheet Range data as a Format file
linktitle: Rango de exportación como formato
type: docs
...
description: Convierte un rango específico de una hoja de cálculo en el almacenamiento en la nube a varios formatos como PDF, CSV o formatos de imagen sin descargar el archivo
weight: 100
kwords: Conversión de hojas de cálculo, REST API, PDF, CSV, JSON, Markdown, hoja de trabajo Excel
---
Exporte una hoja de cálculo en la nube/rango Excel a un archivo de formato. Este archivo se puede guardar en la nube o exportar al almacenamiento local.

## **Rango de exportación como formato API**
...
|hoja de trabajo|Cadena|Camino|El nombre de la hoja de cálculo Spreadsheet/Excel|
|rango|Cadena|Camino|El rango que se va a convertir (por ejemplo, A1:C12).|
|formato|Cadena|Consulta|(Obligatorio) El formato de salida deseado (por ejemplo, "png", "pdf", "svg").|
|carpeta|Cadena|Consulta|(Opcional) Ruta de la carpeta donde se almacena el libro. El valor predeterminado es nulo.|
...
|Ruta de salida|Cadena|Consulta|(Opcional) Ruta de la carpeta donde se guardará el archivo de salida. El valor predeterminado es nulo.|
|nombreAlmacenamientoExterno|Cadena|Consulta|El nombre del almacenamiento del archivo de salida.|
|Ubicación de fuentes|Cadena|Consulta|Ubicación de fuentes personalizadas.|
|región|Cadena|Consulta|La configuración regional de la hoja de cálculo.|
...
## ¿Por qué debería utilizar el rango de hoja de cálculo de exportación con el formato API?
...
## ¿Cómo utilizar el rango de hoja de cálculo de exportación como formato API con SDK?

### Rango de exportación como formato API Especificación

 El[Rango de exportación como formato API Especificación](https://reference.aspose.cloud/cells/#/ConversionController/ExportRangeAsFormat) Proporciona una interfaz de programación de acceso público, que permite interacciones REST directamente desde un navegador web.

### Utilice los SDK de la nube Aspose.Cells

Usar el SDK es la forma más rápida de desarrollar, ya que abstrae los detalles de bajo nivel y permite exportar datos de un rango de una hoja de cálculo a un archivo de formato con código corto.
