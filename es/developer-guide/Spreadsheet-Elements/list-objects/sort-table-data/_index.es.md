---
title: Ordenar datos de objetos de lista en una hoja de cálculo Excel
...
description: Aspose.Cells Cloud REST API permite ordenar un objeto de lista (tabla) en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 40
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Ordenar datos de objetos de lista en una hoja de cálculo Excel
---
Este REST API indica `sort table's data` en una hoja de cálculo Excel.
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSortTable) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
