---
title: Añadir salto de página horizontal
second_title: Aspose.Cells Cloud Documen
linktitle: Añadir salto de página horizontal
type: docs
...
weight: 30
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Agregar salto de página horizontal
---
Este REST API indica insertar el salto de página `vertical`.
...
| columna final| entero| consulta||
| carpeta| cadena| consulta||
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|

 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
