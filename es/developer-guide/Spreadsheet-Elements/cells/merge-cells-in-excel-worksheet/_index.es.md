...
weight: 110
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Combinar Cells en la hoja de trabajo Excel
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
