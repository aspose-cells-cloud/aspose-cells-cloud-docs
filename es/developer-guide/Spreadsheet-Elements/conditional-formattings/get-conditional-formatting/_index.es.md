...
weight: 10
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Obtener formato condicional
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormatting) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
