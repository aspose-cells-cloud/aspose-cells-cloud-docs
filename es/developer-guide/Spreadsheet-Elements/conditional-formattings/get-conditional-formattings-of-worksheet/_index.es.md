...
description: "Cells.Cloud API para Excel opera: obtener formato de condición"
weight: 20
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, JSON, Markdown, Obtener formatos condicionales
---
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
