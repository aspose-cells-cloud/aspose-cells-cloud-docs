---
title: Eliminar una columna en una hoja de cálculo Excel
...
description: Aspose.Cells Cloud REST API permite eliminar columnas en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 80
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Eliminar una columna en una hoja de cálculo Excel
---
Esta copia REST API `column` en una hoja de trabajo Excel.
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetColumns) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
