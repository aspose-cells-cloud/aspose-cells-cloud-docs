---
title: Obtener un objeto OLE en una hoja de cálculo Excel
...
description: Aspose.Cells Cloud REST API admite la obtención de un objeto OLE en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 10
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Obtener un objeto OLE en una hoja de cálculo Excel
---
Este REST API indica a `get` un `OLE object` con formato en una hoja de cálculo Excel.
