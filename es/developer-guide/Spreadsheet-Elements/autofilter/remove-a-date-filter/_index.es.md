---
title: Eliminar un filtro de fecha
second_title: Aspose.Cells Cloud Documen
linktitle: Eliminar filtro de fecha
type: docs
url: /es/autofilter/delete-date-filter/
aliases: [/remove-a-date-filter/,/autofilter/delete-a-date-filter/]
weight: 100
keywords: Delete a date filter on an Excel worksheet
description: El SDK Aspose.Cells Cloud API permite eliminar un filtro de fecha en una hoja de cálculo Excel. El SDK es compatible con varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Eliminar un filtro de fecha
---
Este REST API indica eliminar un filtro de fecha en una hoja de cálculo Excel.
...
| Tipo de agrupación de fecha y hora| cadena| consulta||
| año| entero| consulta|0 |
| mes| entero| consulta|0 |
| día| entero| consulta|0 |
| hora| entero| consulta|0 |
| minuto| entero| consulta|0 |
| segundo| entero| consulta|0 |
| carpeta| cadena| consulta||
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|

 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
