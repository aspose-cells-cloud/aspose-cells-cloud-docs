---
title: Cambiar el ancho de las columnas dentro del rango
...
description: Aspose.Cells Cloud REST API permite configurar el ancho de columna para un rango en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 74
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Cambiar el ancho de las columnas dentro del rango
---
Este REST API indica Establecer el ancho de columna del rango
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeColumnWidth) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
