...
description: Aspose.Cells Cloud REST API admite la obtención de todas las imágenes en una hoja de cálculo Excel. El SDK admite varios lenguajes de desarrollo, como Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 10
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdown, Obtener todas las imágenes en una hoja de cálculo Excel
---
Este REST API indica a `get` toda la información de imágenes de una hoja de trabajo Excel.
...
| nombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 ...
 El[Especificación OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPictures) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
