---
title: Agregue un criterio personalizado en una hoja de trabajo Excel
...
description: El Aspose.Cells Cloud API admite agregar un filtro personalizado en una hoja de trabajo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 65
---
...
| operatorType1| cadena| consulta||
| criterio1| cadena| consulta||
| es y| booleano| consulta||
| operatorType2| cadena| consulta||
| criterio2| cadena| consulta||
| partidoBlanks| booleano| consulta||
| actualizar| booleano| consulta||
| carpeta| cadena| consulta||
| NombreDeAlmacenamiento| cadena| consulta| nombre de almacenamiento.|
 
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetCustomFilter) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
