---
title: Haga coincidir todas las celdas en blanco en una hoja de trabajo Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Coincidir con cel en blanco
type: docs
...
| nombredealmacenamiento| cadena| consulta| nombre del almacenamiento.|
 ...
 El[Especificación de API abierta](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks) define una interfaz de programación de acceso público y le permite realizar interacciones REST directamente desde un navegador web.
