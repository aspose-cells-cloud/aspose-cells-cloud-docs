...
weight: 50
kwords: Excel, Office Cloud, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Mostrar columnas en una hoja de trabajo Excel
---
Este REST API indica mostrar columnas de la hoja de trabajo.
