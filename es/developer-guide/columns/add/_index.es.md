---
title: Agregue una columna vacía en una hoja de trabajo Excel
...
description: Aspose.Cells Cloud REST API admite la adición de columnas en una hoja de trabajo Excel. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 20
---
Este REST API indica insertar columnas de hoja de cálculo.
