...
linktitle: Excel al CS
type: docs
url: /es/convert/excel-to-csv/
aliases: [/convert-excel-file-to-csv-in-cloud/]
keywords: Convert excel files to csv files
description: Aspose.Cells Cloud REST API admite la conversión de archivos de Excel a archivos csv. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 90
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Excel a CSV
---
Este archivo de Excel REST API `saveas` a CSV.

[POST /celdas/{nombre}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API le permite guardar el archivo MS Excel como archivo CSV con configuraciones adicionales y guardar el resultado en el almacenamiento.

Este archivo de Excel REST API `convert` a CSV.

[PUT /celdas/convertir](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook) API le permite convertir un archivo MS Excel a un archivo CSV con configuraciones adicionales y guardar el resultado en la respuesta.

Este archivo de Excel REST API `export` a CSV.

[OBTENER /celdas/{nombre}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API le permite convertir un archivo MS Excel a un archivo CSV con configuraciones adicionales y guardar el resultado en la respuesta.
