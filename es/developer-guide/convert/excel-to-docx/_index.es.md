---
title: Excel al médico
second_title: Aspose.Cells Cloud Documen
linktitle: Excel al médico
type: docs
url: /es/convert/excel-to-docx/
aliases: [/convert-excel-file-to-docx-in-cloud/]
keywords: Convert excel files to docx files
description: Aspose.Cells Cloud REST API admite la conversión de archivos de Excel a archivos docx. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift
weight: 90
---
Este archivo de Excel REST API `saveas` a Docx.
...
[PUT /celdas/convertir](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook) API le permite convertir el archivo MS Excel en un archivo Docx con configuraciones adicionales y guardar el resultado en la respuesta.

Este archivo de Excel REST API `export` a Docx.

[OBTENER /celdas/{nombre}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API le permite convertir el archivo MS Excel en un archivo Docx con configuraciones adicionales y guardar el resultado en la respuesta.
