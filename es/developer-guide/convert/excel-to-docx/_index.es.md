---
title: Excel al doctor
second_title: Aspose.Cells Cloud Documen
linktitle: Excel al doctor
type: docs
url: /es/convert/excel-to-docx/
aliases: [/convert-excel-file-to-docx-in-cloud/]
keywords: Convert excel files to docx files
description: Aspose.Cells Cloud REST API admite la conversión de archivos Excel a archivos docx. SDK admite tipos de lenguajes de desarrollo. Incluyen Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby y Swift.
weight: 90
kwords: Excel, Office Nube, REST API, Hoja de cálculo, PDF, CSV, Json, Markdwon, Excel a Docx
---
Este archivo de Excel REST API `saveas` en Docx.

[POST /celdas/{nombre}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API le permite guardar el archivo MS Excel como archivo Docx con configuraciones adicionales y guardar el resultado en el almacenamiento.

Este archivo de Excel REST API `convert` en Docx.

[PUT /celdas/convertir](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook) API le permite convertir un archivo MS Excel a un archivo Docx con configuraciones adicionales y guardar el resultado en la respuesta.

Este archivo de Excel REST API `export` en Docx.

[OBTENER /celdas/{nombre}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  ) API le permite convertir un archivo MS Excel a un archivo Docx con configuraciones adicionales y guardar el resultado en la respuesta.
