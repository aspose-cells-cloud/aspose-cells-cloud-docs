...
weight: 10
---
Este REST API indica un archivo de Excel `get` para un archivo de formato diferente.
...
|contraseña|cadena||
|esAutoajuste|cadena|verdadero Falso|
|soloGuardarTabla|cadena|verdadero Falso|
|ruta de salida|cadena|nueva posición de archivo.|
