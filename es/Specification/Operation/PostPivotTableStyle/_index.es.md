---
title: Estilo de tabla dinámica posterior
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postpivottablestyle/
description: Actualizar estilo en la tabla dinámica
kwords: Excel, Office, Hoja de cálculo, Nube REST API, PostPivotTableStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/FormatAll,POST,Actualizar estilo en la tabla dinámica.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /PostPivotTableStyle\'>PostPivotTableStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="estilo, clase: estilo, estilo Descripción de estilo en el cuerpo de la solicitud." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
