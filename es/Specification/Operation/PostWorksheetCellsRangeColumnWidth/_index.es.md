---
title: Publicar hoja de cálculo Celdas Rango Columna Ancho
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postworksheetcellsrangecolumnwidth/
description: Establecer el ancho de columna del rango especificado
kwords: Excel, Office, hoja de cálculo, nube REST API, PostWorksheetCellsRangeColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/columnWidth,POST,Establece el ancho de columna del rango especificado.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeColumnWidth\'>PublicarWorksheetCellsRangeColumnWidth</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="valor, flotante, establece el ancho de columna de este rango." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="rango, clase: rango, rango El objeto de rango." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
