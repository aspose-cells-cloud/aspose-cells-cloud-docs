...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name},PUT,Crear un nuevo libro usando diferentes métodos.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate\'>PutWorkbookCreate</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="nombre, cadena, el nuevo nombre del documento." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="templateFile,string,El archivo de plantilla, si los datos no proporcionados se crean en el libro de trabajo predeterminado." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="archivo de datos, cadena, archivo de datos de marcador inteligente, si los datos no se proporcionan, se verifica el contenido de la solicitud para los datos." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isWriteOver,boolean,Especifica si se escribe sobre el archivo de destino." >}} 
