---
title: Poner propiedad del documento
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="propiedad,clase:cellsdocumentproperty,Obtiene o establece el valor de la propiedad." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
