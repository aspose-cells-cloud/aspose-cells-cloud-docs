...
type: docs
url: /es/specification/operation/puthorizontalpagebreak/
description: Agregar saltos de página horizontales en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Nube REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,Agregar saltos de página horizontales en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >PutHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="nombre de celda, cadena, nombre de celda" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="fila, entero, índice de fila, basado en cero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columna, número entero, índice de columna, basado en cero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn, entero, índice de columna inicial, basado en cero." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn, entero, índice de columna final, basado en cero." >}} 
