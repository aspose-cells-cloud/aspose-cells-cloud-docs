...
type: docs
url: /es/specification/operation/postsetworksheetcolumnwidth/
description: Establecer el ancho de columna de la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, PostSetWorksheetColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},POST,Establecer el ancho de la columna de la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostSetWorksheetColumnWidth\'>PostSetWorksheetColumnWidth</a>" >}}
