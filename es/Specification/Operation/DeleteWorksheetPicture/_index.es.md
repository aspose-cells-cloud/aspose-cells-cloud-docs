---
title: Eliminar imagen de hoja de trabajo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/deleteworksheetpicture/
description: Eliminar un objeto de imagen por índice en la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, eliminar imagen de hoja de trabajo
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},DELETE,Eliminar un objeto de imagen por índice en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/# /Imágenes/DeleteWorksheetPicture\'>EliminarWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="índice de imágenes, número entero, índice de imágenes." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
