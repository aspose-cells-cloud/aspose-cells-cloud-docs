---
title: PonerInsertarColumna de hoja de trabajo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/putinsertworksheetcolumns/
description: Insertar columnas de la hoja de trabajo en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PutInsertWorksheetColumns
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PutInsertWorksheetColumns" >}}
{{< blocks/products/cells/docs-title titlemsg="Insert worksheet columns in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},PUT,Insertar columnas de la hoja de trabajo en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PutInsertWorksheetColumns\'>PutInsertWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="columnas, número entero, el número de columnas." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Indica si se actualizarán las referencias en otras hojas de trabajo." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/PutInsertWorksheetColumns\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/columns/1?columns=10&updateReference=True&folder=TestData/In"
    -X PUT 
