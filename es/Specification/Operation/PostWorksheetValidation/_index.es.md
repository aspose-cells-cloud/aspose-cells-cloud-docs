...
type: docs
url: /es/specification/operation/postworksheetvalidation/
description: Actualizar una validación por índice en la hoja de trabajo.
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostWorksheetValidation
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},POST,Actualizar una validación por índice en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/ WorksheetValidations/PostWorksheetValidation\'>PostWorksheetValidation</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="validationIndex, entero, el índice de validación." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="validación, clase: validación, descripción de la validación." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
