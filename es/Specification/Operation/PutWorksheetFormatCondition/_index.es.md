...
type: docs
url: /es/specification/operation/putworksheetformatcondition/
description: Agregar una condición de formato en la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, PutWorksheetFormatCondition
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},PUT,Agregar una condición de formato en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings /PutWorksheetFormatCondition\'>PutWorksheetFormatCondition</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="tipo, cadena, tipo de condición de formato (CellValue/Expression/ColorScale/DataBar/IconSet/Top10/UniqueValues/DuplicateValues/ContainsText/NotContainsText/BeginsWith/EndsWith/ContainsBlanks/NotContainsBlanks/ContainsErrors/NotContainsErrors/TimePeriod/AboveAverage)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="operatorType,string,Representa el tipo de operador de formato condicional y validación de datos (Entre/Equal/GreaterThan/GreaterOrEqual/LessThan/None/NotBetween/NotEqual)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="fórmula1,cadena,El valor o expresión asociada con el formato condicional." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="fórmula2,cadena,El valor o expresión asociada con el formato condicional." >}} 
