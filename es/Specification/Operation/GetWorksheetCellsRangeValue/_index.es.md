---
title: Obtener hoja de trabajoCellsRangeValu
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,Recuperar los valores de las celdas dentro del rango especificado.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /GetWorksheetCellsRangeValue\'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="namerange,cadena,El nombre del rango." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,Obtiene el índice de la primera fila del rango." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,Obtiene el índice de la primera columna del rango." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,integer,Obtiene el recuento de filas en el rango." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnCount,integer,Obtiene el recuento de columnas en el rango." >}} 
