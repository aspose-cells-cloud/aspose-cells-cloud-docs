---
title: Formato posterior claro
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postclearformats/
description: Borrar formatos de celda en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostClearFormats
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearformats,POST,Borrar formatos de celda en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats\' >PostClearFormats</a>" >}}
