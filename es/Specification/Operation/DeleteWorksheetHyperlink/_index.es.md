---
title: Eliminar hoja de trabajo Hyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/deleteworksheethyperlink/
description: Eliminar hipervínculo por índice en la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, eliminar hoja de trabajo hipervínculo
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},DELETE,Eliminar hipervínculo por índice en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /DeleteWorksheetHyperlink\'>DeleteWorksheetHyperlink</a>" >}}
