...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert,PUT,Convierte el libro de trabajo del contenido solicitado en archivos en diferentes formatos.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PutConvertWorkbook\'>PutConvertWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" streamFormat,string,El formato de la secuencia del archivo de entrada." >}} 
