...
type: docs
url: /es/specification/operation/postpivottablefieldhideitem/
description: Ocultar un elemento de campo dinámico en la tabla dinámica
kwords: Excel, Office, hoja de cálculo, nube REST API, PostPivotTableFieldHideItem
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Hide,POST,Ocultar un elemento de campo dinámico en la tabla dinámica.,<a href=\'https://apireference.aspose.cloud/ cell/#/PivotTables/PostPivotTableFieldHideItem\'>PostPivotTableFieldHideItem</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="itemIndex, entero, el índice del elemento dinámico en el campo dinámico." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isHide,boolean,Si el PivotItem específico está oculto (verdadero/falso)." >}} 
