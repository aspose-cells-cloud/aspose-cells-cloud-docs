...
type: docs
url: /es/specification/operation/getworkbooknames/
description: Recuperar rangos con nombre en el libro de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, GetWorkbookNames
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,Recuperar rangos con nombre en el libro de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
