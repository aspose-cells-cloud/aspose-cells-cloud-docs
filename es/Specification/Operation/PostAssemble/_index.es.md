...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/assemble,POST,Reúne archivos de datos con archivos de plantilla para generar archivos en varios formatos.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostAssemble\'>PostAssemble</a>" >}}
