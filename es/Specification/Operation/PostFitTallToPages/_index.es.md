...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/fittalltopages,POST,Establece la escala en la que la página se ajustará a lo alto cuando se imprima en la hoja.,<a href=\'https://apireference.aspose.cloud /cells/#/PageSetup/PostFitTallToPages\'>PostFitTallToPages</a>" >}}
