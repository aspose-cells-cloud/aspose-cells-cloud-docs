---
title: Publicar hoja de trabajo Celdas Rango Fila Altura
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postworksheetcellsrangerowheight/
description: Establece la altura de fila del rango
kwords: Excel, Office, hoja de cálculo, nube REST API, PostWorksheetCellsRangeRowHeight
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/rowHeight,POST,Establece el alto de fila del rango.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeRowHeight\'> PostWorksheetCellsRangeRowHeight</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="valor, flotante, establece la altura de la columna de este rango." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="rango, clase: rango, el objeto de rango." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
