---
title: Publicar hoja de trabajo Hyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postworksheethyperlink/
description: Actualizar hipervínculo por índice en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},POST,Actualizar hipervínculo por índice en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /PostWorksheetHyperlink\'>PostWorksheetHyperlink</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="hyperlinkIndex,integer,El índice del hipervínculo." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="hipervínculo, clase: hipervínculo, objeto hipervínculo" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
