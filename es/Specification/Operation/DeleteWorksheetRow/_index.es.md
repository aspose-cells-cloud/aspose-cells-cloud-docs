---
title: Eliminar hoja de trabajoRo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/deleteworksheetrow/
description: Eliminar una fila en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, DeleteWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},DELETE,Eliminar una fila en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetRow\'>DeleteWorksheetRow</a>" >}}
