---
title: Eliminar encabezado y pie de página
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/deleteheaderfooter/
description: Borrar encabezado y pie de página en la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, DeleteHeaderFooter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/clearheaderfooter,DELETE,Borrar encabezado y pie de página en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/DeleteHeaderFooter \'>Eliminar encabezado y pie de página</a>" >}}
