---
title: Poner Hoja De Trabajo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/putworksheetshape/
description: Agregar una forma en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Nube REST API, PutWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,PUT,Agregar una forma en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape\'>PutWorksheetShape </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Tipo de dibujo, cadena, tipo de objeto de forma" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftRow, entero, índice de la fila superior izquierda." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftColumn, entero, índice de la columna superior izquierda." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="top,integer,Representa el desplazamiento vertical de Spinner desde su fila izquierda, en unidades de píxel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="left,integer,Representa el desplazamiento horizontal de Spinner desde su columna izquierda, en unidades de píxel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ancho, entero, Representa la altura de Spinner, en unidades de píxel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="altura, entero, Representa el ancho de Spinner, en unidades de píxel." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="formaDTO,clase:forma," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
