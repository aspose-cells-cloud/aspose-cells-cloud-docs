...
type: docs
url: /es/specification/operation/postprotect/
description: Excel cifrado de archivos
kwords: Excel, Office, Hoja de cálculo, Nube REST API, PostProtect
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/protect,POST,Excel cifrado de archivos.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostProtect\'>PostProtect</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="protegerWorkbookRequest,clase:protegerworkbookrequest," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
