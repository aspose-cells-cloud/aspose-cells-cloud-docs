---
title: PostDigitalSignatur
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postdigitalsignature/
description: Excel archivo firma digital
kwords: Excel, Office, Hoja de cálculo, Nube REST API, PostDigitalSignature
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/digitalsignature,POST,Excel firma digital del archivo.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostDigitalSignature\'>PostDigitalSignature</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="archivo de firma digital, cadena, La ruta del archivo de firma digital debe incluir tanto la carpeta como el nombre del archivo, junto con la extensión." >}} 
