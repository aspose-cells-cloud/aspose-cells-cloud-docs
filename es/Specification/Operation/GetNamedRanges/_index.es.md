---
title: Obtener rango con nombre
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/getnamedranges/
description: Recuperar descripciones de rangos en las hojas de trabajo.
kwords: Excel, Office, hoja de cálculo, nube REST API, GetNamedRanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/ranges,GET,Recuperar descripciones de rangos en las hojas de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges\'>GetNamedRanges</a >" >}}
