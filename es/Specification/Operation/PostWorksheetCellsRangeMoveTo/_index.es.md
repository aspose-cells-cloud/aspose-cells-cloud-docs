---
title: Publicar hoja de trabajoCeldasRangoMoveT
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postworksheetcellsrangemoveto/
description: Mover el rango actual al rango de destino
kwords: Excel, Office, hoja de cálculo, nube REST API, PostWorksheetCellsRangeMoveTo
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/moveto,POST,Mover el rango actual al rango de destino.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeMoveTo\'>PostWorksheetCellsRangeMoveTo</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destRow,integer,La fila inicial del rango de destino." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destColumn,integer,La columna inicial del rango de destino." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" rango, clase: rango, rango en la hoja de trabajo" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
