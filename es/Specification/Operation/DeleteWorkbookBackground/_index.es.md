---
title: Eliminar fondo del libro de trabajo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/deleteworkbookbackground/
description: Eliminar fondo en el libro de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, eliminar fondo del libro de trabajo
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="DeleteWorkbookBackground" >}}
{{< blocks/products/cells/docs-title titlemsg="Delete background in the workbook." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,DELETE,Eliminar fondo en el libro de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground\'>DeleteWorkbookBackground</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/WorkbookController/DeleteWorkbookBackground\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/background?folder=TestData/In"
    -X DELETE 
