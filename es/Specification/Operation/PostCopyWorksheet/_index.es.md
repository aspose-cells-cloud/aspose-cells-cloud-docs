---
title: PostCopyWorkshee
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postcopyworksheet/
description: Copie contenidos y formatos de otra hoja de trabajo.
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostCopyWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,Copiar contenidos y formatos de otra hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'> Hoja de trabajo posterior a la copia</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="hoja de origen, cadena, hoja de trabajo de origen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="libro de trabajo fuente, cadena, libro de trabajo fuente." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="Carpeta de origen, cadena, carpeta del libro de trabajo original." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="opciones, clase: opciones de copia, Representa las opciones de copia." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
