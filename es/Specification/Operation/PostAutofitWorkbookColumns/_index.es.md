---
title: Publicar columna de libro de trabajo de ajuste automático
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postautofitworkbookcolumns/
description: Autoajustar columnas en el libro de trabajo
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostAutofitWorkbookColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/autofitcolumns,POST,Autofit columnas en el libro de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookColumns\'>PostAutofitWorkbookColumns</a>" >}}
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/autofitcolumns?startColumn=1&endColumn=20&folder=TestData/In"
    -X POST 
