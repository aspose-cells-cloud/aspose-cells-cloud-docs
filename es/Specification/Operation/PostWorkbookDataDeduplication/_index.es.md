---
title: PostWorkbookDataDeduplicación
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postworkbookdatadeduplication/
...
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostWorkbookDataDeduplication
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datadeduplication,POST,La deduplicación de datos de archivos de hojas de cálculo se utiliza principalmente para eliminar datos duplicados en tablas y rangos.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/ PostWorkbookDataDeduplication\'>PostWorkbookDataDeduplication</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="carpeta, cadena," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="nombre de almacenamiento, cadena," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="contraseña, cadena," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="región, cadena," >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Región de deduplicación, clase: región de deduplicación," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
