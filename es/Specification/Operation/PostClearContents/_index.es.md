---
title: Publicar borrar contenido
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postclearcontents/
description: Borrar el contenido del área de celda en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Cloud REST API, PostClearContents
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostClearContents" >}}
{{< blocks/products/cells/docs-title titlemsg="Clear cell area contents in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearcontents,POST,Borrar el contenido del área de celda en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearContents \'>Publicarborrar contenidos</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow, entero, el índice de la fila inicial." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,El índice de la columna inicial." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow, entero, el índice de la fila final." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,El índice de la columna final." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/CellsController/PostClearContents\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/clearcontents?range=A1:C10&startRow=1&startColumn=1&endRow=3&endColumn=3&folder=TestData/In"
    -X POST 
