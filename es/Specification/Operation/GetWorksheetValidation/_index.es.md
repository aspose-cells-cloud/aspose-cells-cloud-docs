...
type: docs
url: /es/specification/operation/getworksheetvalidation/
description: Recuperar una validación por su índice en la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, GetWorksheetValidation
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},GET,Recuperar una validación por su índice en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/# /WorksheetValidations/GetWorksheetValidation\'>GetWorksheetValidation</a>" >}}
