---
title: Obtener formato condicional de hoja de trabajo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/getworksheetconditionalformattings/
description: Recuperar descripciones de formatos condicionales en una hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, GetWorksheetConditionalFormattings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings,GET,Recuperar descripciones de formatos condicionales en una hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings\' >Obtener formatos condicionales de hoja de trabajo</a>" >}}
