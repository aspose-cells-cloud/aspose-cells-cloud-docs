---
title: Fila de hoja de cálculo de grupo de publicación
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postgroupworksheetrows/
description: Agrupar filas en la hoja de trabajo
kwords: Excel, Office, hoja de cálculo, nube REST API, PostGroupWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/group,POST,Agrupar filas en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows \'>Filas de hoja de trabajo de grupo</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,El índice de la primera fila que se va a operar." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex,integer,El último índice de fila que se operará." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ocultar, booleano, estado de filas visibles" >}} 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/cells/rows/group?firstIndex=1&lastIndex=9&hide=true&folder=TestData/In"
    -X POST 
