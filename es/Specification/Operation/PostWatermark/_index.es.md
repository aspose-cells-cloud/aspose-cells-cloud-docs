---
title: PublicarWatermar
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/postwatermark/
description: Agregue marca de agua de texto a archivos Excel y genere archivos de salida en varios formatos
kwords: Excel, Office, hoja de cálculo, nube REST API, PostWatermark
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/watermark,POST,Agregar marca de agua de texto a archivos Excel y generar archivos de salida en varios formatos.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark\'>PostWatermark</a >" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="texto, cadena, texto de fondo." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="color, cadena, por ejemplo # 1032ff" >}} 
