---
title: PutWorksheetOleObjeto
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/operation/putworksheetoleobject/
description: Agregar un objeto OLE en la hoja de trabajo
kwords: Excel, Office, Hoja de cálculo, Nube REST API, PutWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,PUT,Agregar un objeto OLE en la hoja de trabajo.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/PutWorksheetOleObject\'> PonerWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="altura, entero, altura de oleObject, en unidades de píxel" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ancho, entero, ancho de oleObject, en unidades de píxel" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="oleFile, cadena, ruta del nombre del archivo OLE (nombre completo del archivo)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="imageFile, cadena, ruta del nombre del archivo de imagen (nombre completo del archivo)." >}} 
