...
type: docs
url: /es/specification/operation/postworkbookdatafill/
...
kwords: Excel, Office, hoja de cálculo, nube REST API, PostWorkbookDataFill
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API, método Http, descripción, referencia API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datafill,POST,El llenado de datos para archivos de hojas de cálculo se utiliza principalmente para completar datos vacíos en tablas y rangos.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/ PostWorkbookDataFill\'>PostWorkbookDataFill</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Nombre del parámetro, tipo, descripción" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="relleno de datos, clase: relleno de datos," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
