---
title: Opción JsonSave
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/model/jsonsaveoptions/
description: "Aspose.Cells Especificación del modelo de nube: JsonSaveOptions. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
weight: 50
---
## **jsonGuardarOpciones**

 Representa opciones para guardar el archivo .json.
...
|Exportar como cadena| Booleano| Verdadero| FALSO|| Exporta el valor de cadena de las celdas a json.|
| Sangrar| Cadena| Verdadero| FALSO|| Indica la sangría.|
