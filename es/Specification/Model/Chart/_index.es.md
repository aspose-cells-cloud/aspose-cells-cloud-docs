...
| Pared posterior| Clase: elemento de enlace| Verdadero| FALSO||Devuelve un objeto que representa la pared posterior de un gráfico 3D.|
| CategoríaEje| Clase: elemento de enlace| Verdadero| FALSO|| Obtiene el eje X del gráfico.|
| Área del gráfico| Clase: elemento de enlace| Verdadero| FALSO|| Obtiene el área del gráfico en la hoja de cálculo.|
| Tabla de datos del gráfico| Clase: elemento de enlace| Verdadero| FALSO|| Representa la tabla de datos del gráfico.|
...
| Piso| Clase: elemento de enlace| Verdadero| FALSO|| Devuelve un objeto que representa las paredes de un gráfico 3D.|
...
| Leyenda| Clase: elemento de enlace| Verdadero| FALSO|| Obtiene la leyenda del gráfico.|
| Nombre| Cadena| Verdadero| FALSO|||
| Serie N| Clase: elemento de enlace| Verdadero| FALSO|| Obtiene una colección que representa la serie de datos del gráfico.|
...
| Área de parcela| Clase: elemento de enlace| Verdadero| FALSO|| Obtiene el área de trazado del gráfico que incluye etiquetas de marcas de eje.|
...
| Título| Clase: elemento de enlace| Verdadero| FALSO|||
| Tipo| Cadena| Verdadero| FALSO|||
| Eje de valor| Clase: elemento de enlace| Verdadero| FALSO|| Obtiene el eje Y del gráfico.|
