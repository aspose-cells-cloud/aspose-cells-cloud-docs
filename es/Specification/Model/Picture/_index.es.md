...
type: docs
url: /es/specification/model/picture/
description: "Aspose.Cells Especificación del modelo de nube: Imagen. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, hoja de cálculo, nube REST API, imagen
weight: 50
---
## **imagen**
...
|:- |:- |:- |:- |:- |:- |
| BordeLíneaColor| Clase:Color| Verdadero| FALSO|| Representa la línea del borde de una imagen.|
| Peso del borde| Flotante| Verdadero| FALSO|| Obtiene o establece el peso de la línea del borde de una imagen en unidades de pt.|
| Altura original| Entero| Verdadero| FALSO|| Obtiene la altura original de la imagen.|
| Ancho original| Entero| Verdadero| FALSO|| Obtiene el ancho original de la imagen.|
| Formato de imagen| Cadena| Verdadero| FALSO|||
| FuenteNombre completo| Cadena| Verdadero| FALSO|| Obtiene o establece la ruta y el nombre del archivo de origen de la imagen vinculada.|
