---
title: OpciónGuardarXls
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/model/xlssaveoptions/
description: "Aspose.Cells Especificación del modelo de nube: XlsSaveOptions. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, Hoja de cálculo, Nube REST API, XlsSaveOptions
weight: 50
---
## **xlsGuardarOpciones**

 Representa las opciones para guardar el archivo .xls.
