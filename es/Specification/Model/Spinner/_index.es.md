...
type: docs
url: /es/specification/model/spinner/
description: "Aspose.Cells Especificación del modelo de nube: Spinner. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, Hoja de cálculo, Nube REST API, Spinner
weight: 50
---
## **hilandero**

 Representa el control Formularios: Spinner.
...
| Sombra| Booleano| Verdadero| FALSO|| Indica si la forma tiene sombreado 3D.|
