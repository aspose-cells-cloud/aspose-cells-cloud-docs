...
type: docs
url: /es/specification/model/button/
description: "Aspose.Cells Especificación del modelo de nube: Botón. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, Hoja de cálculo, Nube REST API, Botón
weight: 50
---
## **botón**

 Representa el control Formularios: Botón
