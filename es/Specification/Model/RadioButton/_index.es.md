...
type: docs
url: /es/specification/model/radiobutton/
description: "Aspose.Cells Especificación del modelo de nube: RadioButton. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, Hoja de cálculo, Nube REST API, RadioButton
weight: 50
---
## **boton de radio**

 Representa un botón de radio.

| Nombre de la propiedad| tipo de propiedad| Anulable| Solo lectura| Valor por defecto| Descripción|
|:- |:- |:- |:- |:- |:- |
| Cuadro de grupo| Clase: Cuadro de grupo| Verdadero| FALSO|| Obtiene el GroupBox que contiene este RadioButton.|
| Está chequeado| Booleano| Verdadero| FALSO|| Indica si el botón de radio está marcado o no.|
