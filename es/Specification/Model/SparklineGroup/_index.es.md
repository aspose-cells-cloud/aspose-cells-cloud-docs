...
kwords: Excel, Office, hoja de cálculo, nube REST API, SparklineGroup
weight: 50
---
## **grupo sparkline**

 está organizado en un grupo minigráfico. Un SparklineGroup contiene un número variable de elementos minigráficos. Un grupo de minigráficos especifica el tipo, la configuración de visualización y la configuración de ejes para los minigráficos.
