---
title: OpciónGuardarOportunidades
second_title: Aspose.Cells Cloud Documen
type: docs
url: /es/specification/model/odssaveoptions/
description: "Aspose.Cells Especificación del modelo de nube: OdsSaveOptions. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, Hoja de cálculo, Nube REST API, OdsSaveOptions
weight: 50
---
## **odsGuardarOpciones**

 Representa opciones para guardar el archivo .ods.
