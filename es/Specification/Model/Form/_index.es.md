...
type: docs
url: /es/specification/model/form/
description: "Aspose.Cells Especificación del modelo de nube: formulario. Maneje sin esfuerzo Excel y otros documentos de hoja de cálculo con funciones como abrir, generar, editar, dividir, fusionar, comparar y convertir."
kwords: Excel, Office, Hoja de cálculo, Nube REST API, Formulario
weight: 50
---
## **forma**
...
|:- |:- |:- |:- |:- |:- |
| Tipo de formulario| Cadena| Verdadero| FALSO|||
| Valor comprobado| Cadena| Verdadero| FALSO|||
| Sombra| Booleano| Verdadero| FALSO|||
| Rango de entrada| Cadena| Verdadero| FALSO|||
| Índice seleccionado| Entero| Verdadero| FALSO|||
| Valor seleccionado| Cadena| Verdadero| FALSO|||
| Celda seleccionada| Clase: elemento de enlace| Verdadero| FALSO|||
| Líneas desplegables| Entero| Verdadero| FALSO|||
| Recuento de elementos| Entero| Verdadero| FALSO|||
| Celdas seleccionadas| Envase| Verdadero| FALSO|||
| Tipo de selección| Cadena| Verdadero| FALSO|||
| Está chequeado| Booleano| Verdadero| FALSO|||
| Valor actual| Entero| Verdadero| FALSO|||
| mín.| Entero| Verdadero| FALSO|||
| máx.| Entero| Verdadero| FALSO|||
| Cambio incrementado| Entero| Verdadero| FALSO|||
| Cambio de página| Entero| Verdadero| FALSO|||
| EsHorizontal| Booleano| Verdadero| FALSO|||
