...
weight: 40
---
Этот REST API указывает скрыть столбцы рабочего листа.
...
| startColumn| целое число| запрос| Начальный индекс столбца для работы.|
|всегоКолонки| целое число| запрос| Количество колонок для работы.|
| папка| нить| запрос| Папка с документами.|
| имя_хранилища| нить| запрос| имя хранилища.|
 

[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostHideWorksheetColumns) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
