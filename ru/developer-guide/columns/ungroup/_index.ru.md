---
title: Разгруппировать столбцы на рабочем листе Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Унгроу
type: docs
url: /ru/columns/ungroup/
...
description: Aspose.Cells Cloud REST API поддерживает разгруппирование столбца на листе Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
weight: 70
---
Этот REST API указывает разгруппировать столбцы рабочего листа.
...
| первый индекс| целое число| запрос| Индекс первого столбца, с которым нужно работать.|
| последний индекс| целое число| запрос| Последний обрабатываемый индекс столбца.|
| папка| нить| запрос| Папка с документами.|
| имя_хранилища| нить| запрос| имя хранилища.|


[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
