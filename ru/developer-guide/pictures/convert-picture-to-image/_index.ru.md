---
title: Получить изображение в файле Excel
...
weight: 10
---
Этот REST API указывает на `get` изображение за индексом изображения из рабочего листа Excel.
...
| изображениеИндекс| целое число| путь| Индекс изображения.|
| формат| нить| запрос| Формат экспортируемого объекта.|
| папка| нить| запрос| Папка с документами.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
