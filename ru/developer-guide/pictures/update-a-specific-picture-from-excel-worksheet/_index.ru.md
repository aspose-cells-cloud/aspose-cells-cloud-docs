...
weight: 70
---
Этот REST API указывает на изображение `update` по индексу модели для рабочего листа Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
