---
title: Получить автофигуру из рабочего листа Excel
...
| autoshapeNumber| целое число| путь| Номер автофигуры.|
| формат| нить| запрос| Экспортный формат.|
| папка| нить| запрос| Папка с документами.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Autoshapes/GetWorksheetAutoshape) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
