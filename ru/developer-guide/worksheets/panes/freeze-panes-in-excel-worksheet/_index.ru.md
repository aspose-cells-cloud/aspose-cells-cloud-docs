---
title: Заморозить панели на рабочем листе Excel
...
description: Aspose.Cells Cloud REST API поддерживает замораживание панелей на рабочем листе Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
weight: 190
---
Этот REST API указывает `set freeze panes` на рабочем листе Excel.
...
| замороженные ряды| целое число| запрос||
| замороженные столбцы| целое число| запрос||
| папка| нить| запрос||
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PutWorksheetFreezePanes) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
