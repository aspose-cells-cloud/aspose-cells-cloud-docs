---
title: Aspose.Cells Cloud Web API — Преобразование данных электронной таблицы в CSV-файл
second_title: Documen
ArticleTitle: Convert a Spreadsheet Table data to a Csv file
linktitle: Преобразовать таблицу в CS
type: docs
...
description: Эффективно преобразует таблицу из электронной таблицы на локальном диске в CSV-файл с помощью нашего API
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, JSON, Markdown, Таблица в CSV, Конвертация локальных данных в облачные
---
Конвертировать локальную электронную таблицу/Excel в CSV-файл.

## **Конвертировать таблицу в CSV API**
...
| имя_таблицы|Нить| Запрос|Имя преобразуемой таблицы.|
...
| шрифтыРасположение|Нить| Запрос| Путь для использования пользовательских шрифтов.|
...
## Почему вам следует использовать функцию «Конвертировать таблицу в CSV» API?
...
## Как использовать таблицу «Преобразовать в CSV» API с SDK?

### Конвертировать таблицу в CSV API Спецификация

 The[Конвертировать таблицу в CSV API Спецификация](https://reference.aspose.cloud/cells/#/ConversionController/ConvertTableToCsv) предоставляет общедоступный программный интерфейс, позволяющий взаимодействовать с REST непосредственно из веб-браузера.

### Используйте облачные SDK Aspose.Cells

Использование SDK — самый быстрый способ разработки, поскольку он абстрагируется от низкоуровневых деталей и позволяет преобразовать данные электронной таблицы в CSV-файл с коротким кодом.
