---
title: Получить использование диска
second_title: Documen
linktitle: Получить использование диска
type: docs
url: /ru/get-disk-usage/
keywords: API, Disk Usage, Aspose, Cloud, Excel, REST, Storage, Disc Space, SDK, Programming Interfac
description: Получить текущее использование диска для Excel API в облаке Aspose
weight: 100
kwords: Использование диска, Excel API, Aspose Облако, REST API, Информация о хранилище, Примеры SDK, Программный интерфейс
---
...
Эта конечная точка API извлекает текущее использование диска для Excel API в облачной среде Aspose, позволяя разработчикам отслеживать пространство хранилища, используемое их приложениями.

###  Параметры запроса**getDiskUsage** API есть

| Имя параметра| Тип| Путь/Строка запроса/HTTPBody| Описание|
|:- |:- |:- |:- |
|имя_хранилища|Нить|Запрос|Имя хранилища, для которого требуется получить данные об использовании диска.|
...
## Спецификация OpenAPI
 ...
 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/StorageController/GetDiskUsage) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
