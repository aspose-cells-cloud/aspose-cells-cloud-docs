---
title: Объект существует
second_title: Documen
linktitle: Объект существует
type: docs
...
description: Объект Exists API проверяет, существует ли указанный файл или папка в облачном хранилище Aspose.Cells.
weight: 100
kwords: Excel API, Объект существует, REST API, Aspose, Office Облако, Управление файлами, Электронная таблица, PDF, CSV, JSON, Markdown, Проверка существования файла в Exce
---
## **Excel API: Объект существует**
...
`objectExists` API позволяет разработчикам проверять существование указанного файла или папки в облачном хранилище Aspose.Cells.

###  Параметры запроса**объектсуществует** API есть

| Имя параметра| Тип| Путь/Строка запроса/Тело HTTP| Описание|
|:- |:- |:- |:- |
|путь|Нить|Путь|Путь к файлу или папке в облачном хранилище.|
...
## Спецификация OpenAPI
 ...
 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/StorageController/ObjectExists) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
