...
- Стандартные свойства являются общими для Excel. Они содержат основную информацию о документе, такую как название, тема, автор, категория и т. д. Вы можете назначить собственные текстовые значения для этих свойств, чтобы упростить поиск документа Excel.
