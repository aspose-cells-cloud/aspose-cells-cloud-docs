---
title: Удалить метаданные в файлах Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/DeleteMetadata) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
