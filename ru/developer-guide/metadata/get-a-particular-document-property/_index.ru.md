---
title: Получите определенное свойство документа
...
weight: 20
kwords: Excel, Office Cloud, REST API, электронная таблица, PDF, CSV, Json, Markdwon, получение определенного свойства документа
---
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
