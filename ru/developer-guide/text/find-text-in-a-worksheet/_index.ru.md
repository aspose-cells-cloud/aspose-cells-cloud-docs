---
title: Найдите текст на листе Excel.
second_title: Aspose.Cells Cloud Documen
linktitle: Найти на листе
type: docs
...
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdwon, Найти текст на листе Excel
---
Этот REST API указывает на текст `search` на листе Excel.
...
| текст| нить| запрос| Текст для поиска.|
| папка| нить| запрос| Папка документа.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextSearch) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
