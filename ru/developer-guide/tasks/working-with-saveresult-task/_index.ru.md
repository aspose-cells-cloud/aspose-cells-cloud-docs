---
title: Работа с татами SaveResult
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/tasks/save-result/
aliases: [/working-with-saveresult-task/]
keywords: REST API, task, save result, spreadsheets, exce
description: "Cells.Облако API для Excel работа: задачи поддерживают сохранение результата в ответном контенте или в облачном хранилище"
weight: 50
---
## ОТДЫХ API
