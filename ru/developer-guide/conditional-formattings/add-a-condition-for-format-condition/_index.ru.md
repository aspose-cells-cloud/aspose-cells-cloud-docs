...
type: docs
url: /ru/conditional-formattings/add-a-condition/
aliases: [/add-a-condition-for-format-condition/]
keywords: REST API, spreadsheets, excel, add conditiona
description: "Cells.Облако API для Excel работает: добавить условное"
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdwon, Добавить условие
---
Этот REST API указывает на добавление условия для условия формата.
...
| формула 1| нить| запрос||
| формула2| нить| запрос||
| папка| нить| запрос||
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/PutWorksheetFormatConditionCondition) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
