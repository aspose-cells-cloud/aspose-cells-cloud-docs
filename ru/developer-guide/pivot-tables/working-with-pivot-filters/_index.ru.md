---
title: Работа со сводным фильтром
...
weight: 50
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdwon, Работа со сводными фильтрами
---
Этот REST API указывает `add` опорную точку `filter` для индекса таблицы Piovt.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTableFilter) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
