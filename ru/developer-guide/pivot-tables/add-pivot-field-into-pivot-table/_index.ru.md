---
title: Добавьте сводное поле в сводную таблицу
...
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdwon, Добавление сводного поля в сводную таблицу
---
...
| Сводное полетипе| нить| запрос| Тип области полей.|
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PutPivotTableField) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
