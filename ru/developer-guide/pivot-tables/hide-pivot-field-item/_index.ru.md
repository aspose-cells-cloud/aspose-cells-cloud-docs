...
weight: 110
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdwon, Скрыть элемент сводного поля в сводной таблице
---
...
| индекс элемента| целое число| запрос||
| isHide|логическое значение| запрос||
| нужнопересчитать|логическое значение| запрос| ЛОЖЬ|
| папка| нить| запрос||
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldHideItem) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
