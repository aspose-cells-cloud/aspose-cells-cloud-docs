---
title: Добавить пустую строку на лист Excel
...
weight: 20
---
Этот REST API указывает на добавление новой строки рабочего листа на рабочий лист Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRow) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
