---
title: Добавьте несколько строк на лист Excel.
second_title: Aspose.Cells Cloud Documen
linktitle: Ряд
type: docs
url: /ru/rows/add/rows/
keywords: Add multi rows on an Excel workshee
description: Aspose.Cells Cloud REST API поддерживает добавление нескольких строк на лист Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 20
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdwon, Добавление нескольких строк на лист Excel
---
Этот REST API указывает на добавление нескольких новых строк рабочего листа на лист Excel.
...
| всего строк| целое число| запрос|1 |
| обновитьссылку|логическое значение| запрос| Истинный|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRows) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
