---
title: Групповые строки на рабочем листе Excel
...
| первый индекс| целое число| запрос| Индекс первой строки, с которой нужно работать.|
| последний индекс| целое число| запрос| Индекс последней обрабатываемой строки.|
| скрывать| логический| запрос| видимое состояние строк|
| папка| нить| запрос| Папка с документами.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
