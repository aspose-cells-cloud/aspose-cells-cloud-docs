---
title: Группируйте строки на рабочем листе Excel.
...
description: Aspose.Cells Cloud REST API поддерживает группировку строк на листе Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 60
kwords: Excel, Office Облако, REST API, электронная таблица, PDF, CSV, Json, Markdwon, групповые строки на листе Excel.
---
Этот REST API указывает на группировку строк на листе Excel.
...
| первыйиндекс| целое число| запрос| Индекс первой строки, с которой нужно работать.|
| последнийиндекс| целое число| запрос| Индекс последней строки, с которой нужно работать.|
| скрывать|логическое значение| запрос| состояние видимости строк|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
