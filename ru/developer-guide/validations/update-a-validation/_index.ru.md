---
title: Обновите проверку листа на листе Excel.
...
weight: 10
kwords: Excel, Office Cloud, REST API, электронная таблица, PDF, CSV, Json, Markdwon, обновление проверки листа на листе Excel.
---
Этот REST API указывает на обновление проверки листа по индексу на листе Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
