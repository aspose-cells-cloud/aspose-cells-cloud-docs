---
title: Автоподбор столбцов в рабочей книге Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Столбец
type: docs
url: /ru/workbook/autofit/columns/
...
weight: 90
kwords: Excel, Office Cloud, REST API, электронная таблица, PDF, CSV, Json, Markdwon, столбцы автоподбора в книге Excel
---
Этот REST API указывает на автоподбор столбцов в книге Excel.
...
| startColumn| целое число| запрос| Начало столбца.|
| КонецКолонка| целое число| запрос| Конец столбца.|
| папка| нить| запрос| Папка документа.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookColumns) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
