---
title: Преобразование формы в изображение
second_title: Aspose.Cells Cloud Documen
linktitle: Преобразование
type: docs
url: /ru/shapes/conversion/
aliases: [/convert-autoshape-to-image/]
keywords: Convert shape on an Excel workshee
description: Aspose.Cells Cloud REST API поддерживает преобразование формы на листе Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
weight: 10
---
Этот REST API указывает на получение формы с форматом изображения на листе Excel.
