---
title: Добавьте фигуру на лист Excel.
...
| формаDTO|| тело||
| тип чертежа| нить| запрос| Тип объекта формы|
| верхний левый ряд| целое число| запрос| Индекс верхней левой строки.|
| верхний левый столбец| целое число| запрос| Индекс верхнего левого столбца.|
| вершина| целое число| запрос| Представляет вертикальное смещение Spinner от его левого ряда в пикселях.|
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
