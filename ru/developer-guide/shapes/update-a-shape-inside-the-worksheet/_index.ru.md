---
title: Обновление формы на рабочем листе Excel
...
weight: 31
---
Этот REST API указывает на необходимость обновления формы на листе Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Shapes/PostWorksheetShape) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
