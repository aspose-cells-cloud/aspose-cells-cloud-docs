...
---
Этот REST API указывает на вставку среза для объекта списка на листе Excel.
...
|имя_хранилища|Нить|Запрос||
 ...
 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectInsertSlicer) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
