...
description: Aspose.Cells Cloud REST API поддерживает автоматическую подгонку строк на листе Excel. SDK поддерживает различные языки разработки, включая Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Автоматический подбор нескольких строк на листе Excel
---
Этот REST API указывает на автоматическую подгонку строк на листе Excel.
...
| autoFitterOptions|| тело| Параметры автоустановки.|
| startRow| целое число| запрос| Начальный ряд.|
| конец строки| целое число| запрос| Конец ряда.|
| толькоАвто| булев| запрос|ЛОЖЬ|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
