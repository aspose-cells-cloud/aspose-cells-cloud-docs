...
description: Aspose.Cells Cloud REST API поддерживает получение OLE-объекта на листе Excel. SDK поддерживает различные языки разработки, включая Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получение объекта OLE на листе Excel
---
Этот REST API указывает на `get` `OLE object` с форматом на рабочем листе Excel.
