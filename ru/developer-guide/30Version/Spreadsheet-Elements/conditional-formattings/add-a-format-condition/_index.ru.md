---
title: Добавить условие формата
type: docs
...
description: "Cells.Cloud API для работы Excel: добавьте условие форматирования"
weight: 50
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Добавить условие форматирования
---
Этот REST API указывает на добавление условия форматирования.
...
| cellArea| нить| запрос||
| тип| нить| запрос||
| Тип оператора| нить| запрос||
| формула1| нить| запрос||
| формула2| нить| запрос||
| папка| нить| запрос||
| имя_хранилища| нить| запрос| имя хранилища.|
 
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/PutWorksheetFormatCondition) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
