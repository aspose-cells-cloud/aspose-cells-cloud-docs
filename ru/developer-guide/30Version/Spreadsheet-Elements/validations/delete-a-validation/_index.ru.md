---
title: Удалить проверку рабочего листа Excel
...
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Удалить проверку листа на листе Excel
---
Этот REST API указывает на необходимость удаления проверки листа по индексу на листе Excel.
