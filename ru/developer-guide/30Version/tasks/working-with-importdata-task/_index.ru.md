...
description: "Cells.Cloud API для Excel работает: задачи поддерживают импорт данных в файл Excel"
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Работа с задачей ImportData
---
## ОТДЫХ API
