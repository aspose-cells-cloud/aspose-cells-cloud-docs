...
description: "Cells.Cloud API для Excel работает: создание сводной таблицы с помощью задачи CellsObjectOperate"
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Работа со сводной таблицей с использованием задачи CellsObjectOperate
---
Этот REST API создает `pivot table`, используя объект ячеек, оперирует `task`.
