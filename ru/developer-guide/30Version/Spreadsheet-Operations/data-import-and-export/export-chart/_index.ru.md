...
description: Aspose.Cells Cloud REST API поддерживает экспорт диаграмм Excel в файлы различных форматов. SDK поддерживает различные языки разработки, включая Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 20
...
|:- |:- |:- |:- |
|/cells/export|ПОЧТА|Экспортировать объекты Excel из содержимого запроса в какой-либо формат|[ПостЭкспорт](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
