...
description: Восстановление файлов Excel с помощью Aspose.Cells Cloud REST API. API поддерживает множество языков разработки, включая Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift для быстрой интеграции в ваши проекты.
weight: 39
...
Приложение Aspose.Cells Cloud Excel Repair восстанавливает данные из повреждённых файлов Excel онлайн без установки. Повреждённые файлы Excel могут представлять проблему, поскольку вы не сможете их открыть. Вы можете попробовать приложение Aspose.Cells Cloud Excel Repair для восстановления данных из повреждённых файлов Excel.
...
| формат| нить| запрос| Формат вывода. Значение по умолчанию — null, формат вывода соответствует формату входного файла.|
 ...
 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/LightCells/PostRepair) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
