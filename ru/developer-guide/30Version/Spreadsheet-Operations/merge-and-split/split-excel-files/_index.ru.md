...
linktitle: Разделить Excel fil
type: docs
url: /ru/split-multi-excel-files/
aliases: [ /split/multi-files/]
keywords: Split an Excel workbook to multi-files
description: Aspose.Cells Cloud REST API поддерживает разделение рабочей книги Excel на несколько файлов. SDK поддерживает различные языки разработки, включая Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 130
kwords: Excel, Office Cloud, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Разделение книги Excel на несколько файлов
---
...
|от|целое число|Начать оглавление рабочего листа.|
...
|:- |:- |:- |:- |
|/cells/{name}/split|ПОЧТА|Разделить рабочую книгу Excel|[PostWorkbookSplit](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit)|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit) определяет общедоступный программный интерфейс и позволяет осуществлять REST-взаимодействие непосредственно из веб-браузера.
