---
title: Пакетное преобразование
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/batch/convert
keywords: Batch conversion of multiple excel files
description: Aspose.Cells Cloud API поддерживает пакетное преобразование нескольких файлов Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 100
kwords: Excel, Office Облако, REST API, электронная таблица, PDF, CSV, Json, Markdwon, пакетное преобразование
---
...
|:- |:- |:- |:- |
| Пакетная конвертация запроса|| тело||

**Свойства пакетного запросаConvertRequest**
 
Имя | Тип | Описание | Примечания
------------ | ------------- | ------------- | -------------
 Исходная папка | строка | | [необязательно]Условие совпадения | ЗапросУсловия Сопоставления | | [необязательно]Формат | строка | | [необязательно]OutFolder | строка | | [необязательно]СохранитьПараметры | СохранитьПараметры | | [необязательный]**Свойства MatchConditionRequest**
 
Имя | Тип | Описание | Примечания
------------ | ------------- | ------------- | -------------
 РегексПаттерн | строка | | [необязательно]FullMatchConditions | строка[]| | [необязательно][Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PostBatchConvert) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
