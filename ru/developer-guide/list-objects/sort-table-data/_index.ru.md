---
title: Сортировка данных объекта списка на листе Excel
...
weight: 40
kwords: Excel, Office Cloud, REST API, электронная таблица, PDF, CSV, Json, Markdwon, сортировка данных объекта списка на листе Excel
---
Этот REST API указывает на `sort table's data` на листе Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSortTable) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
