---
title: Разъединить Cells в рабочей таблице Excel
type: docs
url: /ru/unmerge-cells-in-excel-worksheet/
weight: 120
kwords: Excel, Office Облако, REST API, электронная таблица, PDF, CSV, Json, Markdwon, разъединить Cells в рабочем листе Excel
---
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
