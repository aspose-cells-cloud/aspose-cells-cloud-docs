---
title: Получить MinDataRow из рабочей таблицы Excel
type: docs
url: /ru/get-mindatarow-from-excel-worksheet/
weight: 90
---
Этот REST API указывает, что шоу получает `mindatarow` в файле Excel, когда параметр `cellOrMethodName` равен `mindatarow`.
