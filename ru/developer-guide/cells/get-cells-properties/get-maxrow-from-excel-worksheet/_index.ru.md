---
title: Получить MaxRow от рабочей таблицы Excel
type: docs
url: /ru/get-maxrow-from-excel-worksheet/
weight: 40
---
Этот REST API указывает, что шоу получает `maxrow` в файле Excel, когда параметр `cellOrMethodName` равен `maxrow`.
