...
weight: 110
kwords: Excel, Office Облако, REST API, электронная таблица, PDF, CSV, Json, Markdwon, объединить Cells в рабочий лист Excel
---
Этот REST API указывает на `merge` ячеек в файле Excel.
...
| startColumn| целое число| запрос| Стартовый столбец.|
| всего строк| целое число| запрос| Всего строк|
| итогостолбцы| целое число| запрос| Итоговые столбцы.|
| папка| нить| запрос| Папка рабочей книги.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
