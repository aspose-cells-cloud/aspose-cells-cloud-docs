---
title: Экспортировать объект списка
...
description: Aspose.Cells Cloud REST API поддерживает экспорт Excel объекта списка в различные форматы файлов. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 20
kwords: Excel, Office Облако, REST API, электронная таблица, PDF, CSV, Json, Markdwon, объект списка экспорта
---
