...
|:- |:- |:- |:- |
|/ячейки/экспорт|ПОМЕЩАТЬ|Экспорт объектов Excel из содержимого запроса в какой-либо формат|[Постэкспорт](https://apireference.aspose.cloud/cells/#/LiteCells/PostExport)|
