---
title: Экспорт символов
second_title: Aspose.Cells Cloud Documen
linktitle: Чар
type: docs
url: /ru/export/excel-chart-to-different-formats/
keywords: Export Excel chart to kinds of format files
description: Aspose.Cells Облачный REST API поддерживает экспорт Excel диаграмм в различные форматы файлов. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
weight: 20
---
...
|:- |:- |:- |:- |
|/ячейки/экспорт|ПОЧТА|Экспорт Excel объектов из содержимого запроса в какой-либо формат|[Постэкспорт](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
