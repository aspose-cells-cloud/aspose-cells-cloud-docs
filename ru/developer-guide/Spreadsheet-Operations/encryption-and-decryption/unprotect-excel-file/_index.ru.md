...
description: "Cells.Облако API для работы Excel: защита рабочей книги Excel"
weight: 60
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Снятие защиты с рабочей книги Excel
---
...
|:- |:- |:- |:- |
|/клетки/{имя}/защита|УДАЛИТЬ|Снять защиту документа|[УдалитьСнятьЗащитуРабочая книга](https://apireference.aspose.cloud/cells/#/Workbook/DeleteUnProtectWorkbook)|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/DeleteUnProtectWorkbook) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
