---
title: Заблокировать файл Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Заблокировать файл Excel
type: docs
url: /ru/lock-excel-files/
aliases: [/lock/without-storage/,/lock/,/lock/without-using-storage/]
keywords: Lock Excel files
description: Aspose.Cells Cloud REST API поддерживает блокировку Excel файлов. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 70
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Блокировка
---
...
| пароль| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostLock) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
