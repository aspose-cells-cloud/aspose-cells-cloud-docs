---
title: Автоподбор столбцов на Excel fil
...
| стартКолонка| целое число| запрос| Стартовая колонка.|
| конецКолонки| целое число| запрос| Конец столбца.|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookColumns) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
