...
description: Aspose.Cells Cloud REST API как создать Excel рабочую книгу с шаблоном смарт-маркера. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Как создать книгу Excel с шаблоном смарт-маркера
---
...
|:- |:- |:- |:- |
|/cells/{name}/smartmarker|ПОЧТА|Создайте новую рабочую книгу Excel из файла шаблона SmartMarker|[PostWorkbookGetSmartMarkerResult](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookGetSmartMarkerResult)|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookGetSmartMarkerResult) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
