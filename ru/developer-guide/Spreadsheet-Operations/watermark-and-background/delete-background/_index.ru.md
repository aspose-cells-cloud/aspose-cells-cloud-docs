---
title: Удалить фон в рабочей книге Excel
...
description: Aspose.Cells Cloud REST API поддерживает удаление фона в рабочей книге Excel в файле Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 170
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Удаление фона в рабочей книге Excel
---
Этот REST API указывает на необходимость удаления фона в рабочей книге Excel.
...
|:- |:- |:- |:- |
|/cells/{имя}/фон|УДАЛИТЬ|Удалить фон в файле Excel|[УдалитьWorkbookBackground](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground)|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
