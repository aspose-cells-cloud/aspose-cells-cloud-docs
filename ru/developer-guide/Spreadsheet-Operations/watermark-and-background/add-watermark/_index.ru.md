...
description: Aspose.Cells Cloud REST API поддерживает добавление маркера воды для файлов Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 39
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Водяной знак
---
Этот REST API указывает на добавление `watermark` в файлы Excel.
...
| цвет| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
