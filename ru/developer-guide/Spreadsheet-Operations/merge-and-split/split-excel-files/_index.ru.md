...
linktitle: Разделить Excel фил
type: docs
url: /ru/split-multi-excel-files/
aliases: [ /split/multi-files/]
keywords: Split an Excel workbook to multi-files
description: Aspose.Cells Cloud REST API поддерживает разделение рабочей книги Excel на несколько файлов. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 130
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Разделение книги Excel на несколько файлов
---
Этот REST API указывает на необходимость разбить Excel `workbook` на несколько файлов с разным форматом.
...
|к|целое число|Конец индекса рабочего листа.|
|горизонтальноеРазрешение|целое число|Горизонтальное разрешение изображения.|
|вертикальныйResolution|целое число|Вертикальное разрешение изображения.|
|outFolder|нить|выходная позиция разделенного файла.|
|splitNameПравило|нить||
...
|:- |:- |:- |:- |
|/cells/{name}/разделить|ПОЧТА|Разделить рабочую книгу Excel|[PostWorkbookSplit](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit)|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
