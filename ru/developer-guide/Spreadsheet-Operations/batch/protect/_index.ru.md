---
title: Пакетная защита Excel Файл
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/batch/protect
keywords: Batch protection of multiple Excel files
description: Aspose.Cells Cloud API поддерживает пакетную защиту нескольких файлов Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 100
...
|:- |:- |:- |:- |
| пакетProtectRequest|| тело||

**Свойства BatchProtectRequest**

Имя | Тип | Описание | Примечания
------------ | ------------- | ------------- | -------------
 SourceFolder | string | | [необязательно]MatchCondition | MatchConditionRequest | | [необязательно]ProtectionType | string | | [необязательно]Password | string | | [необязательно]OutFolder | string | | [необязательно]**Свойства MatchConditionRequest**

Имя | Тип | Описание | Примечания
------------ | ------------- | ------------- | -------------
 RegexPattern | string | | [необязательно]FullMatchConditions | string[]| | [необязательно][Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PostProtectConvert) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
