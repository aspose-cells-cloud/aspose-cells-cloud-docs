...
description: Aspose.Cells Cloud REST API поддерживает сжатие файлов Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 39
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Сжатие
---
Этот REST API указывает на данные `compress` в файле Excel.

- Сжатие XLS, XLSX, XLSM, XLSB, ODS
- Быстрый способ сжатия нескольких файлов электронных таблиц Excel
...
| Уровень сжатия| целое число| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostCompress) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
