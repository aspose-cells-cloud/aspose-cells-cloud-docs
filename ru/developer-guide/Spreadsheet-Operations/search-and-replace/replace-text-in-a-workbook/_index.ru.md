---
title: Заменить текст в рабочей книге Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Заменить в рабочей книге
type: docs
...
description: Aspose.Cells Cloud REST API поддерживает замену текста из рабочей книги Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Замена текста в рабочей книге Excel
---
Этот REST API указывает на текст `replace` в рабочей книге Excel.
...
| староеЗначение| нить| запрос| Старый текст для замены.|
| новоеЗначение| нить| запрос| Новый текст для замены.|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorsheetTextReplace) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
