...
description: Aspose.Cells Cloud REST API поддерживает замену старого значения на новое значение в файлах Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 80
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Замена текста из файлов Excel
---
Этот REST API указывает на данные `replace` из файлов Excel.
...
| текст| нить| запрос||
| новыйтекст| нить| запрос||
| пароль| нить| запрос||
| имя_листа| нить| запрос||

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostReplace) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
