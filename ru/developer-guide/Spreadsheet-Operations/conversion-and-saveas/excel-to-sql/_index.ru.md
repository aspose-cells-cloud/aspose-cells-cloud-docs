...
linktitle: Excel в кв.
type: docs
url: /ru/convert-excel-file-to-sql-file/
keywords: Convert excel files to sql files
description: Aspose.Cells Cloud REST API поддерживает преобразование файлов Excel в файлы SQL. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Excel в SQL
---
Этот REST API указывает `convert` на файл электронной таблицы в формате SQL.
...
|:- |:- |:- |:- |
|/ячейки/конвертировать/sql|ПОЧТА|Преобразовать электронную таблицу в файл SQL.|[PostConvertWorkbookToSQL](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL)|

 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
