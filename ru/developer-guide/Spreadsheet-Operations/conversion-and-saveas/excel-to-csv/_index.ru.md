...
---
Этот REST API указывает `convert` на файл электронной таблицы в формате CSV.
...
|:- |:- |:- |:- |
|/ячейки/конвертировать/csv|ПОЧТА|Преобразуйте электронную таблицу в CSV-файл.|[PostConvertWorkbookToCSV](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV)|

 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
