---
title: Очистить форматирование условий
type: docs
...
description: "Cells.Cloud API для Excel работает: очищает все форматы условий"
weight: 80
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Очистить форматирование условий
---
Этот REST API указывает на Очистить все форматирования условий
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/DeleteWorksheetConditionalFormattings) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
