---
title:  Получить значение диаграммы Axi
type: docs
url: /ru/charts/value-axis/get/
weight: 60
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить ось значений диаграммы
---
...
| имя_хранилища| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartValueAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
