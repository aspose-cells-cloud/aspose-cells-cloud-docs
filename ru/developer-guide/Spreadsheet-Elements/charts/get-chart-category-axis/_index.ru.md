---
title:  Получить диаграмму категории Axi
type: docs
url: /ru/charts/category-axis/get/
weight: 60
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить ось категорий диаграммы
---
Этот REST API указывает на получение оси категорий диаграммы
...
| имя_хранилища| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
