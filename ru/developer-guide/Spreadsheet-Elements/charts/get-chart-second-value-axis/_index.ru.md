---
title:  Получить диаграмму второго значения оси
type: docs
url: /ru/charts/second-value-axis/get/
weight: 60
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить диаграмму, вторая ось значений
---
...
| имя_хранилища| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondValueAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
