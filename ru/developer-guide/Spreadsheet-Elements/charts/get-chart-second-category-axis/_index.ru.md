---
title:  Получить диаграмму Axis второй категории
type: docs
url: /ru/charts/second-category-axis/get/
weight: 60
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить диаграмму Вторая ось категории
---
 Этот REST API указывает на получение оси второй категории диаграммы.
...
| имя| нить| путь||
| Имя листа| нить| путь||
| диаграммаИндекс| целое число| путь||
| папка| нить| запрос||
| имя_хранилища| нить| запрос||
 
 Tget-chart-second-category-axis copyhe[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondCategoryAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
