---
title:  Обновление диаграммы категории Axi
type: docs
url: /ru/charts/category-axis/update/
weight: 160
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Обновление оси категорий диаграммы
---
Этот REST API указывает на обновление оси категорий диаграммы.
...
| имя_хранилища| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartCategoryAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
