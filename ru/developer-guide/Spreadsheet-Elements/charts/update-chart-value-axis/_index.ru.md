---
title:  Обновление оси значений диаграммы
type: docs
url: /ru/charts/value-axis/update/
weight: 160
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Обновление оси значений диаграммы
---
...
| имя_хранилища| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartValueAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
