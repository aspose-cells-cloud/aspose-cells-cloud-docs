---
title:  Обновление диаграммы второй категории Axis
type: docs
url: /ru/charts/second-category-axis/update/
weight: 160
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Обновление диаграммы, вторая ось категории
---
 Этот REST API указывает на обновление оси второй категории диаграммы.
...
| имя_хранилища| нить| запрос||
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondCategoryAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
