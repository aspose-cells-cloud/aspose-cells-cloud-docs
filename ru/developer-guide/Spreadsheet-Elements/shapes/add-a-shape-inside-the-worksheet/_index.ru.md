...
description: Aspose.Cells Cloud REST API поддерживает добавление формы на лист Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 30
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Добавить фигуру на рабочий лист Excel
---
Этот REST API указывает на необходимость добавления фигуры на рабочий лист Excel.
...
| shapeDTO|| тело||
|чертежТип| нить| запрос| тип объекта формы|
| верхний левый ряд| целое число| запрос| Верхний левый индекс строки.|
| верхняя левая колонка| целое число| запрос| Верхний левый столбец индекса.|
| вершина| целое число| запрос| Представляет вертикальное смещение Spinner от его левой строки в пикселях.|
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
