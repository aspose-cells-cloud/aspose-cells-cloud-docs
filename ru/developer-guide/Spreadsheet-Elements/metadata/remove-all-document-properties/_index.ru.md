---
title: Удалить все свойства документа
...
description: Aspose.Cells Cloud REST API поддерживает удаление свойств из файлов Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 58
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Удалить все свойства документа
---
Этот REST API указывает на пользовательские свойства документа `delete all` и чистые встроенные свойства.
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
