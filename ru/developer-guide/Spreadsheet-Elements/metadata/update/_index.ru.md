...
description: Aspose.Cells Cloud REST API поддерживает обновление метаданных в файлах Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 35
...
| Свойства документа|| тело| Cells документ собственности.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PostMetadata) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
