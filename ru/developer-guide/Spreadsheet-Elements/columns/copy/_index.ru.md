---
title: Копировать столбцы на листе Excel
...
description: Aspose.Cells Cloud REST API поддерживает копирование столбцов на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 30
...
| sourceColumnIndex| целое число| запрос| Исходный индекс столбца|
...
| папка| нить| запрос| Папка с документами.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetColumns) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
