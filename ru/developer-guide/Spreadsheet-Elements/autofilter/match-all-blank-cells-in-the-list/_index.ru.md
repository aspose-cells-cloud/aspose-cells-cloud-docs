...
linktitle: Соответствие пустому элементу
type: docs
...
description: Облако Aspose.Cells API поддерживает сопоставление всех пустых ячеек в списке фильтров на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Сопоставление всех пустых ячеек на листе Excel
---
Этот REST API указывает `match` на все `blank cell` в списке фильтров на рабочем листе Excel.
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
