---
title: Удалить фильтр на рабочем листе Excel
...
description: Облако Aspose.Cells API поддерживает удаление фильтра на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Удалить фильтр на листе Excel
---
Этот REST API указывает на необходимость удаления `filter` на рабочем листе Excel.
...
|датаВремяГруппировкаТип|нить| Запрос| День/Час/Минута/Месяц/Секунда/Год|
...
|имя_хранилища|нить| Запрос|Имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetFilter) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
