---
title: Добавьте динамический фильтр даты на рабочий лист Excel
...
description: Облако Aspose.Cells API поддерживает добавление динамического фильтра на лист Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 65
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Добавить динамический фильтр даты на лист Excel
---
...
| динамическийТипФильтра| нить| запрос||
| матчБланки| булев| запрос||
| обновить| булев| запрос||
| папка| нить| запрос||
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDynamicFilter) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
