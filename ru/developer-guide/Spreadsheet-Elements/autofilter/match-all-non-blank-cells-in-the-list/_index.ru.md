---
title: Найдите все непустые ячейки на рабочем листе Excel
...
description: Облако Aspose.Cells API поддерживает сопоставление всех непустых ячеек в списке фильтров на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Сопоставление всех непустых ячеек на листе Excel
---
Этот REST API указывает `match` на все `not blank cell` в списке на рабочем листе Excel.
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchNonBlanks) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
