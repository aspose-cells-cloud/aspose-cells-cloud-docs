---
title: Получить первую ячейку из Excel Worksheet
type: docs
url: /ru/get-first-cell-from-excel-worksheet/
weight: 20
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить первую ячейку из Excel Рабочий лист
---
