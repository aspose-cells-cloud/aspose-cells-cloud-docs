---
title: Получить MaxDataRow из Excel Worksheet
type: docs
url: /ru/get-maxdatarow-from-excel-worksheet/
weight: 50
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить MaxDataRow из Excel Рабочий лист
---
Этот REST API указывает на то, что шоу получает `maxdatarow` в файле Excel, когда параметр `cellOrMethodName` равен `maxdatarow`.
