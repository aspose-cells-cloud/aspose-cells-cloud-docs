---
title: Получить MinDataColumn из Excel Worksheet
type: docs
url: /ru/get-mindatacolumn-from-excel-worksheet/
weight: 110
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить MinDataColumn из Excel Рабочий лист
---
