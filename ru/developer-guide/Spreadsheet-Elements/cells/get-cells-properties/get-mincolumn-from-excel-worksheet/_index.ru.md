---
title: Получить MinColumn из Excel Worksheet
type: docs
url: /ru/get-mincolumn-from-excel-worksheet/
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить MinColumn из Excel Рабочий лист
---
Этот REST API указывает на то, что шоу получает `mincolumn` в файле Excel, когда параметр `cellOrMethodName` равен `mincolumn`.
