...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetCell) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
...
### **Как получить определенную ячейку**

- [Получить данные ячеек с рабочего листа](/cells/ru/get-cell-data-from-a-worksheet/)
...
- [Получить MaxRow из Excel Рабочий лист](/cells/ru/get-maxrow-from-excel-worksheet/)
- [Получить MaxDataRow из рабочего листа Excel](/cells/ru/get-maxdatarow-from-excel-worksheet/)
- [Получить MaxColumn из Excel рабочего листа](/cells/ru/get-maxcolumn-from-excel-worksheet/)
- [Получить MaxDataColumn из рабочего листа Excel](/cells/ru/get-maxdatacolumn-from-excel-worksheet/)
- [Получить MinRow из Excel рабочего листа](/cells/ru/get-minrow-from-excel-worksheet/)
