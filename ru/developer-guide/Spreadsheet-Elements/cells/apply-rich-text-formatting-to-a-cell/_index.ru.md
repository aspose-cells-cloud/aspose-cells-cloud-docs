---
title: Применить форматирование расширенного текста к Cel
type: docs
url: /ru/apply-rich-text-formatting-to-a-cell/
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Применение форматирования расширенного текста к ячейке
---
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
