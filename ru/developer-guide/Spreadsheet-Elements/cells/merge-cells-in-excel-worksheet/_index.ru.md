---
title: Объединить Cells в Excel Worksheet
type: docs
url: /ru/merge-cells-in-excel-worksheet/
weight: 110
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Объединение Cells в Excel Рабочий лист
---
Этот REST API указывает на ячейки `merge` в файле Excel.
...
| всегоСтрок| целое число| запрос| Общее количество строк|
| всегоКолонки| целое число| запрос| Общее количество столбцов.|
| папка| нить| запрос| Папка с рабочей тетрадью.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
