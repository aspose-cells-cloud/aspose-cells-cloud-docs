---
title: Очистить форматирование Cells на рабочем листе Excel
type: docs
url: /ru/clear-cells-formatting-in-excel-worksheet/
weight: 100
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Очистить Cells Форматирование в Excel Рабочий лист
---
Этот REST API указывает на ячейки `clear` `style` в файле Excel.
...
| стартКолонка| целое число| запрос| Начальная колонка.|
| конецСтрока| целое число| запрос| Последний ряд.|
| конецКолонки| целое число| запрос| Конечный столбец.|
| папка| нить| запрос| Папка с рабочей тетрадью.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
