...
description: Aspose.Cells Cloud REST API поддерживает добавление объекта списка (таблицы) в рабочий лист Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Добавить объект списка на рабочий лист Excel
---
Этот REST API указывает на `add a list object(table)` на рабочем листе Excel.
...
| стартКолонка| целое число| запрос| Начальная строка диапазона списка.|
| конецСтрока| целое число| запрос| Начальная строка диапазона списка.|
| конецКолонки| целое число| запрос| Начальная строка диапазона списка.|
| hasHeaders| булев| запрос| Истинный|
| списокОбъект|| тело| Список объектов|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/PutWorksheetListObject) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
