...
description: Aspose.Cells Cloud REST API поддерживает получение листа в другом формате из листа Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить рабочий лист из рабочего листа Excel
---
...
| вертикальныйResolution| целое число| запрос| Устанавливает вертикальное разрешение для создаваемых изображений в точках на дюйм.|
| горизонтальноеРазрешение| целое число| запрос| Устанавливает горизонтальное разрешение для создаваемых изображений в точках на дюйм.|
| область| нить| запрос| Экспортируемая площадь.|
| pageIndex| целое число| запрос| Экспортированный индекс страницы.|
| папка| нить| запрос| Папка с документами.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheet) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
