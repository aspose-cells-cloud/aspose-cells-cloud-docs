---
title: Автоматический подбор нескольких строк на рабочем листе Excel
...
description: Aspose.Cells Cloud REST API поддерживает автоподбор строк на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Автоматическое подгонка нескольких строк на листе Excel
---
Этот REST API указывает на необходимость автоматического подгонки строк на листе Excel.
...
| startRow| целое число| запрос| Начальный ряд.|
| конецСтрока| целое число| запрос| Конец ряда.|
| толькоАвто| булев| запрос|ЛОЖЬ|
| папка| нить| запрос| Папка документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
