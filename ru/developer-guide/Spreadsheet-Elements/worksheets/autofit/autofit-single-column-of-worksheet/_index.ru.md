---
title: Автоматическая подгонка столбца на рабочем листе Excel
...
description: Aspose.Cells Cloud REST API поддерживает автоподбор столбца на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 10
...
---
Этот REST API указывает на необходимость автоматического подбора столбца на листе Excel.
...
|[autoFitterOptions](/cells/ru/auto-filter-options) || тело| Параметры автоустановщика.|
| первыйСтрока| целое число| запрос| Индекс первой строки.|
| последнийСтрока| целое число| запрос| Индекс последней строки.|
