---
title: Автоматическая подгонка строки на рабочем листе Excel
...
description: Aspose.Cells Cloud REST API поддерживает автоматическую подгонку строки на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 30
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Автоматическое подгонка строки на листе Excel
---
Этот REST API указывает на необходимость автоматического подбора строки на листе Excel.
...
| rowIndex| целое число| запрос| Индекс строки.|
| первыйСтолбец| целое число| запрос| Индекс первого столбца.|
| последнийСтолбец| целое число| запрос| Индекс последнего столбца.|
|[autoFitterOptions](/cells/ru/auto-fitter-options) | объект| тело| Параметры автоустановщика.|
| папка| нить| запрос| Папка.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRow) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
