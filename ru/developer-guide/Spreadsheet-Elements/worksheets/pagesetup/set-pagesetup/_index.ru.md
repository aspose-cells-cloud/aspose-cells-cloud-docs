...
weight: 20
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Установка параметров страницы для рабочего листа Excel
---
Этот REST API указывает на `Set page setup for an Excel worksheet`.
...
| Имя листа| нить| путь| Новое имя листа.|
|[страницаНастройка](/cells/ru/page-setup) | объект| тело| Описание настройки TPage.|
| папка| нить| запрос| Папка для документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://reference.aspose.cloud/cells/#/PageSetup/PostPageSetup) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
