...
| диапазон_имен| нить| запрос| имя диапазона, например: «A1:B2» или «range_name1»|
| первыйСтрока| целое число| запрос| первый ряд диапазона|
| первыйСтолбец| целое число| запрос| первый столбец диапазона|
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Ranges/GetWorksheetCellsRangeValue) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
