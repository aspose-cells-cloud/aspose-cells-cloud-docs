---
title: Получить именованные диапазоны на рабочем столе Excel
...
description: Aspose.Cells Cloud REST API поддерживает получение данных ячеек на основе именованного диапазона на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получение именованных диапазонов в рабочей книге Excel
---
Этот REST API указывает на чтение информации о диапазонах рабочих листов.
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
