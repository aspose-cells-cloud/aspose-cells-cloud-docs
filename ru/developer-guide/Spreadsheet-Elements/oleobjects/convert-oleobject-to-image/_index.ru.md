---
title: Преобразовать объект OLE в изображение на рабочем листе Excel
...
description: Aspose.Cells Cloud REST API поддерживает обмен данными между объектом OLE и изображением на листе Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 40
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Преобразование объекта OLE в изображение на Excel листе
---
Этот REST API указывает `get OLE object` с форматом на рабочем листе Excel.
