---
title: Добавьте сводную таблицу на рабочий лист Excel
...
description: Aspose.Cells Cloud REST API поддерживает добавление сводной таблицы в рабочий лист Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 30
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Добавить сводную таблицу на рабочий лист Excel
---
Этот REST API указывает `add` на сводную таблицу в рабочем листе.
...
| источникДанные| нить| запрос| Данные для нового кэша сводной таблицы.|
|destCellName| нить| запрос| Ячейка в верхнем левом углу диапазона назначения отчета сводной таблицы.|
| имя_таблицы| нить| запрос| Название нового отчета сводной таблицы.|
| использоватьSameSource| булев| запрос| Указывает, используется ли тот же источник данных, когда другая существующая сводная таблица использовала этот источник данных. Если свойство имеет значение true, это сэкономит память.|
 
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
