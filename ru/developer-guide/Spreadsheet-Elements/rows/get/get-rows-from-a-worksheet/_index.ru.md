---
title: Получить информацию о строках из рабочего листа Excel
...
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получение информации о строках из рабочего листа Excel
---
Этот REST API указывает на получение информации о строках на рабочем листе Excel.
...
| папка| нить| запрос| Папка Workdook.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRows) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
