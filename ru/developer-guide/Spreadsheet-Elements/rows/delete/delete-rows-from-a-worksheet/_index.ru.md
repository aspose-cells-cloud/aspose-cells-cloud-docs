---
title: Удалить несколько строк на рабочем листе Excel
...
weight: 80
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Удаление нескольких строк на листе Excel
---
Этот REST API указывает на необходимость удаления нескольких строк на листе Excel.
...
| Имя листа| нить| путь| Рабочий лист баме.|
...
| имя_хранилища| нить| запрос| имя хранилища.|
 ...
 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
