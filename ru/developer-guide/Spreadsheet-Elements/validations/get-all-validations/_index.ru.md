---
title: Получите все проверки рабочих листов из рабочего листа Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Получить все
type: docs
url: /ru/validations/get-all/
keywords: Get all worksheet validations from an Excel worksheet
description: Aspose.Cells Cloud REST API поддерживает получение всех проверок листа из листа Excel. SDK поддерживает различные языки разработки. Они включают Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift
weight: 10
kwords: Excel, Office Облако, REST API, Электронная таблица, PDF, CSV, Json, Markdown, Получить все проверки листа из листа Excel
---
Этот REST API указывает на необходимость получения всех проверок рабочего листа на рабочем листе Excel.
...
| папка| нить| запрос| Папка для документов.|
| имя_хранилища| нить| запрос| имя хранилища.|

 The[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
