---
title: Добавьте пользовательские критерии в лист Excel.
...
description: Облако Aspose.Cells API поддерживает добавление пользовательского фильтра на лист Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и Swift.
weight: 65
kwords: Excel, Office Облако, REST API, электронная таблица, PDF, CSV, Json, Markdwon, добавление пользовательских критериев на лист Excel
---
Этот REST API указывает на фильтрацию списка с `custom criteria`.
...
| операторТип1| нить| запрос||
| критерии1| нить| запрос||
| isИ|логическое значение| запрос||
| операторТип2| нить| запрос||
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetCustomFilter) определяет общедоступный интерфейс программирования и позволяет выполнять взаимодействие с REST непосредственно из веб-браузера.
