...
type: docs
url: /ru/specification/operation/getverticalpagebreaks/
description: Получение описаний вертикальных разрывов страниц на листе.
kwords: Excel, Office, электронная таблица, Cloud REST API, GetVerticalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,Получить описания вертикальных разрывов страниц на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks \'>GetVerticalPageBreaks</a>" >}}
