...
type: docs
url: /ru/specification/operation/putinsertworksheetcolumns/
description: Вставка столбцов рабочего листа на рабочий лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutInsertWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},PUT,Вставить столбцы рабочего листа в рабочий лист.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PutInsertWorksheetColumns\'>PutInsertWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="столбцы, целое число, количество столбцов." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Указывает, будут ли обновляться ссылки на других листах." >}} 
