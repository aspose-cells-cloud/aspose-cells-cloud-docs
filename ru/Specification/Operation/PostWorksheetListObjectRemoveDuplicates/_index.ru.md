---
title: Пострабочий листлистлистобжектремоведупликат
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postworksheetlistobjectremoveduplicates/
description: Удалить дубликаты в объекте списка
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetListObjectRemoveDuulates
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/RemoveDuulates,POST,Удалить дубликаты в объекте списка.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects /PostWorksheetListObjectRemoveDuulates\'>PostWorksheetListObjectRemoveDuulates</a>" >}}
