...
type: docs
url: /ru/specification/operation/postupdateworksheetcellstyle/
description: Установите стиль ячейки, используя имя ячейки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostUpdateWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,POST,Установить стиль ячейки, используя имя ячейки на листе.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostUpdateWorksheetCellStyle\'>PostUpdateWorksheetCellStyle</a>" >}}
