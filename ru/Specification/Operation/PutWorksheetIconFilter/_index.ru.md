---
title: ПоместитьРабочий ЛистЗначокФильт
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/iconFilter,PUT,Добавьте фильтр значков на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetIconFilter \'>PutWorksheetIconFilter</a>" >}}
