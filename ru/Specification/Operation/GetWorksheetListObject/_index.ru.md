...
type: docs
url: /ru/specification/operation/getworksheetlistobject/
description: Получить описание объекта списка по индексу на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listobjectindex},GET,Получить описание объекта списка по индексу на листе.,<a href=\'https://apireference.aspose.cloud/cells/# /ListObjects/GetWorksheetListObject\'>GetWorksheetListObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="формат, строка," >}} 
