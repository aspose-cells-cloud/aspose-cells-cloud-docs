---
title: Поместить рабочий листPivotTable
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworksheetpivottable/
description: Добавьте сводную таблицу на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetPivotTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables,PUT,Добавьте сводную таблицу на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable\'>PutWorksheetPivotTable </а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="sourceData,string,данные для нового кэша сводной таблицы." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destCellName,string,ячейка в верхнем левом углу целевого диапазона отчета сводной таблицы." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="tableName,string,имя новой сводной таблицы." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="useSameSource,boolean,Указывает, используется ли тот же источник данных, когда этот источник данных использовался другой существующей сводной таблицей. Если свойство истинно, это сэкономит память." >}} 
