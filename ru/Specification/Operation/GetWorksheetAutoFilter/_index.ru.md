...
type: docs
url: /ru/specification/operation/getworksheetautofilter/
description: Получить описание автофильтров с листа
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetAutoFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter,GET,Получить описание автофильтров из листа.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter \'>GetWorksheetAutoFilter</a>" >}}
