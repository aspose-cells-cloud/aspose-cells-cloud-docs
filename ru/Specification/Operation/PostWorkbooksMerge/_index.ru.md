...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/merge,POST,Объединить книгу с существующей книгой.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge\'>PostWorkbooksMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mergeWith,string,Книга, с которой выполняется слияние." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergedStorageName, строка, имя хранилища." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
