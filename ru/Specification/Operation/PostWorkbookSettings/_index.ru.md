---
title: Настройка посткниги
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postworkbooksettings/
description: Обновить настройку в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, настройки PostWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,Обновить настройку в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings\'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="settings,class:workbooksettings,Описание настроек рабочей книги." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
