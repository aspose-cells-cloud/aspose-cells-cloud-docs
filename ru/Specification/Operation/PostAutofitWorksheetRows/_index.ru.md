---
title: СообщениеAutofitWorksheetRow
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postautofitworksheetrows/
description: Автоподбор строк на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostAutofitWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrows,POST,Автоматическое размещение строк на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows\'>PostAutofitWorksheetRows< /а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto,boolean,Автоматическое размещение всех строк на этом листе." >}} 
