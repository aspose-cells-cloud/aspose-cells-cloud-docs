...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/InsertSlicer,POST,Вставить срез для объекта списка.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects /PostWorksheetListObjectInsertSlicer\'>PostWorksheetListObjectInsertSlicer</a>" >}}
