...
type: docs
url: /ru/specification/operation/getworksheetvalidations/
description: Получение описаний проверок на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,GET,Получить описания проверок на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations\'> GetWorksheetValidations</a>" >}}
