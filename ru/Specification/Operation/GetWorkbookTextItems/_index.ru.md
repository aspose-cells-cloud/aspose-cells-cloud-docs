...
type: docs
url: /ru/specification/operation/getworkbooktextitems/
description: Получение текстовых элементов в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorkbookTextItems
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/textItems,GET,Получить текстовые элементы в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems\'>GetWorkbookTextItems</a>" >}}
