...
type: docs
url: /ru/specification/operation/postprotectworkbook/
description: Excel защита
kwords: Excel, Office, электронная таблица, Cloud REST API, PostProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ProtectWorkbookRequest,класс:protectworkbookrequest,Настройки защиты." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
