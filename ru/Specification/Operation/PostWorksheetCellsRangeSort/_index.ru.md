...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/sort,POST,Выполнить сортировку данных по диапазону ячеек.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeSort\'>PostWorksheetCellsRangeSort</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" rangeSortRequest,class:rangesortrequest,RangeSortRequest Запрос сортировки диапазона" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
