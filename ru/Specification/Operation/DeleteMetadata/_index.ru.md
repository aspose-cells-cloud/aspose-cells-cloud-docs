...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/delete,POST,Удалить свойства документа ячеек в файле Excel и сохранить их в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/DeleteMetadata\'>DeleteMetadata </а>" >}}
