...
type: docs
url: /ru/specification/operation/deleteworksheetoleobject/
description: Удаление объекта OLE на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects/{oleObjectIndex},DELETE,Удалить объект OLE на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects /DeleteWorksheetOleObject\'>DeleteWorksheetOleObject</a>" >}}
