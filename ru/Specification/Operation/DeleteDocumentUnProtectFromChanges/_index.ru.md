---
title: Удалитьдокументунпротектфромчанже
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/writeProtection,DELETE,Excel файл отменяет защиту от записи.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/DeleteDocumentUnProtectFromChanges\'>DeleteDocumentUnProtectFromChanges</a>" >}}
