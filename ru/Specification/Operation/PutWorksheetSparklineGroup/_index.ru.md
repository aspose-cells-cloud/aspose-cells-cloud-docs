---
title: Поместить рабочий листSparklineGrou
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworksheetsparklinegroup/
description: Добавьте группу спарклайнов на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetSparklineGroup
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/sparklineGroups,PUT,Добавьте группу спарклайнов на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/SparklineGroups/PutWorksheetSparklineGroup\'> PutWorksheetSparklineGroup</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,Представляет типы спарклайнов (линия, столбец, стопка)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dataRange,string,Указывает диапазон данных группы спарклайнов." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isVertical,boolean,Указывает, следует ли строить спарклайны из диапазона данных по строке или по столбцу." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="locationRange,string,Указывает, где разместить спарклайны." >}} 
