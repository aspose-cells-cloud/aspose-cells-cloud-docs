...
type: docs
url: /ru/specification/operation/postworkbookgetsmartmarkerresult/
description: Интеллектуальная обработка маркеров
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorkbookGetSmartMarkerResult
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/smartmarker,POST,Интеллектуальная обработка маркеров.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookGetSmartMarkerResult\'>PostWorkbookGetSmartMarkerResult</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="xmlFile,string,Полный путь к XML-файлу. Если он пуст, данные считываются из тела запроса." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="папка,строка,Папка, в которой находится файл." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outPath,строка,Путь для сохранения результата" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="StorageName,string,Имя хранилища, в котором находится файл." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,string,имя хранилища, в котором находится файл результатов." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
