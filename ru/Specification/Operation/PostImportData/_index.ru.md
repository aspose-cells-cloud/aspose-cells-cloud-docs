...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/importdata,POST,Импортировать данные в файл Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostImportData\'>PostImportData</a>" >}}
