---
title: СообщениеAutofitWorksheetRo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postautofitworksheetrow/
description: Автоподбор строки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostAutofitWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrow,POST,Автоматическое размещение строки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRow\'>PostAutofitWorksheetRow </а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,индекс первого столбца." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LastColumn,integer,Индекс последнего столбца." >}} 
