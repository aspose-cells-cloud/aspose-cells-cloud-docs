...
type: docs
url: /ru/specification/operation/postworksheetshape/
description: Обновление фигуры на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},POST,Обновите фигуру на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ PostWorksheetShape\'>PostWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dto,class:shape,Описание формы." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
