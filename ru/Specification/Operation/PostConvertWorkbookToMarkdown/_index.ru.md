...
type: docs
url: /ru/specification/operation/postconvertworkbooktomarkdown/
description: Конвертировать файл Excel в файлы Markdown
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToMarkdown
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/markdown,POST,Преобразовать файл Excel в файлы Markdown.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToMarkdown\'>PostConvertWorkbookToMarkdown</a>" >}}
