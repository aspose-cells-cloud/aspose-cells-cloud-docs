...
type: docs
url: /ru/specification/operation/postcellcalculate/
description: Вычислить формулу ячейки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostCellCalculate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/calculate,POST,Вычислить формулу ячейки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCalculate\'>PostCellCalculate</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:calculationoptions,Параметры расчета" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
