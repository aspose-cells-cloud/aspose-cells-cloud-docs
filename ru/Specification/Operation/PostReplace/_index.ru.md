...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/replace,POST,Заменить указанный текст новым текстом в файлах Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostReplace\'>PostReplace</a>" >}}
