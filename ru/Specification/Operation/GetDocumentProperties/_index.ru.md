---
title: Получить свойство документа
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/getdocumentproperties/
description: Получить описания свойств файла Excel.
kwords: Excel, Office, электронная таблица, Cloud REST API, GetDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,GET,Получить описания свойств файла Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperties\'>GetDocumentProperties</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,Excel тип свойства." >}} 
