...
type: docs
url: /ru/specification/operation/postimport/
description: Импортируйте данные в файл Excel и создавайте выходные файлы в различных форматах.
kwords: Excel, Office, электронная таблица, Cloud REST API, постимпорт
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/import,POST,Импортируйте данные в файл Excel и создайте выходные файлы в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostImport\'>PostImport</a >" >}}
