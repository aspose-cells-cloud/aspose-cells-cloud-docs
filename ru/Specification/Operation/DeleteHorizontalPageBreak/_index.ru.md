---
title: Удалить горизонтальную страницуBrea
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deletehorizontalpagebreak/
description: Удалить горизонтальный разрыв страницы на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks/{index},DELETE,Удалить горизонтальный разрыв страницы на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ PageBreaks/DeleteHorizontalPageBreak\'>DeleteHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="index,integer,Удаляет элемент горизонтального разрыва страницы по указанному имени. Индекс элемента, отсчет от нуля." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
