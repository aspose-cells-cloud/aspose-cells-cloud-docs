---
title: СообщениеAutofitWorkbookRow
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/autofitrows,POST,Автоматическое размещение строк в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookRows\'>PostAutofitWorkbookRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow, целое число, начальная строка." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow, целое число, конечная строка." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto,boolean,Только авто." >}} 
