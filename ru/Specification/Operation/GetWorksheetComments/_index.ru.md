...
type: docs
url: /ru/specification/operation/getworksheetcomments/
description: Получить описание комментариев на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetComments
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,GET,Получить описание комментариев на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComments\' >GetWorksheetComments</a>" >}}
