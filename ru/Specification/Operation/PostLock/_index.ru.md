...
type: docs
url: /ru/specification/operation/postlock/
description: Заблокировать Excel файлы
kwords: Excel, Office, электронная таблица, Cloud REST API, PostLock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/lock,POST,Lock Excel файлы.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostLock\'>PostLock</a>" >}}
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/lock
    -X POST 
