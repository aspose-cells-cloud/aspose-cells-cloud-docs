...
type: docs
url: /ru/specification/operation/gethorizontalpagebreaks/
description: Получение описаний горизонтальных разрывов страниц на листе.
kwords: Excel, Office, электронная таблица, Cloud REST API, GetHorizontalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,Получить описания горизонтальных разрывов страниц на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks \'>GetHorizontalPageBreaks</a>" >}}
