...
type: docs
url: /ru/specification/operation/postmetadata/
description: Обновите свойства документа в файле Excel и сохраните их в различных форматах.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/update,POST,обновите свойства документа в файле Excel и сохраните их в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMetadata\'>PostMetadata< /а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ячейкиДокументы,контейнер,свойства документа" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
