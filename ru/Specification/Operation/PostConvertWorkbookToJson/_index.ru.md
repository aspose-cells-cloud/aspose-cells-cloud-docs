---
title: ПостконвертироватьворкбуктоJso
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postconvertworkbooktojson/
description: Преобразование файла Excel в файлы Json
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,Преобразовать файл Excel в файлы Json.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
