---
title: ПосткнигаTextReplace
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postworkbooktextreplace/
description: Заменить текст в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorkbookTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/replaceText,POST,Заменить текст в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookTextReplace\'>PostWorkbookTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,строка,старое значение." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,строка,Новое значение." >}} 
