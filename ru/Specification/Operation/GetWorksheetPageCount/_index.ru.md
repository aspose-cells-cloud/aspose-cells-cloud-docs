...
type: docs
url: /ru/specification/operation/getworksheetpagecount/
description: Получить количество страниц на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagecount,GET,Получить количество страниц на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetPageCount\'>GetWorksheetPageCount </а>" >}}
