---
title: ПоместитьВставитьрабочий листRo
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},PUT,Вставьте новую строку на лист.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PutInsertWorksheetRow\'>PutInsertWorksheetRow</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="rowIndex,integer,Новый индекс строки." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
