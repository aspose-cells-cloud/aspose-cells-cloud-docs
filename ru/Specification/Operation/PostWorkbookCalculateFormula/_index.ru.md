...
type: docs
url: /ru/specification/operation/postworkbookcalculateformula/
description: Вычислить все формулы в рабочей тетради
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorkbookCalculateFormula
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/calculateformula,POST,Вычислить все формулы в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookCalculateFormula\'>PostWorkbookCalculateFormula</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ignoreError, логическое значение, игнорировать ошибку." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:calculationoptions,CalculationOptions Параметры расчета." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
