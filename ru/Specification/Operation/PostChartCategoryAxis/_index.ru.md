---
title: СообщениеДиаграммаКатегорияAxi
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postchartcategoryaxis/
description: Обновить ось категорий диаграммы на диаграмме
kwords: Excel, Office, электронная таблица, Cloud REST API, PostChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,POST,Обновить ось категории диаграммы на диаграмме.,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/PostChartCategoryAxis\'>PostChartCategoryAxis</a>" >}}
