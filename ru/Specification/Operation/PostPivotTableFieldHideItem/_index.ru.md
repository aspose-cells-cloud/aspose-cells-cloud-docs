...
type: docs
url: /ru/specification/operation/postpivottablefieldhideitem/
description: Скрыть элемент сводного поля в сводной таблице
kwords: Excel, Office, электронная таблица, Cloud REST API, PostPivotTableFieldHideItem
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Hide,POST,Скрыть элемент сводного поля в сводной таблице.,<a href=\'https://apireference.aspose.cloud/ cell/#/PivotTables/PostPivotTableFieldHideItem\'>PostPivotTableFieldHideItem</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="itemIndex,integer,индекс сводного элемента в сводном поле." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isHide,boolean, скрыт ли конкретный элемент PivotItem (истина/ложь)." >}} 
