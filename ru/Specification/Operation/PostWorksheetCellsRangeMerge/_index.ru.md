...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/merge,POST,Объединить диапазон ячеек в одну ячейку.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /PostWorksheetCellsRangeMerge\'>PostWorksheetCellsRangeMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="диапазон,класс:диапазон,Описание диапазона." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
