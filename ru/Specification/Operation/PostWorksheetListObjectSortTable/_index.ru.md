...
type: docs
url: /ru/specification/operation/postworksheetlistobjectsorttable/
description: Сортировка объекта списка на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetListObjectSortTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/sort,POST,Сортировать объект списка на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ ListObjects/PostWorksheetListObjectSortTable\'>PostWorksheetListObjectSortTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataSorter,class:datasorter,Представляет порядок сортировки диапазона данных." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
