---
title: Поместить рабочий листOleObjec
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworksheetoleobject/
description: Добавьте объект OLE на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,PUT,Добавьте объект OLE на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/PutWorksheetOleObject\'> ПоместитьWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="высота, целое число, высота oleObject, в пикселях" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ширина, целое число, ширина oleObject, в пикселях" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="oleFile, строка, путь к имени файла OLE (полное имя файла)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="imageFile,строка,путь к имени файла изображения(полное имя файла)." >}} 
