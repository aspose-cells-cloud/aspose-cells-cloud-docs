...
type: docs
url: /ru/specification/operation/getworksheetpicturewithformat/
description: Получить изображение по номеру на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetPictureWithFormat
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureNumber},GET,Получить изображение по номеру на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ Картинки/GetWorksheetPictureWithFormat\'>GetWorksheetPictureWithFormat</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="imageNumber, целое число, индекс изображения." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="формат, строка, формат преобразования изображения (PNG/TIFF/JPEG/GIF/EMF/BMP)." >}} 
