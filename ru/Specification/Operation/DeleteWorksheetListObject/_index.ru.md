---
title: Удалитьворкшитлистобъект
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deleteworksheetlistobject/
description: Удалить объект списка по индексу на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex},DELETE,Удалить объект списка по индексу на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ ListObjects/DeleteWorksheetListObject\'>DeleteWorksheetListObject</a>" >}}
