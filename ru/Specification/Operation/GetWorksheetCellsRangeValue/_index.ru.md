...
type: docs
url: /ru/specification/operation/getworksheetcellsrangevalue/
description: Получить значения ячеек в указанном диапазоне
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetCellsRangeValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,Получить значения ячеек в указанном диапазоне.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /GetWorksheetCellsRangeValue\'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,Получает индекс первой строки диапазона." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,Получает индекс первого столбца диапазона." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,integer,Получает количество строк в диапазоне." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnsCount,integer,Получает количество столбцов в диапазоне." >}} 
