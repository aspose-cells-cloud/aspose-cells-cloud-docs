...
type: docs
url: /ru/specification/operation/getworkbooknames/
description: Получение именованных диапазонов в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorkbookNames
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,Получить именованные диапазоны в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
