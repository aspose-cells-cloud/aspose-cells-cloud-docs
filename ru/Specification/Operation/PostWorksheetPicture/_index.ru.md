---
title: ПостРабочий ЛистКартинка
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postworksheetpicture/
description: Обновить изображение по индексу на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},POST,Обновить изображение по индексу на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ Картинки/PostWorksheetPicture\'>PostWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="imageIndex,integer,индекс изображения." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="изображение,класс:изображение,Описание объекта изображения." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
