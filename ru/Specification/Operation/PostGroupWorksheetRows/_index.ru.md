---
title: СообщениеГруппаРабочий ЛистСтрока
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/group,POST,Сгруппировать строки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows \'>PostGroupWorksheetRows</a>" >}}
