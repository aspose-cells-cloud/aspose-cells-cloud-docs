...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellOrMethodName},GET,Получить данные ячейки, используя либо ссылку на ячейку, либо имя метода на листе.,<a href=\'https://apireference.aspose.cloud /cells/#/Cells/GetWorksheetCell\'>GetWorksheetCell</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="cellOrMethodName,string,имя ячейки или метода. (Имя метода, например firstcell, endcell и т. д.)" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
