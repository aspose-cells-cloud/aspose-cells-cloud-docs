...
type: docs
url: /ru/specification/operation/postworksheetmerge/
description: Объединить ячейки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/merge,POST,Объединить ячейки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge\'> Пострабочее объединение</a>" >}}
