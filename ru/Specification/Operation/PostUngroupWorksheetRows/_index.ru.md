...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/ungroup,POST,Разгруппировать строки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows \'>PostUngroupWorksheetRows</a>" >}}
