---
title: Постконвертироватьрабочую книгуToPN
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postconvertworkbooktopng/
description: Преобразование файла Excel в файлы PNG
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToPNG
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/png,POST,Преобразовать файл Excel в файлы PNG.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPNG\'>PostConvertWorkbookToPNG</a>" >}}
