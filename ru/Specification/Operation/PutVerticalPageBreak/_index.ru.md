---
title: ПоместитьВертикальнуюСтраницуBrea
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,PUT,Добавьте вертикальный разрыв страницы на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutVerticalPageBreak\' >PutVerticalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,integer,индекс начальной строки, отсчет от нуля." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,integer,Индекс конечной строки, отсчет от нуля." >}} 
