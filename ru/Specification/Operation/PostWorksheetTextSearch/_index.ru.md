...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/findText,POST,Поиск текста на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextSearch\'>PostWorksheetTextSearch </а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="текст, строка, Текст для поиска." >}} 
