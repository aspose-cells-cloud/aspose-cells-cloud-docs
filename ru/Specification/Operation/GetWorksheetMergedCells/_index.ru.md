...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/mergedCells,GET,Получить объединенные ячейки рабочего листа.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetMergedCells\'>GetWorksheetMergedCells</ а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="имя_листа,строка,имя рабочего набора." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
