---
title: Постконвертироватьворкбуктодок
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postconvertworkbooktodocx/
description: Конвертировать файл Excel в файлы Docx
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToDocx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/docx,POST,Преобразовать файл Excel в файлы Docx.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx\'>PostConvertWorkbookToDocx</a>" >}}
