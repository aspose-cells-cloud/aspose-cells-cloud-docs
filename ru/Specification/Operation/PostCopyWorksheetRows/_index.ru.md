---
title: СообщениеКопияРабочий ЛистСтрока
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postcopyworksheetrows/
description: Копирование данных и форматов из определенных целых строк на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostCopyWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/copy,POST,Копировать данные и форматы из определенных целых строк на листе.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetRows\'>PostCopyWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceRowIndex,integer,индекс исходной строки" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="DestinationRowIndex,integer,Индекс целевой строки" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowNumber,integer,номер скопированной строки" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="рабочий лист, строка, имя рабочего листа." >}} 
