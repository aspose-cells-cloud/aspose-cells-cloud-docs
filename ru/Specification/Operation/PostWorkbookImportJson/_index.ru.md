...
type: docs
url: /ru/specification/operation/postworkbookimportjson/
description: Импортируйте файл данных JSON в книгу. Файл данных JSON может быть либо облачным файлом, либо данными из HTTP URI.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorkbookImportJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/importjson,POST,Импортируйте файл данных JSON в книгу. Файл данных JSON может быть либо облачным файлом, либо данными из URI HTTP.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostWorkbookImportJson\'>PostWorkbookImportJson</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="importJsonRequest, класс: importjsonrequest, Импортировать запрос Json." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
