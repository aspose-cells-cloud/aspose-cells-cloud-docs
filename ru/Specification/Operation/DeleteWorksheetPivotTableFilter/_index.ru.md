---
title: Удалитьрабочий листСводная таблицафилте
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters/{fieldIndex},DELETE,Удалить сводный фильтр в сводной таблице.,<a href=\'https://apireference.aspose.cloud /cells/#/PivotTables/DeleteWorksheetPivotTableFilter\'>DeleteWorksheetPivotTableFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="fieldIndex,integer,Получает объект PivotField по определенному индексу." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
