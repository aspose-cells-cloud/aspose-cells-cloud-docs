---
title: Постразблокировка
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postunlock/
description: Разблокировать Excel файлов
kwords: Excel, Office, электронная таблица, Cloud REST API, постразблокировка
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/unlock,POST,Разблокировать файлы Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostUnlock\'>PostUnlock</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/ProtectionController/PostUnlock\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/unlock?password=123456"
    -X POST 
    -H "Authorization: Bearer \<jwt token> " \
 -F '
file=@needUnlock.xlsx;filename=needUnlock.xlsx'
```
