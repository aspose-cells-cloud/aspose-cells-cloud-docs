...
type: docs
url: /ru/specification/operation/postrotate/
description: Поворачивайте строки, столбцы или другие объекты в файлах Excel и сохраняйте их в различных форматах.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostRotate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/rotate,POST,Поворот строк, столбцов или других объектов в файлах Excel и сохранение их в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRotate\'> Постротате</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="RotateType, строка, 270/90/строка/столбец/строка2col" >}} 
