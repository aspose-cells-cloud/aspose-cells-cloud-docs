...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,Удалить совпадающие рабочие листы в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>DeleteWorksheets</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="matchCondition, класс: matchconditionrequest," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
