---
title: Удалить рабочий лист валидация
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deleteworksheetvalidations/
description: Удалить все проверки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,DELETE,Удалить все проверки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidations\'>DeleteWorksheetValidations </а>" >}}
