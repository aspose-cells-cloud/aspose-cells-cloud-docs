...
type: docs
url: /ru/specification/operation/postreverse/
description: Поменяйте местами строки или столбцы в файлах Excel и создайте выходные файлы в различных форматах.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostReverse
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/reverse,POST,Реверс строк или столбцов в файлах Excel и создание выходных файлов в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostReverse\'>PostReverse</ а>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="RotateType, строка, строки/столбцы/оба" >}} 
