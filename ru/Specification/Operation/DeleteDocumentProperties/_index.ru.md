---
title: Удалитьсвойство документа
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,DELETE,Удалить все пользовательские свойства документа и сбросить встроенные.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties\'>DeleteDocumentProperties< /а>" >}}
