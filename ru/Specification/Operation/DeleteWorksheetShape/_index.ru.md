...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},DELETE,Удалить фигуру на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ DeleteWorksheetShape\'>DeleteWorksheetShape</a>" >}}
