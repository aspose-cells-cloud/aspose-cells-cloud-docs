---
title: СообщениеClearFormat
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postclearformats/
description: Очистить форматы ячеек на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostClearFormats
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearformats,POST,Очистить форматы ячеек на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats\' >Постклирформаты</a>" >}}
