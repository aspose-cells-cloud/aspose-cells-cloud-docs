...
type: docs
url: /ru/specification/operation/getworksheetcellstyle/
description: Получение описаний стилей ячеек на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,GET,Получить описания стилей ячеек на листе.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/GetWorksheetCellStyle\'>GetWorksheetCellStyle</a>" >}}
