---
title: Удалить рабочий листPicture
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deleteworksheetpictures/
description: Удалить все изображения на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteWorksheetPictures
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,Удалить все изображения на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures\'>DeleteWorksheetPictures </а>" >}}
