---
title: СообщениеСкрытьрабочий листСтолбец
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/posthideworksheetcolumns/
description: Скрыть столбцы листа на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostHideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,Скрыть столбцы рабочего листа на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
