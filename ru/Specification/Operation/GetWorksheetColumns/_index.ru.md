...
type: docs
url: /ru/specification/operation/getworksheetcolumns/
description: Получение описаний столбцов листа
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,Получить описания столбцов рабочего листа.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\' >GetWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="смещение, целое число, папка рабочей документации." >}} 
