---
title: Удалить рабочий лист Hyperlin
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},DELETE,Удалить гиперссылку по индексу на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /DeleteWorksheetHyperlink\'>DeleteWorksheetHyperlink</a>" >}}
