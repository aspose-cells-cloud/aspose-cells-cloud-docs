...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Значение, строка, входное значение." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isConverted,boolean,True: преобразуется в другой тип данных, если это необходимо." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="setStyle,boolean,True: установите числовой формат в соответствии со стилем ячейки при преобразовании в другой тип данных." >}} 
