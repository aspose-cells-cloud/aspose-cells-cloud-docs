---
title: Поместить рабочий листHyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworksheethyperlink/
description: Добавить гиперссылку на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,PUT,Добавить гиперссылку на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink\'>PutWorksheetHyperlink< /а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,первая строка диапазона гиперссылок." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,первый столбец диапазона гиперссылок." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,Количество строк в этом диапазоне гиперссылок." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Количество столбцов этого диапазона гиперссылок." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="адрес,строка,Адрес гиперссылки." >}} 
