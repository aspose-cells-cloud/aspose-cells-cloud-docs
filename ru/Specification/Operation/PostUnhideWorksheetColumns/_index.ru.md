...
type: docs
url: /ru/specification/operation/postunhideworksheetcolumns/
description: Показать столбцы рабочего листа на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostUnhideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,Показать столбцы рабочего листа на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostUnhideWorksheetColumns\'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,Начало индекса столбца, с которым нужно работать." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Количество столбцов, с которыми нужно работать." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,Получает и устанавливает ширину столбца в символах." >}} 
