---
title: Удалить рабочий листстолбец
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deleteworksheetcolumns/
description: Удалить столбцы рабочего листа на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},DELETE,Удалить столбцы рабочего листа на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetColumns\'>DeleteWorksheetColumns</a>" >}}
