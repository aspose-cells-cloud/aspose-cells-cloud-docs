...
type: docs
url: /ru/specification/operation/postcopyworksheet/
description: Скопируйте содержимое и форматы из другого листа
kwords: Excel, Office, электронная таблица, Cloud REST API, PostCopyWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,Копировать содержимое и форматы из другого листа.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'> Рабочий лист PostCopy</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceSheet, строка, Исходный лист." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceWorkbook,строка,исходная книга." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder,string,Исходная папка книги." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:copyoptions,Представляет параметры копирования." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
