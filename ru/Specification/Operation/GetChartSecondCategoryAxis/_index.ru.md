...
type: docs
url: /ru/specification/operation/getchartsecondcategoryaxis/
description: Получить ось второй категории диаграммы в символе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/ Secondcategoryaxis,GET,Получить вторую ось категории диаграммы на диаграмме,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
