---
title: Получить метадат
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/getmetadata/
description: Получить свойства документа ячеек
kwords: Excel, Office, электронная таблица, Cloud REST API, GetMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/get,POST,Получить свойства документа ячеек.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/GetMetadata\'>GetMetadata</a>" >}}
