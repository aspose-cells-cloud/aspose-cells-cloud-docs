---
title: Удалитьимя рабочей книги
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,DELETE,Удалить все именованные диапазоны в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookNames\'>DeleteWorkbookNames</a>" >}}
