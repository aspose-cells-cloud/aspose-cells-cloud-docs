...
type: docs
url: /ru/specification/operation/putworksheetlistobject/
description: Добавьте ListObject на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects,PUT,Добавьте ListObject на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PutWorksheetListObject\'>PutWorksheetListObject </а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,integer,начальная строка диапазона списка." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,начальный столбец диапазона списка." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,integer,начальная строка диапазона списка." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,начальный столбец диапазона списка." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="папка,строка,Папка, в которой находится файл." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hasHeaders,boolean,Указывает, есть ли в диапазоне заголовки." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="displayName,string,Указывает, отображается ли отображаемое имя." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="showTotals,boolean,Указывает, нужно ли отображать итоги." >}} 
