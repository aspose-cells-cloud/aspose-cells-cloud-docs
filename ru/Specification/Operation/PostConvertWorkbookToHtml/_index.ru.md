---
title: Постконвертироватьворкбуктохтм
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postconvertworkbooktohtml/
description: Преобразование файла Excel в файлы HTML
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToHtml
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/html,POST,Преобразовать файл Excel в файлы HTML.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml\'>PostConvertWorkbookToHtml</a>" >}}
