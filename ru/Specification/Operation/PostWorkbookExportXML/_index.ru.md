---
title: Пострабочая книгаЭкспортXM
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/exportxml,POST,Экспортировать данные XML из файла Excel. Если в файле Excel есть карты XML, экспортируйте данные XML. Если в файле Excel нет карты XML, преобразуйте файл Excel в файл XML.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostWorkbookExportXML\'>PostWorkbookExportXML</a>" >}}
