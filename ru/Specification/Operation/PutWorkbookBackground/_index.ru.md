---
title: ПоместитьРабочую КнигуФон
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworkbookbackground/
description: Установить фон в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,PUT,Установить фон в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookBackground\'>PutWorkbookBackground</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath,string,Полный путь к изображению." >}} 
