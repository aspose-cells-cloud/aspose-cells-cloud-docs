...
type: docs
url: /ru/specification/operation/postworksheetcellsetvalue/
description: Установите значение ячейки, используя имя ячейки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetCellSetValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName},POST,Установить значение ячейки, используя имя ячейки на листе.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PostWorksheetCellSetValue\'>PostWorksheetCellSetValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="значение, строка, значение ячейки." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="тип, строка, тип значения." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="формула, строка, формула для ячейки" >}} 
