---
title: СообщениеWatermar
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postwatermark/
description: Добавьте текстовый водяной знак в файлы Excel и создавайте выходные файлы в различных форматах.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWatermark
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/watermark,POST,добавьте текстовый водяной знак в файлы Excel и создайте выходные файлы в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark\'>PostWatermark</a >" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="текст, строка, фоновый текст." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="цвет, строка, например #1032ff" >}} 
