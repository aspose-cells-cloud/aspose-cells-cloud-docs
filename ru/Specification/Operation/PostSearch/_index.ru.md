...
type: docs
url: /ru/specification/operation/postsearch/
description: Поиск указанного текста в файлах Excel.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostSearch
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/search,POST,Поиск указанного текста в файлах Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSearch\'>PostSearch</a>" >}}
