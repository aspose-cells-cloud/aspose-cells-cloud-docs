---
title: Дедупликация данных PostWorkbookData
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postworkbookdatadeduplication/
...
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorkbookDataDeduplication
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datadeduplication,POST,Дедупликация данных файлов электронных таблиц в основном используется для устранения дублирующихся данных в таблицах и диапазонах.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/ PostWorkbookDataDeduplication\'>PostWorkbookDataDeduplication</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="регион дедупликации, класс: регион дедупликации," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
