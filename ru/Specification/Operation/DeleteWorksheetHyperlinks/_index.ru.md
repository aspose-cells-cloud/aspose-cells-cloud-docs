---
title: Удалить рабочий листгиперссылка
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deleteworksheethyperlinks/
description: Удалить все гиперссылки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteWorksheetHyperlinks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,DELETE,Удалить все гиперссылки на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlinks\'>DeleteWorksheetHyperlinks </а>" >}}
