...
type: docs
url: /ru/specification/operation/postworksheetunmerge/
description: Разъединить ячейки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetUnmerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/unmerge,POST,Отменить объединение ячеек на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge\'> PostWorksheetUnmerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,общее количество строк." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,общее количество столбцов." >}} 
