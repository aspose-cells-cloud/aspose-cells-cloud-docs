---
title: ПостконвертироватьворкбуктоПД
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postconvertworkbooktopdf/
description: Преобразование файла Excel в файлы PDF
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToPDF
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pdf,POST,Преобразовать файл Excel в файлы PDF.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF\'>PostConvertWorkbookToPDF</a>" >}}
