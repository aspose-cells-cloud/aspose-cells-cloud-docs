...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/custom,PUT,Фильтровать список с настраиваемыми критериями на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter /PutWorksheetCustomFilter\'>PutWorksheetCustomFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="isИ, логическое значение, истина/ложь" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="операторТип2, строка," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="критерии2,строка,Пользовательские критерии." >}} 
