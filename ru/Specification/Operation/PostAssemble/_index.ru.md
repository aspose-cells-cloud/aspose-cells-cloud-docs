...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/assemble,POST,Собрать файлы данных с файлами шаблонов для создания файлов в различных форматах.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostAssemble\'>PostAssemble</a>" >}}
