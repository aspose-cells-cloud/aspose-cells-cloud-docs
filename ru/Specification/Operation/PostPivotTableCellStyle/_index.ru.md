---
title: PostPivotTableCellСтиль
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postpivottablecellstyle/
description: Обновление стиля ячеек в сводной таблице
kwords: Excel, Office, электронная таблица, Cloud REST API, PostPivotTableCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,обновить стиль ячейки в сводной таблице.,<a href=\'https://apireference.aspose.cloud/cells/#/ PivotTables/PostPivotTableCellStyle\'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="столбец, целое число, индекс столбца ячейки." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="row,integer,Индекс строки ячейки." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,Style Описание стиля в теле запроса." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
