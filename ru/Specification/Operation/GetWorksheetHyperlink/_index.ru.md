---
title: Получить рабочий лист Hyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/getworksheethyperlink/
description: Получить описание гиперссылки по индексу на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},GET,Получить описание гиперссылки по индексу на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ Hypelinks/GetWorksheetHyperlink\'>GetWorksheetHyperlink</a>" >}}
