---
title: GetWorksheetГиперссылка
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/getworksheethyperlinks/
description: Получение описаний гиперссылок на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetHyperlinks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,GET,Получить описания гиперссылок на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/GetWorksheetHyperlinks\'> GetWorksheetHyperlinks</a>" >}}
