...
type: docs
url: /ru/specification/operation/postworksheettextreplace/
description: Заменить старый текст новым текстом на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/replaceText,POST,Заменить старый текст новым текстом на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextReplace \'>PostWorksheetTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,Старый текст для замены." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,Новый текст для замены." >}} 
