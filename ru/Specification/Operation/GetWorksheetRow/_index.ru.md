...
type: docs
url: /ru/specification/operation/getworksheetrow/
description: Получить данные строки по индексу строки на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},GET,Получить данные строки по индексу строки на листе.,<a href=\'https://apireference.aspose.cloud/ ячейки/#/Cells/GetWorksheetRow\'>GetWorksheetRow</a>" >}}
