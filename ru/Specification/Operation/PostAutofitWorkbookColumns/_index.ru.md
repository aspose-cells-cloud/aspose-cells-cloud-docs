---
title: СообщениеAutofitWorkbookКолонка
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postautofitworkbookcolumns/
description: Автоподбор столбцов в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, PostAutofitWorkbookColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/autofitcolumns,POST,Автоматическое размещение столбцов в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookColumns\'>PostAutofitWorkbookColumns</a>" >}}
