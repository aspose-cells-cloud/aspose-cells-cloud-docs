---
title: PostCopyWorksheetСтолбец
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postcopyworksheetcolumns/
description: Копирование данных из исходных столбцов в целевые столбцы на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostCopyWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/copy,POST,Копировать данные из исходных столбцов в целевые столбцы на листе.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetColumns\'>PostCopyWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex,integer,индекс исходного столбца" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="DestinationColumnIndex,integer,Индекс столбца назначения" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnsNumber,integer,номер скопированного столбца" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="рабочий лист, строка, имя целевого листа." >}} 
