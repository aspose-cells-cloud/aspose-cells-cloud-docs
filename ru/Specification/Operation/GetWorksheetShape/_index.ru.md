...
type: docs
url: /ru/specification/operation/getworksheetshape/
description: Получить описание фигуры на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},GET,Получить описание фигуры на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes /GetWorksheetShape\'>GetWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="shapeindex, целое число, индекс формы в фигурах рабочего листа." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
