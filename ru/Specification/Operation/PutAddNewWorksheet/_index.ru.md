---
title: ПоместитьДобавитьНовыйрабочий лист
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},PUT,Добавьте новый лист в книгу.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PutAddNewWorksheet\'>PutAddNewWorksheet< /а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="имя_листа,строка,Новое имя листа." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
