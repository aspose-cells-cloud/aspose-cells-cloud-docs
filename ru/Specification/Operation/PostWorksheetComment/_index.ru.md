...
type: docs
url: /ru/specification/operation/postworksheetcomment/
description: Обновить комментарий к ячейке на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetComment
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},POST,Обновить комментарий к ячейке на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/ PostWorksheetComment\'>PostWorksheetComment</a>" >}}
