---
title: ПоместитьГоризонтальнуюСтраницуBrea
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/puthorizontalpagebreak/
description: Добавьте горизонтальные разрывы страниц на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,Добавьте горизонтальные разрывы страниц на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >PutHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="имя ячейки, строка, имя ячейки" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="строка, целое число, индекс строки, отсчет от нуля." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="столбец, целое число, индекс столбца, отсчет от нуля." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,индекс начального столбца, отсчет от нуля." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,Индекс конечного столбца, отсчет от нуля." >}} 
