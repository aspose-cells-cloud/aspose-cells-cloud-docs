...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index}/area,PUT,Добавьте область ячеек для условия форматирования на листе.,<a href=\'https://apireference.aspose.cloud /cells/#/ConditionalFormattings/PutWorksheetFormatConditionArea\'>PutWorksheetFormatConditionArea</a>" >}}
