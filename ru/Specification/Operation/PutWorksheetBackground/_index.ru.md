---
title: ПоместитьРабочий ЛистФон
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworksheetbackground/
description: Установить фоновое изображение на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/background,PUT,Установить фоновое изображение на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PutWorksheetBackground\'>PutWorksheetBackground </а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath, строка, полное имя файла изображения." >}} 
