---
title: СообщениеДиаграммаВтораяКатегорияAxi
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/ Secondcategoryaxis,POST,Обновить вторую ось категории диаграммы на диаграмме.,<a href=\'https://apireference.aspose.cloud/cells/ #/Charts/PostChartSecondCategoryAxis\'>PostChartSecondCategoryAxis</a>" >}}
