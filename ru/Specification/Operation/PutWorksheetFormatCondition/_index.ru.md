...
type: docs
url: /ru/specification/operation/putworksheetformatcondition/
description: Добавьте условие форматирования на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetFormatCondition
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},PUT,Добавьте условие форматирования на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings /PutWorksheetFormatCondition\'>PutWorksheetFormatCondition</a>" >}}
