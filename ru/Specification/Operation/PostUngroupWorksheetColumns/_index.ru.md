...
type: docs
url: /ru/specification/operation/postungroupworksheetcolumns/
description: Разгруппировать столбцы листа
kwords: Excel, Office, электронная таблица, Cloud REST API, PostUngroupWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,Разгруппировать столбцы листа.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns\'> PostUngroupWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,первый индекс столбца, с которым нужно работать." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LastIndex,integer,Последний индекс столбца, с которым нужно работать." >}} 
