---
title: PostPivotTableСтиль
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postpivottablestyle/
description: Обновление стиля в сводной таблице
kwords: Excel, Office, электронная таблица, Cloud REST API, PostPivotTableStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/FormatAll,POST,Обновить стиль в сводной таблице.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /PostPivotTableStyle\'>PostPivotTableStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,StyleОписание стиля в теле запроса." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
