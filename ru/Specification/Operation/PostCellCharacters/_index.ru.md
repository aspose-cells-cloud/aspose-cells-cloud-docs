---
title: СообщениеЯчейкаПерсонаж
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postcellcharacters/
description: Установка символов ячеек на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostCellCharacters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/characters,POST,Установить символы ячеек на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCharacters\'>PostCellCharacters</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="опции, контейнер," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
