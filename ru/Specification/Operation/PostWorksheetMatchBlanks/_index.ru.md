---
title: СообщениеРабочий ЛистМатчПустой
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postworksheetmatchblanks/
description: Сопоставьте все пустые ячейки в списке
kwords: Excel, Office, электронная таблица, Cloud REST API, PostWorksheetMatchBlanks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchBlanks,POST,Сопоставить все пустые ячейки в списке.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks \'>PostWorksheetMatchBlanks</a>" >}}
