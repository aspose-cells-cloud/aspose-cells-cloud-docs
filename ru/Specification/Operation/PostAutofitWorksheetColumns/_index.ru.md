---
title: СообщениеAutofitWorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postautofitworksheetcolumns/
description: Автоподбор столбцов на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostAutofitWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitcolumns,POST,Автоматическое размещение столбцов на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetColumns\'>PostAutofitWorksheetColumns< /а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="толькоАвто, логическое значение," >}} 
