...
type: docs
url: /ru/specification/operation/getworksheetpivottablefilters/
description: Получает фильтры сводной таблицы на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetPivotTableFilters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters,GET,Получает фильтры сводной таблицы на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /GetWorksheetPivotTableFilters\'>GetWorksheetPivotTableFilters</a>" >}}
