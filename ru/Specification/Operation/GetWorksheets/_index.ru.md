...
type: docs
url: /ru/specification/operation/getworksheets/
description: Получить описание листов из книги
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheets
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,GET,Получить описание листов из книги.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets\'>GetWorksheets</a>" >}}
