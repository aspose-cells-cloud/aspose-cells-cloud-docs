---
title: Постконвертироватьрабочую книгуToSQ
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/postconvertworkbooktosql/
description: Преобразование файла Excel в файлы SQL Script.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostConvertWorkbookToSQL
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/sql,POST,Преобразовать файл Excel в файлы сценариев SQL.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL\'>PostConvertWorkbookToSQL</a>" >}}
