...
type: docs
url: /ru/specification/operation/getworksheettextitems/
description: Получить текстовые элементы на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetTextItems
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/textItems,GET,Получить текстовые элементы на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetTextItems\'>GetWorksheetTextItems </а>" >}}
