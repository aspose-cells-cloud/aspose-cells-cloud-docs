---
title: Удалитьрабочий листкомментарий
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,DELETE,Удалить все комментарии на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments\'>DeleteWorksheetComments </а>" >}}
