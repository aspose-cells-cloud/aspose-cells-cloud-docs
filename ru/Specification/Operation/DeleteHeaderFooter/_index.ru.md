---
title: Удалитьхедерфуте
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deleteheaderfooter/
description: Очистить верхний и нижний колонтитулы на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteHeaderFooter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/clearheaderfooter,DELETE,Очистить верхний и нижний колонтитулы на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/DeleteHeaderFooter \'>DeleteHeaderFooter</a>" >}}
