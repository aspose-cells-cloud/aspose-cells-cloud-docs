---
title: Поместитьрабочий листДобавить изображение
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/putworksheetaddpicture/
description: Добавьте новое изображение на лист
kwords: Excel, Office, электронная таблица, Cloud REST API, PutWorksheetAddPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,Добавьте новое изображение на лист.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture\'> PutWorksheetAddPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="имя_листа,строка,имя рабочего листа." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftRow,integer,верхняя левая строка изображения." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftColumn,integer,верхний левый столбец изображения." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LowerRightRow,integer,Изображение в нижней правой строке." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LowerRightColumn,integer,Нижний правый столбец изображения." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="PicturePath,string,Путь к изображению. Если он не указан, данные изображения проверяются в теле запроса." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="изображение, класс: изображение, объект изображения" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
