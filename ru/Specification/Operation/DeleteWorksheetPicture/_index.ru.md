---
title: Удалитьрабочий листPictur
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},DELETE,Удалить объект изображения по индексу на листе.,<a href=\'https://apireference.aspose.cloud/cells/# /Pictures/DeleteWorksheetPicture\'>DeleteWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="PictureIndex, целое число, Индекс изображения." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
