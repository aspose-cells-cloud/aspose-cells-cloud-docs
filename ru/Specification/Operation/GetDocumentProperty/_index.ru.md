---
title: ПолучитьДокументПроперт
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/getdocumentproperty/
description: Получить объект Excel по имени
kwords: Excel, Office, электронная таблица, Cloud REST API, GetDocumentProperty
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties/{propertyName},GET,Получить свойство Excel по имени.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty\'>GetDocumentProperty</a >" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="propertyName,строка,Имя свойства." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
