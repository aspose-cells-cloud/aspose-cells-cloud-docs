...
type: docs
url: /ru/specification/operation/postbatchlock/
description: Пакетная блокировка файлов, соответствующих определенным условиям соответствия.
kwords: Excel, Office, электронная таблица, Cloud REST API, PostBatchLock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/lock,POST,Пакетная блокировка файлов, соответствующих определенным условиям соответствия.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchLock\'>PostBatchLock</a>" >}}
