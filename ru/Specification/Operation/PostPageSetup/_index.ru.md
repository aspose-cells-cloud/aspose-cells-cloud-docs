...
type: docs
url: /ru/specification/operation/postpagesetup/
description: Обновить настройку страницы на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostPageSetup
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup,POST,Обновить настройки страницы на листе.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/PostPageSetup\'>PostPageSetup </а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="pageSetup,class:pagesetup,PageSetup Описание настройки страницы." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
