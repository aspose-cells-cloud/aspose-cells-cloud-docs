...
type: docs
url: /ru/specification/operation/postcopycellintocell/
description: Копирование данных из исходной ячейки в целевую ячейку на листе
kwords: Excel, Office, электронная таблица, Cloud REST API, PostCopyCellIntoCell
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{destCellName}/copy,POST,Копировать данные из исходной ячейки в целевую ячейку на листе.,<a href=\'https://apireference.aspose .cloud/cells/#/Cells/PostCopyCellIntoCell\'>PostCopyCellIntoCell</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="имя_листа,строка,имя целевого листа." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="рабочий лист, строка, имя исходного рабочего листа." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="имя_ячейки,строка,имя исходной ячейки." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="row,integer,Индекс исходной строки." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="столбец, целое число, индекс исходного столбца." >}} 
