...
type: docs
url: /ru/specification/operation/getnamedranges/
description: Получение описаний диапазонов на листах
kwords: Excel, Office, электронная таблица, Cloud REST API, GetNamedRanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/ranges,GET,Получить описания диапазонов на листах.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges\'>GetNamedRanges</a >" >}}
