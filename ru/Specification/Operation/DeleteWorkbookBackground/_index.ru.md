---
title: УдалитьWorkbookBackground
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,DELETE,Удалить фон в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground\'>DeleteWorkbookBackground</a>" >}}
