...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/insert,PUT,Вставьте новый лист в книгу.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PutInsertNewWorksheet\'>PutInsertNewWorksheet</a >" >}}
