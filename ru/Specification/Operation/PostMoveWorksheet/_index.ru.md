...
type: docs
url: /ru/specification/operation/postmoveworksheet/
description: Переместить лист в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, PostMoveWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/position,POST,Переместить лист в книгу.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostMoveWorksheet\'>PostMoveWorksheet< /а>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="moving,class:worksheetmovingrequest,WorksheetMovingRequest с параметрами перемещения." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
