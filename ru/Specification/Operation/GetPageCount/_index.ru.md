...
type: docs
url: /ru/specification/operation/getpagecount/
description: Получить количество страниц в книге
kwords: Excel, Office, электронная таблица, Cloud REST API, GetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/pagecount,GET,Получить количество страниц в книге.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount\'>GetPageCount</a>" >}}
