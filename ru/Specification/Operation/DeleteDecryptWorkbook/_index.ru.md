---
title: УдалитьDecryptWorkboo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/deletedecryptworkbook/
description: Excel расшифровка файлов
kwords: Excel, Office, электронная таблица, Cloud REST API, DeleteDecryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,DELETE,Excel расшифровка файлов.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/DeleteDecryptWorkbook\'>DeleteDecryptWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="шифрование, класс: workbookencryptionrequest, параметры WorkbookEncryptionRequestEncryption." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
