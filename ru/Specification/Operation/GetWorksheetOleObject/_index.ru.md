---
title: Получить рабочий листOleObjec
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/operation/getworksheetoleobject/
description: Получить объект OLE в указанном формате на листе.
kwords: Excel, Office, электронная таблица, Cloud REST API, GetWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Описание,ссылка API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects/{objectNumber},GET,Получить объект OLE в указанном формате на листе.,<a href=\'https://apireference.aspose.cloud/cells /#/OleObjects/GetWorksheetOleObject\'>GetWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Имя параметра, тип, описание" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="objectNumber, целое число, номер объекта." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Имя параметра, тип, описание" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="формат, строка, формат преобразования объекта (PNG/TIFF/JPEG/GIF/EMF/BMP)." >}} 
