...
type: docs
url: /ru/specification/model/label/
description: "Aspose.Cells Спецификация облачной модели: Этикетка. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, этикетка
weight: 50
---
## **этикетка**
