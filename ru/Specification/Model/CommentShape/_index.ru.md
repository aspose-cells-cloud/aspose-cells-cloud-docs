---
title: КомментарийШап
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/model/commentshape/
description: "Aspose.Cells Спецификация облачной модели: CommentShape. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, CommentShape
weight: 50
---
## **комментарийФорма**
...
|:- |:- |:- |:- |:- |:- |
| Комментарий| Класс:LinkElement| Истинный| ЛОЖЬ|| Получает объект комментария.|
