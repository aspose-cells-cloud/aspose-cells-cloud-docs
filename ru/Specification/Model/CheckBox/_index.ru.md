...
type: docs
url: /ru/specification/model/checkbox/
description: "Aspose.Cells Спецификация облачной модели: CheckBox. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, флажок
weight: 50
---
## **флажок**
...
|:- |:- |:- |:- |:- |:- |
| Проверенное значение| Нить| Истинный| ЛОЖЬ|| Получает или устанавливает значение флажка.|
| Тень| логическое значение| Истинный| ЛОЖЬ|| Указывает, имеет ли поле со списком трехмерную заливку.|
| Ценить| логическое значение| Истинный| ЛОЖЬ|| Указывает, установлен ли флажок или нет.|
