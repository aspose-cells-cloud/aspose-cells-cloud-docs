...
type: docs
url: /ru/specification/model/cellsdrawing/
description: "Aspose.Cells Спецификация облачной модели: CellsDrawing. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, Электронная таблица, Cloud REST API, CellsDrawing
weight: 50
---
## **клеткиРисование**

 Представляет автофигуру и объект рисования.
