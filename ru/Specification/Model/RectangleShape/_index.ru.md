---
title: ПрямоугольникШап
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ru/specification/model/rectangleshape/
description: "Aspose.Cells Спецификация модели облака: RectangleShape. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, RectangleShape
weight: 50
---
## **прямоугольникФорма**
