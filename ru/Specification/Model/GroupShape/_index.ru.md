...
type: docs
url: /ru/specification/model/groupshape/
description: "Aspose.Cells Спецификация облачной модели: GroupShape. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, GroupShape
weight: 50
---
## **группаФорма**

 Представляет фигуру группы, содержащую отдельные фигуры.
