...
type: docs
url: /ru/specification/model/scrollbar/
description: "Aspose.Cells Спецификация облачной модели: ScrollBar. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, полоса прокрутки
weight: 50
---
## **полоса прокрутки**
...
|:- |:- |:- |:- |:- |:- |
| Текущая стоимость| Целое число| Истинный| ЛОЖЬ|| Получает или задает текущее значение.|
| Инкрементальное изменение| Целое число| Истинный| ЛОЖЬ|| Получает или задает величину, на которую увеличивается полоса прокрутки или счетчик при прокрутке строки.|
| Горизонтальный| логическое значение| Истинный| ЛОЖЬ|| Указывает, является ли это горизонтальной полосой прокрутки.|
| Макс| Целое число| Истинный| ЛОЖЬ|| Получает или задает максимальное значение полосы прокрутки или диапазона счетчика.|
| Мин| Целое число| Истинный| ЛОЖЬ|| Получает или задает минимальное значение полосы прокрутки или диапазона счетчика.|
| Изменение страницы| Целое число| Истинный| ЛОЖЬ|| Получает или задает смену страницы|
| Тень| логическое значение| Истинный| ЛОЖЬ|| Указывает, имеет ли фигура трехмерную заливку.|
