...
type: docs
url: /ru/specification/model/lineshape/
description: "Aspose.Cells Спецификация модели облака: LineShape. Легко обрабатывайте Excel и другие документы электронных таблиц с помощью таких функций, как открытие, создание, редактирование, разделение, слияние, сравнение и преобразование."
kwords: Excel, Office, электронная таблица, Cloud REST API, LineShape
weight: 50
---
## **линияФорма**
...
|:- |:- |:- |:- |:- |:- |
| НачалоСтрелкаДлина| Нить| Истинный| ЛОЖЬ|| Получает и задает длину начальной стрелки линии.|
| НачатьСтрелкаСтиль| Нить| Истинный| ЛОЖЬ|| Получает и задает стиль начала стрелки линии.|
| НачалоСтрелкаШирина| Нить| Истинный| ЛОЖЬ|| Получает и задает ширину начальной стрелки линии.|
| КонецСтрелкаДлина| Нить| Истинный| ЛОЖЬ|| Получает и задает длину конечной стрелки линии.|
| КонецСтрелкаСтиль| Нить| Истинный| ЛОЖЬ|| Получает и задает стиль конечной стрелки линии.|
| КонецСтрелкаШирина| Нить| Истинный| ЛОЖЬ|| Получает и задает ширину конечной стрелки линии.|
