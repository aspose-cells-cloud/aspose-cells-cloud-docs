...
---
## Введение
Aspose.Cells Cloud API — это мощное облачное решение, созданное для создания, редактирования и преобразования файлов электронных таблиц. В этой статье мы покажем вам процесс использования облака Aspose.Cells Cloud API для объединения форматов файлов, включая типичные варианты использования и примеры кода.
