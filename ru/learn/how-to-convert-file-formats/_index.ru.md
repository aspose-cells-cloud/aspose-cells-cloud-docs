...
Для преобразования файлов доступны многочисленные API-интерфейсы, которые обычно совместимы с различными онлайн-средами. Ниже приведено подробное описание этих API:
