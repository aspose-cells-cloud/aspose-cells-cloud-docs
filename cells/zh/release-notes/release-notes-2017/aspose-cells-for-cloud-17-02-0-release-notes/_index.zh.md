---
title: Aspose.Cells Cloud 17.2 发行说明
second_title: Aspose.Cells Cloud Documen
type: docs
url: /zh/aspose-cells-cloud-17-2-release-notes/
...
此页面包含发行说明[Aspose.Cells 云 17.2](https://downloads.aspose.com/cells/cloud/new-releases/aspose.cells-for-cloud-17.02.0/).

{{% /alert %}} 

|**钥匙**|**概括**|**类别**|
|:- |:- |:- |
|CELLSCLOUD-10011|支持数据透视表过滤器|新功能|
|CELLSCLOUD-10019|支持任务处理中的数据透视表操作|新功能|
|CELLSCLOUD-10022|添加用于隐藏数据透视字段项的重新计算参数|新功能|
|CELLSCLOUD-10024|列表对象 - 转换为范围|新功能|
|CELLSCLOUD-10025|列表对象 - 使用数据透视表进行汇总|新功能|
|CELLSCLOUD-10026|移动数据透视表|新功能|
|CELLSCLOUD-10027|移动数据透视表字段|新功能|
## **使用数据透视过滤器**
以下示例代码说明了如何使用 Aspose.Cells for Cloud 使用数据透视过滤器。
...
```
## **使用 CellsObjectOperate 任务处理数据透视表**
以下示例代码说明了如何使用 CellsObjectOperate Task 对象和 Aspose.Cells for Cloud 来处理数据透视表。
...
```
## **隐藏数据透视字段项后重新计算数据透视表**
以下示例代码说明了如何在使用 Aspose.Cells for Cloud 隐藏数据透视字段项后重新计算数据透视表。
...
## **将列表对象或表转换为范围**
以下示例代码说明了如何使用 Aspose.Cells for Cloud 将列表对象或表转换为范围。
...
```
## **使用列表对象作为源数据创建新的数据透视表**
以下示例代码说明了如何使用 Aspose.Cells for Cloud 创建新的数据透视表，并将列表对象作为源数据。
...
1. [使用数据透视过滤器](/cells/zh/working-with-pivot-tables/)
1. [使用 CellsObjectOperate 任务处理数据透视表](/cells/zh/working-with-pivot-table-using-cellsobjectoperate-task/)
1. [隐藏数据透视字段项后重新计算数据透视表](/cells/zh/hide-pivot-field-item/)
1. [将列表对象或表转换为范围](/cells/zh/convert-list-object-or-table-to-range/)
1. [使用列表对象作为源数据创建新的数据透视表](/cells/zh/add-a-pivot-table-in-a-worksheet/)
