...
description: Aspose.Cells Cloud REST API 支持在Excel文件中添加图片。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
---
...
|右下行|整数|询问|0 |
|右下栏|整数|询问|0 |
|图片路径|细绳|询问|图片路径，如果未提供，则在请求正文中检查图片数据。|
|文件夹|细绳|询问|工作簿文件夹。|
|存储名称|细绳|询问|存储名称。|
 
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
