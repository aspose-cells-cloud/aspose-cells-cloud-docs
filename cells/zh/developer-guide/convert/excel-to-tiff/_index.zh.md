...
description: Aspose.Cells Cloud REST API 支持将 excel 文件转换为 tiff 文件。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 90
---
这个 REST API `saveas` excel 文件到 TIFF。

[POST /cells/{名称}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API 可让您将 MS Excel 文件另存为具有附加设置的 TIFF 文件，并将结果保存到存储器中。

这个 REST API `convert` excel 文件到 TIFF。

[PUT /细胞/转换](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook)API 可让您使用其他设置将 MS Excel 文件转换为 TIFF 文件，并将结果保存到响应中。

这个 REST API `export` excel 文件到 TIFF。

[获取/单元格/{名称}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  )API 可让您使用其他设置将 MS Excel 文件转换为 TIFF 文件，并将结果保存到响应中。
