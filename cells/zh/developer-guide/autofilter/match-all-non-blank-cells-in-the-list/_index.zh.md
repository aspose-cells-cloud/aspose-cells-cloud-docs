...
description: Aspose.Cells Cloud API 支持匹配Excel工作表筛选列表中所有非空白单元格。SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 100
---
此 REST API 表示 Excel 工作表上列表中的 `match` 所有 `not blank cell`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchNonBlanks)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
