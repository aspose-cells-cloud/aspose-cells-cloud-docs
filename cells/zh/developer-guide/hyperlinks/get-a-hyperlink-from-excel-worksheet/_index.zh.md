...
weight: 10
---
此 REST API 通过 Excel 工作表上的索引指示 `get worksheet hyperlink`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Hypelinks/GetWorksheetHyperlink)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
