...
description: Aspose.Cells Cloud REST API 支持在 Excel 工作表上添加一个空行。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 20
---
此 REST API 指示在 Excel 工作表上添加新的工作表行。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRow)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
