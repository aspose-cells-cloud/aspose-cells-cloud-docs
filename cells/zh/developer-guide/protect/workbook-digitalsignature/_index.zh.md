...
linktitle: 数字签名
type: docs
url: /zh/workbook/digital-signature/
aliases: [/protect/digital-signature/]
keywords: Add digital signature for an Excel workbook
description: Aspose.Cells Cloud REST API 支持为 Excel 工作簿添加数字签名。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 35
---
此 REST API 指示为 Excel 工作簿添加 `digital signature`。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Workbook/PostDigitalSignature)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
