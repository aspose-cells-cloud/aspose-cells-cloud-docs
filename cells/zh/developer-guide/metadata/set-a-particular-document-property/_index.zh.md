...
description: Aspose.Cells Cloud REST API 支持从 excel 文件更新属性。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 30
---
此 REST API 指示 `set/create` 文档属性。
...
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/Properties/PutDocumentProperty)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
