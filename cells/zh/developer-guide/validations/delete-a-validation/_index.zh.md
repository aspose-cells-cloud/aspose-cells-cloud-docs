...
description: Aspose.Cells Cloud REST API 支持删除 Excel 工作表上的工作表验证。 SDK支持多种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 10
---
此 REST API 指示删除 Excel 工作表上按索引验证的工作表。
