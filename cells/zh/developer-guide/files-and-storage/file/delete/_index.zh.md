...
description: 了解如何使用 Aspose 删除文件 Cells Cloud REST API SDK 支持各种开发语言。它们包括 Android、C#、Go、Java、NodeJS、Perl、PHP、Python、Ruby 和 swift
weight: 100
---
...
|:- |:- |:- |:- |
|小路|细绳|小路|文件路径例如'/folder/file.ext'|
|存储名称|细绳|询问|存储名称|
|版本号|细绳|询问|要删除的文件版本 ID|
 
这[OpenAPI 规范](https://apireference.aspose.cloud/cells/#/File/DeleteFile)定义了一个可公开访问的编程接口，并允许您直接从 Web 浏览器执行 REST 交互。
