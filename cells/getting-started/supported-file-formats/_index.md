...
|[PDF](https://docs.fileformat.com/view/pdf/)|Adobe Portable Document Format.| |{{< emoticons/tick >}}|
...
|SXC|An XML based format used by OpenOffice and StarOffice|{{< emoticons/tick >}}| |
