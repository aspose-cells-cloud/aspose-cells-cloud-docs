...
|[XLSX](https://docs.fileformat.com/spreadsheet/xlsx/)|Office Open XML SpreadsheetML Workbook oder Vorlagendatei, mit oder ohne Makros.|{{< emoticons/tick >}}|{{< emoticons/tick >}}|
...
|[XLAM](https://docs.fileformat.com/spreadsheet/xlam/)|Eine Makro-aktivierte Excel-Add-In-Datei, die zum Hinzufügen neuer Funktionen zu Excel verwendet wird.||{{< emoticons/tick >}}|
