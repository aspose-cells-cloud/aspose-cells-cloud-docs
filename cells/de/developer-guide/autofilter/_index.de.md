---
title: Automatisch filtern
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/autofilter/
aliases: [/working-with-autofilter/]
keywords: Get, add， delete, and so on for auto filter on an Excel worksheet
description: Die Aspose.Cells-Cloud-APIs unterstützen das Abrufen, Hinzufügen, Löschen usw. für den automatischen Filter auf einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 100
---
...
um Daten basierend auf der Füllfarbeneigenschaft der Zellen zu filtern.</p>
  ...
  <td class="col-md-10">
  <p>
 Es können verschiedene Arten von Datumsfiltern implementiert werden, z. B. das Filtern aller Zeilen mit Datumsangaben im Januar 2018.<a href="/cells/de/autofilter/add-date-filter/">die API Datum Farbfilter hinzufügen</a> kann diese Funktionalität implementieren.
</p>
  </td>
  </tr>
    <tr>
  ...
  <td class="col-md-10">
  <p>
 Manchmal sind dynamische Filter basierend auf einem Datum erforderlich, z. B. alle Zellen mit Datumsangaben im Januar, unabhängig vom Jahr.<a href="/cells/de/autofilter/add-dynamic-filter/">die API des dynamischen Filters</a>  
</p>
  </td>
  </tr>
      <tr>
  ...
  <td class="col-md-10">
  <p>
<a href="/cells/de/autofilter/add-filter/">Die benutzerdefinierten Filter API</a> kann mit Aspose.Cells angewendet werden, wie das Auswählen von Zellen mit einer Nummer zwischen einem bestimmten Bereich.
</p>
  </td>
  </tr>
        <tr>
  ...
  <td class="col-md-10">
  <p>
 Wenn eine Spalte Text enthält und Zellen ausgewählt werden sollen, die einen bestimmten Text enthalten,<a href="/cells/de/autofilter/add-filter/"> Der Zusatzfilter API</a>kann verwendet werden.
</p>
  </td>
  </tr>
          <tr>
...
- [So fügen Sie einem Excel-Arbeitsblatt einen Farbfilter hinzu.](/cells/de/autofilter/add-color-filter/)
- [So fügen Sie einem Excel-Arbeitsblatt einen benutzerdefinierten Filter hinzu.](/cells/de/autofilter/add-custom-filter/)
- [So fügen Sie einem Excel-Arbeitsblatt einen Datumsfilter hinzu.](/cells/de/autofilter/add-date-filter/)
- [So fügen Sie einem Excel-Arbeitsblatt einen dynamischen Filter hinzu.](/cells/de/autofilter/add-dynamic-filter/)
- [So fügen Sie einen Filter in einem Excel-Arbeitsblatt hinzu.](/cells/de/autofilter/add-filter/)
- [So fügen Sie einem Excel-Arbeitsblatt einen Symbolfilter hinzu.](/cells/de/autofilter/add-icon-filter/)
- [So löschen Sie einen Datumsfilter in einem Excel-Arbeitsblatt.](/cells/de/autofilter/delete-a-date-filter/)
...
- [So passen Sie alle Leerzeichen in einem Excel-Arbeitsblatt an.](/cells/de/autofilter/match-all-blank/)
- [So passen Sie alle Nicht-Leerzeichen in einem Excel-Arbeitsblatt an.](/cells/de/autofilter/match-all-non-blank/)
