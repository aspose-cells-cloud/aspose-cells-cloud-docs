...
description: Die Aspose.Cells-Cloud API unterstützt das Hinzufügen eines dynamischen Filters auf einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 65
---
Dieser REST API gibt an, dass ein `dynamic filter` auf einem Excel-Arbeitsblatt hinzugefügt werden soll.
...
| dynamischerFiltertyp| Schnur| Anfrage||
| übereinstimmenBlanks| boolesch| Anfrage||
| Aktualisierung| boolesch| Anfrage||
| Ordner| Schnur| Anfrage||
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDynamicFilter) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
