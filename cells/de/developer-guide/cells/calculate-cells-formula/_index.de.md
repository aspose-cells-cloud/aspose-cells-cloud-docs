---
title: Berechnen Sie Cells Formel
type: docs
url: /de/calculate-cells-formula/
weight: 90
---
Dieser REST API zeigt an, dass `cells formula` in einer Excel-Datei berechnet wird.
...
| Zellenname| Schnur| Weg||
| Optionen|| Körper||
| Ordner| Schnur| Anfrage||
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostCellCalculate) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
