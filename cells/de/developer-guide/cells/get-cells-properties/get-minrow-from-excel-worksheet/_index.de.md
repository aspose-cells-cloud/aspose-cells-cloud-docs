---
title: Holen Sie sich MinRow aus dem Arbeitsblatt Excel
type: docs
url: /de/get-minrow-from-excel-worksheet/
weight: 80
---
Dieser REST API zeigt an, dass Shows einen `minrow` in einer Excel-Datei erhalten, wenn der `cellOrMethodName`-Parameter `minrow` ist.
