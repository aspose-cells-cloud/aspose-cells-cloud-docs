---
title: Holen Sie sich die letzte Zelle von Excel Arbeitsblatt
type: docs
url: /de/get-last-cell-of-excel-worksheet/
weight: 30
---
Dieser REST API zeigt an, dass Shows einen `endcell` in einer Excel-Datei erhalten, wenn der `cellOrMethodName`-Parameter `endcell` ist.
