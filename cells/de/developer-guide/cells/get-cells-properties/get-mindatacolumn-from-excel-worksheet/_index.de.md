---
title: Holen Sie sich MinDataColumn aus dem Arbeitsblatt Excel
type: docs
url: /de/get-mindatacolumn-from-excel-worksheet/
weight: 110
---
Dieser REST API zeigt an, dass Shows einen `mindatacolumn` in einer Excel-Datei erhalten, wenn der `cellOrMethodName`-Parameter `mindatacolumn` ist.
