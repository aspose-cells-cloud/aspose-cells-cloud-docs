...
description: Aspose.Cells Cloud REST API unterstützt das Gruppieren von Zeilen auf einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 60
---
Dieser REST API gibt an, Zeilen auf einem Excel-Arbeitsblatt zu gruppieren.
...
| ersterIndex| ganze Zahl| Anfrage| Der erste zu bearbeitende Zeilenindex.|
| lastIndex| ganze Zahl| Anfrage| Der letzte zu bearbeitende Zeilenindex.|
| verstecken| boolesch| Anfrage| Zeilen sichtbarer Zustand|
| Ordner| Schnur| Anfrage| Der Dokumentenordner.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
