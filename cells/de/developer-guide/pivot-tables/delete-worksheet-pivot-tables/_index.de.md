...
description: Aspose.Cells Cloud REST API unterstützt das Löschen aller Pivot-Tabellen in einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 80
---
Dieser REST API gibt an, dass Arbeitsblatt-Pivot-Tabellen gelöscht werden
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTables) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
