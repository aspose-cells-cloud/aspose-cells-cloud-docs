...
description: Aspose.Cells Cloud REST API unterstützt die Verschlüsselung von Excel-Arbeitsmappen. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
...
|:- |:- |:- |:- |
|/cells/{Name}/Verschlüsselung|POST|Excel Dokument verschlüsseln|[PostEncryptDocument](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument)|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
