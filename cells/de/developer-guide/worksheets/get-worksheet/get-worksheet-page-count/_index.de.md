---
title: Abrufen der Seitenzahl für ein Excel-Arbeitsblatt
second_title: Aspose.Cells Cloud Documen
linktitle: PageCoun
type: docs
url: /de/worksheets/page-count/
keywords: Get page count on an Excel worksheet
description: Aspose.Cells Cloud REST API unterstützt das Abrufen der Seitenzahl auf einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 10
---
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/GetPageCount) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
