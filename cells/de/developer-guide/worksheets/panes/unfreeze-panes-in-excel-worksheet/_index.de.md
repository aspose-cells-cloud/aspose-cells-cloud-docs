---
title: Freigeben von Fenstern auf einem Excel-Arbeitsblatt
...
description: Aspose.Cells Cloud REST API unterstützt das Auftauen von Fenstern auf einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 200
---
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetFreezePanes) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
