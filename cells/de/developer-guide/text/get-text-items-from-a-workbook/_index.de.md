---
title: Textelemente aus einem Excel-Workboo abrufen
second_title: Aspose.Cells Cloud Documen
linktitle: Steig ins Workboo ein
type: docs
...
---
Dieser REST API weist auf `text items` der Arbeitsmappe `read` in der Arbeitsmappe Excel hin.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
