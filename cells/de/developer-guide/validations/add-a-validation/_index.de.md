---
title: Fügen Sie eine Arbeitsblattvalidierung auf einem Excel-Arbeitsblatt hinzu
second_title: Aspose.Cells Cloud Documen
linktitle: Anzeige
type: docs
url: /de/validations/add/
keywords: Delete a worksheet validation on an Excel worksheet
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen einer Arbeitsblattvalidierung auf einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 10
---
Dieser REST API gibt an, dass eine Arbeitsblattvalidierung auf einem Excel-Arbeitsblatt hinzugefügt werden soll.
...
| Bereich| Schnur| Anfrage| Angegebener Zellenbereich|
| Validierung|| Körper| Validierung|
| Ordner| Schnur| Anfrage| Ordner des Dokuments.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PutWorksheetValidation) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
