...
weight: 60
---
 Dieser REST API zeigt die zweite Werteachse des Get Chart an.
...
| Speichername| Schnur| Anfrage||
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondValueAxis) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
