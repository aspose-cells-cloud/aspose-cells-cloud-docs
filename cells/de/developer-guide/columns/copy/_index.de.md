---
title: Spalten auf einem Arbeitsblatt Excel kopieren
...
description: Aspose.Cells Cloud REST API unterstützt das Kopieren von Spalten auf einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 30
---
Dieser REST API kopiert `columns` in ein Excel-Arbeitsblatt.
...
| sourceColumnIndex| ganze Zahl| Anfrage| Quellspaltenindex|
| destinationColumnIndex| ganze Zahl| Anfrage| Index der Zielspalte|
| Spaltennummer| ganze Zahl| Anfrage| Die kopierte Spaltennummer|
| Arbeitsblatt| Schnur| Anfrage||
| Ordner| Schnur| Anfrage| Der Dokumentenordner.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetColumns) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
