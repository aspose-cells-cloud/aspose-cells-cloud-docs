---
title: "Get Text Items from a Workbook"
type: docs
url: /get-text-items-from-a-workbook/
weight: 10
---

## **Introduction**
This example shows how to get all text item information from a Excel Workbook using Aspose.Cells Cloud API in your applications. You can use our REST API with any language: .NET, Java, PHP, Ruby, Rails, Python, jQuery and many more.
...
| :- | :- | :- | :- |
|/cells/{name}/textItems|GET|Get all textitems from a Excel Workbook|[GetWorkBookTextItems](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBookTextItems)|
### **cURL Example**
