---
title: "Move Pivot Table"
type: docs
url: /move-pivot-table/
weight: 110
---

## **Introduction**
The following sample code illustrates how to move pivot table, using Aspose.Cells Cloud API in your applications. You can use our REST API with any language: .NET, Java, PHP, Ruby, Rails, Python, jQuery and many more.
## **API Information**

|**API**|**Type**|**Description**|**Resource Link**|
| :- | :- | :- | :- |
|/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Move|POST|Moves pivot field in pivot table|[PostPivotTableFieldMoveTo](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldMoveTo)|
### **cURL Example**
...
curl -X POST "https://api.aspose.cloud/v3.0/cells/Book1.xlsx/worksheets/Sheet1/pivottables/0/PivotField/Move?fieldIndex=0&from=C1&to=C10" -H "accept: application/json" -H "x-aspose-client: Containerize.Swagger"
