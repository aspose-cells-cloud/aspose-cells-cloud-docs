...
This REST API indicates shows get a `mindatacolumn` in an Excel file when the `cellOrMethodName` parameter is `mindatacolumn`.
...
{{< gist "aspose-cloud" "5c1a68c4cea73845b221ff0d3b9ec9df" "Examples-PHP-Cells-GetWorksheetMinDataColumn.php" >}}

{{< /tab >}}

{{< tab tabNum="4" >}}

{{< gist "aspose-cloud" "3c5c9f9fff9898bb8251aa7ee9191641" "Examples-Ruby-Cells-get_worksheet_min_data_column.rb" >}}
...
{{< gist "aspose-cloud" "04e9dd952c704f334a4eceb3925d479e" "Examples-Node.js-SDK-Cells-GetMinDataColumnWorksheet-1.js" >}}
