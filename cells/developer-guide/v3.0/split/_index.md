...
The [OpenAPI Specification](https://apireference.aspose.cloud/cells/#/PostSplit) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
