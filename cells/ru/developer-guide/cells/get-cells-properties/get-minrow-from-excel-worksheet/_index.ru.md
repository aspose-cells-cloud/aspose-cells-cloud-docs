---
title: Получить MinRow из рабочей таблицы Excel
type: docs
url: /ru/get-minrow-from-excel-worksheet/
weight: 80
---
Этот REST API указывает, что шоу получает `minrow` в файле Excel, когда параметр `cellOrMethodName` равен `minrow`.
