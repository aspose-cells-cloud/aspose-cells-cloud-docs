---
title: Применение форматирования расширенного текста к Cel
type: docs
url: /ru/apply-rich-text-formatting-to-a-cell/
weight: 40
---
Этот REST API указывает применить `rich text formatting` к ячейке в файле Excel.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
