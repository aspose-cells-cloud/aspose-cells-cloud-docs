---
title: Добавьте 10 лучших элементов в рабочую таблицу Excel.
second_title: Aspose.Cells Cloud Documen
linktitle: Добавить 10 лучших фильтров
type: docs
...
description: Облако Aspose.Cells API поддерживает добавление фильтра Top10 на рабочий лист Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
weight: 65
---
...
| я остановился| логический| запрос||
| isPercent| логический| запрос||
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetFilterTop10) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
