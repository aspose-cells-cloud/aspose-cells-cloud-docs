...
description: Aspose.Cells Cloud REST API поддерживает замену текста из книги Excel. SDK поддерживает различные языки разработки. К ним относятся Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby и swift.
---
Этот REST API указывает на текст `replace` в книге Excel.
...
| старое значение| нить| запрос| Старый текст заменить.|
| новое значение| нить| запрос| Новый текст для замены.|
| папка| нить| запрос| Папка документа.|
| имя_хранилища| нить| запрос| имя хранилища.|
 
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorsheetTextReplace) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
