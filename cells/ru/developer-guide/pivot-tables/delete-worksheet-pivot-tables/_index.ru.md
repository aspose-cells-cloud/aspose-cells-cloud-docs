---
title: Удалить все сводные таблицы в рабочей таблице Excel
...
weight: 80
---
Этот REST API указывает Удалить сводные таблицы рабочего листа
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTables) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
