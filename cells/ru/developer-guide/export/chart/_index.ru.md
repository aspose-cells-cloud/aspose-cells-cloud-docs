...
|:- |:- |:- |:- |
|/ячейки/экспорт|ПОЧТА|Экспорт Excel объектов из содержимого запроса в какой-либо формат|[Постэкспорт](https://apireference.aspose.cloud/cells/#/LiteCells/PostExport)|
