---
title: Получить область диаграммы из рабочей таблицы
type: docs
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
