---
title: Установите заголовок диаграммы в рабочем листе Excel
type: docs
url: /ru/chart/title/add/
aliases: [/set-chart-title-in-excel-worksheet/]
weight: 30
---
Этот REST API указывает на добавление заголовка диаграммы/задание видимого заголовка диаграммы.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartTitle) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
