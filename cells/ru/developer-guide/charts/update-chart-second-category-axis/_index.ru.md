---
title:  Обновить ось второй категории диаграммы
type: docs
url: /ru/charts/second-category-axis/update/
weight: 160
---
 Этот REST API указывает ось обновления второй категории диаграммы.
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondCategoryAxis) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
