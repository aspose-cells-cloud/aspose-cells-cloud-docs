---
title: Изменить ширину столбцов внутри ранга
...
weight: 74
---
Этот REST API указывает установить ширину столбца диапазона
...
[Спецификация OpenAPI](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeColumnWidth) определяет общедоступный программный интерфейс и позволяет выполнять REST-взаимодействия непосредственно из веб-браузера.
