---
title: Aspose.Cells Note de mise à jour Cloud 17.2
second_title: Aspose.Cells Cloud Documen
type: docs
url: /fr/aspose-cells-cloud-17-2-release-notes/
...
{{% alert color="primary" %}} 
 ...
 Cette page contient des notes de version pour[Aspose.Cells Nuage 17.2](https://downloads.aspose.com/cells/cloud/new-releases/aspose.cells-for-cloud-17.02.0/).

{{% /alert %}} 

|**Clé**|**Résumé**|**Catégorie**|
|:- |:- |:- |
|CELLSCLOUD-10011|Prise en charge des filtres de tableau croisé dynamique|Nouvelle fonctionnalité|
|CELLSCLOUD-10019|Prise en charge de l'opération de tableau croisé dynamique dans le traitement des tâches|Nouvelle fonctionnalité|
|CELLSCLOUD-10022|Ajouter un paramètre de recalcul pour masquer l'élément de champ pivot|Nouvelle fonctionnalité|
|CELLSCLOUD-10024|Objet de liste - Convertir en plage|Nouvelle fonctionnalité|
|CELLSCLOUD-10025|Objet de liste - Résumer avec un tableau croisé dynamique|Nouvelle fonctionnalité|
|CELLSCLOUD-10026|Déplacer le tableau croisé dynamique|Nouvelle fonctionnalité|
|CELLSCLOUD-10027|Champ Déplacer le tableau croisé dynamique|Nouvelle fonctionnalité|
## **Travailler avec des filtres croisés dynamiques**
L'exemple de code suivant illustre comment utiliser des filtres de pivot à l'aide de Aspose.Cells pour Cloud.
...
```
## **Utilisation du tableau croisé dynamique à l'aide de la tâche CellsObjectOperate**
L'exemple de code suivant illustre comment utiliser le tableau croisé dynamique à l'aide de l'objet CellsObjectOperate Task avec Aspose.Cells pour le cloud.
...
```
## **Recalculer le tableau croisé dynamique après avoir masqué l'élément de champ de pivot**
L'exemple de code suivant illustre comment recalculer le tableau croisé dynamique après avoir masqué l'élément de champ croisé dynamique à l'aide de Aspose.Cells pour le cloud.
...
## **Convertir un objet de liste ou un tableau en plage**
L'exemple de code suivant illustre comment convertir un objet de liste ou une table en plage à l'aide de Aspose.Cells pour le cloud.
...
```
## **Créer un nouveau tableau croisé dynamique avec un objet de liste comme données source**
L'exemple de code suivant illustre comment créer un nouveau tableau croisé dynamique avec un objet de liste en tant que données source à l'aide de Aspose.Cells pour le cloud.
...
1. [Travailler avec des filtres croisés dynamiques](/cells/fr/working-with-pivot-tables/)
1. [Utilisation du tableau croisé dynamique à l'aide de la tâche CellsObjectOperate](/cells/fr/working-with-pivot-table-using-cellsobjectoperate-task/)
1. [Recalculer le tableau croisé dynamique après avoir masqué l'élément de champ de pivot](/cells/fr/hide-pivot-field-item/)
1. [Convertir un objet de liste ou un tableau en plage](/cells/fr/convert-list-object-or-table-to-range/)
1. [Créer un nouveau tableau croisé dynamique avec un objet de liste comme données source](/cells/fr/add-a-pivot-table-in-a-worksheet/)
