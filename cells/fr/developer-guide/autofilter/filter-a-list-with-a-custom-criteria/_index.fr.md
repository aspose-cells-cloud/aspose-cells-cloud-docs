...
| typeopérateur1| chaîne| mettre en doute||
| critère1| chaîne| mettre en doute||
| est et| booléen| mettre en doute||
| typeopérateur2| chaîne| mettre en doute||
| critères2| chaîne| mettre en doute||
| matchBlanks| booléen| mettre en doute||
| rafraîchir| booléen| mettre en doute||
| dossier| chaîne| mettre en doute||
| nom_stockage| chaîne| mettre en doute| nom de stockage.|
 
 Le[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetCustomFilter) définit une interface de programmation accessible au public et permet d'effectuer des interactions REST directement depuis un navigateur Web.
