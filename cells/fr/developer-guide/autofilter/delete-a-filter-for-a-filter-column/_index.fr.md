...
weight: 100
---
Ce REST API indique de supprimer un `filter` sur une feuille de travail Excel.
...
|nom_stockage|chaîne| Mettre en doute|Nom de stockage.|
 ...
 Le[Spécification OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetFilter) définit une interface de programmation accessible au public et permet d'effectuer des interactions REST directement depuis un navigateur Web.
