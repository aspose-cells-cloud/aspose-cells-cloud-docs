---
title: Aspose.Cells Bulut 17.2 Sürüm Notu
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/aspose-cells-cloud-17-2-release-notes/
...
{{% alert color="primary" %}} 
 ...
 Bu sayfa için sürüm notları içerir[Aspose.Cells Bulut 17.2](https://downloads.aspose.com/cells/cloud/new-releases/aspose.cells-for-cloud-17.02.0/).

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
|:- |:- |:- |
|CELLSCLOUD-10011|Pivot Tablo Filtrelerini Destekleyin|Yeni özellik|
|CELLSCLOUD-10019|Görev işlemede Pivot Tablo işlemini destekleyin|Yeni özellik|
|CELLSCLOUD-10022|Pivot alan öğesini gizlemek için yeniden hesaplama parametresi ekleyin|Yeni özellik|
|CELLSCLOUD-10024|Liste nesnesi - Aralığa dönüştür|Yeni özellik|
|CELLSCLOUD-10025|Liste nesnesi - Pivot Tablo ile Özetle|Yeni özellik|
|CELLSCLOUD-10026|Pivot Tabloyu Taşı|Yeni özellik|
|CELLSCLOUD-10027|Pivot Tablo alanını taşı|Yeni özellik|
## **Pivot Filtrelerle Çalışma**
Aşağıdaki örnek kod, Bulut için Aspose.Cells kullanılarak pivot filtrelerle nasıl çalışılacağını gösterir.
...
```
## **CellsObjectOperate Task Kullanarak Pivot Tablo ile Çalışma**
Aşağıdaki örnek kod, Cloud için Aspose.Cells ile CellsObjectOperate Task nesnesini kullanarak Özet Tablo ile nasıl çalışılacağını gösterir.
...
```
## **Pivot Alan Öğesini Gizledikten Sonra Özet Tabloyu Yeniden Hesapla**
Aşağıdaki örnek kod, Bulut için Aspose.Cells kullanılarak Özet Alan Öğesini gizledikten sonra Özet Tablonun nasıl yeniden hesaplanacağını gösterir.
...
## **Liste Nesnesini veya Tabloyu Aralığa Dönüştür**
Aşağıdaki örnek kod, Bulut için Aspose.Cells kullanılarak Liste Nesnesinin veya Tablonun Aralığa nasıl dönüştürüleceğini gösterir.
...
```
## **Kaynak Veri Olarak Liste Nesnesi ile yeni Pivot Tablo oluşturun**
Aşağıdaki örnek kod, Bulut için Aspose.Cells kullanılarak Kaynak Veri olarak Liste Nesnesi ile yeni Pivot Tablonun nasıl oluşturulacağını gösterir.
...
1. [Pivot Filtrelerle Çalışma](/cells/tr/working-with-pivot-tables/)
1. [CellsObjectOperate Task Kullanarak Pivot Tablo ile Çalışma](/cells/tr/working-with-pivot-table-using-cellsobjectoperate-task/)
1. [Pivot Alan Öğesini Gizledikten Sonra Özet Tabloyu Yeniden Hesapla](/cells/tr/hide-pivot-field-item/)
1. [Liste Nesnesini veya Tabloyu Aralığa Dönüştür](/cells/tr/convert-list-object-or-table-to-range/)
1. [Kaynak Veri Olarak Liste Nesnesi ile yeni Pivot Tablo oluşturun](/cells/tr/add-a-pivot-table-in-a-worksheet/)
