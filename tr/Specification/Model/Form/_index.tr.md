...
type: docs
url: /tr/specification/model/form/
description: "Aspose.Cells Bulut modeli spesifikasyonu: Form. Açma, oluşturma, düzenleme, bölme, birleştirme, karşılaştırma ve dönüştürme gibi özelliklerle Excel ve diğer elektronik tablo belgelerini zahmetsizce yönetin"
weight: 50
---
## **biçim**
...
|:- |:- |:- |:- |:- |:- |
| Form Türü| Sicim| Doğru| YANLIŞ|||
| Kontrol Edilen Değer| Sicim| Doğru| YANLIŞ|||
| Gölge| Boolean| Doğru| YANLIŞ|||
| Giriş aralığı| Sicim| Doğru| YANLIŞ|||
| Seçilen Dizin| Tamsayı| Doğru| YANLIŞ|||
| Seçilen Değer| Sicim| Doğru| YANLIŞ|||
| Seçilen Hücre| Sınıf:LinkElement| Doğru| YANLIŞ|||
| Açılır Hatlar| Tamsayı| Doğru| YANLIŞ|||
| Eşya sayısı| Tamsayı| Doğru| YANLIŞ|||
| Seçilen Hücreler| Konteyner| Doğru| YANLIŞ|||
| Seçim Türü| Sicim| Doğru| YANLIŞ|||
| Kontrol Edildi| Boolean| Doğru| YANLIŞ|||
| Mevcut değer| Tamsayı| Doğru| YANLIŞ|||
| Min.| Tamsayı| Doğru| YANLIŞ|||
| Maksimum| Tamsayı| Doğru| YANLIŞ|||
| Artımlı Değişim| Tamsayı| Doğru| YANLIŞ|||
| Sayfa Değişikliği| Tamsayı| Doğru| YANLIŞ|||
| Yatay mı| Boolean| Doğru| YANLIŞ|||
