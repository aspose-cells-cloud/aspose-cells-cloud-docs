---
title: İşaretlemeKaydetSeçeneği
...
## **markdownKaydetSeçenekleri**
 ...
 .md dosyasını kaydetme seçeneklerini temsil eder.

| Mülkiyet adı| Emlak Tipi| Geçersiz kılınabilir| Sadece oku| Varsayılan değer| Tanım|
|:- |:- |:- |:- |:- |:- |
| Kodlama| Sicim| Doğru| YANLIŞ|| Varsayılan kodlamayı alır ve ayarlar.|
| FormatStratejisi| Sicim| Doğru| YANLIŞ|| Çalışma kitabını ışık modunda kaydetmek için hücre verilerini sağlayan Veri sağlayıcı.|
| Hat Ayırıcı| Sicim| Doğru| YANLIŞ|| Satır ayırıcıyı alır ve ayarlar.|
