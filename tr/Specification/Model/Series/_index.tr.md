...
| Veri etiketleri| Sınıf:LinkElement| Doğru| YANLIŞ|| Belirtilen ASeries için DataLabels nesnesini temsil eder.|
...
| Aşağı Çubuklar| Sınıf:LinkElement| Doğru| YANLIŞ|| Çizgi grafiğindeki aşağı çubukları temsil eden bir nesne döndürür. Yalnızca çizgi grafikleri için geçerlidir.|
...
| Efsane Girişi| Sınıf:LinkElement| Doğru| YANLIŞ|| Bu seriye göre efsane girişini alır.|
