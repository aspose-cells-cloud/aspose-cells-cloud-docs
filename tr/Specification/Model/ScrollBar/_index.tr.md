...
type: docs
url: /tr/specification/model/scrollbar/
description: "Aspose.Cells Bulut modeli spesifikasyonu: ScrollBar. Açma, oluşturma, düzenleme, bölme, birleştirme, karşılaştırma ve dönüştürme gibi özelliklerle Excel ve diğer elektronik tablo belgelerini zahmetsizce yönetin"
weight: 50
---
## **kaydırma çubuğu**
...
|:- |:- |:- |:- |:- |:- |
| Mevcut değer| Tamsayı| Doğru| YANLIŞ|| Geçerli değeri alır veya ayarlar.|
| Artımlı Değişim| Tamsayı| Doğru| YANLIŞ|| Kaydırma çubuğunun veya döndürücünün satır kaydırma başına artırılacağı miktarı alır veya ayarlar.|
| Yatay mı| Boolean| Doğru| YANLIŞ||Bunun yatay kaydırma çubuğu olup olmadığını belirtir.|
| Maksimum| Tamsayı| Doğru| YANLIŞ|| Kaydırma çubuğunun veya döndürücü aralığının maksimum değerini alır veya ayarlar.|
| Min.| Tamsayı| Doğru| YANLIŞ|| Kaydırma çubuğunun veya döndürücü aralığının minimum değerini alır veya ayarlar.|
| Sayfa Değişikliği| Tamsayı| Doğru| YANLIŞ|| Sayfa değişikliğini alır veya ayarlar|
| Gölge| Boolean| Doğru| YANLIŞ|| Şeklin 3 boyutlu gölgelendirmeye sahip olup olmadığını belirtir.|
