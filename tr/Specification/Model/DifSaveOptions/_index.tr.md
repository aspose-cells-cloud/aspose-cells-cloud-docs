...
type: docs
url: /tr/specification/model/difsaveoptions/
description: "Aspose.Cells Bulut modeli spesifikasyonu: DifSaveOptions. Açma, oluşturma, düzenleme, bölme, birleştirme, karşılaştırma ve dönüştürme gibi özelliklerle Excel ve diğer elektronik tablo belgelerini zahmetsizce yönetin"
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, DifSaveOptions
weight: 50
---
## **difSaveOptions**
