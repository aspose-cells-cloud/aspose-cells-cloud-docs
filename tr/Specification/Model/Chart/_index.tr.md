...
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, Grafik
weight: 50
---
## **çizelge**
...
| Arka duvar| Sınıf:Duvarlar| Doğru| YANLIŞ|| 3 boyutlu bir grafiğin arka duvarını temsil eden bir nesne döndürür.|
| KategoriEksen| Sınıf: Eksen| Doğru| YANLIŞ|| Grafiğin X eksenini alır.|
| GrafikAlan| Sınıf:ChartArea| Doğru| YANLIŞ|| Çalışma sayfasındaki grafik alanını alır.|
| GrafikVeriTablosu| Sınıf:ChartDataTable| Doğru| YANLIŞ|| Grafik veri tablosunu temsil eder.|
| Grafik Nesnesi| Sınıf:LinkElement| Doğru| YANLIŞ|| Grafik Şeklini temsil eder;|
| DerinlikYüzde| Tamsayı| Doğru| YANLIŞ|| boyutlu grafiğin derinliğini grafik genişliğinin yüzdesi olarak temsil eder (yüzde 20 ile 2000 arasında).|
...
| Zemin| Sınıf: Kat| Doğru| YANLIŞ|| 3 boyutlu bir grafiğin duvarlarını temsil eden bir nesne döndürür.|
...
| YükseklikYüzdesi| Tamsayı| Doğru| YANLIŞ|| boyutlu grafiğin yüksekliğini grafik genişliğinin yüzdesi olarak döndürür veya ayarlar (yüzde 5 ile 500 arasında).|
...
| Efsane| Sınıf:Efsane| Doğru| YANLIŞ|| Grafik efsanesini alır.|
| İsim| Sicim| Doğru| YANLIŞ|| Grafik adını temsil eder.|
| NSerisi| Sınıf:SeriesItems| Doğru| YANLIŞ|| Grafikteki veri serisini temsil eden bir koleksiyon alır.|
| Sayfa ayarı| Sınıf:LinkElement| Doğru| YANLIŞ|| Bu grafikteki sayfa yapısı açıklamasını temsil eder.|
| Perspektif| Tamsayı| Doğru| YANLIŞ|| 3 boyutlu harita görünümünün perspektifini döndürür veya ayarlar. 0 ile 100 arasında olmalıdır. RightAngleAxes özelliği True ise bu özellik yoksayılır.|
...
| Arsa alanı| Sınıf:PlotArea| Doğru| YANLIŞ|| Eksen onay etiketlerini içeren grafiğin çizim alanını alır.|
