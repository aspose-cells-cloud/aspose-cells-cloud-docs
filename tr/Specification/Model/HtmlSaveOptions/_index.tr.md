...
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, HtmlSaveOptions
weight: 50
---
...
| Dışa AktarmaHücre Koordinatı| Boolean| Doğru| YANLIŞ|| Dosyayı html'ye kaydederken boş olmayan hücrelerin Excel koordinatının dışa aktarılıp aktarılmayacağını belirtir. Varsayılan değer false'tur. Çıktı html'sini Excel'e aktarmak istiyorsanız lütfen varsayılan değeri koruyun.|
