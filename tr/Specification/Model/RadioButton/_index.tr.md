...
type: docs
url: /tr/specification/model/radiobutton/
description: "Aspose.Cells Bulut modeli spesifikasyonu: RadioButton. Açma, oluşturma, düzenleme, bölme, birleştirme, karşılaştırma ve dönüştürme gibi özelliklerle Excel ve diğer elektronik tablo belgelerini zahmetsizce yönetin"
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, RadioButton
weight: 50
---
## **Radyo düğmesi**
...
|:- |:- |:- |:- |:- |:- |
| Grup Kutusu| Sınıf:GrupBox| Doğru| YANLIŞ|| Bu RadioButton'u içeren GroupBox'u alır.|
| Kontrol Edildi| Boolean| Doğru| YANLIŞ|| Radyo düğmesinin işaretlenip işaretlenmediğini gösterir.|
