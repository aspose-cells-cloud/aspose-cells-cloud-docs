---
title: PutWorksheetArka Grup
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/putworksheetbackground/
description: Çalışma sayfasında arka plan resmini ayarlama
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutWorksheetBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/background,PUT,Çalışma sayfasında arka plan resmini ayarlayın.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PutWorksheetBackground\'>PutWorksheetBackground </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath,string,resim tam dosya adı." >}} 
