...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/assemble,POST,Çeşitli formatlarda dosyalar oluşturmak için veri dosyalarını şablon dosyalarıyla birleştirin.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostAssemble\'>PostAssemble</a>" >}}
