...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,PUT,Çalışma sayfasına bir tarih filtresi uygulayın.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDateFilter \'>PutWorksheetDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,dateTime değerlerinin (Gün, Saat, Dakika, Ay, Saniye, Yıl) nasıl gruplanacağını belirtir." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="yıl,tamsayı,Yıl." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ay,integer,Ay." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="gün,tamsayı,Gün." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="saat,tamsayı,saat." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dakika,tamsayı,dakika." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ikinci,tamsayı,İkinci." >}} 
