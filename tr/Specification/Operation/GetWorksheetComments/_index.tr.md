...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,GET,Çalışma sayfasındaki yorumların açıklamasını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComments\' >Çalışma SayfasıYorumlarını Al</a>" >}}
