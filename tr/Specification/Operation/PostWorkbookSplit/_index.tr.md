...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/split,POST,Çalışma kitabını belirli bir formatla bölün.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit\'>PostWorkbookSplit</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="biçim,dize,Bölünmüş biçim." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dışarıKlasör,dize," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="from,integer,Çalışma sayfası dizinini başlat." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="to,integer,End çalışma sayfası dizini." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" splitNameRule,string,kural adı : sayfa adı newguid" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,dize," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
