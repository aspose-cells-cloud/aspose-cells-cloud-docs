...
type: docs
url: /tr/specification/operation/getchartcategoryaxis/
description: Grafikteki grafik serisi ekseninin açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,GET,Grafikteki grafik serisi ekseninin açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells /#/Charts/GetChartCategoryAxis\'>GetChartCategoryAxis</a>" >}}
