---
title: Yazı GrafikKategoriAxi
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postchartcategoryaxis/
description: Grafikteki grafik kategorisi eksenini güncelleyin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,POST,Grafikteki grafik kategorisi eksenini güncelleyin.,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/PostChartCategoryAxis\'>PostChartCategoryAxis</a>" >}}
