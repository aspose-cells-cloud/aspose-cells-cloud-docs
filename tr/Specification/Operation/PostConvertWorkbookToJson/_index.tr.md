...
type: docs
url: /tr/specification/operation/postconvertworkbooktojson/
description: Excel dosyasını Json dosyalarına dönüştürün
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostConvertWorkbookToJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,Excel dosyasını Json dosyalarına dönüştürün.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
