---
title: Metadat'ı Getir
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/getmetadata/
description: Hücre belge özelliklerini alma
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/get,POST,Hücrelerin belge özelliklerini al.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/GetMetadata\'>GetMetadata</a>" >}}
