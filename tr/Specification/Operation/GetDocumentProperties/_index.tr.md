...
type: docs
url: /tr/specification/operation/getdocumentproperties/
description: Excel dosya özelliklerinin açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetDocumentProperties
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,GET,Excel dosya özelliklerinin açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperties\'>GetDocumentProperties</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,Excel özellik türü." >}} 
