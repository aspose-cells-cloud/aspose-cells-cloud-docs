---
title: Çalışma Sayfası Shap'i Sil
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/deleteworksheetshape/
description: Çalışma sayfasındaki bir şekli silme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, deleteWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},DELETE,Çalışma sayfasındaki bir şekli silin.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ deleteWorksheetShape\'>DeleteWorksheetShape</a>" >}}
