...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Değer, dize, Giriş değeri." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isConverted,boolean,True: uygunsa diğer veri türüne dönüştürülür." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="setStyle,boolean,True: diğer veri türlerine dönüştürürken sayı biçimini hücrenin stiline ayarlayın." >}} 
