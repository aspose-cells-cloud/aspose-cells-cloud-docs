...
type: docs
url: /tr/specification/operation/putinsertworksheetrow/
description: Çalışma sayfasına yeni bir satır ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutInsertWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},PUT,Çalışma sayfasına yeni bir satır ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PutInsertWorksheetRow\'>PutInsertWorksheetRow</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="rowIndex,integer,Yeni satır dizini." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
