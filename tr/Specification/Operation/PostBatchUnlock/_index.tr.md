...
type: docs
url: /tr/specification/operation/postbatchunlock/
description: Belirli eşleşme koşullarını karşılayan dosyaların kilidini toplu olarak açma
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostBatchUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/unlock,POST,Belirli eşleşme koşullarını karşılayan dosyaların kilidini toplu olarak açın.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchUnlock\'>PostBatchUnlock</a>" >}}
