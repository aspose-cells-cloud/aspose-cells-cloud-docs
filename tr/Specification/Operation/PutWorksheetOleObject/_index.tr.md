...
type: docs
url: /tr/specification/operation/putworksheetoleobject/
description: Çalışma sayfasına bir OLE nesnesi ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,PUT,Çalışma sayfasına bir OLE nesnesi ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/PutWorksheetOleObject\'> PutWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="height,integer,oleObject\'in yüksekliği, piksel birimi cinsinden" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="genişlik,integer,oleObject\'in genişliği, piksel birimi cinsinden" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="oleFile,string,OLE dosya adı yolu(tam dosya adı)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="imageFile,string,Resim dosya adı yolu(tam dosya adı)." >}} 
