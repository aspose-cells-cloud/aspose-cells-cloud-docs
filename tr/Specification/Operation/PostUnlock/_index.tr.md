...
type: docs
url: /tr/specification/operation/postunlock/
description: Excel dosyasının kilidini açın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/unlock,POST,Excel dosyanın kilidini açın.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostUnlock\'>PostUnlock</a>" >}}
