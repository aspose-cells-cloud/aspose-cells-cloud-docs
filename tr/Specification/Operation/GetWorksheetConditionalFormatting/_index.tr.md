...
type: docs
url: /tr/specification/operation/getworksheetconditionalformatting/
description: Çalışma sayfasındaki koşullu biçimlendirme açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetConditionalFormatting
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},GET,Çalışma sayfasındaki koşullu biçimlendirme açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings /GetWorksheetConditionalFormatting\'>GetWorksheetConditionalFormatting</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="index,integer,Koşullu biçimlendirme dizini." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
