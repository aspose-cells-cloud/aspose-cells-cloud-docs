---
title: PostDijitalİmza
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postdigitalsignature/
description: Excel dosya dijital imza
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostDigitalSignature
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/digitalsignature,POST,Excel dijital imza dosyası.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostDigitalSignature\'>PostDigitalSignature</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="digitalsignaturefile,string,Dijital imza dosyası yolu, uzantıyla birlikte hem klasörü hem de dosya adını içermelidir." >}} 
