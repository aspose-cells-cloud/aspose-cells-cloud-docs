---
title: Güncelleme SonrasıÇalışma SayfasıCellStyl
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postupdateworksheetcellstyle/
description: Çalışma sayfasındaki hücre adını kullanarak hücre stilini ayarlama
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostUpdateWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,POST,Çalışma sayfasındaki hücre adını kullanarak hücre stilini ayarlayın.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostUpdateWorksheetCellStyle\'>PostUpdateWorksheetCellStyle</a>" >}}
