...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},PUT,Çalışma sayfasına çalışma sayfası sütunları ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PutInsertWorksheetColumns\'>PutInsertWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sütunlar,tamsayı,Sütun sayısı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Diğer çalışma sayfalarındaki referansların güncellenip güncellenmeyeceğini belirtir." >}} 
