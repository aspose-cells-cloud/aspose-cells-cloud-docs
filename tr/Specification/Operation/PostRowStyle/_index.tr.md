...
type: docs
url: /tr/specification/operation/postrowstyle/
description: Formatları çalışma sayfasındaki bir satırın tamamına uygulama
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostRowStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex}/style,POST,Biçimleri çalışma sayfasındaki bir satırın tamamına uygula.,<a href=\'https://apireference.aspose.cloud /cells/#/Cells/PostRowStyle\'>PostRowStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="stil, sınıf: stil, Stil açıklaması." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
