...
type: docs
url: /tr/specification/operation/getworksheetcolumns/
description: Çalışma sayfası sütunlarının açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,Çalışma sayfası sütunlarının açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\' >Çalışma Sayfası Sütunlarını Al</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ofset,integer,Workdook klasörü." >}} 
