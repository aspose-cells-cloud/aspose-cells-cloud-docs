...
type: docs
url: /tr/specification/operation/deleteworksheetpictures/
description: Çalışma sayfasındaki tüm resimleri sil
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilÇalışma SayfasıResimleri
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,Çalışma sayfasındaki tüm resimleri sil.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures\'>DeleteWorksheetPictures </a>" >}}
