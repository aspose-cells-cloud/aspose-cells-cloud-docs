---
title: SilmeÇalışma SayfasıOleObject
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/deleteworksheetoleobjects/
description: Çalışma sayfasındaki tüm OLE nesnelerini silin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilWorksheetOleObjects
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,DELETE,Çalışma sayfasındaki tüm OLE nesnelerini silin.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/DeleteWorksheetOleObjects\'> SilÇalışma SayfasıOleObjects</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="sayfaAdı,string,Çalışma sayfası adı." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
