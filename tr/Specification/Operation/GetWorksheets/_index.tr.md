...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,GET,Bir çalışma kitabındaki çalışma sayfalarının açıklamasını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets\'>GetWorksheets</a>" >}}
