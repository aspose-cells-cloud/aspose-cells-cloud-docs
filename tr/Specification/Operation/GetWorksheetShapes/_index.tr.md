...
type: docs
url: /tr/specification/operation/getworksheetshapes/
description: Çalışma sayfasındaki şekillerin açıklamalarını alma
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetShapes
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,Çalışma sayfasındaki şekillerin açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'> GetWorksheetShapes</a>" >}}
