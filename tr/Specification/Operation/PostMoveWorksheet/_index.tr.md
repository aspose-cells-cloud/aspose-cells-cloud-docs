...
type: docs
url: /tr/specification/operation/postmoveworksheet/
description: Çalışma sayfasını çalışma kitabında taşıma
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostMoveWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/position,POST,Çalışma sayfasını çalışma kitabında taşıyın.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostMoveWorksheet\'>PostMoveWorksheet< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="move,class:worksheetmovingrequest,WorksheetMovingRequest hareketli parametrelerle." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
