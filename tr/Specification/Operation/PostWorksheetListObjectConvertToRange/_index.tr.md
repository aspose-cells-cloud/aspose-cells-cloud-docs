...
type: docs
url: /tr/specification/operation/postworksheetlistobjectconverttorange/
description: Liste nesnesini çalışma sayfasındaki aralığa dönüştürün
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorksheetListObjectConvertToRange
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/ConvertToRange,POST,Liste nesnesini çalışma sayfasındaki aralığa dönüştürün.,<a href=\'https://apireference.aspose.cloud/cells/ #/ListObjects/PostWorksheetListObjectConvertToRange\'>PostWorksheetListObjectConvertToRange</a>" >}}
