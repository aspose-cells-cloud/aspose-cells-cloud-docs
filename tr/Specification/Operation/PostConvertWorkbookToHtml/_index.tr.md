...
type: docs
url: /tr/specification/operation/postconvertworkbooktohtml/
description: Excel dosyasını HTML dosyalarına dönüştürün
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostConvertWorkbookToHtml
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/html,POST,Excel dosyasını HTML dosyaya dönüştürün.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml\'>PostConvertWorkbookToHtml</a>" >}}
