---
title: Çalışma Sayfası Köprüsünü Sil
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/deleteworksheethyperlinks/
description: Çalışma sayfasındaki tüm köprüleri silin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, deleteWorksheetHyperlinks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,DELETE,Çalışma sayfasındaki tüm köprüleri silin.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlinks\'>DeleteWorksheetHyperlinks </a>" >}}
