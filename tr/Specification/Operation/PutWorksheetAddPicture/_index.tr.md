...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,Çalışma sayfasına yeni bir resim ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture\'> PutWorksheetAddPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftRow,integer,Resmin sol üst satırı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftColumn,integer,Resmin sol üst sütunu." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LowerRightRow,integer,Görüntü sağ alt satır." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LowerRightColumn,integer,Görüntü sağ alt sütunu." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="picturePath,string,Resim yolu, eğer resim verisi sağlanmadıysa istek gövdesinde incelenir." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="resim,sınıf:resim,Pictute nesnesi" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
