...
type: docs
url: /tr/specification/operation/putworksheethyperlink/
description: Çalışma sayfasına köprü ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,PUT,Çalışma sayfasına köprü ekle.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink\'>PutWorksheetHyperlink< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="FirstRow,integer,Köprü aralığının ilk satırı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="FirstColumn,integer,Köprü aralığının ilk sütunu." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,Bu köprü aralığındaki satırların sayısı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Bu köprü aralığının sütun sayısı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="adres, dize, Köprünün adresi." >}} 
