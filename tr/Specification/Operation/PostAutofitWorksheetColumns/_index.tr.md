---
title: PostOtomatik SığdırÇalışma SayfasıSütunu
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postautofitworksheetcolumns/
description: Çalışma sayfasındaki sütunları otomatik sığdır
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostAutofitWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitcolumns,POST,Çalışma sayfasındaki sütunları otomatik sığdır.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetColumns\'>PostAutofitWorksheetColumns< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="yalnızcaOtomatik,boolean," >}} 
