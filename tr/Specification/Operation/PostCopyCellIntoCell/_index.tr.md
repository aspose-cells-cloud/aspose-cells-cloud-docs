...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{destCellName}/copy,POST,Verileri bir kaynak hücreden çalışma sayfasındaki bir hedef hücreye kopyalayın.,<a href=\'https://apireference.aspose .cloud/cells/#/Cells/PostCopyCellIntoCell\'>PostCopyCellIntoCell</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="sayfaAdı,string,Hedef çalışma sayfası adı." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="çalışma sayfası,dize,Kaynak çalışma sayfasının adı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hücre adı, dize, Kaynak hücre adı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="satır,integer,Kaynak satır dizini." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sütun,tamsayı,Kaynak sütun dizini." >}} 
