---
title: PostRevers'lar
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postreverse/
description: Excel dosyalarındaki satırları veya sütunları ters çevirin ve çeşitli formatlarda çıktı dosyaları oluşturun
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostReverse
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/reverse,POST,Excel dosyadaki satırları veya sütunları tersine çevirin ve çeşitli formatlarda çıktı dosyaları oluşturun.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostReverse\'>PostReverse</ a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="rotaryType,string,satırlar/sütunlar/her ikisi" >}} 
