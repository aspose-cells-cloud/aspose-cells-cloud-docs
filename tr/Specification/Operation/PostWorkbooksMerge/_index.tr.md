---
title: PostWorkbooksBirleştirme
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postworkbooksmerge/
description: Çalışma kitabını mevcut çalışma kitabıyla birleştirme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorkbooksMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/merge,POST,Bir çalışma kitabını mevcut çalışma kitabıyla birleştirin.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge\'>PostWorkbooksMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mergeWith,string,Birleştirilecek çalışma kitabı." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="birleştirilmişStorageName,string,Depolama adı." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/merge?mergeWith=TestData/In/myDocument.xlsx&folder=TestData/In"
    -X POST 
