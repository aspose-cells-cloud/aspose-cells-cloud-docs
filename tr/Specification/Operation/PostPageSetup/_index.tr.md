...
type: docs
url: /tr/specification/operation/postpagesetup/
description: Çalışma sayfasındaki sayfa düzenini güncelleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostPageSetup
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup,POST,Çalışma sayfasında sayfa düzenini güncelleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/PostPageSetup\'>PostPageSetup </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sayfa Kurulumu, sınıf: sayfa kurulumu, Sayfa Kurulumu Sayfa Yapısı açıklaması." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
