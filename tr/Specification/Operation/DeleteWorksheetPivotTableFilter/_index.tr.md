---
title: Çalışma Sayfası PivotTableFilte Sil
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/deleteworksheetpivottablefilter/
description: PivotTable'da bir pivot filtresini silme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, deleteWorksheetPivotTableFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters/{fieldIndex},DELETE,PivotTable\'da bir pivot filtresini silin.,<a href=\'https://apireference.aspose.cloud /cells/#/PivotTables/DeleteWorksheetPivotTableFilter\'>DeleteWorksheetPivotTableFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="fieldIndex,integer,Belirli bir dizindeki PivotField Nesnesini alır." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
