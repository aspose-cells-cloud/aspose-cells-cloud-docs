...
type: docs
url: /tr/specification/operation/getchartsecondcategoryaxis/
description: Karakterdeki grafiğin ikinci kategori eksenini al
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,GET,Grafiğin ikinci kategori eksenini al,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
