...
type: docs
url: /tr/specification/operation/postworksheettextreplace/
description: Çalışma sayfasındaki eski metni yeni metinle değiştirin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorksheetTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/replaceText,POST,Eski metni çalışma sayfasındaki yeni metinle değiştirin.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextReplace \'>PostWorksheetTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,Değiştirilecek eski metin." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,Değiştirilecek yeni metin." >}} 
