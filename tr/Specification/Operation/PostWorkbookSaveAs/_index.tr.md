...
type: docs
url: /tr/specification/operation/postworkbooksaveas/
description: Excel dosyasını çeşitli formatlarda kaydedin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorkbookSaveAs
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/SaveAs,POST,Excel dosyasını çeşitli formatlarda kaydedin.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostWorkbookSaveAs\'>PostWorkbookSaveAs</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sonucu kaydetmek için yenidosyaadı,string,yenidosyaadı. \'Yenidosyaadı\' hem dosya adını hem de uzantıyı kapsamalıdır." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAutoFitRows,boolean,Çalışma kitabındaki satırların Otomatik Sığdırılıp sığdırılmayacağını gösterir." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAutoFitColumns,boolean,Çalışma kitabındaki sütunların otomatik sığdırılıp sığdırılmayacağını gösterir." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="kaydetmeSeçenekleri,sınıf:saveseçenekler," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
