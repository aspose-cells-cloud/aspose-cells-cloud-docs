...
type: docs
url: /tr/specification/operation/deleteheaderfooter/
description: Çalışma sayfasında üstbilgi ve altbilgiyi temizleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilHeaderFooter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/clearheaderfooter,DELETE,Çalışma sayfasında üstbilgi ve altbilgiyi temizle.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/DeleteHeaderFooter \'>ÜstbilgiAltbilgiyi Sil</a>" >}}
