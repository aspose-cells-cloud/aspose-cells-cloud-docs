---
title: Çalışma Sayfası Karakterini Sil
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,Çalışma sayfasındaki bir grafiği dizine göre silin.,<a href=\'https://apireference.aspose.cloud/cells/#/ Charts/DeleteWorksheetChart\'>DeleteWorksheetChart</a>" >}}
