---
title: PostGrupÇalışma SayfasıSütun
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/group,POST,Çalışma sayfasındaki çalışma sayfası sütunlarını gruplayın.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostGroupWorksheetColumns\'>PostGroupWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="gizle, boolean, sütunların görünür durumu" >}} 
