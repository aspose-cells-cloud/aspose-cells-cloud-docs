...
type: docs
url: /tr/specification/operation/postconvertworkbooktopdf/
description: Excel dosyasını PDF dosyalarına dönüştürün
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostConvertWorkbookToPDF
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pdf,POST,Excel dosyasını PDF dosyaya dönüştürün.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF\'>PostConvertWorkbookToPDF</a>" >}}
