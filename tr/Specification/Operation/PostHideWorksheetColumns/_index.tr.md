...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,Çalışma sayfasındaki çalışma sayfası sütunlarını gizle.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
