...
type: docs
url: /tr/specification/operation/postcopyworksheetcolumns/
description: Verileri kaynak sütunlardan çalışma sayfasındaki hedef sütunlara kopyalama
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostCopyWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/copy,POST,Verileri kaynak sütunlardan çalışma sayfasındaki hedef sütunlara kopyalayın.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetColumns\'>PostCopyWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex,integer,Kaynak sütun dizini" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hedefColumnIndex,integer,Hedef sütun dizini" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sütunNumber,integer,Kopyalanan sütun numarası" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="çalışma sayfası,dize,Hedef çalışma sayfası adı." >}} 
