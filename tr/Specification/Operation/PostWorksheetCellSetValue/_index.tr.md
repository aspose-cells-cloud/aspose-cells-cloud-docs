...
type: docs
url: /tr/specification/operation/postworksheetcellsetvalue/
description: Çalışma sayfasındaki hücre adını kullanarak hücre değerini ayarlayın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorksheetCellSetValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName},POST,Çalışma sayfasındaki hücre adını kullanarak hücre değerini ayarlayın.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PostWorksheetCellSetValue\'>PostWorksheetCellSetValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="değer,dize,Hücre değeri." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,Değer türü." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="formül,dize,hücre formülü" >}} 
