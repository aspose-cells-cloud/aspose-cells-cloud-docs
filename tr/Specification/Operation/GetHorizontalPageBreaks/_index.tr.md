---
title: Yatay Sayfa Sonu Getir
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/gethorizontalpagebreaks/
description: Çalışma sayfasındaki yatay sayfa sonlarının açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetHorizontalPageBreaks
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="GetHorizontalPageBreaks" >}}
{{< blocks/products/cells/docs-title titlemsg="Retrieve descriptions of horizontal page breaks in the worksheet." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,Çalışma sayfasındaki yatay sayfa sonlarının açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks \'>YataySayfaSonlarını Al</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/PageBreaksController/GetHorizontalPageBreaks\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/horizontalpagebreaks?folder=TestData/In"
    -X GET 
