---
title: PutWorkbookArka Grubu
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/putworkbookbackground/
description: Çalışma kitabındaki arka planı ayarlama
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,PUT,Çalışma kitabındaki arka planı ayarlayın.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookBackground\'>PutWorkbookBackground</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath,string,Resmin tam yolu." >}} 
