---
title: PostCellHesaplama
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postcellcalculate/
description: Çalışma sayfasındaki hücre formülünü hesapla
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostCellCalculate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/calculate,POST,Çalışma sayfasındaki hücre formülünü hesapla.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCalculate\'>PostCellCalculate</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="seçenekler,sınıf:hesaplama seçenekleri,Hesaplama Seçenekleri" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
