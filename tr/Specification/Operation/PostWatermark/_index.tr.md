...
type: docs
url: /tr/specification/operation/postwatermark/
description: Excel dosyalarına Metin Filigranı ekleyin ve çeşitli formatlarda çıktı dosyaları oluşturun
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostFiligran
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/watermark,POST,Excel dosyaya Metin Filigranı ekleyin ve çeşitli formatlarda çıktı dosyaları oluşturun.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark\'>PostWatermark</a >" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="metin,dize,arka plan metni." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="renk, dize, örneğin #1032ff" >}} 
