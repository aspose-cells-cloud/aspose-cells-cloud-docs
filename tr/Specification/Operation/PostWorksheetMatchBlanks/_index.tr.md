---
title: PostWorksheetMatchBlank
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postworksheetmatchblanks/
description: Listedeki tüm boş hücreleri eşleştir
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorksheetMatchBlanks
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostWorksheetMatchBlanks" >}}
{{< blocks/products/cells/docs-title titlemsg="Match all blank cells in the list." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchBlanks,POST,Listedeki tüm boş hücreleri eşleştir.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks \'>PostWorksheetMatchBlanks</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/AutoFilterController/PostWorksheetMatchBlanks\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/autoFilter/matchBlanks?fieldIndex=0&folder=TestData/In"
    -X POST 
