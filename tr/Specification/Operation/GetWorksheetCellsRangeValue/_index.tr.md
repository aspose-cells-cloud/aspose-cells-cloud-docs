...
type: docs
url: /tr/specification/operation/getworksheetcellsrangevalue/
description: Belirtilen aralıktaki hücrelerin değerlerini al
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetCellsRangeValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,Belirtilen aralıktaki hücrelerin değerlerini al.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /GetWorksheetCellsRangeValue\'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="namerange,string,Aralık adı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="FirstRow,integer,Aralığın ilk satırının indeksini alır." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="FirstColumn,integer,Aralığın ilk sütununun dizinini alır." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,integer,Aralıktaki satır sayısını döndürür." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ColumnCount,integer,Aralıktaki sütunların sayısını döndürür." >}} 
