...
type: docs
url: /tr/specification/operation/getnamedranges/
description: Çalışma sayfalarındaki aralıkların açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetNamedRanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/ranges,GET,Çalışma sayfalarındaki aralıkların açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges\'>GetNamedRanges</a >" >}}
