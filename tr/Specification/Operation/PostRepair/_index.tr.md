...
type: docs
url: /tr/specification/operation/postrepair/
description: Anormal dosyaları onarın ve çeşitli formatlarda dosyalar oluşturun
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, Onarım Sonrası
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/repair,POST,Anormal dosyaları onarın ve çeşitli formatlarda dosyalar oluşturun.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRepair\'>PostRepair</a>" >}}
