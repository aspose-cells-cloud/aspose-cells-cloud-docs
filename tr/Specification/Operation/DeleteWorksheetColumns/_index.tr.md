---
title: Çalışma Sayfası Sütununu Sil
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},DELETE,Çalışma sayfasındaki çalışma sayfası sütunlarını silin.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetColumns\'>DeleteWorksheetColumns</a>" >}}
