---
title: Yatay Sayfayı KoyBrea
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/puthorizontalpagebreak/
description: Çalışma sayfasına yatay sayfa sonları ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,Çalışma sayfasına yatay sayfa sonları ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >PutHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="hücre adı, dize, Hücre adı" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="satır,tamsayı,Satır dizini, sıfır tabanlı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sütun,tamsayı,Sütun dizini, sıfır tabanlı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,Başlangıç sütunu dizini, sıfır tabanlı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,Son sütun dizini, sıfır tabanlı." >}} 
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/PageBreaksController/PutHorizontalPageBreak\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/horizontalpagebreaks?cellname=A1&row=1&column=1&startColumn=1&endColumn=1&folder=TestData/In"
    -X PUT 
