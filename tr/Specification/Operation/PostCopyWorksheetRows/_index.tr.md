---
title: GönderiKopyalaÇalışma SayfasıSatır
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/copy,POST,Çalışma sayfasındaki belirli satırların tamamındaki verileri ve biçimleri kopyalayın.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetRows\'>PostCopyWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceRowIndex,integer,Kaynak satır dizini" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hedefRowIndex,integer,Hedef satır dizini" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowNumber,integer,Kopyalanan satır numarası" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="çalışma sayfası,dize,Çalışma sayfasının adı." >}} 
