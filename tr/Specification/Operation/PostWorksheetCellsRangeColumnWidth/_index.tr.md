---
title: PostWorksheetCellsRangeColumnWidt
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postworksheetcellsrangecolumnwidth/
description: Belirtilen aralığın sütun genişliğini ayarlayın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorksheetCellsRangeColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/columnWidth,POST,Belirtilen aralığın sütun genişliğini ayarlayın.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeColumnWidth\'>PostWorksheetCellsRangeColumnWidth</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="değer,floating,Bu aralığın sütun genişliğini ayarlar." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="aralık,sınıf:aralık,Aralık Aralık nesnesi." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
