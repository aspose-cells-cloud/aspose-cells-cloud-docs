---
title: Çalışma Sayfası Sonrası Ayrılma
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/unmerge,POST,Çalışma sayfasındaki hücreleri ayır.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge\'> Çalışma Sonrası Sayfayı Ayır</a>" >}}
