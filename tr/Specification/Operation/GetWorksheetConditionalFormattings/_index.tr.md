...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings,GET,Çalışma sayfasındaki koşullu biçimlendirmelerin açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings\' >Çalışma SayfasıKoşullu Biçimlendirmeleri Al</a>" >}}
