...
type: docs
url: /tr/specification/operation/postencryptworkbook/
description: Excel Şifreleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostEncryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,POST,Excel Şifreleme.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostEncryptWorkbook\'>PostEncryptWorkbook</a>" >}}
