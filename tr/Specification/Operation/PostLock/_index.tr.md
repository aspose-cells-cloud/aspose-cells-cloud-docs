...
type: docs
url: /tr/specification/operation/postlock/
description: Excel dosyasını kilitle
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostLock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/lock,POST,Lock Excel dosyaları.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostLock\'>PostLock</a>" >}}
