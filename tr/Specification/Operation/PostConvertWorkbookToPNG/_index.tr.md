...
type: docs
url: /tr/specification/operation/postconvertworkbooktopng/
description: Excel dosyasını PNG dosyalarına dönüştürün
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostConvertWorkbookToPNG
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/png,POST,Excel dosyasını PNG dosyaya dönüştürün.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPNG\'>PostConvertWorkbookToPNG</a>" >}}
