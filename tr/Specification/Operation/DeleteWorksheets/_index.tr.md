...
type: docs
url: /tr/specification/operation/deleteworksheets/
description: Çalışma kitabındaki eşleşen çalışma sayfalarını silin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilÇalışma Sayfaları
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,Çalışma kitabındaki eşleşen çalışma sayfalarını silin.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>DeleteWorksheets</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="eşleşmeKoşulu,sınıf:eşleşmekoşuluisteği," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
