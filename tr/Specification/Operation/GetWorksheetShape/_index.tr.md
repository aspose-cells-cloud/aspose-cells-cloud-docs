...
type: docs
url: /tr/specification/operation/getworksheetshape/
description: Çalışma sayfasındaki şeklin açıklamasını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},GET,Çalışma sayfasındaki şeklin açıklamasını al.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes /GetWorksheetShape\'>GetWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="çalışma sayfası şekillerinde şekil indeksi, tamsayı, şekil indeksi." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
