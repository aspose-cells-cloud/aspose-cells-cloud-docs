---
title: Çalışma Sayfası Resmini Sil
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},DELETE,Çalışma sayfasındaki bir resim nesnesini dizine göre silin.,<a href=\'https://apireference.aspose.cloud/cells/# /Pictures/DeleteWorksheetPicture\'>DeleteWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="resimIndex,tamsayı,Resim dizini." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
