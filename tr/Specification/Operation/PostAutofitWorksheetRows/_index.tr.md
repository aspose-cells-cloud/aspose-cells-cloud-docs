---
title: PostOtomatik SığdırÇalışma SayfasıSatır
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postautofitworksheetrows/
description: Çalışma sayfasındaki satırları otomatik sığdır
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostAutofitWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrows,POST,Çalışma sayfasındaki satırları otomatik sığdır.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows\'>PostAutofitWorksheetRows< /a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="onlyAuto,boolean,Bu çalışma sayfasındaki tüm satırları otomatik olarak sığdırır." >}} 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/autofitrows?startRow=1&endRow=9&onlyAuto=true&folder=TestData/In"
    -X POST 
