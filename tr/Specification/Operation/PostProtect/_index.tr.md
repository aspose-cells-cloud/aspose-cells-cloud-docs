...
type: docs
url: /tr/specification/operation/postprotect/
description: Excel dosya şifreleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostProtect
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/protect,POST,Excel dosya şifreleme.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostProtect\'>PostProtect</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="protectedWorkbookRequest,sınıf:protectworkbookrequest," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
