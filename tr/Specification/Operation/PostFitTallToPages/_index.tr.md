...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup/fittalltopages,POST,Sayfanın sayfaya yazdırıldığında uzun sığacağı ölçeği ayarlayın.,<a href=\'https://apireference.aspose.cloud /cells/#/PageSetup/PostFitTallToPages\'>PostFitTallToPages</a>" >}}
