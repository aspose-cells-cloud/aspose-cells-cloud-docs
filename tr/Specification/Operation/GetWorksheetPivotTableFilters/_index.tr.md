...
type: docs
url: /tr/specification/operation/getworksheetpivottablefilters/
description: Çalışma sayfasında PivotTable filtrelerini alır
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetPivotTableFilters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters,GET,Çalışma sayfasında PivotTable filtrelerini alır.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /GetWorksheetPivotTableFilters\'>GetWorksheetPivotTableFilters</a>" >}}
