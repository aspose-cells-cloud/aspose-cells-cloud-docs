...
type: docs
url: /tr/specification/operation/deleteworksheetcomments/
description: Çalışma sayfasındaki tüm yorumları sil
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilÇalışma SayfasıYorumlar
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,DELETE,Çalışma sayfasındaki tüm yorumları silin.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments\'>DeleteWorksheetComments </a>" >}}
