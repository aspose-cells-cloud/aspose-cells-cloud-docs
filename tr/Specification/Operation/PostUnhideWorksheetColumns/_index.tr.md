...
type: docs
url: /tr/specification/operation/postunhideworksheetcolumns/
description: Çalışma sayfasındaki çalışma sayfası sütunlarını gösterme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostUnhideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,Çalışma sayfasındaki çalışma sayfası sütunlarını göster.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostUnhideWorksheetColumns\'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,İşletilecek başlangıç sütunu dizini." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,İşletilecek sütun sayısı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,Sütun genişliğini karakter birimi cinsinden alır ve ayarlar." >}} 
