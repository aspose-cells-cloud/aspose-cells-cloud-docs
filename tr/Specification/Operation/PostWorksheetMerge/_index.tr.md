---
title: Çalışma Sayfası SonrasıBirleştirme
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/merge,POST,Çalışma sayfasındaki hücreleri birleştir.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge\'> Çalışma Sayfası Sonrası Birleştirme</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="totalRows,integer,Toplam satır sayısı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Toplam sütun sayısı." >}} 
