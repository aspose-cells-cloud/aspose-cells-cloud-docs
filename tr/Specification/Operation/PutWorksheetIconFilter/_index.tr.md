---
title: PutWorksheetIconFilte
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/putworksheeticonfilter/
description: Çalışma sayfasına simge filtresi ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutWorksheetIconFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/iconFilter,PUT,Çalışma sayfasına bir simge filtresi ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetIconFilter \'>PutWorksheetIconFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="iconSetType,string,Simge seti türü." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="iconId,integer,Simge kimliği." >}} 
