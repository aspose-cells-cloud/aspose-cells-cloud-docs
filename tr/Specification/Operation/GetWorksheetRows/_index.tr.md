...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,GET,Çalışma sayfasındaki satırların açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ GetWorksheetRows\'>GetWorksheetRows</a>" >}}
