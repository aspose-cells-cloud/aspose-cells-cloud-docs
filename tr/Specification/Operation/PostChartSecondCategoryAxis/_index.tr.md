---
title: Yazı GrafiğiİkinciKategoriAxi
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postchartsecondcategoryaxis/
description: Grafikteki ikinci kategori eksenini güncelleyin
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,POST,Grafikteki grafik ikinci kategori eksenini güncelleyin.,<a href=\'https://apireference.aspose.cloud/cells/ #/Charts/PostChartSecondCategoryAxis\'>PostChartSecondCategoryAxis</a>" >}}
