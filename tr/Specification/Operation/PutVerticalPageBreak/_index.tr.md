...
type: docs
url: /tr/specification/operation/putverticalpagebreak/
description: Çalışma sayfasına dikey sayfa sonu ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutVerticalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,PUT,Çalışma sayfasına dikey sayfa sonu ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutVerticalPageBreak\' >PutVerticalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow,integer,Başlangıç satırı dizini, sıfır tabanlı." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow,integer,End satır dizini, sıfır tabanlı." >}} 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/Book1.xlsx/worksheets/Sheet1/verticalpagebreaks?cellname=A1&column=1&row=1&startRow=1&endRow=1&folder=TestData/In"
    -X PUT 
