...
type: docs
url: /tr/specification/operation/postpivottablefieldhideitem/
description: PivotTable'da bir pivot alanı öğesini gizleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostPivotTableFieldHideItem
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Hide,POST,PivotTable\'da bir pivot alanı öğesini gizleyin.,<a href=\'https://apireference.aspose.cloud/ hücreler/#/PivotTables/PostPivotTableFieldHideItem\'>PostPivotTableFieldHideItem</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="itemIndex,integer,Pivot alanındaki pivot öğesinin dizini." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isHide,boolean,Belirli PivotItem\'in gizli olup olmadığı (doğru/yanlış)." >}} 
