---
title: Çalışma Sayfasını SilYorum
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/deleteworksheetcomment/
description: Çalışma sayfasındaki hücre yorumunu sil
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilÇalışma SayfasıYorum
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},DELETE,Çalışma sayfasındaki hücre yorumunu sil.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/ deleteWorksheetComment\'>DeleteWorksheetComment</a>" >}}
