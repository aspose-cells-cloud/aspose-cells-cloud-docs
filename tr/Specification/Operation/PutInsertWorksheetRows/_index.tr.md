...
type: docs
url: /tr/specification/operation/putinsertworksheetrows/
description: Çalışma sayfasına birkaç yeni satır ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutInsertWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,PUT,Çalışma sayfasına birkaç yeni satır ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PutInsertWorksheetRows\'>PutInsertWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Diğer çalışma sayfalarındaki güncelleme referanslarının olup olmadığını gösterir." >}} 
