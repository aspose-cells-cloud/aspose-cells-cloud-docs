---
title: Çalışma Kitabı Sonrası Ayarı
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/specification/operation/postworkbooksettings/
description: Çalışma kitabındaki ayarı güncelleştirme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostWorkbookSettings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,Çalışma kitabındaki ayarı güncelleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings\'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ayarlar,sınıf:çalışma kitabı ayarları,Çalışma Kitabı Ayarı açıklaması." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
