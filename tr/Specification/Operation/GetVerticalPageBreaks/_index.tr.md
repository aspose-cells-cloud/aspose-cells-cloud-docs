...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,Çalışma sayfasındaki dikey sayfa sonlarının açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks \'>VerticalPageBreaks\'i Alın</a>" >}}
