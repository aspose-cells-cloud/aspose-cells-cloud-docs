...
type: docs
url: /tr/specification/operation/deleteworksheet/
description: Çalışma kitabındaki bir çalışma sayfasını silme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, SilÇalışma Sayfası
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},DELETE,Çalışma kitabındaki bir çalışma sayfasını silin.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheet\'>DeleteWorksheet</a> a>" >}}
