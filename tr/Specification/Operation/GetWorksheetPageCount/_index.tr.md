...
type: docs
url: /tr/specification/operation/getworksheetpagecount/
description: Çalışma sayfasındaki sayfa sayısını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagecount,GET,Çalışma sayfasındaki sayfa sayısını alın.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetPageCount\'>GetWorksheetPageCount </a>" >}}
