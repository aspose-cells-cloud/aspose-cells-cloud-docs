...
type: docs
url: /tr/specification/operation/postpivottablecellstyle/
description: PivotTable'da hücre stilini güncelleştirme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PostPivotTableCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,PivotTable\'da hücre stilini güncelleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/ PivotTables/PostPivotTableCellStyle\'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sütun,tamsayı,Hücrenin sütun dizini." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="satır,integer,Hücrenin satır dizini." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="stil,sınıf:stil,Stil İstek gövdesindeki stil açıklaması." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
