...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/importdata,POST,Verileri Excel dosyasına aktarın.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostImportData\'>PostImportData</a>" >}}
