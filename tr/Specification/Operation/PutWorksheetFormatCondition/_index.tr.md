...
type: docs
url: /tr/specification/operation/putworksheetformatcondition/
description: Çalışma sayfasına bir biçim koşulu ekleme
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, PutWorksheetFormatCondition
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},PUT,Çalışma sayfasına bir biçim koşulu ekleyin.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings /PutWorksheetFormatCondition\'>PutWorksheetFormatCondition</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,Biçim koşulu türü(CellValue/Expression/ColorScale/DataBar/IconSet/Top10/UniqueValues/DuplicateValues/ContainsText/NotContainsText/BeginsWith/EndsWith/ContainsBlanks/NotContainsBlanks/ContainsErrors/NotContainsErrors/TimePeriod/AboveAverage)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="operType,string,Koşullu formatın operatör türünü ve veri doğrulamayı temsil eder (Between/Equal/GreaterThan/GreaterOrEqual/LessThan/None/NotBetween/NotEqual)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="formül1,dize,Koşullu biçimlendirmeyle ilişkili değer veya ifade." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="formül2,dize,Koşullu biçimlendirmeyle ilişkili değer veya ifade." >}} 
