...
type: docs
url: /tr/specification/operation/getworksheetcellstyle/
description: Çalışma sayfasındaki hücre stili açıklamalarını alın
kwords: Excel, Office, Elektronik Tablo, Cloud REST API, GetWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Açıklama,API referans" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,GET,Çalışma sayfasındaki hücre stili açıklamalarını alın.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/GetWorksheetCellStyle\'>GetWorksheetCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametre Adı,Tip,Açıklama" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="hücreAdı,dize,Hücrenin adı." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
