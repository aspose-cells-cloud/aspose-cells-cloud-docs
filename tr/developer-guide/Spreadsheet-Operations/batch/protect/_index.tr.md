---
title: Toplu Koruma Excel Dosyası
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/batch/protect
keywords: Batch protection of multiple Excel files
description: Aspose.Cells Cloud API, birden fazla excel dosyasının toplu korumasını destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 100
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Toplu Koruma
---
...
------------ | ------------- | ------------- | -------------
 KaynakKlasörü | dize | | [isteğe bağlı]EşleşmeKoşulu | EşleşmeKoşuluİsteği | | [isteğe bağlı]KorumaTürü | dize | | [isteğe bağlı]Parola | dize | | [isteğe bağlı]ÇıkışKlasörü | dize | | [isteğe bağlı]**MatchConditionRequest Özellikleri**

İsim | Tür | Açıklama | Notlar
------------ | ------------- | ------------- | -------------
 RegexPattern | dize | | [isteğe bağlı]FullMatchConditions | dize[]| | [isteğe bağlı][OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/PostProtectConvert) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
