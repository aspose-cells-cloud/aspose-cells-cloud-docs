...
description: Aspose.Cells Cloud REST API boş bir Excel çalışma kitabı nasıl oluşturulur. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 20
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Boş bir Excel çalışma kitabı oluştur
---
Bu REST API, `empty workbook`'i oluşturmayı gösterir.
...
|:- |:- |:- |:- |
|/hücreler/{isim}|KOYMAK|Boş Bir Çalışma Kitabı Oluştur|[ÇalışmaKitabıOluştur](https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate)|
