...
description: Aspose.Cells Cloud REST API, 2 boyutlu dize dizisi verilerini Excel dosyalarına aktarmayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir.
weight: 20
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, 2 Boyutlu Dize Dizisini Excel Çalışma Sayfasına Aktar
---
Bu REST API `import 2 dimension string array data`'i Excel çalışma sayfasına aktarın.

İstek, çok parçalı içeriğe sahip bir HTTP isteğidir (bkz.[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)veya[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). Çok parçalı içeriğin ilk kısmı Import2DimensionStringArrayOption verilerini, ikinci kısmı ise bir veri dosyasını içerir.
...
**İçe Aktar2BoyutDizeDiziSeçeneği**
