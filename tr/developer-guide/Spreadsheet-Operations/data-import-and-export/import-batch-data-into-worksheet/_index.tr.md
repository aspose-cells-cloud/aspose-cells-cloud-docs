...
description: Aspose.Cells Cloud REST API toplu veriyi Excel dosyalarına aktarmayı destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 19
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Toplu Verileri Excel Çalışma Sayfasına Aktar
---
Bu REST API `import batch data`'i Excel çalışma sayfasına aktarın.
...
|Parametre Adı|Tip|Tanım|
|:- |:- |:- |
| DosyaKaynak Türü| sicim| InMemoryFiles/CloudFileSystem/İstekDosyaları|
