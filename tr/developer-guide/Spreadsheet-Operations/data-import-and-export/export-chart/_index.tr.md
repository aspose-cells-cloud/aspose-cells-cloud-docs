...
description: Aspose.Cells Cloud REST API, Excel grafiğini çeşitli biçim dosyalarına aktarmayı destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir.
weight: 20
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Grafik Dışa Aktarma
---
...
|:- |:- |:- |:- |
|/hücreler/dışa aktarma|POSTALAMAK|Excel nesnesini istek içeriğinden bir biçime aktar|[Postİhracat](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
