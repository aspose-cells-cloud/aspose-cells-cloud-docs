...
description: Aspose.Cells Cloud REST API, Excel şeklini çeşitli biçim dosyalarına aktarmayı destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 20
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Dışa Aktarma Şekli
---
...
|:- |:- |:- |:- |
|/hücreler/dışa aktarma|KOYMAK|Excel nesnelerini istek içeriğinden bir biçime aktarın|[Postİhracat](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
