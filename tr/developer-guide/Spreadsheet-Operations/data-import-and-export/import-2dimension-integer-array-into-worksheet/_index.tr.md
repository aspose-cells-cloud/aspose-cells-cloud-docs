...
description: Aspose.Cells Cloud REST API, 2 boyutlu tam sayı dizisi verilerini Excel dosyalarına aktarmayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir.
weight: 20
...
---
Bu REST API `import 2 dimension integer array data`'i Excel çalışma sayfasına aktarın.
