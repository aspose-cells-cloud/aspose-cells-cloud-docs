...
description: Aspose.Cells Cloud REST API, csv verilerini Excel dosyalarına aktarmayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir.
weight: 19
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, CSV Verilerini Excel Çalışma Sayfasına Aktar
---
Bu REST API `import csv data`'i Excel çalışma sayfasına aktarın.
...
|:- |:- |:- |
| AyırıcıDize| sicim||
| SayısalVerileriDönüştür| sicim|doğru/yanlış.|
| İlk Sıra| int||
| İlkSütun| int||
| KaynakDosyası| sicim||
