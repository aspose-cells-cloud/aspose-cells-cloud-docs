---
title: Onarım Excel Dosyası
second_title: Aspose.Cells Cloud Documen
type: docs
linktitle: Onarım Excel Dosyası
...
weight: 39
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Onarım
---
...
Aspose.Cells Cloud Excel Repair, kurulum yapmadan bozuk Excel dosyalarından verileri çevrimiçi olarak kurtarır. Bozuk Excel dosyaları sorun olabilir çünkü onları açamazsınız. Bozuk Excel dosyalarından verileri kurtarmak için Aspose.Cells Cloud Excel Repair Uygulamasını deneyebilirsiniz.
...
| biçim| sicim| sorgu| Çıktı biçimi, Varsayılan değer null'dır, çıktı biçimi giriş dosya biçimine eşittir.|
 ...
 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/LightCells/PostRepair) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
