...
description: Aspose.Cells Cloud REST API excel dosyalarını html dosyalarına dönüştürmeyi destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 100
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel ila HTML
---
Bu REST API, `convert`'e bir elektronik tablo dosyasının html formatlı bir dosyaya dönüştürüldüğünü gösterir.
...
|/hücreler/dönüştür/html|POSTALAMAK|Bir elektronik tabloyu pptx dosyasına dönüştürün.|[PostConvertWorkbookToHtml](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml)|
 ...
 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
