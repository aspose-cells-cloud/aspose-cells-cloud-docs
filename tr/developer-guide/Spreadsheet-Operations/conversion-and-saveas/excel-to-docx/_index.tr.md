...
linktitle: Excel Doc'a
type: docs
url: /trconvert-excel-file-to-docx-file/
keywords: Convert excel files to docx files
description: Aspose.Cells Cloud REST API excel dosyalarını csv dosyalarına dönüştürmeyi destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 90
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Excel'den Docx'e
---
Bu REST API, `convert`'e bir elektronik tablo dosyasını docx formatlı bir dosyaya dönüştürdüğünü gösterir.
...
|:- |:- |:- |:- |
|/hücreler/dönüştür/docx|POSTALAMAK|Bir elektronik tabloyu docx dosyasına dönüştürün.|[PostConvertWorkbookToDocx](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx)|

 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
...
[POST /hücreler/{isim}/kaydet](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs)API, MS Excel dosyasını ek ayarlarla CSV dosyası olarak kaydetmenizi ve sonucu depolama alanına kaydetmenizi sağlar.
