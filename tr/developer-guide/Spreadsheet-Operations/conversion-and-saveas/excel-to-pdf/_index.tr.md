...
description: Aspose.Cells Cloud REST API excel dosyalarını pdf dosyalarına dönüştürmeyi destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 80
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel ila PDF
---
Bu REST API, `convert`'e bir elektronik tablo dosyasını PDF biçimindeki bir dosyaya gösterir.
...
|/hücreler/dönüştür/pdf|POSTALAMAK|Bir elektronik tabloyu PDF dosyasına dönüştürün.|[PostConvertWorkbookToPDF](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF)|
 ...
 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
...
[POST /hücreler/{isim}/kaydet](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) API, MS Excel dosyasını ek ayarlarla PDF dosyası olarak kaydetmenizi ve sonucu depolama alanına kaydetmenizi sağlar.

Bu REST API `convert` excel dosyasını PDF'e kopyalayın.
...
Bu REST API `export` excel dosyasını PDF'e kopyalayın.
