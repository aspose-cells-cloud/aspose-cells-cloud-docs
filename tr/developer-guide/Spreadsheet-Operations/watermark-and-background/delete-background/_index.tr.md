---
title: Excel çalışma kitabındaki arka planı sil
...
description: Aspose.Cells Cloud REST API, Excel çalışma kitabındaki arka planı silmeyi destekler Excel dosyasında. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 170
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma kitabındaki arka planı sil
---
...
|:- |:- |:- |:- |
|/hücreler/{isim}/arka plan|SİLMEK|Excel dosyasındaki arka planı sil|[ÇalışmaKitabıArkaplanınıSil](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground)|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
