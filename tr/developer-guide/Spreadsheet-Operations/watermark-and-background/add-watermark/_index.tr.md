...
description: Aspose.Cells Cloud REST API, Excel dosyaları için su işareti eklemeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 39
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Filigran
---
Bu REST API, Excel dosyalarına `watermark`'in eklenmesini belirtir.
...
| renk| sicim| sorgu||
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
