...
description: Aspose.Cells Cloud REST API Excel çalışma kitabını şifrelemeyi destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 20
...
|:- |:- |:- |:- |
|/hücreler/{isim}/şifreleme|POSTALAMAK|Excel Belgesini Şifrele|[PostEncryptDoküman](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument)|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
