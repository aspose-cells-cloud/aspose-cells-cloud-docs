...
linktitle: Excel Fil'i koruyun
type: docs
url: /tr/protect-excel-file/
aliases: [/protect-excel-workbooks/,/workbook/protect/]
keywords: Protect Excel files
description: Aspose.Cells Cloud REST API Excel dosyalarını korumayı destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 30
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel Çalışma Kitabını Koru
---
Bu REST API, Excel `workbook`'i korur.
...
|Parametre Adı|Tip|Tanım|
|:- |:- |:- |
|koruma|Çalışma KitabıKorumaİsteği||

**Çalışma KitabıKorumaİsteği**

|Parametre Adı|Tip|Tanım|
|:- |:- |:- |
|Koruma Türü|sicim|TÜMÜ/İÇERİKLER/HİÇBİRİ/NESNELER/SENARYOLAR/YAPI/PENCERELER|
|Şifre|sicim||
...
|:- |:- |:- |:- |
|/hücreler/{isim}/koruma|POSTALAMAK|Bir belgeyi koruyun|[PostProtectDocument](https://apireference.aspose.cloud/cells/#/Workbook/PostProtectDocument)|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/PostProtectDocument) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
