---
title: Excel Fil'den sayfa sayısını alın
...
description: Aspose.Cells Cloud REST API, Excel çalışma kitabında sayfa sayısı almayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 10
kwords: Excel, Office Bulut, REST API, E-tablo, PDF, CSV, Json, Markdown, Sayfa sayısını al
---
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
