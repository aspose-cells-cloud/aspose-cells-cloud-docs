...
description: Aspose.Cells Cloud REST API, Excel dosyalarının dahili nesnelerini temizlemeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir.
weight: 39
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Temizle
---
Bu REST API, Excel dosyalarındaki `clear` excel nesnesini gösterir.
...
| nesne türü| sicim| sorgu| duplicaterows/blankcolumns/blankrows/formül/içerik/stil/grafik/yorum/resim/şekil/liste nesnesi/hiperlink/oleobject/pivottable/doğrulama/Arka Plan|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/LightCells/PostClearObjects) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
