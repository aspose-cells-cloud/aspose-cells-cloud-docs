---
title: SaveResult Tas ile Çalışmak
second_title: Aspose.Cells Cloud Documen
type: docs
url: /tr/tasks/save-result/
aliases: [/working-with-saveresult-task/]
keywords: REST API, task, save result, spreadsheets, exce
description: "Cells.Cloud API for Excel çalıştır: sonucu yanıt içeriğine veya bulut depolamaya kaydetmek için görevler desteği"
weight: 50
---
## DİNLENME API
