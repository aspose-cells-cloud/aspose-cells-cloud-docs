---
title: Tüm çalışma sayfası doğrulamalarını bir Excel çalışma sayfasından alın
second_title: Aspose.Cells Cloud Documen
linktitle: al al
type: docs
url: /tr/validations/get-all/
keywords: Get all worksheet validations from an Excel worksheet
description: Aspose.Cells Cloud REST API, tüm çalışma sayfası doğrulamalarının bir Excel çalışma sayfasından alınmasını destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 10
---
Bu REST API, bir Excel çalışma sayfasındaki tüm çalışma sayfası doğrulamalarını almayı belirtir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
