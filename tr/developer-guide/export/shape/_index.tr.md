...
description: Aspose.Cells Cloud REST API, Excel şeklinin çeşitli format dosyalarına dışa aktarılmasını destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 20
---
...
|:- |:- |:- |:- |
|/hücreler/dışa aktarma|KOYMAK|Excel nesnelerini istek içeriğinden bir biçime aktarın|[İhracat Sonrası](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
