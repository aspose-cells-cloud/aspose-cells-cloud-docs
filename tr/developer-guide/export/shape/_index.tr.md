...
description: Aspose.Cells Cloud REST API, Excel şeklinin çeşitli format dosyalarına aktarılmasını destekler. SDK çeşitli geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur
weight: 20
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Dışa Aktarma Şekli
---
...
|:- |:- |:- |:- |
|/hücreler/dışa aktarma|KOYMAK|Excel nesnelerini istek içeriğinden bazı formatlara aktarma|[İhracat Sonrası](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
