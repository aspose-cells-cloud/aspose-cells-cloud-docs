...
description: Aspose Cells Cloud REST API SDK destekli geliştirme dili türleriyle dosya yüklemeyi öğrenin. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 100
---
...
|:- |:- |:- |:- |
| yol| sicim| yol| Dosya adı ve uzantı da dahil olmak üzere karşıya yüklenecek yol, örneğin /file.ext veya /Folder 1/file.ext İçerik çok parçalıysa ve yol dosya adını içermiyorsa, bunları Content-Disposition başlığındaki dosyaadı parametresinden almaya çalışır.|
| dosya| Dosya| form verisi| Yüklenecek dosya|
| depolamaAdı| sicim| sorgu| Depolama adı|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/File/UploadFile) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
