...
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasından köprüleri temizlemeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 40
---
Bu REST API, bir Excel çalışma sayfasında `delete all hyperlinks`'i gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlinks) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
