---
title: CellsObjectOperate kullanarak pivot tabloyla çalışma
...
description: "Cells.Cloud API Excel için: CellsObjectOperate görevini kullanarak pivot tablo oluşturma"
weight: 10
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, CellsObjectOperate görevini kullanarak pivot tabloyla çalışma
---
Bu REST API, hücre nesnesini kullanarak `pivot table`'i oluşturur ve `task`'i çalıştırır.
