...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında ayar aralığı stilini destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur.
weight: 70
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Aralığın Stilini Ayarla
---
## **giriiş**
...
|:- |:- |:- |:- |
|/hücreler/{ad}/çalışma sayfaları/{sayfaAdı}/aralıklar/stil|POSTALAMAK|Adlandırılmış bir aralığın hücre stilini ayarlayın|[PostWorksheetCellsRangeStyle](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeStyle)|
### **cURL Örnek**
