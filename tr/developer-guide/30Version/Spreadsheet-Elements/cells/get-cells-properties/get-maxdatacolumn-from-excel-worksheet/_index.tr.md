---
title: Excel Çalışma Sayfasından MaxDataColumn'u Alın
type: docs
url: /tr/get-maxdatacolumn-from-excel-worksheet/
weight: 70
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel Çalışma Sayfasından MaxDataColumn'u Al
---
Bu REST API, `cellOrMethodName` parametresi `maxdatacolumn` olduğunda Excel dosyasında `maxdatacolumn` alındığını gösterir.
