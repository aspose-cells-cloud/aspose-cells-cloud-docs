---
title: Excel Çalışma Sayfasının Son Hücresini Alın
type: docs
url: /tr/get-last-cell-of-excel-worksheet/
weight: 30
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel Çalışma Sayfasının Son Hücresini Alma
---
Bu REST API, `cellOrMethodName` parametresi `endcell` olduğunda Excel dosyasında `endcell` alındığını gösterir.
