...
---
Bu REST API, `convert`'e bir elektronik tablo dosyasının csv formatlı bir dosyaya dönüştürüldüğünü gösterir.
...
|/hücreler/dönüştür/csv|POSTALAMAK|Bir elektronik tabloyu csv dosyasına dönüştürün.|[PostConvertWorkbookToCSV](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV)|
 ...
 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToCSV) herkesin erişebileceği bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
