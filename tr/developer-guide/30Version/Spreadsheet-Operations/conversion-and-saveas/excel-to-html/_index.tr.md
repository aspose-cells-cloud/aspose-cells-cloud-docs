...
linktitle: Excel HTM'ye
type: docs
url: /tr/convert-excel-file-to-html-file/
aliases: [/convert-excel-file-to-html-in-cloud/,/convert/excel-to-html/]
keywords: Convert excel files to html files
description: Aspose.Cells Cloud REST API, Excel dosyalarını HTML dosyalarına dönüştürmeyi destekler. SDK, Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift gibi çeşitli geliştirme dillerini destekler.
weight: 100
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel ila HTML
---
Bu REST API, `convert`'e bir elektronik tablo dosyasının html formatındaki bir dosyaya dönüştürüldüğünü gösterir.
...
|:- |:- |:- |:- |
|/hücreler/dönüştür/html|POSTALAMAK|Bir elektronik tabloyu pptx dosyasına dönüştürün.|[PostConvertWorkbookToHtml](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml)|

 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml) herkesin erişebileceği bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
