...
description: Aspose.Cells Cloud REST API, Excel dosyasının çeşitli biçimlere aktarılmasını destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur.
weight: 20
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Çalışma Kitabını Dışa Aktar
---
...
|:- |:- |:- |:- |
|/hücreler/dışa aktarma|POSTALAMAK|Excel nesnelerini istek içeriğinden bir biçime aktarın|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
