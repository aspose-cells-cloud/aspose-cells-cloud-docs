---
title: Excel çalışma kutusundaki arka planı silme
second_title: Aspose.Cells Cloud Documen
linktitle: Sil
type: docs
url: /tr/workbook/background/delete/
aliases: [/delete-background-in-workbook/,/workbook/delete-background/]
keywords: Delete background on an Excel workbook
description: Aspose.Cells Cloud REST API, bir Excel dosyasındaki Excel çalışma kitabında arka planı silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 170
---
Bu REST API, bir Excel çalışma kitabındaki arka planı silmeyi gösterir.
...
|:- |:- |:- |:- |
|/hücreler/{isim}/arka plan|SİLMEK|Excel dosyasındaki arka planı silme|[Çalışma KitabıArka Planını Sil](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground)|

 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDecryptDDeleteWorkbookBackgroundocument) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
