---
title: Excel workboo'nun değiştirme parolasını ayarlayın
...
description: Aspose.Cells Cloud REST API, Excel çalışma kitabı için parola değiştirmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 100
---
Bu REST API, belgeyi değişikliklerden korumayı belirtir.
...
| şifre|| vücut| Değişiklik parolası.|
| dosya| sicim| sorgu| Belgenin klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/PutDocumentProtectFromChanges) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
