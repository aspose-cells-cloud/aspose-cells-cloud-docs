---
title: Excel Çalışma Kitabının Değiştirme Parolasını Temizle
...
description: Aspose.Cells Cloud REST API, Excel çalışma kitabında parola silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 110
---
Bu REST API, belgenin değişikliklerden korunmasını belirtir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/DeleteDocumentUnprotectFromChanges) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
