---
title: Excel çalışma kitabında sütunları otomatik sığdırma
...
weight: 90
---
Bu REST API, bir Excel çalışma kitabındaki sütunların otomatik sığdırılacağını belirtir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookColumns) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
