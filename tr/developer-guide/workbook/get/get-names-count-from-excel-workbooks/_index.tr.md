---
title: Excel çalışma kitabından adları alın
second_title: Aspose.Cells Cloud Documen
linktitle: İsim
type: docs
url: /tr/workbook/get/names/
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
