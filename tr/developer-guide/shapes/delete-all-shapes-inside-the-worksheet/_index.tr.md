...
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasındaki tüm şekilleri silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 40
---
Bu REST API, bir Excel çalışma sayfasındaki tüm şekillerin silineceğini belirtir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShapes) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
