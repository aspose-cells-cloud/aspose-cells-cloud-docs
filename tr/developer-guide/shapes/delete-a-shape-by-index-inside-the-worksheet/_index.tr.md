---
title: Excel çalışma sayfasında bir şekli dizine göre silme
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında şekil silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 50
---
Bu REST API, Excel çalışma sayfasındaki bir şekli silmeyi belirtir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShape) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
