---
title: Excel dosyasındaki bir resmi silin
...
description: Aspose.Cells Cloud REST API, Excel dosyasındaki bir resmi silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 50
---
Bu REST API, Excel çalışma sayfasından bir resmi `delete`'e gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPicture) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
