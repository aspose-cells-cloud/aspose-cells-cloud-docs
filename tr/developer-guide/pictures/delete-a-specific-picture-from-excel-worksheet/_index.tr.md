---
title: Excel dosyasındaki bir resmi silme
...
description: Aspose.Cells Cloud REST API, Excel dosyasındaki bir resmin silinmesini destekler. SDK çeşitli geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur
weight: 50
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Excel dosyasındaki resmi silme
---
Bu REST API, `delete`'e Excel çalışma sayfasındaki bir resmi gösterir.
...
| resimIndex| tamsayı| yol| Resim indeksi|
| dosya| sicim| sorgu| Çalışma kitabı klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPicture) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
