---
title: Excel dosyasındaki resmi güncelleyin
...
| resimIndex| tamsayı| yol| Resmin indeksi.|
| resim|| vücut| Resim nesnesi|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
