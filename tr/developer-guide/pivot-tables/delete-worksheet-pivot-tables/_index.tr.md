...
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasındaki tüm pivot tabloları silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 80
---
Bu REST API, çalışma sayfası pivot tablolarını sil anlamına gelir
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTables) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
