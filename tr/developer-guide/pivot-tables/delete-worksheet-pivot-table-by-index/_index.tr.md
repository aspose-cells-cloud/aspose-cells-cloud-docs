---
title: Excel çalışma sayfasındaki bir pivot tabloyu silme
...
description: Aspose.Cells Cloud REST API, Excel dosyasındaki bir pivot tabloyu silmeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 70
---
Bu REST API, dizine göre `delete` çalışma sayfası pivot tablosunu gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTable) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
