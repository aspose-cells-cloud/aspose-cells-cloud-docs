...
weight: 10
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Excel çalışma sayfasında bir pivot tablo alın
---
Bu REST API, çalışma sayfası `pivottable` bilgilerinin dizine göre alındığını gösterir.
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/PivotTables/GetWorksheetPivotTable) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
