---
title: Excel çalışma sayfasındaki bir şekli güncelleyin
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında bir şekli güncellemeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 31
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfasındaki bir şekli güncelle
---
Bu REST API, Excel çalışma sayfasındaki bir şekli güncellemeyi gösterir.
...
| şekil indeksi| tam sayı| yol| çalışma kağıdı şekillerinde şekil dizini.|
| dto|| vücut||
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Shapes/PostWorksheetShape) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
