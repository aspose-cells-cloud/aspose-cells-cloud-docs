...
weight: 60
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Bir Çalışma Sayfasından MergedCell'i Alın
---
Bu REST API, Excel dosyasında `merged cell`'i aldığını gösteriyor.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetMergedCells) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
