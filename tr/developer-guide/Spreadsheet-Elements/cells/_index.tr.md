...
description: "Cells.Bulut API Excel için çalışır: hücreler çalışır"
weight: 100
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Cells
---
...
<div class="row">
    <div class="col-md-6">
        <ul>
            ...
            <li><a href="/cells/tr/calculate-cells-formula/">Cells formülünü hesaplayınız.</a></li>
        </ul>
    </div>
</div>
{{< /tab >}}
...
<div class="row">
    <div class="col-md-6">
        <ul>
            <li><a href="/cells/tr/merge-cells-in-excel-worksheet/">Cells'i Excel Çalışma Kağıdına Birleştir.</a></li>
            <li><a href="/cells/tr/Unmerge Cells in Excel Worksheet/">excel-çalışma-sayfasındaki-hücreleri-ayır.</a></li>
