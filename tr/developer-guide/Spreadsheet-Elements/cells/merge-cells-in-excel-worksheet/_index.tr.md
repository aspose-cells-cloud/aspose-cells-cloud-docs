---
title: Cells'i Excel Çalışma Sayfasına Birleştir
type: docs
url: /tr/merge-cells-in-excel-worksheet/
weight: 110
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Cells'i Excel Çalışma Sayfasında Birleştir
---
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
