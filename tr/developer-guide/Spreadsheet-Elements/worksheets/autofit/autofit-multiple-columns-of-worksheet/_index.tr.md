...
weight: 20
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfasında birden fazla sütunu otomatik olarak sığdır
---
...
| ilkSütun| tam sayı| sorgu| Başlangıç sütun dizini.|
| sonSütun| tam sayı| sorgu| Sütun sonu indeksi.|
