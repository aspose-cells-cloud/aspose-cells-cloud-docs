...
weight: 20
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfası için sayfa düzenini ayarla
---
Bu REST API, `Set page setup for an Excel worksheet`'i göstermektedir.
...
|[sayfaKurulumu](/cells/tr/page-setup) | nesne| vücut| TPage Kurulum açıklaması.|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|

 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/PageSetup/PostPageSetup) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
