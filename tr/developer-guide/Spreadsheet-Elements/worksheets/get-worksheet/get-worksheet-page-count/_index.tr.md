---
title: Excel çalışma sayfasının sayfa sayısını al
second_title: Aspose.Cells Cloud Documen
linktitle: SayfaSayısı
type: docs
url: /tr/worksheets/page-count/
keywords: Get page count on an Excel worksheet
description: Aspose.Cells Cloud REST API, Excel Çalışma Sayfasında sayfa sayısını almayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 10
kwords: Excel, Office Bulut, REST API, E-tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfası için sayfa sayısını al
---
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Worksheets/GetPageCount) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
