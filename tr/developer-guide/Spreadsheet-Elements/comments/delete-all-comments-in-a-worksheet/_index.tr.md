...
description: "Cells.Bulut API Excel için çalışır: yorumları temizle"
weight: 50
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Temizle
---
Bu REST API, çalışma sayfasındaki tüm yorumları sil anlamına gelir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
