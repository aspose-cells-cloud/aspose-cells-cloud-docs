...
description: "Cells.Cloud API Excel için çalıştır: koşul biçimlendirmesini al"
weight: 20
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Koşullu Biçimlendirmeleri Al
---
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
