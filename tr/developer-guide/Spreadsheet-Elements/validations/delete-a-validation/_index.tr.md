---
title: Excel çalışma sayfasındaki bir çalışma sayfası doğrulamasını silin
second_title: Aspose.Cells Cloud Documen
linktitle: Sil
type: docs
url: /tr/validations/delete/
keywords: Delete a worksheet validation on an Excel worksheet
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasındaki bir çalışma sayfası doğrulamasını silmeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 10
...
---
Bu REST API, Excel çalışma sayfasındaki dizine göre bir çalışma sayfası doğrulamasını silmeyi belirtir.
