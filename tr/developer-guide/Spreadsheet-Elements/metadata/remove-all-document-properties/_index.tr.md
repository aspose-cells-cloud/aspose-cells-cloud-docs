...
description: Aspose.Cells Cloud REST API Excel dosyalarından özellikleri silmeyi destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 58
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Tüm Belge Özelliklerini Kaldır
---
Bu REST API, `delete all`'e özel belge özelliklerini ve temiz yerleşik olanları gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperties) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
