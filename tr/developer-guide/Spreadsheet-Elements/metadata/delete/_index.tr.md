...
description: Aspose.Cells Cloud REST API excel dosyalarından meta verileri silmeyi destekler. SDK çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 55
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel dosyalarındaki meta verileri silin.
---
...
| tip| sicim| sorgu| Tümü|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/DeleteMetadata) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
