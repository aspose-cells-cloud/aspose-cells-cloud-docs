...
description: Aspose.Cells Cloud API, Excel çalışma sayfasındaki filtre listesindeki tüm boş hücreleri eşleştirmeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 100
...
---
Bu REST API, `match`'e Excel çalışma sayfasındaki filtre listesindeki tüm `blank cell`'i gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
