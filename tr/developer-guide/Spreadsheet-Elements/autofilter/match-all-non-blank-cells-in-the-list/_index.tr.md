---
title: Excel çalışma sayfasındaki boş olmayan tüm hücreleri eşleştirin
...
description: Aspose.Cells Cloud API, Excel çalışma sayfasındaki filtre listesindeki tüm boş olmayan hücreleri eşleştirmeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 100
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfasındaki tüm boş olmayan hücreleri eşleştir
---
Bu REST API, Excel çalışma sayfasındaki listedeki tüm `not blank cell`'i, `match`'i gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchNonBlanks) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
