---
title: Excel çalışma sayfasındaki sütunları kopyala
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında sütun kopyalamayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 30
...
| dosya| sicim| sorgu| Belge klasörü.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetColumns) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
