...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında sütun gruplandırmasını kaldırmayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 70
...
---
Bu REST API çalışma sayfası sütunlarının gruplandırılmasının kaldırılmasını gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
