---
title: Excel dosyasındaki bir resmi sil
...
description: Aspose.Cells Cloud REST API, Excel dosyasındaki bir resmi silmeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 50
kwords: Excel, Office Bulut, REST API, E-tablo, PDF, CSV, Json, Markdown, Excel dosyasındaki bir resmi sil
---
Bu REST API, `delete`'e Excel çalışma sayfasından bir resmi gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPicture) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
