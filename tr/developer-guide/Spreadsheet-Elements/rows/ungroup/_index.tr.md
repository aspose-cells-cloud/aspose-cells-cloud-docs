...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında satırların gruplandırılmasını kaldırmayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 70
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel Çalışma Sayfasındaki Satırların Grubunu Kaldırma
---
Bu REST API, Excel çalışma sayfasındaki satırların gruplandırılmasının kaldırılmasını belirtir.
...
| ilkindeks| tam sayı| sorgu| İşlem yapılacak ilk satır indeksi.|
| sonIndex| tam sayı| sorgu| İşlem yapılacak son satır indeksi.|
| hepsi| Boolean| sorgu| Tüm satırlar çalıştırılacak mı?|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
