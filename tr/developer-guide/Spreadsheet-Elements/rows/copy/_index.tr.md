---
title: Excel çalışma sayfasındaki satırları kopyala
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında satır kopyalamayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 30
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfasındaki satırları kopyala
---
Bu REST API çalışma sayfası satırlarının kopyalanmasını gösterir.
...
| kaynakSatırDizini| tam sayı| sorgu| Kaynak satır dizini|
| hedefSatırİndeksi| tam sayı| sorgu| Hedef satır dizini|
| satırNumarası| tam sayı| sorgu| Kopyalanan satır numarası|
| çalışma sayfası| sicim| sorgu| çalışma sayfası|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetRows) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
