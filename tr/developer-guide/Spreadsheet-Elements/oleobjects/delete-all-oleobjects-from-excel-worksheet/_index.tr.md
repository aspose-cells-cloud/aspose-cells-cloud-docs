---
title: Excel çalışma sayfasındaki tüm OLE nesnelerini silin
second_title: Aspose.Cells Cloud Documen
linktitle: Temiz
type: docs
url: /tr/oleobjects/clear/
aliases: [/delete-all-oleobjects-from-excel-worksheet/]
keywords: Delete all OLE objects in an Excel worksheet
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasındaki tüm OLE nesnelerini silmeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 60
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Excel çalışma sayfasındaki tüm OLE nesnelerini sil
---
Bu REST API, Excel çalışma sayfasındaki `delete all` OLE nesnesini gösterir.
...
| sayfaAdı| sicim| yol| İbadet sayfasının adı.|
| dosya| sicim| sorgu| Çalışma kitabı klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|

 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/OleObjects/DeleteWorksheetOleObjects) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
