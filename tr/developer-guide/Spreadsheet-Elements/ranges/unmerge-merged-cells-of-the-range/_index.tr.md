---
title: Birleştirilmiş hücrelerin birleştirilmesini kaldır
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasındaki aralığın birleştirilmiş hücrelerinin birleştirilmesini kaldırmayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 20
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Aralığın birleştirilmiş hücrelerini ayır
---
Bu REST API, Excel çalışma sayfasındaki bu aralıktaki birleştirilmiş hücrelerin birleştirilmesinin kaldırılmasını belirtir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeUnmerge) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
