...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında aralık için sütun genişliğini ayarlamayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 74
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Aralık İçindeki Sütunların Genişliklerini Değiştirme
---
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeColumnWidth) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
