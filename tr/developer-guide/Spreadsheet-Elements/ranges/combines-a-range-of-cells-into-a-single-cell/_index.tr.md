...
linktitle: Birleştirmek
type: docs
url: /tr/ranges/merge/
aliases: [/combines-a-range-of-cells-into-a-single-cell/]
keywords: Merge a range of cells into a single cell
description: Aspose.Cells Cloud REST API, bir hücre aralığını Excel çalışma sayfasında tek bir hücreye birleştirmeyi destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir
weight: 20
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeMerge) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
