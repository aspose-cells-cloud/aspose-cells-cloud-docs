---
title: Bir Çalışma Sayfasından Grafik Alanını Alın
type: docs
url: /tr/charts/area/get/
aliases: [/get-chart-area-from-a-worksheet/]
weight: 60
kwords: Excel, Office Bulut, REST API, Elektronik Tablo, PDF, CSV, Json, Markdown, Çalışma Sayfasından Grafik Alanını Al
---
Bu REST API grafik alanı bilgisini al'ı gösterir.
...
<br/>
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
