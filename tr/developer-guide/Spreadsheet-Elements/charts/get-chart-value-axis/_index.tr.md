---
title:  Grafik Değerini Al Axi
type: docs
url: /tr/charts/value-axis/get/
weight: 60
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Grafik Değer Eksenini Al
---
...
| depolamaAdı| sicim| sorgu||
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Charts/GetChartValueAxis) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
