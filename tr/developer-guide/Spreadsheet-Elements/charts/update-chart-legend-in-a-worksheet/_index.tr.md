---
title: Bir Çalışma Sayfasındaki Grafik Efsanesini Güncelle
type: docs
...
---
Bu REST API güncelleme grafik efsanesini gösterir
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Charts/PostWorksheetChartLegend) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
