---
title:  Grafik Kategorisi Axi'yi Al
type: docs
url: /tr/charts/category-axis/get/
weight: 60
kwords: Excel, Office Bulut, REST API, E-Tablo, PDF, CSV, Json, Markdown, Grafik Kategori Eksenini Al
---
...
| depolamaAdı| sicim| sorgu||
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
