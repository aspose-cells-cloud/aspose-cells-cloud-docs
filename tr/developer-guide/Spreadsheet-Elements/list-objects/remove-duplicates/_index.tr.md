---
title: Liste nesnesi yinelenenleri kaldır
...
weight: 20
kwords: Excel, Office Bulut, REST API, E-tablo, PDF, CSV, Json, Markdown, Liste nesnesi yinelenenleri kaldır
---
...
|depolamaAdı|Sicim|Sorgu||
 ...
 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectRemoveDuplicates) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
