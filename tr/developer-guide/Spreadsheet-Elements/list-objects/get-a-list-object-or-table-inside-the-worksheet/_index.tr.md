...
description: Aspose.Cells Cloud REST API, bir liste nesnesini (tablo) bir Excel çalışma sayfasına almayı destekler. SDK, çeşitli geliştirme dillerini destekler. Bunlara Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve swift dahildir.
weight: 9
...
---
Bu REST API, `get`'e indeksle bir liste nesnesi bilgisi gösterir veya `list object`'i Excel çalışma sayfasındaki farklı bir biçim dosyasına dönüştürür.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 The[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ListObjects/GetWorksheetListObject) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
