...
weight: 20
kwords: Excel, Office Bulut, REST API, E-tablo, PDF, CSV, Json, Markdown, Liste nesnesi dilimleyici ekle
---
...
|sütunIndeks|Tam sayı|Sorgu||
|hedefHücreAdı|Sicim|Sorgu||
|dosya|Sicim|Sorgu||
|depolamaAdı|Sicim|Sorgu||

 The[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectInsertSlicer) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
