...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında bir OLE nesnesi almayı destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 10
---
Bu REST API, Excel çalışma sayfasında biçimle `get` ve `OLE object`'i gösterir.
