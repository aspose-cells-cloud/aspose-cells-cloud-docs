...
weight: 80
---
Bu REST API, Excel çalışma sayfasındaki birden fazla satırın silinmesini belirtir.
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
