---
title: Excel çalışma sayfasından satır açıklamasını alın
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında satır bilgilerinin alınmasını destekler. SDK çeşitli geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur
weight: 10
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Excel çalışma sayfasından satır açıklamasını alın
---
Bu REST API, Excel çalışma sayfasındaki satır dizinine göre bir satır verisi almayı belirtir.
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRow) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
