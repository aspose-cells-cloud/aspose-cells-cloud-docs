---
title: Excel Çalışma Sayfasında satırların grubunu çözme
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasında satırların gruplandırılmasını destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 70
---
Bu REST API, bir Excel çalışma sayfasındaki satırların grubunu çözmeyi belirtir.
...
| ilk dizin| tamsayı| sorgu| Çalıştırılacak ilk satır dizini.|
| son dizin| tamsayı| sorgu| Çalıştırılacak son satır dizini.|
| hepsi| mantıksal| sorgu| Tüm sıra çalıştırılacak mı?|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
