---
title: Çalışma Sayfasından Grafik Alma
type: docs
url: /tr/charts/get/
aliases: [/get-chart-from-a-worksheet/]
weight: 10
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Çalışma Sayfasından Grafik Al
---
Bu REST API, grafik bilgisinin alındığını gösterir.
...
| grafikNumarası| tamsayı| yol| Grafik numarası.|
| biçim| sicim| sorgu| Dışa aktarılan dosya formatı.|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChart) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
