---
title: Bir Çalışma Sayfasında Grafik Göstergesini Göster
type: docs
url: /tr/charts/legend/show/
aliases: [/show-chart-legend-in-a-worksheet/]
weight: 100
---
Bu REST API, tablodaki açıklamayı gösterir
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartLegend) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
