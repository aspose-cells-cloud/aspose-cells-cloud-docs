---
title: Çalışma Sayfasından Grafik Alanı Alma
type: docs
url: /tr/charts/area/get/
aliases: [/get-chart-area-from-a-worksheet/]
weight: 60
---
Bu REST API, grafik alanı bilgisi alındığını gösterir.
...
<br/>
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
