---
title: Bir Çalışma Sayfasından Grafik Alanının Doldurma Biçimini Alma
type: docs
url: /tr/charts/chart-area/fill-format/get/
aliases: [/get-fill-format-of-a-chart-area-from-a-worksheet/]
weight: 70
---
Bu REST API, grafik alanı doldurma formatı bilgisinin alındığını gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartAreaFillFormat) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
