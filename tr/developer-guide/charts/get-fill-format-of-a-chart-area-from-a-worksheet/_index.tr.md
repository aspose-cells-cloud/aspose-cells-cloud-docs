---
title: Çalışma Sayfasından Grafik Alanının Dolgu Formatını Alma
type: docs
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartAreaFillFormat) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
