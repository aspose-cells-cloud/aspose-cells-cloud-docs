...
| dateTimeGroupingType| sicim| sorgu||
| yıl| tamsayı| sorgu|0 |
| ay| tamsayı| sorgu|0 |
| gün| tamsayı| sorgu|0 |
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
