---
title: Bir Tarih Filtresini Silme
...
description: Aspose.Cells Bulut API, bir Excel çalışma sayfasında bir tarih filtresinin silinmesini destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
---
Bu REST API, bir Excel çalışma sayfasındaki bir tarih filtresinin silineceğini belirtir.
...
| tarihSaatGruplamaTürü| sicim| sorgu||
| yıl| tamsayı| sorgu|0 |
| ay| tamsayı| sorgu|0 |
| gün| tamsayı| sorgu|0 |
| saat| tamsayı| sorgu|0 |
| dakika| tamsayı| sorgu|0 |
| ikinci| tamsayı| sorgu|0 |
| dosya| sicim| sorgu||
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
