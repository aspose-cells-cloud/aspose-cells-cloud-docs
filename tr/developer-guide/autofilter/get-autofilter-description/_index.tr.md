---
title: Excel çalışma sayfasında bir otomatik filtre alın
second_title: Aspose.Cells Cloud Documen
linktitle: Otomatik filtreleme al
type: docs
url: /tr/autofilter/get/
aliases: [/get-autofilter-description/]
keywords: Gets auto filter description from an Excel worksheet
description: Aspose.Cells Bulut API, bir Excel çalışma sayfasından otomatik filtre açıklaması alır. SDK, geliştirme dillerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 50
---
Bu REST API, bir Excel çalışma sayfasında `auto filter` açıklaması alındığını gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
