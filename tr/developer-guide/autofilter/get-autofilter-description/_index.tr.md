---
title: Excel çalışma sayfasında otomatik filtre alma
second_title: Aspose.Cells Cloud Documen
linktitle: Otomatik filtreyi al
type: docs
url: /tr/autofilter/get/
aliases: [/get-autofilter-description/]
keywords: Gets auto filter description from an Excel worksheet
description: Aspose.Cells Bulut API desteği, Excel çalışma sayfasından otomatik filtre açıklamasını alır. SDK, geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur
weight: 50
---
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
