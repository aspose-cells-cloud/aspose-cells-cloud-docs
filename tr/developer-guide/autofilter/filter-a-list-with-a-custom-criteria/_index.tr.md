...
description: Aspose.Cells Bulut API, Excel çalışma sayfasına özel bir filtre eklenmesini destekler. SDK, geliştirme dillerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 65
---
Bu REST API, bir listeyi `custom criteria` ile filtrelemeyi belirtir.
...
| operatörTip1| sicim| sorgu||
| kriter1| sicim| sorgu||
| ve| mantıksal| sorgu||
| operatörTip2| sicim| sorgu||
| kriter2| sicim| sorgu||
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetCustomFilter) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
