---
title: Excel çalışma kutusunu şifreleme
...
description: Aspose.Cells Cloud REST API, Excel çalışma kitabını şifrelemeyi destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 20
---
Bu REST API, bir Excel `workbook`'i şifreler.
...
|/hücreler/{isim}/şifreleme|POSTALAMAK|Excel Belgesini Şifrele|[PostEncryptDocument](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument)|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
