...
description: "Cells.Cloud API, Excel için çalıştır: bir Excel çalışma kitabını koru"
weight: 60
---
Bu REST API, bir Excel `workbook` korumasını kaldırır.
...
|Parametre adı|Tip|Tanım|
|:- |:- |:- |
|Koruma Türü|sicim|TÜMÜ/ İÇİNDEKİLER/HİÇBİRİ/NESNELER/SENARYOLAR/YAPI/PENCERELER|
|Şifre|sicim||
...
|:- |:- |:- |:- |
|/hücreler/{isim}/koruma|SİLMEK|Bir belgenin korumasını kaldırın|[UnProtectBelgesini Sil](https://apireference.aspose.cloud/cells/#/Workbook/DeleteUnProtectDocument)|

 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Workbook/DeleteUnProtectDocument) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
