...
type: docs
url: /tr/lock/without-using-storage/
...
weight: 70
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Lock
---
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/LightCells/PostLock) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
