...
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasında ayar aralığı değerini destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 72
---
Bu REST API, Aralığa bir değer koyar, uygunsa değer diğer veri tipine dönüştürülür ve hücrenin sayı formatı sıfırlanır.
...
| Dönüştürülür| mantıksal| sorgu| YANLIŞ|
| setStyle| mantıksal| sorgu| YANLIŞ|
| dosya| sicim| sorgu| Çalışma kitabı klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeValue) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
