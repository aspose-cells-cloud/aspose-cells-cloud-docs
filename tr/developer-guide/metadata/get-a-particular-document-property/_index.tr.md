...
weight: 20
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Belirli Bir Belge Özelliği Alma
---
Bu REST API, belge özelliğinin ada göre okunması gerektiğini belirtir.
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
