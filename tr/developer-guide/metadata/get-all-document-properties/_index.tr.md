...
weight: 25
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Tüm Belge Özelliklerini Al
---
Bu REST API, belge özelliklerinin okunacağını belirtir.
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperties) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
