...
linktitle: Depo kullanmadan silin
type: docs
url: /tr/metadata/delete/
keywords: Deleting metadata from Excel files
description: Aspose.Cells Cloud REST API, excel dosyalarından meta verilerin silinmesini destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 55
---
...
| tip| sicim| sorgu| Tümü|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/DeleteMetadata) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
