...
description: Aspose.Cells Cloud REST API, 2 boyutlu tamsayı dizisi verilerinin Excel dosyalarına aktarılmasını destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 20
---
Bu REST API `import 2 dimension integer array data`, Excel çalışma sayfasına.

İstek, çok parçalı içeriğe sahip bir HTTP isteğidir (bkz.[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)veya[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)). Çok parçalı içeriğin ilk bölümü Import2DimensionIntegerArrayOption verilerini içerir ve ikincisi bir veri dosyası içerir.
