---
title: Excel çalışma sayfasındaki bölmeleri çözme
...
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasında bölmelerin çözülmesini destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 200
---
...
| sıra| tamsayı| sorgu||
| kolon| tamsayı| sorgu||
| donmuş satırlar| tamsayı| sorgu||
| donmuş Sütunlar| tamsayı| sorgu||
| dosya| sicim| sorgu||
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetFreezePanes) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
