---
title: Excel çalışma sayfasındaki formülü hesaplayın
...
weight: 20
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Excel çalışma sayfasında formülü hesapla
---
Bu REST API, bir çalışma sayfasında `calculate formula value`'in alındığını gösterir.
...
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetCalculateFormula) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
