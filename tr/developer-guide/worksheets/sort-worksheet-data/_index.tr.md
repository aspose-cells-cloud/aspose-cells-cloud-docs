---
title: Aralık verilerini bir Excel çalışma sayfasında sıralama
...
description: Aspose.Cells Cloud REST API, bir Excel çalışma sayfasındaki sıralama aralığı verilerini destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 20
---
...
| veri sıralayıcı|| vücut| sıralama ayarları ile.|
| dosya| sicim| sorgu| Çalışma kitabı klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetRangeSort) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
