...
description: Aspose.Cells Cloud REST API, bir Excel çalışma kitabında otomatik sığdırma sütunlarını destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 20
---
 Bu REST API, Excel çalışma sayfasında `multiple columns`'in otomatik sığdırılacağını gösterir.
