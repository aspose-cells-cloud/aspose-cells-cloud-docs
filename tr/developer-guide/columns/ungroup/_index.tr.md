---
title: Excel çalışma sayfasındaki sütunların grubunu çözme
...
description: Aspose.Cells Cloud REST API, Excel çalışma sayfasındaki sütunun gruplandırılmasını destekler. SDK çeşitli geliştirme dillerini destekler. Bunlar arasında Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift bulunur
weight: 70
kwords: Excel, Office Cloud, REST API, Elektronik Tablo, PDF, CSV, Json, Markdwon, Excel çalışma sayfasındaki sütunların grubunu çöz
---
Bu REST API çalışma sayfası sütunlarının gruplandırılmasını gösterir.
...
| ilkIndex| tamsayı| sorgu| Çalıştırılacak ilk sütun dizini.|
| LastIndex| tamsayı| sorgu| Çalıştırılacak son sütun dizini.|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|


[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
