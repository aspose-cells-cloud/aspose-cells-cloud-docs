---
title: Excel Çalışma Sayfasındaki Cells'in İçeriğini ve Stillerini Temizle
type: docs
...
| endRow| tamsayı| sorgu| Son sıra.|
| endColumn| tamsayı| sorgu| Son sütun.|
| dosya| sicim| sorgu| Çalışma kitabı klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostClearContents) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
