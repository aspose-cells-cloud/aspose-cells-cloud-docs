---
title: Excel Çalışma Sayfasında Cells Biçimlendirmesini Temizle
type: docs
url: /tr/clear-cells-formatting-in-excel-worksheet/
weight: 100
---
Bu REST API, bir Excel dosyasında `clear` hücre `style`'i gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
