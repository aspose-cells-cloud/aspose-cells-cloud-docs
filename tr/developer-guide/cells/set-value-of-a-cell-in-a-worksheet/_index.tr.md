---
title: Bir Çalışma Sayfasında Bir Hücrenin Değerini Ayarlama
type: docs
url: /tr/set-value-of-a-cell-in-a-worksheet/
weight: 70
---
Bu REST API, bir Excel dosyasında `cell value` ayarını gösterir.
...
| formül| sicim| sorgu| Hücre için formül|
| dosya| sicim| sorgu| Belge klasörü.|
| depolamaAdı| sicim| sorgu| depolama adı.|
 
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetCellSetValue) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
