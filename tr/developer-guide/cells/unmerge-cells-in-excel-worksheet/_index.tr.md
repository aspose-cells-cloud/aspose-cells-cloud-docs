---
title: Cells'i Excel Çalışma Sayfası'ndan ayır
type: docs
url: /tr/unmerge-cells-in-excel-worksheet/
weight: 120
---
Bu REST API, bir Excel dosyasındaki `unmerge` hücreyi gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
