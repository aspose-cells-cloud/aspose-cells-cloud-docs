---
title: Excel Workshee'den MaxDataRow'u edinin
type: docs
url: /tr/get-maxdatarow-from-excel-worksheet/
weight: 50
---
Bu REST API, `cellOrMethodName` parametresi `maxdatarow` olduğunda bir Excel dosyasında `maxdatarow` alındığını gösterir.
