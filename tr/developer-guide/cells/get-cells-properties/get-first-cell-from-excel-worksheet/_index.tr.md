---
title: Excel Çalışma Sayfasından İlk Hücreyi Alın
type: docs
url: /tr/get-first-cell-from-excel-worksheet/
weight: 20
---
Bu REST API, `cellOrMethodName` parametresi `firstcell` olduğunda bir Excel dosyasında `firstcell` alındığını gösterir.
