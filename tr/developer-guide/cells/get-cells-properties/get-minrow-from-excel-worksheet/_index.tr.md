---
title: Excel Çalışma Sayfasından MinRow'u edinin
type: docs
url: /tr/get-minrow-from-excel-worksheet/
weight: 80
---
Bu REST API, `cellOrMethodName` parametresi `minrow` olduğunda bir Excel dosyasında `minrow` alındığını gösterir.
