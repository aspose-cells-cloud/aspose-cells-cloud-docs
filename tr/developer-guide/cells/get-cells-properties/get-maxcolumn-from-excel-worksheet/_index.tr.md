---
title: Excel Workshee'den MaxColumn'u edinin
type: docs
url: /tr/get-maxcolumn-from-excel-worksheet/
weight: 60
---
Bu REST API, `cellOrMethodName` parametresi `maxcolumn` olduğunda bir Excel dosyasında `maxcolumn` alındığını gösterir.
