---
title: Excel Workshee'den MaxDataColumn'u edinin
type: docs
url: /tr/get-maxdatacolumn-from-excel-worksheet/
weight: 70
---
Bu REST API, `cellOrMethodName` parametresi `maxdatacolumn` olduğunda bir Excel dosyasında `maxdatacolumn` alındığını gösterir.
