---
title: Excel Workshee'den MinDataRow'u edinin
type: docs
url: /tr/get-mindatarow-from-excel-worksheet/
weight: 90
---
Bu REST API, `cellOrMethodName` parametresi `mindatarow` olduğunda bir Excel dosyasında `mindatarow` alındığını gösterir.
