...
description: Aspose.Cells Cloud REST API, bir liste nesnesinin (tablonun) Excel çalışma sayfasında aralığa dönüştürülmesini destekler. SDK, geliştirme dili türlerini destekler. Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby ve Swift'i içerir
weight: 30
---
Bu REST API, bir Excel çalışma sayfasında `convert table or list object to range`'i gösterir.
...
| depolamaAdı| sicim| sorgu| depolama adı.|
 ...
 bu[OpenAPI Spesifikasyonu](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectConvertToRange) herkesin erişebileceği bir programlama arabirimi tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
