...
|sütunIndex|Tamsayı|Sorgu||
|destCellName|Sicim|Sorgu||
|dosya|Sicim|Sorgu||
|depolamaAdı|Sicim|Sorgu||



[OpenAPI Spesifikasyonu](https://reference.aspose.cloud/cells/#/ListObjectsController/PostWorksheetListObjectInsertSlicer) herkese açık bir programlama arayüzü tanımlar ve REST etkileşimlerini doğrudan bir web tarayıcısından gerçekleştirmenize olanak tanır.
