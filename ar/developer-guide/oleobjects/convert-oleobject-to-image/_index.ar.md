---
title: تحويل كائن OLE إلى صورة في Excel كائنات العمل
...
description: Aspose.Cells Cloud REST API يدعم المحادثة مع صورة كائن OLE في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 40
---
يشير هذا REST API إلى `get OLE object` بالتنسيق في ورقة عمل Excel.
...
| شكل| خيط| استفسار| تنسيق الكائن الذي تم تصديره.|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/OleObjects/GetWorksheetOleObject) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
