...
description: Aspose.Cells Cloud REST API يدعم تحديث كائن OLE في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 30
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، تحديث كائن OLE في ورقة عمل Excel
---
يشير REST API إلى `update` و`OLE object` في ورقة عمل Excel.
...
| oleObjectIndex| عدد صحيح| طريق| فهرس كائن أولي|
| أولي|| جسم| كائن أوله|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/OleObjects/PostUpdateWorksheetOleObject) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
