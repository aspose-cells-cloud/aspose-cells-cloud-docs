---
title: احصل على فاصل صفحة عمودي
second_title: Aspose.Cells Cloud Documen
linktitle: احصل على فاصل صفحة عمودي
type: docs
...
weight: 20
---
 يشير هذا REST API إلى الحصول على `vertical` فواصل صفحات.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
