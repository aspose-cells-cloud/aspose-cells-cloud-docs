---
title: إضافة فاصل صفحة أفقي
second_title: Aspose.Cells Cloud Documen
linktitle: إضافة فاصل صفحة أفقي
type: docs
...
weight: 30
---
يشير هذا REST API إلى إدخال فاصل صفحة `vertical`.
...
| نهاية العمود| عدد صحيح| استفسار||
| مجلد| خيط| استفسار||
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
