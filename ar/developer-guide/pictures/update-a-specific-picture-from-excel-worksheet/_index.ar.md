...
description: Aspose.Cells Cloud REST API يدعم تحديث صورة في ملف Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 70
kwords: Excel، Office Cloud، REST API، Spreadsheet، PDF، CSV، Json، Markdwon، تحديث الصورة في ملف Excel
---
يشير REST API إلى `update` صورة حسب فهرس الأسعار لورقة عمل Excel.
...
| صورة|| جسم| كائن الصورة|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
