---
title: تحديث الصورة في Excel فيل
...
description: Aspose.Cells Cloud REST API يدعم تحديث صورة في ملف Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 70
---
يشير هذا REST API إلى `update` صورة بواسطة فهرس pricture لورقة عمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/PostWorksheetPicture) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
