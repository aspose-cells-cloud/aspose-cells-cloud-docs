...
description: Aspose.Cells Cloud REST API يدعم إضافة علامة مائية لملفات Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 39
---
يشير هذا REST API إلى إضافة `watermark` على ملفات Excel.
...
| لون| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
