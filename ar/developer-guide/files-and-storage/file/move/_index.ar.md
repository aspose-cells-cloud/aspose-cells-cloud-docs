...
weight: 100
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، نقل الملف
---
يشير REST API إلى `move file`
...
| com.destPath| خيط| استفسار| مسار الملف الوجهة، على سبيل المثال "/dest.ext"|
| srcStorageName| خيط| استفسار| اسم تخزين المصدر|
| destStorageName| خيط| استفسار| اسم تخزين الوجهة|
| معرف الإصدار| خيط| استفسار| معرف إصدار الملف للتحرك|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/File/MoveFile) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
