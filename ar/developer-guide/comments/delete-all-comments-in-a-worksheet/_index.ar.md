...
description: "Cells.Cloud API لـ Excel تعمل: تعليقات واضحة"
weight: 50
---
يشير هذا REST API إلى حذف كافة التعليقات الخاصة بورقة العمل.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
