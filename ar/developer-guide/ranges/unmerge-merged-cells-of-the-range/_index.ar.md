---
title: قم بإلغاء دمج الخلايا المدمجة للنطاق
...
description: Aspose.Cells Cloud REST API يدعم إلغاء دمج الخلايا المدمجة للنطاق في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
---
يشير REST API إلى إلغاء دمج الخلايا المدمجة من هذا النطاق في ورقة عمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeUnmerge) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
