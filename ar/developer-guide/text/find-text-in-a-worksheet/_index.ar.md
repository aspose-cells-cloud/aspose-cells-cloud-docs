---
title: ابحث عن نص في Excel
second_title: Aspose.Cells Cloud Documen
linktitle: تجد في ووركشي
type: docs
...
---
يشير هذا REST API إلى نص `search` في ورقة العمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextSearch) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
