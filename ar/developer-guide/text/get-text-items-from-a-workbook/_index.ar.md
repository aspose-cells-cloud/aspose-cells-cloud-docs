---
title: احصل على عناصر نصية من مجموعة العمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: ادخل إلى ورشة العمل
type: docs
...
description: Aspose.Cells Cloud REST API يدعم الحصول على النص من ورقة العمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، الحصول على عناصر نصية من مصنف Excel
---
يشير REST API إلى `read` المصنف `text items` في المصنف Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
