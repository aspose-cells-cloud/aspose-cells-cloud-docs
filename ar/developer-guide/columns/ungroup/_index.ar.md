---
title: قم بفك تجميع الأعمدة في Excel
...
description: Aspose.Cells Cloud REST API يدعم عمود فك التجميع في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 70
---
يشير هذا REST API إلى فك تجميع أعمدة ورقة العمل.
...
| الفهرس الأول| عدد صحيح| استفسار| سيتم تشغيل فهرس العمود الأول.|
| lastIndex| عدد صحيح| استفسار| فهرس العمود الأخير المراد تشغيله.|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|


 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
