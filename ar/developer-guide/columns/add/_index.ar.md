---
title: أضف عمودًا فارغًا في ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم إضافة عمود في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، إضافة عمود فارغ في ورقة عمل Excel
---
يشير REST API إلى إدراج أعمدة ورقة العمل.
...
| أعمدة| عدد صحيح| استفسار| الاعمدة.|
| updateReference|منطقية| استفسار| حقيقي|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetColumns) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
