---
title: إخفاء الأعمدة في ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم إخفاء العمود في ورقة العمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 40
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، إخفاء الأعمدة في ورقة عمل Excel
---
يشير REST API إلى إخفاء أعمدة ورقة العمل.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostHideWorksheetColumns) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
