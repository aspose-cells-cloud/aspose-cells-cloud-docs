...
description: Aspose.Cells Cloud REST API عمود إخفاء الدعم بورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 40
---
...
| startColumn| عدد صحيح| استفسار| سيتم تشغيل فهرس عمود البداية.|
|إجمالي الأعمدة| عدد صحيح| استفسار| عدد الأعمدة المراد تشغيلها.|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 

 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostHideWorksheetColumns) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
