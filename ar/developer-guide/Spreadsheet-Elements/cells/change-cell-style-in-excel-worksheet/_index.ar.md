...
weight: 30
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تغيير نمط الخلية في ورقة عمل Excel
---
يشير هذا REST API إلى التحديث `cell style` في ملف Excel.
