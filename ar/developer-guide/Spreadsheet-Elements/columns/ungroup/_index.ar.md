---
title: إلغاء تجميع الأعمدة في ورقة العمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: أونغرو
type: docs
url: /ar/columns/ungroup/
...
description: يدعم Cloud REST Aspose.Cells فك تجميع الأعمدة في ورقة عمل Excel. تدعم SDK أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 70
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إلغاء تجميع الأعمدة في ورقة عمل Excel
---
يشير هذا REST API إلى إلغاء تجميع أعمدة ورقة العمل.
...
| الفهرس الأول| عدد صحيح| استفسار|فهرس العمود الأول الذي سيتم تشغيله.|
| الفهرس الأخير| عدد صحيح| استفسار| آخر فهرس العمود الذي سيتم تشغيله.|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|

 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
