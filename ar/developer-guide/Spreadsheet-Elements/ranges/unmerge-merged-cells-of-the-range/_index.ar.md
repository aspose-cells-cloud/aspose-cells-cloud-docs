...
description: يدعم Cloud REST Aspose.Cells إلغاء دمج الخلايا المدمجة في النطاق في ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 20
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إلغاء دمج الخلايا المدمجة في النطاق
---
