---
title: الحصول على تنسيق التعبئة لمنطقة الرسم البياني من ورقة عمل
type: docs
url: /ar/charts/chart-area/fill-format/get/
aliases: [/get-fill-format-of-a-chart-area-from-a-worksheet/]
weight: 70
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، الحصول على تنسيق التعبئة لمنطقة الرسم البياني من ورقة عمل
---
يشير هذا REST API إلى الحصول على معلومات تنسيق تعبئة منطقة الرسم البياني.
