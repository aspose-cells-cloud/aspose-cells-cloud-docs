---
title:  الحصول على فئة الرسم البياني Axi
type: docs
...
| اسم التخزين| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
