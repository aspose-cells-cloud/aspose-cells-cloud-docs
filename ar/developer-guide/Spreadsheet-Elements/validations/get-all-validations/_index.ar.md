---
title: احصل على جميع عمليات التحقق من صحة أوراق العمل من ورقة عمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: احصل على ال
type: docs
url: /ar/validations/get-all/
keywords: Get all worksheet validations from an Excel worksheet
description: يدعم Cloud REST الحصول على جميع عمليات التحقق من صحة أوراق العمل من ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 10
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، احصل على جميع عمليات التحقق من صحة أوراق العمل من ورقة عمل Excel
---
