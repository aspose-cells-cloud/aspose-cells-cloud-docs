...
description: يدعم Cloud REST Aspose.Cells التحقق من صحة ورقة العمل من خلال الفهرس من ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 10
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، الحصول على التحقق من صحة ورقة العمل عن طريق الفهرس من ورقة عمل Excel
---
