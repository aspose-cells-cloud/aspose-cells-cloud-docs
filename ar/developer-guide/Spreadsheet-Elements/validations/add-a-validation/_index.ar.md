...
description: يدعم Cloud REST إضافة التحقق من صحة ورقة العمل على ورقة عمل أخرى. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 10
