...
description: يدعم Cloud REST فرز كائنات القائمة (الجدول) في ورقة عمل. تدعم مجموعة أدوات التطوير (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 40
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، فرز بيانات كائن القائمة في ورقة عمل Excel
---
