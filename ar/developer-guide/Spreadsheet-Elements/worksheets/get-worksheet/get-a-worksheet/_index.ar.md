...
description: يدعم Cloud REST Aspose.Cells تحويل جداول العمل إلى تنسيقات مختلفة عن جداول العمل Excel. تدعم حزمة تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 10
...
| الدقة العمودية| عدد صحيح| استفسار| تعيين الدقة الرأسية للصور المولدة، بوحدة النقاط لكل بوصة.|
