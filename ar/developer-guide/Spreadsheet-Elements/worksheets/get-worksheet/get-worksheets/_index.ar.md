...
description: يدعم Cloud REST Aspose.Cells الحصول على وصف أوراق العمل من مصنف Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 10
