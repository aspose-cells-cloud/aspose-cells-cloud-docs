...
description: يدعم Cloud REST تحديث نمط الخلية لجدول محوري. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 90
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تحديث نمط الخلية لجدول محوري
---
يشير هذا REST API إلى تحديث الخلية `style` لجدول المحور.
...
| فهرس الجدول المحوري| عدد صحيح| طريق| فهرس جدول المحور|
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableCellStyle) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
