...
description: يدعم الإصدار Aspose.Cells Cloud API حذف مرشح التاريخ في ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
