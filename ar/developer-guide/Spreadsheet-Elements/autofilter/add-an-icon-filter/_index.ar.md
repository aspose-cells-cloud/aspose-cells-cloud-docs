...
description: يدعم الإصدار Aspose.Cells Cloud API إضافة مرشح أيقونات إلى ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرمجيات (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 65
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إضافة مرشح أيقونة في ورقة عمل Excel
---
