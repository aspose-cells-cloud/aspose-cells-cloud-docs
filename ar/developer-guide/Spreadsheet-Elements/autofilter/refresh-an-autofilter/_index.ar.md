...
description: يدعم الإصدار Aspose.Cells Cloud API تحديث الفلتر تلقائيًا على ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تحديث مرشح تلقائي في ورقة عمل Excel
---
يشير هذا REST API إلى الفلتر التلقائي `refresh` على ورقة عمل Excel.
