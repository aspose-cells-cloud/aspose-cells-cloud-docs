...
weight: 70
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تحديث الصورة في ملف Excel
---
يشير هذا REST API إلى `update` صورة حسب فهرس الأسعار لورقة عمل Excel.
