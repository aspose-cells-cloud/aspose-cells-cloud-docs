...
description: يدعم Cloud REST حذف جميع الصور في ورقة عمل Aspose.Cells. تدعم SDK أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 60
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، حذف جميع الصور في ورقة عمل Excel
---
يشير هذا REST API إلى `delete` `all` الصور في ورقة العمل.
