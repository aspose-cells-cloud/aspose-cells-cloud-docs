...
description: يدعم Cloud REST إضافة صورة في ملف. تدعم حزمة SDK لغات تطوير متنوعة، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 20
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إضافة صورة في ملف Excel
---
...
| اسم الورقة| خيط| طريق| اسم ورقة العبادة.|
| صورة|| جسم| كائن مصور|
...
| مسار الصورة| خيط| استفسار| مسار الصورة، إذا لم يتم توفير بيانات الصورة، فسيتم فحصها في نص الطلب.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|

 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
