...
description: دعم Cloud REST Aspose.Cells API لتحويل كائن OLE إلى صورة في ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 40
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تحويل كائن OLE إلى صورة في ورقة عمل Excel
---
يشير هذا REST API إلى `get OLE object` بتنسيق في ورقة عمل Excel.
