...
description: Aspose.Cells Cloud REST API يدعم حفظ ملفات Excel كأنواع ملفات التنسيق. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 30
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، SaveAs Excel
---
يشير REST API إلى ملف Excel `save` كملف بتنسيق مختلف.

**معلمة الاستعلام**

|اسم المعلمة|يكتب|وصف|
|:- |:- |:- |
|newfilename|خيط| اسم الملف الجديد|
|com.isAutoFitRows|خيط| خطأ صحيح|
...
|/الخلايا/{name}/saveAs|بريد|تصدير المصنف إلى التنسيق|[PostDocumentSaveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs)|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
