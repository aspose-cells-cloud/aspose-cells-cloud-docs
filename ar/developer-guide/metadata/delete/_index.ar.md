---
title: احذف البيانات الأولية الموجودة على Excel ملف
second_title: Aspose.Cells Cloud Documen
linktitle: احذف بدون استخدام storag
type: docs
url: /ar/metadata/delete/
keywords: Deleting metadata from Excel files
description: Aspose.Cells Cloud REST API يدعم حذف البيانات الأولية من ملفات Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 55
---
يشير هذا REST API إلى حذف `metadata` من عدة ملفات Excel.
...
| يكتب| خيط| استفسار| الجميع|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/DeleteMetadata) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
