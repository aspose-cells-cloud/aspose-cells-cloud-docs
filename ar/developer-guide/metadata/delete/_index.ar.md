...
linktitle: حذف دون استخدام storag
type: docs
url: /ar/metadata/delete/
keywords: Deleting metadata from Excel files
description: Aspose.Cells Cloud REST API يدعم حذف البيانات الوصفية من ملفات Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 55
---
يشير REST API إلى حذف `metadata` من ملفات Excel المتعددة.
...
| يكتب| خيط| استفسار| الجميع|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/DeleteMetadata) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
