---
title: قم بتعيين خصائص وثيقة معينة
...
description: Aspose.Cells Cloud REST API يدعم تحديث الخصائص من ملفات Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 30
---
يشير هذا REST API إلى `set/create` خاصية الوثيقة.
...
| ملكية|| جسم| بقيمة ملكية جديدة.|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Properties/PutDocumentProperty) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
