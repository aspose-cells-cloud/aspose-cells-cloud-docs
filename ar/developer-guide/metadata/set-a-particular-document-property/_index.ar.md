...
description: Aspose.Cells Cloud REST API يدعم تحديث الخصائص من ملفات الاكسل. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 30
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، تعيين خاصية مستند معينة
---
يشير REST API إلى خاصية المستند `set/create`.
...
| اسم الخاصية| خيط| طريق| اسم العقار.|
| ملكية|| جسم| بقيمة عقارية جديدة.|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Properties/PutDocumentProperty) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
