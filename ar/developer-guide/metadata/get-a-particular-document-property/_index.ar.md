---
title: احصل على خصائص وثيقة معينة
...
weight: 20
---
يشير هذا REST API إلى قراءة خاصية الوثيقة بالاسم.
...
| اسم الخاصية| خيط| طريق| اسم الخاصية.|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
