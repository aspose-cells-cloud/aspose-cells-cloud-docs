---
title: احصل على MergedCell من ورقة عمل
type: docs
url: /ar/get-mergedcell-from-a-worksheet/
weight: 60
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، Get MergedCell من ورقة عمل
---
يشير REST API إلى الحصول على `merged cell` في ملف Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetMergedCells) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
