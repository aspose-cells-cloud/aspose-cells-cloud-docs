...
weight: 80
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على MinRow من Excel ورقة عمل
---
يشير REST API إلى الحصول على `minrow` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `minrow`.
