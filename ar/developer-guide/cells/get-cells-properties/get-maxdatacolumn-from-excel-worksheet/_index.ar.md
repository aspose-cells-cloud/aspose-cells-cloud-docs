---
title: احصل على MaxDataColumn من ورقة عمل Excel
type: docs
url: /ar/get-maxdatacolumn-from-excel-worksheet/
weight: 70
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على MaxDataColumn من Excel ورقة عمل
---
يشير REST API إلى الحصول على `maxdatacolumn` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `maxdatacolumn`.
