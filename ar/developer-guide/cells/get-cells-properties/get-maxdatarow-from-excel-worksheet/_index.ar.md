---
title: احصل على MaxDataRow من Excel Workshee
type: docs
url: /ar/get-maxdatarow-from-excel-worksheet/
weight: 50
---
يشير هذا REST API إلى إظهار الحصول على `maxdatarow` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `maxdatarow`.
