---
title: احصل على MaxDataRow من ورقة عمل Excel
type: docs
url: /ar/get-maxdatarow-from-excel-worksheet/
weight: 50
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على MaxDataRow من Excel ورقة عمل
---
يشير REST API إلى الحصول على `maxdatarow` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `maxdatarow`.
