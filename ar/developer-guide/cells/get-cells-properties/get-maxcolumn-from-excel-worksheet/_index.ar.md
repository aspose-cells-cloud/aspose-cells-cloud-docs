---
title: احصل على MaxColumn من Excel Workshee
type: docs
url: /ar/get-maxcolumn-from-excel-worksheet/
weight: 60
---
يشير هذا REST API إلى إظهار الحصول على `maxcolumn` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `maxcolumn`.
