---
title: احصل على MaxColumn من ورقة عمل Excel
type: docs
url: /ar/get-maxcolumn-from-excel-worksheet/
weight: 60
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على MaxColumn من Excel ورقة عمل
---
يشير REST API إلى الحصول على `maxcolumn` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `maxcolumn`.
