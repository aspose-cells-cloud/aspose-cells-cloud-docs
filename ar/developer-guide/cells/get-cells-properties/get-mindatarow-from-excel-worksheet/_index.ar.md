---
title: احصل على MinDataRow من Excel Workshee
type: docs
url: /ar/get-mindatarow-from-excel-worksheet/
weight: 90
---
يشير هذا REST API إلى إظهار الحصول على `mindatarow` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `mindatarow`.
