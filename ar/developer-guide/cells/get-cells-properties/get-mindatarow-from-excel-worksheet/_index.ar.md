---
title: احصل على MinDataRow من ورقة عمل Excel
type: docs
url: /ar/get-mindatarow-from-excel-worksheet/
weight: 90
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على MinDataRow من Excel ورقة عمل
---
يشير REST API إلى الحصول على `mindatarow` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `mindatarow`.
