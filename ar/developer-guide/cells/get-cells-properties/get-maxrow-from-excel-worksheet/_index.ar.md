...
weight: 40
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على MaxRow من Excel ورقة عمل
---
يشير REST API إلى الحصول على `maxrow` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `maxrow`.
