---
title: احصل على الخلية الأخيرة من Excel Workshee
type: docs
url: /ar/get-last-cell-of-excel-worksheet/
weight: 30
---
يشير هذا REST API إلى إظهار الحصول على `endcell` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `endcell`.
