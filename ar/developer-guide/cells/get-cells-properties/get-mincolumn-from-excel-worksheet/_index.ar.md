---
title: احصل على MinColumn من Excel Workshee
type: docs
url: /ar/get-mincolumn-from-excel-worksheet/
weight: 100
---
يشير هذا REST API إلى إظهار الحصول على `mincolumn` في ملف Excel عندما تكون المعلمة `cellOrMethodName` هي `mincolumn`.
