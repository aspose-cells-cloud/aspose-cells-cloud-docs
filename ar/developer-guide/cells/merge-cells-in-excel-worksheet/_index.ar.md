---
title: دمج Cells في Excel ورقة عمل
type: docs
url: /ar/merge-cells-in-excel-worksheet/
weight: 110
kwords: Excel، Office سحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdwon، دمج Cells في Excel ورقة عمل
---
يشير REST API إلى `merge` خلية في ملف Excel.
...
| com.totalRows| عدد صحيح| استفسار| مجموع الصفوف|
| إجمالي الأعمدة| عدد صحيح| استفسار| إجمالي الأعمدة.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
