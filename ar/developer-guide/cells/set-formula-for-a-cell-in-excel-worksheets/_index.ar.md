---
title: قم بتعيين صيغة للخلية في ورقة عمل Excel
type: docs
url: /ar/set-formula-for-a-cell-in-excel-worksheets/
weight: 80
kwords: Excel، Office السحابة، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، تعيين صيغة للخلية في أوراق العمل Excel
---
يشير REST API إلى تعيين `cell formula` في ملف Excel.
...
| معادلة| خيط| استفسار| صيغة للخلية|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetCellSetValue) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
