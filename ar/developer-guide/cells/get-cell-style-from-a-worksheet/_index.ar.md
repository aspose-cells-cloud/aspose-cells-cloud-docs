---
title: احصل على نمط الخلية من ورقة عمل
type: docs
url: /ar/get-cell-style-from-a-worksheet/
weight: 10
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على نمط الخلية من ورقة عمل
---
يشير REST API إلى الحصول على الخلية `style` في ملف Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetCellStyle) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
