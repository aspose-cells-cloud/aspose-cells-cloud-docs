---
title: فك Cells في Excel Workshee
type: docs
...
| إجمالي الصفوف| عدد صحيح| استفسار| الصفوف الإجمالية|
|إجمالي الأعمدة| عدد صحيح| استفسار| مجموع الأعمدة.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetUnmerge) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
