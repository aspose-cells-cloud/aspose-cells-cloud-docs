---
title: مسح التنسيق Cells في ورقة عمل Excel
type: docs
url: /ar/clear-cells-formatting-in-excel-worksheet/
weight: 100
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، Clear Cells التنسيق في Excel ورقة عمل
---
يشير REST API إلى `clear` خلية `style` في ملف Excel.
...
| يتراوح| خيط| استفسار| النطاق.|
| startRow| عدد صحيح| استفسار| صف البداية.|
| startColumn| عدد صحيح| استفسار| عمود البداية.|
| endRow| عدد صحيح| استفسار| صف النهاية.|
| endColumn| عدد صحيح| استفسار| عمود النهاية.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
