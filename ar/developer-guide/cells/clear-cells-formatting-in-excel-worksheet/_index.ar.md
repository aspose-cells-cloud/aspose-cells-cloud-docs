---
title: مسح Cells التنسيق في Excel Workshee
type: docs
url: /ar/clear-cells-formatting-in-excel-worksheet/
weight: 100
---
يشير هذا REST API إلى `clear` خلية `style` في ملف Excel.
...
| نهاية العمود| عدد صحيح| استفسار| عمود النهاية.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
