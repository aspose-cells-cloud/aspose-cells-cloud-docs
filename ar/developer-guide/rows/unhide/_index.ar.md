---
title: إظهار الصفوف في ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم إظهار الصفوف في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 50
kwords: Excel، Office السحابة، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، إظهار الصفوف في ورقة عمل Excel
---
يشير REST API إلى إظهار الصفوف في ورقة عمل Excel.
...
| com.totalRows| عدد صحيح| استفسار| عدد الصفوف التي سيتم تشغيلها.|
| ارتفاع| رقم| استفسار|15.0 |
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetRows) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
