---
title: فك تجميع الصفوف في Excel Workshee
...
description: Aspose.Cells Cloud REST API يدعم فك تجميع الصفوف في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 70
---
يشير هذا REST API إلى فك تجميع الصفوف في ورقة عمل Excel.
...
| هو كل شيء| قيمة منطقية| استفسار| هل كل الصف ليتم تشغيله|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
