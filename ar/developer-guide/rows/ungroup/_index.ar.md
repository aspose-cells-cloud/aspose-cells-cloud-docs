---
title: فك تجميع الصفوف في ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم فك تجميع الصفوف في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 70
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، فك تجميع الصفوف في ورقة عمل Excel
---
يشير REST API إلى فك تجميع الصفوف في ورقة عمل Excel.
...
| هو كل شيء|منطقية| استفسار| هل سيتم تشغيل كل الصف|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
