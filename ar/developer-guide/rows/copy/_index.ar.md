---
title: نسخ الصفوف على Excel workhe
...
description: Aspose.Cells Cloud REST API يدعم نسخ الصفوف بورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 30
---
...
| المصدر| عدد صحيح| استفسار| فهرس صف المصدر|
| الوجهة| عدد صحيح| استفسار|فهرس صف الوجهة|
| رقم الصف| عدد صحيح| استفسار| رقم الصف المنسوخ|
| ورقة عمل| خيط| استفسار| ورقة عمل|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetRows) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
