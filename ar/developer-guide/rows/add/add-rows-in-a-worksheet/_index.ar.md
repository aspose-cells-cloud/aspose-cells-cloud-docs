---
title: إضافة صفوف متعددة في ورقة عمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: صف
type: docs
url: /ar/rows/add/rows/
keywords: Add multi rows on an Excel workshee
description: Aspose.Cells Cloud REST API يدعم إضافة صفوف متعددة في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
kwords: Excel، Office كلاود، ريست API، جدول البيانات، PDF، CSV، Json، Markdwon، إضافة صفوف متعددة في ورقة عمل Excel
---
يشير REST API إلى إضافة عدة صفوف جديدة في ورقة العمل في ورقة عمل Excel.
...
| com.startrow| عدد صحيح| استفسار| مؤشر صف البداية المراد تشغيله.|
| com.totalRows| عدد صحيح| استفسار|1 |
| updateReference|منطقية| استفسار| حقيقي|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRows) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
