...
description: Aspose.Cells Cloud REST API يدعم استيراد بيانات مصفوفة الأعداد الصحيحة ثنائية الأبعاد إلى ملفات Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
---
