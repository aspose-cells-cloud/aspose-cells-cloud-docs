...
linktitle: استيراد البيانات دون تخزين
type: docs
...
يشير REST API إلى `import data` في ملف Excel.
...
**معلمات خيارات استيراد البيانات** موصوفة في[الرابط المرجعي](/cells/ar/import/#import-data-option-parameter).
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostImport) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
