---
title: قم بإضافة عنصر قائمة في Excel كائنات عمل
...
description: Aspose.Cells Cloud REST API يدعم إضافة كائن قائمة (جدول) في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 10
---
...
| نهاية العمود| عدد صحيح| استفسار| صف البداية لنطاق القائمة.|
| hasHeaders| قيمة منطقية| استفسار| حقيقي|
| listObject|| جسم| قائمة الكائن|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/ListObjects/PutWorksheetListObject) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
