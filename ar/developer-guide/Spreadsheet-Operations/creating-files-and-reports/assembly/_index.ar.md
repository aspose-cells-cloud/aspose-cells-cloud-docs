...
description: يُنشئ Aspoe.Cells Cloud تقارير بصيغ XLS وXLSX وXLSM وXLSB وODS باستخدام القالب وورقة البيانات. عالج العلامات الذكية في القالب لملء البيانات من ورقة بيانات أخرى. تدعم حزمة تطوير البرامج (SDK) لغات تطوير متنوعة، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 40
