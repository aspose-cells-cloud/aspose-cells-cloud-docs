...
description: يدعم Cloud REST Aspose.Cells الحصول على الأسماء في مصنف Excel. تدعم SDK أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 120
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، الحصول على الأسماء من مصنف Excel
---
