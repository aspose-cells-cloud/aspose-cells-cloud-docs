...
description: يدعم Cloud REST Aspose.Cells التجهيز التلقائي للصفوف في مصنف Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 90
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، ضبط تلقائي للصفوف في مصنف Excel
---
