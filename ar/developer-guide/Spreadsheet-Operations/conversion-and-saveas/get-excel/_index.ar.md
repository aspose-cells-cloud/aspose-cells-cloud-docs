...
weight: 10
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، يحصل على ملف Excel إلى تنسيقات أخرى
---
...
|isAutoFit|خيط|يُلائم عرض الصفوف والأعمدة في هذا المصنف تلقائيًا. القيمة الافتراضية هي "خطأ".|
