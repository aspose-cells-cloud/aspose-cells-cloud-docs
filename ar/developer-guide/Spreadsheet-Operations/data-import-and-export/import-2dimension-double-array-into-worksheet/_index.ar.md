---
title: استيراد مصفوفة مزدوجة ثنائية الأبعاد إلى ورقة العمل Excel
...
الطلب هو طلب HTTP بمحتوى متعدد الأجزاء (انظر[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)أو[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)يحتوي الجزء الأول من المحتوى متعدد الأجزاء على بيانات Import2DimensionDoubleArrayOption ويحتوي الجزء الثاني على ملف بيانات.
