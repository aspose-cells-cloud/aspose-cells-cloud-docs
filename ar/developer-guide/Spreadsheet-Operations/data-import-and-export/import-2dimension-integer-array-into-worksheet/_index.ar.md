...
linktitle: استيراد أعداد صحيحة ثنائية الأبعاد
type: docs
...
weight: 20
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، استيراد مصفوفة أعداد صحيحة ثنائية الأبعاد إلى ورقة عمل Excel
---
هذه ورقة عمل REST API `import 2 dimension integer array data` في Excel.

الطلب هو طلب HTTP بمحتوى متعدد الأجزاء (انظر[RFC 2046](http://tools.ietf.org/html/rfc2046#page-17)أو[RFC 1341](http://www.w3.org/Protocols/rfc1341/7_2_Multipart.html)يحتوي الجزء الأول من المحتوى متعدد الأجزاء على بيانات Import2DimensionIntegerArrayOption ويحتوي الجزء الثاني على ملف بيانات.
