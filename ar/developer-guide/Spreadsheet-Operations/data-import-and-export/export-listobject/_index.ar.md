...
description: يدعم Cloud REST تصدير كائنات القائمة إلى أنواع مختلفة من ملفات التنسيق. تدعم مجموعة أدوات تطوير البرامج (SDK) لغات تطوير مختلفة، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 20
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تصدير كائن القائمة
---
