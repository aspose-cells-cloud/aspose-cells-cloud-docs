...
description: يدعم Cloud REST استبدال القيم القديمة بالقيم الجديدة في ملفات SDK. تدعم SDK أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 80
