...
description: يدعم Cloud REST دمج ملفات في ملفات أخرى. تدعم مجموعة أدوات تطوير البرامج (SDK) لغات تطوير متنوعة، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 50
...
|:- |:- |:- |:- |
|/الخلايا/{الاسم}/دمج|بريد|دمج Excel مصنفات|[دمج مصنفات ما بعد العمل](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge)|
