...
linktitle: ملف Split Multi Excel
type: docs
url: /ar/split-an-excel-file-to-multi-files/
aliases: [/split-excel-workbooks/,/workbook/split/]
keywords: Split multi Excel files
description: يدعم Cloud REST تقسيم ملفات متعددة. تدعم SDK أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 32
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، Split
---
تشير واجهة برمجة التطبيقات REST هذه إلى الملفات المتعددة `split` Excel.
...
| ل| عدد صحيح| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostSplit) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
