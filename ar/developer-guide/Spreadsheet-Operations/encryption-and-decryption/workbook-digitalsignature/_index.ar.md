...
description: يدعم Cloud REST إضافة توقيع رقمي لمصنف العمل. تدعم مجموعة أدوات تطوير البرامج (SDK) لغات تطوير متنوعة، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 35
