...
description: يدعم Aspose.Cells Cloud API الحماية الدفعية لملفات إكسل متعددة. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 100
