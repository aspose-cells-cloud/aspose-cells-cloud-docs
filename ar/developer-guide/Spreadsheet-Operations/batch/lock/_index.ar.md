...
description: يدعم Aspose.Cells Cloud API قفل الدفعات لملفات إكسل المتعددة. تدعم مجموعة أدوات التطوير (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 100
