...
description: "Cells.Cloud API لـ Excel التشغيل: المهام تدعم استيراد البيانات إلى ملف Excel"
weight: 40
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، العمل مع مهمة ImportData
---
## بقية API
