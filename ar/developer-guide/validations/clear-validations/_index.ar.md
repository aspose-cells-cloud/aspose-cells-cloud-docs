---
title: احذف كافة عمليات التحقق من ورقة العمل الموجودة في Excel
second_title: Aspose.Cells Cloud Documen
linktitle: كليا
type: docs
url: /ar/validations/clear/
keywords: Delete all worksheet validations from an Excel worksheet
description: Aspose.Cells Cloud REST API يدعم حذف كافة عمليات التحقق من صحة ورقة العمل من ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 10
---
يشير هذا REST API إلى حذف كافة عمليات التحقق من صحة ورقة العمل في ورقة عمل Excel.
...
| التحقق من صحة الفهرس| عدد صحيح| طريق| فهرس التحقق.|
| مجلد| خيط| استفسار| مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidation) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
