---
title: حذف كافة عمليات التحقق من صحة ورقة العمل في ورقة عمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: كليا
type: docs
url: /ar/validations/clear/
keywords: Delete all worksheet validations from an Excel worksheet
description: Aspose.Cells Cloud REST API يدعم حذف جميع عمليات التحقق من صحة ورقة العمل من ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 10
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdwon، حذف جميع عمليات التحقق من صحة ورقة العمل في ورقة عمل Excel
---
يشير REST API إلى حذف جميع عمليات التحقق من صحة ورقة العمل في ورقة عمل Excel.
...
| validationIndex| عدد صحيح| طريق| مؤشر التحقق من الصحة.|
| مجلد| خيط| استفسار| مجلد الوثيقة.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidation) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
