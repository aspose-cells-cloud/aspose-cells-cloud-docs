...
description: Aspose.Cells Cloud REST API يدعم الحصول على التحقق من صحة ورقة العمل عن طريق الفهرس من ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 10
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdwon، احصل على التحقق من صحة ورقة العمل حسب الفهرس من ورقة عمل Excel
---
يشير REST API إلى الحصول على التحقق من صحة ورقة العمل عن طريق الفهرس في ورقة عمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidation) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
