---
title: قم بتحديث التحقق من صحة ورقة العمل على Excel ورقة عمل
second_title: Aspose.Cells Cloud Documen
linktitle: تحديث
type: docs
url: /ar/validations/update/
keywords: Delete a worksheet validation on an Excel worksheet
description: Aspose.Cells Cloud REST API يدعم حذف التحقق من صحة ورقة العمل في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 10
---
يشير هذا REST API إلى تحديث التحقق من صحة ورقة العمل بالفهرس في ورقة عمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
