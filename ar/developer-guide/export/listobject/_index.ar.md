---
title: هدف قائمة التصدير
second_title: Aspose.Cells Cloud Documen
linktitle: قائمة Objec
type: docs
url: /ar/export/excel-listobject-to-different-formats/
keywords: Export Excel list object to kinds of format files
description: Aspose.Cells Cloud REST API يدعم تصدير كائن قائمة Excel لأنواع ملفات النسق. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 20
---
...
|:- |:- |:- |:- |
|/ خلايا / تصدير|بريد|تصدير Excel من محتوى الطلب إلى بعض النسق|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
