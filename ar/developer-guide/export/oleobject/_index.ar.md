---
title: تصدير OLE Objec
second_title: Aspose.Cells Cloud Documen
linktitle: OLE Objec
type: docs
url: /ar/export/excel-ole-object/
keywords: Export Excel OLE object to kinds of format files
description: Aspose.Cells Cloud REST API يدعم تصدير عنصر Excel OLE لأنواع ملفات النسق. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 20
---
- **REST API**
...
|:- |:- |:- |:- |
|/ خلايا / تصدير|بريد|تصدير اكسل من طلب المحتوى إلى بعض التنسيق|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
