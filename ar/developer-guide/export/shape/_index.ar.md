---
title: تصدير حالات العسر الشديد
second_title: Aspose.Cells Cloud Documen
linktitle: حالات العسر الشديد
type: docs
url: /ar/export/excel-shape-to-different-formats/
keywords: Export Excel shape to kinds of format files
description: Aspose.Cells Cloud REST API يدعم تصدير شكل Excel لأنواع ملفات التنسيق. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 20
---
...
|:- |:- |:- |:- |
|/ خلايا / تصدير|يضع|تصدير كائنات Excel من طلب المحتوى إلى بعض التنسيق|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
