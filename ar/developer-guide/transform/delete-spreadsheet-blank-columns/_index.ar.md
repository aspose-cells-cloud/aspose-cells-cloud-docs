---
title: Aspose.Cells Cloud Web API - حذف الأعمدة الفارغة في جدول البيانات
second_title: Documen
ArticleTitle: Delete Blank Columns in a Spreadshee
linktitle: حذف العمود الفارغ
type: docs
...
description: حذف جميع الأعمدة الفارغة بكفاءة من جدول بيانات Excel، مما يؤدي إلى تحسين إدارة البيانات وسهولة الاستخدام
weight: 100
kwords: Excel، Office السحابة، جدول البيانات، PDF، CSV، JSON، Markdown، إزالة الأعمدة الفارغة، Excel تنظيف ورقة العمل
---
حذف جميع الأعمدة الفارغة التي لا تحتوي على أي بيانات أو كائنات أخرى من جدول بيانات Excel.

## **حذف أعمدة جدول البيانات الفارغة AP**
...
### حذف الأعمدة الفارغة في جدول البيانات API المواصفات

 ال[حذف الأعمدة الفارغة في جدول البيانات API المواصفات](https://reference.aspose.cloud/cells/#/TransformController/DeleteSpreadsheetBlankColumns) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.

### استخدم Aspose.Cells Cloud SDKs

يعد استخدام SDK أسرع طريقة للتطوير، حيث يقوم بتلخيص التفاصيل منخفضة المستوى، مما يسمح لك بحذف الأعمدة الفارغة في جدول البيانات باستخدام رمز قصير.
