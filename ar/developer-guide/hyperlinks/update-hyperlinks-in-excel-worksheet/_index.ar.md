...
description: Aspose.Cells Cloud REST API يدعم تحديث الارتباط التشعبي في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 30
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، تحديث
---
يشير REST API إلى `update worksheet hyperlink` حسب الفهرس في ورقة عمل Excel.
...
| HyperlinkIndex| عدد صحيح| طريق| فهرس الارتباط التشعبي.|
| ارتباط تشعبي|| جسم| كائن الارتباط التشعبي|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Hypelinks/PostWorksheetHyperlink) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
