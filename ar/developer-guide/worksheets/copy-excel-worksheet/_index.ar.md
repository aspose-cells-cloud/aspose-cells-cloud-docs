...
description: Aspose.Cells Cloud REST API يدعم نسخ المحتويات والتنسيقات من ورقة عمل Excel أخرى. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
kwords: Excel، Office Cloud، REST API، Spreadsheet، PDF، CSV، Json، Markdwon، نسخ المحتويات والتنسيقات من ورقة عمل أخرى.
---
 يشير REST API إلى `copy a worksheet` وحفظه باسم جديد في نفس المصنف
...
| اسم| خيط| طريق||
| اسم الورقة| خيط| طريق||
| sourceSheet| خيط| استفسار||
| خيارات|| جسم||
| sourceWorkbook| خيط| استفسار||
| المجلد المصدر| خيط| استفسار||
| مجلد| خيط| استفسار||
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
