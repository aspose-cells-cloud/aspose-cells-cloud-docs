---
title: قم بإلغاء تجميد الأجزاء على Excel
...
description: Aspose.Cells Cloud REST API يدعم إلغاء تجميد الأجزاء في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 200
---
يشير هذا REST API إلى `unfreeze panes` في ورقة العمل Excel.
...
| مجمدة صفوف| عدد صحيح| استفسار||
| تجميد الأعمدة| عدد صحيح| استفسار||
| مجلد| خيط| استفسار||
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetFreezePanes) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
