---
title: فرز بيانات النطاق على Excel
...
description: Aspose.Cells Cloud REST API يدعم فرز بيانات النطاق في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 20
---
...
| منطقة الخلية| خيط| استفسار| النطاق المطلوب الفرز.|
| فرز البيانات|| جسم| مع إعدادات الفرز.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetRangeSort) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
