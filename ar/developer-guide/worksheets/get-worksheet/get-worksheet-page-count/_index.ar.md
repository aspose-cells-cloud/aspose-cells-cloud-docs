---
title: الحصول على عدد الصفحات لورشة عمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: PageCoun
type: docs
url: /ar/worksheets/page-count/
keywords: Get page count on an Excel worksheet
description: دعم Aspose.Cells Cloud REST API الحصول على عدد الصفحات في ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 10
---
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetPageCount) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
