---
title: احصل على شكل تلقائي من ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم الحصول على الشكل التلقائي بتنسيق مختلف من ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 10
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على شكل تلقائي من ورقة عمل Excel
---
يشير REST API إلى `get autoshape info`.
...
| autoshapeNumber| عدد صحيح| طريق| رقم الشكل التلقائي|
| شكل| خيط| استفسار| التنسيق المُصدَّر.|
| مجلد| خيط| استفسار| مجلد المستندات.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Autoshapes/GetWorksheetAutoshape) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
