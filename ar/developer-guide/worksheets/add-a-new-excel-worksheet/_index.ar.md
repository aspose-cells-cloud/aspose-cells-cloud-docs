...
description: Aspose.Cells Cloud REST API دعم إضافة ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 20
---
...
| اسم الورقة| خيط| طريق| اسم الورقة الجديد.|
| موضع| عدد صحيح| استفسار| موضع الورقة الجديد.|
| نوع الورقة| خيط| استفسار| نوع الورقة الجديد.|
| مجلد| خيط| استفسار|مجلد المستند.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/PutAddNewWorksheet) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
