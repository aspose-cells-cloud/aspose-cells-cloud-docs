---
title: حساب الصيغة في ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم حساب الصيغة في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، حساب الصيغة في ورقة عمل Excel
---
يشير REST API إلى الحصول على `calculate formula value` في ورقة العمل.
...
| معادلة| خيط| استفسار| الصيغة.|
| مجلد| خيط| استفسار| مجلد الوثيقة.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetCalculateFormula) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
