...
description: Aspose.Cells Cloud REST API يدعم فتح Excel ملف. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 70
---
يشير REST API إلى `unlock` Excel ملفًا.
## رسيت API
...
| كلمة المرور| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostUnlock) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
