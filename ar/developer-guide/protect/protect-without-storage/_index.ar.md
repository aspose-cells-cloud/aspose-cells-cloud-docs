...
linktitle: حماية دون استخدام storag
type: docs
...
| حماية WorkbookRequest| فصل| بيانات النموذج| حماية طلب المصنف|
 
 ال[مواصفات OpenAPI](https://reference.aspose.cloud/cells/#/LightCells/PostProtect) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
