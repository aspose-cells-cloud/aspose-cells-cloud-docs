---
title: حماية ملفات Excel دون استخدام التخزين
second_title: Aspose.Cells Cloud Documen
linktitle: تشفير دون استخدام storag
type: docs
...
weight: 40
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, حماية Excel ملفات بدون استخدام التخزين
---
يشير REST API إلى `protect` Excel ملفًا.
...
| كلمة المرور| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostProtect) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
