---
title: أضف شكلاً على Excel وورشة عمل
...
description: Aspose.Cells Cloud REST API يدعم إضافة شكل على ورقة عمل Excel. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 30
---
يشير هذا REST API إلى إضافة شكل على ورقة عمل Excel.
...
| الشكل|| جسم||
| النوع| خيط| استفسار| نوع كائن الشكل|
| topLeftRow| عدد صحيح| استفسار| فهرس الصف العلوي الأيسر.|
| topLeftColumn| عدد صحيح| استفسار| فهرس العمود الأيسر العلوي.|
| قمة| عدد صحيح| استفسار| يمثل الإزاحة الرأسية لـ Spinner من صفه الأيسر ، بوحدة بكسل.|
| غادر| عدد صحيح| استفسار| يمثل الإزاحة الأفقية لـ Spinner من عمودها الأيسر ، بوحدة البكسل.|
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
