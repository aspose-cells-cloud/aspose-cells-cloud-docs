---
title: تطابق جميع الخلايا غير الفارغة في Excel workhe
second_title: Aspose.Cells Cloud Documen
linktitle: تطابق لا فارغة cel
type: docs
...
description: يدعم Aspose.Cells Cloud API مطابقة جميع الخلايا غير الفارغة في قائمة التصفية في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 100
---
يشير هذا REST API إلى `match` الكل `not blank cell` في القائمة في ورقة عمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchNonBlanks) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
