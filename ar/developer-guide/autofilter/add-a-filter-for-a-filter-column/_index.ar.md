---
title: إضافة عامل تصفية في ورقة عمل Excel
...
description: تدعم سحابة Aspose.Cells API إضافة مرشح لعمود مرشح في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 60
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، إضافة عامل تصفية في ورقة عمل Excel
---
يشير REST API إلى إضافة `a filter` لعمود عامل التصفية في ورقة عمل Excel.
...
|اسم التخزين|خيط| استفسار|اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetFilter) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
