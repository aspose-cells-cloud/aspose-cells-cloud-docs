---
title: تطابق جميع الخلايا الفارغة في Excel workhe
second_title: Aspose.Cells Cloud Documen
linktitle: تطابق فارغة cel
type: docs
...
description: يدعم Aspose.Cells Cloud API مطابقة جميع الخلايا الفارغة في قائمة التصفية في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 100
---
يشير هذا REST API إلى `match` الكل `blank cell` في قائمة التصفية في ورقة عمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
