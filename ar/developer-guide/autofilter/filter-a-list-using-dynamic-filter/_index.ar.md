---
title: أضف عامل تصفية التاريخ الديناميكي في ورقة العمل Excel
second_title: Aspose.Cells Cloud Documen
linktitle: إضافة فلتر ديناميكي
type: docs
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDynamicFilter) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
