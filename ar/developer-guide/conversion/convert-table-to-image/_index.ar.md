---
title: Aspose.Cells Cloud Web API - تحويل بيانات جدول بيانات إلى صورة
...
description: تحويل جدول بيانات محلي إلى ملف صورة بكفاءة باستخدام Aspose.Cells Cloud Web API
weight: 100
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، JSON، Markdown، تحويل الجدول إلى صورة، تحويل السحابة، تنسيقات ملفات الصور، تحويل جدول البيانات
---
 تحويل بيانات جدول بيانات محلي/Excel إلى صورة. مدعوم**تنسيقات الصور:** [PNG](https://docs.fileformat.com/image/png/), [SVG](https://docs.fileformat.com/page-description-language/svg/), [TIFF](https://docs.fileformat.com/image/tiff/), [JPEG](https://docs.fileformat.com/image/jpeg/), [BMP](https://docs.fileformat.com/image/bmp/)

## **تحويل الجدول إلى صورة API**
...
|شكل|خيط|استفسار|تنسيق ملف الصورة المطلوب (على سبيل المثال، png، svg).|
|المسار الخارجي|خيط|استفسار|(اختياري) مسار المجلد الذي سيتم تخزين الصورة المُحوّلة فيه. القيمة الافتراضية هي null.|
...
|كلمة المرور|خيط|استفسار|كلمة المرور مطلوبة للوصول إلى ملف جدول البيانات.|
...
## لماذا يجب عليك استخدام تحويل الجدول إلى صورة API؟
...
## كيفية استخدام تحويل الجدول إلى صورة API مع SDKs؟

### تحويل الجدول إلى صورة API المواصفات

 ال[تحويل الجدول إلى صورة API المواصفات](https://reference.aspose.cloud/cells/#/ConversionController/ConvertTableToImage) يوفر واجهة برمجة يمكن الوصول إليها بشكل عام لإجراء تفاعلات REST مباشرة من متصفح الويب.

### استخدم Aspose.Cells Cloud SDKs

يعد استخدام SDK أسرع طريقة للتطوير، حيث إنه يجرد التفاصيل منخفضة المستوى، مما يسمح لك بتحويل بيانات جدول بيانات إلى صورة باستخدام رمز قصير.
