---
title: Aspose.Cells Cloud Web API - تحويل جدول بيانات إلى صورة
...
description: تحويل جدول بيانات من محرك أقراص محلي إلى تنسيقات صور مختلفة بكفاءة باستخدام Aspose.Cells API
weight: 100
kwords: Excel، Office السحابة، REST API، جدول بيانات، تحويل الصور، SVG، PNG، TIFF، الخدمات السحابية، التحويل المحلي إلى السحابة، مطابقة جميع الخلايا الفارغة في ورقة عمل Excel
---
تحويل جدول بيانات محلي/ورقة عمل Excel إلى صورة.

## **تحويل ورقة العمل إلى صورة API**
...
| شكل| خيط| استفسار| صيغة الصورة المطلوبة: svg، png، tiff، إلخ.|
...
### تحويل الجدول إلى صورة API المواصفات
 ...
 ال[تحويل الجدول إلى صورة API المواصفات](https://reference.aspose.cloud/cells/#/ConversionController/ConvertWorksheetToImage) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح بالتفاعلات REST مباشرة من متصفح الويب.
