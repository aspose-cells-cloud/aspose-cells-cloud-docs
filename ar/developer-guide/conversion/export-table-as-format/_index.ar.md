---
title: Aspose.Cells Cloud Web API - تصدير بيانات جدول بيانات إلى ملف تنسيق
second_title: Documen
ArticleTitle: Export a Spreadsheet Table data as a Format file
linktitle: تصدير الجدول إلى صيغة محددة
type: docs
...
description: يحول الجداول بكفاءة من جداول البيانات في التخزين السحابي إلى تنسيقات محددة مختلفة
weight: 100
kwords: تحويل جداول البيانات، PDF، CSV، Excel، JSON، Markdown، تصدير الجدول
---
تصدير جدول بيانات سحابي/Excel إلى ملف بتنسيق آخر.

## **تصدير الجدول بالتنسيق API**
...
|اسم الجدول|خيط|طريق|اسم الجدول.|
|شكل|خيط|استفسار|(مطلوب) التنسيق المطلوب (على سبيل المثال، "png"، "pdf"، "svg").|
...
|المسار الخارجي|خيط|استفسار|(اختياري) مسار المجلد لتخزين المخرجات. الافتراضي هو null.|
|اسم التخزين الخارجي|خيط|استفسار|اسم تخزين ملف الإخراج.|
|الخطوطالموقع|خيط|استفسار|موقع للخطوط المخصصة.|
|منطقة|خيط|استفسار|الإعداد لمنطقة جدول البيانات.|
...
## لماذا يجب عليك استخدام جدول تصدير جدول البيانات بالتنسيق API؟
...
## كيفية استخدام جدول تصدير جدول البيانات بالتنسيق API مع مجموعات تطوير البرامج (SDKs)؟

### تصدير الجدول بالتنسيق API المواصفات

 ال[تصدير الجدول بالتنسيق API المواصفات](https://reference.aspose.cloud/cells/#/ConversionController/ExportTableAsFormat) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.

### استخدم Aspose.Cells Cloud SDKs

يعد استخدام SDK أسرع طريقة للتطوير، حيث إنه يجرد التفاصيل منخفضة المستوى، مما يسمح لك بتصدير بيانات جدول بيانات إلى ملف تنسيق باستخدام رمز قصير.
