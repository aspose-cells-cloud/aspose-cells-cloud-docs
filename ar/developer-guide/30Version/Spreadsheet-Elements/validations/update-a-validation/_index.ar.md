---
title: تحديث التحقق من صحة ورقة العمل على ورقة العمل Excel
second_title: Documen
linktitle: تحديث
type: docs
url: /ar/validations/update/
keywords: Delete a worksheet validation on an Excel worksheet
description: يدعم Cloud REST حذف بيانات التحقق من صحة ورقة العمل. تدعم حزمة تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 10
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، تحديث التحقق من صحة ورقة العمل على ورقة عمل Excel
---
يشير هذا REST API إلى تحديث التحقق من صحة ورقة العمل بواسطة الفهرس على ورقة العمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/WorksheetValidations/PostWorksheetValidation) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
