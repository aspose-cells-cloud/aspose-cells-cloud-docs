...
weight: 10
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إضافة كائن قائمة في ورقة عمل Excel
---
يشير هذا REST API إلى `add a list object(table)` في ورقة العمل Excel.
...
| صف البداية| عدد صحيح| استفسار| الصف الأول لنطاق القائمة.|
| عمود البداية| عدد صحيح| استفسار| الصف الأول لنطاق القائمة.|
| صف النهاية| عدد صحيح| استفسار| الصف الأول لنطاق القائمة.|
| عمود النهاية| عدد صحيح| استفسار| الصف الأول لنطاق القائمة.|
