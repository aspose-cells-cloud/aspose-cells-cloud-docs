---
title:  احصل على مخطط الفئة الثانية Axi
type: docs
...
| اسم التخزين| خيط| استفسار||
 ...
 نسخة محور الفئة الثانية لمخطط Tget[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondCategoryAxis) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
