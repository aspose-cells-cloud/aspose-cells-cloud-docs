---
title: الحصول على منطقة الرسم البياني من ورقة العمل
type: docs
url: /ar/charts/area/get/
aliases: [/get-chart-area-from-a-worksheet/]
weight: 60
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، الحصول على منطقة الرسم البياني من ورقة عمل
---
يشير هذا REST API إلى الحصول على معلومات منطقة الرسم البياني.
...
<br/>
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
