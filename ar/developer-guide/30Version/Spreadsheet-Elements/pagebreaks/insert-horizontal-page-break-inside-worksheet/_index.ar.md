---
title: إضافة فواصل الصفحات الأفقية
second_title: Documen
linktitle: إضافة فواصل الصفحات الأفقية
type: docs
...
weight: 30
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إضافة فاصل صفحات أفقي
---
يشير هذا REST API إلى إدراج فاصل الصفحة `vertical`.
...
| عمود البداية| عدد صحيح| استفسار||
| عمود النهاية| عدد صحيح| استفسار||
| مجلد| خيط| استفسار||
| اسم التخزين| خيط| استفسار| اسم التخزين.|

 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
