...
description: يدعم Cloud REST Aspose.Cells فك تجميع الأعمدة في ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 70
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إلغاء تجميع الأعمدة في ورقة عمل Excel
---
