...
description: يدعم الإصدار Aspose.Cells Cloud API مطابقة جميع الخلايا غير الفارغة في قائمة المرشحات على ورقة عمل Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 100
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdown، مطابقة جميع الخلايا غير الفارغة في ورقة عمل Excel
---
يشير هذا REST API إلى `match` كل `not blank cell` في القائمة الموجودة في ورقة العمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchNonBlanks) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
