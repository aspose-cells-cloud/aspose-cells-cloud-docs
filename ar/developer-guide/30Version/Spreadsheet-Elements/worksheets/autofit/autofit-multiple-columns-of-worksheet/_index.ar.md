...
weight: 20
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdown، ملاءمة تلقائية لأعمدة متعددة في ورقة عمل Excel
---
يشير هذا REST API إلى الملاءمة التلقائية `multiple columns` في ورقة عمل Excel.
