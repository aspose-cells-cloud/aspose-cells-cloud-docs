---
title: حذف صف في ورقة عمل Excel
...
weight: 80
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، حذف صف في ورقة عمل Excel
---
يشير هذا REST API إلى حذف صف في ورقة العمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRow) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
...
يوضح هذا المثال كيفية حذف صف من ورقة عمل Excel باستخدام Aspose.Cells Cloud API في تطبيقاتك. يمكنك استخدام REST API مع أي لغة: .NET، Java، PHP، Ruby، Rails، Python، jQuery، وغيرها الكثير.

## **API معلومات**

|**API**|**يكتب**|**وصف**|**رابط المورد**|
|:- |:- |:- |:- |
|/الخلايا/{الاسم}/أوراق العمل/{اسم الورقة}/الخلايا/الصفوف|بريد|حذف الصفوف من ورقة العمل Excel|[حذف صفوف ورقة العمل](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows)|
