---
title: إظهار الصفوف في ورقة العمل Excel
...
description: يدعم Cloud REST Aspose.Cells إظهار الصفوف في ورقة عمل Excel. تدعم SDK أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 50
kwords: Excel، Office Cloud، REST API، جدول بيانات، PDF، CSV، Json، Markdown، إظهار الصفوف في ورقة عمل Excel
---
يشير هذا REST API إلى إظهار الصفوف الموجودة في ورقة العمل Excel.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetRows) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
