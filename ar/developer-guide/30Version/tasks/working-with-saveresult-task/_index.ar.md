...
description: "Cells.Cloud API لتشغيل Excel: تدعم المهام حفظ النتيجة في محتوى الاستجابة أو التخزين السحابي"
weight: 50
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، العمل مع مهمة SaveResult
---
## الباقي API
