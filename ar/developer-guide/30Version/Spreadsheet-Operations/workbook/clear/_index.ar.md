...
description: يدعم Cloud REST Aspose.Cells مسح الكائنات الداخلية للملفات Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 39
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، مسح
---
يشير هذا REST API إلى كائن Excel `clear` في ملفات Excel.
...
| نوع الكائن| خيط| استفسار| تكرار الصفوف/الأعمدة الفارغة/الصفوف الفارغة/الصيغة/المحتوى/النمط/المخطط/التعليق/الصورة/الشكل/كائن القائمة/الارتباط التشعبي/كائن الزيت/الجدول المحوري/التحقق/الخلفية|

 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/LightCells/PostClearObjects) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
