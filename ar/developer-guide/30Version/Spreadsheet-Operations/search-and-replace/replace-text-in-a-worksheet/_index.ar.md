---
title: استبدال النص في ورقة العمل Excel
...
weight: 70
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، استبدال النص في ورقة عمل Excel
---
يشير هذا REST API إلى النص `replace` في ورقة عمل Excel.
