---
title: تحويل متقدم Excel ملف
second_title: Documen
linktitle: المحول المتقدم
type: docs
...
---
## السحابة المتقدمة API للتحويل Excel

### القدرة على تحميل ملفات جدول البيانات من مصادر بيانات متعددة

### تعيين إعدادات الصفحة وخيارات الحفظ
