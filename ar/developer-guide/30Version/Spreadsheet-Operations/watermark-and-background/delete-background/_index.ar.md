...
description: يدعم Cloud REST حذف الخلفية في مصنف Excel أو ملف Excel. تدعم مجموعة أدوات تطوير البرامج (SDK) أنواعًا مختلفة من لغات التطوير، بما في ذلك Android وGo وNodeJS وRuby وSwift.
weight: 170
kwords: Excel، Office السحابة، REST API، جدول بيانات، PDF، CSV، Json، Markdown، حذف الخلفية في مصنف Excel
---
يشير هذا REST API إلى حذف الخلفية في مصنف Excel.
...
|:- |:- |:- |:- |
|/الخلايا/{الاسم}/الخلفية|يمسح|حذف الخلفية في ملف Excel|[حذف خلفية المصنف](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground)|

 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويسمح لك بتنفيذ تفاعلات REST مباشرة من متصفح الويب.
