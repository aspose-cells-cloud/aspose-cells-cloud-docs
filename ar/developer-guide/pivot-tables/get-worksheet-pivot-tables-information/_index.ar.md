---
title: احصل على جميع الجداول المحورية في ورقة عمل Excel
...
description: دعم Aspose.Cells Cloud REST API يحصل على جميع الجداول المحورية في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 20
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، احصل على جميع الجداول المحورية في ورقة عمل Excel
---
يشير REST API إلى الحصول على معلومات ورقة العمل `pivottables`.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/GetWorksheetPivotTables) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
