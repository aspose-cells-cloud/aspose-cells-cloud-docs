---
title: حذف كافة الجداول المحورية في ورقة عمل Excel
...
description: Aspose.Cells Cloud REST API يدعم حذف كافة الجداول المحورية في ورقة عمل Excel. يدعم SDK أنواع لغات التطوير. وهي تشمل Android وC# وGo وJava وNodeJS وPerl وPHP وPython وRuby وswift.
weight: 80
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، حذف كافة الجداول المحورية في ورقة عمل Excel
---
يشير REST API إلى حذف الجداول المحورية لورقة العمل
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTables) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
