...
description: Aspose.Cells Cloud REST API يدعم إضافة مرشح لجدول محوري. SDK يدعم أنواع لغات التطوير. وهي تشمل Android و C# و Go و Java و NodeJS و Perl و PHP و Python و Ruby و swift
weight: 50
---
يشير هذا REST API إلى `add` المحور المحوري `filter` لمؤشر جدول piovt
...
| اسم| خيط| طريق||
| اسم الورقة| خيط| طريق||
| pivotTable فهرس| عدد صحيح| طريق||
| منقي|| جسم||
| تحتاج إلى إعادة الحساب| قيمة منطقية| استفسار| خطأ شنيع|
| مجلد| خيط| استفسار||
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTableFilter) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
