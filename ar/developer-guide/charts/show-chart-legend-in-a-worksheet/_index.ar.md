---
title: إظهار وسيلة إيضاح الرسم البياني في Workshee
type: docs
url: /ar/charts/legend/show/
aliases: [/show-chart-legend-in-a-worksheet/]
weight: 100
---
يشير هذا REST API إلى إظهار وسيلة الإيضاح في الرسم البياني
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetChartLegend) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
