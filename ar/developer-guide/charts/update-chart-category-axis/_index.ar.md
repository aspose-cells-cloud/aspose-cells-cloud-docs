---
title:  تحديث محور فئة المخطط
type: docs
url: /ar/charts/category-axis/update/
weight: 160
---
يشير هذا REST API إلى تحديث محور فئة الرسم البياني.
...
| اسم التخزين| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartCategoryAxis) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
