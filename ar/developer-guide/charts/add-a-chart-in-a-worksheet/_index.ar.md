...
| نوع التخطيط| خيط| استفسار| نوع المخطط ، يرجى الرجوع إلى الخاصية اكتب في مورد المخطط.|
...
| عمودي| قيمة منطقية| استفسار| حقيقي|
|فئة البيانات| خيط| استفسار| الحصول على أو تحديد نطاق قيم محور الفئة. يمكن أن يكون نطاقًا من الخلايا (مثل ، "d1: e10").|
| isAutoGetSerialName| قيمة منطقية| استفسار| حقيقي|
| عنوان| خيط| استفسار| يحدد اسم عنوان المخطط.|
| مجلد| خيط| استفسار| مجلد المصنف.|
| اسم التخزين| خيط| استفسار| اسم التخزين.|
| تصنيفات البيانات| قيمة منطقية| استفسار| حقيقي|
| تصنيفات البيانات| خيط| استفسار| فوق|
| pivotTableSheet| خيط| استفسار||
| pivotTableName| خيط| استفسار||
 
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PutWorksheetAddChart) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
