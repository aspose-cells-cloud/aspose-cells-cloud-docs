---
title: تحديث عنوان المخطط في Excel Workshee
type: docs
url: /ar/charts/title/update/
aliases: [/update-chart-title-in-excel-worksheet/]
weight: 160
---
يشير هذا REST API إلى عنوان مخطط التحديث
...
<br/>
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostWorksheetChartTitle) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
