---
title:  تحديث الرسم البياني الفئة الثانية المحور
type: docs
url: /ar/charts/second-category-axis/update/
weight: 160
---
 يشير هذا REST API إلى تحديث محور الفئة الثانية للرسم البياني.
...
| اسم التخزين| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondCategoryAxis) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
