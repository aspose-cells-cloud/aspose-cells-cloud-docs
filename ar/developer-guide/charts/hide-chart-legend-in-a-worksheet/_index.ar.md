---
title: إخفاء وسيلة إيضاح الرسم البياني في Workshee
type: docs
url: /ar/charts/legend/hide/
aliases: [/hide-chart-legend-in-a-worksheet/]
weight: 110
---
يشير هذا REST API إلى إخفاء وسيلة الإيضاح في الرسم البياني
...
<br/>
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChartLegend) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
