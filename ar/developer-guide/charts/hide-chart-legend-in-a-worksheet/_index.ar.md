---
title: إخفاء وسيلة إيضاح المخطط في ورقة عمل
type: docs
url: /ar/charts/legend/hide/
aliases: [/hide-chart-legend-in-a-worksheet/]
weight: 110
---
يشير REST API إلى إخفاء وسيلة الإيضاح في المخطط
...
<br/>
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChartLegend) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
