---
title:  تحديث المحور الثاني للقيمة التخطيطية
type: docs
url: /ar/charts/second-value-axis/update/
weight: 160
---
 يشير هذا REST API إلى تحديث محور القيمة الثانية للرسم البياني.
...
| اسم التخزين| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondValueAxis) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
