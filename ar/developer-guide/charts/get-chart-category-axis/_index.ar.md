...
weight: 60
---
يشير هذا REST API إلى الحصول على محور فئة الرسم البياني
...
| اسم التخزين| خيط| استفسار||
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
