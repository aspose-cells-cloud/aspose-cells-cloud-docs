...
weight: 60
kwords: Excel، Office Cloud، REST API، جدول البيانات، PDF، CSV، Json، Markdwon، الحصول على منطقة المخطط من ورقة عمل
---
يشير REST API إلى الحصول على معلومات منطقة المخطط.
...
<br/>
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
