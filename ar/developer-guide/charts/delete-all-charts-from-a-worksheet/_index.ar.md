---
title: حذف كافة المخططات من ورقة عمل
type: docs
url: /ar/charts/clear/
aliases: [/delete-all-charts-from-a-worksheet/]
weight: 30
kwords: Excel، Office كلاود، ريست API، جدول بيانات، PDF، CSV، Json، Markdwon، حذف كافة المخططات من ورقة عمل
---
يشير REST API إلى مسح المخططات.
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetClearCharts) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك تنفيذ تفاعلات REST مباشرة من متصفح الويب.
