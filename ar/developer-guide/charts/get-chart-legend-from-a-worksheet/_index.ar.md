---
title: احصل على وسيلة إيضاح الرسم البياني من Workshee
type: docs
url: /ar/charts/legend/get/
aliases: [/get-chart-legend-from-a-worksheet/]
weight: 80
---
يشير هذا REST API إلى الحصول على وسيلة إيضاح الرسم البياني
...
| اسم التخزين| خيط| استفسار| اسم التخزين.|
 ...
 ال[مواصفات OpenAPI](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChartLegend) يحدد واجهة برمجة يمكن الوصول إليها بشكل عام ويتيح لك إجراء تفاعلات REST مباشرة من مستعرض ويب.
