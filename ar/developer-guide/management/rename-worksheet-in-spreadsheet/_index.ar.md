---
title: Aspose.Cells Cloud Web API - إعادة تسمية ورقة العمل في جدول البيانات
second_title: Documen
ArticleTitle: Rename worksheet in Spreadshee
linktitle: إعادة تسمية ورقة العمل في جدول البيانات
type: docs
...
description: تتيح نقطة نهاية الويب API للمستخدمين إعادة تسمية ورقة عمل محددة داخل مصنف، مما يعزز التنظيم وسهولة القراءة
weight: 100
kwords: Excel API، إعادة تسمية ورقة العمل، إدارة المصنف، REST API، جدول بيانات، PDF، CSV، JSON، Markdown، مطابقة جميع الخلايا الفارغة في ورقة عمل Excel
---
إعادة تسمية ورقة العمل في جدول البيانات.

## **إعادة تسمية اسم ورقة العمل في جدول البيانات API**
...
|اسم المصدر|خيط|استفسار|الاسم الحالي للورقة العمل التي سيتم إعادة تسميتها.|
|اسم الهدف|خيط|استفسار|اسم جديد لورقة العمل.|
...
## أين يجب علينا استخدام ورقة عمل إعادة التسمية في جدول البيانات API؟

عندما تحتاج إلى إعادة تسمية ورقة العمل في جداول البيانات، يمكنك استخدام هذا API.

## لماذا يجب عليك استخدام ورقة عمل إعادة التسمية في جدول البيانات API؟

- إعادة تسمية أوراق العمل بسرعة من جداول البيانات.
- يمكن إكمال التطوير بسرعة من خلال مجموعة أدوات التطوير البرمجية الموجودة.

## كيفية استخدام ورقة عمل إعادة التسمية في جدول البيانات API مع مجموعات تطوير البرامج (SDKs)

### مواصفات OpenAPI

 ال[مواصفات OpenAPI](https://reference.aspose.cloud/cells/#/ManagementController/RenameWorksheetInSpreadsheet)تفاصيل واجهة برمجة يمكن الوصول إليها علنًا، مما يسمح بالتفاعلات REST مباشرة من متصفح الويب.

### استخدم Aspose.Cells Cloud SDKs

يُعد استخدام مجموعة أدوات تطوير البرامج (SDK) أفضل طريقة لتسريع عملية التطوير. فهي تُعنى بالتفاصيل الأساسية، مما يسمح لك بتطبيق إعادة تسمية ورقة العمل في جداول البيانات للخلايا ذات التعليمات البرمجية البسيطة.
