...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datacleansing,POST,تنظيف البيانات لملفات جداول البيانات هو عملية إدارة بيانات تستخدم لتحديد وتصحيح وإزالة الأخطاء أو عدم الاكتمال أو التكرارات أو عدم الدقة في الجداول والنطاقات.,<a href=\'https: //apireference.aspose.cloud/cells/#/DataProcessing/PostWorkbookDataCleansing\'>PostWorkbookDataCleansing</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="تنظيف البيانات، الفئة: تنظيف البيانات، محتوى تنظيف البيانات." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
