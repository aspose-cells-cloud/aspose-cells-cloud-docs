...
type: docs
url: /ar/specification/operation/postworksheetcomment/
description: تحديث تعليق الخلية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetComment
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},POST,تحديث تعليق الخلية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/ PostWorksheetComment\'>PostWorksheetComment</a>" >}}
