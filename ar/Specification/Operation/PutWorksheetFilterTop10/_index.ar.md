...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/filterTop10,PUT,قم بتصفية أعلى 10 عناصر في القائمة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/# /AutoFilter/PutWorksheetFilterTop10\'>PutWorksheetFilterTop10</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="isTop,boolean,يشير إلى ما إذا كان الفلتر من الأعلى أو الأسفل" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isPercent,boolean,يشير إلى ما إذا كانت العناصر نسبة مئوية أم عدداً" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="عدد العناصر، عدد صحيح، عدد العناصر" >}} 
