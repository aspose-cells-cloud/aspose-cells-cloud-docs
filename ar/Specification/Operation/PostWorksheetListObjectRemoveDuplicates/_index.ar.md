...
type: docs
url: /ar/specification/operation/postworksheetlistobjectremoveduplicates/
description: إزالة التكرارات في كائن القائمة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetListObjectRemoveDuplicates
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/RemoveDuplicates,POST,إزالة التكرارات في كائن القائمة.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects /PostWorksheetListObjectRemoveDuplicates\'>PostWorksheetListObjectRemoveDuplicates</a>" >}}
