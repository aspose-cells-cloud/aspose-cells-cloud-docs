...
type: docs
url: /ar/specification/operation/postconvertworkbooktopng/
description: تحويل ملف Excel إلى PNG ملف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToPNG
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/png,POST,تحويل ملف Excel إلى PNG ملف.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPNG\'>PostConvertWorkbookToPNG</a>" >}}
