...
type: docs
url: /ar/specification/operation/postconvertworkbooktodocx/
description: تحويل ملف Excel إلى ملفات Docx
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToDocx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/docx,POST,تحويل ملف Excel إلى ملفات Docx.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx\'>PostConvertWorkbookToDocx</a>" >}}
