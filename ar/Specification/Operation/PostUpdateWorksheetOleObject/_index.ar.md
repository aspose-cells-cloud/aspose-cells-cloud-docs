...
type: docs
url: /ar/specification/operation/postupdateworksheetoleobject/
description: تحديث كائن OLE في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostUpdateWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects/{oleObjectIndex},POST,تحديث كائن OLE في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/ PostUpdateWorksheetOleObject\'>PostUpdateWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="oleObjectIndex، عدد صحيح، فهرس كائن Ole." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ole,class:oleobject,وصف كائن Ole." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
