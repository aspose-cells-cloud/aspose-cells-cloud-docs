---
title: احصل على شكل ورقة العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/getworksheetshapes/
description: استرداد أوصاف الأشكال في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetShapes
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,استرداد أوصاف الأشكال في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'> الحصول على أشكال ورقة العمل</a>" >}}
