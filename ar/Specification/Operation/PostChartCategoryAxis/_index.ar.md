...
type: docs
url: /ar/specification/operation/postchartcategoryaxis/
description: تحديث محور فئة المخطط في المخطط
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,POST,تحديث محور فئة المخطط في المخطط.,<a href=\'https://apireference.aspose.cloud/cells/# /Charts/PostChartCategoryAxis\'>PostChartCategoryAxis</a>" >}}
