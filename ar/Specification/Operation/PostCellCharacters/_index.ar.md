...
type: docs
url: /ar/specification/operation/postcellcharacters/
description: تعيين أحرف الخلية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostCellCharacters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/characters,POST,تعيين أحرف الخلية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCharacters\'>PostCellCharacters</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="خيارات، حاوية،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
