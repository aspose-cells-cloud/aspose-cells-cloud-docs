...
type: docs
url: /ar/specification/operation/postpivottablecellstyle/
description: تحديث نمط الخلية في PivotTable
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostPivotTableCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,تحديث نمط الخلية في PivotTable.,<a href=\'https://apireference.aspose.cloud/cells/#/ PivotTables/PostPivotTableCellStyle\'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="عمود، عدد صحيح، فهرس عمود الخلية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="الصف، عدد صحيح، فهرس صف الخلية." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="النمط، الفئة: النمط، النمط وصف النمط في نص الطلب." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
