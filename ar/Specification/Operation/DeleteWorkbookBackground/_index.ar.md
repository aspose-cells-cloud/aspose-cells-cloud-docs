---
title: حذف WorkbookBackgroun
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworkbookbackground/
description: حذف الخلفية في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف WorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,DELETE,حذف الخلفية في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/DeleteWorkbookBackground\'>DeleteWorkbookBackground</a>" >}}
