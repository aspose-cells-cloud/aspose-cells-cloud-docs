...
type: docs
url: /ar/specification/operation/getnamedranges/
description: استرداد أوصاف النطاقات في أوراق العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetNamedRanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/ranges,GET,استرجاع أوصاف النطاقات في أوراق العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges\'>GetNamedRanges</a >" >}}
