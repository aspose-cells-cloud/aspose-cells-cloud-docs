...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/protect,POST,Excel تشفير الملفات.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostProtect\'>PostProtect</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="حماية WorkbookRequest، الفئة: حماية Workbookrequest،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
