...
type: docs
url: /ar/specification/operation/getworksheetcolumns/
description: استرداد أوصاف أعمدة ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/,GET,استرداد أوصاف أعمدة ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetColumns\' >GetWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="إزاحة، عدد صحيح، مجلد العمل." >}} 
