...
type: docs
url: /ar/specification/operation/getworkbooktextitems/
description: استرداد العناصر النصية في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorkbookTextItems
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/textItems,GET,استرداد العناصر النصية في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems\'>GetWorkbookTextItems</a>" >}}
