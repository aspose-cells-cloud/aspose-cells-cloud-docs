...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},DELETE,حذف التحقق من الصحة عن طريق الفهرس في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations /DeleteWorksheetValidation\'>DeleteWorksheetValidation</a>" >}}
