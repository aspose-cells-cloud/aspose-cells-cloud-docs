---
title: ضع ورقة عملOleObjec
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworksheetoleobject/
description: إضافة كائن OLE في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetOleObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,PUT,أضف كائن OLE في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/PutWorksheetOleObject\'> PutWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="الارتفاع، عدد صحيح، ارتفاع كائن أولي، بوحدة البكسل" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="العرض، عدد صحيح، عرض كائن أولي، بوحدة البكسل" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="oleFile، سلسلة، مسار اسم ملف OLE (اسم الملف الكامل)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="imageFile، سلسلة، مسار اسم ملف الصورة (اسم الملف الكامل)." >}} 
