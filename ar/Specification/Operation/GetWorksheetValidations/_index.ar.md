...
type: docs
url: /ar/specification/operation/getworksheetvalidations/
description: استرداد أوصاف عمليات التحقق من الصحة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,GET,استرجاع أوصاف عمليات التحقق من الصحة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations\'> GetWorksheetValidations</a>" >}}
