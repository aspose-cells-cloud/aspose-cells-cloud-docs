...
type: docs
url: /ar/specification/operation/postworkbookgetsmartmarkerresult/
description: معالجة العلامات الذكية
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorkbookGetSmartMarkerResult
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/smartmarker,POST,معالجة العلامات الذكية.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookGetSmartMarkerResult\'>PostWorkbookGetSmartMarkerResult</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="xmlFile,string,المسار الكامل لملف xml، إذا كان فارغًا، تتم قراءة البيانات من نص الطلب." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="المجلد، السلسلة، المجلد الذي يوجد به الملف." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outPath,string,مسار حفظ النتيجة" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="اسم التخزين، سلسلة، اسم التخزين حيث يوجد الملف." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,string,اسم التخزين الذي يوجد به الملف الناتج." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
