...
type: docs
url: /ar/specification/operation/postworksheetcellsrangemerge/
description: دمج نطاق من الخلايا في خلية واحدة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetCellsRangeMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/merge,POST,دمج نطاق من الخلايا في خلية واحدة.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /PostWorksheetCellsRangeMerge\'>PostWorksheetCellsRangeMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="النطاق، الفئة: النطاق، وصف النطاق." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
