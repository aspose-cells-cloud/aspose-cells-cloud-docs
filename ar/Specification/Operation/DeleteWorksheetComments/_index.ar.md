---
title: حذف تعليق ورقة العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetcomments/
description: حذف كافة التعليقات في ورقة العمل
kwords: Excel, Office, جدول البيانات, Cloud REST API, حذف ورقة العملComments
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,DELETE,حذف جميع التعليقات في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComments\'>DeleteWorksheetComments </أ>" >}}
