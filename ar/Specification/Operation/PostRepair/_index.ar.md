...
type: docs
url: /ar/specification/operation/postrepair/
description: إصلاح الملفات غير الطبيعية وإنشاء ملفات بتنسيقات مختلفة
kwords: Excel, Office, جدول البيانات, Cloud REST API, PostRepair
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/repair,POST,إصلاح الملفات غير الطبيعية وإنشاء ملفات بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRepair\'>PostRepair</a>" >}}
