...
type: docs
url: /ar/specification/operation/getworkbooknames/
description: استرداد النطاقات المسماة في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorkbookNames
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/names,GET,استرداد النطاقات المسماة في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookNames\'>GetWorkbookNames</a>" >}}
