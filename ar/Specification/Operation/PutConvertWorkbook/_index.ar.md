...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert,PUT,تحويل المصنف من المحتوى المطلوب إلى ملفات بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PutConvertWorkbook\'>PutConvertWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" streamFormat,string,تنسيق دفق ملف الإدخال." >}} 
