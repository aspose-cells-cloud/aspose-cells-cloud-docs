...
type: docs
url: /ar/specification/operation/postworkbookcalculateformula/
description: حساب كافة الصيغ في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorkbookCalculateFormula
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/calculateformula,POST,احسب جميع الصيغ في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookCalculateFormula\'>PostWorkbookCalculateFormula</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="تجاهل الخطأ، منطقي، تجاهل الخطأ." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="خيارات، فئة: خيارات الحساب، خيارات الحساب خيارات الحساب." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
