...
type: docs
url: /ar/specification/operation/postdigitalsignature/
description: Excel ملف التوقيع الرقمي
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostDigitalSignature
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/digitalsignature,POST,Excel ملف التوقيع الرقمي.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostDigitalSignature\'>PostDigitalSignature</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="digitalsignaturefile,string,يجب أن يتضمن مسار ملف التوقيع الرقمي كلاً من المجلد واسم الملف، بالإضافة إلى الامتداد." >}} 
