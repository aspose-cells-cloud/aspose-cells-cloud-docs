---
title: ضع WorkbookBackgroun
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworkbookbackground/
description: تعيين الخلفية في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorkbookBackground
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/background,PUT,تعيين الخلفية في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookBackground\'>PutWorkbookBackground</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picPath، سلسلة، الصورة المسار الكامل." >}} 
