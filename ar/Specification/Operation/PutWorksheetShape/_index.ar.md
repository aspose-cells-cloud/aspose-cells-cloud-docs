...
type: docs
url: /ar/specification/operation/putworksheetshape/
description: إضافة شكل في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,PUT,أضف شكلاً في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape\'>PutWorksheetShape </أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="نوع الرسم، السلسلة، نوع كائن الشكل" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftRow، عدد صحيح، فهرس الصف الأيسر العلوي." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftColumn، عدد صحيح، فهرس العمود الأيسر العلوي." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="أعلى، عدد صحيح، يمثل الإزاحة الرأسية لـ Spinner من الصف الأيسر، بوحدة البكسل." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="يسار، عدد صحيح، يمثل الإزاحة الأفقية لـ Spinner من العمود الأيسر، بوحدة البكسل." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="العرض، عدد صحيح، يمثل ارتفاع الدوار، بوحدة البكسل." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="الارتفاع، عدد صحيح، يمثل عرض الدوار، بوحدة البكسل." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="الشكلDTO، الفئة: الشكل،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
