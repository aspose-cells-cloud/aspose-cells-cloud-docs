...
type: docs
url: /ar/specification/operation/postsetworksheetcolumnwidth/
description: ضبط عرض عمود ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostSetWorksheetColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},POST,تعيين عرض عمود ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostSetWorksheetColumnWidth\'>PostSetWorksheetColumnWidth</a>" >}}
