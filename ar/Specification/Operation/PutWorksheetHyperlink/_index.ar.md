---
title: ضع ورقة العملHyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworksheethyperlink/
description: إضافة ارتباط تشعبي في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,PUT,أضف رابطًا تشعبيًا في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink\'>PutWorksheetHyperlink< /أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow، عدد صحيح، الصف الأول من نطاق الارتباط التشعبي." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn، عدد صحيح، العمود الأول من نطاق الارتباط التشعبي." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="TotalRows، عدد صحيح، عدد الصفوف في نطاق الارتباط التشعبي هذا." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="TotalColumns,integer,عدد الأعمدة في نطاق الارتباط التشعبي هذا." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="العنوان، السلسلة، عنوان الارتباط التشعبي." >}} 
