---
title: صورة ما بعد ورقة العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postworksheetpicture/
description: قم بتحديث الصورة حسب الفهرس في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureIndex},POST,تحديث صورة حسب الفهرس في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ الصور/PostWorksheetPicture\'>PostWorksheetPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="صورة، فئة: صورة، وصف كائن الصورة." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
