---
title: حذفVerticalPageBrea
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteverticalpagebreak/
description: حذف فاصل صفحات عمودي في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، DeleteVerticalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks/{index},DELETE,حذف فاصل صفحات رأسي في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ فواصل الصفحات/DeleteVerticalPageBreak\'>DeleteVerticalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="فهرس، عدد صحيح، يزيل عنصر فاصل الصفحات العمودي عند اسم محدد. مؤشر العنصر، على أساس صفر." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
