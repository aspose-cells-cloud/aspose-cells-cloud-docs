...
type: docs
url: /ar/specification/operation/postworksheetlistobjectsorttable/
description: فرز كائن القائمة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetListObjectSortTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/sort,POST,فرز كائن القائمة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ ListObjects/PostWorksheetListObjectSortTable\'>PostWorksheetListObjectSortTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataSorter,class:datasorter,يمثل ترتيب الفرز لنطاق البيانات." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
