...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datadeduplication,POST,يتم استخدام إلغاء البيانات المكررة لملفات جداول البيانات بشكل أساسي لإزالة البيانات المكررة في الجداول والنطاقات.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/ PostWorkbookDataDeduplication\'>PostWorkbookDataDeduplication</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="منطقة إلغاء البيانات المكررة، الفئة: منطقة إلغاء البيانات المكررة،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
