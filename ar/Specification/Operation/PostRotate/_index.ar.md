...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/rotate,POST,تدوير الصفوف أو الأعمدة أو الكائنات الأخرى في ملفات Excel وحفظها بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostRotate\'> بعد التدوير</a>" >}}
