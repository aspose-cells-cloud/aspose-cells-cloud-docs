...
type: docs
url: /ar/specification/operation/getworksheetcell/
description: قم باسترداد بيانات الخلية باستخدام مرجع الخلية أو اسم الطريقة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetCell
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellOrMethodName},GET,استرداد بيانات الخلية باستخدام مرجع الخلية أو اسم الطريقة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud /cells/#/Cells/GetWorksheetCell\'>GetWorksheetCell</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="cellOrMethodName,string,اسم الخلية أو الأسلوب. (اسم الطريقة مثل firstcell وendcell وما إلى ذلك)" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
