---
title: ضع WorkbookCreat
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworkbookcreate/
description: إنشاء مصنف جديد باستخدام أساليب مختلفة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorkbookCreate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name},PUT,أنشئ مصنفًا جديدًا باستخدام طرق مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PutWorkbookCreate\'>PutWorkbookCreate</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="الاسم، السلسلة، اسم المستند الجديد." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="templateFile,string,ملف القالب، إذا لم يتم توفير البيانات، فسيتم إنشاء المصنف الافتراضي." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="dataFile، string، ملف بيانات العلامة الذكية، إذا لم يتم توفير البيانات، فسيتم فحص محتوى الطلب بحثًا عن البيانات." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isWriteOver,boolean,يحدد ما إذا كان سيتم الكتابة فوق ملف الهدف أم لا." >}} 
