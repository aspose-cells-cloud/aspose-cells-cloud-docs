...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,DELETE,حذف فواصل الصفحات الأفقية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/DeleteHorizontalPageBreaks\'> حذفHorizontalPageBreaks</a>" >}}
