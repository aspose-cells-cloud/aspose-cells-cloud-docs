...
type: docs
url: /ar/specification/operation/postconvertworkbooktomarkdown/
description: تحويل ملف Excel إلى ملفات Markdown
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToMarkdown
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/markdown,POST,تحويل ملف Excel إلى ملفات Markdown.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToMarkdown\'>PostConvertWorkbookToMarkdown</a>" >}}
