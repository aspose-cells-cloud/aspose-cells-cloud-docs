...
type: docs
url: /ar/specification/operation/getworksheetvalidation/
description: استرداد التحقق من الصحة من خلال فهرسه في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetValidation
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},GET,استرداد التحقق من الصحة من خلال فهرسه في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/# /WorksheetValidations/GetWorksheetValidation\'>GetWorksheetValidation</a>" >}}
