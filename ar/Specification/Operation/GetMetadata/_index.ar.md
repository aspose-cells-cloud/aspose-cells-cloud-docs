...
type: docs
url: /ar/specification/operation/getmetadata/
description: الحصول على خصائص وثيقة الخلايا
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/get,POST,الحصول على خصائص مستند الخلايا.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/GetMetadata\'>GetMetadata</a>" >}}
