...
type: docs
url: /ar/specification/operation/putworksheetlistobject/
description: إضافة كائن قائمة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetListObject
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects,PUT,أضف كائن قائمة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PutWorksheetListObject\'>PutWorksheetListObject </أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow، عدد صحيح، صف البداية لنطاق القائمة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,عمود البداية لنطاق القائمة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow، عدد صحيح، صف البداية لنطاق القائمة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn,integer,عمود البداية لنطاق القائمة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="المجلد، السلسلة، المجلد الذي يوجد به الملف." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hasHeaders,boolean,حدد ما إذا كان النطاق يحتوي على رؤوس." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="اسم العرض، سلسلة، تشير إلى ما إذا كان اسم العرض." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="showTotals، منطقي، يشير إلى ما إذا كان سيتم إظهار الإجماليات أم لا." >}} 
