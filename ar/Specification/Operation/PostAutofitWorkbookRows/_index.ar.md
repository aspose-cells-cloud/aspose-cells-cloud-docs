...
type: docs
url: /ar/specification/operation/postautofitworkbookrows/
description: الاحتواء التلقائي للصفوف في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostAutofitWorkbookRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/autofitrows,POST,الاحتواء التلقائي للصفوف في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostAutofitWorkbookRows\'>PostAutofitWorkbookRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startRow، عدد صحيح، صف البداية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow، عدد صحيح، صف النهاية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="فقط تلقائي، منطقي، تلقائي فقط." >}} 
