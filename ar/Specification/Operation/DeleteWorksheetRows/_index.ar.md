---
title: حذف صف ورقة العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetrows/
description: حذف عدة صفوف في ورقة العمل
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,DELETE,حذف عدة صفوف في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetRows \'>حذف صفوف ورقة العمل</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,يشير إلى ما إذا كان التحديث يشير إلى أوراق عمل أخرى." >}} 
