---
title: PostWorksheetMerg
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postworksheetmerge/
description: دمج الخلايا في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/merge,POST,دمج الخلايا في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetMerge\'> دمج ورقة العمل بعد</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="TotalRows، عدد صحيح، إجمالي عدد الصفوف." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="TotalColumns، عدد صحيح، إجمالي عدد الأعمدة." >}} 
