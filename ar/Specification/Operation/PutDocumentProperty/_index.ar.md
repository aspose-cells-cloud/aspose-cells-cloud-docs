...
type: docs
url: /ar/specification/operation/putdocumentproperty/
description: تعيين أو إضافة خاصية Excel
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutDocumentProperty
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties,PUT,قم بتعيين أو إضافة خاصية Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/PutDocumentProperty\'>PutDocumentProperty</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="property,class:cellsdocumentproperty,احصل على قيمة الخاصية أو قم بتعيينها." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
