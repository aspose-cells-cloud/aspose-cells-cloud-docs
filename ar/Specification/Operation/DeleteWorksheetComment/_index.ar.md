---
title: حذف ورقة العملCommen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetcomment/
description: حذف تعليق الخلية في ورقة العمل
kwords: Excel, Office, جدول البيانات, Cloud REST API, حذف ورقة العملComment
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},DELETE,حذف تعليق الخلية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/ RemoveWorksheetComment\'>DeleteWorksheetComment</a>" >}}
