...
type: docs
url: /ar/specification/operation/getworksheetrows/
description: استرداد أوصاف الصفوف في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,GET,استرداد أوصاف الصفوف في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ GetWorksheetRows\'>GetWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="إزاحة، عدد صحيح، إزاحة الصف." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="العد، عدد صحيح، عرض رقم الصفوف." >}} 
