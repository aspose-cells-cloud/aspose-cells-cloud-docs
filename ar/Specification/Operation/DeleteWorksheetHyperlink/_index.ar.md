---
title: حذف ورقة العملHyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheethyperlink/
description: حذف الارتباط التشعبي حسب الفهرس في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف ورقة العمل، الارتباط التشعبي
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},DELETE,حذف الارتباط التشعبي حسب الفهرس في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks /DeleteWorksheetHyperlink\'>DeleteWorksheetHyperlink</a>" >}}
