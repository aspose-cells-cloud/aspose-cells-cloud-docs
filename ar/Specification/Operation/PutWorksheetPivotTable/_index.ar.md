---
title: ضع ورقة عملPivotTabl
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworksheetpivottable/
description: أضف PivotTable في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetPivotTable
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables,PUT,أضف PivotTable في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/PutWorksheetPivotTable\'>PutWorksheetPivotTable </أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="sourceData,string,بيانات ذاكرة التخزين المؤقت PivotTable الجديدة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destCellName,string,الخلية الموجودة في الزاوية العلوية اليسرى من النطاق الوجهة لتقرير PivotTable." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="tableName,string,اسم PivotTable الجديد." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="useSameSource,boolean,يشير إلى ما إذا كان سيتم استخدام نفس مصدر البيانات عندما يستخدم PivotTable موجود آخر مصدر البيانات هذا. إذا كانت الخاصية صحيحة، فسيتم حفظ الذاكرة." >}} 
