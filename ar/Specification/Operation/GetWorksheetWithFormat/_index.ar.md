...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},GET,استرداد ورقة العمل بتنسيق محدد من المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetWithFormat\' >GetWorksheetWithFormat</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="pageIndex,integer,يمثل الصفحة المراد طباعتها" >}} 
