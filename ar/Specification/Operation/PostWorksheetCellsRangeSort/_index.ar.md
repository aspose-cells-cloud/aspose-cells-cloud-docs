...
type: docs
url: /ar/specification/operation/postworksheetcellsrangesort/
description: إجراء فرز البيانات حول نطاق من الخلايا
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetCellsRangeSort
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/sort,POST,إجراء فرز البيانات حول نطاق من الخلايا.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeSort\'>PostWorksheetCellsRangeSort</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" rangeSortRequest,class:rangesortrequest,RangeSortRequest طلب فرز النطاق" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
