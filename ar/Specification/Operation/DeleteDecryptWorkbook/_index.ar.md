---
title: حذفDecryptWorkboo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deletedecryptworkbook/
description: Excel فك تشفير الملفات
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف ديكريبت ووركبوك
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,DELETE,Excel فك تشفير الملفات.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/DeleteDecryptWorkbook\'>DeleteDecryptWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="التشفير، الفئة: طلب تشفير المصنف، معلمات WorkbookEncryptionRequestEncryption." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
