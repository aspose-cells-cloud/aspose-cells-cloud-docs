---
title: PostCellCaculat
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postcellcalculate/
description: حساب صيغة الخلية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostCellCalculate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/calculate,POST,احسب صيغة الخلية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/PostCellCalculate\'>PostCellCalculate</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="خيارات، فئة: خيارات الحساب، خيارات الحساب" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
