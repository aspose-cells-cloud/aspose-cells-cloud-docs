...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/watermark,POST,إضافة علامة مائية نصية إلى Excel ملفًا وإنشاء ملفات إخراج بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark\'>PostWatermark</a >" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="النص، سلسلة، نص الخلفية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="اللون، سلسلة، على سبيل المثال # 1032ff" >}} 
