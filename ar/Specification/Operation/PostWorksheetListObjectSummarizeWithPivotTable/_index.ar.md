...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/SummarizeWithPivotTable,POST,إنشاء جدول محوري باستخدام كائن قائمة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud /cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable\'>PostWorksheetListObjectSummarizeWithPivotTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destsheetName,string,اسم ورقة العمل الهدف." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="createPivotTableRequest,class:createpivottablerequest,إنشاء طلب جدول محوري." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
