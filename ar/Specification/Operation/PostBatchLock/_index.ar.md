...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/lock,POST,تأمين الملفات الدفعية التي تستوفي شروط مطابقة محددة.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchLock\'>PostBatchLock</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns=" BatchLockRequest,class:batchlockrequest,BatchLockRequest طلب ملف قفل الدفعة." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
