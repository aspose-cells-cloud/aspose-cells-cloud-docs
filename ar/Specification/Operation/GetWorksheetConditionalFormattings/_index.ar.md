...
type: docs
url: /ar/specification/operation/getworksheetconditionalformattings/
description: استرداد أوصاف التنسيقات الشرطية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetConditionalFormattings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings,GET,استرداد أوصاف التنسيقات الشرطية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings\' >GetWorksheetConditionalFormattings</a>" >}}
