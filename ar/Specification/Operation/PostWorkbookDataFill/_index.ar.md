...
type: docs
url: /ar/specification/operation/postworkbookdatafill/
description: يتم استخدام تعبئة البيانات لملفات جداول البيانات بشكل أساسي لملء البيانات الفارغة في الجداول والنطاقات
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorkbookDataFill
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/datafill,POST,يتم استخدام تعبئة البيانات لملفات جداول البيانات بشكل أساسي لملء البيانات الفارغة في الجداول والنطاقات.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/ PostWorkbookDataFill\'>PostWorkbookDataFill</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="المجلد، السلسلة،" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="اسم التخزين، سلسلة،" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="كلمة المرور، سلسلة،" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="المنطقة، السلسلة،" >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="تعبئة البيانات، الفئة: تعبئة البيانات،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
