...
type: docs
url: /ar/specification/operation/postpivottablefieldhideitem/
description: إخفاء عنصر حقل محوري في PivotTable
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostPivotTableFieldHideItem
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotField/Hide,POST,إخفاء عنصر حقل محوري في PivotTable.,<a href=\'https://apireference.aspose.cloud/ الخلايا/#/PivotTables/PostPivotTableFieldHideItem\'>PostPivotTableFieldHideItem</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="itemIndex,integer,فهرس العنصر المحوري في الحقل المحوري." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isHide، boolean، ما إذا كان العنصر المحوري المحدد مخفيًا (صواب/خطأ)." >}} 
