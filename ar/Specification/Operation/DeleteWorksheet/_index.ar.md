...
type: docs
url: /ar/specification/operation/deleteworksheet/
description: حذف ورقة عمل في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف ورقة العمل
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},DELETE,حذف ورقة عمل في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheet\'>DeleteWorksheet</ أ>" >}}
