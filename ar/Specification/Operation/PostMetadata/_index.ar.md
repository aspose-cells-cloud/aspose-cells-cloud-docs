...
type: docs
url: /ar/specification/operation/postmetadata/
description: تحديث خصائص الوثيقة في الملف Excel وحفظها بصيغ مختلفة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/update,POST,تحديث خصائص المستند في ملف Excel وحفظها بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMetadata\'>PostMetadata< /أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="الخلايا، المستندات، الحاوية، خصائص الوثيقة" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
