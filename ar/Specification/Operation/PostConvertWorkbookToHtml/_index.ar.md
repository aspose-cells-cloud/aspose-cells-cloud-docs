...
type: docs
url: /ar/specification/operation/postconvertworkbooktohtml/
description: تحويل ملف Excel إلى HTML ملف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToHtml
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/html,POST,تحويل ملف Excel إلى HTML ملف.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToHtml\'>PostConvertWorkbookToHtml</a>" >}}
