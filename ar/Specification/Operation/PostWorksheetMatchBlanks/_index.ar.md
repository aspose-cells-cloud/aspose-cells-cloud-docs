...
type: docs
url: /ar/specification/operation/postworksheetmatchblanks/
description: مطابقة كافة الخلايا الفارغة في القائمة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetMatchBlanks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchBlanks,POST,مطابقة جميع الخلايا الفارغة في القائمة.<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetMatchBlanks \'>PostWorksheetMatchBlanks</a>" >}}
