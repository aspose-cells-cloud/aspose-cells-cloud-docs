...
type: docs
url: /ar/specification/operation/deleteworksheets/
description: حذف أوراق العمل المطابقة في المصنف
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,حذف أوراق العمل المتطابقة في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>حذف أوراق العمل</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     {{< blocks/products/cells/docs-Parameter-content columns="الاسم، السلسلة،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="حالة المطابقة، الفئة: طلب حالة المطابقة،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
