---
title: حذف ورقة العملShap
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetshape/
description: حذف شكل في ورقة العمل
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},DELETE,حذف شكل في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/ حذف شكل ورقة العمل\'>حذف شكل ورقة العمل</a>" >}}
