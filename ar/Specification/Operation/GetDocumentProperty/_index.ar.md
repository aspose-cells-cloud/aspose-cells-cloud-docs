...
type: docs
url: /ar/specification/operation/getdocumentproperty/
description: احصل على عقار Excel بالاسم
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetDocumentProperty
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties/{propertyName},GET,احصل على Excel خاصية بالاسم.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty\'>GetDocumentProperty</a >" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="اسم الخاصية، سلسلة، اسم الخاصية." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
