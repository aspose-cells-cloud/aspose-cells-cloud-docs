...
type: docs
url: /ar/specification/operation/postworksheetcellsetvalue/
description: قم بتعيين قيمة الخلية باستخدام اسم الخلية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetCellSetValue
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName},POST,تعيين قيمة الخلية باستخدام اسم الخلية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PostWorksheetCellSetValue\'>PostWorksheetCellSetValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="القيمة، السلسلة، قيمة الخلية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="النوع، السلسلة، نوع القيمة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="صيغة، سلسلة، صيغة للخلية" >}} 
