...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,GET,استرجاع أوصاف فواصل الصفحات العمودية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetVerticalPageBreaks \'>GetVerticalPageBreaks</a>" >}}
