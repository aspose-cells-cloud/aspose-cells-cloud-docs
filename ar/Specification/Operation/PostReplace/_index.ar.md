...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/replace,POST,استبدل النص المحدد بنص جديد في ملفات Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostReplace\'>PostReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="نص جديد، سلسلة، استبدال المحتوى" >}} 
