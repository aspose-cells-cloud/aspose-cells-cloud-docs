...
type: docs
url: /ar/specification/operation/gethorizontalpagebreaks/
description: استرداد أوصاف فواصل الصفحات الأفقية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetHorizontalPageBreaks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,استرجاع أوصاف فواصل الصفحات الأفقية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks \'>GetHorizontalPageBreaks</a>" >}}
