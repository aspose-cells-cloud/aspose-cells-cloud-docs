...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/compress,POST,ضغط الملفات وإنشاء الملفات المستهدفة بتنسيقات مختلفة، وتشمل تنسيقات الملفات المدعومة Xls وXlsx وXlsm وXlsb وOds والمزيد.<a href=\'https://apireference.aspose.cloud/ cell/#/LightCells/PostCompress\'>PostCompress</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="مستوى الضغط، عدد صحيح، مستوى الضغط. نسبة الضغط 1-100." >}} 
