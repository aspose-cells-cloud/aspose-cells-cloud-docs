---
title: حذف عمود ورقة العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetcolumns/
description: حذف أعمدة ورقة العمل في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف أوراق العملColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},DELETE,حذف أعمدة ورقة العمل في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetColumns\'>DeleteWorksheetColumns</a>" >}}
