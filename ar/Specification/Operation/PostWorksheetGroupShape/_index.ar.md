...
type: docs
url: /ar/specification/operation/postworksheetgroupshape/
description: تجميع الأشكال في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetGroupShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/group,POST,تجميع الأشكال في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PostWorksheetGroupShape\'> PostWorksheetGroupShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="listShape,array<integer>,صفيف فهرس الشكل." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
