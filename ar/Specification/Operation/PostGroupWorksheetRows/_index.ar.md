---
title: صف ورقة عمل PostGroup
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postgroupworksheetrows/
description: صفوف المجموعة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostGroupWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/group,POST,صفوف المجموعة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows \'>PostGroupWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,مؤشر الصف الأول الذي سيتم تشغيله." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex، عدد صحيح، فهرس الصف الأخير الذي سيتم تشغيله." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="إخفاء، منطقية، حالة الصفوف مرئية" >}} 
