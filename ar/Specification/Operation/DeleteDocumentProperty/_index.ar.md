---
title: حذفDocumentPropert
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deletedocumentproperty/
description: حذف خاصية Excel
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/documentproperties/{propertyName},DELETE,حذف خاصية Excel.,<a href=\'https://apireference.aspose.cloud/cells/#/Properties/DeleteDocumentProperty\'>DeleteDocumentProperty</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="اكتب، سلسلة،" >}} 
