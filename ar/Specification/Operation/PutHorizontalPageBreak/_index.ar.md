...
type: docs
url: /ar/specification/operation/puthorizontalpagebreak/
description: أضف فواصل صفحات أفقية في ورقة العمل
kwords: Excel, Office, جدول البيانات, Cloud REST API, PutHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,PUT,أضف فواصل صفحات أفقية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutHorizontalPageBreak\' >PutHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="الصف، عدد صحيح، فهرس الصف، على أساس الصفر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="العمود، عدد صحيح، فهرس العمود، على أساس الصفر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn، عدد صحيح، فهرس عمود البداية، على أساس صفر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn، عدد صحيح، فهرس عمود النهاية، على أساس صفر." >}} 
