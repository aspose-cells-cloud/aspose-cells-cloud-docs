...
type: docs
url: /ar/specification/operation/postencryptworkbook/
description: Excel التشفير
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostEncryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,POST,Excel التشفير.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostEncryptWorkbook\'>PostEncryptWorkbook</a>" >}}
