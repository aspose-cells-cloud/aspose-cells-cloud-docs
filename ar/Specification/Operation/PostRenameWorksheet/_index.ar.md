...
type: docs
url: /ar/specification/operation/postrenameworksheet/
description: إعادة تسمية ورقة العمل في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostRenameWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/rename,POST,إعادة تسمية ورقة العمل في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostRenameWorksheet\'>PostRenameWorksheet< /أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="اسم جديد، سلسلة، اسم ورقة العمل الجديدة." >}} 
