...
type: docs
url: /ar/specification/operation/postpagesetup/
description: تحديث إعداد الصفحة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostPageSetup
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup,POST,تحديث إعداد الصفحة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PageSetup/PostPageSetup\'>PostPageSetup </أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="pageSetup، class:pagesetup، PageSetup وصف إعداد الصفحة." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
