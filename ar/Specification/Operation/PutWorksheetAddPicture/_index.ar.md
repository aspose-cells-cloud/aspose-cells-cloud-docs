---
title: ضع ورقة عمل AddPictur
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworksheetaddpicture/
description: إضافة صورة جديدة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetAddPicture
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,أضف صورة جديدة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture\'> ضع ورقة عمل أضف صورة </a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftRow،عدد صحيح،الصف الأيسر العلوي للصورة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="UpperLeftColumn، عدد صحيح، العمود الأيسر العلوي للصورة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LowerRightRow، عدد صحيح، الصورة في الصف الأيمن السفلي." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="LowerRightColumn,integer,العمود الأيمن السفلي للصورة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="PicturePath,string,مسار الصورة، إذا لم يتم توفيره، فسيتم فحص بيانات الصورة في نص الطلب." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="صورة، فئة: صورة، كائن Pictute" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
