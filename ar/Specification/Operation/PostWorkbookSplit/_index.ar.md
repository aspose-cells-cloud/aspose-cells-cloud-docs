...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/split,POST,قم بتقسيم المصنف بتنسيق معين.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit\'>PostWorkbookSplit</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="تنسيق، سلسلة، تنسيق سبليت." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="سلسلة خارجية," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="من عدد صحيح، بدء فهرس ورقة العمل." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="إلى، عدد صحيح، إنهاء فهرس ورقة العمل." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" SplitNameRule، string، اسم القاعدة: اسم الورقة newguid" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="اسم التخزين الخارجي، سلسلة،" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
