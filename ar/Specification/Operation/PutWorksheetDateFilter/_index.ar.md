---
title: ضع ورقة عملDateFilte
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putworksheetdatefilter/
description: تطبيق عامل تصفية التاريخ في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutWorksheetDateFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,PUT,تطبيق مرشح التاريخ في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetDateFilter \'>PutWorksheetDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,يحدد كيفية تجميع قيم dateTime (اليوم، الساعة، الدقيقة، الشهر، الثانية، السنة)." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="السنة، عدد صحيح، السنة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="الشهر، عدد صحيح، الشهر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="اليوم، عدد صحيح، اليوم." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="الساعة، عدد صحيح، الساعة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="الدقيقة، عدد صحيح، الدقيقة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="الثاني، عدد صحيح، الثاني." >}} 
