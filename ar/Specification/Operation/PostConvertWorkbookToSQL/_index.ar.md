...
type: docs
url: /ar/specification/operation/postconvertworkbooktosql/
description: تحويل ملف Excel إلى ملفات SQL Script
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToSQL
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/sql,POST,تحويل ملف Excel إلى ملفات SQL Script.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToSQL\'>PostConvertWorkbookToSQL</a>" >}}
