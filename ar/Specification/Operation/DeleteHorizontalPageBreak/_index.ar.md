---
title: حذفHorizontalPageBrea
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deletehorizontalpagebreak/
description: حذف فاصل الصفحات الأفقي في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذفHorizontalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks/{index},DELETE,حذف فاصل صفحات أفقي في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ PageBreaks/DeleteHorizontalPageBreak\'>DeleteHorizontalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="فهرس، عدد صحيح، يزيل عنصر فاصل الصفحات الأفقي عند اسم محدد. مؤشر العنصر، على أساس صفر." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
