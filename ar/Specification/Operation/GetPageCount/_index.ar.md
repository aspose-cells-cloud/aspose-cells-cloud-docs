...
type: docs
url: /ar/specification/operation/getpagecount/
description: الحصول على عدد الصفحات في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/pagecount,GET,الحصول على عدد الصفحات في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount\'>GetPageCount</a>" >}}
