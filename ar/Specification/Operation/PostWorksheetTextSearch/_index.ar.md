...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/findText,POST,البحث عن نص في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextSearch\'>PostWorksheetTextSearch </أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="نص، سلسلة، نص للبحث." >}} 
