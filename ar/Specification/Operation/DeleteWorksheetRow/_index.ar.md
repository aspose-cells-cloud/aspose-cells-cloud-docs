...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},DELETE,حذف صف في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ Cells/DeleteWorksheetRow\'>DeleteWorksheetRow</a>" >}}
