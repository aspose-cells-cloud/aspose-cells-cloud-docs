...
type: docs
url: /ar/specification/operation/postbatchunlock/
description: فتح الملفات دفعة واحدة التي تستوفي شروط مطابقة محددة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostBatchUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/batch/unlock,POST,فتح الملفات المجمعة التي تستوفي شروط مطابقة محددة.,<a href=\'https://apireference.aspose.cloud/cells/#/Batch/PostBatchUnlock\'>PostBatchUnlock</a>" >}}
