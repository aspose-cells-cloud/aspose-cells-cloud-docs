...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects/{objectNumber},GET,استرداد كائن OLE بتنسيق محدد في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells /#/OleObjects/GetWorksheetOleObject\'>GetWorksheetOleObject</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="رقم الكائن، عدد صحيح، رقم الكائن." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="تنسيق، سلسلة، تنسيق تحويل الكائن (PNG/TIFF/JPEG/GIF/EMF/BMP)." >}} 
