...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/importjson,POST,استيراد ملف بيانات JSON إلى المصنف. يمكن أن يكون ملف بيانات JSON إما ملفًا سحابيًا أو بيانات من HTTP URI.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostWorkbookImportJson\'>PostWorkbookImportJson</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="importJsonRequest,class:importjsonrequest,استيراد طلب Json." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
