...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/defaultstyle,GET,استرجاع وصف النمط الافتراضي للمصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookDefaultStyle\'>GetWorkbookDefaultStyle</ أ>" >}}
