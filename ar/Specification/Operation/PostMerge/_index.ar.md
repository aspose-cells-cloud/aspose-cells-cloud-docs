...
type: docs
url: /ar/specification/operation/postmerge/
description: دمج الخلايا في ورقة العمل
kwords: Excel, Office, جدول البيانات, Cloud REST API, PostMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/merge,POST,دمج الخلايا في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMerge\'>PostMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergeToOneSheet,boolean,دمج كافة المصنفات في ورقة." >}} 
