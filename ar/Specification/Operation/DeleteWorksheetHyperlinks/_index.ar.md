---
title: حذف ورقة العمل الارتباط التشعبي
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheethyperlinks/
description: حذف كافة الارتباطات التشعبية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف ورقة العمل، الارتباطات التشعبية
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks,DELETE,حذف كافة الارتباطات التشعبية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlinks\'>DeleteWorksheetHyperlinks </أ>" >}}
