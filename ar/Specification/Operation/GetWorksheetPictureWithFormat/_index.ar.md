...
type: docs
url: /ar/specification/operation/getworksheetpicturewithformat/
description: استرجاع صورة حسب الرقم في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetPictureWithFormat
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures/{pictureNumber},GET,استرجاع صورة حسب الرقم في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ الصور/GetWorksheetPictureWithFormat\'>GetWorksheetPictureWithFormat</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="رقم الصورة، عدد صحيح، فهرس الصورة." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="تنسيق، سلسلة، تنسيق تحويل الصور (PNG/TIFF/JPEG/GIF/EMF/BMP)." >}} 
