---
title: حذف ورقة العملPivotTableFilte
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetpivottablefilter/
description: حذف عامل تصفية محوري في PivotTable
kwords: Excel، Office، جدول البيانات، Cloud REST API، DeleteWorksheetPivotTableFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters/{fieldIndex},DELETE,حذف عامل تصفية محوري في PivotTable.,<a href=\'https://apireference.aspose.cloud /cells/#/PivotTables/DeleteWorksheetPivotTableFilter\'>DeleteWorksheetPivotTableFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="fieldIndex,integer,يحصل على كائن PivotField في فهرس محدد." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
