...
type: docs
url: /ar/specification/operation/postworksheettextreplace/
description: استبدال النص القديم بنص جديد في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetTextReplace
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/replaceText,POST,استبدل النص القديم بنص جديد في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextReplace \'>PostWorksheetTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,النص القديم المراد استبداله." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,النص الجديد الذي سيتم استبداله." >}} 
