...
type: docs
url: /ar/specification/operation/postmoveworksheet/
description: نقل ورقة العمل في المصنف
kwords: Excel, Office, جدول البيانات, Cloud REST API, PostMoveWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/position,POST,نقل ورقة العمل في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostMoveWorksheet\'>PostMoveWorksheet< /أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="متحرك، فئة: طلب نقل ورقة العمل، طلب نقل ورقة العمل مع نقل المعلمات." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
