---
title: حذفUnProtectWorkboo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteunprotectworkbook/
description: Excel فك الحماية
kwords: Excel، Office، جدول البيانات، Cloud REST API، RemoveUnProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="كلمة المرور، سلسلة، إعدادات الحماية، يمكن تحديد كلمة المرور فقط." >}} 
