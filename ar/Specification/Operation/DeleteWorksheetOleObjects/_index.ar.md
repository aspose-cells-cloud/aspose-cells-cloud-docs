---
title: حذف ورقة العملOleObject
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetoleobjects/
description: حذف كافة كائنات OLE في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، حذف ورقة العملOleObjects
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/oleobjects,DELETE,حذف كافة كائنات OLE في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/OleObjects/DeleteWorksheetOleObjects\'> حذف ورقة العملOleObjects</a>" >}}
