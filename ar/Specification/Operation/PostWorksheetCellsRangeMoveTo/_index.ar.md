...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/moveto,POST,انقل النطاق الحالي إلى النطاق الوجهة.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/ PostWorksheetCellsRangeMoveTo\'>PostWorksheetCellsRangeMoveTo</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destRow,integer,صف البداية للنطاق dest." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destColumn,integer,عمود البداية للنطاق dest." >}} 
