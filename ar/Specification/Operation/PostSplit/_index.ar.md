...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/split,POST,Split Excel ملفات جداول البيانات بناءً على أوراق العمل وإنشاء ملفات الإخراج بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostSplit\'>PostSplit</ أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="من، عدد صحيح، فهرس الورقة" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="إلى، عدد صحيح، فهرس الورقة" >}} 
