---
title: حذف شكل ورقة العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetshapes/
description: حذف كافة الأشكال في ورقة العمل
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,DELETE,حذف جميع الأشكال في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShapes\'>DeleteWorksheetShapes </أ>" >}}
