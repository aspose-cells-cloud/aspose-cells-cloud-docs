...
type: docs
url: /ar/specification/operation/postconvertworkbooktopdf/
description: تحويل ملف Excel إلى PDF ملف
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToPDF
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/pdf,POST,تحويل ملف Excel إلى PDF ملف.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPDF\'>PostConvertWorkbookToPDF</a>" >}}
