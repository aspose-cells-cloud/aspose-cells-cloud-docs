---
title: صف PostAutofitWorksheet
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postautofitworksheetrows/
description: الاحتواء التلقائي للصفوف في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostAutofitWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrows,POST,الصفوف التلقائية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRows\'>PostAutofitWorksheetRows< /أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="OnlyAuto,boolean,Autofits كافة الصفوف في ورقة العمل هذه." >}} 
