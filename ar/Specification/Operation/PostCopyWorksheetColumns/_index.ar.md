...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/copy,POST,نسخ البيانات من أعمدة المصدر إلى أعمدة الوجهة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetColumns\'>PostCopyWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex، عدد صحيح، فهرس العمود المصدر" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="DestinationColumnIndex، عدد صحيح، فهرس عمود الوجهة" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="رقم العمود، عدد صحيح، رقم العمود المنسوخ" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ورقة العمل، سلسلة، اسم ورقة العمل الوجهة." >}} 
