...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/assemble,POST,تجميع ملفات البيانات باستخدام ملفات القالب لإنشاء ملفات بتنسيقات مختلفة.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostAssemble\'>PostAssemble</a>" >}}
