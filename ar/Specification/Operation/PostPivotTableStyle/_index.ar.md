...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/FormatAll,POST,تحديث النمط في PivotTable.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables /PostPivotTableStyle\'>PostPivotTableStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,StyleStyle الوصف في نص الطلب." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
