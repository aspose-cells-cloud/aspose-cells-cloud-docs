...
type: docs
url: /ar/specification/operation/postworksheetlistobjectconverttorange/
description: تحويل كائن القائمة إلى نطاق في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetListObjectConvertToRange
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/ConvertToRange,POST,تحويل كائن القائمة إلى نطاق في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/ #/ListObjects/PostWorksheetListObjectConvertToRange\'>PostWorksheetListObjectConvertToRange</a>" >}}
