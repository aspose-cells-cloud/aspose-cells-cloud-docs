...
type: docs
url: /ar/specification/operation/postungroupworksheetcolumns/
description: فك تجميع أعمدة ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostUngroupWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,فك تجميع أعمدة ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns\'> PostUngroupWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,فهرس العمود الأول المراد تشغيله." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex، عدد صحيح، فهرس العمود الأخير الذي سيتم تشغيله." >}} 
