...
type: docs
url: /ar/specification/operation/getworksheetconditionalformatting/
description: استرداد أوصاف التنسيق الشرطي في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetConditionalFormatting
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},GET,استرداد أوصاف التنسيق الشرطي في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings /GetWorksheetConditionalFormatting\'>GetWorksheetConditionalFormatting</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="فهرس، عدد صحيح، فهرس التنسيق الشرطي." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
