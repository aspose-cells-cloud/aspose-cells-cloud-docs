...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,GET,استرجاع وصف أوراق العمل من مصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets\'>GetWorksheets</a>" >}}
