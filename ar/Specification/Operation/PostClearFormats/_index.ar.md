---
title: تنسيق بوست كلير
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postclearformats/
description: مسح تنسيقات الخلايا في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostClearFormats
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/clearformats,POST,مسح تنسيقات الخلايا في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats\' >تنسيقات بوستكلير</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow، عدد صحيح، فهرس صف البداية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn، عدد صحيح، فهرس عمود البداية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow، عدد صحيح، فهرس صف النهاية." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endColumn، عدد صحيح، فهرس عمود النهاية." >}} 
