...
type: docs
url: /ar/specification/operation/postconvertworkbooktojson/
description: تحويل ملف Excel إلى ملفات Json
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostConvertWorkbookToJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,تحويل ملف Excel إلى ملفات Json.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
