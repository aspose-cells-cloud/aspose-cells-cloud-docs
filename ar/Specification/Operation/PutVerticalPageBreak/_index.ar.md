...
type: docs
url: /ar/specification/operation/putverticalpagebreak/
description: إضافة فاصل صفحات عمودي في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutVerticalPageBreak
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/verticalpagebreaks,PUT,أضف فاصل صفحات رأسيًا في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/PageBreaks/PutVerticalPageBreak\' >PutVerticalPageBreak</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="startRow، عدد صحيح، فهرس صف البداية، على أساس صفر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="endRow، عدد صحيح، فهرس صف النهاية، على أساس صفر." >}} 
