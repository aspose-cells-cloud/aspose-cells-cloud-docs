---
title: صف ورقة عمل PostCopy
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postcopyworksheetrows/
description: انسخ البيانات والتنسيقات من صفوف كاملة محددة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostCopyWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/copy,POST,نسخ البيانات والتنسيقات من صفوف كاملة محددة في ورقة العمل.<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostCopyWorksheetRows\'>PostCopyWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceRowIndex، عدد صحيح، فهرس الصف المصدر" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="DestinationRowIndex، عدد صحيح، فهرس صف الوجهة" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="رقم الصف، عدد صحيح، رقم الصف المنسوخ" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="ورقة العمل، سلسلة، اسم ورقة العمل." >}} 
