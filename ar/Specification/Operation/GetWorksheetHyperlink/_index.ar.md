...
type: docs
url: /ar/specification/operation/getworksheethyperlink/
description: استرداد وصف الارتباط التشعبي حسب الفهرس في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، GetWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},GET,استرداد وصف الارتباط التشعبي حسب الفهرس في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ الروابط التشعبية/GetWorksheetHyperlink\'>GetWorksheetHyperlink</a>" >}}
