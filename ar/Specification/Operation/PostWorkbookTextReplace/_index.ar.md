...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/replaceText,POST,استبدال النص في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookTextReplace\'>PostWorkbookTextReplace</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue، سلسلة، القيمة القديمة." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue، سلسلة، القيمة الجديدة." >}} 
