...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,استرجاع قيم الخلايا ضمن النطاق المحدد.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges /GetWorksheetCellsRangeValue\'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="firstRow,integer,يحصل على فهرس الصف الأول من النطاق." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn,integer,يحصل على فهرس العمود الأول من النطاق." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,integer,يحصل على عدد الصفوف في النطاق." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnCount,integer,يحصل على عدد الأعمدة في النطاق." >}} 
