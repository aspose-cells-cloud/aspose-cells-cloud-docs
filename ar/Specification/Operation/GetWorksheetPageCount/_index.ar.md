...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagecount,GET,الحصول على عدد الصفحات في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetPageCount\'>GetWorksheetPageCount </أ>" >}}
