...
type: docs
url: /ar/specification/operation/postworksheetvalidation/
description: قم بتحديث التحقق من الصحة بواسطة الفهرس في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، التحقق من صحة ورقة العمل
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations/{validationIndex},POST,تحديث التحقق من الصحة عن طريق الفهرس في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/ WorksheetValidations/PostWorksheetValidation\'>PostWorksheetValidation</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="validationIndex، عدد صحيح، فهرس التحقق من الصحة." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="التحقق من الصحة، الفئة: التحقق من الصحة، وصف التحقق من الصحة." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
