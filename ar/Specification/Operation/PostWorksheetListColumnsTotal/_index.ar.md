...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/listcolumns/total,POST,تحديث إجمالي أعمدة القائمة في الجدول.,<a href=\'https://apireference.aspose.cloud/ cell/#/ListObjects/PostWorksheetListColumnsTotal\'>PostWorksheetListColumnsTotal</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="tableTotalRequests,container,يمثل وصف عمود الجدول." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
