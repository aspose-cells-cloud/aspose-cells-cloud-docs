...
type: docs
url: /ar/specification/operation/postprotectworkbook/
description: Excel الحماية
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostProtectWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ProtectWorkbookRequest,class:protectworkbookrequest,إعدادات الحماية." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
