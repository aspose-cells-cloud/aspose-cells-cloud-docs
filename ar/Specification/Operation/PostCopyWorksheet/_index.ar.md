...
type: docs
url: /ar/specification/operation/postcopyworksheet/
description: نسخ المحتويات والتنسيقات من ورقة عمل أخرى
kwords: Excel، Office، جدول البيانات، Cloud REST API، ورقة عمل PostCopy
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,نسخ المحتويات والتنسيقات من ورقة عمل أخرى.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet\'> ورقة عمل ما بعد النسخ</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="ورقة المصدر، سلسلة، ورقة العمل المصدر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="مصدر المصنف، سلسلة، المصنف المصدر." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder، سلسلة، مجلد المصنف الأصلي." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="خيارات، فئة: Copyoptions، يمثل خيارات النسخ." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
