...
type: docs
url: /ar/specification/operation/postunhideworksheetcolumns/
description: إظهار أعمدة ورقة العمل في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostUnhideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,إظهار أعمدة ورقة العمل في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostUnhideWorksheetColumns\'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn، عدد صحيح، فهرس العمود الذي سيتم تشغيله." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="TotalColumns، عدد صحيح، عدد الأعمدة التي سيتم تشغيلها." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,يحصل على عرض العمود ويحدده بوحدة الأحرف." >}} 
