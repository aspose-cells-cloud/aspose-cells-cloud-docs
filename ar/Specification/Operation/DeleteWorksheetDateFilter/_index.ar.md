...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,DELETE,إزالة عامل تصفية التاريخ في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter \'>حذف ورقة العملDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,يحدد كيفية تجميع قيم dateTime." >}} 
