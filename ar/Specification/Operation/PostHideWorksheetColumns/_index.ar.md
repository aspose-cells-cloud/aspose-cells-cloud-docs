...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,إخفاء أعمدة ورقة العمل في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/ PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
