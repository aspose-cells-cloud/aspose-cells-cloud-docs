---
title: إعداد ما بعد العمل
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/postworkbooksettings/
description: تحديث الإعداد في المصنف
kwords: Excel، Office، جدول البيانات، Cloud REST API، إعدادات PostWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,تحديث الإعداد في المصنف.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings\'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="الإعدادات، الفئة: إعدادات المصنف، وصف إعداد المصنف." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
