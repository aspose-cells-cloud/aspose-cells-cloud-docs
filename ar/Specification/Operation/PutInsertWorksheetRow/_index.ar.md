...
type: docs
url: /ar/specification/operation/putinsertworksheetrow/
description: قم بإدراج صف جديد في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutInsertWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},PUT,أدخل صفًا جديدًا في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/# /Cells/PutInsertWorksheetRow\'>PutInsertWorksheetRow</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="RowIndex، عدد صحيح، فهرس الصف الجديد." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
