...
type: docs
url: /ar/specification/operation/postupdateworksheetcellstyle/
description: قم بتعيين نمط الخلية باستخدام اسم الخلية في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostUpdateWorksheetCellStyle
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/style,POST,تعيين نمط الخلية باستخدام اسم الخلية في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells /#/Cells/PostUpdateWorksheetCellStyle\'>PostUpdateWorksheetCellStyle</a>" >}}
