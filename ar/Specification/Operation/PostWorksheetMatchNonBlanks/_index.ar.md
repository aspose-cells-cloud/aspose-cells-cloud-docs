...
type: docs
url: /ar/specification/operation/postworksheetmatchnonblanks/
description: مطابقة كافة الخلايا غير الفارغة في القائمة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetMatchNonBlanks
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/matchNonBlanks,POST,مطابقة كافة الخلايا غير الفارغة في القائمة.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/ PostWorksheetMatchNonBlanks\'>PostWorksheetMatchNonBlanks</a>" >}}
