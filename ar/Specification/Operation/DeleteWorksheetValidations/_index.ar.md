---
title: حذف ورقة العملالتحقق من الصحة
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/deleteworksheetvalidations/
description: حذف كافة عمليات التحقق من الصحة في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، RemoveWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,DELETE,حذف كافة عمليات التحقق من الصحة في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidations\'>DeleteWorksheetValidations </أ>" >}}
