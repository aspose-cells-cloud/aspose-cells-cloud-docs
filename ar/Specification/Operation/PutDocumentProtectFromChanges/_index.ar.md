---
title: وضع الوثيقةProtectFromChange
second_title: Aspose.Cells Cloud Documen
type: docs
url: /ar/specification/operation/putdocumentprotectfromchanges/
description: Excel ملف الحماية ضد الكتابة
kwords: Excel، Office، جدول البيانات، Cloud REST API، PutDocumentProtectFromChanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/writeProtection,PUT,Excel حماية ضد كتابة الملفات.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PutDocumentProtectFromChanges\'>PutDocumentProtectFromChanges</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="كلمة المرور، الفئة: طلب كلمة المرور، كلمة المرور اللازمة لفتح ملف Excel." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
