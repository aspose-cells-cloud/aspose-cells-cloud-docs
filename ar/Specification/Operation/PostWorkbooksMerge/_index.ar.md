...
type: docs
url: /ar/specification/operation/postworkbooksmerge/
description: دمج مصنف في المصنف الموجود
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorkbooksMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/merge,POST,دمج مصنفًا في المصنف الموجود.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksMerge\'>PostWorkbooksMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="mergeWith,string,المصنف المراد الدمج معه." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="اسم التخزين المدمج، السلسلة، اسم التخزين." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
