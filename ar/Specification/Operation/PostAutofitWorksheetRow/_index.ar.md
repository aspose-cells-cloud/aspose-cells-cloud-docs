...
type: docs
url: /ar/specification/operation/postautofitworksheetrow/
description: احتواء تلقائي لصف في ورقة العمل
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostAutofitWorksheetRow
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autofitrow,POST,الاحتواء التلقائي لصف في ورقة العمل.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostAutofitWorksheetRow\'>PostAutofitWorksheetRow </أ>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="firstColumn، عدد صحيح، فهرس العمود الأول." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastColumn، عدد صحيح، فهرس العمود الأخير." >}} 
