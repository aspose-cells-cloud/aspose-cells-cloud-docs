...
type: docs
url: /ar/specification/operation/postworksheetcellsrangeunmerge/
description: قم بإلغاء دمج الخلايا المدمجة ضمن هذا النطاق
kwords: Excel، Office، جدول البيانات، Cloud REST API، PostWorksheetCellsRangeUnMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API، طريقة المتشعب، الوصف، مرجع API" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/unmerge,POST,إلغاء دمج الخلايا المدمجة ضمن هذا النطاق.,<a href=\'https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeUnMerge\' >PostWorksheetCellsRangeUnMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="اسم المعلمة، النوع، الوصف" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="النطاق، الفئة: النطاق، وصف نطاق النطاق." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
