...
type: docs
url: /ar/specification/model/label/
description: "Aspose.Cells مواصفات نموذج السحابة: الملصق. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, التسمية
weight: 50
---
## **ملصق**

 يقوم بتغليف الكائن الذي يمثل تسمية في جدول بيانات.
