...
type: docs
url: /ar/specification/model/textbox/
description: "Aspose.Cells مواصفات النموذج السحابي: TextBox. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, TextBox
weight: 50
---
## **مربع الكتابة**

 يقوم بتغليف الكائن الذي يمثل مربع نص في جدول بيانات.
