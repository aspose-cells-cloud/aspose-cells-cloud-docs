...
type: docs
url: /ar/specification/model/cellsdrawing/
description: "Aspose.Cells مواصفات النموذج السحابي: رسم الخلايا. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, CellsDrawing
weight: 50
---
## **رسم الخلايا**
