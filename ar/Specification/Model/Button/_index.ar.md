...
type: docs
url: /ar/specification/model/button/
description: "Aspose.Cells مواصفات نموذج السحابة: زر. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, زر
weight: 50
---
## **زر**

 يمثل عنصر التحكم في النماذج: الزر
