...
type: docs
url: /ar/specification/model/chartshape/
description: "Aspose.Cells مواصفات النموذج السحابي: ChartShape. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel، Office، جدول البيانات، Cloud REST API، ChartShape
weight: 50
---
## **com.chartShape**

 كائن شكل الرسم البياني
