...
type: docs
url: /ar/specification/model/radiobutton/
description: "Aspose.Cells مواصفات النموذج السحابي: RadioButton. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, RadioButton
weight: 50
---
## **زر الراديو**
...
|:- |:- |:- |:- |:- |:- |
| صندوق المجموعة| الفئة: صندوق المجموعة| حقيقي| خطأ شنيع|| يحصل على GroupBox الذي يحتوي على زر الراديو هذا.|
| مفحوص| منطقية| حقيقي| خطأ شنيع|| يشير إلى ما إذا كان زر الراديو محددًا أم لا.|
