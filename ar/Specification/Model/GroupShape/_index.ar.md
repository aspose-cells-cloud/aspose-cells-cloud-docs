...
type: docs
url: /ar/specification/model/groupshape/
description: "Aspose.Cells مواصفات النموذج السحابي: GroupShape. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, GroupShape
weight: 50
---
## **com.groupShape**
