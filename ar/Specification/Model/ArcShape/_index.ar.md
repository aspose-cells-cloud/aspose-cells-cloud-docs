...
type: docs
url: /ar/specification/model/arcshape/
description: "Aspose.Cells مواصفات النموذج السحابي: ArcShape. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, ArcShape
weight: 50
---
## **com.arcShape**
