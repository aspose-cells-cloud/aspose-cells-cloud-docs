...
type: docs
url: /ar/specification/model/checkbox/
description: "Aspose.Cells مواصفات النموذج السحابي: CheckBox. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, CheckBox
weight: 50
---
## **checkBox**

 يمثل كائن خانة الاختيار في ورقة العمل.

| اسم الخاصية| نوع الملكية| لاغية| يقرأ فقط| القيمة الافتراضية| وصف|
|:- |:- |:- |:- |:- |:- |
| قيمة محددة| خيط| حقيقي| خطأ شنيع|| الحصول على قيمة خانة الاختيار أو تعيينها.|
| ظل| منطقية| حقيقي| خطأ شنيع|| يشير إلى ما إذا كان مربع التحرير والسرد يحتوي على تظليل ثلاثي الأبعاد.|
| قيمة| منطقية| حقيقي| خطأ شنيع|| يشير إلى ما إذا تم تحديد خانة الاختيار أم لا.|
