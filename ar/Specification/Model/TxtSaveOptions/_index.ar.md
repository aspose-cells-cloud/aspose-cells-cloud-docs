...
kwords: Excel، Office، جدول البيانات، Cloud REST API، TxtSaveOptions
weight: 50
---
## **com.txtSaveOptions**
...
| دائما مقتبس| منطقية| حقيقي| خطأ شنيع||يشير إلى ما إذا كان سيتم دائمًا إضافة '"' لكل حقل. إذا كان صحيحًا، فسيتم نقل كافة القيم؛ وإذا كان خطأ، فسيتم نقل القيم فقط عند الحاجة (على سبيل المثال، عندما تحتوي القيم على أحرف خاصة مثل '"' أو '\n' أو حرف فاصل). الافتراضي خطأ.|
