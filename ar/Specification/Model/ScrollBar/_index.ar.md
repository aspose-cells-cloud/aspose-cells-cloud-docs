...
type: docs
url: /ar/specification/model/scrollbar/
description: "Aspose.Cells مواصفات النموذج السحابي: ScrollBar. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel، Office، جدول البيانات، Cloud REST API، شريط التمرير
weight: 50
---
## **ScrollBar**
...
| أفقي| منطقية| حقيقي| خطأ شنيع|| يشير إلى ما إذا كان هذا شريط تمرير أفقيًا.|
...
| تغيير الصفحة| عدد صحيح| حقيقي| خطأ شنيع|| الحصول على تغيير الصفحة أو تعيينه|
