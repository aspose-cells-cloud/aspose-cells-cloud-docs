...
type: docs
url: /ar/specification/model/autoshape/
description: "Aspose.Cells مواصفات النموذج السحابي: شكل تلقائي. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel، Office، جدول البيانات، Cloud REST API، الشكل التلقائي
weight: 50
---
## **com.autoShape**
