...
type: docs
url: /ar/specification/model/form/
description: "Aspose.Cells مواصفات النموذج السحابي: النموذج. تعامل بسهولة مع Excel ومستندات جداول البيانات الأخرى التي تحتوي على ميزات مثل الفتح والتوليد والتحرير والتقسيم والدمج والمقارنة والتحويل"
kwords: Excel, Office, جدول البيانات, Cloud REST API, النموذج
weight: 50
---
## **استمارة**
...
|:- |:- |:- |:- |:- |:- |
| نوع النموذج| خيط| حقيقي| خطأ شنيع|||
| قيمة محددة| خيط| حقيقي| خطأ شنيع|||
| ظل| منطقية| حقيقي| خطأ شنيع|||
| نطاق الإدخال| خيط| حقيقي| خطأ شنيع|||
| الفهرس المحدد| عدد صحيح| حقيقي| خطأ شنيع|||
| القيمة المحددة| خيط| حقيقي| خطأ شنيع|||
| الخلية المحددة| الفئة: عنصر الارتباط| حقيقي| خطأ شنيع|||
| DropDownLines| عدد صحيح| حقيقي| خطأ شنيع|||
| عدد الأصناف| عدد صحيح| حقيقي| خطأ شنيع|||
| الخلايا المحددة| حاوية| حقيقي| خطأ شنيع|||
| نوع التحديد| خيط| حقيقي| خطأ شنيع|||
| مفحوص| منطقية| حقيقي| خطأ شنيع|||
| القيمة الحالية| عدد صحيح| حقيقي| خطأ شنيع|||
| دقيقة| عدد صحيح| حقيقي| خطأ شنيع|||
| الأعلى| عدد صحيح| حقيقي| خطأ شنيع|||
| تغيير تدريجي| عدد صحيح| حقيقي| خطأ شنيع|||
| تغيير الصفحة| عدد صحيح| حقيقي| خطأ شنيع|||
| أفقي| منطقية| حقيقي| خطأ شنيع|||
