...
**Authentication** – The API requires an OAuth 2.0 access token. Include it in the request header:
...
```bash
curl -X PUT "https://api.aspose.cloud/v4.0/cells/Annual_Report.xlsx/worksheets/DataSheet1/search/broken-links?folder=Reports&storageName=MyStorage&region=en-US" \
