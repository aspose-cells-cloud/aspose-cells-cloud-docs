---
title: "Aspose.Cells Cloud API – Replace Text in Remote Excel Spreadsheets (Find & Replace)"
second_title: "Document"
ArticleTitle: "Bulk Text Replacement in Cloud Excel Files Using Aspose.Cells Find & Replace API"
linktitle: "Replace Remote Spreadsheet Content"
type: docs
url: /replace-content-in-remote-spreadsheet/
keywords: "Aspose.Cells Cloud, replace text, remote spreadsheet, find and replace API, Excel API, cloud Excel, bulk text replacement"
description: "Bulk replace text in Excel workbooks stored in the cloud with Aspose.Cells Cloud Find & Replace API. Learn request syntax, parameters, SDK examples, and error handling."
weight: 100
---
...
| **searchText**  | String | Query    | String to locate within the entire workbook. The search is case‑sensitive and applies to all worksheets unless constrained by other parameters. |
