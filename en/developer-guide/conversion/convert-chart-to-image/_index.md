...
keywords: "convert chart to image, Aspose.Cells, Excel chart export, PNG, SVG, JPEG, BMP, TIFF"
...
| Code | Description |
| ---- | ----------- |
| 200  | Image generated and returned successfully. |
| 400  | Invalid Aspose.Cells Cloud API URI. |
| 401  | Invalid access token, or invalid client ID and secret. |
| 404  | The spreadsheet file is not accessible. |
| 500  | The spreadsheet encountered an error while obtaining calculation data. |
...
The <a href="https://reference.aspose.cloud/cells/?urls.primaryName=API+v4#/Conversion/ConvertChartToImage" rel="noopener noreferrer">Convert Chart to Image API Specification</a> defines a publicly accessible programming interface and enables you to carry out REST interactions directly from a web browser.
