...
**Prerequisites**  
- A valid OAuth 2.0 access token (client‑id and client‑secret) is required for all calls.  
- Supported input formats include `.xlsx`, `.xls`, `.xlsb`, and other Excel workbook types.  
- The service enforces standard quota limits; see the Aspose.Cells Cloud usage policy for details.
...
*Example snippet of the returned HTML (truncated):*
...
<head>
    <meta charset="UTF-8">
    <title>Sheet1</title>
    <style>/* inline styles generated by Aspose.Cells */</style>
</head>
<body>
    <table>
