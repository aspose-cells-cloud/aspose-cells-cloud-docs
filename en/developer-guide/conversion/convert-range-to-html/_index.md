---
title: "Convert Excel Range to HTML – Aspose.Cells Cloud API (v5)"
second_title: "Document"
ArticleTitle: "Step‑by‑Step Guide to Convert an Excel Range to HTML with Aspose.Cells Cloud API"
linktitle: "Convert Range to HTML"
type: docs
url: /convert-range-to-html/
keywords: "Aspose.Cells, Excel to HTML, convert range to HTML, cloud API, REST, spreadsheet conversion"
description: "Learn how to convert a specific Excel range (e.g., A1:C10) to HTML with Aspose.Cells Cloud REST API. Includes auth steps, cURL and SDK examples."
weight: 100
---
...
```http
PUT https://api.aspose.cloud/v5.0/cells/convert/range/html
```
...
| outPath        | String | Query    | Optional folder path on cloud storage where the resulting HTML file will be saved. If omitted, the file is returned in the response stream. |
| outStorageName | String | Query    | Name of the output file storage. |
| fontsLocation  | String | Query    | Custom fonts location on cloud storage. |
...
```bash
curl -X PUT "https://api.aspose.cloud/v5.0/cells/convert/range/html?worksheet=Sheet1&range=A1:C10" \
