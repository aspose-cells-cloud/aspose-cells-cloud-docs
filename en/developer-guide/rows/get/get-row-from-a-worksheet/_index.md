...
keywords: "Get row info on an Excel worksheet"
description: "Aspose.Cells Cloud REST API support getting row info on an Excel worksheet. SDK support kinds of development languages. They include Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby, and swift."
weight: 10
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdwon, Get row description from an Excel worksheet
---

This REST API indicates to get a row data by row's index on an Excel worksheet.
...
The [OpenAPI Specification](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRow) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
