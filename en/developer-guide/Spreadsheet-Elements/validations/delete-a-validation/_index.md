...
weight: 10
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, Json, Markdown, Delete a worksheet validation on an Excel worksheet
---

This REST API indicates to delete a worksheet validation by index on an Excel worksheet.
