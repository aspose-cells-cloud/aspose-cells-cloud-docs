---
title: "Add multi rows on an Excel worksheet"
second_title: "Document"
linktitle: "Rows"
type: docs
url: /rows/add/rows/
keywords: "Add multi rows on an Excel worksheet"
description: "Aspose.Cells Cloud REST API support adding  multi rows on an Excel worksheet. SDK support kinds of development languages. They include Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby, and swift."
weight: 20
kwords: Excel, Office Cloud, REST API, Spreadsheet, PDF, CSV, JSON, Markdown, Add multi rows on an Excel worksheet
---
This REST API indicates to add several new worksheet rows on an Excel worksheet.
