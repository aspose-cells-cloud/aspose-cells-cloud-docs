...
keywords: "Aspose.Cells, Excel, worksheet background, REST API, add background, delete background, SDK"
description: "Learn how to set or remove a background image on an Excel worksheet using Aspose.Cells Cloud REST API. Includes request syntax, SDK examples (Java, .NET, Python, PHP) and error handling."
weight: 20
---

## Working with background on an Excel worksheet

**Overview:** A worksheet background is an image that appears behind the cells of a worksheet, useful for branding or visual cues. Aspose.Cells Cloud API lets you add or delete a background image programmatically.
