...
keywords: "Aspose.Cells Cloud, Excel, date filter, auto filter, REST API, worksheet"
description: "Use the Aspose.Cells Cloud API to add a date filter to an Excel worksheet. Supports cURL and multiple SDKs for various programming languages."
weight: 65
---
