...
type: docs
keywords: "Insert slicer, list object, Excel, Aspose.Cells, REST API, Cloud SDK"
url: /list-objects/insert-slicer/
description: "Learn how to insert a slicer into a list object on an Excel worksheet using the Aspose.Cells Cloud REST API."
weight: 20
---
