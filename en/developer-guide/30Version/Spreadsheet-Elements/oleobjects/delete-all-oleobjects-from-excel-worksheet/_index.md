...
_Full source files for all supported languages are available in the [Aspose.Cells Cloud GitHub repository](https://github.com/aspose-cells-cloud)._
...
**A:** This endpoint deletes **all** OLE objects in the worksheet. To remove a single object, use the _Delete a specific OLE object_ operation.
