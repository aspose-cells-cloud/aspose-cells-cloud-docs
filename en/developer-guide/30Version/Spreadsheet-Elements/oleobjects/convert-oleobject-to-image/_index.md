...
_Replace `<jwt-token>` with a valid JWT token._
...
- **Encode to Base64** for debugging or embedding in JSON:
  ...
  _Sample (truncated) Base64 output:_
...
_(The full list of SDKs is available in the [GitHub repository](https://github.com/aspose-cells-cloud).)_
