...
description: "Learn how to set a formula for a specific cell in an Excel worksheet using Aspose.Cells Cloud REST API, with examples for cURL and multiple SDKs."
---
...
| type           | string | query    | Data type of the value (e.g., string).  |
| formula        | string | query    | Formula to apply to the cell.            |
