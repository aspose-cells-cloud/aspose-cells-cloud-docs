---
title: "Working with Excel Cells – Aspose.Cells Cloud API Guide"
second_title: "Document"
linktitle: "Cells"
type: docs
url: /working-with-cells/
aliases: [/working-with-worksheets/]
keywords: "Aspose.Cells, Excel, cell API, spreadsheet, cloud"
description: "Learn how to read, write, style, merge, and calculate Excel cells using Aspose.Cells Cloud API. Includes code samples, request formats, and best practices."
weight: 100
---

A cell is the basic operational object of Aspose.Cells for Excel files.
...
<div class="row">
    <div class="col-md-6">
        <ul>
            <li><a href="/cells/get-mergedcell-from-a-worksheet//">Get merged cell from a worksheet.</a></li>
            <li><a href="/cells/set-value-of-a-cell-in-a-worksheet/">Set the value of a cell in an Excel worksheet.</a></li>
            <li><a href="/cells/set-formula-for-a-cell-in-excel-worksheets/">Set formula for a cell in Excel worksheets.</a></li>
            <li><a href="/cells/calculate-cells-formula/">Calculate cell formulas.</a></li>
        </ul>
    </div>
</div>
{{< /tab >}}
