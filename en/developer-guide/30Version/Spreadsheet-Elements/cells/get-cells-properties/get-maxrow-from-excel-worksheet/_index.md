---
title: "Get MaxRow – Retrieve the Highest Row Index in an Excel Worksheet | Aspose.Cells Cloud API"
type: docs
url: /get-maxrow-from-excel-worksheet/
weight: 40
keywords: "Aspose.Cells, Excel, MaxRow, GetMaxRow, REST API, Cloud SDK, Spreadsheet, Worksheet"
description: "Learn how to use Aspose.Cells Cloud REST API to obtain the maximum row number of a worksheet. Includes cURL, SDK examples (C#, Java, Python, etc.), required parameters, and sample response."
---
