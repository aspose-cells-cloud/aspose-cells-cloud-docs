...
weight: 40
keywords: ["Aspose.Cells", "REST API", "Delete Chart", "Worksheet", "Excel", "Cloud SDK"]
description: "Deletes a chart from a worksheet by its index using the Aspose.Cells Cloud REST API."
---
