---
title: "Trim Characters, Spaces & Line Breaks – Aspose.Cells Cloud API"
second_title: "Document"
ArticleTitle: "Excel Data Cleaner – Trim Characters, Spaces & Line Breaks Online"
linktitle: "Trim Character"
type: docs
url: /trim-character/
keywords: "Aspose.Cells Cloud, Trim Character API, Excel text trimming, remove spaces, remove line breaks"
description: "Remove extra spaces, line breaks, and unwanted characters from Excel cells using Aspose.Cells Cloud Trim Character API. Fast, pay‑per‑use, no server required."
weight: 100
---
...
- **Special spaces removed**
  - Specifically clear non‑breaking spaces.
...
| trimContent             | String  | Query                      | Specifies the characters or strings to be trimmed from cell content. Can be a single character, multiple characters, or a custom pattern.                           |
...
Using the SDK is the best way to accelerate development. The SDK handles the underlying details, allowing you to simply implement Trim character for cells with minimal code. Please check out the [GitHub repository](https://github.com/aspose-cells-cloud) for a complete list of Aspose.Cells Cloud SDKs.
