---
title: "Aspose.Cells Cloud API – Split Excel Workbook Locally (30+ Formats)"
second_title: "Document"
ArticleTitle: "Split Excel Workbook Locally – Export to 30+ Formats with Aspose.Cells Cloud"
linktitle: "Split Spreadsheet"
type: docs
url: /split-spreadsheet/
keywords: "split excel workbook api, aspose cells cloud, split spreadsheet, export excel to pdf, export excel to csv, export excel to json"
description: "Use Aspose.Cells Cloud API to split a local Excel workbook into separate files in over 30 formats such as PDF, CSV, JSON, XLSX, and HTML, without uploading to the cloud. Learn request parameters, sample code, and error handling."
weight: 100
---
...
Using the SDK is the fastest way to develop, as it abstracts away the low‑level details, allowing you to split the spreadsheet into separate files with short code. Please check out the [GitHub repository](https://github.com/aspose-cells-cloud) for a complete list of Aspose.Cells Cloud SDKs.
