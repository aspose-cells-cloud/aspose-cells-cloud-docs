---
title: "Aspose.Cells Cloud SDK for Perl: Convert, merge, split, protect, search, replace, and more."
...
description: "Aspose.Cells Cloud SDK for Perl offers true cross-platform power: one import provides Windows, Linux, and macOS developers with the same fluent API to create, convert, merge, split, protect, and manipulate every Excel object—no Office installation is required, and no platform-specific tweaks are needed."
weight: 30
kwords: Perl, Perl SDK, Excel SDK for Perl, Cloud SDK for Perl, REST, Chart, Pivot Table, Table/List Object, Convert Spreadsheet, PDF, CSV, Json, Markdown, Merge, Split, Protect, Search, Replace
---
