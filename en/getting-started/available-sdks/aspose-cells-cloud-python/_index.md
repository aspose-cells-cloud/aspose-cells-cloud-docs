...
The SDK is open-source and has an MIT license. You can get the Node library source code about Aspose.Cells Cloud [here](https://github.com/aspose-cells-cloud/aspose-cells-cloud-python).
