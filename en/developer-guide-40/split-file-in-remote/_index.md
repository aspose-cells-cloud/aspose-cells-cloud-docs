## **Excel API : SplitFileInRemote **

Split a spreadsheet in cloud storage into the specified format, multi-file. 

```bash

PUT http://api.aspose.cloud/v4.0/cells/{name}/split
...
## The request parameters of **splitFileInRemote** API are: 
...
The [OpenAPI Specification](https://reference.aspose.cloud/cells/#/DataProcessingController/SplitFileInRemote) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
