...
PUT http://api.aspose.cloud/v4.0/cells/split
...
## The request parameters of **splitFile** API are: 
...
The [OpenAPI Specification](https://reference.aspose.cloud/cells/#/DataProcessingController/SplitFile) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
