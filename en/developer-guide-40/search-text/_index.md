## **Excel API : SearchText **

Search text in the local spreadsheet. 

```bash

PUT http://api.aspose.cloud/v4.0/cells/search
...
## The request parameters of **searchText** API are: 
...
The [OpenAPI Specification](https://reference.aspose.cloud/cells/#/SearchControllor/SearchText) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
