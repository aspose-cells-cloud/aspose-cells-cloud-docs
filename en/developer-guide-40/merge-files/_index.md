## **Excel API : MergeFiles **

Merge local spreadsheet files into a specified format file. 

```bash

PUT http://api.aspose.cloud/v4.0/cells/merge
...
## The request parameters of **mergeFiles** API are: 
...
The [OpenAPI Specification](https://reference.aspose.cloud/cells/#/DataProcessingController/MergeFiles) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
