## **Excel API : ReplaceText **

Replace text in the local spreadsheet. 

```bash

PUT http://api.aspose.cloud/v4.0/cells/replace
...
## The request parameters of **replaceText** API are: 
...
The [OpenAPI Specification](https://reference.aspose.cloud/cells/#/SearchControllor/ReplaceText) defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser.
