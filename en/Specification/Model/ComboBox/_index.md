...
description: "Aspose.Cells Cloud model specification : ComboBox. Effortlessly handle Excel and other spreadsheet documents with features like opening, generating, editing, splitting, merging, comparing, and converting."
kwords: Excel, Office, Spreadsheet, Cloud REST API, ComboBox
weight: 50
---
...
| SelectedCell | Class:LinkElement | True |  False |  | Gets the selected cell in the input range of the combo box. |  
