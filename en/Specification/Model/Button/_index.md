...
type: docs
url: /specification/model/button/
description: "Aspose.Cells Cloud model specification : Button. Effortlessly handle Excel and other spreadsheet documents with features like opening, generating, editing, splitting, merging, comparing, and converting."
kwords: Excel, Office, Spreadsheet, Cloud REST API, Button
weight: 50
---
