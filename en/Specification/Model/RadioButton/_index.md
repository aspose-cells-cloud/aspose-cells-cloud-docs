...
type: docs
url: /specification/model/radiobutton/
description: "Aspose.Cells Cloud model specification : RadioButton. Effortlessly handle Excel and other spreadsheet documents with features like opening, generating, editing, splitting, merging, comparing, and converting."
kwords: Excel, Office, Spreadsheet, Cloud REST API, RadioButton
weight: 50
---
...
| :- | :- | :- |:- |  :- | :- |
| GroupBox | Class:GroupBox | True |  False |  | Gets the GroupBox that contains this RadioButton. |  
