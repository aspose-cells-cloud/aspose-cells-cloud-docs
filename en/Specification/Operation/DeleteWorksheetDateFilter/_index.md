...
kwords: Excel, Office, Spreadsheet, Cloud REST API, DeleteWorksheetDateFilter
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/dateFilter,DELETE,Remove a date filter in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/AutoFilter/DeleteWorksheetDateFilter'>DeleteWorksheetDateFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,Specifies how to group dateTime values." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="year,integer,The year." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="month,integer,The month." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="day,integer,The day." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="hour,integer,The hour." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="minute,integer,The minute." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="second,integer,The second." >}} 
