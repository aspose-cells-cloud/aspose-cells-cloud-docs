...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,PUT,Add a new picture in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Pictures/PutWorksheetAddPicture'>PutWorksheetAddPicture</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftRow,integer,The image upper left row." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="upperLeftColumn,integer,The image upper left column." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightRow,integer,The image low right row." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lowerRightColumn,integer,The image low right column." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="picturePath,string,The picture path, if not provided the picture data is inspected in the request body." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="picture,class:picture,Pictute object" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
