...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceColumnIndex,integer,Source column index" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destinationColumnIndex,integer,Destination column index" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnNumber,integer,The copied column number" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="worksheet,string,The destination worksheet name." >}} 
