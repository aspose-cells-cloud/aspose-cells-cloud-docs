...
kwords: Excel, Office, Spreadsheet, Cloud REST API, PutWorksheetCustomFilter
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/custom,PUT,Filter a list with custom criteria in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetCustomFilter'>PutWorksheetCustomFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="operatorType1,string,The filter operator type" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="criteria1,string,The custom criteria." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAnd,boolean,true/false" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="operatorType2,string," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="criteria2,string,The custom criteria." >}} 
