...
kwords: Excel, Office, Spreadsheet, Cloud REST API, DeleteWorksheetPictures
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,Delete all pictures in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures'>DeleteWorksheetPictures</a>" >}}
