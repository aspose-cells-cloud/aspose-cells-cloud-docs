...
{{< blocks/products/cells/docs-Parameter parameter-title="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagesetup,POST,Update page setup in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/PageSetup/PostPageSetup'>PostPageSetup</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parameter-title="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="pageSetup,class:pagesetup,PageSetup Page Setup description." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
