...
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostCopyWorksheet
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/copy,POST,Copy contents and formats from another worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet'>PostCopyWorksheet</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="sourceSheet,string,Source worksheet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceWorkbook,string,source Workbook." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="sourceFolder,string,Original workbook folder." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="options,class:copyoptions,Represents the copy options." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
