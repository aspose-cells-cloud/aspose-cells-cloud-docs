---
title: "PostPivotTableCellStyle"
second_title: "Aspose.Cells Cloud Document"
type: docs
url: /specification/operation/postpivottablecellstyle/
description: "Update cell style in the PivotTable."
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostPivotTableCellStyle
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/Format,POST,Update cell style in the PivotTable.,<a href='https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableCellStyle'>PostPivotTableCellStyle</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="column,integer,The column index of the cell." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="row,integer,The row index of the cell." >}} 
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="style,class:style,Style Style description in request body." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
