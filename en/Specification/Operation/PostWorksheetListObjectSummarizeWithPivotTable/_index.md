...
{{< blocks/products/cells/docs-Parameter parameter-title="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destsheetName,string,The target worksheet name." >}} 
...
{{< blocks/products/cells/docs-Parameter parameter-title="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="createPivotTableRequest,class:createpivottablerequest,Create pivot table request." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
