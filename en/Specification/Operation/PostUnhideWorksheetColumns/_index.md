...
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostUnhideWorksheetColumns
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/unhide,POST,Unhide worksheet columns in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetColumns'>PostUnhideWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="startColumn,integer,The begin column index to be operated." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="totalColumns,integer,Number of columns to be operated." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,floating,Gets and sets the column width in unit of characters." >}} 
