...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,,<a href='https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings'>PostWorkbookSettings</a>" >}}
