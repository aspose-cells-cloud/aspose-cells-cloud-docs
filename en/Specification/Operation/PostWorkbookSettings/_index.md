...
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostWorkbookSettings
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/settings,POST,Update setting in the workbook.,<a href='https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSettings'>PostWorkbookSettings</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="settings,class:workbooksettings,Workbook Setting description." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
