...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parameter Name,Type,Description" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="pivotTableIndex,integer,The PivotTable index in the worksheet." >}} 
     {{< blocks/products/cells/docs-Parameter-content columns="filterIndex,integer,The pivot filter index of PivotTable." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
