...
kwords: Excel, Office, Spreadsheet, Cloud REST API, DeleteDecryptWorkbook
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="encryption,class:workbookencryptionrequest,WorkbookEncryptionRequestEncryption parameters." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
