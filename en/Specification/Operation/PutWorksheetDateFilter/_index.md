...
{{< blocks/products/cells/docs-Parameter parameter-title="Query Parameter" columns="Parameter Name,Type,Description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="dateTimeGroupingType,string,Specifies how to group dateTime values (Day, Hour, Minute, Month, Second, Year)." >}} 
