...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,GET,Retrieve descriptions of rows in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRows'>GetWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="offset,integer,Row offset." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="count,integer,Display rows number." >}} 
