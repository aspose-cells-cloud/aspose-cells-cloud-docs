...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/value,GET,,<a href='https://apireference.aspose.cloud/cells/#/Ranges/GetWorksheetCellsRangeValue'>GetWorksheetCellsRangeValue</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="rowCount,integer,Gets the count of rows in the range." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="columnCount,integer,Gets the count of columns in the range." >}} 
