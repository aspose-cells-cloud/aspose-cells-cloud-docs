...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/ranges/sort,POST,Perform data sorting around a range of cells.,<a href='https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeSort'>PostWorksheetCellsRangeSort</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="rangeSortRequest,class:rangesortrequest,RangeSortRequest Range Sort Request " >}} 
{{< /blocks/products/cells/docs-Parameter >}}
