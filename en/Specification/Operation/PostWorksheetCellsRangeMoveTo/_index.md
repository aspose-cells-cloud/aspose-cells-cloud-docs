...
{{< blocks/products/cells/docs-Parameter parameter-title="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="destRow,integer,The start row of the dest range." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="destColumn,integer,The start column of the dest range." >}} 
...
{{< blocks/products/cells/docs-Parameter parameter-title="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="range,class:range,range in worksheet " >}} 
{{< /blocks/products/cells/docs-Parameter >}}
