...
kwords: Excel, Office, Spreadsheet, Cloud REST API, GetWorksheetRow
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/{rowIndex},GET,Retrieve row data by the row's index in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRow'>GetWorksheetRow</a>" >}}
