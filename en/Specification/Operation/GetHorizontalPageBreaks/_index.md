---
title: "GetHorizontalPageBreaks"
second_title: "Aspose.Cells Cloud Document"
type: docs
url: /specification/operation/gethorizontalpagebreaks/
description: "Retrieve descriptions of horizontal page breaks in the worksheet."
kwords: Excel, Office, Spreadsheet, Cloud REST API, GetHorizontalPageBreaks
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/horizontalpagebreaks,GET,Retrieve descriptions of horizontal page breaks in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/PageBreaks/GetHorizontalPageBreaks'>GetHorizontalPageBreaks</a>" >}}
