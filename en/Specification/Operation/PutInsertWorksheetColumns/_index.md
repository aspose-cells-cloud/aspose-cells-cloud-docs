...
kwords: Excel, Office, Spreadsheet, Cloud REST API, PutInsertWorksheetColumns
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},PUT,Insert worksheet columns in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetColumns'>PutInsertWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="columns,integer,The number of columns." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="updateReference,boolean,Indicates if references in other worksheets will be updated." >}} 
