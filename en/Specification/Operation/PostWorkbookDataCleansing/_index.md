---
title: "PostWorkbookDataCleansing"
second_title: "Aspose.Cells Cloud Document"
type: docs
url: /postworkbookdatacleansing/
...
{{< blocks/products/cells/docs-Parameter parameter-title="Query Parameter" columns="Parameter Name,Type,Description" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="password,string,The file password. " >}} 
...
{{< blocks/products/cells/docs-Parameter parameter-title="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataCleansing,class:datacleansing,data cleansing content." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
