...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,GET,Retrieve the description of worksheets from a workbook.,<a href='https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheets'>GetWorksheets</a>" >}}
