...
{{< blocks/products/cells/docs-Parameter parameter-title="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="value,string,The cell value." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="type,string,The value type." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="formula,string,Formula for cell" >}} 
