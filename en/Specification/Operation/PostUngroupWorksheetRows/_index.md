---
title: "PostUngroupWorksheetRows"
second_title: "Aspose.Cells Cloud Document"
type: docs
url: /specification/operation/postungroupworksheetrows/
description: "Ungroup rows in the worksheet."
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostUngroupWorksheetRows
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/ungroup,POST,Ungroup rows in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows'>PostUngroupWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,The first row index to be operated." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex,integer,The last row index to be operated." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="isAll,boolean,Is all row to be operated" >}} 
