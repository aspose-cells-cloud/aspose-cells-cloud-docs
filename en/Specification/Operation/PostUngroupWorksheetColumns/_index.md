...
kwords: Excel, Office, Spreadsheet, Cloud REST API, PostUngroupWorksheetColumns
weight: 50
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/ungroup,POST,Ungroup worksheet columns.,<a href='https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetColumns'>PostUngroupWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="firstIndex,integer,The first column index to be operated." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="lastIndex,integer,The last column index to be operated." >}} 
