...
{{< blocks/products/cells/docs-Parameter parameter-title="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="oldValue,string,The old text to replace." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="newValue,string,The new text to replace by." >}} 
