...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,PUT,Add a shape in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape'>PutWorksheetShape</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="DrawingType,string,Shape object type" >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="top,integer,Represents the vertical offset of Spinner from its left row, in unit of pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="left,integer,Represents the horizontal offset of Spinner from its left column, in unit of pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="width,integer,Represents the height of Spinner, in unit of pixel." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="height,integer,Represents the width of Spinner, in unit of pixel." >}} 
