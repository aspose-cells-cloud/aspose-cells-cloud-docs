...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API reference" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/sort,POST,Sort list object in the worksheet.,<a href='https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSortTable'>PostWorksheetListObjectSortTable</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parameter Name,Type,Description" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="dataSorter,class:datasorter,Represents sort order for the data range." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
