---
title: Löschen Sie die Cells-Formatierung im Excel-Arbeitsblatt
type: docs
url: /de/clear-cells-formatting-in-excel-worksheet/
weight: 100
---
Dieser REST API gibt `clear` Zellen `style` in einer Excel-Datei an.
...
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostClearFormats) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
