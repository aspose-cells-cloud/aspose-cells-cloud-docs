---
title: Holen Sie sich den Zellenstil von einem Arbeitsblatt
type: docs
url: /de/get-cell-style-from-a-worksheet/
weight: 10
---
Dieser REST API gibt an, Zelle `style` in einer Datei Excel abzurufen.
...
| Zellenname| Zeichenfolge| Weg| Cells Name.|
| Ordner| Zeichenfolge| Abfrage| Ordner des Dokuments.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetCellStyle) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
