---
title: Holen Sie sich MaxDataRow aus dem Arbeitsblatt Excel
type: docs
url: /de/get-maxdatarow-from-excel-worksheet/
weight: 50
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, MaxDataRow aus Excel Arbeitsblatt abrufen
---
Dieser REST API zeigt an, dass in einer Excel-Datei ein `maxdatarow` abgerufen wird, wenn der `cellOrMethodName`-Parameter `maxdatarow` ist.
