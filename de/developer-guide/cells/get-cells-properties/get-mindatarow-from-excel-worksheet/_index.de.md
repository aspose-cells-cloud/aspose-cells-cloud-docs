---
title: Holen Sie sich MinDataRow von Excel Workshee
type: docs
url: /de/get-mindatarow-from-excel-worksheet/
weight: 90
---
Dieser REST API zeigt an, dass er einen `mindatarow` in einer Excel-Datei erhält, wenn der Parameter `cellOrMethodName` `mindatarow` ist.
