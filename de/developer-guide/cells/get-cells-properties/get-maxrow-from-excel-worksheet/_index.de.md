---
title: Holen Sie sich MaxRow von Excel Workshee
type: docs
url: /de/get-maxrow-from-excel-worksheet/
weight: 40
---
Dieser REST API zeigt an, dass er einen `maxrow` in einer Excel-Datei erhält, wenn der Parameter `cellOrMethodName` `maxrow` ist.
