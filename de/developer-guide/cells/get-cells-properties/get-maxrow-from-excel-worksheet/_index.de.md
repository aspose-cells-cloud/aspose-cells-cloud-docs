---
title: Holen Sie sich MaxRow aus dem Arbeitsblatt Excel
type: docs
url: /de/get-maxrow-from-excel-worksheet/
weight: 40
---
Dieser REST API zeigt an, dass Shows einen `maxrow` in einer Excel-Datei erhalten, wenn der `cellOrMethodName`-Parameter `maxrow` ist.
