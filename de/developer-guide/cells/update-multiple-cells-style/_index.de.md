---
title: Update Multiple Cells Stil
type: docs
url: /de/update-multiple-cells-style/
weight: 20
---
Dieser REST API gibt an, dass `cells style` auf eine Zelle in einer Excel-Datei festgelegt ist.
...
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostUpdateWorksheetRangeStyle) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
