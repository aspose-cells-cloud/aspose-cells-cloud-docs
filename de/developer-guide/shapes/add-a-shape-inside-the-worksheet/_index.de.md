...
weight: 30
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Hinzufügen einer Form zu einem Excel-Arbeitsblatt
---
...
| Breite| ganze Zahl| Abfrage| Stellt die Höhe des Spinners in Pixeln dar.|
| Höhe| ganze Zahl| Abfrage| Stellt die Breite des Spinners in Pixeln dar.|
| Ordner| Schnur| Abfrage| Ordner des Dokuments.|
| Speichername| Schnur| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Shapes/PutWorksheetShape) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
