...
weight: 90
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Excel zu Docx
---
Dieser REST API gibt an, `convert` eine Tabellenkalkulationsdatei in eine Datei im docx-Format zu konvertieren.
...
|:- |:- |:- |:- |
|/Zellen/konvertieren/docx|POST|Konvertieren Sie eine Tabelle in eine docx-Datei.|[PostConvertWorkbookToDocx](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx)|

 Der[OpenAPI-Spezifikation](https://reference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
