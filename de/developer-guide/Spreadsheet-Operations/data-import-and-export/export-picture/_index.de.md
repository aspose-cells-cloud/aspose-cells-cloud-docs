...
description: Aspose.Cells Cloud REST API unterstützt den Export von Excel Bildern in verschiedene Dateiformate. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift.
weight: 20
...
|:- |:- |:- |:- |
|/Zellen/Export|POST|Exportieren Sie Excel-Objekte aus Anforderungsinhalten in ein beliebiges Format|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
