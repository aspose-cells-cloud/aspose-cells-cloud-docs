...
description: "Cells.Cloud API für Excel bedienen: Aufgaben unterstützen Excel-Datei konvertieren"
weight: 30
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Arbeiten mit Konvertierungsaufgabe
---
## REST API
