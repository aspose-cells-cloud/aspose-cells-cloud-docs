---
title: Fügen Sie eine leere Zeile in einem Excel-Arbeitsblatt hinzu
...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen einer leeren Zeile in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Fügen Sie eine leere Zeile in ein Excel-Arbeitsblatt ein
---
Dieser REST API gibt an, dass eine neue Arbeitsblattzeile zu einem Excel-Arbeitsblatt hinzugefügt werden soll.
...
| Zeilenindex| ganze Zahl| Weg| Der neue Zeilenindex.|
| Ordner| Schnur| Abfrage| Der Dokumentenordner.|
| Speichername| Schnur| Abfrage| Speichername.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRow) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
