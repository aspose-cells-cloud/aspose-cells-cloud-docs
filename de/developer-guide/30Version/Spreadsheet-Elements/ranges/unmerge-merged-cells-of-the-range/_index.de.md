...
description: Aspose.Cells Cloud REST API unterstützt das Aufheben der Zusammenführung zusammengeführter Zellen des Bereichs auf einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Zusammengeführte Zellen des Bereichs aufheben
---
Dieser REST API gibt an, dass zusammengeführte Zellen dieses Bereichs auf einem Excel-Arbeitsblatt getrennt werden sollen.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeUnmerge) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
