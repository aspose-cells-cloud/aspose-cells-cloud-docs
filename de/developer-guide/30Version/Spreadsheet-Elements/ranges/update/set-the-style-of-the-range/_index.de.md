...
---
## **Einführung**
Mit diesem Beispiel können Sie den Stil des Bereichs mithilfe von Aspose.Cells Cloud API in Ihren Anwendungen festlegen. Sie können unser REST API mit jeder Sprache verwenden: .NET, Java, PHP, Ruby, Rails, Python, jQuery und viele mehr.
## **API Informationen**
