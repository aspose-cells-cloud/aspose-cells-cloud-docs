---
title: Abrufen einer bestimmten Dokumenteigenschaft
...
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Abrufen einer bestimmten Dokument-Eigenschaft
---
Dieser REST API gibt an, dass die Dokumenteigenschaften nach Namen gelesen werden sollen.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Properties/GetDocumentProperty) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
