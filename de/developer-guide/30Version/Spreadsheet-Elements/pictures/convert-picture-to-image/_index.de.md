...
description: Aspose.Cells Cloud REST API unterstützt das Abrufen eines Bildes in einer Excel-Datei. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Holen Sie sich ein Bild in einer Excel-Datei
---
Dieser REST API zeigt einen `get` Bild-für-Bild-Index aus einem Excel Arbeitsblatt an.
...
| Bildindex| ganze Zahl| Weg| Der Bildindex.|
| Format| Schnur| Abfrage| Das exportierte Objektformat.|
| Ordner| Schnur| Abfrage| Der Dokumentenordner.|
| Speichername| Schnur| Abfrage| Speichername.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
