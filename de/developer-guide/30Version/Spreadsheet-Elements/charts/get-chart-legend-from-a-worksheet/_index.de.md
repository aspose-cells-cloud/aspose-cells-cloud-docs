---
title: Diagrammlegende aus einem Arbeitsblatt abrufen
type: docs
url: /de/charts/legend/get/
aliases: [/get-chart-legend-from-a-worksheet/]
weight: 80
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Diagrammlegende aus einem Arbeitsblatt abrufen
---
Dieser REST API zeigt an, dass die Diagrammlegende abgerufen werden soll.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChartLegend) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
