...
keywords:
  ...
  - "SDK"
  - "GetChartArea"
description: "Erfahren Sie, wie Sie mithilfe der Aspose.Cells Cloud REST API Diagrammbereichsinformationen aus einem Arbeitsblatt abrufen – mit Beispielen für cURL und mehrere SDKs."
ArticleTitle: "Diagrammbereich aus einem Arbeitsblatt abrufen – Aspose.Cells Cloud API"
---

Diese REST API gibt Informationen zum Diagrammbereich zurück.

**Voraussetzungen:** Um diesen Endpunkt aufzurufen, benötigen Sie ein gültiges JWT-Access-Token, die Zielarbeitsmappe muss in den Aspose Cloud-Speicher hochgeladen sein und das Dateiformat muss von Aspose.Cells unterstützt werden.

**Hintergrund:** Ein Diagrammbereich definiert den äußersten Begrenzungsrahmen eines Excel-Diagramms, einschließlich Titel, Legende und Plotbereich. Das Abrufen seiner Eigenschaften ermöglicht es Ihnen, Layout und Gestaltung programmgesteuert anzupassen.
...
## Verwendung der GetChartArea API mit SDKs

### Spezifikation der GetChartArea API

Die <a href="https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea" target="_blank" rel="noopener noreferrer">OpenAPI-Spezifikation</a> definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht REST-Interaktionen direkt aus einem Webbrowser.
...
Die Verwendung eines SDKs ist der beste Weg, um die Entwicklung zu beschleunigen. Ein SDK übernimmt Details auf niedriger Ebene, sodass Sie sich auf Ihre Projektanforderungen konzentrieren können. Eine vollständige Liste der Aspose.Cells Cloud SDKs finden Sie im <a href="https://github.com/aspose-cells-cloud" target="_blank" rel="noopener noreferrer">GitHub-Repository</a>.
...
**Allgemeine HTTP-Anforderung (z. B. mit fetch):**
