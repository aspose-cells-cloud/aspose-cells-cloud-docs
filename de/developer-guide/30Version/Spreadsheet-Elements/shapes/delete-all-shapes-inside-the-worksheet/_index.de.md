---
title: Löschen Sie alle Formen auf einem Excel-Arbeitsblatt
...
description: Aspose.Cells Cloud REST API unterstützt das Löschen aller Formen auf einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 40
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Alle Formen auf einem Excel-Arbeitsblatt löschen
---
Dieser REST API gibt an, alle Formen auf einem Excel-Arbeitsblatt zu löschen.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShapes) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
