...
description: Aspose.Cells Cloud REST API unterstützt das Aufheben der Fixierung von Fenstern auf einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 200
...
---
Dieser REST API gibt `unfreeze panes` auf dem Arbeitsblatt Excel an.
