---
title: Festlegen der Seiteneinrichtung für ein Arbeitsblatt
second_title: Aspose.Cells Cloud Documen
linktitle: Seiteneinstellungen festlegen
type: docs
...
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Seiteneinrichtung für ein Excel-Arbeitsblatt festlegen
---
Dieser REST API zeigt `Set page setup for an Excel worksheet` an.
...
| Blattname| Schnur| Weg| Der neue Blattname.|
|[Seiteneinrichtung](/cells/de/page-setup) | Objekt| Körper| Beschreibung der TPage-Einrichtung.|
| Ordner| Schnur| Abfrage| Dokumentenordner.|
| Speichername| Schnur| Abfrage| Speichername.|

 Der[OpenAPI-Spezifikation](https://reference.aspose.cloud/cells/#/PageSetup/PostPageSetup) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
