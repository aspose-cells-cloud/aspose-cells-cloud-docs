...
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Kopiert Inhalte und Formate aus einem anderen Arbeitsblatt.
---
Dieser REST API gibt `copy a worksheet` an und speichert mit neuem Namen in der gleichen Arbeitsmappe
...
| Quellordner| Schnur| Abfrage||
| Ordner| Schnur| Abfrage||
| Speichername| Schnur| Abfrage| Speichername.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PostCopyWorksheet) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
