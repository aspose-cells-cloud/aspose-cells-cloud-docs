...
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Automatische Anpassung mehrerer Spalten in einem Excel-Arbeitsblatt
---
Dieser REST API gibt an, dass `multiple columns` automatisch in ein Excel-Arbeitsblatt eingepasst werden soll.
...
| erste Spalte| ganze Zahl| Abfrage| Der Startspaltenindex.|
| letzte Spalte| ganze Zahl| Abfrage| Der Index der Endspalte.|
|[autoFitterOptions](/cells/de/auto-fitter-options/) || Körper| Auto Fitter-Optionen.|
| erste Zeile| ganze Zahl| Abfrage||
| letzte Zeile| ganze Zahl| Abfrage||
