---
title: Holen Sie sich eine Autoshape aus einem Excel-Arbeitsblatt
...
description: Aspose.Cells Cloud REST API unterstützt das Erhalten von Autoshape in ein anderes Format aus einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 10
---
...
| Format| Schnur| Anfrage| Exportiertes Format.|
| Ordner| Schnur| Anfrage| Der Dokumentenordner.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Autoshapes/GetWorksheetAutoshape) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
