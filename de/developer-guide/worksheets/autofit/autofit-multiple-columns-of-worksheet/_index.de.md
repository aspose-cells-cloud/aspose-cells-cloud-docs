---
title: Mehrere Spalten in einem Arbeitsblatt Excel automatisch anpassen
...
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Automatische Anpassung mehrerer Spalten an ein Excel-Arbeitsblatt
---
 Dieser REST API gibt an, `multiple columns` automatisch in ein Excel-Arbeitsblatt einzupassen.
