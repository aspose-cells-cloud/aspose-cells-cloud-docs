---
title: Frieren Sie Fenster auf einem Excel-Arbeitsblatt ein
...
description: Aspose.Cells Cloud REST API unterstützt das Einfrieren von Fenstern auf einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 190
---
...
| eingefrorene Zeilen| ganze Zahl| Anfrage||
| eingefrorene Spalten| ganze Zahl| Anfrage||
| Ordner| Schnur| Anfrage||
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PutWorksheetFreezePanes) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
