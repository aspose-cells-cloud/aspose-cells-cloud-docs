---
title: Stellen Sie den Zoom für ein Arbeitsblatt Excel ein
...
weight: 20
---
Dieser REST API gibt `set the zoom value of Excel worksheet` an.
...
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PostUpdateWorksheetZoom) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
