---
title: Verschieben eines Arbeitsblatts Excel
...
description: Aspose.Cells Cloud REST API unterstützt das Verschieben eines Excel Arbeitsblatts in eine Excel Arbeitsmappe. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Verschieben eines Excel Arbeitsblatts
---
Dieser REST API zeigt `move worksheet` an.
...
| ziehen um|| Körper| mit beweglichen Parametern.|
| Ordner| Schnur| Abfrage| Der Dokumentordner.|
| Speichername| Schnur| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PostMoveWorksheet) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
