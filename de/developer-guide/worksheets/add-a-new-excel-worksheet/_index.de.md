...
weight: 20
---
Dieser REST API gibt `add new worksheet` an.
...
| Blattname| Zeichenfolge| Weg| Der neue Blattname.|
| Position| ganze Zahl| Abfrage| Die neue Blattposition.|
| Blatttyp| Zeichenfolge| Abfrage| Der neue Blatttyp.|
| Ordner| Zeichenfolge| Abfrage| Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PutAddNewWorksheet) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
