---
title: Holen Sie sich einen automatischen Filter in einem Excel-Arbeitsblatt
second_title: Aspose.Cells Cloud Documen
linktitle: Holen Sie sich Autofilter
type: docs
url: /de/autofilter/get/
aliases: [/get-autofilter-description/]
keywords: Gets auto filter description from an Excel worksheet
description: Die Aspose.Cells-Cloud API-Unterstützung erhält eine automatische Filterbeschreibung aus einem Excel-Arbeitsblatt. SDK-Unterstützungsarten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 50
---
Dieser REST API gibt an, dass die Beschreibung von `auto filter` in einem Excel-Arbeitsblatt abgerufen wird.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
