---
title: Holen Sie sich ein Bild in der Datei Excel
...
weight: 10
---
Dieser REST API verweist auf den Bild-für-Bild-Index `get` aus einem Excel-Arbeitsblatt.
...
| pictureIndex| ganze Zahl| Weg| Der Bildindex.|
| Format| Zeichenfolge| Abfrage| Das exportierte Objektformat.|
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPicture) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
