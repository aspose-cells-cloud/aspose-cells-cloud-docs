...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen eines Hyperlinks in ein Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
Dieser REST API gibt `add a worksheet hyperlink` auf einem Excel-Arbeitsblatt an.
...
| erste Reihe| ganze Zahl| Anfrage||
| erste Spalte| ganze Zahl| Anfrage||
| totalRows| ganze Zahl| Anfrage||
| totalColumns| ganze Zahl| Anfrage||
| Adresse| Schnur| Anfrage||
| Ordner| Schnur| Anfrage| Der Dokumentenordner.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
