...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen eines Hyperlinks zu einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
Dieser REST API weist auf `add a worksheet hyperlink` auf einem Excel-Arbeitsblatt hin.
...
| totalRows| ganze Zahl| Abfrage||
|totalColumns| ganze Zahl| Abfrage||
| Adresse| Zeichenfolge| Abfrage||
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Hypelinks/PutWorksheetHyperlink) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
