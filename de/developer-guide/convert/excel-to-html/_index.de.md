...
weight: 100
---
Diese REST API `saveas` Excel-Datei in HTML.

[POST /cells/{name}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) Mit API können Sie die Datei MS Excel als Datei HTML mit zusätzlichen Einstellungen speichern und das Ergebnis im Speicher speichern.

Diese REST API `convert` Excel-Datei in HTML.

[PUT /cells/convert](https://apireference.aspose.cloud/cells/#/Workbook/PutConvertWorkBook)Mit API können Sie die MS-Datei Excel mit zusätzlichen Einstellungen in die Datei HTML konvertieren und das Ergebnis in der Antwort speichern.

Diese REST API `export` Excel-Datei in HTML.

[GET /cells/{name}](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkBook  )Mit API können Sie die MS-Datei Excel mit zusätzlichen Einstellungen in die Datei HTML konvertieren und das Ergebnis in der Antwort speichern.
