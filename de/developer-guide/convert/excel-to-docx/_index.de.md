...
linktitle: Excel an Doc
type: docs
url: /de/convert/excel-to-docx/
aliases: [/convert-excel-file-to-docx-in-cloud/]
keywords: Convert excel files to docx files
description: Aspose.Cells Cloud REST API unterstützt die Konvertierung von Excel-Dateien in Docx-Dateien. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 90
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Excel zu Docx
---
Diese REST API `saveas` Excel-Datei in Docx.

[POST /cells/{name}/saveAs](https://apireference.aspose.cloud/cells/#/SaveAs/PostDocumentSaveAs) Mit API können Sie die Datei MS Excel mit zusätzlichen Einstellungen als Docx-Datei speichern und das Ergebnis im Speicher ablegen.
