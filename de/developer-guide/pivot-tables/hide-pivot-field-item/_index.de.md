...
description: Aspose.Cells Cloud REST API unterstützt das Ausblenden eines Pivot-Felds in einer Pivot-Tabelle. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 110
---
...
| PivotFieldType| Schnur| Anfrage||
| FeldIndex| ganze Zahl| Anfrage||
| itemIndex| ganze Zahl| Anfrage||
| istAusblenden| boolesch| Anfrage||
| NeedReCalculate| boolesch| Anfrage| FALSCH|
| Ordner| Schnur| Anfrage||
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldHideItem) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
