---
title: Verschieben Sie eine Pivot-Tabelle in einem Excel-Fil
...
description: Aspose.Cells Cloud REST API unterstützt das Verschieben einer Pivot-Tabelle in einer Excel-Datei. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 120
---
Dieser REST API gibt die Pivot-Tabelle `move` an.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/PivotTables/PostPivotTableFieldMoveTo) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
