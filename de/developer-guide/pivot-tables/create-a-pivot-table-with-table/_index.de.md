...
description: Aspose.Cells Cloud REST API unterstützt das Erstellen einer Pivot-Tabelle mit Listenobjekt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 60
---
Dieser REST API gibt an, dass ein `pivottable` mit Listenobjekt erstellt werden soll.
...
| ZielblattName| Schnur| Anfrage||
| Anfrage|| Körper||
| Ordner| Schnur| Anfrage||
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectSummarizeWithPivotTable) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
