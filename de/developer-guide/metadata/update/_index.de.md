...
linktitle: Aktualisieren Sie ohne Verwendung von Speicher
type: docs
url: /de/metadata/update/
keywords: Update metadata on excel files
description: Aspose.Cells Cloud REST API unterstützt das Aktualisieren von Metadaten in Excel-Dateien. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 35
---
...
| Dokumenteigenschaften|| Körper| Cells Dokumenteigenschaft.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/PostMetadata) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
