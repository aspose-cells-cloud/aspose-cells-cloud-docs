---
title: Holen Sie sich Textelemente aus einer Excel-Arbeitsgruppe
second_title: Aspose.Cells Cloud Documen
linktitle: Geh zur Arbeit
type: docs
...
---
Dieser REST API verweist auf `text items` der Arbeitsmappe `read` in der Arbeitsmappe Excel.
...
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
