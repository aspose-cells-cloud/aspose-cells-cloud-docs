...
linktitle: Holen Sie sich Workbook
type: docs
...
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Textelemente aus einer Excel Arbeitsmappe abrufen
---
Dieser REST API zeigt auf die Arbeitsmappe `read` `text items` in der Arbeitsmappe Excel.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/GetWorkbookTextItems) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
