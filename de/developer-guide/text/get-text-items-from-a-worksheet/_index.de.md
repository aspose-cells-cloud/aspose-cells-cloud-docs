---
title: Abrufen von Textelementen aus einem Excel-Arbeitsblatt
second_title: Aspose.Cells Cloud Documen
linktitle: Steigen Sie in das Arbeitsblatt ein
type: docs
...
description: Aspose.Cells Cloud REST API unterstützt das Abrufen von Text aus dem Arbeitsblatt Excel. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
---
Dieser REST API gibt den `text items` des Arbeitsblatts `read` im Arbeitsblatt Excel an.
...
| Ordner| Schnur| Anfrage| Der Ordner der Arbeitsmappe.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetTextItems) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
