...
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Textelemente aus einem Excel-Arbeitsblatt abrufen
---
Dieser REST API zeigt an, dass das Arbeitsblatt `read` im Arbeitsblatt `text items` das Arbeitsblatt Excel ist.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetTextItems) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
