---
title: Holen Sie sich Textelemente aus einem Arbeitsblatt Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Geh ins Arbeitsblatt
type: docs
...
---
Dieser REST API weist auf `text items` des Arbeitsblatts `read` im Arbeitsblatt Excel hin.
...
| Ordner| Zeichenfolge| Abfrage| Der Ordner der Arbeitsmappe.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetTextItems) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
