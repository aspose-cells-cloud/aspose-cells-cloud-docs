---
title: Suchen Sie nach Text in einem Arbeitsblatt Excel
second_title: Aspose.Cells Cloud Documen
linktitle: Finden Sie im Arbeitsblatt
type: docs
...
description: Aspose.Cells Cloud REST API unterstützt die Suche nach Text aus dem Arbeitsblatt Excel. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
---
Dieser REST API weist auf den `search`-Text im Excel-Arbeitsblatt hin.
...
| Text| Zeichenfolge| Abfrage| Zu durchsuchender Text.|
| Ordner| Zeichenfolge| Abfrage| Ordner des Dokuments.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/PostWorksheetTextSearch) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
