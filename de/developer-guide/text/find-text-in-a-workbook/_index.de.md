---
title: Suchen Sie Text in einem Excel-Arbeitsbuch
...
description: Aspose.Cells Cloud REST API unterstützt das Suchen von Text aus der Arbeitsmappe Excel. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
---
Dieser REST API gibt `search`-Text in einer Excel-Datei an.
...
| Text| Schnur| Anfrage| Textbeispiel.|
| Ordner| Schnur| Anfrage| Ordner des Dokuments.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksTextSearch) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
