---
title: Suchen Sie nach Text in einer Excel-Arbeitsmappe
second_title: Aspose.Cells Cloud Documen
linktitle: Finden Sie in Workboo
type: docs
...
description: Aspose.Cells Cloud REST API unterstützt das Suchen von Text aus der Arbeitsmappe Excel. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
---
Dieser REST API gibt den `search`-Text in einer Excel-Datei an.
...
| Text| Zeichenfolge| Abfrage| Textbeispiel.|
| Ordner| Zeichenfolge| Abfrage| Ordner des Dokuments.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbooksTextSearch) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
