---
title: Blenden Sie Zeilen auf einem Arbeitsblatt Excel ein
...
weight: 50
---
Dieser REST API gibt an, Zeilen in einem Excel-Arbeitsblatt einzublenden.
...
| totalRows| ganze Zahl| Abfrage| Anzahl der zu bedienenden Zeilen.|
| Höhe| Nummer| Abfrage|15.0 |
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
