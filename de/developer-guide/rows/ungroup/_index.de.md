...
description: Aspose.Cells Cloud REST API unterstützt das Aufheben der Gruppierung von Zeilen auf einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 70
---
Dieser REST API gibt an, dass die Gruppierung von Zeilen auf einem Excel-Arbeitsblatt aufgehoben werden soll.
...
| ist Alles| boolesch| Anfrage| Ist alle Reihe zu bedienen|
| Ordner| Schnur| Anfrage| Der Dokumentenordner.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
