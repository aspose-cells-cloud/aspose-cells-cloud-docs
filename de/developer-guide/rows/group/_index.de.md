---
title: Gruppieren Sie Zeilen auf einem Arbeitsblatt Excel
...
description: Aspose.Cells Cloud REST API unterstützt das Gruppieren von Zeilen in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 60
---
Dieser REST API gibt an, Zeilen in einem Excel-Arbeitsblatt zu gruppieren.
...
| ersterIndex| ganze Zahl| Abfrage| Der erste Zeilenindex, der bearbeitet werden soll.|
| lastIndex| ganze Zahl| Abfrage| Der letzte Zeilenindex, der bearbeitet werden soll.|
| verstecken| Boolescher Wert| Abfrage| Zeilen sichtbarer Zustand|
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
