...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen mehrerer Zeilen zu einem Excel-Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
Dieser REST API gibt an, mehrere neue Arbeitsblattzeilen zu einem Arbeitsblatt Excel hinzuzufügen.
...
| startrow| ganze Zahl| Abfrage| Der Anfangszeilenindex, der bearbeitet werden soll.|
| totalRows| ganze Zahl| Abfrage|1 |
| updateReference| Boolescher Wert| Abfrage| WAHR|
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
