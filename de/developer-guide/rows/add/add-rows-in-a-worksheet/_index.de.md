---
title: Mehrere Zeilen zu einem Arbeitsblatt Excel hinzufügen
second_title: Aspose.Cells Cloud Documen
linktitle: Reihe
type: docs
url: /de/rows/add/rows/
keywords: Add multi rows on an Excel workshee
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen mehrerer Zeilen in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Mehrere Zeilen zu einem Excel-Arbeitsblatt hinzufügen
---
Dieser REST API gibt an, dass mehrere neue Arbeitsblattzeilen zu einem Excel-Arbeitsblatt hinzugefügt werden sollen.
...
| startrow| ganze Zahl| Abfrage| Der Index der Anfangszeile, die bearbeitet werden soll.|
| Gesamtzeilen| ganze Zahl| Abfrage|1 |
| Referenz aktualisieren|Boolescher Wert| Abfrage| WAHR|
| Ordner| Schnur| Abfrage| Der Dokumentordner.|
| Speichername| Schnur| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
