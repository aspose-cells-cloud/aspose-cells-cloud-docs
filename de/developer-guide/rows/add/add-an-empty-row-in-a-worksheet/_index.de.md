---
title: Fügen Sie eine leere Zeile auf einem Excel-Arbeitsblatt hinzu
...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen einer leeren Zeile auf einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
Dieser REST API gibt an, dass eine neue Arbeitsblattzeile auf einem Excel-Arbeitsblatt hinzugefügt werden soll.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRow) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
