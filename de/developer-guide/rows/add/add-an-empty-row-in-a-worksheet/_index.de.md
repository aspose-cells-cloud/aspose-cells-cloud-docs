---
title: Fügen Sie eine leere Zeile auf einem Arbeitsblatt Excel hinzu
...
weight: 20
---
Dieser REST API gibt an, eine neue Arbeitsblattzeile zu einem Excel-Arbeitsblatt hinzuzufügen.
...
| rowIndex| ganze Zahl| Weg| Der neue Zeilenindex.|
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetRow) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
