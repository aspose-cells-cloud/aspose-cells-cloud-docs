---
title: Rufen Sie Zeileninformationen aus einem Arbeitsblatt Excel ab
...
weight: 10
---
Dieser REST API gibt an, Zeileninformationen in einem Excel-Arbeitsblatt abzurufen.
...
| Ordner| Zeichenfolge| Abfrage| Der Workdook-Ordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
