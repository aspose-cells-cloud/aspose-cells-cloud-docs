---
title: Zeileninformationen aus einem Excel-Arbeitsblatt abrufen
...
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Zeileninformationen aus einem Excel-Arbeitsblatt abrufen
---
Dieser REST API gibt an, dass Zeileninformationen in einem Excel-Arbeitsblatt abgerufen werden sollen.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRows) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
