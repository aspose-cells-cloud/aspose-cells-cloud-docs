---
title: Aspose.Cells Cloud Web API - Leere Arbeitsblätter in Spreadsheet löschen
second_title: Documen
ArticleTitle: Delete Blank Worksheets in a Spreadshee
linktitle: Leeres Arbeitsblatt löschen
type: docs
...
description: Löschen Sie effizient alle leeren Arbeitsblätter aus einer Tabelle, die keine Daten oder Objekte enthalten. Optimieren Sie Ihre Arbeitsmappe für eine bessere Leistung
weight: 100
kwords: Excel, Office Cloud, REST, Tabellenkalkulation, PDF, CSV, JSON, Markdown
---
Löschen Sie alle leeren Arbeitsblätter, die keine Daten oder andere Objekte aus einer Excel-Tabelle enthalten.

## **LöschenTabellenblattLeerArbeitsblätter API**
...
|:- |:- |:- |:- |
| Kalkulationstabelle| Datei| FormData| Laden Sie die zu bereinigende Tabellenkalkulationsdatei hoch.|
...
## Wo sollten wir die leeren Arbeitsblätter der Tabellenkalkulation API löschen?

Wenn Sie Daten transformieren müssen, können Sie diese API verwenden.

## Warum sollten Sie die leeren Arbeitsblätter zum Löschen von Tabellenkalkulationen API verwenden?

- Löschen Sie schnell alle leeren Arbeitsblätter, die keine Daten oder andere Objekte aus einer Excel-Tabelle enthalten.
- Die Entwicklung kann über das vorhandene SDK schnell abgeschlossen werden.

## So verwenden Sie die Funktion „Tabelle löschen“ für leere Arbeitsblätter API mit SDKs

### Tabellenkalkulation löschen Leere Arbeitsblätter API Spezifikation

 Der[Tabellenkalkulation löschen Leere Arbeitsblätter API Spezifikation](https://reference.aspose.cloud/cells/#/TransformController/DeleteSpreadsheetBlankWorksheets) definiert eine öffentlich zugängliche Programmierschnittstelle, die es Ihnen ermöglicht, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.

### Verwenden Sie Aspose.Cells Cloud SDKs

Die Verwendung des SDK ist die schnellste Art der Entwicklung, da es die Details auf niedriger Ebene abstrahiert und es Ihnen ermöglicht, leere Tabellenblätter mit einem kurzen Code zu löschen.
