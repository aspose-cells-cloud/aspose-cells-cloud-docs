---
title: Holen Sie sich eine Diagrammlegende aus einem Arbeitsblatt
type: docs
url: /de/charts/legend/get/
aliases: [/get-chart-legend-from-a-worksheet/]
weight: 80
---
Dieser REST API gibt an, dass die Diagrammlegende abgerufen werden soll
...
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChartLegend) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
