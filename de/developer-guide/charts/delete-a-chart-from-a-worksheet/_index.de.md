---
title: Löschen Sie ein Diagramm aus einem Arbeitsblatt
type: docs
url: /de/charts/delete/
aliases: [/delete-a-chart-from-a-worksheet/]
weight: 40
---
Dieser REST API zeigt das Diagramm zum Löschen des Arbeitsblatts nach Index an.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetDeleteChart) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
