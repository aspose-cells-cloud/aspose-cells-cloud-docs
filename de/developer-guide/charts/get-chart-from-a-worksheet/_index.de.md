...
weight: 10
---
Dieser REST API zeigt an, dass Diagramminformationen abgerufen werden.
...
| Format| Schnur| Anfrage| Das exportierte Dateiformat.|
| Ordner| Schnur| Anfrage| Der Dokumentenordner.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChart) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
