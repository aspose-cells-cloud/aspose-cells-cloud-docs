...
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Diagramm aus einem Arbeitsblatt abrufen
---
Dieser REST API zeigt an, dass Diagramminformationen abgerufen werden sollen.
