---
title: Holen Sie sich ein Diagramm aus einem Arbeitsblatt
type: docs
url: /de/charts/get/
aliases: [/get-chart-from-a-worksheet/]
weight: 10
---
Dieser REST API gibt an, Diagramminformationen abzurufen.
...
| chartNumber| ganze Zahl| Weg| Die Diagrammnummer.|
| Format| Zeichenfolge| Abfrage| Das exportierte Dateiformat.|
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/GetWorksheetChart) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
