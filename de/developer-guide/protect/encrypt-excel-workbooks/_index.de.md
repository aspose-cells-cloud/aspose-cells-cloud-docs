---
title: Verschlüsseln Sie ein Excel-Workboo
second_title: Aspose.Cells Cloud Documen
linktitle: Verschlüsselung
type: docs
url: /de/workbook/encrypt/
aliases: [/encrypt-excel-workbooks/]
keywords: Encrypt Excel workbook
description: Aspose.Cells Cloud REST API unterstützt die Verschlüsselung der Excel Arbeitsmappe. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
...
|Parametername|Typ|Beschreibung|
|:- |:- |:- |
|Verschlüsselungstyp|Zeichenfolge|XOR/Compatible/EnhancedCryptographicProviderV1/StrongCryptographicProvider|
...
|:- |:- |:- |:- |
|/cells/{name}/encryption|POST|Excel-Dokument verschlüsseln|[PostEncryptDocument](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument)|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Workbook/PostEncryptDocument) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
