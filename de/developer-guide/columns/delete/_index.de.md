---
title: Löschen Sie eine Spalte im Arbeitsblatt Excel
...
description: Aspose.Cells Cloud REST API unterstützt das Löschen einer Spalte in einem Excel-Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 80
---
Dieses REST API kopiert `column` in ein Excel Arbeitsblatt.
...
| updateReference| Boolescher Wert| Abfrage| Die Update-Referenz.|
| Ordner| Zeichenfolge| Abfrage| Der Arbeitsmappenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/DeleteWorksheetColumns) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
