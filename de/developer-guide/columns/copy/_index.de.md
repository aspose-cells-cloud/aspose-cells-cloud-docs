---
title: Spalten in einem Arbeitsblatt Excel kopieren
...
description: Aspose.Cells Cloud REST API unterstützt das Kopieren von Spalten in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 30
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Spalten in einem Excel Arbeitsblatt kopieren
---
Diese REST API-Kopie `columns` in einem Excel-Arbeitsblatt.
...
| Quellspaltenindex| ganze Zahl| Abfrage| Quellspaltenindex|
| Zielspaltenindex| ganze Zahl| Abfrage| Zielspaltenindex|
| Spaltennummer| ganze Zahl| Abfrage| Die kopierte Spaltennummer|
| Arbeitsblatt| Schnur| Abfrage||
| Ordner| Schnur| Abfrage| Der Dokumentordner.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostCopyWorksheetColumns) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
