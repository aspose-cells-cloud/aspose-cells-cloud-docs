...
weight: 40
---
Dieser REST API zeigt an, dass Arbeitsblattspalten ausgeblendet werden.
...
| startColumn| ganze Zahl| Abfrage| Der Anfangsspaltenindex, der bearbeitet werden soll.|
...
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostHideWorksheetColumns) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
