---
title: Spalten auf einem Arbeitsblatt Excel einblenden
...
weight: 50
---
Dieser REST API zeigt an, dass Arbeitsblattspalten eingeblendet werden.
...
|totalColumns| ganze Zahl| Abfrage| Anzahl der zu bedienenden Säulen.|
| Breite| Nummer| Abfrage|50.0 |
| Ordner| Zeichenfolge| Abfrage| Der Dokumentenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|

 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostUnhideWorksheetColumns) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
