---
title: Fügen Sie eine leere Spalte zu einem Arbeitsblatt Excel hinzu
...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen einer Spalte in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
Dieser REST API weist auf das Einfügen von Arbeitsblattspalten hin.
...
| ColumnIndex| ganze Zahl| Weg| Der Spaltenindex.|
| Säulen| ganze Zahl| Abfrage| Die Spalten.|
| updateReference| Boolescher Wert| Abfrage| WAHR|
| Ordner| Zeichenfolge| Abfrage| Der Arbeitsmappenordner.|
| Speichername| Zeichenfolge| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PutInsertWorksheetColumns) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
