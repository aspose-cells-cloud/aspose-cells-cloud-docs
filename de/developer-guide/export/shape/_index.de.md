...
description: Aspose.Cells Cloud REST API unterstützt den Export von Excel Formen in verschiedene Formatdateien. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
...
|:- |:- |:- |:- |
|/cells/export|SETZEN|Exportieren Sie Excel-Objekte aus Anforderungsinhalten in ein bestimmtes Format|[PostExport](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
