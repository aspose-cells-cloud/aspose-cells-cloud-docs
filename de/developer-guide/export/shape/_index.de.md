...
description: Aspose.Cells Cloud REST API unterstützt den Export von Excel Shape in verschiedene Formatdateien. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Form exportieren
---
...
|:- |:- |:- |:- |
|/Zellen/Export|SETZEN|Exportieren Sie Excel-Objekte aus Anforderungsinhalten in ein bestimmtes Format|[Nach dem Export](https://apireference.aspose.cloud/cells/#/LightCells/PostExport)|
