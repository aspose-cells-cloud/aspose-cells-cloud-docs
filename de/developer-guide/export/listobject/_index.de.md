...
description: Aspose.Cells Cloud REST API unterstützt den Export von Excel Listenobjekten in Formatdateien. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
...
|:- |:- |:- |:- |
|/cells/exportieren|POST|Exportieren Sie Excel aus dem Anforderungsinhalt in ein bestimmtes Format|[PostExport](https://apireference.aspose.cloud/cells/#/LiteCells/PostExport)|
