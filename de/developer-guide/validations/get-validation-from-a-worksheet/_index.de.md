---
title: Abrufen einer Arbeitsblattvalidierung nach Index aus einem Excel-Arbeitsblatt
...
description: Aspose.Cells Cloud REST API unterstützt das Abrufen einer Arbeitsblattvalidierung nach Index aus einem Excel-Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 10
---
Dieser REST API gibt an, dass eine Arbeitsblattvalidierung nach Index auf einem Excel-Arbeitsblatt abgerufen werden soll.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidation) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
