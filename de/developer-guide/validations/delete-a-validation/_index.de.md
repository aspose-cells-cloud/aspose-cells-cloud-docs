---
title: Löschen einer Arbeitsblattvalidierung auf einem Arbeitsblatt Excel
...
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Löschen einer Arbeitsblattvalidierung auf einem Excel-Arbeitsblatt
---
Dieser REST API gibt an, dass eine Arbeitsblattvalidierung nach Index auf einem Excel-Arbeitsblatt gelöscht werden soll.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/WorksheetValidations/DeleteWorksheetValidation) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
