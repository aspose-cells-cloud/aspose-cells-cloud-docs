---
title: Festlegen der Zeilenhöhen innerhalb des Bereichs
...
weight: 76
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Höhen der Zeilen innerhalb des Bereichs festlegen
---
Dieser REST API gibt an, dass die Zeilenhöhe des Bereichs in einem Excel-Arbeitsblatt festgelegt werden soll.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Ranges/PostWorksheetCellsRangeRowHeight) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen, REST-Interaktionen direkt von einem Webbrowser aus durchzuführen.
