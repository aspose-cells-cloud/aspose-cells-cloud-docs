...
description: "Cells.Cloud API für Excel betreiben: Formatbedingung hinzufügen"
weight: 50
---
Dieser REST API zeigt an, dass eine Formatbedingung hinzugefügt wird.
...
| Speichername| Schnur| Anfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/ConditionalFormattings/PutWorksheetFormatCondition) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
