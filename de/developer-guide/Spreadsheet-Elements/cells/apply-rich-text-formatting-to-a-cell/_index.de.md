---
title: Rich-Text-Formatierung auf eine Cel anwenden
type: docs
url: /de/apply-rich-text-formatting-to-a-cell/
weight: 40
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Rich-Text-Formatierung auf eine Zelle anwenden
---
Dieser REST API gibt an, `rich text formatting` auf eine Zelle in einer Excel-Datei anzuwenden.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
