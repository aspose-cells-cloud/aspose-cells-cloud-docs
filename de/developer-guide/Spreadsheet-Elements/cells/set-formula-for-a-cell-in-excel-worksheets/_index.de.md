---
title: Formel für eine Zelle im Arbeitsblatt Excel festlegen
type: docs
url: /de/set-formula-for-a-cell-in-excel-worksheets/
weight: 80
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Formel für eine Zelle in Excel Arbeitsblättern festlegen
---
Dieser REST API zeigt den Satz `cell formula` in einer Excel-Datei an.
...
| Wert| Schnur| Abfrage| Der Zellenwert.|
| Typ| Schnur| Abfrage| Der Werttyp.|
| Formel| Schnur| Abfrage| Formel für Zelle|
| Ordner| Schnur| Abfrage| Der Dokumentenordner.|
| Speichername| Schnur| Abfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Cells/PostWorksheetCellSetValue) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
