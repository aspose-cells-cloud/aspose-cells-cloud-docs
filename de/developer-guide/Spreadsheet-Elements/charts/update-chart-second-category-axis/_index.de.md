---
title:  Update-Diagramm zweite Kategorie Axi
type: docs
url: /de/charts/second-category-axis/update/
weight: 160
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Update-Diagramm Zweite Kategorieachse
---
 Dieser REST API zeigt die Aktualisierung der zweiten Kategorieachse des Diagramms an.
...
| Speichername| Schnur| Abfrage||
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/PostChartSecondCategoryAxis) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
