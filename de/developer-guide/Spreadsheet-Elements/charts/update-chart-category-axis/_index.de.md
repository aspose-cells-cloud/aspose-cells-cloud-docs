---
title:  Diagrammkategorie Axi aktualisieren
type: docs
url: /de/charts/category-axis/update/
weight: 160
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Diagrammkategorieachse aktualisieren
---
Dieser REST API zeigt die Aktualisierung der Diagrammkategorieachse an.
...
| Speichername| Schnur| Abfrage||
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/PostChartCategoryAxis) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
