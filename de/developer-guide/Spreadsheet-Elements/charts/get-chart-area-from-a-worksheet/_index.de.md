...
weight: 60
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Diagrammbereich aus einem Arbeitsblatt abrufen
---
Dieser REST API gibt an, dass Informationen zum Kartenbereich abgerufen werden sollen.
...
<br/>
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/ChartArea/GetChartArea) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
