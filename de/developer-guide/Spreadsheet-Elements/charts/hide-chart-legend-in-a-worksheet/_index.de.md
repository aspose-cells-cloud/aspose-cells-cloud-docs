---
title: Diagrammlegende in einem Arbeitsblatt ausblenden
type: docs
url: /de/charts/legend/hide/
aliases: [/hide-chart-legend-in-a-worksheet/]
weight: 110
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Diagrammlegende in einem Arbeitsblatt ausblenden
---
Dieser REST API zeigt an, dass die Legende im Diagramm ausgeblendet wird
...
<br/>
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChartLegend) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
