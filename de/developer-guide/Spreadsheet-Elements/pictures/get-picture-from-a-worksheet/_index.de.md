---
title: Alle Bilder in einem Arbeitsblatt Excel
...
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Alle Bilder in einem Excel-Arbeitsblatt abrufen
---
Dieses REST API gibt an `get` alle Bildinformationen aus einem Excel Arbeitsblatt weiter.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Pictures/GetWorksheetPictures) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
