---
title: Fenster auf einem Excel-Arbeitsblatt freigeben
...
description: Aspose.Cells Cloud REST API unterstützt das Aufheben der Fixierung von Fenstern in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift.
weight: 200
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Fenster auf einem Excel-Arbeitsblatt freigeben
---
Dieser REST API gibt `unfreeze panes` im Arbeitsblatt Excel an.
...
| Speichername| Schnur| Abfrage| Speichername.|
 ...
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetFreezePanes) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht Ihnen die Durchführung von REST-Interaktionen direkt von einem Webbrowser aus.
