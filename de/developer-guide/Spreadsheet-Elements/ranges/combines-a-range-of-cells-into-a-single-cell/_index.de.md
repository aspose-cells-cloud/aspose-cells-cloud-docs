...
description: Aspose.Cells Cloud REST API unterstützt das Zusammenführen eines Zellbereichs zu einer einzigen Zelle in einem Excel Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift.
weight: 20
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, kombiniert einen Bereich von Cells in einer einzigen Zelle
---
