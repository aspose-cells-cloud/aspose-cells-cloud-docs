...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen einer Arbeitsblattvalidierung zu einem Excel-Arbeitsblatt. SDK unterstützt verschiedene Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift.
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Hinzufügen einer Arbeitsblattvalidierung zu einem Excel-Arbeitsblatt
---
