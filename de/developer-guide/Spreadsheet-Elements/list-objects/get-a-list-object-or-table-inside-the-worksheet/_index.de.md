...
---
Dieser REST API zeigt `get` eine Liste von Objektinformationen nach Index an oder konvertiert `list object` in eine Datei mit einem anderen Format in einem Excel-Arbeitsblatt.
