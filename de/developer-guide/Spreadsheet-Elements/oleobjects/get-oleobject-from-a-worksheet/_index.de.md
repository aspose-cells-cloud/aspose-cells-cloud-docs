...
weight: 10
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdown, Holen Sie sich ein OLE-Objekt in einem Excel-Arbeitsblatt
---
Dieser REST API zeigt `get` und `OLE object` mit Format in einem Excel-Arbeitsblatt an.
