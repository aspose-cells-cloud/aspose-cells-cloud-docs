...
------------ | ------------- | ------------- | -------------
Quellordner | Zeichenfolge | | [optional]MatchCondition | MatchConditionRequest | | [optional]Schutztyp | Zeichenfolge | | [optional]Passwort | Zeichenfolge | | [optional]OutFolder | Zeichenfolge | | [Optional]**MatchConditionRequest-Eigenschaften**
 
Name | Geben Sie | ein Beschreibung | Anmerkungen
------------ | ------------- | ------------- | -------------
 RegexPattern | Zeichenfolge | | [optional]FullMatchConditions | string[]| | [optional]Die[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/PostProtectConvert) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
