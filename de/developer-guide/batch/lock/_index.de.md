...
Name | Geben Sie | ein Beschreibung | Anmerkungen
------------ | ------------- | ------------- | -------------
 RegexPattern | Zeichenfolge | | [optional]FullMatchConditions | string[]| | [optional]Die[OpenAPI-Spezifikation](https://reference.aspose.cloud/cells/#/Batch/PostBatchLock) definiert eine öffentlich zugängliche Programmierschnittstelle und ermöglicht die Durchführung von REST-Interaktionen direkt über einen Webbrowser.
