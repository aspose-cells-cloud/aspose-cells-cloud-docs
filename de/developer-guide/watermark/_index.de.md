...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen von Wassermarkern für Excel-Dateien. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 39
---
...
| Text| Schnur| Anfrage||
| Farbe| Schnur| Anfrage||
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/LiteCells/PostWatermark) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
