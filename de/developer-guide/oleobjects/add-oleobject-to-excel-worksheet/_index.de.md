---
title: Fügen Sie ein OLE-Objekt in einem Excel-Arbeitsblatt hinzu
...
description: Aspose.Cells Cloud REST API unterstützt das Hinzufügen eines OLE-Objekts in einem Excel Arbeitsblatt. SDK unterstützt Arten von Entwicklungssprachen. Dazu gehören Android, C#, Go, Java, NodeJS, Perl, PHP, Python, Ruby und Swift
weight: 20
---
...
| Höhe| ganze Zahl| Anfrage|0 |
| Breite| ganze Zahl| Anfrage|0 |
| oleDatei| Schnur| Anfrage| OLE-Dateiname|
| Bilddatei| Schnur| Anfrage| Bilddateiname|
| Ordner| Schnur| Anfrage| Der Arbeitsmappenordner.|
| Speichername| Schnur| Anfrage| Speichername.|
 
 Der[OpenAPI-Spezifikation](https://apireference.aspose.cloud/cells/#/OleObjects/PutWorksheetOleObject) definiert eine öffentlich zugängliche Programmierschnittstelle und lässt Sie REST-Interaktionen direkt von einem Webbrowser ausführen.
