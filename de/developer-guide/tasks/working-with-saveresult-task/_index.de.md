...
description: "Cells.Cloud API für Excel betreiben: Aufgaben unterstützen das Speichern des Ergebnisses im Antwortinhalt oder im Cloud-Speicher"
weight: 50
kwords: Excel, Office Cloud, REST API, Tabellenkalkulation, PDF, CSV, Json, Markdwon, Arbeiten mit SaveResult-Aufgabe
---
## REST API
