---
title: DeleteWorksheetChar
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/deleteworksheetchart/
description: Löschen Sie ein Diagramm nach Index im Arbeitsblatt
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,Ein Diagramm nach Index im Arbeitsblatt löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/ Charts/DeleteWorksheetChart\'>DeleteWorksheetChart</a>" >}}
