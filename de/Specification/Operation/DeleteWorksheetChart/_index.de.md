---
title: Arbeitsblattzeichen löschen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/deleteworksheetchart/
description: Löschen eines Diagramms nach Index im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, DeleteWorksheetChart
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex},DELETE,Löschen Sie ein Diagramm nach Index im Arbeitsblatt.,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/DeleteWorksheetChart\'>DeleteWorksheetChart</a>" >}}
