---
title: ArbeitsblattHyperlin abrufen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/getworksheethyperlink/
description: Abrufen der Hyperlinkbeschreibung nach Index im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetHyperlink
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},GET,Hyperlinkbeschreibung nach Index im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/GetWorksheetHyperlink\'>GetWorksheetHyperlink</a>" >}}
