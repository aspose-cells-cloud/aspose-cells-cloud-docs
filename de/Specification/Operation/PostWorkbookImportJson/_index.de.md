...
type: docs
url: /de/specification/operation/postworkbookimportjson/
description: Importieren Sie eine JSON-Datendatei in die Arbeitsmappe. Die JSON-Datendatei kann entweder eine Cloud-Datei oder Daten aus einer HTTP-URI sein.
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostWorkbookImportJson
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/importjson,POST,Importieren Sie eine JSON-Datendatei in die Arbeitsmappe. Die JSON-Datendatei kann entweder eine Cloud-Datei oder Daten von einer HTTP-URI sein.,<a href=\'https://apireference.aspose.cloud/cells/#/DataProcessing/PostWorkbookImportJson\'>PostWorkbookImportJson</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="importJsonRequest, Klasse: importjsonrequest, JSON-Anfrage importieren." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
