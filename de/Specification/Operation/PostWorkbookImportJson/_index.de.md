...
description: Importieren Sie eine JSON-Datendatei in die Arbeitsmappe. Die JSON-Datendatei kann entweder eine Cloud-Datei oder Daten aus einem HTTP-URI sein
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="importJsonRequest,class:importjsonrequest,Json-Anfrage importieren." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
