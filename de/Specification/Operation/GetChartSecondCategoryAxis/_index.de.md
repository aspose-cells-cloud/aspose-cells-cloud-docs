...
type: docs
url: /de/specification/operation/getchartsecondcategoryaxis/
description: Rufen Sie die zweite Kategorieachse des Diagramms im Diagramm ab
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetChartSecondCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/secondcategoryaxis,GET,Zweite Kategorieachse im Diagramm abrufen,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/GetChartSecondCategoryAxis\'>GetChartSecondCategoryAxis</a>" >}}
