---
title: ArbeitsblattFormErstellen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/getworksheetshape/
description: Beschreibung der Form im Arbeitsblatt abrufen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},GET,Beschreibung der Form im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShape\'>GetWorksheetShape</a>" >}}
