...
type: docs
url: /de/specification/operation/postcellcalculate/
description: Berechnen Sie die Zellformel im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostCellCalculate
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/calculate,POST,Zellformel im Arbeitsblatt berechnen.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostCellCalculate\'>PostCellCalculate</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Optionen,Klasse:Berechnungsoptionen,Berechnungsoptionen" >}} 
{{< /blocks/products/cells/docs-Parameter >}}
