...
type: docs
url: /de/specification/operation/postwatermark/
description: Fügen Sie Excel-Dateien Textwasserzeichen hinzu und generieren Sie Ausgabedateien in verschiedenen Formaten
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostWatermark
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/watermark,POST,Fügen Sie den Dateien Excel ein Textwasserzeichen hinzu und generieren Sie Ausgabedateien in verschiedenen Formaten.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostWatermark\'>PostWatermark</a>" >}}
{{< /blocks/products/cells/docs-Parameter >}}


{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Text, Zeichenfolge, Hintergrundtext." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="Farbe,Zeichenfolge,zB #1032ff" >}} 
