---
title: PostConvertWorkbookToJso
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/postconvertworkbooktojson/
description: Konvertieren Sie die Datei Excel in JSON-Dateien
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostConvertWorkbookToJson
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostConvertWorkbookToJson" >}}
{{< blocks/products/cells/docs-title titlemsg="Convert Excel file to Json files." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/json,POST,Datei Excel in JSON-Dateien konvertieren.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToJson\'>PostConvertWorkbookToJson</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/ConversionController/PostConvertWorkbookToJson\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/convert/json
    -X POST 
...
{{< tab tabNum="13" >}}
{{< gist "aspose-cells-cloud-gists" "8a5b324fdf3e574dbd747c1a1e24b05d" "ExamplePostConvertWorkbookToJson.cs" >}}
{{< /tab >}}
