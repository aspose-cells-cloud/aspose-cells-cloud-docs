...
type: docs
url: /de/specification/operation/getpagecount/
description: Abrufen der Seitenanzahl in der Arbeitsmappe
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/pagecount,GET,Seitenzahl in der Arbeitsmappe abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/GetPageCount\'>GetPageCount</a>" >}}
