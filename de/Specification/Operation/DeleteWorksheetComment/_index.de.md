---
title: Arbeitsblatt löschenKommen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/deleteworksheetcomment/
description: Zellkommentar im Arbeitsblatt löschen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, DeleteWorksheetComment
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments/{cellName},DELETE,Zellenkommentar im Arbeitsblatt löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheetComment\'>DeleteWorksheetComment</a>" >}}
