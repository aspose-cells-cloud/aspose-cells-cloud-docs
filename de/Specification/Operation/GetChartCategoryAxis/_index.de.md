...
type: docs
url: /de/specification/operation/getchartcategoryaxis/
description: Beschreibungen der Diagrammreihenachsen im Diagramm abrufen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetChartCategoryAxis
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/charts/{chartIndex}/categoryaxis,GET,Beschreibungen der Diagrammreihenachsen im Diagramm abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Charts/GetChartCategoryAxis\'>GetChartCategoryAxis</a>" >}}
