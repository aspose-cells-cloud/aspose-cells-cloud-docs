---
title: Arbeitsblattfilter einfügen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/putworksheetfilter/
description: Hinzufügen eines Filters für eine Spalte im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PutWorksheetFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/filter,PUT,Fügen Sie einen Filter für eine Spalte im Arbeitsblatt hinzu.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetFilter\'>PutWorksheetFilter</a>" >}}
