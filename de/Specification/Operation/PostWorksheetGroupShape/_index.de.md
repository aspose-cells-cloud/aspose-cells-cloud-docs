...
type: docs
url: /de/specification/operation/postworksheetgroupshape/
description: Gruppieren von Formen im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostWorksheetGroupShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/group,POST,Formen im Arbeitsblatt gruppieren.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/PostWorksheetGroupShape\'>PostWorksheetGroupShape</a>" >}}
