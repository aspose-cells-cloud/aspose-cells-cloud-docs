...
type: docs
url: /de/specification/operation/getworksheetconditionalformatting/
description: Abrufen von Beschreibungen der bedingten Formatierung im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetConditionalFormatting
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings/{index},GET,Beschreibungen der bedingten Formatierung im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormatting\'>GetWorksheetConditionalFormatting</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametername, Typ, Beschreibung" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="Index, Ganzzahl, Der Index der bedingten Formatierung." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
