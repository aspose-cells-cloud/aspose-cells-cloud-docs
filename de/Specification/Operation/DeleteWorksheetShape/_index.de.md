...
type: docs
url: /de/specification/operation/deleteworksheetshape/
description: Löschen einer Form im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, DeleteWorksheetShape
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes/{shapeindex},DELETE,Eine Form im Arbeitsblatt löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/DeleteWorksheetShape\'>DeleteWorksheetShape</a>" >}}
