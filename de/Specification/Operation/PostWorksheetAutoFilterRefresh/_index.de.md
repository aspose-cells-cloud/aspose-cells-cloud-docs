---
title: PostWorksheetAutoFilterRefreshs
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/postworksheetautofilterrefresh/
description: Automatische Filter im Arbeitsblatt aktualisieren
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostWorksheetAutoFilterRefresh
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/refresh,POST,Automatische Filter im Arbeitsblatt aktualisieren.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PostWorksheetAutoFilterRefresh\'>PostWorksheetAutoFilterRefresh</a>" >}}
