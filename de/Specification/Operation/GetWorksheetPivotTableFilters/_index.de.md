---
title: Arbeitsblatt abrufenPivotTableFilter
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/getworksheetpivottablefilters/
description: Ruft PivotTable-Filter im Arbeitsblatt ab
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetPivotTableFilters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters,GET,Ruft PivotTable-Filter im Arbeitsblatt ab.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/GetWorksheetPivotTableFilters\'>GetWorksheetPivotTableFilters</a>" >}}
