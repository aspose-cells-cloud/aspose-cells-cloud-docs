...
type: docs
url: /de/specification/operation/postcellcharacters/
description: Festlegen von Zellzeichen im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostCellCharacters
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/{cellName}/characters,POST,Zellenzeichen im Arbeitsblatt festlegen.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostCellCharacters\'>PostCellCharacters</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Optionen, Container," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
