...
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostMetadata
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/metadata/update,POST,Dokumenteigenschaften in Datei Excel aktualisieren und in verschiedenen Formaten speichern.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMetadata\'>PostMetadata</a>" >}}
