...
type: docs
url: /de/specification/operation/postworksheetlistobjectremoveduplicates/
description: Duplikate im Listenobjekt entfernen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostWorksheetListObjectRemoveDuplicates
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/RemoveDuplicates,POST,Duplikate im Listenobjekt entfernen.,<a href=\'https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectRemoveDuplicates\'>PostWorksheetListObjectRemoveDuplicates</a>" >}}
