...
type: docs
url: /de/specification/operation/postunlock/
description: Excel-Dateien entsperren
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostUnlock
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/unlock,POST,Excel Dateien entsperren.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostUnlock\'>PostUnlock</a>" >}}
