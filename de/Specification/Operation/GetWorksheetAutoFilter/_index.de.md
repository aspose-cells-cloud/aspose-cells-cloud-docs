...
type: docs
url: /de/specification/operation/getworksheetautofilter/
description: Abrufen der Beschreibung von Autofiltern aus einem Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetAutoFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter,GET,Beschreibung von Autofiltern aus einem Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/GetWorksheetAutoFilter\'>GetWorksheetAutoFilter</a>" >}}
