---
title: Arbeitsblattkommentar abrufen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/getworksheetcomments/
description: Abrufen der Beschreibung von Kommentaren im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetComments
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/comments,GET,Beschreibung der Kommentare im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetComments\'>GetWorksheetComments</a>" >}}
