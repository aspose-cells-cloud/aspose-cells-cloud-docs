...
type: docs
url: /de/specification/operation/deleteworksheetpivottablefilter/
description: Löschen eines Pivotfilters in der PivotTable
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, Arbeitsblatt löschenPivotTableFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pivottables/{pivotTableIndex}/PivotFilters/{fieldIndex},DELETE,Einen Pivot-Filter in der PivotTable löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/PivotTables/DeleteWorksheetPivotTableFilter\'>DeleteWorksheetPivotTableFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Path Parameter" columns="Parametername, Typ, Beschreibung" >}}
     ...
     {{< blocks/products/cells/docs-Parameter-content columns="fieldIndex,integer,Ruft das PivotField-Objekt am spezifischen Index ab." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
