...
description: Rufen Sie Beschreibungen der Formen im Arbeitsblatt ab
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/shapes,GET,Beschreibungen von Formen im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Shapes/GetWorksheetShapes\'> GetWorksheetShapes</a>" >}}
