---
title: Posten Sie den Verschlüsselungsworkboo
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/postencryptworkbook/
description: Excel Verschlüsselung
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostEncryptWorkbook
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/encryption,POST,Excel Verschlüsselung.,<a href=\'https://apireference.aspose.cloud/cells/#/Protection/PostEncryptWorkbook\'>PostEncryptWorkbook</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/ProtectionController/PostEncryptWorkbook\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
