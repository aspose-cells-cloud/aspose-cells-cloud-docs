...
type: docs
url: /de/specification/operation/deleteworksheet/
description: Löschen eines Arbeitsblatts in der Arbeitsmappe
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, Arbeitsblatt löschen
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName},LÖSCHEN,Ein Arbeitsblatt in der Arbeitsmappe löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheet\'>Arbeitsblatt löschen</a>" >}}
