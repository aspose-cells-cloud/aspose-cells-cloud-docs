...
type: docs
url: /de/specification/operation/postsetworksheetcolumnwidth/
description: Festlegen der Spaltenbreite des Arbeitsblatts
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostSetWorksheetColumnWidth
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/{columnIndex},POST,Spaltenbreite des Arbeitsblatts festlegen.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostSetWorksheetColumnWidth\'>PostSetWorksheetColumnWidth</a>" >}}
