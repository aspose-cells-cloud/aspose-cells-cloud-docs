---
title: LöschenArbeitsblattHyperlin
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/deleteworksheethyperlink/
description: Hyperlink nach Index im Arbeitsblatt löschen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, ArbeitsblattHyperlink löschen
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/hyperlinks/{hyperlinkIndex},DELETE,Hyperlink nach Index im Arbeitsblatt löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/Hypelinks/DeleteWorksheetHyperlink\'>DeleteWorksheetHyperlink</a>" >}}
