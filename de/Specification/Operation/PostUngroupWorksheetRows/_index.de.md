...
type: docs
url: /de/specification/operation/postungroupworksheetrows/
description: Gruppierung von Zeilen im Arbeitsblatt aufheben
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostUngroupWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/ungroup,POST,Gruppierung der Zeilen im Arbeitsblatt aufheben.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostUngroupWorksheetRows\'>PostUngroupWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="isAll,boolean,Sind alle Zeilen zu bearbeiten" >}} 
