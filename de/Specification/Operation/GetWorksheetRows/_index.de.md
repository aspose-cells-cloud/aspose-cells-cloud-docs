---
title: Arbeitsblattzeile abrufen
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/getworksheetrows/
description: Beschreibungen der Zeilen im Arbeitsblatt abrufen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetRows
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/rows/,GET,Beschreibungen der Zeilen im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/GetWorksheetRows\'>GetWorksheetRows</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Offset, Ganzzahl, Zeilenoffset." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="Anzahl, Ganzzahl, Anzahl der Anzeigezeilen." >}} 
