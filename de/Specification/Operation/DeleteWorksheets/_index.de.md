...
description: Löschen Sie übereinstimmende Arbeitsblätter in der Arbeitsmappe
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets,DELETE,Übereinstimmende Arbeitsblätter in der Arbeitsmappe löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/DeleteWorksheets\'>DeleteWorksheets</a>" >}}
