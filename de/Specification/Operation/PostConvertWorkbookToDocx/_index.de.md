---
title: PostConvertWorkbookToDoc
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/postconvertworkbooktodocx/
description: Konvertieren Sie die Datei Excel in Docx-Dateien
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostConvertWorkbookToDocx
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/docx,POST,Datei Excel in Docx-Dateien konvertieren.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToDocx\'>PostConvertWorkbookToDocx</a>" >}}
