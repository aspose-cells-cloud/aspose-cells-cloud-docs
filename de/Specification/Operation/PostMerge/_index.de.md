...
type: docs
url: /de/specification/operation/postmerge/
description: Zellen im Arbeitsblatt zusammenführen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostMerge
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/merge,POST,Zellen im Arbeitsblatt zusammenführen.,<a href=\'https://apireference.aspose.cloud/cells/#/LightCells/PostMerge\'>PostMerge</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="mergeToOneSheet, Boolean, Alle Arbeitsmappen in einem Blatt zusammenführen." >}} 
