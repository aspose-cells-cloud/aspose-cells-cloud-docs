---
title: PostConvertWorkbookToPN
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/postconvertworkbooktopng/
description: Konvertieren Sie die Datei Excel in Dateien vom Typ PNG
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostConvertWorkbookToPNG
weight: 50
---
{{< blocks/products/cells/docs-title titlemsg="PostConvertWorkbookToPNG" >}}
{{< blocks/products/cells/docs-title titlemsg="Convert Excel file to PNG files." >}}

{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/convert/png,POST,Datei Excel in Dateien PNG konvertieren.,<a href=\'https://apireference.aspose.cloud/cells/#/Conversion/PostConvertWorkbookToPNG\'>PostConvertWorkbookToPNG</a>" >}}
...
{{< blocks/products/cells/docs-title titlemsg="The <a href=\'https://apireference.aspose.cloud/cells/#/ConversionController/PostConvertWorkbookToPNG\'>OpenAPI Specification</a> defines a publicly accessible programming interface and lets you carry out REST interactions directly from a web browser. " >}}
 
...
curl -v "https://api.aspose.cloud/v3.0/cells/cells/convert/png
    -X POST 
...
{{< tab tabNum="13" >}}
{{< gist "aspose-cells-cloud-gists" "8a5b324fdf3e574dbd747c1a1e24b05d" "ExamplePostConvertWorkbookToPNG.cs" >}}
{{< /tab >}}
