...
type: docs
url: /de/specification/operation/getnamedranges/
description: Abrufen von Beschreibungen von Bereichen in den Arbeitsblättern
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetNamedRanges
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/ranges,GET,Beschreibungen von Bereichen in den Arbeitsblättern abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetNamedRanges\'>GetNamedRanges</a>" >}}
