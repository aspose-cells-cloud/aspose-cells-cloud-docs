---
title: PostGroupWorksheetColumn
second_title: Aspose.Cells Cloud Documen
type: docs
url: /de/specification/operation/postgroupworksheetcolumns/
description: Gruppieren Sie Arbeitsblattspalten im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostGroupWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/group,POST,Arbeitsblattspalten im Arbeitsblatt gruppieren.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostGroupWorksheetColumns\'>PostGroupWorksheetColumns</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="ausblenden, Boolescher Wert, sichtbarer Spaltenstatus" >}} 
