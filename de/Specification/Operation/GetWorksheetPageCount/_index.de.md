...
type: docs
url: /de/specification/operation/getworksheetpagecount/
description: Seitenanzahl im Arbeitsblatt abrufen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetPageCount
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pagecount,GET,Seitenzahl im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/GetWorksheetPageCount\'>GetWorksheetPageCount</a>" >}}
