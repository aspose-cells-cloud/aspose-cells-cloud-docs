...
description: Teilen Sie die Arbeitsmappe mit einem bestimmten Format auf
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Description,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/split,POST,Teilen Sie die Arbeitsmappe mit einem bestimmten Format.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit\'>PostWorkbookSplit</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Format, Zeichenfolge, Split-Format." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outFolder,string," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="from,integer,Startarbeitsblattindex." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="to,integer,Arbeitsblattindex beenden." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" splitNameRule,string,Regelname: Blattname, neue Guid" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="Ordner, Zeichenfolge, Der Ordner, in dem sich die Datei befindet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="storageName,string,Der Speichername, in dem sich die Datei befindet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,string," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
