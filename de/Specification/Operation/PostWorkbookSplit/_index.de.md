...
type: docs
url: /de/specification/operation/postworkbooksplit/
description: Teilen Sie die Arbeitsmappe mit einem bestimmten Format
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostWorkbookSplit
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/split,POST,Arbeitsmappe mit einem bestimmten Format aufteilen.,<a href=\'https://apireference.aspose.cloud/cells/#/Workbook/PostWorkbookSplit\'>PostWorkbookSplit</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Format, Zeichenfolge, Format teilen." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outFolder,Zeichenfolge," >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="von, Ganzzahl, Arbeitsblattindex starten." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="bis, Ganzzahl, Arbeitsblattindex beenden." >}} 
    ...
    {{< blocks/products/cells/docs-Parameter-content columns=" splitNameRule,Zeichenfolge,Regelname: Tabellenname newguid" >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="Ordner, Zeichenfolge, Der Ordner, in dem sich die Datei befindet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="storageName, string, Der Name des Speichers, in dem sich die Datei befindet." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="outStorageName,Zeichenfolge," >}} 
{{< /blocks/products/cells/docs-Parameter >}}
