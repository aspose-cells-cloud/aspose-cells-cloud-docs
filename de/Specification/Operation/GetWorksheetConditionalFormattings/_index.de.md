...
type: docs
url: /de/specification/operation/getworksheetconditionalformattings/
description: Abrufen von Beschreibungen bedingter Formatierungen in einem Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetConditionalFormattings
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/conditionalFormattings,GET,Beschreibungen bedingter Formatierungen in einem Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/ConditionalFormattings/GetWorksheetConditionalFormattings\'>GetWorksheetConditionalFormattings</a>" >}}
