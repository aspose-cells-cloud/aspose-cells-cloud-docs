...
type: docs
url: /de/specification/operation/postmoveworksheet/
description: Arbeitsblatt in der Arbeitsmappe verschieben
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostMoveWorksheet
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/position,POST,Arbeitsblatt in der Arbeitsmappe verschieben.,<a href=\'https://apireference.aspose.cloud/cells/#/Worksheets/PostMoveWorksheet\'>PostMoveWorksheet</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Request Body Parameter" columns="Parametername, Typ, Beschreibung" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="Verschieben, Klasse: Arbeitsblattverschiebungsanforderung, Arbeitsblattverschiebungsanforderung mit Verschiebungsparametern." >}} 
{{< /blocks/products/cells/docs-Parameter >}}
