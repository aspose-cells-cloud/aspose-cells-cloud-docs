...
type: docs
url: /de/specification/operation/posthideworksheetcolumns/
description: Arbeitsblattspalten im Arbeitsblatt ausblenden
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PostHideWorksheetColumns
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/cells/columns/hide,POST,Arbeitsblattspalten im Arbeitsblatt ausblenden.,<a href=\'https://apireference.aspose.cloud/cells/#/Cells/PostHideWorksheetColumns\'>PostHideWorksheetColumns</a>" >}}
