...
type: docs
url: /de/specification/operation/deleteworksheetpictures/
description: Löschen Sie alle Bilder im Arbeitsblatt
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, DeleteWorksheetPictures
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/pictures,DELETE,Alle Bilder im Arbeitsblatt löschen.,<a href=\'https://apireference.aspose.cloud/cells/#/Pictures/DeleteWorksheetPictures\'>DeleteWorksheetPictures</a>" >}}
