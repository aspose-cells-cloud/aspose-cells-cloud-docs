...
type: docs
url: /de/specification/operation/getworksheetvalidations/
description: Beschreibungen der Validierungen im Arbeitsblatt abrufen
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, GetWorksheetValidations
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/validations,GET,Beschreibungen der Validierungen im Arbeitsblatt abrufen.,<a href=\'https://apireference.aspose.cloud/cells/#/WorksheetValidations/GetWorksheetValidations\'>GetWorksheetValidations</a>" >}}
