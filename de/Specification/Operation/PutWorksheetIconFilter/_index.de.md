...
type: docs
url: /de/specification/operation/putworksheeticonfilter/
description: Fügen Sie im Arbeitsblatt einen Symbolfilter hinzu
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, PutWorksheetIconFilter
weight: 50
---
...
{{< blocks/products/cells/docs-Parameter parametertitle="REST API" columns="API,HttpMethod,Beschreibung,API Referenz" >}}
    {{< blocks/products/cells/docs-Parameter-content columns="/cells/{name}/worksheets/{sheetName}/autoFilter/iconFilter,PUT,Fügen Sie dem Arbeitsblatt einen Symbolfilter hinzu.,<a href=\'https://apireference.aspose.cloud/cells/#/AutoFilter/PutWorksheetIconFilter\'>PutWorksheetIconFilter</a>" >}}
...
{{< blocks/products/cells/docs-Parameter parametertitle="Query Parameter" columns="Parametername, Typ, Beschreibung" >}}
    ...
    {{< blocks/products/cells/docs-Parameter-content columns="iconSetType, string, Der Symbolsatztyp." >}} 
    {{< blocks/products/cells/docs-Parameter-content columns="iconId, integer, Die Symbol-ID." >}} 
