...
type: docs
url: /de/specification/model/radiobutton/
description: "Aspose.Cells Cloud-Modellspezifikation: RadioButton. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, RadioButton
weight: 50
---
## **Radio knopf**
...
|:- |:- |:- |:- |:- |:- |
| Gruppenfeld| Klasse:GroupBox| WAHR| FALSCH|| Ruft die GroupBox ab, die diesen RadioButton enthält.|
| Wird geprüft| Boolescher Wert| WAHR| FALSCH|| Gibt an, ob das Optionsfeld aktiviert ist oder nicht.|
