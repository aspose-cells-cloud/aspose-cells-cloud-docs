...
type: docs
url: /de/specification/model/listbox/
description: "Aspose.Cells Cloud-Modellspezifikation: ListBox. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, ListBox
weight: 50
---
## **Listenfeld**
...
|:- |:- |:- |:- |:- |:- |
| Eingabebereich| Zeichenfolge| WAHR| FALSCH|||
| Stückzahl| Ganze Zahl| WAHR| FALSCH|| Ruft die Anzahl der Elemente im Listenfeld ab.|
| Seitenwechsel| Ganze Zahl| WAHR| FALSCH||Gibt den Betrag an, um den der Wert des Steuerelements geändert wird, wenn der Benutzer auf den Bild-auf- oder Bild-ab-Bereich der Bildlaufleiste klickt.|
| Ausgewählte Zellen| Container| WAHR| FALSCH|| Ruft die ausgewählten Zellen ab. Gibt null zurück, wenn der Eingabebereich nicht festgelegt ist oder kein Element ausgewählt ist|
| Ausgewählter Index| Ganze Zahl| WAHR| FALSCH||Ruft die Indexnummer des aktuell ausgewählten Elements in einem Listenfeld oder Kombinationsfeld ab oder legt diese fest. Nullbasiert.|
| Auswahltyp| Zeichenfolge| WAHR| FALSCH|| Ruft den Auswahlmodus des angegebenen Listenfelds ab oder legt ihn fest.|
| Schatten| Boolescher Wert| WAHR| FALSCH|| Gibt an, ob die Combobox eine 3D-Schattierung hat.|
