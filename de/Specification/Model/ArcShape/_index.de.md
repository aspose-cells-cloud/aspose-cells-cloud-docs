...
type: docs
url: /de/specification/model/arcshape/
description: "Aspose.Cells Cloud-Modellspezifikation: ArcShape. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, ArcShape
weight: 50
---
## **Bogenform**
...
|:- |:- |:- |:- |:- |:- |
| BeginnPfeilspitzeLänge| Zeichenfolge| WAHR| FALSCH|| Ruft die Anfangslänge der Pfeilspitze der Linie ab und legt sie fest.|
| Pfeilspitzenstil beginnen| Zeichenfolge| WAHR| FALSCH|| Ruft den Anfangspfeilspitzenstil der Linie ab und legt ihn fest.|
| BeginnPfeilspitzenbreite| Zeichenfolge| WAHR| FALSCH|| Ruft die Anfangsbreite der Pfeilspitze der Linie ab und legt sie fest.|
| EndePfeilspitzeLänge| Zeichenfolge| WAHR| FALSCH|| Ruft die Länge der Pfeilspitze am Ende der Linie ab und legt sie fest.|
| EndPfeilspitzenStil| Zeichenfolge| WAHR| FALSCH|| Ruft den Endpfeilspitzenstil der Linie ab und legt ihn fest.|
| EndPfeilspitzenbreite| Zeichenfolge| WAHR| FALSCH|| Ruft die Breite der Pfeilspitze am Ende der Linie ab und legt sie fest.|
