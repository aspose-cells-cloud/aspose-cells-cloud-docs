...
type: docs
url: /de/specification/model/combobox/
description: "Aspose.Cells Cloud-Modellspezifikation: ComboBox. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, ComboBox
weight: 50
---
## **Kombinationsfeld**

 Stellt das Steuerelement in der Form „ComboBox“ dar.

| Name des Anwesens| Art der Immobilie| Nullwerte zulassen| Schreibgeschützt| Standardwert| Beschreibung|
|:- |:- |:- |:- |:- |:- |
| Dropdown-Linien| Ganze Zahl| WAHR| FALSCH|| Ruft die Anzahl der Listenzeilen ab, die im Dropdown-Bereich eines Kombinationsfelds angezeigt werden, oder legt diese fest.|
| Eingabebereich| Zeichenfolge| WAHR| FALSCH|||
| Ausgewählte Zelle| Klasse:LinkElement| WAHR| FALSCH|| Ruft die ausgewählte Zelle im Eingabebereich der Kombinationsbox ab.|
...
| Ausgewählter Wert| Zeichenfolge| WAHR| FALSCH|| Ruft den ausgewählten Wert des Kombinationsfelds ab.|
