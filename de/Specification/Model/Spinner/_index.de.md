...
description: "Aspose.Cells Cloud-Modellspezifikation: Spinner. Bearbeiten Sie mühelos Excel und andere Tabellenkalkulationsdokumente mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
weight: 50
---
## **Spinner**
...
| Inkrementelle Änderung| Ganze Zahl| WAHR| FALSCH|| Ruft den Betrag ab, um den die Bildlaufleiste oder der Spinner um einen Zeilenscroll erhöht wird, oder legt diesen fest.|
| Max| Ganze Zahl| WAHR| FALSCH|| Ruft den Maximalwert einer Bildlaufleiste oder eines Spinnerbereichs ab oder legt diesen fest.|
| Mindest| Ganze Zahl| WAHR| FALSCH|| Ruft den Mindestwert einer Bildlaufleiste oder eines Spinnerbereichs ab oder legt diesen fest.|
| Schatten| Boolescher Wert| WAHR| FALSCH|| Gibt an, ob die Form eine 3D-Schattierung aufweist.|
