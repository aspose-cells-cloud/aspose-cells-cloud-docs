...
type: docs
url: /de/specification/model/spinner/
description: "Aspose.Cells Cloud-Modellspezifikation: Spinner. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, Spinner
weight: 50
---
## **Spinner**

 Stellt das Formularsteuerelement dar: Spinner.

| Name des Anwesens| Art der Immobilie| Nullwerte zulassen| Schreibgeschützt| Standardwert| Beschreibung|
|:- |:- |:- |:- |:- |:- |
| Aktueller Wert| Ganze Zahl| WAHR| FALSCH|| Ruft den aktuellen Wert ab oder legt ihn fest.|
| Inkrementelle Änderung| Ganze Zahl| WAHR| FALSCH|| Ruft den Betrag ab, um den die Bildlaufleiste oder der Spinner bei einem Zeilenbildlauf erhöht wird, oder legt diesen fest.|
| Max| Ganze Zahl| WAHR| FALSCH|| Ruft den Maximalwert eines Bildlaufleisten- oder Spinnerbereichs ab oder legt ihn fest.|
| Mindest| Ganze Zahl| WAHR| FALSCH|| Ruft den Mindestwert eines Bildlaufleisten- oder Spinnerbereichs ab oder legt ihn fest.|
| Schatten| Boolescher Wert| WAHR| FALSCH|| Gibt an, ob die Form eine 3D-Schattierung hat.|
