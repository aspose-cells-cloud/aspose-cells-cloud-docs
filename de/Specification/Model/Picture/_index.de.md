...
description: "Aspose.Cells Wolkenmodellspezifikation: Bild. Bearbeiten Sie mühelos Excel und andere Tabellenkalkulationsdokumente mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
weight: 50
---
## **Bild**
...
|:- |:- |:- |:- |:- |:- |
| BorderLineColor| Klasse:Farbe| WAHR| FALSCH|| Stellt die Grenzlinie eines Bildes dar.|
| Grenzgewicht| Schwebend| WAHR| FALSCH|| Ruft die Stärke der Randlinie eines Bildes in Einheiten von pt ab oder legt diese fest.|
...
| SourceFullName| Zeichenfolge| WAHR| FALSCH|| Ruft den Pfad und Namen der Quelldatei für das verknüpfte Bild ab oder legt diesen fest.|
