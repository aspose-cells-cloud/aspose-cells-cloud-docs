...
type: docs
url: /de/specification/model/picture/
description: "Aspose.Cells Cloud-Modellspezifikation: Bild. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, Bild
weight: 50
---
## **Bild**

 Kapselt das Objekt ein, das ein einzelnes Bild in einer Tabelle darstellt.

| Name des Anwesens| Art der Immobilie| Nullwerte zulassen| Schreibgeschützt| Standardwert| Beschreibung|
|:- |:- |:- |:- |:- |:- |
| Rahmenlinienfarbe| Klasse:Farbe| WAHR| FALSCH|| Stellt die Kanten der Rahmenlinie eines Bildes dar.|
| Rahmengewicht| Schwimmend| WAHR| FALSCH|| Ruft die Stärke der Rahmenlinie eines Bildes in pt-Einheiten ab oder legt sie fest.|
| Originalhöhe| Ganze Zahl| WAHR| FALSCH|| Ruft die ursprüngliche Höhe des Bildes ab.|
| Originalbreite| Ganze Zahl| WAHR| FALSCH|| Ruft die ursprüngliche Breite des Bildes ab.|
| Bildformat| Zeichenfolge| WAHR| FALSCH|||
| Vollständiger Quellname| Zeichenfolge| WAHR| FALSCH|| Ruft den Pfad und den Namen der Quelldatei für das verknüpfte Bild ab oder legt diese fest.|
