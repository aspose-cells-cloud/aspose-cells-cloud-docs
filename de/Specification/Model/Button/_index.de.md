...
type: docs
url: /de/specification/model/button/
description: "Aspose.Cells Cloud-Modellspezifikation: Button. Müheloses Bearbeiten von Excel und anderen Tabellenkalkulationsdokumenten mit Funktionen wie Öffnen, Generieren, Bearbeiten, Teilen, Zusammenführen, Vergleichen und Konvertieren"
kwords: Excel, Office, Tabellenkalkulation, Cloud REST API, Schaltfläche
weight: 50
---
## **Taste**

 Stellt das Formular-Steuerelement dar: Button
